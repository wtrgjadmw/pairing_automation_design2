...
writeCommands(72, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
writeCommands(73, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(74, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
writeCommands(75, {`MODE_MUL_CONJ, `RAM_E, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(t2, t1)
// t4 = expFp12(t1)
writeCommands(76, {`MODE_SQR012345, `RAM_G, `RAM_C, `RAM_C});
...
writeCommands(92, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(125, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(135, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(139, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(140, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(141, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(142, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(143, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(144, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(145, {`MODE_MUL_CONJ, `RAM_F, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(f, t1) 
// t5 = expFp12(t4)
writeCommands(146, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(162, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_A});
...
writeCommands(195, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(205, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(209, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
writeCommands(210, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(211, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(212, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
writeCommands(213, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(214, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
writeCommands(215, {`MODE_MUL, `RAM_F, `RAM_B, `RAM_B}); // t4 = mulFp12(f, t4)
// t3 = expFp12(t5)
writeCommands(216, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(232, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_D});
...
writeCommands(265, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(275, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(279, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(284, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(285, {`MODE_MUL, `RAM_E, `RAM_A, `RAM_A}); // t5 = mulFp12(t2, t5)
writeCommands(286, {`MODE_SQR012345, `RAM_E, `RAM_E, `RAM_E}); // t2 = SQR012345Fp12(t2)
writeCommands(287, {`MODE_FROB, `RAM_B, `RAM_E, `RAM_B}); // t4 = FrobFp12(FrobFp12(t4))
writeCommands(288, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B});
writeCommands(289, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(FrobFp12(t5))
writeCommands(290, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A});
writeCommands(291, {`MODE_MUL, `RAM_E, `RAM_D, `RAM_E}); //t2 = mulFp12(t2, t3)
writeCommands(292, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B}); // t4 = FrobFp12(t4)
// t3 = expFp12(t2)
writeCommands(293, {`MODE_SQR012345, `RAM_E, `RAM_C, `RAM_C});
...
writeCommands(309, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_D});
...
writeCommands(342, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(352, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(359, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(360, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(361, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(362, {`MODE_MUL, `RAM_B, `RAM_A, `RAM_B}); // t4 = mulFp12(t4, t5)
writeCommands(363, {`MODE_MUL_CONJ, `RAM_E, `RAM_F, `RAM_A}); // t5 = mulFp12_conj_forRTL(t2, f)
writeCommands(364, {`MODE_MUL, `RAM_G, `RAM_D, `RAM_G}); // t1 = mulFp12(t1, t3)
writeCommands(365, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(t5)
writeCommands(366, {`MODE_MUL, `RAM_G, `RAM_B, `RAM_G}); // t1 = mulFp12(t1, t4)
writeCommands(367, {`MODE_MUL, `RAM_G, `RAM_A, `RAM_G}); // t1 = mulFp12(t1, t3)
