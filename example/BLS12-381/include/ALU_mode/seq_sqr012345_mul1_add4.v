...
17: begin
	...
	mm0_opr1 <= add1_out; mm0_opr2 <= add1_out_reg; 
...
18: begin
	...
	add1_opr1 <= add1_out; add1_opr2 <= add2_out; issub1 <= 0;
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_add2_wr_n <= 0;
...
24: begin
	...
	add2_opr1 <= add3_out; add2_opr2 <= ram_input_out2; issub2 <= 1;
...
26: begin
	...
	add0_opr1 <= add2_out; add0_opr2 <= ram_input_out1; issub0 <= 0;
	add1_opr1 <= add2_out; add1_opr2 <= ram_input_out2; issub1 <= 1;
	ram_add0_wr_n <= 0;
	ram_add2_wr_n <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
...
27: begin
	...
	add0_opr1 <= ram_add3_out2; add0_opr2 <= ram_input_out2; issub0 <= 0;
...
29: begin
	...
	add2_opr1 <= mm0_out_reg; add2_opr2 <= ram_add2_out2; issub2 <= 0;
...
34: begin
	add1_opr1 <= add2_out; add1_opr2 <= ram_input_out1; issub1 <= 1;
...
37: begin
	...
	add0_opr1 <= ram_add2_out1; add0_opr2 <= mm0_out; issub0 <= 0;
...
38: begin
	...
	add0_opr1 <= add0_out; add0_opr2 <= ram_mm0_out2; issub0 <= 1;
	w1_n_reg <= 0;
