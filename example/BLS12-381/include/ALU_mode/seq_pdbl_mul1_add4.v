...
12: begin
	...
	mm0_opr1 <= mm0_out; mm0_opr2 <= ram_add0_out2; 
...
17: begin
	mm0_opr1 <= ram_mm0_out1; mm0_opr2 <= add3_out_reg; 
	add3_opr1 <= mm0_out; add3_opr2 <= mm0_out; issub3 <= 0;
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	add0_opr1 <= add0_out; add0_opr2 <= add0_out; issub0 <= 0;
	ram_add3_wr_n <= 1;
	ram_add3_raddr1 <= 0;
	ram_input_raddr1 <= `RAM_B20;
	ram_input_raddr2 <= `RAM_B21;
	state <= state + 1;
end
18: begin
...
20: begin
	mm0_opr1 <= ram_input_out1; mm0_opr2 <= mm0_out; 
