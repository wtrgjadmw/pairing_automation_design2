...
50: begin
	add0_opr1 <= add0_out; add0_opr2 <= add2_out_reg; issub0 <= 1;
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	mm0_opr1 <= add3_out; mm0_opr2 <= ram_add2_out1; 
	add2_opr1 <= add3_out; add2_opr2 <= add1_out_reg; issub2 <= 0;
...
61: begin
	...
	add2_opr1 <= ram_mm0_out1; add2_opr2 <= add1_out; issub2 <= 1;
...
74: begin
	...
	add0_opr1 <= ram_add1_out2; add0_opr2 <= add3_out; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_add3_wr_n <= 1;
	ram_mm0_waddr <= 2;
	ram_add0_wr_n <= 0;
