...
38: begin
	add2_opr1 <= add1_out; add2_opr2 <= add3_out; issub2 <= 0;
	add1_opr1 <= mm0_out_reg; add1_opr2 <= mm0_out_reg; issub1 <= 0;
...
39: begin
	...
	add0_opr1 <= mm0_out_reg; add0_opr2 <= ram_add3_out2; issub0 <= 0;
...
42: begin
	...
	add3_opr1 <= ram_mm0_out2; add3_opr2 <= add2_out; issub3 <= 1;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 7;
	ram_add0_wr_n <= 1;
	ram_add1_wr_n <= 0;
...
53: begin
	add2_opr1 <= add2_out; add2_opr2 <= add2_out_reg; issub2 <= 1;
...
54: begin
	add1_opr1 <= add2_out; add1_opr2 <= add0_out_reg; issub1 <= 1;
...
74: begin
	...
	add0_opr1 <= ram_add0_out2; add0_opr2 <= add1_out; issub0 <= 1;
...
91: begin
	...
	add0_opr1 <= ram_input_out1; add0_opr2 <= add3_out_reg; issub0 <= 1;
	ram_add0_wr_n <= 1;
	ram_add0_raddr1 <= 9;
	state <= state + 1;
end
...
155: begin
	...
	add1_opr1 <= ram_add1_out2; add1_opr2 <= add0_out_reg; issub1 <= 1;
	mm0_opr1 <= ram_add2_out1; mm0_opr2 <= ram_add2_out2; 
...
165: begin
	...
	add2_opr1 <= ram_add2_out2; add2_opr2 <= add0_out; issub2 <= 1;
	ram_add2_wr_n <= 1;
	ram_add3_raddr1 <= 1;
	ram_add3_raddr2 <= 3;
	ram_mm0_raddr1 <= 3;
