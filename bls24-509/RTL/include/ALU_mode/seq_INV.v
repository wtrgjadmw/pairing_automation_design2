...
145: begin
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	add2_opr1 <= ram_mm0_out1; add2_opr2 <= ram_add0_out1; issub2 <= 1;
	add3_opr1 <= add3_out_reg; add3_opr2 <= ram_add2_out1; issub3 <= 1;
...
161: begin
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
	add1_opr1 <= ram_add0_out1; add1_opr2 <= ram_add3_out1; issub1 <= 1;
	add3_opr1 <= ram_add0_out2; add3_opr2 <= add2_out_reg; issub3 <= 1;
...
162: begin
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	add2_opr1 <= ram_add3_out1; add2_opr2 <= ram_add0_out1; issub2 <= 0;
	add3_opr1 <= add2_out_reg; add3_opr2 <= ram_add1_out2; issub3 <= 1;
...
170: begin
	...
	add2_opr1 <= ram_add1_out2; add2_opr2 <= add2_out_reg; issub2 <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 7;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 17;
...
175: begin
	...
	add2_opr1 <= ram_add0_out1; add2_opr2 <= ram_add3_out2; issub2 <= 0;
	add3_opr1 <= ram_add1_out1; add3_opr2 <= add0_out_reg; issub3 <= 1;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 13;
	ram_add0_raddr1 <= 8;
	ram_add3_raddr1 <= 18;
...
181: begin
	add0_opr1 <= ram_add3_out1; add0_opr2 <= ram_add3_out2; issub0 <= 0;
	add1_opr1 <= ram_add0_out1; add1_opr2 <= add2_out_reg; issub1 <= 1;
	ram_add1_wr_n <= 1;
	ram_add3_wr_n <= 1;
	ram_add3_raddr1 <= 4;
	ram_add3_raddr2 <= 0;
...
233: begin
	add2_opr1 <= ram_add0_out1; add2_opr2 <= ram_add3_out1; issub2 <= 0;
	add0_opr1 <= add3_out_reg; add0_opr2 <= ram_add2_out1; issub0 <= 1;
...
237: begin
	add3_opr1 <= ram_mm0_out1; add3_opr2 <= ram_mm0_out2; issub3 <= 0;
	add0_opr1 <= ram_add1_out1; add0_opr2 <= add1_out_reg; issub0 <= 1;
	add2_opr1 <= ram_add0_out1; add2_opr2 <= add2_out_reg; issub2 <= 1;
...
238: begin
	add1_opr1 <= mm0_out_reg; add1_opr2 <= ram_add1_out1; issub1 <= 1;
	add0_opr1 <= ram_mm0_out1; add0_opr2 <= ram_add3_out1; issub0 <= 1;
	add3_opr1 <= ram_add2_out1; add3_opr2 <= ram_add1_out2; issub3 <= 1;
...
269: begin
	...
	add0_opr1 <= add1_out_reg; add0_opr2 <= ram_add1_out1; issub0 <= 1;
	ram_add3_wr_n <= 0;
	ram_mm0_wr_n <= 1;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 22;
...
283: begin
	mm0_opr1 <= add2_out_reg; mm0_opr2 <= add2_out_reg; 
	add3_opr1 <= add1_out_reg; add3_opr2 <= add2_out_reg; issub3 <= 0;
	ram_add1_wr_n <= 1;
	ram_add2_wr_n <= 1;
	ram_add1_raddr1 <= 8;
	ram_add1_raddr2 <= 8;
...
309: begin
	if (inv_comp == 1) begin
		inv_out_reg <= inv_out;	ram_add0_raddr1 <= 24;
	state <= state + 1;
	end
end
310: begin
...
455: begin
	...
	add0_opr1 <= ram_mm0_out1; add0_opr2 <= ram_add0_out1; issub0 <= 1;
	add2_opr1 <= ram_add2_out2; add2_opr2 <= add0_out_reg; issub2 <= 1;
	mm0_opr1 <= ram_add1_out1; mm0_opr2 <= ram_add1_out2; 
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 5;
	ram_add0_wr_n <= 0;
...
478: begin
	add2_opr1 <= ram_add0_out1; add2_opr2 <= ram_add3_out1; issub2 <= 0;
	add1_opr1 <= ram_add0_out2; add1_opr2 <= ram_add3_out2; issub1 <= 0;
	add0_opr1 <= add2_out_reg; add0_opr2 <= ram_add1_out2; issub0 <= 1;
	add3_opr1 <= ram_add1_out1; add3_opr2 <= ram_add2_out1; issub3 <= 0;
	ram_add3_wr_n <= 0;
	ram_add0_wr_n <= 1;
	ram_add2_wr_n <= 0;
...
489: begin
	add1_opr1 <= ram_add2_out1; add1_opr2 <= ram_add3_out1; issub1 <= 0;
	add2_opr1 <= ram_add2_out2; add2_opr2 <= ram_add0_out1; issub2 <= 0;
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_add3_out2; issub3 <= 1;
	add0_opr1 <= ram_add1_out1; add0_opr2 <= ram_add0_out2; issub0 <= 0;
	ram_add2_wr_n <= 0;
	ram_add3_wr_n <= 1;
	ram_add0_wr_n <= 0;
...
490: begin
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_add3_out1; issub1 <= 1;
	add0_opr1 <= ram_input_out2; add0_opr2 <= ram_add0_out1; issub0 <= 1;
	add2_opr1 <= ram_add2_out1; add2_opr2 <= ram_add1_out1; issub2 <= 1;
	add3_opr1 <= ram_add1_out2; add3_opr2 <= ram_add2_out2; issub3 <= 0;
	ram_add0_wr_n <= 1;
	ram_add2_wr_n <= 1;
...
494: begin
	...
	add2_opr1 <= ram_input_out2; add2_opr2 <= add1_out_reg; issub2 <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 0;
	ram_add3_raddr1 <= 7;
	ram_add0_raddr1 <= 15;
...
497: begin
	add2_opr1 <= ram_input_out1; add2_opr2 <= add2_out_reg; issub2 <= 1;
	add1_opr1 <= ram_input_out2; add1_opr2 <= add1_out_reg; issub1 <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
	w1_n_reg <= 0;
