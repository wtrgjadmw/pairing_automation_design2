...
120: begin
	...
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_add2_out2; issub1 <= 0;
	mm0_opr1 <= ram_input_out2; mm0_opr2 <= ram_add3_out2; 
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
	ram_add0_wr_n <= 0;
...
162: begin
	...
	add2_opr1 <= add0_out_reg; add2_opr2 <= ram_add3_out2; issub2 <= 1;
	add0_opr1 <= add1_out_reg; add0_opr2 <= ram_add1_out1; issub0 <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 1;
	ram_add0_wr_n <= 0;
