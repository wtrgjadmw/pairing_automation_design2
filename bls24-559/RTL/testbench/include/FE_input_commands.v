...
writeCommands(13, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_A});
...
writeCommands(17, {`MODE_MUL, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(52, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(66, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
// b = expFp24(a)
writeCommands(67, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(73, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(77, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(112, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(127, {`MODE_SQR012345, `RAM_A, `RAM_A, `RAM_A}); // a = squareFp24(a)
writeCommands(128, {`MODE_MUL_CONJ, `RAM_B, `RAM_A, `RAM_A}); // a = mulFp24_conj_forRTL(b, a)
writeCommands(129, {`MODE_MUL, `RAM_A, `RAM_F, `RAM_A}); // a = mulFp24(a, f)
// b = expFp24(a)
writeCommands(130, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(136, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(140, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(175, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(189, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(190, {`MODE_FROB, `RAM_A, `RAM_C, `RAM_E}); // e = FrobFp24(a)
writeCommands(191, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
writeCommands(192, {`MODE_CONJ, `RAM_A, `RAM_A, `RAM_A}); // a = conjFp24(a)
// b = expFp24(b)
writeCommands(193, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(199, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(203, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(238, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(252, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(253, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(254, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(255, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(261, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(265, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(300, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(314, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(315, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(316, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(317, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(323, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(327, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(362, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(376, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(377, {`MODE_MUL, `RAM_B, `RAM_A, `RAM_B}); // b = mulFp24(b, a)
writeCommands(378, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(379, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(380, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(386, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(390, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(425, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(439, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(440, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(441, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(442, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(448, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(452, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(487, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(501, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(502, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(503, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(504, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(510, {`MODE_CONJ, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(514, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(549, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(563, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(564, {`MODE_SQR012345, `RAM_F, `RAM_F, `RAM_A}); // a = squareFp24(f)
writeCommands(565, {`MODE_MUL, `RAM_A, `RAM_B, `RAM_A}); // a = mulFp24(a, b)
writeCommands(566, {`MODE_MUL, `RAM_A, `RAM_F, `RAM_A}); // a = mulFp24(a, f)
writeCommands(567, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(568, {`MODE_MUL, `RAM_E, `RAM_A, `RAM_E}); // e = mulFp24(e, a)
