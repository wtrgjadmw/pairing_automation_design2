...
from export_formula.fp2 import fp2_mul, fp2_sub, fp2_add, fp2_sqr, fp2_neg, fp2_constMulNotMont, fp2_guzai
...
def ep2_dbl():
    ...
    formulaList += fp2_constMulNotMont("t11", "yp", "l00")
    formulaList += fp2_constMulNotMont("t9", "xp", "l10")
    return formulaList
...
def ep2_add():
    ...
    formulaList += fp2_constMulNotMont("t3", "yp", "l00")
    formulaList += fp2_constMulNotMont("t1", "xp", "l10")
...
def fp12_SQR012345(opr1: str, ret: str):
    ...
    formulaList += fp2_add(opr1+"00", opr1+"02", "t1")
    formulaList += fp2_sub("t1", opr1+"01", "t2")
    formulaList += fp2_add("t1", opr1+"01", "t8")
    formulaList += fp2_sqr("t8", "t9")
    formulaList += fp2_sqr("t2", "t10")
    formulaList += fp2_mul(opr1+"02", opr1+"01", "t3")
    formulaList += fp2_add("t3", "t3", "t11")
    formulaList += fp2_sqr(opr1+"02", "t4")
    formulaList += fp2_mul(opr1+"00", opr1+"11", "t5")
    formulaList += fp2_mul(opr1+"01", opr1+"12", "t6")
    ...
    formulaList += fp2_add("t27", opr1+"12", "t28")
    formulaList += fp2_add("t28", "t28", ret+"12")
    formulaList += fp2_add("t5", "t5", "t29")
    formulaList += fp2_add("t29", "t5", "t30")
    formulaList += fp2_add("t30", opr1+"11", "t31")
    formulaList += fp2_add("t31", "t31", ret+"11")
    return formulaList
...
def fp12_sparse_m6(opr1: str, opr2: str, ret: str): # opr1: line evaluation
    formulaList = fp2_mul(opr1+"11", opr2+"10", "t1")
    formulaList += fp2_mul(opr1+"11", opr2+"11", "t2")
    formulaList += fp2_mul(opr1+"11", opr2+"12", "t0")
    formulaList += fp2_guzai("t0", "t3")  
    formulaList += Fp2SparseMul(opr1+"00", opr1+"01", opr2+"00", opr2+"01", opr2+"02", "t4")
    formulaList += fp2_add(opr1+"01", opr1+"11", "t7")
    formulaList += fp2_add(opr2+"00", opr2+"10", "t8")
    formulaList += fp2_add(opr2+"01", opr2+"11", "t9")
    formulaList += fp2_add(opr2+"02", opr2+"12", "t10")
    ...
    formulaList += fp2_sub("t51", "t15", ret+"11")
    formulaList += fp2_sub("t52", "t16", ret+"12")
    formulaList += fp2_guzai("t2", "t17")
    formulaList += fp2_add("t17", "t40", ret+"00")
    formulaList += fp2_add("t3", "t41", ret+"01")
    formulaList += fp2_add("t1", "t42", ret+"02")
    return formulaList

def fp12_sparse_d6(opr1: str, opr2: str, ret: str): # opr1: line evaluation
    formulaList = fp2_mul(opr1+"00", opr2+"00", "t0")
    formulaList += fp2_mul(opr1+"00", opr2+"01", "t1")
    formulaList += fp2_mul(opr1+"00", opr2+"02", "t2")
    formulaList += Fp2SparseMul(opr1+"10", opr1+"11", opr2+"10", opr2+"11", opr2+"12", "t4")
    formulaList += fp2_add(opr1+"00", opr1+"10", "t7")
    formulaList += fp2_add(opr2+"00", opr2+"10", "t8")
    formulaList += fp2_add(opr2+"01", opr2+"11", "t9")
    formulaList += fp2_add(opr2+"02", opr2+"12", "t10")
    formulaList += Fp2SparseMul("t7", opr1+"11", "t8", "t9", "t10", "t5")
    ...
    formulaList += fp2_add("t1", "t40", ret+"01")
    formulaList += fp2_add("t2", "t41", ret+"02")
    return formulaList
