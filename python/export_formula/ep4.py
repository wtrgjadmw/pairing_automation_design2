...
def ep4_add():
    formulaList = fp4_mul("yq", "zt", "t0")
    formulaList += fp4_sub("yt", "t0", "t1")
    formulaList += fp4_mul("xq", "zt", "t2")
    formulaList += fp4_sub("xt", "t2", "t3")
    formulaList += fp4_sqr("t1", "t4")
    formulaList += fp4_sqr("t3", "t5")
    formulaList += fp4_mul("t3", "t5", "t6")
    formulaList += fp4_mul("zt", "t4", "t7")
    formulaList += fp4_add("t6", "t7", "t8")
    formulaList += fp4_mul("xt", "t5", "t9")
