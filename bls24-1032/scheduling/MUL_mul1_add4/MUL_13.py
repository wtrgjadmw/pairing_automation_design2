...
def solve():
	...
	S += 197 < c_t4_t3_t01_mem0
	S += c_t4_t3_t01_mem0 <= c_t4_t3_t01

	c_t4_t3_t01_mem1 = S.Task('c_t4_t3_t01_mem1', length=1, delay_cost=1)
	c_t4_t3_t01_mem1 += ADD_mem[1]
	S += 182 < c_t4_t3_t01_mem1
	S += c_t4_t3_t01_mem1 <= c_t4_t3_t01
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/MUL_mul1_add4/MUL_13.png"
	if(S.solution() != []):
