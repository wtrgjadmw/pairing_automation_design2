...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/MUL_mul1_add4/MUL_16.png"
	if(S.solution() != []):
