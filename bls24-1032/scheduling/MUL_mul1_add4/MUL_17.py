...
def solve():
	...
	S += (c_t0_t7_y1_0*ADD[0]) < c_t0000_mem1*ADD_mem[0]
	S += (c_t0_t7_y1_0*ADD[1]) < c_t0000_mem1*ADD_mem[1]
	S += (c_t0_t7_y1_0*ADD[2]) < c_t0000_mem1*ADD_mem[2]
	S += (c_t0_t7_y1_0*ADD[3]) < c_t0000_mem1*ADD_mem[3]
	...
	S += (c_t0_t7_y1_1*ADD[0]) < c_t0001_mem1*ADD_mem[0]
	S += (c_t0_t7_y1_1*ADD[1]) < c_t0001_mem1*ADD_mem[1]
	S += (c_t0_t7_y1_1*ADD[2]) < c_t0001_mem1*ADD_mem[2]
	S += (c_t0_t7_y1_1*ADD[3]) < c_t0001_mem1*ADD_mem[3]
	...
	S += (c_t1_t7_y1_0*ADD[0]) < c_t1000_mem1*ADD_mem[0]
	S += (c_t1_t7_y1_0*ADD[1]) < c_t1000_mem1*ADD_mem[1]
	S += (c_t1_t7_y1_0*ADD[2]) < c_t1000_mem1*ADD_mem[2]
	S += (c_t1_t7_y1_0*ADD[3]) < c_t1000_mem1*ADD_mem[3]
	...
	S += (c_t1_t7_y1_1*ADD[0]) < c_t1001_mem1*ADD_mem[0]
	S += (c_t1_t7_y1_1*ADD[1]) < c_t1001_mem1*ADD_mem[1]
	S += (c_t1_t7_y1_1*ADD[2]) < c_t1001_mem1*ADD_mem[2]
	S += (c_t1_t7_y1_1*ADD[3]) < c_t1001_mem1*ADD_mem[3]
	...
	S += (c_t4_t600*ADD[0]) < c_t4100_mem0*ADD_mem[0]
	S += (c_t4_t600*ADD[1]) < c_t4100_mem0*ADD_mem[1]
	S += (c_t4_t600*ADD[2]) < c_t4100_mem0*ADD_mem[2]
	S += (c_t4_t600*ADD[3]) < c_t4100_mem0*ADD_mem[3]
	...
	S += (c_t4_t611*ADD[0]) < c_t4111_mem0*ADD_mem[0]
	S += (c_t4_t611*ADD[1]) < c_t4111_mem0*ADD_mem[1]
	S += (c_t4_t611*ADD[2]) < c_t4111_mem0*ADD_mem[2]
	S += (c_t4_t611*ADD[3]) < c_t4111_mem0*ADD_mem[3]
	...
	S += (c_t4_t7111*ADD[0]) < c_t4_t7_y1_0_mem1*ADD_mem[0]
	S += (c_t4_t7111*ADD[1]) < c_t4_t7_y1_0_mem1*ADD_mem[1]
	S += (c_t4_t7111*ADD[2]) < c_t4_t7_y1_0_mem1*ADD_mem[2]
	S += (c_t4_t7111*ADD[3]) < c_t4_t7_y1_0_mem1*ADD_mem[3]
	...
	S += (c_t4_t7111*ADD[0]) < c_t4_t7_y1_1_mem0*ADD_mem[0]
	S += (c_t4_t7111*ADD[1]) < c_t4_t7_y1_1_mem0*ADD_mem[1]
	S += (c_t4_t7111*ADD[2]) < c_t4_t7_y1_1_mem0*ADD_mem[2]
	S += (c_t4_t7111*ADD[3]) < c_t4_t7_y1_1_mem0*ADD_mem[3]
	...
	S += (c_t4_t7100*ADD[0]) < c_t4010_mem1*ADD_mem[0]
	S += (c_t4_t7100*ADD[1]) < c_t4010_mem1*ADD_mem[1]
	S += (c_t4_t7100*ADD[2]) < c_t4010_mem1*ADD_mem[2]
	S += (c_t4_t7100*ADD[3]) < c_t4010_mem1*ADD_mem[3]
	...
	S += (c_t4_t800*ADD[0]) < c_t4200_mem0*ADD_mem[0]
	S += (c_t4_t800*ADD[1]) < c_t4200_mem0*ADD_mem[1]
	S += (c_t4_t800*ADD[2]) < c_t4200_mem0*ADD_mem[2]
	S += (c_t4_t800*ADD[3]) < c_t4200_mem0*ADD_mem[3]
	...
	S += (c_t4_t811*ADD[0]) < c_t4211_mem0*ADD_mem[0]
	S += (c_t4_t811*ADD[1]) < c_t4211_mem0*ADD_mem[1]
	S += (c_t4_t811*ADD[2]) < c_t4211_mem0*ADD_mem[2]
	S += (c_t4_t811*ADD[3]) < c_t4211_mem0*ADD_mem[3]
	...
	S += 227 < c_s00_y1_0_mem0
	S += c_s00_y1_0_mem0 <= c_s00_y1_0

	c_s00_y1_0_mem1 = S.Task('c_s00_y1_0_mem1', length=1, delay_cost=1)
	c_s00_y1_0_mem1 += alt(ADD_mem)
	S += (c_t1211*ADD[0]) < c_s00_y1_0_mem1*ADD_mem[0]
	S += (c_t1211*ADD[1]) < c_s00_y1_0_mem1*ADD_mem[1]
	S += (c_t1211*ADD[2]) < c_s00_y1_0_mem1*ADD_mem[2]
	S += (c_t1211*ADD[3]) < c_s00_y1_0_mem1*ADD_mem[3]
	...
	S += (c_t1211*ADD[0]) < c_s00_y1_1_mem0*ADD_mem[0]
	S += (c_t1211*ADD[1]) < c_s00_y1_1_mem0*ADD_mem[1]
	S += (c_t1211*ADD[2]) < c_s00_y1_1_mem0*ADD_mem[2]
	S += (c_t1211*ADD[3]) < c_s00_y1_1_mem0*ADD_mem[3]
	S += c_s00_y1_1_mem0 <= c_s00_y1_1

	c_s00_y1_1_mem1 = S.Task('c_s00_y1_1_mem1', length=1, delay_cost=1)
	c_s00_y1_1_mem1 += ADD_mem[1]
	S += 227 < c_s00_y1_1_mem1
	...
	S += (c_t1200*ADD[0]) < c0010_mem1*ADD_mem[0]
	S += (c_t1200*ADD[1]) < c0010_mem1*ADD_mem[1]
	S += (c_t1200*ADD[2]) < c0010_mem1*ADD_mem[2]
	S += (c_t1200*ADD[3]) < c0010_mem1*ADD_mem[3]
	S += c0010_mem1 <= c0010
	...
	S += (c_t0111*ADD[0]) < c0111_mem0*ADD_mem[0]
	S += (c_t0111*ADD[1]) < c0111_mem0*ADD_mem[1]
	S += (c_t0111*ADD[2]) < c0111_mem0*ADD_mem[2]
	S += (c_t0111*ADD[3]) < c0111_mem0*ADD_mem[3]
	S += c0111_mem0 <= c0111
	...
	S += (c_t0200*ADD[0]) < c0200_mem0*ADD_mem[0]
	S += (c_t0200*ADD[1]) < c0200_mem0*ADD_mem[1]
	S += (c_t0200*ADD[2]) < c0200_mem0*ADD_mem[2]
	S += (c_t0200*ADD[3]) < c0200_mem0*ADD_mem[3]
	S += c0200_mem0 <= c0200

	c0200_mem1 = S.Task('c0200_mem1', length=1, delay_cost=1)
	c0200_mem1 += alt(ADD_mem)
	S += (c_t1100*ADD[0]) < c0200_mem1*ADD_mem[0]
	S += (c_t1100*ADD[1]) < c0200_mem1*ADD_mem[1]
	S += (c_t1100*ADD[2]) < c0200_mem1*ADD_mem[2]
	S += (c_t1100*ADD[3]) < c0200_mem1*ADD_mem[3]
	S += c0200_mem1 <= c0200
	...
	S += (c_t0211*ADD[0]) < c0211_mem0*ADD_mem[0]
	S += (c_t0211*ADD[1]) < c0211_mem0*ADD_mem[1]
	S += (c_t0211*ADD[2]) < c0211_mem0*ADD_mem[2]
	S += (c_t0211*ADD[3]) < c0211_mem0*ADD_mem[3]
	S += c0211_mem0 <= c0211

	c0211_mem1 = S.Task('c0211_mem1', length=1, delay_cost=1)
	c0211_mem1 += alt(ADD_mem)
	S += (c_t1111*ADD[0]) < c0211_mem1*ADD_mem[0]
	S += (c_t1111*ADD[1]) < c0211_mem1*ADD_mem[1]
	S += (c_t1111*ADD[2]) < c0211_mem1*ADD_mem[2]
	S += (c_t1111*ADD[3]) < c0211_mem1*ADD_mem[3]
	S += c0211_mem1 <= c0211
	...
	S += (c_t0100*ADD[0]) < c_t5100_mem0*ADD_mem[0]
	S += (c_t0100*ADD[1]) < c_t5100_mem0*ADD_mem[1]
	S += (c_t0100*ADD[2]) < c_t5100_mem0*ADD_mem[2]
	S += (c_t0100*ADD[3]) < c_t5100_mem0*ADD_mem[3]
	S += c_t5100_mem0 <= c_t5100

	c_t5100_mem1 = S.Task('c_t5100_mem1', length=1, delay_cost=1)
	c_t5100_mem1 += alt(ADD_mem)
	S += (c_t1100*ADD[0]) < c_t5100_mem1*ADD_mem[0]
	S += (c_t1100*ADD[1]) < c_t5100_mem1*ADD_mem[1]
	S += (c_t1100*ADD[2]) < c_t5100_mem1*ADD_mem[2]
	S += (c_t1100*ADD[3]) < c_t5100_mem1*ADD_mem[3]
	...
	S += (c_t0111*ADD[0]) < c_t5111_mem0*ADD_mem[0]
	S += (c_t0111*ADD[1]) < c_t5111_mem0*ADD_mem[1]
	S += (c_t0111*ADD[2]) < c_t5111_mem0*ADD_mem[2]
	S += (c_t0111*ADD[3]) < c_t5111_mem0*ADD_mem[3]
	S += c_t5111_mem0 <= c_t5111

	c_t5111_mem1 = S.Task('c_t5111_mem1', length=1, delay_cost=1)
	c_t5111_mem1 += alt(ADD_mem)
	S += (c_t1111*ADD[0]) < c_t5111_mem1*ADD_mem[0]
	S += (c_t1111*ADD[1]) < c_t5111_mem1*ADD_mem[1]
	S += (c_t1111*ADD[2]) < c_t5111_mem1*ADD_mem[2]
	S += (c_t1111*ADD[3]) < c_t5111_mem1*ADD_mem[3]
	...
	S += (c_t0200*ADD[0]) < c_t5200_mem0*ADD_mem[0]
	S += (c_t0200*ADD[1]) < c_t5200_mem0*ADD_mem[1]
	S += (c_t0200*ADD[2]) < c_t5200_mem0*ADD_mem[2]
	S += (c_t0200*ADD[3]) < c_t5200_mem0*ADD_mem[3]
	S += c_t5200_mem0 <= c_t5200

	c_t5200_mem1 = S.Task('c_t5200_mem1', length=1, delay_cost=1)
	c_t5200_mem1 += alt(ADD_mem)
	S += (c_t1200*ADD[0]) < c_t5200_mem1*ADD_mem[0]
	S += (c_t1200*ADD[1]) < c_t5200_mem1*ADD_mem[1]
	S += (c_t1200*ADD[2]) < c_t5200_mem1*ADD_mem[2]
	S += (c_t1200*ADD[3]) < c_t5200_mem1*ADD_mem[3]
	...
	S += (c_t0211*ADD[0]) < c_t5211_mem0*ADD_mem[0]
	S += (c_t0211*ADD[1]) < c_t5211_mem0*ADD_mem[1]
	S += (c_t0211*ADD[2]) < c_t5211_mem0*ADD_mem[2]
	S += (c_t0211*ADD[3]) < c_t5211_mem0*ADD_mem[3]
	S += c_t5211_mem0 <= c_t5211

	c_t5211_mem1 = S.Task('c_t5211_mem1', length=1, delay_cost=1)
	c_t5211_mem1 += alt(ADD_mem)
	S += (c_t1211*ADD[0]) < c_t5211_mem1*ADD_mem[0]
	S += (c_t1211*ADD[1]) < c_t5211_mem1*ADD_mem[1]
	S += (c_t1211*ADD[2]) < c_t5211_mem1*ADD_mem[2]
	S += (c_t1211*ADD[3]) < c_t5211_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/MUL_mul1_add4/MUL_17.png"
	if(S.solution() != []):
