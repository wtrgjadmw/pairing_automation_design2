...
def solve():
	horizon = 194
	S = Scenario("MUL_0", horizon=horizon)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/MUL_mul1_add4/MUL_0.png"
	if(S.solution() != []):
