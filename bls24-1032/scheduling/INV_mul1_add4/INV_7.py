...
def solve():
	...
	S += 95 < c_bb_t3_t20_mem0
	S += c_bb_t3_t20_mem0 <= c_bb_t3_t20

	c_bb_t3_t20_mem1 = S.Task('c_bb_t3_t20_mem1', length=1, delay_cost=1)
	c_bb_t3_t20_mem1 += ADD_mem[0]
	S += 97 < c_bb_t3_t20_mem1
	S += c_bb_t3_t20_mem1 <= c_bb_t3_t20
	...
	S += 96 < c_bb_t3_t21_mem0
	S += c_bb_t3_t21_mem0 <= c_bb_t3_t21

	c_bb_t3_t21_mem1 = S.Task('c_bb_t3_t21_mem1', length=1, delay_cost=1)
	c_bb_t3_t21_mem1 += ADD_mem[0]
	S += 98 < c_bb_t3_t21_mem1
	S += c_bb_t3_t21_mem1 <= c_bb_t3_t21
	...
	S += 99 < c_bb_t3_t30_mem0
	S += c_bb_t3_t30_mem0 <= c_bb_t3_t30

	c_bb_t3_t30_mem1 = S.Task('c_bb_t3_t30_mem1', length=1, delay_cost=1)
	c_bb_t3_t30_mem1 += ADD_mem[0]
	S += 101 < c_bb_t3_t30_mem1
	S += c_bb_t3_t30_mem1 <= c_bb_t3_t30
	...
	S += 103 < c_bb_t4_t20_mem0
	S += c_bb_t4_t20_mem0 <= c_bb_t4_t20

	c_bb_t4_t20_mem1 = S.Task('c_bb_t4_t20_mem1', length=1, delay_cost=1)
	c_bb_t4_t20_mem1 += ADD_mem[0]
	S += 106 < c_bb_t4_t20_mem1
	S += c_bb_t4_t20_mem1 <= c_bb_t4_t20
	...
	S += 105 < c_bb_t4_t21_mem0
	S += c_bb_t4_t21_mem0 <= c_bb_t4_t21

	c_bb_t4_t21_mem1 = S.Task('c_bb_t4_t21_mem1', length=1, delay_cost=1)
	c_bb_t4_t21_mem1 += ADD_mem[0]
	S += 107 < c_bb_t4_t21_mem1
	S += c_bb_t4_t21_mem1 <= c_bb_t4_t21
	...
	S += 108 < c_bb_t4_t30_mem0
	S += c_bb_t4_t30_mem0 <= c_bb_t4_t30

	c_bb_t4_t30_mem1 = S.Task('c_bb_t4_t30_mem1', length=1, delay_cost=1)
	c_bb_t4_t30_mem1 += ADD_mem[0]
	S += 110 < c_bb_t4_t30_mem1
	S += c_bb_t4_t30_mem1 <= c_bb_t4_t30
	...
	S += 112 < c_bb_t5_t20_mem0
	S += c_bb_t5_t20_mem0 <= c_bb_t5_t20

	c_bb_t5_t20_mem1 = S.Task('c_bb_t5_t20_mem1', length=1, delay_cost=1)
	c_bb_t5_t20_mem1 += ADD_mem[2]
	S += 114 < c_bb_t5_t20_mem1
	S += c_bb_t5_t20_mem1 <= c_bb_t5_t20
	...
	S += 113 < c_bb_t5_t21_mem0
	S += c_bb_t5_t21_mem0 <= c_bb_t5_t21

	c_bb_t5_t21_mem1 = S.Task('c_bb_t5_t21_mem1', length=1, delay_cost=1)
	c_bb_t5_t21_mem1 += ADD_mem[0]
	S += 116 < c_bb_t5_t21_mem1
	S += c_bb_t5_t21_mem1 <= c_bb_t5_t21
	...
	S += 117 < c_bb_t5_t30_mem0
	S += c_bb_t5_t30_mem0 <= c_bb_t5_t30

	c_bb_t5_t30_mem1 = S.Task('c_bb_t5_t30_mem1', length=1, delay_cost=1)
	c_bb_t5_t30_mem1 += ADD_mem[0]
	S += 119 < c_bb_t5_t30_mem1
	S += c_bb_t5_t30_mem1 <= c_bb_t5_t30
	...
	S += 118 < c_bb_t5_t31_mem0
	S += c_bb_t5_t31_mem0 <= c_bb_t5_t31

	c_bb_t5_t31_mem1 = S.Task('c_bb_t5_t31_mem1', length=1, delay_cost=1)
	c_bb_t5_t31_mem1 += ADD_mem[0]
	S += 120 < c_bb_t5_t31_mem1
	S += c_bb_t5_t31_mem1 <= c_bb_t5_t31
	...
	S += 151 < c0_t0_t4_t2_mem0
	S += c0_t0_t4_t2_mem0 <= c0_t0_t4_t2

	c0_t0_t4_t2_mem1 = S.Task('c0_t0_t4_t2_mem1', length=1, delay_cost=1)
	c0_t0_t4_t2_mem1 += ADD_mem[0]
	S += 122 < c0_t0_t4_t2_mem1
	S += c0_t0_t4_t2_mem1 <= c0_t0_t4_t2
	...
	S += 125 < c0_t1_t4_t2_mem0
	S += c0_t1_t4_t2_mem0 <= c0_t1_t4_t2

	c0_t1_t4_t2_mem1 = S.Task('c0_t1_t4_t2_mem1', length=1, delay_cost=1)
	c0_t1_t4_t2_mem1 += ADD_mem[0]
	S += 126 < c0_t1_t4_t2_mem1
	S += c0_t1_t4_t2_mem1 <= c0_t1_t4_t2
	...
	S += 129 < c0_t2_t4_t2_mem0
	S += c0_t2_t4_t2_mem0 <= c0_t2_t4_t2

	c0_t2_t4_t2_mem1 = S.Task('c0_t2_t4_t2_mem1', length=1, delay_cost=1)
	c0_t2_t4_t2_mem1 += ADD_mem[0]
	S += 130 < c0_t2_t4_t2_mem1
	S += c0_t2_t4_t2_mem1 <= c0_t2_t4_t2
	...
	S += 131 < c0_t3_t0_t2_mem0
	S += c0_t3_t0_t2_mem0 <= c0_t3_t0_t2

	c0_t3_t0_t2_mem1 = S.Task('c0_t3_t0_t2_mem1', length=1, delay_cost=1)
	c0_t3_t0_t2_mem1 += ADD_mem[2]
	S += 132 < c0_t3_t0_t2_mem1
	S += c0_t3_t0_t2_mem1 <= c0_t3_t0_t2
	...
	S += 133 < c0_t3_t1_t2_mem0
	S += c0_t3_t1_t2_mem0 <= c0_t3_t1_t2

	c0_t3_t1_t2_mem1 = S.Task('c0_t3_t1_t2_mem1', length=1, delay_cost=1)
	c0_t3_t1_t2_mem1 += ADD_mem[1]
	S += 134 < c0_t3_t1_t2_mem1
	S += c0_t3_t1_t2_mem1 <= c0_t3_t1_t2
	...
	S += 131 < c0_t3_t20_mem0
	S += c0_t3_t20_mem0 <= c0_t3_t20

	c0_t3_t20_mem1 = S.Task('c0_t3_t20_mem1', length=1, delay_cost=1)
	c0_t3_t20_mem1 += ADD_mem[0]
	S += 133 < c0_t3_t20_mem1
	S += c0_t3_t20_mem1 <= c0_t3_t20
	...
	S += 132 < c0_t3_t21_mem0
	S += c0_t3_t21_mem0 <= c0_t3_t21

	c0_t3_t21_mem1 = S.Task('c0_t3_t21_mem1', length=1, delay_cost=1)
	c0_t3_t21_mem1 += ADD_mem[1]
	S += 134 < c0_t3_t21_mem1
	S += c0_t3_t21_mem1 <= c0_t3_t21
	...
	S += 135 < c0_t4_t0_t2_mem0
	S += c0_t4_t0_t2_mem0 <= c0_t4_t0_t2

	c0_t4_t0_t2_mem1 = S.Task('c0_t4_t0_t2_mem1', length=1, delay_cost=1)
	c0_t4_t0_t2_mem1 += ADD_mem[0]
	S += 136 < c0_t4_t0_t2_mem1
	S += c0_t4_t0_t2_mem1 <= c0_t4_t0_t2
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/INV_mul1_add4/INV_7.png"
	if(S.solution() != []):
