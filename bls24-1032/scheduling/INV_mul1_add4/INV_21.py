...
def solve():
	...
	S += 270 < c_denom_inv_pcb_t41_mem0
	...
	S += 269 < c_denom_inv_pcb_t41_mem1
	...
	S += 262 < c_denom_inv_pcb_t51_mem0
	...
	S += 262 < c_denom_inv_pcb_t51_mem1
	...
	S += 272 < c_denom_inv_paa_t41_mem0
	...
	S += 270 < c_denom_inv_paa_t41_mem1
	...
	S += 271 < c_denom_inv_paa_t51_mem0
	...
	S += 253 < c_denom_inv_paa_t51_mem1
	...
	S += 269 < c_denom_inv_pbccb10_mem0
	...
	S += (c_denom_inv_pbccb01*ADD[0]) < c_denom_inv_q11_mem0*ADD_mem[0]
	S += (c_denom_inv_pbccb01*ADD[1]) < c_denom_inv_q11_mem0*ADD_mem[1]
	S += (c_denom_inv_pbccb01*ADD[2]) < c_denom_inv_q11_mem0*ADD_mem[2]
	S += (c_denom_inv_pbccb01*ADD[3]) < c_denom_inv_q11_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_q10*ADD[0]) < c_denom_inv_qinv1__t2_mem0*ADD_mem[0]
	S += (c_denom_inv_q10*ADD[1]) < c_denom_inv_qinv1__t2_mem0*ADD_mem[1]
	S += (c_denom_inv_q10*ADD[2]) < c_denom_inv_qinv1__t2_mem0*ADD_mem[2]
	S += (c_denom_inv_q10*ADD[3]) < c_denom_inv_qinv1__t2_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv1__t2_mem1 += alt(ADD_mem)
	S += (c_denom_inv_q11*ADD[0]) < c_denom_inv_qinv1__t2_mem1*ADD_mem[0]
	S += (c_denom_inv_q11*ADD[1]) < c_denom_inv_qinv1__t2_mem1*ADD_mem[1]
	S += (c_denom_inv_q11*ADD[2]) < c_denom_inv_qinv1__t2_mem1*ADD_mem[2]
	S += (c_denom_inv_q11*ADD[3]) < c_denom_inv_qinv1__t2_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_pxi_y1_0*ADD[0]) < c_denom_inv_q00_mem0*ADD_mem[0]
	S += (c_denom_inv_pxi_y1_0*ADD[1]) < c_denom_inv_q00_mem0*ADD_mem[1]
	S += (c_denom_inv_pxi_y1_0*ADD[2]) < c_denom_inv_q00_mem0*ADD_mem[2]
	S += (c_denom_inv_pxi_y1_0*ADD[3]) < c_denom_inv_q00_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pxi_y1_1*ADD[0]) < c_denom_inv_q01_mem0*ADD_mem[0]
	S += (c_denom_inv_pxi_y1_1*ADD[1]) < c_denom_inv_q01_mem0*ADD_mem[1]
	S += (c_denom_inv_pxi_y1_1*ADD[2]) < c_denom_inv_q01_mem0*ADD_mem[2]
	S += (c_denom_inv_pxi_y1_1*ADD[3]) < c_denom_inv_q01_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_qinv_bb_t0*MUL[0]) < c_denom_inv_qinv_bb0_mem0*MUL_mem[0]
	...
	S += (c_denom_inv_qinv_bb_t0*MUL[0]) < c_denom_inv_qinv_bb_t5_mem0*MUL_mem[0]
	...
	c_denom_inv_qinv_aa_t0_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q00*ADD[0]) < c_denom_inv_qinv_aa_t0_mem0*ADD_mem[0]
	S += (c_denom_inv_q00*ADD[1]) < c_denom_inv_qinv_aa_t0_mem0*ADD_mem[1]
	S += (c_denom_inv_q00*ADD[2]) < c_denom_inv_qinv_aa_t0_mem0*ADD_mem[2]
	S += (c_denom_inv_q00*ADD[3]) < c_denom_inv_qinv_aa_t0_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv_aa_t1_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q01*ADD[0]) < c_denom_inv_qinv_aa_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_q01*ADD[1]) < c_denom_inv_qinv_aa_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_q01*ADD[2]) < c_denom_inv_qinv_aa_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_q01*ADD[3]) < c_denom_inv_qinv_aa_t1_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv_aa_t2_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q00*ADD[0]) < c_denom_inv_qinv_aa_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_q00*ADD[1]) < c_denom_inv_qinv_aa_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_q00*ADD[2]) < c_denom_inv_qinv_aa_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_q00*ADD[3]) < c_denom_inv_qinv_aa_t2_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv_aa_t2_mem1 += alt(ADD_mem)
	S += (c_denom_inv_q01*ADD[0]) < c_denom_inv_qinv_aa_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_q01*ADD[1]) < c_denom_inv_qinv_aa_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_q01*ADD[2]) < c_denom_inv_qinv_aa_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_q01*ADD[3]) < c_denom_inv_qinv_aa_t2_mem1*ADD_mem[3]
	...
	c_denom_inv_qinv_aa_t3_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q00*ADD[0]) < c_denom_inv_qinv_aa_t3_mem0*ADD_mem[0]
	S += (c_denom_inv_q00*ADD[1]) < c_denom_inv_qinv_aa_t3_mem0*ADD_mem[1]
	S += (c_denom_inv_q00*ADD[2]) < c_denom_inv_qinv_aa_t3_mem0*ADD_mem[2]
	S += (c_denom_inv_q00*ADD[3]) < c_denom_inv_qinv_aa_t3_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv_aa_t3_mem1 += alt(ADD_mem)
	S += (c_denom_inv_q01*ADD[0]) < c_denom_inv_qinv_aa_t3_mem1*ADD_mem[0]
	S += (c_denom_inv_q01*ADD[1]) < c_denom_inv_qinv_aa_t3_mem1*ADD_mem[1]
	S += (c_denom_inv_q01*ADD[2]) < c_denom_inv_qinv_aa_t3_mem1*ADD_mem[2]
	S += (c_denom_inv_q01*ADD[3]) < c_denom_inv_qinv_aa_t3_mem1*ADD_mem[3]
	...
	c_denom_inv_qinv0_t2_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q00*ADD[0]) < c_denom_inv_qinv0_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_q00*ADD[1]) < c_denom_inv_qinv0_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_q00*ADD[2]) < c_denom_inv_qinv0_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_q00*ADD[3]) < c_denom_inv_qinv0_t2_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv0_t2_mem1 += alt(ADD_mem)
	S += (c_denom_inv_q01*ADD[0]) < c_denom_inv_qinv0_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_q01*ADD[1]) < c_denom_inv_qinv0_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_q01*ADD[2]) < c_denom_inv_qinv0_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_q01*ADD[3]) < c_denom_inv_qinv0_t2_mem1*ADD_mem[3]
	...
	c_denom_inv_qinv0_t0_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q00*ADD[0]) < c_denom_inv_qinv0_t0_mem0*ADD_mem[0]
	S += (c_denom_inv_q00*ADD[1]) < c_denom_inv_qinv0_t0_mem0*ADD_mem[1]
	S += (c_denom_inv_q00*ADD[2]) < c_denom_inv_qinv0_t0_mem0*ADD_mem[2]
	S += (c_denom_inv_q00*ADD[3]) < c_denom_inv_qinv0_t0_mem0*ADD_mem[3]
	...
	c_denom_inv_qinv0_t1_mem0 += alt(ADD_mem)
	S += (c_denom_inv_q01*ADD[0]) < c_denom_inv_qinv0_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_q01*ADD[1]) < c_denom_inv_qinv0_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_q01*ADD[2]) < c_denom_inv_qinv0_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_q01*ADD[3]) < c_denom_inv_qinv0_t1_mem0*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/INV_mul1_add4/INV_21.png"
	if(S.solution() != []):
