...
def solve():
	...
	S += 250 < c_denom_inv_pbc_t01_mem0
	...
	S += 249 < c_denom_inv_pbc_t01_mem1
	...
	S += 253 < c_denom_inv_pbc_t1_t4_mem0
	...
	S += 198 < c_denom_inv_pbc_t1_t4_mem1
	...
	S += 249 < c_denom_inv_pbc_t10_mem0
	...
	S += 255 < c_denom_inv_pbc_t10_mem1
	...
	S += 249 < c_denom_inv_pbc_t1_t5_mem0
	...
	S += 255 < c_denom_inv_pbc_t1_t5_mem1
	...
	S += 240 < c_denom_inv_pbc_t4_t0_mem0
	...
	S += 194 < c_denom_inv_pbc_t4_t0_mem1
	...
	S += 251 < c_denom_inv_pbc_t4_t1_mem0
	...
	S += 191 < c_denom_inv_pbc_t4_t1_mem1
	...
	S += 240 < c_denom_inv_pbc_t4_t2_mem0
	...
	S += 251 < c_denom_inv_pbc_t4_t2_mem1
	...
	S += 242 < c_denom_inv_pcb_t0_t0_mem0
	...
	S += 179 < c_denom_inv_pcb_t0_t0_mem1
	...
	S += 247 < c_denom_inv_pcb_t0_t1_mem0
	...
	S += 185 < c_denom_inv_pcb_t0_t1_mem1
	...
	S += 242 < c_denom_inv_pcb_t0_t2_mem0
	...
	S += 247 < c_denom_inv_pcb_t0_t2_mem1
	...
	S += 197 < c_denom_inv_pcb_t1_t4_mem1
	...
	S += 252 < c_denom_inv_pcb_t10_mem0
	...
	S += 252 < c_denom_inv_pcb_t1_t5_mem0
	...
	S += 242 < c_denom_inv_pcb_t20_mem0
	...
	S += 244 < c_denom_inv_pcb_t20_mem1
	...
	S += 247 < c_denom_inv_pcb_t21_mem0
	...
	S += 249 < c_denom_inv_paa_t0_t0_mem0
	...
	S += 187 < c_denom_inv_paa_t0_t0_mem1
	...
	S += 248 < c_denom_inv_paa_t0_t1_mem0
	...
	S += 182 < c_denom_inv_paa_t0_t1_mem1
	...
	S += 249 < c_denom_inv_paa_t0_t2_mem0
	...
	S += 248 < c_denom_inv_paa_t0_t2_mem1
	...
	S += 251 < c_denom_inv_paa_t11_mem0
	...
	S += 250 < c_denom_inv_paa_t11_mem1
	...
	S += 249 < c_denom_inv_paa_t20_mem0
	...
	S += 239 < c_denom_inv_paa_t20_mem1
	...
	S += 248 < c_denom_inv_paa_t21_mem0
	...
	S += 238 < c_denom_inv_paa_t21_mem1
	...
	S += 215 < c_denom_inv_pbc_t4_t4_mem1
	...
	c_denom_inv_pbc_t40_mem0 += alt(MUL_mem)
	S += (c_denom_inv_pbc_t4_t0*MUL[0]) < c_denom_inv_pbc_t40_mem0*MUL_mem[0]
	...
	c_denom_inv_pbc_t40_mem1 += alt(MUL_mem)
	S += (c_denom_inv_pbc_t4_t1*MUL[0]) < c_denom_inv_pbc_t40_mem1*MUL_mem[0]
	...
	c_denom_inv_pbc_t4_t5_mem1 += alt(MUL_mem)
	S += (c_denom_inv_pbc_t4_t1*MUL[0]) < c_denom_inv_pbc_t4_t5_mem1*MUL_mem[0]
	...
	S += 248 < c_denom_inv_pbc_t50_mem0
	...
	S += 212 < c_denom_inv_pcb_t0_t4_mem1
	...
	S += 212 < c_denom_inv_pcb_t4_t0_mem1
	...
	S += 191 < c_denom_inv_paa_t0_t4_mem1
	...
	c_denom_inv_paa_t00_mem0 += alt(MUL_mem)
	S += (c_denom_inv_paa_t0_t0*MUL[0]) < c_denom_inv_paa_t00_mem0*MUL_mem[0]
	...
	c_denom_inv_paa_t00_mem1 += alt(MUL_mem)
	S += (c_denom_inv_paa_t0_t1*MUL[0]) < c_denom_inv_paa_t00_mem1*MUL_mem[0]
	...
	c_denom_inv_paa_t0_t5_mem1 += alt(MUL_mem)
	S += (c_denom_inv_paa_t0_t1*MUL[0]) < c_denom_inv_paa_t0_t5_mem1*MUL_mem[0]
	...
	S += 206 < c_denom_inv_paa_t4_t0_mem1
	...
	c_denom_inv_paa_t4_t1_mem0 += alt(ADD_mem)
	S += (c_denom_inv_paa_t21*ADD[0]) < c_denom_inv_paa_t4_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_paa_t21*ADD[1]) < c_denom_inv_paa_t4_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_paa_t21*ADD[2]) < c_denom_inv_paa_t4_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_paa_t21*ADD[3]) < c_denom_inv_paa_t4_t1_mem0*ADD_mem[3]
	...
	S += 193 < c_denom_inv_paa_t4_t1_mem1
	...
	c_denom_inv_paa_t4_t2_mem1 += alt(ADD_mem)
	S += (c_denom_inv_paa_t21*ADD[0]) < c_denom_inv_paa_t4_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_paa_t21*ADD[1]) < c_denom_inv_paa_t4_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_paa_t21*ADD[2]) < c_denom_inv_paa_t4_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_paa_t21*ADD[3]) < c_denom_inv_paa_t4_t2_mem1*ADD_mem[3]
	...
	S += 251 < c_denom_inv_paa_s00_mem0
	...
	S += 251 < c_denom_inv_paa_s01_mem1
	...
	c_denom_inv0_t4_t2_mem1 += alt(ADD_mem)
	S += (c_denom_inv0_t21*ADD[0]) < c_denom_inv0_t4_t2_mem1*ADD_mem[0]
	S += (c_denom_inv0_t21*ADD[1]) < c_denom_inv0_t4_t2_mem1*ADD_mem[1]
	S += (c_denom_inv0_t21*ADD[2]) < c_denom_inv0_t4_t2_mem1*ADD_mem[2]
	S += (c_denom_inv0_t21*ADD[3]) < c_denom_inv0_t4_t2_mem1*ADD_mem[3]
	...
	c_denom_inv_pbc_s00_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t10*ADD[0]) < c_denom_inv_pbc_s00_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t10*ADD[1]) < c_denom_inv_pbc_s00_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t10*ADD[2]) < c_denom_inv_pbc_s00_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t10*ADD[3]) < c_denom_inv_pbc_s00_mem0*ADD_mem[3]
	...
	c_denom_inv_pbc_s00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t11*ADD[0]) < c_denom_inv_pbc_s00_mem1*ADD_mem[0]
	S += (c_denom_inv_pbc_t11*ADD[1]) < c_denom_inv_pbc_s00_mem1*ADD_mem[1]
	S += (c_denom_inv_pbc_t11*ADD[2]) < c_denom_inv_pbc_s00_mem1*ADD_mem[2]
	S += (c_denom_inv_pbc_t11*ADD[3]) < c_denom_inv_pbc_s00_mem1*ADD_mem[3]
	...
	c_denom_inv_pbc_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t11*ADD[0]) < c_denom_inv_pbc_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t11*ADD[1]) < c_denom_inv_pbc_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t11*ADD[2]) < c_denom_inv_pbc_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t11*ADD[3]) < c_denom_inv_pbc_s01_mem0*ADD_mem[3]
	...
	c_denom_inv_pbc_s01_mem1 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t10*ADD[0]) < c_denom_inv_pbc_s01_mem1*ADD_mem[0]
	S += (c_denom_inv_pbc_t10*ADD[1]) < c_denom_inv_pbc_s01_mem1*ADD_mem[1]
	S += (c_denom_inv_pbc_t10*ADD[2]) < c_denom_inv_pbc_s01_mem1*ADD_mem[2]
	S += (c_denom_inv_pbc_t10*ADD[3]) < c_denom_inv_pbc_s01_mem1*ADD_mem[3]
	...
	S += 214 < c_denom_inv_pcb_t4_t4_mem1
	...
	c_denom_inv_pcb_t40_mem0 += alt(MUL_mem)
	S += (c_denom_inv_pcb_t4_t0*MUL[0]) < c_denom_inv_pcb_t40_mem0*MUL_mem[0]
	...
	c_denom_inv_pcb_t40_mem1 += alt(MUL_mem)
	S += (c_denom_inv_pcb_t4_t1*MUL[0]) < c_denom_inv_pcb_t40_mem1*MUL_mem[0]
	...
	c_denom_inv_pcb_t4_t5_mem1 += alt(MUL_mem)
	S += (c_denom_inv_pcb_t4_t1*MUL[0]) < c_denom_inv_pcb_t4_t5_mem1*MUL_mem[0]
	...
	c_denom_inv_pcb_s00_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t10*ADD[0]) < c_denom_inv_pcb_s00_mem0*ADD_mem[0]
	S += (c_denom_inv_pcb_t10*ADD[1]) < c_denom_inv_pcb_s00_mem0*ADD_mem[1]
	S += (c_denom_inv_pcb_t10*ADD[2]) < c_denom_inv_pcb_s00_mem0*ADD_mem[2]
	S += (c_denom_inv_pcb_t10*ADD[3]) < c_denom_inv_pcb_s00_mem0*ADD_mem[3]
	...
	c_denom_inv_pcb_s00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t11*ADD[0]) < c_denom_inv_pcb_s00_mem1*ADD_mem[0]
	S += (c_denom_inv_pcb_t11*ADD[1]) < c_denom_inv_pcb_s00_mem1*ADD_mem[1]
	S += (c_denom_inv_pcb_t11*ADD[2]) < c_denom_inv_pcb_s00_mem1*ADD_mem[2]
	S += (c_denom_inv_pcb_t11*ADD[3]) < c_denom_inv_pcb_s00_mem1*ADD_mem[3]
	...
	c_denom_inv_pcb_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t11*ADD[0]) < c_denom_inv_pcb_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_pcb_t11*ADD[1]) < c_denom_inv_pcb_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_pcb_t11*ADD[2]) < c_denom_inv_pcb_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_pcb_t11*ADD[3]) < c_denom_inv_pcb_s01_mem0*ADD_mem[3]
	...
	c_denom_inv_pcb_s01_mem1 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t10*ADD[0]) < c_denom_inv_pcb_s01_mem1*ADD_mem[0]
	S += (c_denom_inv_pcb_t10*ADD[1]) < c_denom_inv_pcb_s01_mem1*ADD_mem[1]
	S += (c_denom_inv_pcb_t10*ADD[2]) < c_denom_inv_pcb_s01_mem1*ADD_mem[2]
	S += (c_denom_inv_pcb_t10*ADD[3]) < c_denom_inv_pcb_s01_mem1*ADD_mem[3]
	...
	c_denom_inv_pcb_t50_mem1 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t10*ADD[0]) < c_denom_inv_pcb_t50_mem1*ADD_mem[0]
	S += (c_denom_inv_pcb_t10*ADD[1]) < c_denom_inv_pcb_t50_mem1*ADD_mem[1]
	S += (c_denom_inv_pcb_t10*ADD[2]) < c_denom_inv_pcb_t50_mem1*ADD_mem[2]
	S += (c_denom_inv_pcb_t10*ADD[3]) < c_denom_inv_pcb_t50_mem1*ADD_mem[3]
	...
	S += 218 < c_denom_inv_paa_t4_t4_mem1
	...
	S += 251 < c_denom_inv_paa_t50_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/INV_mul1_add4/INV_20.png"
	if(S.solution() != []):
