...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/INV_mul1_add4/INV_27.png"
	if(S.solution() != []):
