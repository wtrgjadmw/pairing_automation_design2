...
def solve():
	...
	S += 233 < c_denom_inv_bcxi_y1_0_mem0
	...
	S += 233 < c_denom_inv_bcxi_y1_1_mem1
	...
	S += (c_denom_inv_cc00*ADD[0]) < c_denom_inv_pb10_mem0*ADD_mem[0]
	S += (c_denom_inv_cc00*ADD[1]) < c_denom_inv_pb10_mem0*ADD_mem[1]
	S += (c_denom_inv_cc00*ADD[2]) < c_denom_inv_pb10_mem0*ADD_mem[2]
	S += (c_denom_inv_cc00*ADD[3]) < c_denom_inv_pb10_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_cc01*ADD[0]) < c_denom_inv_pb11_mem0*ADD_mem[0]
	S += (c_denom_inv_cc01*ADD[1]) < c_denom_inv_pb11_mem0*ADD_mem[1]
	S += (c_denom_inv_cc01*ADD[2]) < c_denom_inv_pb11_mem0*ADD_mem[2]
	S += (c_denom_inv_cc01*ADD[3]) < c_denom_inv_pb11_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb00*ADD[0]) < c_denom_inv_pbc_t0_t0_mem0*ADD_mem[0]
	S += (c_denom_inv_pb00*ADD[1]) < c_denom_inv_pbc_t0_t0_mem0*ADD_mem[1]
	S += (c_denom_inv_pb00*ADD[2]) < c_denom_inv_pbc_t0_t0_mem0*ADD_mem[2]
	S += (c_denom_inv_pb00*ADD[3]) < c_denom_inv_pbc_t0_t0_mem0*ADD_mem[3]
	...
	S += 184 < c_denom_inv_pbc_t0_t0_mem1
	...
	S += (c_denom_inv_pb01*ADD[0]) < c_denom_inv_pbc_t0_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_pb01*ADD[1]) < c_denom_inv_pbc_t0_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_pb01*ADD[2]) < c_denom_inv_pbc_t0_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_pb01*ADD[3]) < c_denom_inv_pbc_t0_t1_mem0*ADD_mem[3]
	...
	S += 178 < c_denom_inv_pbc_t0_t1_mem1
	...
	S += (c_denom_inv_pb00*ADD[0]) < c_denom_inv_pbc_t0_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_pb00*ADD[1]) < c_denom_inv_pbc_t0_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_pb00*ADD[2]) < c_denom_inv_pbc_t0_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_pb00*ADD[3]) < c_denom_inv_pbc_t0_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb01*ADD[0]) < c_denom_inv_pbc_t0_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_pb01*ADD[1]) < c_denom_inv_pbc_t0_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_pb01*ADD[2]) < c_denom_inv_pbc_t0_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_pb01*ADD[3]) < c_denom_inv_pbc_t0_t2_mem1*ADD_mem[3]
	...
	S += 186 < c_denom_inv_pcb_t1_t0_mem1
	...
	S += (c_denom_inv_pa10*ADD[0]) < c_denom_inv_paa_t1_t0_mem0*ADD_mem[0]
	S += (c_denom_inv_pa10*ADD[1]) < c_denom_inv_paa_t1_t0_mem0*ADD_mem[1]
	S += (c_denom_inv_pa10*ADD[2]) < c_denom_inv_paa_t1_t0_mem0*ADD_mem[2]
	S += (c_denom_inv_pa10*ADD[3]) < c_denom_inv_paa_t1_t0_mem0*ADD_mem[3]
	...
	S += 176 < c_denom_inv_paa_t1_t0_mem1
	...
	S += 180 < c_denom_inv_paa_t1_t1_mem1
	...
	S += (c_denom_inv_pa10*ADD[0]) < c_denom_inv_paa_t1_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_pa10*ADD[1]) < c_denom_inv_paa_t1_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_pa10*ADD[2]) < c_denom_inv_paa_t1_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_pa10*ADD[3]) < c_denom_inv_paa_t1_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pa10*ADD[0]) < c_denom_inv0_t1_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_pa10*ADD[1]) < c_denom_inv0_t1_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_pa10*ADD[2]) < c_denom_inv0_t1_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_pa10*ADD[3]) < c_denom_inv0_t1_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb00*ADD[0]) < c_denom_inv1_t0_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_pb00*ADD[1]) < c_denom_inv1_t0_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_pb00*ADD[2]) < c_denom_inv1_t0_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_pb00*ADD[3]) < c_denom_inv1_t0_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb01*ADD[0]) < c_denom_inv1_t0_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_pb01*ADD[1]) < c_denom_inv1_t0_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_pb01*ADD[2]) < c_denom_inv1_t0_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_pb01*ADD[3]) < c_denom_inv1_t0_t2_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_aa00*ADD[0]) < c_denom_inv_pa00_mem0*ADD_mem[0]
	S += (c_denom_inv_aa00*ADD[1]) < c_denom_inv_pa00_mem0*ADD_mem[1]
	S += (c_denom_inv_aa00*ADD[2]) < c_denom_inv_pa00_mem0*ADD_mem[2]
	S += (c_denom_inv_aa00*ADD[3]) < c_denom_inv_pa00_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_bcxi_y1_0*ADD[0]) < c_denom_inv_pa00_mem1*ADD_mem[0]
	S += (c_denom_inv_bcxi_y1_0*ADD[1]) < c_denom_inv_pa00_mem1*ADD_mem[1]
	S += (c_denom_inv_bcxi_y1_0*ADD[2]) < c_denom_inv_pa00_mem1*ADD_mem[2]
	S += (c_denom_inv_bcxi_y1_0*ADD[3]) < c_denom_inv_pa00_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_aa01*ADD[0]) < c_denom_inv_pa01_mem0*ADD_mem[0]
	S += (c_denom_inv_aa01*ADD[1]) < c_denom_inv_pa01_mem0*ADD_mem[1]
	S += (c_denom_inv_aa01*ADD[2]) < c_denom_inv_pa01_mem0*ADD_mem[2]
	S += (c_denom_inv_aa01*ADD[3]) < c_denom_inv_pa01_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_bcxi_y1_1*ADD[0]) < c_denom_inv_pa01_mem1*ADD_mem[0]
	S += (c_denom_inv_bcxi_y1_1*ADD[1]) < c_denom_inv_pa01_mem1*ADD_mem[1]
	S += (c_denom_inv_bcxi_y1_1*ADD[2]) < c_denom_inv_pa01_mem1*ADD_mem[2]
	S += (c_denom_inv_bcxi_y1_1*ADD[3]) < c_denom_inv_pa01_mem1*ADD_mem[3]
	...
	S += 193 < c_denom_inv_pbc_t0_t4_mem1
	...
	S += 179 < c_denom_inv_pbc_t1_t0_mem1
	...
	S += 185 < c_denom_inv_pbc_t1_t1_mem1
	...
	S += (c_denom_inv_pb00*ADD[0]) < c_denom_inv_pbc_t20_mem0*ADD_mem[0]
	S += (c_denom_inv_pb00*ADD[1]) < c_denom_inv_pbc_t20_mem0*ADD_mem[1]
	S += (c_denom_inv_pb00*ADD[2]) < c_denom_inv_pbc_t20_mem0*ADD_mem[2]
	S += (c_denom_inv_pb00*ADD[3]) < c_denom_inv_pbc_t20_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb10*ADD[0]) < c_denom_inv_pbc_t20_mem1*ADD_mem[0]
	S += (c_denom_inv_pb10*ADD[1]) < c_denom_inv_pbc_t20_mem1*ADD_mem[1]
	S += (c_denom_inv_pb10*ADD[2]) < c_denom_inv_pbc_t20_mem1*ADD_mem[2]
	S += (c_denom_inv_pb10*ADD[3]) < c_denom_inv_pbc_t20_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_pb01*ADD[0]) < c_denom_inv_pbc_t21_mem0*ADD_mem[0]
	S += (c_denom_inv_pb01*ADD[1]) < c_denom_inv_pbc_t21_mem0*ADD_mem[1]
	S += (c_denom_inv_pb01*ADD[2]) < c_denom_inv_pbc_t21_mem0*ADD_mem[2]
	S += (c_denom_inv_pb01*ADD[3]) < c_denom_inv_pbc_t21_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb11*ADD[0]) < c_denom_inv_pbc_t21_mem1*ADD_mem[0]
	S += (c_denom_inv_pb11*ADD[1]) < c_denom_inv_pbc_t21_mem1*ADD_mem[1]
	S += (c_denom_inv_pb11*ADD[2]) < c_denom_inv_pbc_t21_mem1*ADD_mem[2]
	S += (c_denom_inv_pb11*ADD[3]) < c_denom_inv_pbc_t21_mem1*ADD_mem[3]
	...
	S += 183 < c_denom_inv_pcb_t1_t1_mem1
	...
	S += (c_denom_inv_paa_t1_t2*ADD[0]) < c_denom_inv_paa_t1_t4_mem0*ADD_mem[0]
	S += (c_denom_inv_paa_t1_t2*ADD[1]) < c_denom_inv_paa_t1_t4_mem0*ADD_mem[1]
	S += (c_denom_inv_paa_t1_t2*ADD[2]) < c_denom_inv_paa_t1_t4_mem0*ADD_mem[2]
	S += (c_denom_inv_paa_t1_t2*ADD[3]) < c_denom_inv_paa_t1_t4_mem0*ADD_mem[3]
	...
	S += 192 < c_denom_inv_paa_t1_t4_mem1
	...
	S += (c_denom_inv_paa_t1_t0*MUL[0]) < c_denom_inv_paa_t10_mem0*MUL_mem[0]
	...
	S += (c_denom_inv_paa_t1_t1*MUL[0]) < c_denom_inv_paa_t10_mem1*MUL_mem[0]
	...
	S += (c_denom_inv_paa_t1_t0*MUL[0]) < c_denom_inv_paa_t1_t5_mem0*MUL_mem[0]
	...
	S += (c_denom_inv_paa_t1_t1*MUL[0]) < c_denom_inv_paa_t1_t5_mem1*MUL_mem[0]
	...
	S += (c_denom_inv_pb00*ADD[0]) < c_denom_inv1_t20_mem0*ADD_mem[0]
	S += (c_denom_inv_pb00*ADD[1]) < c_denom_inv1_t20_mem0*ADD_mem[1]
	S += (c_denom_inv_pb00*ADD[2]) < c_denom_inv1_t20_mem0*ADD_mem[2]
	S += (c_denom_inv_pb00*ADD[3]) < c_denom_inv1_t20_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb10*ADD[0]) < c_denom_inv1_t20_mem1*ADD_mem[0]
	S += (c_denom_inv_pb10*ADD[1]) < c_denom_inv1_t20_mem1*ADD_mem[1]
	S += (c_denom_inv_pb10*ADD[2]) < c_denom_inv1_t20_mem1*ADD_mem[2]
	S += (c_denom_inv_pb10*ADD[3]) < c_denom_inv1_t20_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_pb01*ADD[0]) < c_denom_inv1_t21_mem0*ADD_mem[0]
	S += (c_denom_inv_pb01*ADD[1]) < c_denom_inv1_t21_mem0*ADD_mem[1]
	S += (c_denom_inv_pb01*ADD[2]) < c_denom_inv1_t21_mem0*ADD_mem[2]
	S += (c_denom_inv_pb01*ADD[3]) < c_denom_inv1_t21_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pb11*ADD[0]) < c_denom_inv1_t21_mem1*ADD_mem[0]
	S += (c_denom_inv_pb11*ADD[1]) < c_denom_inv1_t21_mem1*ADD_mem[1]
	S += (c_denom_inv_pb11*ADD[2]) < c_denom_inv1_t21_mem1*ADD_mem[2]
	S += (c_denom_inv_pb11*ADD[3]) < c_denom_inv1_t21_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/INV_mul1_add4/INV_19.png"
	if(S.solution() != []):
