...
def solve():
	...
	S += (new_TX_t0_t3*ADD[0]) < new_TX_t0_t4_mem1*ADD_mem[0]
	S += (new_TX_t0_t3*ADD[1]) < new_TX_t0_t4_mem1*ADD_mem[1]
	S += (new_TX_t0_t3*ADD[2]) < new_TX_t0_t4_mem1*ADD_mem[2]
	S += (new_TX_t0_t3*ADD[3]) < new_TX_t0_t4_mem1*ADD_mem[3]
	...
	S += (new_TX_t0_t1*MUL[0]) < new_TX_t0_t5_mem1*MUL_mem[0]
	...
	S += (t1111*ADD[0]) < new_TX_t1_t3_mem1*ADD_mem[0]
	S += (t1111*ADD[1]) < new_TX_t1_t3_mem1*ADD_mem[1]
	S += (t1111*ADD[2]) < new_TX_t1_t3_mem1*ADD_mem[2]
	S += (t1111*ADD[3]) < new_TX_t1_t3_mem1*ADD_mem[3]
	...
	S += 121 < t13_t0_t3_mem0
	S += t13_t0_t3_mem0 <= t13_t0_t3

	t13_t0_t3_mem1 = S.Task('t13_t0_t3_mem1', length=1, delay_cost=1)
	t13_t0_t3_mem1 += alt(ADD_mem)
	S += (t1201*ADD[0]) < t13_t0_t3_mem1*ADD_mem[0]
	S += (t1201*ADD[1]) < t13_t0_t3_mem1*ADD_mem[1]
	S += (t1201*ADD[2]) < t13_t0_t3_mem1*ADD_mem[2]
	S += (t1201*ADD[3]) < t13_t0_t3_mem1*ADD_mem[3]
	...
	S += (t14_t1_t4*MUL[0]) < t14_t11_mem0*MUL_mem[0]
	S += t14_t11_mem0 <= t14_t11

	t14_t11_mem1 = S.Task('t14_t11_mem1', length=1, delay_cost=1)
	t14_t11_mem1 += alt(ADD_mem)
	S += (t14_t1_t5*ADD[0]) < t14_t11_mem1*ADD_mem[0]
	S += (t14_t1_t5*ADD[1]) < t14_t11_mem1*ADD_mem[1]
	S += (t14_t1_t5*ADD[2]) < t14_t11_mem1*ADD_mem[2]
	S += (t14_t1_t5*ADD[3]) < t14_t11_mem1*ADD_mem[3]
	...
	S += (t14_t4_t3*ADD[0]) < t14_t4_t4_mem1*ADD_mem[0]
	S += (t14_t4_t3*ADD[1]) < t14_t4_t4_mem1*ADD_mem[1]
	S += (t14_t4_t3*ADD[2]) < t14_t4_t4_mem1*ADD_mem[2]
	S += (t14_t4_t3*ADD[3]) < t14_t4_t4_mem1*ADD_mem[3]
	...
	S += (t14_t4_t1*MUL[0]) < t14_t40_mem1*MUL_mem[0]
	...
	S += (new_TZ_t1_t4*MUL[0]) < new_TZ_t11_mem0*MUL_mem[0]
	S += new_TZ_t11_mem0 <= new_TZ_t11

	new_TZ_t11_mem1 = S.Task('new_TZ_t11_mem1', length=1, delay_cost=1)
	new_TZ_t11_mem1 += alt(ADD_mem)
	S += (new_TZ_t1_t5*ADD[0]) < new_TZ_t11_mem1*ADD_mem[0]
	S += (new_TZ_t1_t5*ADD[1]) < new_TZ_t11_mem1*ADD_mem[1]
	S += (new_TZ_t1_t5*ADD[2]) < new_TZ_t11_mem1*ADD_mem[2]
	S += (new_TZ_t1_t5*ADD[3]) < new_TZ_t11_mem1*ADD_mem[3]
	...
	S += (new_TZ_t4_t3*ADD[0]) < new_TZ_t4_t4_mem1*ADD_mem[0]
	S += (new_TZ_t4_t3*ADD[1]) < new_TZ_t4_t4_mem1*ADD_mem[1]
	S += (new_TZ_t4_t3*ADD[2]) < new_TZ_t4_t4_mem1*ADD_mem[2]
	S += (new_TZ_t4_t3*ADD[3]) < new_TZ_t4_t4_mem1*ADD_mem[3]
	...
	S += (new_TZ_t4_t1*MUL[0]) < new_TZ_t4_t5_mem1*MUL_mem[0]
	...
	S += (t13_t0_t1*MUL[0]) < t13_t0_t5_mem1*MUL_mem[0]
	...
	S += (t1211*ADD[0]) < t13_t1_t3_mem1*ADD_mem[0]
	S += (t1211*ADD[1]) < t13_t1_t3_mem1*ADD_mem[1]
	S += (t1211*ADD[2]) < t13_t1_t3_mem1*ADD_mem[2]
	S += (t1211*ADD[3]) < t13_t1_t3_mem1*ADD_mem[3]
	...
	S += (t13_t30*ADD[0]) < t13_t4_t0_mem1*ADD_mem[0]
	S += (t13_t30*ADD[1]) < t13_t4_t0_mem1*ADD_mem[1]
	S += (t13_t30*ADD[2]) < t13_t4_t0_mem1*ADD_mem[2]
	S += (t13_t30*ADD[3]) < t13_t4_t0_mem1*ADD_mem[3]
	...
	S += (t14_t10*ADD[0]) < t14_s00_mem0*ADD_mem[0]
	S += (t14_t10*ADD[1]) < t14_s00_mem0*ADD_mem[1]
	S += (t14_t10*ADD[2]) < t14_s00_mem0*ADD_mem[2]
	S += (t14_t10*ADD[3]) < t14_s00_mem0*ADD_mem[3]
	S += t14_s00_mem0 <= t14_s00

	t14_s00_mem1 = S.Task('t14_s00_mem1', length=1, delay_cost=1)
	t14_s00_mem1 += alt(ADD_mem)
	S += (t14_t11*ADD[0]) < t14_s00_mem1*ADD_mem[0]
	S += (t14_t11*ADD[1]) < t14_s00_mem1*ADD_mem[1]
	S += (t14_t11*ADD[2]) < t14_s00_mem1*ADD_mem[2]
	S += (t14_t11*ADD[3]) < t14_s00_mem1*ADD_mem[3]
	...
	S += (t14_t11*ADD[0]) < t14_s01_mem0*ADD_mem[0]
	S += (t14_t11*ADD[1]) < t14_s01_mem0*ADD_mem[1]
	S += (t14_t11*ADD[2]) < t14_s01_mem0*ADD_mem[2]
	S += (t14_t11*ADD[3]) < t14_s01_mem0*ADD_mem[3]
	S += t14_s01_mem0 <= t14_s01

	t14_s01_mem1 = S.Task('t14_s01_mem1', length=1, delay_cost=1)
	t14_s01_mem1 += alt(ADD_mem)
	S += (t14_t10*ADD[0]) < t14_s01_mem1*ADD_mem[0]
	S += (t14_t10*ADD[1]) < t14_s01_mem1*ADD_mem[1]
	S += (t14_t10*ADD[2]) < t14_s01_mem1*ADD_mem[2]
	S += (t14_t10*ADD[3]) < t14_s01_mem1*ADD_mem[3]
	...
	S += (t14_t01*ADD[0]) < t14_t51_mem0*ADD_mem[0]
	S += (t14_t01*ADD[1]) < t14_t51_mem0*ADD_mem[1]
	S += (t14_t01*ADD[2]) < t14_t51_mem0*ADD_mem[2]
	S += (t14_t01*ADD[3]) < t14_t51_mem0*ADD_mem[3]
	...
	S += (new_TZ_t10*ADD[0]) < new_TZ_s00_mem0*ADD_mem[0]
	S += (new_TZ_t10*ADD[1]) < new_TZ_s00_mem0*ADD_mem[1]
	S += (new_TZ_t10*ADD[2]) < new_TZ_s00_mem0*ADD_mem[2]
	S += (new_TZ_t10*ADD[3]) < new_TZ_s00_mem0*ADD_mem[3]
	S += new_TZ_s00_mem0 <= new_TZ_s00

	new_TZ_s00_mem1 = S.Task('new_TZ_s00_mem1', length=1, delay_cost=1)
	new_TZ_s00_mem1 += alt(ADD_mem)
	S += (new_TZ_t11*ADD[0]) < new_TZ_s00_mem1*ADD_mem[0]
	S += (new_TZ_t11*ADD[1]) < new_TZ_s00_mem1*ADD_mem[1]
	S += (new_TZ_t11*ADD[2]) < new_TZ_s00_mem1*ADD_mem[2]
	S += (new_TZ_t11*ADD[3]) < new_TZ_s00_mem1*ADD_mem[3]
	...
	S += (new_TZ_t11*ADD[0]) < new_TZ_s01_mem0*ADD_mem[0]
	S += (new_TZ_t11*ADD[1]) < new_TZ_s01_mem0*ADD_mem[1]
	S += (new_TZ_t11*ADD[2]) < new_TZ_s01_mem0*ADD_mem[2]
	S += (new_TZ_t11*ADD[3]) < new_TZ_s01_mem0*ADD_mem[3]
	S += new_TZ_s01_mem0 <= new_TZ_s01

	new_TZ_s01_mem1 = S.Task('new_TZ_s01_mem1', length=1, delay_cost=1)
	new_TZ_s01_mem1 += alt(ADD_mem)
	S += (new_TZ_t10*ADD[0]) < new_TZ_s01_mem1*ADD_mem[0]
	S += (new_TZ_t10*ADD[1]) < new_TZ_s01_mem1*ADD_mem[1]
	S += (new_TZ_t10*ADD[2]) < new_TZ_s01_mem1*ADD_mem[2]
	S += (new_TZ_t10*ADD[3]) < new_TZ_s01_mem1*ADD_mem[3]
	...
	S += (new_TZ_t01*ADD[0]) < new_TZ_t51_mem0*ADD_mem[0]
	S += (new_TZ_t01*ADD[1]) < new_TZ_t51_mem0*ADD_mem[1]
	S += (new_TZ_t01*ADD[2]) < new_TZ_t51_mem0*ADD_mem[2]
	S += (new_TZ_t01*ADD[3]) < new_TZ_t51_mem0*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/PADD_mul1_add4/PADD_8.png"
	if(S.solution() != []):
