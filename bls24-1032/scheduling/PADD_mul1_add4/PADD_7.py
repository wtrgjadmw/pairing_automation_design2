...
def solve():
	...
	S += 114 < t14_t0_t3_mem0
	S += t14_t0_t3_mem0 <= t14_t0_t3

	t14_t0_t3_mem1 = S.Task('t14_t0_t3_mem1', length=1, delay_cost=1)
	t14_t0_t3_mem1 += alt(ADD_mem)
	S += (t601*ADD[0]) < t14_t0_t3_mem1*ADD_mem[0]
	S += (t601*ADD[1]) < t14_t0_t3_mem1*ADD_mem[1]
	S += (t601*ADD[2]) < t14_t0_t3_mem1*ADD_mem[2]
	S += (t601*ADD[3]) < t14_t0_t3_mem1*ADD_mem[3]
	...
	S += (t601*ADD[0]) < new_TZ_t0_t3_mem1*ADD_mem[0]
	S += (t601*ADD[1]) < new_TZ_t0_t3_mem1*ADD_mem[1]
	S += (t601*ADD[2]) < new_TZ_t0_t3_mem1*ADD_mem[2]
	S += (t601*ADD[3]) < new_TZ_t0_t3_mem1*ADD_mem[3]
	...
	S += (t14_t0_t1*MUL[0]) < t14_t0_t5_mem1*MUL_mem[0]
	...
	S += (t611*ADD[0]) < t14_t1_t3_mem1*ADD_mem[0]
	S += (t611*ADD[1]) < t14_t1_t3_mem1*ADD_mem[1]
	S += (t611*ADD[2]) < t14_t1_t3_mem1*ADD_mem[2]
	S += (t611*ADD[3]) < t14_t1_t3_mem1*ADD_mem[3]
	...
	S += (new_TZ_t0_t1*MUL[0]) < new_TZ_t0_t5_mem1*MUL_mem[0]
	...
	S += (t611*ADD[0]) < new_TZ_t1_t3_mem1*ADD_mem[0]
	S += (t611*ADD[1]) < new_TZ_t1_t3_mem1*ADD_mem[1]
	S += (t611*ADD[2]) < new_TZ_t1_t3_mem1*ADD_mem[2]
	S += (t611*ADD[3]) < new_TZ_t1_t3_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/PADD_mul1_add4/PADD_7.png"
	if(S.solution() != []):
