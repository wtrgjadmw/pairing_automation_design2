...
def solve():
	...
	S += (t1600*ADD[0]) < c1100_mem0*ADD_mem[0]
	S += (t1600*ADD[1]) < c1100_mem0*ADD_mem[1]
	S += (t1600*ADD[2]) < c1100_mem0*ADD_mem[2]
	S += (t1600*ADD[3]) < c1100_mem0*ADD_mem[3]
	S += c1100_mem0 <= c1100

	c1100_mem1 = S.Task('c1100_mem1', length=1, delay_cost=1)
	c1100_mem1 += alt(ADD_mem)
	S += (t1700*ADD[0]) < c1100_mem1*ADD_mem[0]
	S += (t1700*ADD[1]) < c1100_mem1*ADD_mem[1]
	S += (t1700*ADD[2]) < c1100_mem1*ADD_mem[2]
	S += (t1700*ADD[3]) < c1100_mem1*ADD_mem[3]
	S += c1100_mem1 <= c1100
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/PADD_mul1_add4/PADD_5.png"
	if(S.solution() != []):
