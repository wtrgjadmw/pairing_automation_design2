...
def solve():
	...
	S += (t9_t2_t1*MUL[0]) < t9_t20_mem1*MUL_mem[0]
	...
	S += (t9_t2_t1*MUL[0]) < t9_t2_t5_mem1*MUL_mem[0]
	...
	S += (t9_t31*ADD[0]) < t9_t40_mem1*ADD_mem[0]
	S += (t9_t31*ADD[1]) < t9_t40_mem1*ADD_mem[1]
	S += (t9_t31*ADD[2]) < t9_t40_mem1*ADD_mem[2]
	S += (t9_t31*ADD[3]) < t9_t40_mem1*ADD_mem[3]
	...
	S += (t9_t31*ADD[0]) < t9_t41_mem0*ADD_mem[0]
	S += (t9_t31*ADD[1]) < t9_t41_mem0*ADD_mem[1]
	S += (t9_t31*ADD[2]) < t9_t41_mem0*ADD_mem[2]
	S += (t9_t31*ADD[3]) < t9_t41_mem0*ADD_mem[3]
	...
	S += (t9_t31*ADD[0]) < t911_mem0*ADD_mem[0]
	S += (t9_t31*ADD[1]) < t911_mem0*ADD_mem[1]
	S += (t9_t31*ADD[2]) < t911_mem0*ADD_mem[2]
	S += (t9_t31*ADD[3]) < t911_mem0*ADD_mem[3]
	S += t911_mem0 <= t911
	...
	S += (t10_t2_t1*MUL[0]) < t10_t20_mem1*MUL_mem[0]
	...
	S += (t10_t2_t1*MUL[0]) < t10_t2_t5_mem1*MUL_mem[0]
	...
	S += (t10_t31*ADD[0]) < t10_t40_mem1*ADD_mem[0]
	S += (t10_t31*ADD[1]) < t10_t40_mem1*ADD_mem[1]
	S += (t10_t31*ADD[2]) < t10_t40_mem1*ADD_mem[2]
	S += (t10_t31*ADD[3]) < t10_t40_mem1*ADD_mem[3]
	...
	S += (t10_t31*ADD[0]) < t10_t41_mem0*ADD_mem[0]
	S += (t10_t31*ADD[1]) < t10_t41_mem0*ADD_mem[1]
	S += (t10_t31*ADD[2]) < t10_t41_mem0*ADD_mem[2]
	S += (t10_t31*ADD[3]) < t10_t41_mem0*ADD_mem[3]
	...
	S += (t10_t31*ADD[0]) < t1011_mem0*ADD_mem[0]
	S += (t10_t31*ADD[1]) < t1011_mem0*ADD_mem[1]
	S += (t10_t31*ADD[2]) < t1011_mem0*ADD_mem[2]
	S += (t10_t31*ADD[3]) < t1011_mem0*ADD_mem[3]
	S += t1011_mem0 <= t1011
	...
	S += (t301*ADD[0]) < t1101_mem0*ADD_mem[0]
	S += (t301*ADD[1]) < t1101_mem0*ADD_mem[1]
	S += (t301*ADD[2]) < t1101_mem0*ADD_mem[2]
	S += (t301*ADD[3]) < t1101_mem0*ADD_mem[3]
	S += t1101_mem0 <= t1101
	...
	S += (t311*ADD[0]) < t1111_mem0*ADD_mem[0]
	S += (t311*ADD[1]) < t1111_mem0*ADD_mem[1]
	S += (t311*ADD[2]) < t1111_mem0*ADD_mem[2]
	S += (t311*ADD[3]) < t1111_mem0*ADD_mem[3]
	S += t1111_mem0 <= t1111
	...
	S += (t1511*ADD[0]) < t1611_mem0*ADD_mem[0]
	S += (t1511*ADD[1]) < t1611_mem0*ADD_mem[1]
	S += (t1511*ADD[2]) < t1611_mem0*ADD_mem[2]
	S += (t1511*ADD[3]) < t1611_mem0*ADD_mem[3]
	S += t1611_mem0 <= t1611
	...
	S += (t910*ADD[0]) < t1710_mem0*ADD_mem[0]
	S += (t910*ADD[1]) < t1710_mem0*ADD_mem[1]
	S += (t910*ADD[2]) < t1710_mem0*ADD_mem[2]
	S += (t910*ADD[3]) < t1710_mem0*ADD_mem[3]
	S += t1710_mem0 <= t1710

	t1710_mem1 = S.Task('t1710_mem1', length=1, delay_cost=1)
	t1710_mem1 += alt(ADD_mem)
	S += (t1610*ADD[0]) < t1710_mem1*ADD_mem[0]
	S += (t1610*ADD[1]) < t1710_mem1*ADD_mem[1]
	S += (t1610*ADD[2]) < t1710_mem1*ADD_mem[2]
	S += (t1610*ADD[3]) < t1710_mem1*ADD_mem[3]
	S += t1710_mem1 <= t1710
	...
	S += (t601*ADD[0]) < t2201_mem0*ADD_mem[0]
	S += (t601*ADD[1]) < t2201_mem0*ADD_mem[1]
	S += (t601*ADD[2]) < t2201_mem0*ADD_mem[2]
	S += (t601*ADD[3]) < t2201_mem0*ADD_mem[3]
	S += t2201_mem0 <= t2201
	...
	S += (t611*ADD[0]) < t2211_mem0*ADD_mem[0]
	S += (t611*ADD[1]) < t2211_mem0*ADD_mem[1]
	S += (t611*ADD[2]) < t2211_mem0*ADD_mem[2]
	S += (t611*ADD[3]) < t2211_mem0*ADD_mem[3]
	S += t2211_mem0 <= t2211
	...
	S += (t2210*ADD[0]) < t2310_mem0*ADD_mem[0]
	S += (t2210*ADD[1]) < t2310_mem0*ADD_mem[1]
	S += (t2210*ADD[2]) < t2310_mem0*ADD_mem[2]
	S += (t2210*ADD[3]) < t2310_mem0*ADD_mem[3]
	S += t2310_mem0 <= t2310
	...
	S += (t701*ADD[0]) < t2601_mem0*ADD_mem[0]
	S += (t701*ADD[1]) < t2601_mem0*ADD_mem[1]
	S += (t701*ADD[2]) < t2601_mem0*ADD_mem[2]
	S += (t701*ADD[3]) < t2601_mem0*ADD_mem[3]
	S += t2601_mem0 <= t2601
	...
	S += (t711*ADD[0]) < t2611_mem0*ADD_mem[0]
	S += (t711*ADD[1]) < t2611_mem0*ADD_mem[1]
	S += (t711*ADD[2]) < t2611_mem0*ADD_mem[2]
	S += (t711*ADD[3]) < t2611_mem0*ADD_mem[3]
	S += t2611_mem0 <= t2611
	...
	S += (t2610*ADD[0]) < t2710_mem0*ADD_mem[0]
	S += (t2610*ADD[1]) < t2710_mem0*ADD_mem[1]
	S += (t2610*ADD[2]) < t2710_mem0*ADD_mem[2]
	S += (t2610*ADD[3]) < t2710_mem0*ADD_mem[3]
	S += t2710_mem0 <= t2710
	...
	S += (t501*ADD[0]) < t2901_mem0*ADD_mem[0]
	S += (t501*ADD[1]) < t2901_mem0*ADD_mem[1]
	S += (t501*ADD[2]) < t2901_mem0*ADD_mem[2]
	S += (t501*ADD[3]) < t2901_mem0*ADD_mem[3]
	S += t2901_mem0 <= t2901
	...
	S += (t511*ADD[0]) < t2911_mem0*ADD_mem[0]
	S += (t511*ADD[1]) < t2911_mem0*ADD_mem[1]
	S += (t511*ADD[2]) < t2911_mem0*ADD_mem[2]
	S += (t511*ADD[3]) < t2911_mem0*ADD_mem[3]
	S += t2911_mem0 <= t2911
	...
	S += (t2910*ADD[0]) < t3010_mem0*ADD_mem[0]
	S += (t2910*ADD[1]) < t3010_mem0*ADD_mem[1]
	S += (t2910*ADD[2]) < t3010_mem0*ADD_mem[2]
	S += (t2910*ADD[3]) < t3010_mem0*ADD_mem[3]
	S += t3010_mem0 <= t3010
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/SQR012345_mul1_add4/SQR012345_6.png"
	if(S.solution() != []):
