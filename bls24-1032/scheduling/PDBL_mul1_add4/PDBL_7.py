...
def solve():
	...
	S += t17_t0_t2_mem0 >= 105
	t17_t0_t2_mem0 += ADD_mem[2]

	t17_t0_t2_mem1 = S.Task('t17_t0_t2_mem1', length=1, delay_cost=1)
	S += t17_t0_t2_mem1 >= 105
	...
	t17_t4_t0_mem0 += ADD_mem[3]
	S += 106 < t17_t4_t0_mem0
	...
	t17_t4_t2_mem0 += ADD_mem[3]
	S += 106 < t17_t4_t2_mem0
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-1032/scheduling/PDBL_mul1_add4/PDBL_7.png"
	if(S.solution() != []):
