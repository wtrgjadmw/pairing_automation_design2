...
96: begin
	...
	add1_opr1 <= add2_out_reg; add1_opr2 <= ram_input_out1; issub1 <= 0;
	add0_opr1 <= ram_add1_out1; add0_opr2 <= ram_add1_out1; issub0 <= 0;
...
101: begin
	...
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_add3_out1; issub3 <= 0;
	add1_opr1 <= add2_out_reg; add1_opr2 <= ram_input_out2; issub1 <= 0;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 0;
	ram_add1_wr_n <= 1;
	ram_add0_wr_n <= 0;
...
104: begin
	...
	add0_opr1 <= ram_add0_out2; add0_opr2 <= ram_input_out1; issub0 <= 0;
	ram_add1_wr_n <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_add0_wr_n <= 0;
...
110: begin
	...
	add3_opr1 <= ram_add2_out1; add3_opr2 <= ram_input_out1; issub3 <= 1;
