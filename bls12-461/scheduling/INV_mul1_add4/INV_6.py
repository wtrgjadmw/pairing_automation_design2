...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls12-461/scheduling/INV_mul1_add4/INV_6.png"
	if(S.solution() != []):
