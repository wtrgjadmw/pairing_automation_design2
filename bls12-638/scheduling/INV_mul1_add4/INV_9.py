...
def solve():
	...
	c_qinv_denom_inv_bb_mem0 += ADD_mem[3]
	...
	c_qinv_denom_inv_aa_mem0 += ADD_mem[2]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls12-638/scheduling/INV_mul1_add4/INV_9.png"
	if(S.solution() != []):
