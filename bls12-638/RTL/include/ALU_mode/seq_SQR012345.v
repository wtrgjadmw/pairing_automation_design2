...
20: begin
	...
	add1_opr1 <= ram_mm0_out1; add1_opr2 <= ram_mm0_out1; issub1 <= 1;
...
27: begin
	mm0_opr1 <= add0_out; mm0_opr2 <= add2_out; 
...
28: begin
	add1_opr1 <= add0_out_reg; add1_opr2 <= add2_out_reg; issub1 <= 1;
...
29: begin
	mm0_opr1 <= add1_out; mm0_opr2 <= add2_out; 
...
30: begin
	...
	add2_opr1 <= add3_out; add2_opr2 <= add3_out_reg; issub2 <= 0;
...
40: begin
	...
	add0_opr1 <= add3_out; add0_opr2 <= ram_input_out1; issub0 <= 1;
...
41: begin
	...
	add3_opr1 <= ram_input_out1; add3_opr2 <= add1_out; issub3 <= 0;
	w1_n_reg <= 0;
