...
writeCommands(10, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_E});
writeCommands(11, {`MODE_SQR012345, `RAM_E, `RAM_C, `RAM_C});
...
writeCommands(99, {`MODE_MUL, `RAM_E, `RAM_C, `RAM_E});
...
writeCommands(112, {`MODE_MUL, `RAM_E, `RAM_C, `RAM_E});
writeCommands(113, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(114, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(115, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
writeCommands(116, {`MODE_MUL_CONJ, `RAM_E, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(t2, t1)
// t4 = expFp12(t1)
writeCommands(117, {`MODE_SQR012345, `RAM_G, `RAM_C, `RAM_C});
...
writeCommands(121, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
writeCommands(122, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(210, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(223, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
writeCommands(224, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(225, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(226, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(227, {`MODE_MUL_CONJ, `RAM_F, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(f, t1) 
// t5 = expFp12(t4)
writeCommands(228, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(232, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_A});
writeCommands(233, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(321, {`MODE_MUL, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(334, {`MODE_MUL, `RAM_A, `RAM_C, `RAM_A});
writeCommands(335, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(336, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(337, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
writeCommands(338, {`MODE_MUL, `RAM_F, `RAM_B, `RAM_B}); // t4 = mulFp12(f, t4)
// t3 = expFp12(t5)
writeCommands(339, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(343, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_D});
writeCommands(344, {`MODE_SQR012345, `RAM_D, `RAM_C, `RAM_C});
...
writeCommands(432, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(445, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
writeCommands(446, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(447, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(448, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(449, {`MODE_MUL, `RAM_E, `RAM_A, `RAM_A}); // t5 = mulFp12(t2, t5)
writeCommands(450, {`MODE_SQR012345, `RAM_E, `RAM_E, `RAM_E}); // t2 = SQR012345Fp12(t2)
writeCommands(451, {`MODE_FROB, `RAM_B, `RAM_E, `RAM_B}); // t4 = FrobFp12(FrobFp12(t4))
writeCommands(452, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B});
writeCommands(453, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(FrobFp12(t5))
writeCommands(454, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A});
writeCommands(455, {`MODE_MUL, `RAM_E, `RAM_D, `RAM_E}); //t2 = mulFp12(t2, t3)
writeCommands(456, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B}); // t4 = FrobFp12(t4)
// t3 = expFp12(t2)
writeCommands(457, {`MODE_SQR012345, `RAM_E, `RAM_C, `RAM_C});
...
writeCommands(461, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_D});
writeCommands(462, {`MODE_SQR012345, `RAM_D, `RAM_C, `RAM_C});
...
writeCommands(550, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(563, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
writeCommands(564, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(565, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(566, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(567, {`MODE_MUL, `RAM_B, `RAM_A, `RAM_B}); // t4 = mulFp12(t4, t5)
writeCommands(568, {`MODE_MUL_CONJ, `RAM_E, `RAM_F, `RAM_A}); // t5 = mulFp12_conj_forRTL(t2, f)
writeCommands(569, {`MODE_MUL, `RAM_G, `RAM_D, `RAM_G}); // t1 = mulFp12(t1, t3)
writeCommands(570, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(t5)
writeCommands(571, {`MODE_MUL, `RAM_G, `RAM_B, `RAM_G}); // t1 = mulFp12(t1, t4)
writeCommands(572, {`MODE_MUL, `RAM_G, `RAM_A, `RAM_G}); // t1 = mulFp12(t1, t3)
