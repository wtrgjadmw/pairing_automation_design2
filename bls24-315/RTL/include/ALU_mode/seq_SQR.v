...
72: begin
	add3_opr1 <= add3_out; add3_opr2 <= add2_out_reg; issub3 <= 0;
...
85: begin
	add0_opr1 <= ram_add3_out1; add0_opr2 <= ram_input_out1; issub0 <= 0;
	add3_opr1 <= ram_add2_out1; add3_opr2 <= ram_mm0_out1; issub3 <= 0;
...
101: begin
	add2_opr1 <= ram_input_out1; add2_opr2 <= add1_out; issub2 <= 0;
...
192: begin
	add2_opr1 <= add3_out_reg; add2_opr2 <= add0_out; issub2 <= 1;
...
193: begin
	add3_opr1 <= add1_out_reg; add3_opr2 <= add3_out; issub3 <= 1;
	add2_opr1 <= ram_add1_out1; add2_opr2 <= ram_add1_out1; issub2 <= 0;
...
195: begin
	add2_opr1 <= add2_out; add2_opr2 <= add0_out_reg; issub2 <= 1;
	add1_opr1 <= add1_out; add1_opr2 <= add1_out; issub1 <= 0;
	add3_opr1 <= ram_add3_out1; add3_opr2 <= ram_add0_out1; issub3 <= 0;
