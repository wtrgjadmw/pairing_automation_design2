...
def solve():
	...
	S += (t5_t8_s0_y1_0*ADD[0]) < t5_t8_s0_y1_1_mem0*ADD_mem[0]
	S += (t5_t8_s0_y1_0*ADD[1]) < t5_t8_s0_y1_1_mem0*ADD_mem[1]
	S += (t5_t8_s0_y1_0*ADD[2]) < t5_t8_s0_y1_1_mem0*ADD_mem[2]
	S += (t5_t8_s0_y1_0*ADD[3]) < t5_t8_s0_y1_1_mem0*ADD_mem[3]
	...
	S += (t5_t8_t51*ADD[0]) < t5_t811_mem1*ADD_mem[0]
	S += (t5_t8_t51*ADD[1]) < t5_t811_mem1*ADD_mem[1]
	S += (t5_t8_t51*ADD[2]) < t5_t811_mem1*ADD_mem[2]
	S += (t5_t8_t51*ADD[3]) < t5_t811_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/SPARSE_mul1_add4/SPARSE_11.png"
	if(S.solution() != []):
