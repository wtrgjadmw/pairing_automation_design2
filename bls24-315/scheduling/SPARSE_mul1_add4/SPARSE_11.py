...
def solve():
	...
	S += 144 < t5_t8_t51_mem0
	S += t5_t8_t51_mem0 <= t5_t8_t51

	t5_t8_t51_mem1 = S.Task('t5_t8_t51_mem1', length=1, delay_cost=1)
	t5_t8_t51_mem1 += ADD_mem[1]
	S += 117 < t5_t8_t51_mem1
	S += t5_t8_t51_mem1 <= t5_t8_t51
	...
	S += 36 < t1_s0_y1_2_mem0
	S += t1_s0_y1_2_mem0 <= t1_s0_y1_2
	...
	t5_t811_mem1 += alt(ADD_mem)
	S += (t5_t8_t51*ADD[0])-1 < t5_t811_mem1*ADD_mem[0]
	S += (t5_t8_t51*ADD[1])-1 < t5_t811_mem1*ADD_mem[1]
	S += (t5_t8_t51*ADD[2])-1 < t5_t811_mem1*ADD_mem[2]
	S += (t5_t8_t51*ADD[3])-1 < t5_t811_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/SPARSE_mul1_add4/SPARSE_11.png"
	if(S.solution() != []):
