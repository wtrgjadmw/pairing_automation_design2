...
def solve():
	horizon = 253
	S = Scenario("SPARSE_13", horizon=horizon)
	...
	S += 41 < t1_s0_y1_4_mem0
	S += t1_s0_y1_4_mem0 <= t1_s0_y1_4

	t1_s0_y1_4_mem1 = S.Task('t1_s0_y1_4_mem1', length=1, delay_cost=1)
	t1_s0_y1_4_mem1 += ADD_mem[0]
	S += 34 < t1_s0_y1_4_mem1
	S += t1_s0_y1_4_mem1 <= t1_s0_y1_4
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/SPARSE_mul1_add4/SPARSE_13.png"
	if(S.solution() != []):
