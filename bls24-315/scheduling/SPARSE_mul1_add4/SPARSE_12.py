...
def solve():
	horizon = 253
	S = Scenario("SPARSE_12", horizon=horizon)
	...
	S += 44 < t1_s0_y1_3_mem0
	S += t1_s0_y1_3_mem0 <= t1_s0_y1_3
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/SPARSE_mul1_add4/SPARSE_12.png"
	if(S.solution() != []):
