...
def solve():
	...
	S += 210 < c_denom_inv_cc_a1__y1_1_mem0
	...
	S += 200 < c_denom_inv_cc_a1__y1_1_mem1
	...
	S += 200 < c_denom_inv_cc_t3_t1_mem1
	...
	S += 200 < c_denom_inv_bc_t1_t1_mem1
	...
	S += 200 < c_denom_inv_ac_t1_t1_mem0
	...
	S += 200 < c_denom_inv_pbc_t31_mem1
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_19.png"
	if(S.solution() != []):
