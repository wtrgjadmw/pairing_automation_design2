...
def solve():
	...
	S += 135 < c0_t3_t4_t2_mem0
	S += c0_t3_t4_t2_mem0 <= c0_t3_t4_t2

	c0_t3_t4_t2_mem1 = S.Task('c0_t3_t4_t2_mem1', length=1, delay_cost=1)
	c0_t3_t4_t2_mem1 += ADD_mem[1]
	S += 136 < c0_t3_t4_t2_mem1
	S += c0_t3_t4_t2_mem1 <= c0_t3_t4_t2
	...
	S += 139 < c0_t4_t4_t2_mem0
	S += c0_t4_t4_t2_mem0 <= c0_t4_t4_t2

	c0_t4_t4_t2_mem1 = S.Task('c0_t4_t4_t2_mem1', length=1, delay_cost=1)
	c0_t4_t4_t2_mem1 += ADD_mem[0]
	S += 141 < c0_t4_t4_t2_mem1
	S += c0_t4_t4_t2_mem1 <= c0_t4_t4_t2
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_10.png"
	if(S.solution() != []):
