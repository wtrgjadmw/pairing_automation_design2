...
def solve():
	horizon = 588
	S = Scenario("INV_36", horizon=horizon)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_36.png"
	if(S.solution() != []):
