...
def solve():
	horizon = 626
	S = Scenario("INV_41", horizon=horizon)
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_41.png"
	if(S.solution() != []):
