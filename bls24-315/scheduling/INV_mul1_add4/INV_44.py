...
def solve():
	horizon = 659
	S = Scenario("INV_44", horizon=horizon)
	...
	S += 542 < c1__t5_t41_mem0
	S += c1__t5_t41_mem0 <= c1__t5_t41

	c1__t5_t41_mem1 = S.Task('c1__t5_t41_mem1', length=1, delay_cost=1)
	c1__t5_t41_mem1 += alt(ADD_mem)
	S += (c1__t5_t4_t5*ADD[0]) < c1__t5_t41_mem1*ADD_mem[0]
	S += (c1__t5_t4_t5*ADD[1]) < c1__t5_t41_mem1*ADD_mem[1]
	S += (c1__t5_t4_t5*ADD[2]) < c1__t5_t41_mem1*ADD_mem[2]
	S += (c1__t5_t4_t5*ADD[3]) < c1__t5_t41_mem1*ADD_mem[3]
	S += c1__t5_t41_mem1 <= c1__t5_t41

	c1__t5_s0_y1_4 = S.Task('c1__t5_s0_y1_4', length=1, delay_cost=1)
	c1__t5_s0_y1_4 += alt(ADD)

	c1__t5_s0_y1_4_mem0 = S.Task('c1__t5_s0_y1_4_mem0', length=1, delay_cost=1)
	c1__t5_s0_y1_4_mem0 += alt(ADD_mem)
	S += (c1__t5_s0_y1_3*ADD[0]) < c1__t5_s0_y1_4_mem0*ADD_mem[0]
	S += (c1__t5_s0_y1_3*ADD[1]) < c1__t5_s0_y1_4_mem0*ADD_mem[1]
	S += (c1__t5_s0_y1_3*ADD[2]) < c1__t5_s0_y1_4_mem0*ADD_mem[2]
	S += (c1__t5_s0_y1_3*ADD[3]) < c1__t5_s0_y1_4_mem0*ADD_mem[3]
	S += c1__t5_s0_y1_4_mem0 <= c1__t5_s0_y1_4

	c1__t5_s0_y1_4_mem1 = S.Task('c1__t5_s0_y1_4_mem1', length=1, delay_cost=1)
	c1__t5_s0_y1_4_mem1 += ADD_mem[2]
	S += 493 < c1__t5_s0_y1_4_mem1
	S += c1__t5_s0_y1_4_mem1 <= c1__t5_s0_y1_4
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_44.png"
	if(S.solution() != []):
