...
def solve():
	horizon = 593
	S = Scenario("INV_38", horizon=horizon)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_38.png"
	if(S.solution() != []):
