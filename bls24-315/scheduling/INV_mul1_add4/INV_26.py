...
def solve():
	...
	S += 289 < c_denom_inv_bcxi_y1__y1_4_mem0
	S += c_denom_inv_bcxi_y1__y1_4_mem0 <= c_denom_inv_bcxi_y1__y1_4
	...
	S += 266 < c_denom_inv_bcxi_y1__y1_4_mem1
	S += c_denom_inv_bcxi_y1__y1_4_mem1 <= c_denom_inv_bcxi_y1__y1_4
	...
	S += 289 < c_denom_inv_pbc_t0_t0_mem0
	...
	S += 216 < c_denom_inv_pbc_t0_t0_mem1
	...
	S += 289 < c_denom_inv_pbc_t0_t2_mem0
	...
	S += 279 < c_denom_inv_pbc_t0_t2_mem1
	...
	c_denom_inv_pbc_t0_s01 += alt(ADD)
	...
	S += 289 < c_denom_inv_pbc_t0_s01_mem0
	S += c_denom_inv_pbc_t0_s01_mem0 <= c_denom_inv_pbc_t0_s01
	...
	S += 286 < c_denom_inv_pbc_t0_s01_mem1
	S += c_denom_inv_pbc_t0_s01_mem1 <= c_denom_inv_pbc_t0_s01

	c_denom_inv_pbc_t1_s00 = S.Task('c_denom_inv_pbc_t1_s00', length=1, delay_cost=1)
	c_denom_inv_pbc_t1_s00 += alt(ADD)
	...
	S += 284 < c_denom_inv_pbc_t1_s00_mem0
	S += c_denom_inv_pbc_t1_s00_mem0 <= c_denom_inv_pbc_t1_s00
	...
	S += 281 < c_denom_inv_pbc_t4_t1_mem0
	...
	S += 213 < c_denom_inv_pbc_t4_t1_mem1
	...
	S += 288 < c_denom_inv_pcb_t0_t1_mem0
	...
	S += 215 < c_denom_inv_pcb_t0_t1_mem1
	...
	S += 286 < c_denom_inv_pcb_t1_t0_mem0
	...
	S += 216 < c_denom_inv_pcb_t1_t0_mem1
	...
	S += 286 < c_denom_inv_pcb_t1_t2_mem0
	...
	S += 265 < c_denom_inv_pcb_t1_t2_mem1
	...
	c_denom_inv_pcb_t1_s02 += alt(ADD)
	...
	S += 288 < c_denom_inv_pcb_t1_s02_mem0
	S += c_denom_inv_pcb_t1_s02_mem0 <= c_denom_inv_pcb_t1_s02
	...
	S += 288 < c_denom_inv_pcb_t21_mem0
	...
	S += 265 < c_denom_inv_pcb_t21_mem1
	...
	S += 287 < c_denom_inv_paa_t0_t1_mem0
	...
	S += 216 < c_denom_inv_paa_t0_t1_mem1
	...
	S += 284 < c_denom_inv_paa_t1_t0_mem0
	...
	S += 216 < c_denom_inv_paa_t1_t0_mem1
	...
	S += 284 < c_denom_inv_paa_t1_t2_mem0
	...
	S += 276 < c_denom_inv_paa_t1_t2_mem1
	...
	c_denom_inv_paa_t1_s01 += alt(ADD)
	...
	S += 289 < c_denom_inv_paa_t1_s01_mem0
	S += c_denom_inv_paa_t1_s01_mem0 <= c_denom_inv_paa_t1_s01
	...
	S += 283 < c_denom_inv_paa_t1_s01_mem1
	S += c_denom_inv_paa_t1_s01_mem1 <= c_denom_inv_paa_t1_s01
	...
	S += 287 < c_denom_inv_paa_t21_mem0
	...
	S += 276 < c_denom_inv_paa_t21_mem1
	...
	S += (c_denom_inv_bcxi_y1__y1_4*ADD[0])-1 < c_denom_inv_pa00_mem1*ADD_mem[0]
	S += (c_denom_inv_bcxi_y1__y1_4*ADD[1])-1 < c_denom_inv_pa00_mem1*ADD_mem[1]
	S += (c_denom_inv_bcxi_y1__y1_4*ADD[2])-1 < c_denom_inv_pa00_mem1*ADD_mem[2]
	S += (c_denom_inv_bcxi_y1__y1_4*ADD[3])-1 < c_denom_inv_pa00_mem1*ADD_mem[3]
	...
	S += 233 < c_denom_inv_pbc_t0_t4_mem1
	...
	c_denom_inv_pbc_t0_s02 += alt(ADD)

	c_denom_inv_pbc_t0_s02_mem0 = S.Task('c_denom_inv_pbc_t0_s02_mem0', length=1, delay_cost=1)
	c_denom_inv_pbc_t0_s02_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t0_s01*ADD[0])-1 < c_denom_inv_pbc_t0_s02_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t0_s01*ADD[1])-1 < c_denom_inv_pbc_t0_s02_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t0_s01*ADD[2])-1 < c_denom_inv_pbc_t0_s02_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t0_s01*ADD[3])-1 < c_denom_inv_pbc_t0_s02_mem0*ADD_mem[3]
	S += c_denom_inv_pbc_t0_s02_mem0 <= c_denom_inv_pbc_t0_s02
	...
	S += 286 < c_denom_inv_pbc_t0_t5_mem1
	...
	S += 214 < c_denom_inv_pbc_t1_t0_mem1
	...
	S += 277 < c_denom_inv_pbc_t1_t2_mem1
	...
	c_denom_inv_pbc_t1_s01 += alt(ADD)

	c_denom_inv_pbc_t1_s01_mem0 = S.Task('c_denom_inv_pbc_t1_s01_mem0', length=1, delay_cost=1)
	c_denom_inv_pbc_t1_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pbc_t1_s00*ADD[0])-1 < c_denom_inv_pbc_t1_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t1_s00*ADD[1])-1 < c_denom_inv_pbc_t1_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t1_s00*ADD[2])-1 < c_denom_inv_pbc_t1_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t1_s00*ADD[3])-1 < c_denom_inv_pbc_t1_s01_mem0*ADD_mem[3]
	S += c_denom_inv_pbc_t1_s01_mem0 <= c_denom_inv_pbc_t1_s01
	...
	S += 284 < c_denom_inv_pbc_t1_s01_mem1
	S += c_denom_inv_pbc_t1_s01_mem1 <= c_denom_inv_pbc_t1_s01
	...
	S += 289 < c_denom_inv_pbc_t20_mem0
	...
	c_denom_inv_pbc_t4_s00 += alt(ADD)

	c_denom_inv_pbc_t4_s00_mem0 = S.Task('c_denom_inv_pbc_t4_s00_mem0', length=1, delay_cost=1)
	c_denom_inv_pbc_t4_s00_mem0 += alt(MUL_mem)
	S += (c_denom_inv_pbc_t4_t1*MUL[0])-1 < c_denom_inv_pbc_t4_s00_mem0*MUL_mem[0]
	S += c_denom_inv_pbc_t4_s00_mem0 <= c_denom_inv_pbc_t4_s00

	c_denom_inv_pcb_t0_s00 = S.Task('c_denom_inv_pcb_t0_s00', length=1, delay_cost=1)
	c_denom_inv_pcb_t0_s00 += alt(ADD)

	c_denom_inv_pcb_t0_s00_mem0 = S.Task('c_denom_inv_pcb_t0_s00_mem0', length=1, delay_cost=1)
	c_denom_inv_pcb_t0_s00_mem0 += alt(MUL_mem)
	S += (c_denom_inv_pcb_t0_t1*MUL[0])-1 < c_denom_inv_pcb_t0_s00_mem0*MUL_mem[0]
	S += c_denom_inv_pcb_t0_s00_mem0 <= c_denom_inv_pcb_t0_s00
	...
	c_denom_inv_pcb_t1_t4_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t1_t2*ADD[0])-1 < c_denom_inv_pcb_t1_t4_mem0*ADD_mem[0]
	S += (c_denom_inv_pcb_t1_t2*ADD[1])-1 < c_denom_inv_pcb_t1_t4_mem0*ADD_mem[1]
	S += (c_denom_inv_pcb_t1_t2*ADD[2])-1 < c_denom_inv_pcb_t1_t4_mem0*ADD_mem[2]
	S += (c_denom_inv_pcb_t1_t2*ADD[3])-1 < c_denom_inv_pcb_t1_t4_mem0*ADD_mem[3]
	...
	S += 226 < c_denom_inv_pcb_t1_t4_mem1
	...
	c_denom_inv_pcb_t1_s03_mem0 += alt(ADD_mem)
	S += (c_denom_inv_pcb_t1_s02*ADD[0])-1 < c_denom_inv_pcb_t1_s03_mem0*ADD_mem[0]
	S += (c_denom_inv_pcb_t1_s02*ADD[1])-1 < c_denom_inv_pcb_t1_s03_mem0*ADD_mem[1]
	S += (c_denom_inv_pcb_t1_s02*ADD[2])-1 < c_denom_inv_pcb_t1_s03_mem0*ADD_mem[2]
	S += (c_denom_inv_pcb_t1_s02*ADD[3])-1 < c_denom_inv_pcb_t1_s03_mem0*ADD_mem[3]
	...
	c_denom_inv_pcb_t1_t5_mem0 += alt(MUL_mem)
	S += (c_denom_inv_pcb_t1_t0*MUL[0])-1 < c_denom_inv_pcb_t1_t5_mem0*MUL_mem[0]
	...
	S += 275 < c_denom_inv_pcb_t1_t5_mem1
	...
	S += 230 < c_denom_inv_pcb_t4_t1_mem1
	...
	c_denom_inv_paa_t0_s00 += alt(ADD)

	c_denom_inv_paa_t0_s00_mem0 = S.Task('c_denom_inv_paa_t0_s00_mem0', length=1, delay_cost=1)
	c_denom_inv_paa_t0_s00_mem0 += alt(MUL_mem)
	S += (c_denom_inv_paa_t0_t1*MUL[0])-1 < c_denom_inv_paa_t0_s00_mem0*MUL_mem[0]
	S += c_denom_inv_paa_t0_s00_mem0 <= c_denom_inv_paa_t0_s00
	...
	S += 218 < c_denom_inv_paa_t1_t4_mem1
	...
	c_denom_inv_paa_t1_s02 += alt(ADD)

	c_denom_inv_paa_t1_s02_mem0 = S.Task('c_denom_inv_paa_t1_s02_mem0', length=1, delay_cost=1)
	c_denom_inv_paa_t1_s02_mem0 += alt(ADD_mem)
	S += (c_denom_inv_paa_t1_s01*ADD[0])-1 < c_denom_inv_paa_t1_s02_mem0*ADD_mem[0]
	S += (c_denom_inv_paa_t1_s01*ADD[1])-1 < c_denom_inv_paa_t1_s02_mem0*ADD_mem[1]
	S += (c_denom_inv_paa_t1_s01*ADD[2])-1 < c_denom_inv_paa_t1_s02_mem0*ADD_mem[2]
	S += (c_denom_inv_paa_t1_s01*ADD[3])-1 < c_denom_inv_paa_t1_s02_mem0*ADD_mem[3]
	S += c_denom_inv_paa_t1_s02_mem0 <= c_denom_inv_paa_t1_s02
	...
	S += 283 < c_denom_inv_paa_t1_t5_mem1
	...
	S += 231 < c_denom_inv_paa_t4_t1_mem1
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/INV_mul1_add4/INV_26.png"
	if(S.solution() != []):
