...
def solve():
	horizon = 657
	S = Scenario("INV_42", horizon=horizon)
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls24-315/scheduling/INV_mul1_add4/INV_42.png"
	if(S.solution() != []):
