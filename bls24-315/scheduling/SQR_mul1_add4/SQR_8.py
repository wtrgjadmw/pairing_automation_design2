...
def solve():
	horizon = 204
	S = Scenario("SQR_8", horizon=horizon)
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/SQR_mul1_add4/SQR_8.png"
	if(S.solution() != []):
