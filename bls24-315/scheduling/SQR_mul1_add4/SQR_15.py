...
def solve():
	...
	S += (c_t2_t300*ADD[0])-1 < c_t2_t600_mem0*ADD_mem[0]
	S += (c_t2_t300*ADD[1])-1 < c_t2_t600_mem0*ADD_mem[1]
	S += (c_t2_t300*ADD[2])-1 < c_t2_t600_mem0*ADD_mem[2]
	S += (c_t2_t300*ADD[3])-1 < c_t2_t600_mem0*ADD_mem[3]
	S += c_t2_t600_mem0 <= c_t2_t600

	c_t2_t600_mem1 = S.Task('c_t2_t600_mem1', length=1, delay_cost=1)
	c_t2_t600_mem1 += alt(ADD_mem)
	S += (c_t2_t6000*ADD[0])-1 < c_t2_t600_mem1*ADD_mem[0]
	S += (c_t2_t6000*ADD[1])-1 < c_t2_t600_mem1*ADD_mem[1]
	S += (c_t2_t6000*ADD[2])-1 < c_t2_t600_mem1*ADD_mem[2]
	S += (c_t2_t6000*ADD[3])-1 < c_t2_t600_mem1*ADD_mem[3]
	...
	S += (c_t2_t301*ADD[0])-1 < c_t2_t601_mem0*ADD_mem[0]
	S += (c_t2_t301*ADD[1])-1 < c_t2_t601_mem0*ADD_mem[1]
	S += (c_t2_t301*ADD[2])-1 < c_t2_t601_mem0*ADD_mem[2]
	S += (c_t2_t301*ADD[3])-1 < c_t2_t601_mem0*ADD_mem[3]
	S += c_t2_t601_mem0 <= c_t2_t601

	c_t2_t601_mem1 = S.Task('c_t2_t601_mem1', length=1, delay_cost=1)
	c_t2_t601_mem1 += alt(ADD_mem)
	S += (c_t2_t6001*ADD[0])-1 < c_t2_t601_mem1*ADD_mem[0]
	S += (c_t2_t6001*ADD[1])-1 < c_t2_t601_mem1*ADD_mem[1]
	S += (c_t2_t6001*ADD[2])-1 < c_t2_t601_mem1*ADD_mem[2]
	S += (c_t2_t6001*ADD[3])-1 < c_t2_t601_mem1*ADD_mem[3]
	...
	S += (c_t2_t400*ADD[0])-1 < c_t2_t7100_mem0*ADD_mem[0]
	S += (c_t2_t400*ADD[1])-1 < c_t2_t7100_mem0*ADD_mem[1]
	S += (c_t2_t400*ADD[2])-1 < c_t2_t7100_mem0*ADD_mem[2]
	S += (c_t2_t400*ADD[3])-1 < c_t2_t7100_mem0*ADD_mem[3]
	S += c_t2_t7100_mem0 <= c_t2_t7100

	c_t2_t7100_mem1 = S.Task('c_t2_t7100_mem1', length=1, delay_cost=1)
	c_t2_t7100_mem1 += alt(ADD_mem)
	S += (c_t2_t7000*ADD[0])-1 < c_t2_t7100_mem1*ADD_mem[0]
	S += (c_t2_t7000*ADD[1])-1 < c_t2_t7100_mem1*ADD_mem[1]
	S += (c_t2_t7000*ADD[2])-1 < c_t2_t7100_mem1*ADD_mem[2]
	S += (c_t2_t7000*ADD[3])-1 < c_t2_t7100_mem1*ADD_mem[3]
	...
	S += (c_t2_t410*ADD[0])-1 < c_t2_t7110_mem0*ADD_mem[0]
	S += (c_t2_t410*ADD[1])-1 < c_t2_t7110_mem0*ADD_mem[1]
	S += (c_t2_t410*ADD[2])-1 < c_t2_t7110_mem0*ADD_mem[2]
	S += (c_t2_t410*ADD[3])-1 < c_t2_t7110_mem0*ADD_mem[3]
	S += c_t2_t7110_mem0 <= c_t2_t7110

	c_t2_t7110_mem1 = S.Task('c_t2_t7110_mem1', length=1, delay_cost=1)
	c_t2_t7110_mem1 += alt(ADD_mem)
	S += (c_t2_t7010*ADD[0])-1 < c_t2_t7110_mem1*ADD_mem[0]
	S += (c_t2_t7010*ADD[1])-1 < c_t2_t7110_mem1*ADD_mem[1]
	S += (c_t2_t7010*ADD[2])-1 < c_t2_t7110_mem1*ADD_mem[2]
	S += (c_t2_t7010*ADD[3])-1 < c_t2_t7110_mem1*ADD_mem[3]
	...
	S += (c_t2_t7_y1__y1_2*ADD[0])-1 < c_t2_t7_y1__y1_3_mem0*ADD_mem[0]
	S += (c_t2_t7_y1__y1_2*ADD[1])-1 < c_t2_t7_y1__y1_3_mem0*ADD_mem[1]
	S += (c_t2_t7_y1__y1_2*ADD[2])-1 < c_t2_t7_y1__y1_3_mem0*ADD_mem[2]
	S += (c_t2_t7_y1__y1_2*ADD[3])-1 < c_t2_t7_y1__y1_3_mem0*ADD_mem[3]
	...
	S += (c_t2_t011*ADD[0])-1 < c_t2011_mem0*ADD_mem[0]
	S += (c_t2_t011*ADD[1])-1 < c_t2011_mem0*ADD_mem[1]
	S += (c_t2_t011*ADD[2])-1 < c_t2011_mem0*ADD_mem[2]
	S += (c_t2_t011*ADD[3])-1 < c_t2011_mem0*ADD_mem[3]
	S += c_t2011_mem0 <= c_t2011

	c_t2011_mem1 = S.Task('c_t2011_mem1', length=1, delay_cost=1)
	c_t2011_mem1 += alt(ADD_mem)
	S += (c_t2_t7101*ADD[0])-1 < c_t2011_mem1*ADD_mem[0]
	S += (c_t2_t7101*ADD[1])-1 < c_t2011_mem1*ADD_mem[1]
	S += (c_t2_t7101*ADD[2])-1 < c_t2011_mem1*ADD_mem[2]
	S += (c_t2_t7101*ADD[3])-1 < c_t2011_mem1*ADD_mem[3]
	...
	S += (c_t2_t500*ADD[0])-1 < c_t2_t800_mem0*ADD_mem[0]
	S += (c_t2_t500*ADD[1])-1 < c_t2_t800_mem0*ADD_mem[1]
	S += (c_t2_t500*ADD[2])-1 < c_t2_t800_mem0*ADD_mem[2]
	S += (c_t2_t500*ADD[3])-1 < c_t2_t800_mem0*ADD_mem[3]
	S += c_t2_t800_mem0 <= c_t2_t800

	c_t2_t800_mem1 = S.Task('c_t2_t800_mem1', length=1, delay_cost=1)
	c_t2_t800_mem1 += alt(ADD_mem)
	S += (c_t2_t8000*ADD[0])-1 < c_t2_t800_mem1*ADD_mem[0]
	S += (c_t2_t8000*ADD[1])-1 < c_t2_t800_mem1*ADD_mem[1]
	S += (c_t2_t8000*ADD[2])-1 < c_t2_t800_mem1*ADD_mem[2]
	S += (c_t2_t8000*ADD[3])-1 < c_t2_t800_mem1*ADD_mem[3]
	...
	S += (c_t2_t501*ADD[0])-1 < c_t2_t801_mem0*ADD_mem[0]
	S += (c_t2_t501*ADD[1])-1 < c_t2_t801_mem0*ADD_mem[1]
	S += (c_t2_t501*ADD[2])-1 < c_t2_t801_mem0*ADD_mem[2]
	S += (c_t2_t501*ADD[3])-1 < c_t2_t801_mem0*ADD_mem[3]
	S += c_t2_t801_mem0 <= c_t2_t801

	c_t2_t801_mem1 = S.Task('c_t2_t801_mem1', length=1, delay_cost=1)
	c_t2_t801_mem1 += alt(ADD_mem)
	S += (c_t2_t8001*ADD[0])-1 < c_t2_t801_mem1*ADD_mem[0]
	S += (c_t2_t8001*ADD[1])-1 < c_t2_t801_mem1*ADD_mem[1]
	S += (c_t2_t8001*ADD[2])-1 < c_t2_t801_mem1*ADD_mem[2]
	S += (c_t2_t8001*ADD[3])-1 < c_t2_t801_mem1*ADD_mem[3]
	...
	S += (c_t3_t600*ADD[0])-1 < c_t3100_mem0*ADD_mem[0]
	S += (c_t3_t600*ADD[1])-1 < c_t3100_mem0*ADD_mem[1]
	S += (c_t3_t600*ADD[2])-1 < c_t3100_mem0*ADD_mem[2]
	S += (c_t3_t600*ADD[3])-1 < c_t3100_mem0*ADD_mem[3]
	...
	S += (c_t3_t610*ADD[0])-1 < c_t3110_mem0*ADD_mem[0]
	S += (c_t3_t610*ADD[1])-1 < c_t3110_mem0*ADD_mem[1]
	S += (c_t3_t610*ADD[2])-1 < c_t3110_mem0*ADD_mem[2]
	S += (c_t3_t610*ADD[3])-1 < c_t3110_mem0*ADD_mem[3]
	...
	S += (c_t3_t7_y1__y1_3*ADD[0])-1 < c_t3_t7_y1__y1_4_mem0*ADD_mem[0]
	S += (c_t3_t7_y1__y1_3*ADD[1])-1 < c_t3_t7_y1__y1_4_mem0*ADD_mem[1]
	S += (c_t3_t7_y1__y1_3*ADD[2])-1 < c_t3_t7_y1__y1_4_mem0*ADD_mem[2]
	S += (c_t3_t7_y1__y1_3*ADD[3])-1 < c_t3_t7_y1__y1_4_mem0*ADD_mem[3]
	...
	S += (c_t3_t7110*ADD[0])-1 < c_t3001_mem1*ADD_mem[0]
	S += (c_t3_t7110*ADD[1])-1 < c_t3001_mem1*ADD_mem[1]
	S += (c_t3_t7110*ADD[2])-1 < c_t3001_mem1*ADD_mem[2]
	S += (c_t3_t7110*ADD[3])-1 < c_t3001_mem1*ADD_mem[3]
	...
	S += (c_t3_t7100*ADD[0])-1 < c_t3010_mem1*ADD_mem[0]
	S += (c_t3_t7100*ADD[1])-1 < c_t3010_mem1*ADD_mem[1]
	S += (c_t3_t7100*ADD[2])-1 < c_t3010_mem1*ADD_mem[2]
	S += (c_t3_t7100*ADD[3])-1 < c_t3010_mem1*ADD_mem[3]
	...
	S += (c_t3_t800*ADD[0])-1 < c_t3200_mem0*ADD_mem[0]
	S += (c_t3_t800*ADD[1])-1 < c_t3200_mem0*ADD_mem[1]
	S += (c_t3_t800*ADD[2])-1 < c_t3200_mem0*ADD_mem[2]
	S += (c_t3_t800*ADD[3])-1 < c_t3200_mem0*ADD_mem[3]
	...
	S += (c_t3_t810*ADD[0])-1 < c_t3210_mem0*ADD_mem[0]
	S += (c_t3_t810*ADD[1])-1 < c_t3210_mem0*ADD_mem[1]
	S += (c_t3_t810*ADD[2])-1 < c_t3210_mem0*ADD_mem[2]
	S += (c_t3_t810*ADD[3])-1 < c_t3210_mem0*ADD_mem[3]
	...
	S += (c_t40_y1__y1_2*ADD[0])-1 < c_t40_y1__y1_3_mem0*ADD_mem[0]
	S += (c_t40_y1__y1_2*ADD[1])-1 < c_t40_y1__y1_3_mem0*ADD_mem[1]
	S += (c_t40_y1__y1_2*ADD[2])-1 < c_t40_y1__y1_3_mem0*ADD_mem[2]
	S += (c_t40_y1__y1_2*ADD[3])-1 < c_t40_y1__y1_3_mem0*ADD_mem[3]
	...
	S += (c_t3011*ADD[0])-1 < c_t5011_mem0*ADD_mem[0]
	S += (c_t3011*ADD[1])-1 < c_t5011_mem0*ADD_mem[1]
	S += (c_t3011*ADD[2])-1 < c_t5011_mem0*ADD_mem[2]
	S += (c_t3011*ADD[3])-1 < c_t5011_mem0*ADD_mem[3]
	S += c_t5011_mem0 <= c_t5011

	c_t5011_mem1 = S.Task('c_t5011_mem1', length=1, delay_cost=1)
	c_t5011_mem1 += alt(ADD_mem)
	S += (c_t3201*ADD[0])-1 < c_t5011_mem1*ADD_mem[0]
	S += (c_t3201*ADD[1])-1 < c_t5011_mem1*ADD_mem[1]
	S += (c_t3201*ADD[2])-1 < c_t5011_mem1*ADD_mem[2]
	S += (c_t3201*ADD[3])-1 < c_t5011_mem1*ADD_mem[3]
	...
	S += (c_t3011*ADD[0])-1 < c_t5111_mem1*ADD_mem[0]
	S += (c_t3011*ADD[1])-1 < c_t5111_mem1*ADD_mem[1]
	S += (c_t3011*ADD[2])-1 < c_t5111_mem1*ADD_mem[2]
	S += (c_t3011*ADD[3])-1 < c_t5111_mem1*ADD_mem[3]
	...
	S += (c_t3011*ADD[0])-1 < c1011_mem0*ADD_mem[0]
	S += (c_t3011*ADD[1])-1 < c1011_mem0*ADD_mem[1]
	S += (c_t3011*ADD[2])-1 < c1011_mem0*ADD_mem[2]
	S += (c_t3011*ADD[3])-1 < c1011_mem0*ADD_mem[3]
	S += c1011_mem0 <= c1011
	...
	S += (c_t3101*ADD[0])-1 < c1101_mem0*ADD_mem[0]
	S += (c_t3101*ADD[1])-1 < c1101_mem0*ADD_mem[1]
	S += (c_t3101*ADD[2])-1 < c1101_mem0*ADD_mem[2]
	S += (c_t3101*ADD[3])-1 < c1101_mem0*ADD_mem[3]
	S += c1101_mem0 <= c1101
	...
	S += (c_t3201*ADD[0])-1 < c1201_mem0*ADD_mem[0]
	S += (c_t3201*ADD[1])-1 < c1201_mem0*ADD_mem[1]
	S += (c_t3201*ADD[2])-1 < c1201_mem0*ADD_mem[2]
	S += (c_t3201*ADD[3])-1 < c1201_mem0*ADD_mem[3]
	S += c1201_mem0 <= c1201
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/SQR_mul1_add4/SQR_15.png"
	if(S.solution() != []):
