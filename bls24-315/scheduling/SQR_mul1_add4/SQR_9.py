...
def solve():
	horizon = 206
	S = Scenario("SQR_9", horizon=horizon)
	...
	S += 102 < c_t3_t5_t51_mem0
	S += c_t3_t5_t51_mem0 <= c_t3_t5_t51

	c_t3_t5_t51_mem1 = S.Task('c_t3_t5_t51_mem1', length=1, delay_cost=1)
	c_t3_t5_t51_mem1 += ADD_mem[2]
	S += 107 < c_t3_t5_t51_mem1
	S += c_t3_t5_t51_mem1 <= c_t3_t5_t51
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/SQR_mul1_add4/SQR_9.png"
	if(S.solution() != []):
