...
def solve():
	...
	S += 8 < c_t3_t0_t00_mem0
	S += c_t3_t0_t00_mem0 <= c_t3_t0_t00

	c_t3_t0_t00_mem1 = S.Task('c_t3_t0_t00_mem1', length=1, delay_cost=1)
	c_t3_t0_t00_mem1 += ADD_mem[1]
	S += 71 < c_t3_t0_t00_mem1
	S += c_t3_t0_t00_mem1 <= c_t3_t0_t00
	...
	S += 44 < c_t3_t1_t00_mem0
	S += c_t3_t1_t00_mem0 <= c_t3_t1_t00

	c_t3_t1_t00_mem1 = S.Task('c_t3_t1_t00_mem1', length=1, delay_cost=1)
	c_t3_t1_t00_mem1 += ADD_mem[2]
	S += 91 < c_t3_t1_t00_mem1
	S += c_t3_t1_t00_mem1 <= c_t3_t1_t00
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/SQR_mul1_add4/SQR_11.png"
	if(S.solution() != []):
