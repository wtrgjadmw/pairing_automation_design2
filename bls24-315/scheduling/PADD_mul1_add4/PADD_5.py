...
def solve():
	...
	t17_t4_s00_mem0 += alt(MUL_mem)
	S += (t17_t4_t1*MUL[0]) < t17_t4_s00_mem0*MUL_mem[0]
	...
	t17_t4_s01_mem1 += alt(MUL_mem)
	S += (t17_t4_t1*MUL[0]) < t17_t4_s01_mem1*MUL_mem[0]
