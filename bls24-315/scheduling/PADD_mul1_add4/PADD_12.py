...
def solve():
	...
	S += t14_t0_s02_mem0 >= 143
	t14_t0_s02_mem0 += ADD_mem[0]
	...
	S += t14_t0_s03_mem0 >= 145
	t14_t0_s03_mem0 += ADD_mem[2]
	...
	S += new_TZ_t0_s03_mem0 >= 147
	new_TZ_t0_s03_mem0 += ADD_mem[3]
	...
	S += new_TZ_t4_s01_mem0 >= 150
	new_TZ_t4_s01_mem0 += ADD_mem[1]

	new_TZ_t4_s01_mem1 = S.Task('new_TZ_t4_s01_mem1', length=1, delay_cost=1)
	S += new_TZ_t4_s01_mem1 >= 150
	...
	S += new_TX_t1_s01_mem0 >= 153
	new_TX_t1_s01_mem0 += ADD_mem[1]

	new_TX_t1_s01_mem1 = S.Task('new_TX_t1_s01_mem1', length=1, delay_cost=1)
	S += new_TX_t1_s01_mem1 >= 153
	...
	S += new_TZ_t4_s03_mem0 >= 154
	new_TZ_t4_s03_mem0 += ADD_mem[2]
	...
	S += t14_t0_s04_mem0 >= 154
	t14_t0_s04_mem0 += ADD_mem[0]

	t14_t0_s04_mem1 = S.Task('t14_t0_s04_mem1', length=1, delay_cost=1)
	S += t14_t0_s04_mem1 >= 154
	...
	S += t14_s0_y1_0_mem0 >= 162
	t14_s0_y1_0_mem0 += ADD_mem[1]
	...
	new_TX_t0_s04_mem0 += ADD_mem[3]
	S += 153 < new_TX_t0_s04_mem0
	...
	new_TX_t1_s03_mem0 += ADD_mem[3]
	S += 157 < new_TX_t1_s03_mem0
	...
	new_TX_t4_s02_mem0 += ADD_mem[1]
	S += 160 < new_TX_t4_s02_mem0
	...
	t13_t1_s02_mem0 += ADD_mem[2]
	S += 162 < t13_t1_s02_mem0
	...
	S += 154 < new_TX_t00_mem0
	S += new_TX_t00_mem0 <= new_TX_t00

	new_TX_t00_mem1 = S.Task('new_TX_t00_mem1', length=1, delay_cost=1)
	new_TX_t00_mem1 += alt(ADD_mem)
	S += (new_TX_t0_s04*ADD[0]) < new_TX_t00_mem1*ADD_mem[0]
	S += (new_TX_t0_s04*ADD[1]) < new_TX_t00_mem1*ADD_mem[1]
	S += (new_TX_t0_s04*ADD[2]) < new_TX_t00_mem1*ADD_mem[2]
	S += (new_TX_t0_s04*ADD[3]) < new_TX_t00_mem1*ADD_mem[3]
	...
	S += (new_TX_t1_s03*ADD[0]) < new_TX_t1_s04_mem0*ADD_mem[0]
	S += (new_TX_t1_s03*ADD[1]) < new_TX_t1_s04_mem0*ADD_mem[1]
	S += (new_TX_t1_s03*ADD[2]) < new_TX_t1_s04_mem0*ADD_mem[2]
	S += (new_TX_t1_s03*ADD[3]) < new_TX_t1_s04_mem0*ADD_mem[3]
	...
	S += (new_TX_t4_s02*ADD[0]) < new_TX_t4_s03_mem0*ADD_mem[0]
	S += (new_TX_t4_s02*ADD[1]) < new_TX_t4_s03_mem0*ADD_mem[1]
	S += (new_TX_t4_s02*ADD[2]) < new_TX_t4_s03_mem0*ADD_mem[2]
	S += (new_TX_t4_s02*ADD[3]) < new_TX_t4_s03_mem0*ADD_mem[3]
	...
	S += (new_TX_t11*ADD[0]) < new_TX_s0_y1_0_mem0*ADD_mem[0]
	S += (new_TX_t11*ADD[1]) < new_TX_s0_y1_0_mem0*ADD_mem[1]
	S += (new_TX_t11*ADD[2]) < new_TX_s0_y1_0_mem0*ADD_mem[2]
	S += (new_TX_t11*ADD[3]) < new_TX_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t13_t0_s03*ADD[0]) < t13_t0_s04_mem0*ADD_mem[0]
	S += (t13_t0_s03*ADD[1]) < t13_t0_s04_mem0*ADD_mem[1]
	S += (t13_t0_s03*ADD[2]) < t13_t0_s04_mem0*ADD_mem[2]
	S += (t13_t0_s03*ADD[3]) < t13_t0_s04_mem0*ADD_mem[3]
	S += t13_t0_s04_mem0 <= t13_t0_s04

	t13_t0_s04_mem1 = S.Task('t13_t0_s04_mem1', length=1, delay_cost=1)
	t13_t0_s04_mem1 += MUL_mem[0]
	S += 152 < t13_t0_s04_mem1
	...
	S += (t13_t1_s02*ADD[0]) < t13_t1_s03_mem0*ADD_mem[0]
	S += (t13_t1_s02*ADD[1]) < t13_t1_s03_mem0*ADD_mem[1]
	S += (t13_t1_s02*ADD[2]) < t13_t1_s03_mem0*ADD_mem[2]
	S += (t13_t1_s02*ADD[3]) < t13_t1_s03_mem0*ADD_mem[3]
	...
	S += (t13_t4_s01*ADD[0]) < t13_t4_s02_mem0*ADD_mem[0]
	S += (t13_t4_s01*ADD[1]) < t13_t4_s02_mem0*ADD_mem[1]
	S += (t13_t4_s01*ADD[2]) < t13_t4_s02_mem0*ADD_mem[2]
	S += (t13_t4_s01*ADD[3]) < t13_t4_s02_mem0*ADD_mem[3]
	...
	S += (t14_t4_s04*ADD[0]) < t14_t40_mem1*ADD_mem[0]
	S += (t14_t4_s04*ADD[1]) < t14_t40_mem1*ADD_mem[1]
	S += (t14_t4_s04*ADD[2]) < t14_t40_mem1*ADD_mem[2]
	S += (t14_t4_s04*ADD[3]) < t14_t40_mem1*ADD_mem[3]
	...
	S += (t14_s0_y1_1*ADD[0]) < t14_s0_y1_2_mem0*ADD_mem[0]
	S += (t14_s0_y1_1*ADD[1]) < t14_s0_y1_2_mem0*ADD_mem[1]
	S += (t14_s0_y1_1*ADD[2]) < t14_s0_y1_2_mem0*ADD_mem[2]
	S += (t14_s0_y1_1*ADD[3]) < t14_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (t14_t10*ADD[0]) < t1401_mem1*ADD_mem[0]
	S += (t14_t10*ADD[1]) < t1401_mem1*ADD_mem[1]
	S += (t14_t10*ADD[2]) < t1401_mem1*ADD_mem[2]
	S += (t14_t10*ADD[3]) < t1401_mem1*ADD_mem[3]
	S += t1401_mem1 <= t1401
	...
	S += (t14_t10*ADD[0]) < t14_t50_mem1*ADD_mem[0]
	S += (t14_t10*ADD[1]) < t14_t50_mem1*ADD_mem[1]
	S += (t14_t10*ADD[2]) < t14_t50_mem1*ADD_mem[2]
	S += (t14_t10*ADD[3]) < t14_t50_mem1*ADD_mem[3]
	...
	S += 159 < new_TZ_t40_mem0
	S += new_TZ_t40_mem0 <= new_TZ_t40

	new_TZ_t40_mem1 = S.Task('new_TZ_t40_mem1', length=1, delay_cost=1)
	new_TZ_t40_mem1 += alt(ADD_mem)
	S += (new_TZ_t4_s04*ADD[0]) < new_TZ_t40_mem1*ADD_mem[0]
	S += (new_TZ_t4_s04*ADD[1]) < new_TZ_t40_mem1*ADD_mem[1]
	S += (new_TZ_t4_s04*ADD[2]) < new_TZ_t40_mem1*ADD_mem[2]
	S += (new_TZ_t4_s04*ADD[3]) < new_TZ_t40_mem1*ADD_mem[3]
	...
	S += (new_TZ_s0_y1_1*ADD[0]) < new_TZ_s0_y1_2_mem0*ADD_mem[0]
	S += (new_TZ_s0_y1_1*ADD[1]) < new_TZ_s0_y1_2_mem0*ADD_mem[1]
	S += (new_TZ_s0_y1_1*ADD[2]) < new_TZ_s0_y1_2_mem0*ADD_mem[2]
	S += (new_TZ_s0_y1_1*ADD[3]) < new_TZ_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (new_TZ_t10*ADD[0]) < new_TZ01_mem1*ADD_mem[0]
	S += (new_TZ_t10*ADD[1]) < new_TZ01_mem1*ADD_mem[1]
	S += (new_TZ_t10*ADD[2]) < new_TZ01_mem1*ADD_mem[2]
	S += (new_TZ_t10*ADD[3]) < new_TZ01_mem1*ADD_mem[3]
	...
	S += 159 < new_TZ_t50_mem0
	S += new_TZ_t50_mem0 <= new_TZ_t50

	new_TZ_t50_mem1 = S.Task('new_TZ_t50_mem1', length=1, delay_cost=1)
	new_TZ_t50_mem1 += alt(ADD_mem)
	S += (new_TZ_t10*ADD[0]) < new_TZ_t50_mem1*ADD_mem[0]
	S += (new_TZ_t10*ADD[1]) < new_TZ_t50_mem1*ADD_mem[1]
	S += (new_TZ_t10*ADD[2]) < new_TZ_t50_mem1*ADD_mem[2]
	S += (new_TZ_t10*ADD[3]) < new_TZ_t50_mem1*ADD_mem[3]
	...
	S += 166 < new_TX_t10_mem0
	S += new_TX_t10_mem0 <= new_TX_t10

	new_TX_t10_mem1 = S.Task('new_TX_t10_mem1', length=1, delay_cost=1)
	new_TX_t10_mem1 += alt(ADD_mem)
	S += (new_TX_t1_s04*ADD[0]) < new_TX_t10_mem1*ADD_mem[0]
	S += (new_TX_t1_s04*ADD[1]) < new_TX_t10_mem1*ADD_mem[1]
	S += (new_TX_t1_s04*ADD[2]) < new_TX_t10_mem1*ADD_mem[2]
	S += (new_TX_t1_s04*ADD[3]) < new_TX_t10_mem1*ADD_mem[3]
	...
	S += (new_TX_t4_s03*ADD[0]) < new_TX_t4_s04_mem0*ADD_mem[0]
	S += (new_TX_t4_s03*ADD[1]) < new_TX_t4_s04_mem0*ADD_mem[1]
	S += (new_TX_t4_s03*ADD[2]) < new_TX_t4_s04_mem0*ADD_mem[2]
	S += (new_TX_t4_s03*ADD[3]) < new_TX_t4_s04_mem0*ADD_mem[3]
	...
	S += (new_TX_t11*ADD[0]) < new_TX_s0_y1_1_mem1*ADD_mem[0]
	S += (new_TX_t11*ADD[1]) < new_TX_s0_y1_1_mem1*ADD_mem[1]
	S += (new_TX_t11*ADD[2]) < new_TX_s0_y1_1_mem1*ADD_mem[2]
	S += (new_TX_t11*ADD[3]) < new_TX_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t13_t0_s04*ADD[0]) < t13_t00_mem1*ADD_mem[0]
	S += (t13_t0_s04*ADD[1]) < t13_t00_mem1*ADD_mem[1]
	S += (t13_t0_s04*ADD[2]) < t13_t00_mem1*ADD_mem[2]
	S += (t13_t0_s04*ADD[3]) < t13_t00_mem1*ADD_mem[3]
	...
	S += (t13_t1_s03*ADD[0]) < t13_t1_s04_mem0*ADD_mem[0]
	S += (t13_t1_s03*ADD[1]) < t13_t1_s04_mem0*ADD_mem[1]
	S += (t13_t1_s03*ADD[2]) < t13_t1_s04_mem0*ADD_mem[2]
	S += (t13_t1_s03*ADD[3]) < t13_t1_s04_mem0*ADD_mem[3]
	S += t13_t1_s04_mem0 <= t13_t1_s04

	t13_t1_s04_mem1 = S.Task('t13_t1_s04_mem1', length=1, delay_cost=1)
	t13_t1_s04_mem1 += MUL_mem[0]
	S += 158 < t13_t1_s04_mem1
	...
	S += (t13_t4_s02*ADD[0]) < t13_t4_s03_mem0*ADD_mem[0]
	S += (t13_t4_s02*ADD[1]) < t13_t4_s03_mem0*ADD_mem[1]
	S += (t13_t4_s02*ADD[2]) < t13_t4_s03_mem0*ADD_mem[2]
	S += (t13_t4_s02*ADD[3]) < t13_t4_s03_mem0*ADD_mem[3]
	...
	S += (t13_t11*ADD[0]) < t13_s0_y1_0_mem0*ADD_mem[0]
	S += (t13_t11*ADD[1]) < t13_s0_y1_0_mem0*ADD_mem[1]
	S += (t13_t11*ADD[2]) < t13_s0_y1_0_mem0*ADD_mem[2]
	S += (t13_t11*ADD[3]) < t13_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t14_s0_y1_2*ADD[0]) < t14_s0_y1_3_mem0*ADD_mem[0]
	S += (t14_s0_y1_2*ADD[1]) < t14_s0_y1_3_mem0*ADD_mem[1]
	S += (t14_s0_y1_2*ADD[2]) < t14_s0_y1_3_mem0*ADD_mem[2]
	S += (t14_s0_y1_2*ADD[3]) < t14_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (t14_t40*ADD[0]) < t1410_mem0*ADD_mem[0]
	S += (t14_t40*ADD[1]) < t1410_mem0*ADD_mem[1]
	S += (t14_t40*ADD[2]) < t1410_mem0*ADD_mem[2]
	S += (t14_t40*ADD[3]) < t1410_mem0*ADD_mem[3]
	S += t1410_mem0 <= t1410

	t1410_mem1 = S.Task('t1410_mem1', length=1, delay_cost=1)
	t1410_mem1 += alt(ADD_mem)
	S += (t14_t50*ADD[0]) < t1410_mem1*ADD_mem[0]
	S += (t14_t50*ADD[1]) < t1410_mem1*ADD_mem[1]
	S += (t14_t50*ADD[2]) < t1410_mem1*ADD_mem[2]
	S += (t14_t50*ADD[3]) < t1410_mem1*ADD_mem[3]
	S += t1410_mem1 <= t1410
	...
	S += (new_TZ_s0_y1_2*ADD[0]) < new_TZ_s0_y1_3_mem0*ADD_mem[0]
	S += (new_TZ_s0_y1_2*ADD[1]) < new_TZ_s0_y1_3_mem0*ADD_mem[1]
	S += (new_TZ_s0_y1_2*ADD[2]) < new_TZ_s0_y1_3_mem0*ADD_mem[2]
	S += (new_TZ_s0_y1_2*ADD[3]) < new_TZ_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (new_TZ_t40*ADD[0]) < new_TZ10_mem0*ADD_mem[0]
	S += (new_TZ_t40*ADD[1]) < new_TZ10_mem0*ADD_mem[1]
	S += (new_TZ_t40*ADD[2]) < new_TZ10_mem0*ADD_mem[2]
	S += (new_TZ_t40*ADD[3]) < new_TZ10_mem0*ADD_mem[3]
	S += new_TZ10_mem0 <= new_TZ10

	new_TZ10_mem1 = S.Task('new_TZ10_mem1', length=1, delay_cost=1)
	new_TZ10_mem1 += alt(ADD_mem)
	S += (new_TZ_t50*ADD[0]) < new_TZ10_mem1*ADD_mem[0]
	S += (new_TZ_t50*ADD[1]) < new_TZ10_mem1*ADD_mem[1]
	S += (new_TZ_t50*ADD[2]) < new_TZ10_mem1*ADD_mem[2]
	S += (new_TZ_t50*ADD[3]) < new_TZ10_mem1*ADD_mem[3]
	...
	S += 168 < new_TX_t40_mem0
	S += new_TX_t40_mem0 <= new_TX_t40

	new_TX_t40_mem1 = S.Task('new_TX_t40_mem1', length=1, delay_cost=1)
	new_TX_t40_mem1 += alt(ADD_mem)
	S += (new_TX_t4_s04*ADD[0]) < new_TX_t40_mem1*ADD_mem[0]
	S += (new_TX_t4_s04*ADD[1]) < new_TX_t40_mem1*ADD_mem[1]
	S += (new_TX_t4_s04*ADD[2]) < new_TX_t40_mem1*ADD_mem[2]
	S += (new_TX_t4_s04*ADD[3]) < new_TX_t40_mem1*ADD_mem[3]
	...
	S += (new_TX_t10*ADD[0]) < new_TX01_mem1*ADD_mem[0]
	S += (new_TX_t10*ADD[1]) < new_TX01_mem1*ADD_mem[1]
	S += (new_TX_t10*ADD[2]) < new_TX01_mem1*ADD_mem[2]
	S += (new_TX_t10*ADD[3]) < new_TX01_mem1*ADD_mem[3]
	...
	S += (t13_t1_s04*ADD[0]) < t13_t10_mem1*ADD_mem[0]
	S += (t13_t1_s04*ADD[1]) < t13_t10_mem1*ADD_mem[1]
	S += (t13_t1_s04*ADD[2]) < t13_t10_mem1*ADD_mem[2]
	S += (t13_t1_s04*ADD[3]) < t13_t10_mem1*ADD_mem[3]
	...
	S += (t13_t4_s03*ADD[0]) < t13_t4_s04_mem0*ADD_mem[0]
	S += (t13_t4_s03*ADD[1]) < t13_t4_s04_mem0*ADD_mem[1]
	S += (t13_t4_s03*ADD[2]) < t13_t4_s04_mem0*ADD_mem[2]
	S += (t13_t4_s03*ADD[3]) < t13_t4_s04_mem0*ADD_mem[3]
	S += t13_t4_s04_mem0 <= t13_t4_s04

	t13_t4_s04_mem1 = S.Task('t13_t4_s04_mem1', length=1, delay_cost=1)
	t13_t4_s04_mem1 += MUL_mem[0]
	S += 162 < t13_t4_s04_mem1
	...
	S += (t13_s0_y1_0*ADD[0]) < t13_s0_y1_1_mem0*ADD_mem[0]
	S += (t13_s0_y1_0*ADD[1]) < t13_s0_y1_1_mem0*ADD_mem[1]
	S += (t13_s0_y1_0*ADD[2]) < t13_s0_y1_1_mem0*ADD_mem[2]
	S += (t13_s0_y1_0*ADD[3]) < t13_s0_y1_1_mem0*ADD_mem[3]
	S += t13_s0_y1_1_mem0 <= t13_s0_y1_1

	t13_s0_y1_1_mem1 = S.Task('t13_s0_y1_1_mem1', length=1, delay_cost=1)
	t13_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t13_t11*ADD[0]) < t13_s0_y1_1_mem1*ADD_mem[0]
	S += (t13_t11*ADD[1]) < t13_s0_y1_1_mem1*ADD_mem[1]
	S += (t13_t11*ADD[2]) < t13_s0_y1_1_mem1*ADD_mem[2]
	S += (t13_t11*ADD[3]) < t13_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t14_s0_y1_3*ADD[0]) < t14_s0_y1_4_mem0*ADD_mem[0]
	S += (t14_s0_y1_3*ADD[1]) < t14_s0_y1_4_mem0*ADD_mem[1]
	S += (t14_s0_y1_3*ADD[2]) < t14_s0_y1_4_mem0*ADD_mem[2]
	S += (t14_s0_y1_3*ADD[3]) < t14_s0_y1_4_mem0*ADD_mem[3]
	S += t14_s0_y1_4_mem0 <= t14_s0_y1_4

	t14_s0_y1_4_mem1 = S.Task('t14_s0_y1_4_mem1', length=1, delay_cost=1)
	t14_s0_y1_4_mem1 += ADD_mem[1]
	S += 162 < t14_s0_y1_4_mem1
	...
	S += (new_TZ_s0_y1_3*ADD[0]) < new_TZ_s0_y1_4_mem0*ADD_mem[0]
	S += (new_TZ_s0_y1_3*ADD[1]) < new_TZ_s0_y1_4_mem0*ADD_mem[1]
	S += (new_TZ_s0_y1_3*ADD[2]) < new_TZ_s0_y1_4_mem0*ADD_mem[2]
	S += (new_TZ_s0_y1_3*ADD[3]) < new_TZ_s0_y1_4_mem0*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PADD_mul1_add4/PADD_12.png"
	if(S.solution() != []):
