...
def solve():
	...
	S += new_TZ_s0_y1_0 >= 161
	new_TZ_s0_y1_0 += ADD[2]
	...
	t13_t1_s02_mem0 += ADD_mem[0]
	S += 161 < t13_t1_s02_mem0
	...
	t13_t4_t0_mem1 += ADD_mem[0]
	S += 150 < t13_t4_t0_mem1
	...
	t13_t4_t3_mem0 += ADD_mem[0]
	S += 150 < t13_t4_t3_mem0
	S += t13_t4_t3_mem0 <= t13_t4_t3

	t13_t4_t3_mem1 = S.Task('t13_t4_t3_mem1', length=1, delay_cost=1)
	t13_t4_t3_mem1 += ADD_mem[1]
	S += 146 < t13_t4_t3_mem1
