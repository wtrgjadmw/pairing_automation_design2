...
def solve():
	...
	S += (t500*ADD[0])-1 < t6_t0_t0_mem1*ADD_mem[0]
	S += (t500*ADD[1])-1 < t6_t0_t0_mem1*ADD_mem[1]
	S += (t500*ADD[2])-1 < t6_t0_t0_mem1*ADD_mem[2]
	S += (t500*ADD[3])-1 < t6_t0_t0_mem1*ADD_mem[3]
	...
	S += (t500*ADD[0])-1 < t6_t0_t3_mem0*ADD_mem[0]
	S += (t500*ADD[1])-1 < t6_t0_t3_mem0*ADD_mem[1]
	S += (t500*ADD[2])-1 < t6_t0_t3_mem0*ADD_mem[2]
	S += (t500*ADD[3])-1 < t6_t0_t3_mem0*ADD_mem[3]
	...
	S += (t6_t0_s00*ADD[0])-1 < t6_t0_s01_mem0*ADD_mem[0]
	S += (t6_t0_s00*ADD[1])-1 < t6_t0_s01_mem0*ADD_mem[1]
	S += (t6_t0_s00*ADD[2])-1 < t6_t0_s01_mem0*ADD_mem[2]
	S += (t6_t0_s00*ADD[3])-1 < t6_t0_s01_mem0*ADD_mem[3]
	S += t6_t0_s01_mem0 <= t6_t0_s01

	t6_t0_s01_mem1 = S.Task('t6_t0_s01_mem1', length=1, delay_cost=1)
	t6_t0_s01_mem1 += MUL_mem[0]
	S += 103 < t6_t0_s01_mem1
	...
	S += (t6_t1_s04*ADD[0])-1 < t6_t10_mem1*ADD_mem[0]
	S += (t6_t1_s04*ADD[1])-1 < t6_t10_mem1*ADD_mem[1]
	S += (t6_t1_s04*ADD[2])-1 < t6_t10_mem1*ADD_mem[2]
	S += (t6_t1_s04*ADD[3])-1 < t6_t10_mem1*ADD_mem[3]
	...
	S += (t500*ADD[0])-1 < t6_t30_mem0*ADD_mem[0]
	S += (t500*ADD[1])-1 < t6_t30_mem0*ADD_mem[1]
	S += (t500*ADD[2])-1 < t6_t30_mem0*ADD_mem[2]
	S += (t500*ADD[3])-1 < t6_t30_mem0*ADD_mem[3]
	...
	S += (t6_t4_t1*MUL[0])-1 < t6_t4_s00_mem0*MUL_mem[0]
	...
	S += (t6_t11*ADD[0])-1 < t6_s0_y1_0_mem0*ADD_mem[0]
	S += (t6_t11*ADD[1])-1 < t6_s0_y1_0_mem0*ADD_mem[1]
	S += (t6_t11*ADD[2])-1 < t6_s0_y1_0_mem0*ADD_mem[2]
	S += (t6_t11*ADD[3])-1 < t6_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t400*ADD[0])-1 < t7_t0_t0_mem1*ADD_mem[0]
	S += (t400*ADD[1])-1 < t7_t0_t0_mem1*ADD_mem[1]
	S += (t400*ADD[2])-1 < t7_t0_t0_mem1*ADD_mem[2]
	S += (t400*ADD[3])-1 < t7_t0_t0_mem1*ADD_mem[3]
	...
	S += (t400*ADD[0])-1 < t7_t0_t3_mem0*ADD_mem[0]
	S += (t400*ADD[1])-1 < t7_t0_t3_mem0*ADD_mem[1]
	S += (t400*ADD[2])-1 < t7_t0_t3_mem0*ADD_mem[2]
	S += (t400*ADD[3])-1 < t7_t0_t3_mem0*ADD_mem[3]
	...
	S += (t7_t0_s00*ADD[0])-1 < t7_t0_s01_mem0*ADD_mem[0]
	S += (t7_t0_s00*ADD[1])-1 < t7_t0_s01_mem0*ADD_mem[1]
	S += (t7_t0_s00*ADD[2])-1 < t7_t0_s01_mem0*ADD_mem[2]
	S += (t7_t0_s00*ADD[3])-1 < t7_t0_s01_mem0*ADD_mem[3]
	S += t7_t0_s01_mem0 <= t7_t0_s01

	t7_t0_s01_mem1 = S.Task('t7_t0_s01_mem1', length=1, delay_cost=1)
	t7_t0_s01_mem1 += MUL_mem[0]
	S += 104 < t7_t0_s01_mem1
	...
	S += (t7_t1_s04*ADD[0])-1 < t7_t10_mem1*ADD_mem[0]
	S += (t7_t1_s04*ADD[1])-1 < t7_t10_mem1*ADD_mem[1]
	S += (t7_t1_s04*ADD[2])-1 < t7_t10_mem1*ADD_mem[2]
	S += (t7_t1_s04*ADD[3])-1 < t7_t10_mem1*ADD_mem[3]
	...
	S += (t400*ADD[0])-1 < t7_t30_mem0*ADD_mem[0]
	S += (t400*ADD[1])-1 < t7_t30_mem0*ADD_mem[1]
	S += (t400*ADD[2])-1 < t7_t30_mem0*ADD_mem[2]
	S += (t400*ADD[3])-1 < t7_t30_mem0*ADD_mem[3]
	...
	S += (t7_t4_t1*MUL[0])-1 < t7_t4_s00_mem0*MUL_mem[0]
	...
	S += (t7_t11*ADD[0])-1 < t7_s0_y1_0_mem0*ADD_mem[0]
	S += (t7_t11*ADD[1])-1 < t7_s0_y1_0_mem0*ADD_mem[1]
	S += (t7_t11*ADD[2])-1 < t7_s0_y1_0_mem0*ADD_mem[2]
	S += (t7_t11*ADD[3])-1 < t7_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t500*ADD[0])-1 < t9_t0_t0_mem1*ADD_mem[0]
	S += (t500*ADD[1])-1 < t9_t0_t0_mem1*ADD_mem[1]
	S += (t500*ADD[2])-1 < t9_t0_t0_mem1*ADD_mem[2]
	S += (t500*ADD[3])-1 < t9_t0_t0_mem1*ADD_mem[3]
	...
	S += (t500*ADD[0])-1 < t9_t0_t3_mem0*ADD_mem[0]
	S += (t500*ADD[1])-1 < t9_t0_t3_mem0*ADD_mem[1]
	S += (t500*ADD[2])-1 < t9_t0_t3_mem0*ADD_mem[2]
	S += (t500*ADD[3])-1 < t9_t0_t3_mem0*ADD_mem[3]
	...
	S += (t9_t0_s00*ADD[0])-1 < t9_t0_s01_mem0*ADD_mem[0]
	S += (t9_t0_s00*ADD[1])-1 < t9_t0_s01_mem0*ADD_mem[1]
	S += (t9_t0_s00*ADD[2])-1 < t9_t0_s01_mem0*ADD_mem[2]
	S += (t9_t0_s00*ADD[3])-1 < t9_t0_s01_mem0*ADD_mem[3]
	S += t9_t0_s01_mem0 <= t9_t0_s01

	t9_t0_s01_mem1 = S.Task('t9_t0_s01_mem1', length=1, delay_cost=1)
	t9_t0_s01_mem1 += MUL_mem[0]
	S += 102 < t9_t0_s01_mem1
	...
	S += (t9_t1_s04*ADD[0])-1 < t9_t10_mem1*ADD_mem[0]
	S += (t9_t1_s04*ADD[1])-1 < t9_t10_mem1*ADD_mem[1]
	S += (t9_t1_s04*ADD[2])-1 < t9_t10_mem1*ADD_mem[2]
	S += (t9_t1_s04*ADD[3])-1 < t9_t10_mem1*ADD_mem[3]
	...
	S += (t500*ADD[0])-1 < t9_t30_mem0*ADD_mem[0]
	S += (t500*ADD[1])-1 < t9_t30_mem0*ADD_mem[1]
	S += (t500*ADD[2])-1 < t9_t30_mem0*ADD_mem[2]
	S += (t500*ADD[3])-1 < t9_t30_mem0*ADD_mem[3]
	...
	S += (t9_t4_t1*MUL[0])-1 < t9_t4_s00_mem0*MUL_mem[0]
	...
	S += (t9_t11*ADD[0])-1 < t9_s0_y1_0_mem0*ADD_mem[0]
	S += (t9_t11*ADD[1])-1 < t9_s0_y1_0_mem0*ADD_mem[1]
	S += (t9_t11*ADD[2])-1 < t9_s0_y1_0_mem0*ADD_mem[2]
	S += (t9_t11*ADD[3])-1 < t9_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t6_t0_t3*ADD[0])-1 < t6_t0_t4_mem1*ADD_mem[0]
	S += (t6_t0_t3*ADD[1])-1 < t6_t0_t4_mem1*ADD_mem[1]
	S += (t6_t0_t3*ADD[2])-1 < t6_t0_t4_mem1*ADD_mem[2]
	S += (t6_t0_t3*ADD[3])-1 < t6_t0_t4_mem1*ADD_mem[3]
	...
	S += (t6_t0_s01*ADD[0])-1 < t6_t0_s02_mem0*ADD_mem[0]
	S += (t6_t0_s01*ADD[1])-1 < t6_t0_s02_mem0*ADD_mem[1]
	S += (t6_t0_s01*ADD[2])-1 < t6_t0_s02_mem0*ADD_mem[2]
	S += (t6_t0_s01*ADD[3])-1 < t6_t0_s02_mem0*ADD_mem[3]
	...
	S += (t6_t0_t0*MUL[0])-1 < t6_t0_t5_mem0*MUL_mem[0]
	...
	S += (t6_t30*ADD[0])-1 < t6_t4_t0_mem1*ADD_mem[0]
	S += (t6_t30*ADD[1])-1 < t6_t4_t0_mem1*ADD_mem[1]
	S += (t6_t30*ADD[2])-1 < t6_t4_t0_mem1*ADD_mem[2]
	S += (t6_t30*ADD[3])-1 < t6_t4_t0_mem1*ADD_mem[3]
	...
	S += (t6_t30*ADD[0])-1 < t6_t4_t3_mem0*ADD_mem[0]
	S += (t6_t30*ADD[1])-1 < t6_t4_t3_mem0*ADD_mem[1]
	S += (t6_t30*ADD[2])-1 < t6_t4_t3_mem0*ADD_mem[2]
	S += (t6_t30*ADD[3])-1 < t6_t4_t3_mem0*ADD_mem[3]
	...
	S += (t6_t4_s00*ADD[0])-1 < t6_t4_s01_mem0*ADD_mem[0]
	S += (t6_t4_s00*ADD[1])-1 < t6_t4_s01_mem0*ADD_mem[1]
	S += (t6_t4_s00*ADD[2])-1 < t6_t4_s01_mem0*ADD_mem[2]
	S += (t6_t4_s00*ADD[3])-1 < t6_t4_s01_mem0*ADD_mem[3]
	S += t6_t4_s01_mem0 <= t6_t4_s01

	t6_t4_s01_mem1 = S.Task('t6_t4_s01_mem1', length=1, delay_cost=1)
	t6_t4_s01_mem1 += alt(MUL_mem)
	S += (t6_t4_t1*MUL[0])-1 < t6_t4_s01_mem1*MUL_mem[0]
	...
	S += (t6_s0_y1_0*ADD[0])-1 < t6_s0_y1_1_mem0*ADD_mem[0]
	S += (t6_s0_y1_0*ADD[1])-1 < t6_s0_y1_1_mem0*ADD_mem[1]
	S += (t6_s0_y1_0*ADD[2])-1 < t6_s0_y1_1_mem0*ADD_mem[2]
	S += (t6_s0_y1_0*ADD[3])-1 < t6_s0_y1_1_mem0*ADD_mem[3]
	S += t6_s0_y1_1_mem0 <= t6_s0_y1_1

	t6_s0_y1_1_mem1 = S.Task('t6_s0_y1_1_mem1', length=1, delay_cost=1)
	t6_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t6_t11*ADD[0])-1 < t6_s0_y1_1_mem1*ADD_mem[0]
	S += (t6_t11*ADD[1])-1 < t6_s0_y1_1_mem1*ADD_mem[1]
	S += (t6_t11*ADD[2])-1 < t6_s0_y1_1_mem1*ADD_mem[2]
	S += (t6_t11*ADD[3])-1 < t6_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t7_t0_t3*ADD[0])-1 < t7_t0_t4_mem1*ADD_mem[0]
	S += (t7_t0_t3*ADD[1])-1 < t7_t0_t4_mem1*ADD_mem[1]
	S += (t7_t0_t3*ADD[2])-1 < t7_t0_t4_mem1*ADD_mem[2]
	S += (t7_t0_t3*ADD[3])-1 < t7_t0_t4_mem1*ADD_mem[3]
	...
	S += (t7_t0_s01*ADD[0])-1 < t7_t0_s02_mem0*ADD_mem[0]
	S += (t7_t0_s01*ADD[1])-1 < t7_t0_s02_mem0*ADD_mem[1]
	S += (t7_t0_s01*ADD[2])-1 < t7_t0_s02_mem0*ADD_mem[2]
	S += (t7_t0_s01*ADD[3])-1 < t7_t0_s02_mem0*ADD_mem[3]
	...
	S += (t7_t0_t0*MUL[0])-1 < t7_t0_t5_mem0*MUL_mem[0]
	...
	S += (t7_t30*ADD[0])-1 < t7_t4_t0_mem1*ADD_mem[0]
	S += (t7_t30*ADD[1])-1 < t7_t4_t0_mem1*ADD_mem[1]
	S += (t7_t30*ADD[2])-1 < t7_t4_t0_mem1*ADD_mem[2]
	S += (t7_t30*ADD[3])-1 < t7_t4_t0_mem1*ADD_mem[3]
	...
	S += (t7_t30*ADD[0])-1 < t7_t4_t3_mem0*ADD_mem[0]
	S += (t7_t30*ADD[1])-1 < t7_t4_t3_mem0*ADD_mem[1]
	S += (t7_t30*ADD[2])-1 < t7_t4_t3_mem0*ADD_mem[2]
	S += (t7_t30*ADD[3])-1 < t7_t4_t3_mem0*ADD_mem[3]
	...
	S += (t7_t4_s00*ADD[0])-1 < t7_t4_s01_mem0*ADD_mem[0]
	S += (t7_t4_s00*ADD[1])-1 < t7_t4_s01_mem0*ADD_mem[1]
	S += (t7_t4_s00*ADD[2])-1 < t7_t4_s01_mem0*ADD_mem[2]
	S += (t7_t4_s00*ADD[3])-1 < t7_t4_s01_mem0*ADD_mem[3]
	S += t7_t4_s01_mem0 <= t7_t4_s01

	t7_t4_s01_mem1 = S.Task('t7_t4_s01_mem1', length=1, delay_cost=1)
	t7_t4_s01_mem1 += alt(MUL_mem)
	S += (t7_t4_t1*MUL[0])-1 < t7_t4_s01_mem1*MUL_mem[0]
	...
	S += (t7_s0_y1_0*ADD[0])-1 < t7_s0_y1_1_mem0*ADD_mem[0]
	S += (t7_s0_y1_0*ADD[1])-1 < t7_s0_y1_1_mem0*ADD_mem[1]
	S += (t7_s0_y1_0*ADD[2])-1 < t7_s0_y1_1_mem0*ADD_mem[2]
	S += (t7_s0_y1_0*ADD[3])-1 < t7_s0_y1_1_mem0*ADD_mem[3]
	S += t7_s0_y1_1_mem0 <= t7_s0_y1_1

	t7_s0_y1_1_mem1 = S.Task('t7_s0_y1_1_mem1', length=1, delay_cost=1)
	t7_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t7_t11*ADD[0])-1 < t7_s0_y1_1_mem1*ADD_mem[0]
	S += (t7_t11*ADD[1])-1 < t7_s0_y1_1_mem1*ADD_mem[1]
	S += (t7_t11*ADD[2])-1 < t7_s0_y1_1_mem1*ADD_mem[2]
	S += (t7_t11*ADD[3])-1 < t7_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t9_t0_t3*ADD[0])-1 < t9_t0_t4_mem1*ADD_mem[0]
	S += (t9_t0_t3*ADD[1])-1 < t9_t0_t4_mem1*ADD_mem[1]
	S += (t9_t0_t3*ADD[2])-1 < t9_t0_t4_mem1*ADD_mem[2]
	S += (t9_t0_t3*ADD[3])-1 < t9_t0_t4_mem1*ADD_mem[3]
	...
	S += (t9_t0_s01*ADD[0])-1 < t9_t0_s02_mem0*ADD_mem[0]
	S += (t9_t0_s01*ADD[1])-1 < t9_t0_s02_mem0*ADD_mem[1]
	S += (t9_t0_s01*ADD[2])-1 < t9_t0_s02_mem0*ADD_mem[2]
	S += (t9_t0_s01*ADD[3])-1 < t9_t0_s02_mem0*ADD_mem[3]
	...
	S += (t9_t0_t0*MUL[0])-1 < t9_t0_t5_mem0*MUL_mem[0]
	...
	S += (t9_t30*ADD[0])-1 < t9_t4_t0_mem1*ADD_mem[0]
	S += (t9_t30*ADD[1])-1 < t9_t4_t0_mem1*ADD_mem[1]
	S += (t9_t30*ADD[2])-1 < t9_t4_t0_mem1*ADD_mem[2]
	S += (t9_t30*ADD[3])-1 < t9_t4_t0_mem1*ADD_mem[3]
	...
	S += (t9_t30*ADD[0])-1 < t9_t4_t3_mem0*ADD_mem[0]
	S += (t9_t30*ADD[1])-1 < t9_t4_t3_mem0*ADD_mem[1]
	S += (t9_t30*ADD[2])-1 < t9_t4_t3_mem0*ADD_mem[2]
	S += (t9_t30*ADD[3])-1 < t9_t4_t3_mem0*ADD_mem[3]
	...
	S += (t9_t4_s00*ADD[0])-1 < t9_t4_s01_mem0*ADD_mem[0]
	S += (t9_t4_s00*ADD[1])-1 < t9_t4_s01_mem0*ADD_mem[1]
	S += (t9_t4_s00*ADD[2])-1 < t9_t4_s01_mem0*ADD_mem[2]
	S += (t9_t4_s00*ADD[3])-1 < t9_t4_s01_mem0*ADD_mem[3]
	S += t9_t4_s01_mem0 <= t9_t4_s01

	t9_t4_s01_mem1 = S.Task('t9_t4_s01_mem1', length=1, delay_cost=1)
	t9_t4_s01_mem1 += alt(MUL_mem)
	S += (t9_t4_t1*MUL[0])-1 < t9_t4_s01_mem1*MUL_mem[0]
	...
	S += (t9_s0_y1_0*ADD[0])-1 < t9_s0_y1_1_mem0*ADD_mem[0]
	S += (t9_s0_y1_0*ADD[1])-1 < t9_s0_y1_1_mem0*ADD_mem[1]
	S += (t9_s0_y1_0*ADD[2])-1 < t9_s0_y1_1_mem0*ADD_mem[2]
	S += (t9_s0_y1_0*ADD[3])-1 < t9_s0_y1_1_mem0*ADD_mem[3]
	S += t9_s0_y1_1_mem0 <= t9_s0_y1_1

	t9_s0_y1_1_mem1 = S.Task('t9_s0_y1_1_mem1', length=1, delay_cost=1)
	t9_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t9_t11*ADD[0])-1 < t9_s0_y1_1_mem1*ADD_mem[0]
	S += (t9_t11*ADD[1])-1 < t9_s0_y1_1_mem1*ADD_mem[1]
	S += (t9_t11*ADD[2])-1 < t9_s0_y1_1_mem1*ADD_mem[2]
	S += (t9_t11*ADD[3])-1 < t9_s0_y1_1_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PADD_mul1_add4/PADD_8.png"
	if(S.solution() != []):
