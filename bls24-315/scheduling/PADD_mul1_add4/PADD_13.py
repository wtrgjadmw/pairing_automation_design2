...
def solve():
	...
	S += new_TZ_s0_y1_1 >= 162
	new_TZ_s0_y1_1 += ADD[0]
	...
	S += new_TZ_s0_y1_2_mem0 >= 163
	new_TZ_s0_y1_2_mem0 += ADD_mem[0]
	...
	S += new_TZ_s0_y1_2 >= 164
	new_TZ_s0_y1_2 += ADD[2]
	...
	S += new_TZ_s0_y1_3_mem0 >= 165
	new_TZ_s0_y1_3_mem0 += ADD_mem[2]
	...
	S += t14_s0_y1_3_mem0 >= 165
	t14_s0_y1_3_mem0 += ADD_mem[3]
