...
def solve():
	...
	S += (t0_t0_s00*ADD[0]) < t0_t0_s01_mem0*ADD_mem[0]
	S += (t0_t0_s00*ADD[1]) < t0_t0_s01_mem0*ADD_mem[1]
	S += (t0_t0_s00*ADD[2]) < t0_t0_s01_mem0*ADD_mem[2]
	S += (t0_t0_s00*ADD[3]) < t0_t0_s01_mem0*ADD_mem[3]
	...
	S += (t0_t1_s00*ADD[0]) < t0_t1_s01_mem0*ADD_mem[0]
	S += (t0_t1_s00*ADD[1]) < t0_t1_s01_mem0*ADD_mem[1]
	S += (t0_t1_s00*ADD[2]) < t0_t1_s01_mem0*ADD_mem[2]
	S += (t0_t1_s00*ADD[3]) < t0_t1_s01_mem0*ADD_mem[3]
	...
	S += (t0_t4_t1*MUL[0]) < t0_t4_s00_mem0*MUL_mem[0]
	...
	S += (t2_t0_s00*ADD[0]) < t2_t0_s01_mem0*ADD_mem[0]
	S += (t2_t0_s00*ADD[1]) < t2_t0_s01_mem0*ADD_mem[1]
	S += (t2_t0_s00*ADD[2]) < t2_t0_s01_mem0*ADD_mem[2]
	S += (t2_t0_s00*ADD[3]) < t2_t0_s01_mem0*ADD_mem[3]
	...
	S += (t2_t4_t1*MUL[0]) < t2_t4_s00_mem0*MUL_mem[0]
	...
	S += (t0_t0_s01*ADD[0]) < t0_t0_s02_mem0*ADD_mem[0]
	S += (t0_t0_s01*ADD[1]) < t0_t0_s02_mem0*ADD_mem[1]
	S += (t0_t0_s01*ADD[2]) < t0_t0_s02_mem0*ADD_mem[2]
	S += (t0_t0_s01*ADD[3]) < t0_t0_s02_mem0*ADD_mem[3]
	...
	S += (t0_t1_s01*ADD[0]) < t0_t1_s02_mem0*ADD_mem[0]
	S += (t0_t1_s01*ADD[1]) < t0_t1_s02_mem0*ADD_mem[1]
	S += (t0_t1_s01*ADD[2]) < t0_t1_s02_mem0*ADD_mem[2]
	S += (t0_t1_s01*ADD[3]) < t0_t1_s02_mem0*ADD_mem[3]
	...
	S += (t0_t4_s00*ADD[0]) < t0_t4_s01_mem0*ADD_mem[0]
	S += (t0_t4_s00*ADD[1]) < t0_t4_s01_mem0*ADD_mem[1]
	S += (t0_t4_s00*ADD[2]) < t0_t4_s01_mem0*ADD_mem[2]
	S += (t0_t4_s00*ADD[3]) < t0_t4_s01_mem0*ADD_mem[3]
	S += t0_t4_s01_mem0 <= t0_t4_s01

	t0_t4_s01_mem1 = S.Task('t0_t4_s01_mem1', length=1, delay_cost=1)
	t0_t4_s01_mem1 += alt(MUL_mem)
	S += (t0_t4_t1*MUL[0]) < t0_t4_s01_mem1*MUL_mem[0]
	...
	S += (t0_t11*ADD[0]) < t0_s0_y1_0_mem0*ADD_mem[0]
	S += (t0_t11*ADD[1]) < t0_s0_y1_0_mem0*ADD_mem[1]
	S += (t0_t11*ADD[2]) < t0_s0_y1_0_mem0*ADD_mem[2]
	S += (t0_t11*ADD[3]) < t0_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t2_t1_s01*ADD[0]) < t2_t1_s02_mem0*ADD_mem[0]
	S += (t2_t1_s01*ADD[1]) < t2_t1_s02_mem0*ADD_mem[1]
	S += (t2_t1_s01*ADD[2]) < t2_t1_s02_mem0*ADD_mem[2]
	S += (t2_t1_s01*ADD[3]) < t2_t1_s02_mem0*ADD_mem[3]
	...
	S += (t2_t4_t1*MUL[0]) < t2_t4_s01_mem1*MUL_mem[0]
	...
	S += (t0_t0_s02*ADD[0]) < t0_t0_s03_mem0*ADD_mem[0]
	S += (t0_t0_s02*ADD[1]) < t0_t0_s03_mem0*ADD_mem[1]
	S += (t0_t0_s02*ADD[2]) < t0_t0_s03_mem0*ADD_mem[2]
	S += (t0_t0_s02*ADD[3]) < t0_t0_s03_mem0*ADD_mem[3]
	...
	S += (t0_t1_s02*ADD[0]) < t0_t1_s03_mem0*ADD_mem[0]
	S += (t0_t1_s02*ADD[1]) < t0_t1_s03_mem0*ADD_mem[1]
	S += (t0_t1_s02*ADD[2]) < t0_t1_s03_mem0*ADD_mem[2]
	S += (t0_t1_s02*ADD[3]) < t0_t1_s03_mem0*ADD_mem[3]
	...
	S += (t0_t4_s01*ADD[0]) < t0_t4_s02_mem0*ADD_mem[0]
	S += (t0_t4_s01*ADD[1]) < t0_t4_s02_mem0*ADD_mem[1]
	S += (t0_t4_s01*ADD[2]) < t0_t4_s02_mem0*ADD_mem[2]
	S += (t0_t4_s01*ADD[3]) < t0_t4_s02_mem0*ADD_mem[3]
	...
	S += (t0_s0_y1_0*ADD[0]) < t0_s0_y1_1_mem0*ADD_mem[0]
	S += (t0_s0_y1_0*ADD[1]) < t0_s0_y1_1_mem0*ADD_mem[1]
	S += (t0_s0_y1_0*ADD[2]) < t0_s0_y1_1_mem0*ADD_mem[2]
	S += (t0_s0_y1_0*ADD[3]) < t0_s0_y1_1_mem0*ADD_mem[3]
	S += t0_s0_y1_1_mem0 <= t0_s0_y1_1

	t0_s0_y1_1_mem1 = S.Task('t0_s0_y1_1_mem1', length=1, delay_cost=1)
	t0_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t0_t11*ADD[0]) < t0_s0_y1_1_mem1*ADD_mem[0]
	S += (t0_t11*ADD[1]) < t0_s0_y1_1_mem1*ADD_mem[1]
	S += (t0_t11*ADD[2]) < t0_s0_y1_1_mem1*ADD_mem[2]
	S += (t0_t11*ADD[3]) < t0_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t2_s0_y1_0*ADD[0]) < t2_s0_y1_1_mem0*ADD_mem[0]
	S += (t2_s0_y1_0*ADD[1]) < t2_s0_y1_1_mem0*ADD_mem[1]
	S += (t2_s0_y1_0*ADD[2]) < t2_s0_y1_1_mem0*ADD_mem[2]
	S += (t2_s0_y1_0*ADD[3]) < t2_s0_y1_1_mem0*ADD_mem[3]
	S += t2_s0_y1_1_mem0 <= t2_s0_y1_1

	t2_s0_y1_1_mem1 = S.Task('t2_s0_y1_1_mem1', length=1, delay_cost=1)
	t2_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t2_t11*ADD[0]) < t2_s0_y1_1_mem1*ADD_mem[0]
	S += (t2_t11*ADD[1]) < t2_s0_y1_1_mem1*ADD_mem[1]
	S += (t2_t11*ADD[2]) < t2_s0_y1_1_mem1*ADD_mem[2]
	S += (t2_t11*ADD[3]) < t2_s0_y1_1_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PADD_mul1_add4/PADD_2.png"
	if(S.solution() != []):
