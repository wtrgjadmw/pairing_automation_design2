...
def solve():
	...
	S += (t4_t2_s01*ADD[0]) < t4_t2_s02_mem0*ADD_mem[0]
	S += (t4_t2_s01*ADD[1]) < t4_t2_s02_mem0*ADD_mem[1]
	S += (t4_t2_s01*ADD[2]) < t4_t2_s02_mem0*ADD_mem[2]
	S += (t4_t2_s01*ADD[3]) < t4_t2_s02_mem0*ADD_mem[3]
	...
	S += (t4_t3_s03*ADD[0]) < t4_t3_s04_mem0*ADD_mem[0]
	S += (t4_t3_s03*ADD[1]) < t4_t3_s04_mem0*ADD_mem[1]
	S += (t4_t3_s03*ADD[2]) < t4_t3_s04_mem0*ADD_mem[2]
	S += (t4_t3_s03*ADD[3]) < t4_t3_s04_mem0*ADD_mem[3]
	...
	S += (t4_t4_y1_0*ADD[0]) < t4_t4_y1_1_mem0*ADD_mem[0]
	S += (t4_t4_y1_0*ADD[1]) < t4_t4_y1_1_mem0*ADD_mem[1]
	S += (t4_t4_y1_0*ADD[2]) < t4_t4_y1_1_mem0*ADD_mem[2]
	S += (t4_t4_y1_0*ADD[3]) < t4_t4_y1_1_mem0*ADD_mem[3]
	S += t4_t4_y1_1_mem0 <= t4_t4_y1_1

	t4_t4_y1_1_mem1 = S.Task('t4_t4_y1_1_mem1', length=1, delay_cost=1)
	t4_t4_y1_1_mem1 += ADD_mem[1]
	S += 89 < t4_t4_y1_1_mem1
	...
	S += (t5_t2_s01*ADD[0]) < t5_t2_s02_mem0*ADD_mem[0]
	S += (t5_t2_s01*ADD[1]) < t5_t2_s02_mem0*ADD_mem[1]
	S += (t5_t2_s01*ADD[2]) < t5_t2_s02_mem0*ADD_mem[2]
	S += (t5_t2_s01*ADD[3]) < t5_t2_s02_mem0*ADD_mem[3]
	...
	S += (t5_t3_s03*ADD[0]) < t5_t3_s04_mem0*ADD_mem[0]
	S += (t5_t3_s03*ADD[1]) < t5_t3_s04_mem0*ADD_mem[1]
	S += (t5_t3_s03*ADD[2]) < t5_t3_s04_mem0*ADD_mem[2]
	S += (t5_t3_s03*ADD[3]) < t5_t3_s04_mem0*ADD_mem[3]
	...
	S += (t5_t4_y1_0*ADD[0]) < t5_t4_y1_1_mem0*ADD_mem[0]
	S += (t5_t4_y1_0*ADD[1]) < t5_t4_y1_1_mem0*ADD_mem[1]
	S += (t5_t4_y1_0*ADD[2]) < t5_t4_y1_1_mem0*ADD_mem[2]
	S += (t5_t4_y1_0*ADD[3]) < t5_t4_y1_1_mem0*ADD_mem[3]
	S += t5_t4_y1_1_mem0 <= t5_t4_y1_1

	t5_t4_y1_1_mem1 = S.Task('t5_t4_y1_1_mem1', length=1, delay_cost=1)
	t5_t4_y1_1_mem1 += ADD_mem[2]
	S += 85 < t5_t4_y1_1_mem1
	...
	S += (t16_t0_s03*ADD[0]) < t16_t0_s04_mem0*ADD_mem[0]
	S += (t16_t0_s03*ADD[1]) < t16_t0_s04_mem0*ADD_mem[1]
	S += (t16_t0_s03*ADD[2]) < t16_t0_s04_mem0*ADD_mem[2]
	S += (t16_t0_s03*ADD[3]) < t16_t0_s04_mem0*ADD_mem[3]
	S += t16_t0_s04_mem0 <= t16_t0_s04

	t16_t0_s04_mem1 = S.Task('t16_t0_s04_mem1', length=1, delay_cost=1)
	t16_t0_s04_mem1 += MUL_mem[0]
	S += 65 < t16_t0_s04_mem1
	...
	S += (t16_t4_s02*ADD[0]) < t16_t4_s03_mem0*ADD_mem[0]
	S += (t16_t4_s02*ADD[1]) < t16_t4_s03_mem0*ADD_mem[1]
	S += (t16_t4_s02*ADD[2]) < t16_t4_s03_mem0*ADD_mem[2]
	S += (t16_t4_s02*ADD[3]) < t16_t4_s03_mem0*ADD_mem[3]
	...
	S += (t16_s0_y1_0*ADD[0]) < t16_s0_y1_1_mem0*ADD_mem[0]
	S += (t16_s0_y1_0*ADD[1]) < t16_s0_y1_1_mem0*ADD_mem[1]
	S += (t16_s0_y1_0*ADD[2]) < t16_s0_y1_1_mem0*ADD_mem[2]
	S += (t16_s0_y1_0*ADD[3]) < t16_s0_y1_1_mem0*ADD_mem[3]
	S += t16_s0_y1_1_mem0 <= t16_s0_y1_1

	t16_s0_y1_1_mem1 = S.Task('t16_s0_y1_1_mem1', length=1, delay_cost=1)
	t16_s0_y1_1_mem1 += ADD_mem[2]
	S += 83 < t16_s0_y1_1_mem1
	...
	S += (t1601*ADD[0]) < c1101_mem0*ADD_mem[0]
	S += (t1601*ADD[1]) < c1101_mem0*ADD_mem[1]
	S += (t1601*ADD[2]) < c1101_mem0*ADD_mem[2]
	S += (t1601*ADD[3]) < c1101_mem0*ADD_mem[3]
	S += c1101_mem0 <= c1101

	c1101_mem1 = S.Task('c1101_mem1', length=1, delay_cost=1)
	c1101_mem1 += alt(ADD_mem)
	S += (t1701*ADD[0]) < c1101_mem1*ADD_mem[0]
	S += (t1701*ADD[1]) < c1101_mem1*ADD_mem[1]
	S += (t1701*ADD[2]) < c1101_mem1*ADD_mem[2]
	S += (t1701*ADD[3]) < c1101_mem1*ADD_mem[3]
	S += c1101_mem1 <= c1101
	...
	S += (t4_t2_s02*ADD[0]) < t4_t2_s03_mem0*ADD_mem[0]
	S += (t4_t2_s02*ADD[1]) < t4_t2_s03_mem0*ADD_mem[1]
	S += (t4_t2_s02*ADD[2]) < t4_t2_s03_mem0*ADD_mem[2]
	S += (t4_t2_s02*ADD[3]) < t4_t2_s03_mem0*ADD_mem[3]
	...
	S += (t4_t3_s04*ADD[0]) < t4_t30_mem1*ADD_mem[0]
	S += (t4_t3_s04*ADD[1]) < t4_t30_mem1*ADD_mem[1]
	S += (t4_t3_s04*ADD[2]) < t4_t30_mem1*ADD_mem[2]
	S += (t4_t3_s04*ADD[3]) < t4_t30_mem1*ADD_mem[3]
	...
	S += (t4_t4_y1_1*ADD[0]) < t4_t4_y1_2_mem0*ADD_mem[0]
	S += (t4_t4_y1_1*ADD[1]) < t4_t4_y1_2_mem0*ADD_mem[1]
	S += (t4_t4_y1_1*ADD[2]) < t4_t4_y1_2_mem0*ADD_mem[2]
	S += (t4_t4_y1_1*ADD[3]) < t4_t4_y1_2_mem0*ADD_mem[3]
	...
	S += (t5_t2_s02*ADD[0]) < t5_t2_s03_mem0*ADD_mem[0]
	S += (t5_t2_s02*ADD[1]) < t5_t2_s03_mem0*ADD_mem[1]
	S += (t5_t2_s02*ADD[2]) < t5_t2_s03_mem0*ADD_mem[2]
	S += (t5_t2_s02*ADD[3]) < t5_t2_s03_mem0*ADD_mem[3]
	...
	S += (t5_t3_s04*ADD[0]) < t5_t30_mem1*ADD_mem[0]
	S += (t5_t3_s04*ADD[1]) < t5_t30_mem1*ADD_mem[1]
	S += (t5_t3_s04*ADD[2]) < t5_t30_mem1*ADD_mem[2]
	S += (t5_t3_s04*ADD[3]) < t5_t30_mem1*ADD_mem[3]
	...
	S += (t5_t4_y1_1*ADD[0]) < t5_t4_y1_2_mem0*ADD_mem[0]
	S += (t5_t4_y1_1*ADD[1]) < t5_t4_y1_2_mem0*ADD_mem[1]
	S += (t5_t4_y1_1*ADD[2]) < t5_t4_y1_2_mem0*ADD_mem[2]
	S += (t5_t4_y1_1*ADD[3]) < t5_t4_y1_2_mem0*ADD_mem[3]
	...
	S += (t6_t1_t1*MUL[0]) < t6_t1_s00_mem0*MUL_mem[0]
	...
	S += (t7_t1_t1*MUL[0]) < t7_t1_s00_mem0*MUL_mem[0]
	...
	S += (t9_t1_t1*MUL[0]) < t9_t1_s00_mem0*MUL_mem[0]
	...
	S += (t16_t0_s04*ADD[0]) < t16_t00_mem1*ADD_mem[0]
	S += (t16_t0_s04*ADD[1]) < t16_t00_mem1*ADD_mem[1]
	S += (t16_t0_s04*ADD[2]) < t16_t00_mem1*ADD_mem[2]
	S += (t16_t0_s04*ADD[3]) < t16_t00_mem1*ADD_mem[3]
	...
	S += (t16_t4_s03*ADD[0]) < t16_t4_s04_mem0*ADD_mem[0]
	S += (t16_t4_s03*ADD[1]) < t16_t4_s04_mem0*ADD_mem[1]
	S += (t16_t4_s03*ADD[2]) < t16_t4_s04_mem0*ADD_mem[2]
	S += (t16_t4_s03*ADD[3]) < t16_t4_s04_mem0*ADD_mem[3]
	S += t16_t4_s04_mem0 <= t16_t4_s04

	t16_t4_s04_mem1 = S.Task('t16_t4_s04_mem1', length=1, delay_cost=1)
	t16_t4_s04_mem1 += MUL_mem[0]
	S += 78 < t16_t4_s04_mem1
	...
	S += (t16_s0_y1_1*ADD[0]) < t16_s0_y1_2_mem0*ADD_mem[0]
	S += (t16_s0_y1_1*ADD[1]) < t16_s0_y1_2_mem0*ADD_mem[1]
	S += (t16_s0_y1_1*ADD[2]) < t16_s0_y1_2_mem0*ADD_mem[2]
	S += (t16_s0_y1_1*ADD[3]) < t16_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (t1611*ADD[0]) < c1111_mem0*ADD_mem[0]
	S += (t1611*ADD[1]) < c1111_mem0*ADD_mem[1]
	S += (t1611*ADD[2]) < c1111_mem0*ADD_mem[2]
	S += (t1611*ADD[3]) < c1111_mem0*ADD_mem[3]
	S += c1111_mem0 <= c1111

	c1111_mem1 = S.Task('c1111_mem1', length=1, delay_cost=1)
	c1111_mem1 += alt(ADD_mem)
	S += (t1711*ADD[0]) < c1111_mem1*ADD_mem[0]
	S += (t1711*ADD[1]) < c1111_mem1*ADD_mem[1]
	S += (t1711*ADD[2]) < c1111_mem1*ADD_mem[2]
	S += (t1711*ADD[3]) < c1111_mem1*ADD_mem[3]
	S += c1111_mem1 <= c1111
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PADD_mul1_add4/PADD_6.png"
	if(S.solution() != []):
