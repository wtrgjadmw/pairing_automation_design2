...
def solve():
	...
	t16_t4_t1_mem1 += alt(ADD_mem)
	S += (t16_t31*ADD[0]) < t16_t4_t1_mem1*ADD_mem[0]
	S += (t16_t31*ADD[1]) < t16_t4_t1_mem1*ADD_mem[1]
	S += (t16_t31*ADD[2]) < t16_t4_t1_mem1*ADD_mem[2]
	S += (t16_t31*ADD[3]) < t16_t4_t1_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PADD_mul1_add4/PADD_4.png"
	if(S.solution() != []):
