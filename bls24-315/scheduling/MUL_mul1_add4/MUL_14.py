...
def solve():
	horizon = 289
	S = Scenario("MUL_14", horizon=horizon)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/MUL_mul1_add4/MUL_14.png"
	if(S.solution() != []):
