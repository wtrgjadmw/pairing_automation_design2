...
def solve():
	...
	t5_t4_s01_mem0 += alt(ADD_mem)
	S += (t5_t4_s00*ADD[0]) < t5_t4_s01_mem0*ADD_mem[0]
	S += (t5_t4_s00*ADD[1]) < t5_t4_s01_mem0*ADD_mem[1]
	S += (t5_t4_s00*ADD[2]) < t5_t4_s01_mem0*ADD_mem[2]
	S += (t5_t4_s00*ADD[3]) < t5_t4_s01_mem0*ADD_mem[3]
