...
def solve():
	...
	S += (t0_a1__y1_3*ADD[0])-1 < t0_a1__y1_4_mem0*ADD_mem[0]
	S += (t0_a1__y1_3*ADD[1])-1 < t0_a1__y1_4_mem0*ADD_mem[1]
	S += (t0_a1__y1_3*ADD[2])-1 < t0_a1__y1_4_mem0*ADD_mem[2]
	S += (t0_a1__y1_3*ADD[3])-1 < t0_a1__y1_4_mem0*ADD_mem[3]
	...
	S += (t0_t2_s01*ADD[0])-1 < t0_t2_s02_mem0*ADD_mem[0]
	S += (t0_t2_s01*ADD[1])-1 < t0_t2_s02_mem0*ADD_mem[1]
	S += (t0_t2_s01*ADD[2])-1 < t0_t2_s02_mem0*ADD_mem[2]
	S += (t0_t2_s01*ADD[3])-1 < t0_t2_s02_mem0*ADD_mem[3]
	...
	S += (t0_t3_s02*ADD[0])-1 < t0_t3_s03_mem0*ADD_mem[0]
	S += (t0_t3_s02*ADD[1])-1 < t0_t3_s03_mem0*ADD_mem[1]
	S += (t0_t3_s02*ADD[2])-1 < t0_t3_s03_mem0*ADD_mem[2]
	S += (t0_t3_s02*ADD[3])-1 < t0_t3_s03_mem0*ADD_mem[3]
	...
	S += (t0_t4_y1_0*ADD[0])-1 < t0_t4_y1_1_mem0*ADD_mem[0]
	S += (t0_t4_y1_0*ADD[1])-1 < t0_t4_y1_1_mem0*ADD_mem[1]
	S += (t0_t4_y1_0*ADD[2])-1 < t0_t4_y1_1_mem0*ADD_mem[2]
	S += (t0_t4_y1_0*ADD[3])-1 < t0_t4_y1_1_mem0*ADD_mem[3]
	S += t0_t4_y1_1_mem0 <= t0_t4_y1_1

	t0_t4_y1_1_mem1 = S.Task('t0_t4_y1_1_mem1', length=1, delay_cost=1)
	t0_t4_y1_1_mem1 += ADD_mem[1]
	S += 30 < t0_t4_y1_1_mem1
	...
	S += (t1_a1__y1_3*ADD[0])-1 < t1_a1__y1_4_mem0*ADD_mem[0]
	S += (t1_a1__y1_3*ADD[1])-1 < t1_a1__y1_4_mem0*ADD_mem[1]
	S += (t1_a1__y1_3*ADD[2])-1 < t1_a1__y1_4_mem0*ADD_mem[2]
	S += (t1_a1__y1_3*ADD[3])-1 < t1_a1__y1_4_mem0*ADD_mem[3]
	...
	S += (t1_t2_s01*ADD[0])-1 < t1_t2_s02_mem0*ADD_mem[0]
	S += (t1_t2_s01*ADD[1])-1 < t1_t2_s02_mem0*ADD_mem[1]
	S += (t1_t2_s01*ADD[2])-1 < t1_t2_s02_mem0*ADD_mem[2]
	S += (t1_t2_s01*ADD[3])-1 < t1_t2_s02_mem0*ADD_mem[3]
	...
	S += (t1_t3_s02*ADD[0])-1 < t1_t3_s03_mem0*ADD_mem[0]
	S += (t1_t3_s02*ADD[1])-1 < t1_t3_s03_mem0*ADD_mem[1]
	S += (t1_t3_s02*ADD[2])-1 < t1_t3_s03_mem0*ADD_mem[2]
	S += (t1_t3_s02*ADD[3])-1 < t1_t3_s03_mem0*ADD_mem[3]
	...
	S += (t1_t4_y1_0*ADD[0])-1 < t1_t4_y1_1_mem0*ADD_mem[0]
	S += (t1_t4_y1_0*ADD[1])-1 < t1_t4_y1_1_mem0*ADD_mem[1]
	S += (t1_t4_y1_0*ADD[2])-1 < t1_t4_y1_1_mem0*ADD_mem[2]
	S += (t1_t4_y1_0*ADD[3])-1 < t1_t4_y1_1_mem0*ADD_mem[3]
	S += t1_t4_y1_1_mem0 <= t1_t4_y1_1

	t1_t4_y1_1_mem1 = S.Task('t1_t4_y1_1_mem1', length=1, delay_cost=1)
	t1_t4_y1_1_mem1 += ADD_mem[0]
	S += 28 < t1_t4_y1_1_mem1
	...
	S += (t5_t0_s02*ADD[0])-1 < t5_t0_s03_mem0*ADD_mem[0]
	S += (t5_t0_s02*ADD[1])-1 < t5_t0_s03_mem0*ADD_mem[1]
	S += (t5_t0_s02*ADD[2])-1 < t5_t0_s03_mem0*ADD_mem[2]
	S += (t5_t0_s02*ADD[3])-1 < t5_t0_s03_mem0*ADD_mem[3]
	...
	S += (t5_t1_s02*ADD[0])-1 < t5_t1_s03_mem0*ADD_mem[0]
	S += (t5_t1_s02*ADD[1])-1 < t5_t1_s03_mem0*ADD_mem[1]
	S += (t5_t1_s02*ADD[2])-1 < t5_t1_s03_mem0*ADD_mem[2]
	S += (t5_t1_s02*ADD[3])-1 < t5_t1_s03_mem0*ADD_mem[3]
	...
	S += (t5_t4_s01*ADD[0])-1 < t5_t4_s02_mem0*ADD_mem[0]
	S += (t5_t4_s01*ADD[1])-1 < t5_t4_s02_mem0*ADD_mem[1]
	S += (t5_t4_s01*ADD[2])-1 < t5_t4_s02_mem0*ADD_mem[2]
	S += (t5_t4_s01*ADD[3])-1 < t5_t4_s02_mem0*ADD_mem[3]
	...
	S += (t5_s0_y1_0*ADD[0])-1 < t5_s0_y1_1_mem0*ADD_mem[0]
	S += (t5_s0_y1_0*ADD[1])-1 < t5_s0_y1_1_mem0*ADD_mem[1]
	S += (t5_s0_y1_0*ADD[2])-1 < t5_s0_y1_1_mem0*ADD_mem[2]
	S += (t5_s0_y1_0*ADD[3])-1 < t5_s0_y1_1_mem0*ADD_mem[3]
	S += t5_s0_y1_1_mem0 <= t5_s0_y1_1

	t5_s0_y1_1_mem1 = S.Task('t5_s0_y1_1_mem1', length=1, delay_cost=1)
	t5_s0_y1_1_mem1 += ADD_mem[0]
	S += 36 < t5_s0_y1_1_mem1
	...
	S += (t7_a1__y1_3*ADD[0])-1 < t7_a1__y1_4_mem0*ADD_mem[0]
	S += (t7_a1__y1_3*ADD[1])-1 < t7_a1__y1_4_mem0*ADD_mem[1]
	S += (t7_a1__y1_3*ADD[2])-1 < t7_a1__y1_4_mem0*ADD_mem[2]
	S += (t7_a1__y1_3*ADD[3])-1 < t7_a1__y1_4_mem0*ADD_mem[3]
	...
	S += (t7_t2_s01*ADD[0])-1 < t7_t2_s02_mem0*ADD_mem[0]
	S += (t7_t2_s01*ADD[1])-1 < t7_t2_s02_mem0*ADD_mem[1]
	S += (t7_t2_s01*ADD[2])-1 < t7_t2_s02_mem0*ADD_mem[2]
	S += (t7_t2_s01*ADD[3])-1 < t7_t2_s02_mem0*ADD_mem[3]
	...
	S += (t7_t3_s02*ADD[0])-1 < t7_t3_s03_mem0*ADD_mem[0]
	S += (t7_t3_s02*ADD[1])-1 < t7_t3_s03_mem0*ADD_mem[1]
	S += (t7_t3_s02*ADD[2])-1 < t7_t3_s03_mem0*ADD_mem[2]
	S += (t7_t3_s02*ADD[3])-1 < t7_t3_s03_mem0*ADD_mem[3]
	...
	S += (t7_t4_y1_0*ADD[0])-1 < t7_t4_y1_1_mem0*ADD_mem[0]
	S += (t7_t4_y1_0*ADD[1])-1 < t7_t4_y1_1_mem0*ADD_mem[1]
	S += (t7_t4_y1_0*ADD[2])-1 < t7_t4_y1_1_mem0*ADD_mem[2]
	S += (t7_t4_y1_0*ADD[3])-1 < t7_t4_y1_1_mem0*ADD_mem[3]
	S += t7_t4_y1_1_mem0 <= t7_t4_y1_1

	t7_t4_y1_1_mem1 = S.Task('t7_t4_y1_1_mem1', length=1, delay_cost=1)
	t7_t4_y1_1_mem1 += ADD_mem[1]
	S += 56 < t7_t4_y1_1_mem1
	...
	S += (t10_t0_s02*ADD[0])-1 < t10_t0_s03_mem0*ADD_mem[0]
	S += (t10_t0_s02*ADD[1])-1 < t10_t0_s03_mem0*ADD_mem[1]
	S += (t10_t0_s02*ADD[2])-1 < t10_t0_s03_mem0*ADD_mem[2]
	S += (t10_t0_s02*ADD[3])-1 < t10_t0_s03_mem0*ADD_mem[3]
	...
	S += (t10_t1_s02*ADD[0])-1 < t10_t1_s03_mem0*ADD_mem[0]
	S += (t10_t1_s02*ADD[1])-1 < t10_t1_s03_mem0*ADD_mem[1]
	S += (t10_t1_s02*ADD[2])-1 < t10_t1_s03_mem0*ADD_mem[2]
	S += (t10_t1_s02*ADD[3])-1 < t10_t1_s03_mem0*ADD_mem[3]
	...
	S += (t10_t4_s01*ADD[0])-1 < t10_t4_s02_mem0*ADD_mem[0]
	S += (t10_t4_s01*ADD[1])-1 < t10_t4_s02_mem0*ADD_mem[1]
	S += (t10_t4_s01*ADD[2])-1 < t10_t4_s02_mem0*ADD_mem[2]
	S += (t10_t4_s01*ADD[3])-1 < t10_t4_s02_mem0*ADD_mem[3]
	...
	S += (t10_s0_y1_0*ADD[0])-1 < t10_s0_y1_1_mem0*ADD_mem[0]
	S += (t10_s0_y1_0*ADD[1])-1 < t10_s0_y1_1_mem0*ADD_mem[1]
	S += (t10_s0_y1_0*ADD[2])-1 < t10_s0_y1_1_mem0*ADD_mem[2]
	S += (t10_s0_y1_0*ADD[3])-1 < t10_s0_y1_1_mem0*ADD_mem[3]
	S += t10_s0_y1_1_mem0 <= t10_s0_y1_1

	t10_s0_y1_1_mem1 = S.Task('t10_s0_y1_1_mem1', length=1, delay_cost=1)
	t10_s0_y1_1_mem1 += ADD_mem[1]
	S += 58 < t10_s0_y1_1_mem1
	...
	S += (t011*ADD[0])-1 < t18_a1__y1_0_mem0*ADD_mem[0]
	S += (t011*ADD[1])-1 < t18_a1__y1_0_mem0*ADD_mem[1]
	S += (t011*ADD[2])-1 < t18_a1__y1_0_mem0*ADD_mem[2]
	S += (t011*ADD[3])-1 < t18_a1__y1_0_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PDBL_mul1_add4/PDBL_3.png"
	if(S.solution() != []):
