...
def solve():
	...
	S += (t2_t0_t3*ADD[0]) < t2_t0_t4_mem1*ADD_mem[0]
	S += (t2_t0_t3*ADD[1]) < t2_t0_t4_mem1*ADD_mem[1]
	S += (t2_t0_t3*ADD[2]) < t2_t0_t4_mem1*ADD_mem[2]
	S += (t2_t0_t3*ADD[3]) < t2_t0_t4_mem1*ADD_mem[3]
	...
	S += (t2_t0_t1*MUL[0]) < t2_t0_s00_mem0*MUL_mem[0]
	...
	S += (t2_t30*ADD[0]) < t2_t4_t0_mem1*ADD_mem[0]
	S += (t2_t30*ADD[1]) < t2_t4_t0_mem1*ADD_mem[1]
	S += (t2_t30*ADD[2]) < t2_t4_t0_mem1*ADD_mem[2]
	S += (t2_t30*ADD[3]) < t2_t4_t0_mem1*ADD_mem[3]
	...
	S += (t2_t31*ADD[0]) < t2_t4_t1_mem1*ADD_mem[0]
	S += (t2_t31*ADD[1]) < t2_t4_t1_mem1*ADD_mem[1]
	S += (t2_t31*ADD[2]) < t2_t4_t1_mem1*ADD_mem[2]
	S += (t2_t31*ADD[3]) < t2_t4_t1_mem1*ADD_mem[3]
	...
	S += (t2_t30*ADD[0]) < t2_t4_t3_mem0*ADD_mem[0]
	S += (t2_t30*ADD[1]) < t2_t4_t3_mem0*ADD_mem[1]
	S += (t2_t30*ADD[2]) < t2_t4_t3_mem0*ADD_mem[2]
	S += (t2_t30*ADD[3]) < t2_t4_t3_mem0*ADD_mem[3]
	S += t2_t4_t3_mem0 <= t2_t4_t3

	t2_t4_t3_mem1 = S.Task('t2_t4_t3_mem1', length=1, delay_cost=1)
	t2_t4_t3_mem1 += alt(ADD_mem)
	S += (t2_t31*ADD[0]) < t2_t4_t3_mem1*ADD_mem[0]
	S += (t2_t31*ADD[1]) < t2_t4_t3_mem1*ADD_mem[1]
	S += (t2_t31*ADD[2]) < t2_t4_t3_mem1*ADD_mem[2]
	S += (t2_t31*ADD[3]) < t2_t4_t3_mem1*ADD_mem[3]
	...
	S += (t2_t11*ADD[0]) < t2_s0_y1_0_mem0*ADD_mem[0]
	S += (t2_t11*ADD[1]) < t2_s0_y1_0_mem0*ADD_mem[1]
	S += (t2_t11*ADD[2]) < t2_s0_y1_0_mem0*ADD_mem[2]
	S += (t2_t11*ADD[3]) < t2_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t800*ADD[0]) < t900_mem0*ADD_mem[0]
	S += (t800*ADD[1]) < t900_mem0*ADD_mem[1]
	S += (t800*ADD[2]) < t900_mem0*ADD_mem[2]
	S += (t800*ADD[3]) < t900_mem0*ADD_mem[3]
	S += t900_mem0 <= t900
	...
	S += (t801*ADD[0]) < t901_mem0*ADD_mem[0]
	S += (t801*ADD[1]) < t901_mem0*ADD_mem[1]
	S += (t801*ADD[2]) < t901_mem0*ADD_mem[2]
	S += (t801*ADD[3]) < t901_mem0*ADD_mem[3]
	S += t901_mem0 <= t901
	...
	S += (t12_t0_t2*ADD[0]) < t12_t0_t4_mem0*ADD_mem[0]
	S += (t12_t0_t2*ADD[1]) < t12_t0_t4_mem0*ADD_mem[1]
	S += (t12_t0_t2*ADD[2]) < t12_t0_t4_mem0*ADD_mem[2]
	S += (t12_t0_t2*ADD[3]) < t12_t0_t4_mem0*ADD_mem[3]
	S += t12_t0_t4_mem0 <= t12_t0_t4

	t12_t0_t4_mem1 = S.Task('t12_t0_t4_mem1', length=1, delay_cost=1)
	t12_t0_t4_mem1 += alt(ADD_mem)
	S += (t12_t0_t3*ADD[0]) < t12_t0_t4_mem1*ADD_mem[0]
	S += (t12_t0_t3*ADD[1]) < t12_t0_t4_mem1*ADD_mem[1]
	S += (t12_t0_t3*ADD[2]) < t12_t0_t4_mem1*ADD_mem[2]
	S += (t12_t0_t3*ADD[3]) < t12_t0_t4_mem1*ADD_mem[3]
	...
	S += (t12_t0_t1*MUL[0]) < t12_t0_s00_mem0*MUL_mem[0]
	...
	S += (t12_t1_t3*ADD[0]) < t12_t1_t4_mem1*ADD_mem[0]
	S += (t12_t1_t3*ADD[1]) < t12_t1_t4_mem1*ADD_mem[1]
	S += (t12_t1_t3*ADD[2]) < t12_t1_t4_mem1*ADD_mem[2]
	S += (t12_t1_t3*ADD[3]) < t12_t1_t4_mem1*ADD_mem[3]
	...
	S += (t12_t1_s03*ADD[0]) < t12_t1_s04_mem0*ADD_mem[0]
	S += (t12_t1_s03*ADD[1]) < t12_t1_s04_mem0*ADD_mem[1]
	S += (t12_t1_s03*ADD[2]) < t12_t1_s04_mem0*ADD_mem[2]
	S += (t12_t1_s03*ADD[3]) < t12_t1_s04_mem0*ADD_mem[3]
	S += t12_t1_s04_mem0 <= t12_t1_s04

	t12_t1_s04_mem1 = S.Task('t12_t1_s04_mem1', length=1, delay_cost=1)
	t12_t1_s04_mem1 += MUL_mem[0]
	S += 76 < t12_t1_s04_mem1
	...
	S += (t12_t1_t0*MUL[0]) < t12_t1_t5_mem0*MUL_mem[0]
	...
	S += (t12_t20*ADD[0]) < t12_t4_t0_mem0*ADD_mem[0]
	S += (t12_t20*ADD[1]) < t12_t4_t0_mem0*ADD_mem[1]
	S += (t12_t20*ADD[2]) < t12_t4_t0_mem0*ADD_mem[2]
	S += (t12_t20*ADD[3]) < t12_t4_t0_mem0*ADD_mem[3]
	S += t12_t4_t0_mem0 <= t12_t4_t0

	t12_t4_t0_mem1 = S.Task('t12_t4_t0_mem1', length=1, delay_cost=1)
	t12_t4_t0_mem1 += alt(ADD_mem)
	S += (t12_t30*ADD[0]) < t12_t4_t0_mem1*ADD_mem[0]
	S += (t12_t30*ADD[1]) < t12_t4_t0_mem1*ADD_mem[1]
	S += (t12_t30*ADD[2]) < t12_t4_t0_mem1*ADD_mem[2]
	S += (t12_t30*ADD[3]) < t12_t4_t0_mem1*ADD_mem[3]
	...
	S += (t12_t21*ADD[0]) < t12_t4_t1_mem0*ADD_mem[0]
	S += (t12_t21*ADD[1]) < t12_t4_t1_mem0*ADD_mem[1]
	S += (t12_t21*ADD[2]) < t12_t4_t1_mem0*ADD_mem[2]
	S += (t12_t21*ADD[3]) < t12_t4_t1_mem0*ADD_mem[3]
	...
	S += (t12_t20*ADD[0]) < t12_t4_t2_mem0*ADD_mem[0]
	S += (t12_t20*ADD[1]) < t12_t4_t2_mem0*ADD_mem[1]
	S += (t12_t20*ADD[2]) < t12_t4_t2_mem0*ADD_mem[2]
	S += (t12_t20*ADD[3]) < t12_t4_t2_mem0*ADD_mem[3]
	S += t12_t4_t2_mem0 <= t12_t4_t2

	t12_t4_t2_mem1 = S.Task('t12_t4_t2_mem1', length=1, delay_cost=1)
	t12_t4_t2_mem1 += alt(ADD_mem)
	S += (t12_t21*ADD[0]) < t12_t4_t2_mem1*ADD_mem[0]
	S += (t12_t21*ADD[1]) < t12_t4_t2_mem1*ADD_mem[1]
	S += (t12_t21*ADD[2]) < t12_t4_t2_mem1*ADD_mem[2]
	S += (t12_t21*ADD[3]) < t12_t4_t2_mem1*ADD_mem[3]
	...
	S += (t12_t30*ADD[0]) < t12_t4_t3_mem0*ADD_mem[0]
	S += (t12_t30*ADD[1]) < t12_t4_t3_mem0*ADD_mem[1]
	S += (t12_t30*ADD[2]) < t12_t4_t3_mem0*ADD_mem[2]
	S += (t12_t30*ADD[3]) < t12_t4_t3_mem0*ADD_mem[3]
	...
	S += (t18_t00*ADD[0]) < t18_t2_t0_mem0*ADD_mem[0]
	S += (t18_t00*ADD[1]) < t18_t2_t0_mem0*ADD_mem[1]
	S += (t18_t00*ADD[2]) < t18_t2_t0_mem0*ADD_mem[2]
	S += (t18_t00*ADD[3]) < t18_t2_t0_mem0*ADD_mem[3]
	S += t18_t2_t0_mem0 <= t18_t2_t0

	t18_t2_t0_mem1 = S.Task('t18_t2_t0_mem1', length=1, delay_cost=1)
	t18_t2_t0_mem1 += alt(ADD_mem)
	S += (t18_t10*ADD[0]) < t18_t2_t0_mem1*ADD_mem[0]
	S += (t18_t10*ADD[1]) < t18_t2_t0_mem1*ADD_mem[1]
	S += (t18_t10*ADD[2]) < t18_t2_t0_mem1*ADD_mem[2]
	S += (t18_t10*ADD[3]) < t18_t2_t0_mem1*ADD_mem[3]
	...
	S += (t18_t01*ADD[0]) < t18_t2_t1_mem0*ADD_mem[0]
	S += (t18_t01*ADD[1]) < t18_t2_t1_mem0*ADD_mem[1]
	S += (t18_t01*ADD[2]) < t18_t2_t1_mem0*ADD_mem[2]
	S += (t18_t01*ADD[3]) < t18_t2_t1_mem0*ADD_mem[3]
	S += t18_t2_t1_mem0 <= t18_t2_t1

	t18_t2_t1_mem1 = S.Task('t18_t2_t1_mem1', length=1, delay_cost=1)
	t18_t2_t1_mem1 += alt(ADD_mem)
	S += (t18_t11*ADD[0]) < t18_t2_t1_mem1*ADD_mem[0]
	S += (t18_t11*ADD[1]) < t18_t2_t1_mem1*ADD_mem[1]
	S += (t18_t11*ADD[2]) < t18_t2_t1_mem1*ADD_mem[2]
	S += (t18_t11*ADD[3]) < t18_t2_t1_mem1*ADD_mem[3]
	...
	S += (t18_t00*ADD[0]) < t18_t2_t2_mem0*ADD_mem[0]
	S += (t18_t00*ADD[1]) < t18_t2_t2_mem0*ADD_mem[1]
	S += (t18_t00*ADD[2]) < t18_t2_t2_mem0*ADD_mem[2]
	S += (t18_t00*ADD[3]) < t18_t2_t2_mem0*ADD_mem[3]
	S += t18_t2_t2_mem0 <= t18_t2_t2

	t18_t2_t2_mem1 = S.Task('t18_t2_t2_mem1', length=1, delay_cost=1)
	t18_t2_t2_mem1 += alt(ADD_mem)
	S += (t18_t01*ADD[0]) < t18_t2_t2_mem1*ADD_mem[0]
	S += (t18_t01*ADD[1]) < t18_t2_t2_mem1*ADD_mem[1]
	S += (t18_t01*ADD[2]) < t18_t2_t2_mem1*ADD_mem[2]
	S += (t18_t01*ADD[3]) < t18_t2_t2_mem1*ADD_mem[3]
	...
	S += (t18_t10*ADD[0]) < t18_t2_t3_mem0*ADD_mem[0]
	S += (t18_t10*ADD[1]) < t18_t2_t3_mem0*ADD_mem[1]
	S += (t18_t10*ADD[2]) < t18_t2_t3_mem0*ADD_mem[2]
	S += (t18_t10*ADD[3]) < t18_t2_t3_mem0*ADD_mem[3]
	S += t18_t2_t3_mem0 <= t18_t2_t3

	t18_t2_t3_mem1 = S.Task('t18_t2_t3_mem1', length=1, delay_cost=1)
	t18_t2_t3_mem1 += alt(ADD_mem)
	S += (t18_t11*ADD[0]) < t18_t2_t3_mem1*ADD_mem[0]
	S += (t18_t11*ADD[1]) < t18_t2_t3_mem1*ADD_mem[1]
	S += (t18_t11*ADD[2]) < t18_t2_t3_mem1*ADD_mem[2]
	S += (t18_t11*ADD[3]) < t18_t2_t3_mem1*ADD_mem[3]
	...
	S += (t18_t3_t2*ADD[0]) < t18_t3_t4_mem0*ADD_mem[0]
	S += (t18_t3_t2*ADD[1]) < t18_t3_t4_mem0*ADD_mem[1]
	S += (t18_t3_t2*ADD[2]) < t18_t3_t4_mem0*ADD_mem[2]
	S += (t18_t3_t2*ADD[3]) < t18_t3_t4_mem0*ADD_mem[3]
	...
	S += (t18_t3_t1*MUL[0]) < t18_t3_s00_mem0*MUL_mem[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PDBL_mul1_add4/PDBL_6.png"
	if(S.solution() != []):
