...
def solve():
	...
	S += t17_t1_t0_mem0 >= 119
	t17_t1_t0_mem0 += ADD_mem[2]

	t17_t1_t0_mem1 = S.Task('t17_t1_t0_mem1', length=1, delay_cost=1)
	S += t17_t1_t0_mem1 >= 119
	...
	S += t17_t1_t2_mem0 >= 122
	t17_t1_t2_mem0 += ADD_mem[2]

	t17_t1_t2_mem1 = S.Task('t17_t1_t2_mem1', length=1, delay_cost=1)
	S += t17_t1_t2_mem1 >= 122
	...
	S += t17_t1_t4_mem0 >= 123
	t17_t1_t4_mem0 += ADD_mem[3]

	t17_t1_t4_mem1 = S.Task('t17_t1_t4_mem1', length=1, delay_cost=1)
	S += t17_t1_t4_mem1 >= 123
	...
	S += new_TX_t1_s02_mem0 >= 124
	new_TX_t1_s02_mem0 += ADD_mem[1]
	...
	S += new_TX_t4_s04_mem0 >= 127
	new_TX_t4_s04_mem0 += ADD_mem[0]

	new_TX_t4_s04_mem1 = S.Task('new_TX_t4_s04_mem1', length=1, delay_cost=1)
	S += new_TX_t4_s04_mem1 >= 127
	...
	S += t17_t4_t4_mem0 >= 127
	t17_t4_t4_mem0 += ADD_mem[2]

	t17_t4_t4_mem1 = S.Task('t17_t4_t4_mem1', length=1, delay_cost=1)
	S += t17_t4_t4_mem1 >= 127
	...
	S += (t17_t10*ADD[0])-1 < t1701_mem1*ADD_mem[0]
	S += (t17_t10*ADD[1])-1 < t1701_mem1*ADD_mem[1]
	S += (t17_t10*ADD[2])-1 < t1701_mem1*ADD_mem[2]
	S += (t17_t10*ADD[3])-1 < t1701_mem1*ADD_mem[3]
	S += t1701_mem1 <= t1701
	...
	S += (new_TX_s0_y1_2*ADD[0])-1 < new_TX_s0_y1_3_mem0*ADD_mem[0]
	S += (new_TX_s0_y1_2*ADD[1])-1 < new_TX_s0_y1_3_mem0*ADD_mem[1]
	S += (new_TX_s0_y1_2*ADD[2])-1 < new_TX_s0_y1_3_mem0*ADD_mem[2]
	S += (new_TX_s0_y1_2*ADD[3])-1 < new_TX_s0_y1_3_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PDBL_mul1_add4/PDBL_10.png"
	if(S.solution() != []):
