...
def solve():
	...
	S += (t0_a1__y1_1*ADD[0]) < t0_a1__y1_2_mem0*ADD_mem[0]
	S += (t0_a1__y1_1*ADD[1]) < t0_a1__y1_2_mem0*ADD_mem[1]
	S += (t0_a1__y1_1*ADD[2]) < t0_a1__y1_2_mem0*ADD_mem[2]
	S += (t0_a1__y1_1*ADD[3]) < t0_a1__y1_2_mem0*ADD_mem[3]
	...
	S += (t0_t2_t1*MUL[0]) < t0_t2_s00_mem0*MUL_mem[0]
	...
	S += (t0_t3_s00*ADD[0]) < t0_t3_s01_mem0*ADD_mem[0]
	S += (t0_t3_s00*ADD[1]) < t0_t3_s01_mem0*ADD_mem[1]
	S += (t0_t3_s00*ADD[2]) < t0_t3_s01_mem0*ADD_mem[2]
	S += (t0_t3_s00*ADD[3]) < t0_t3_s01_mem0*ADD_mem[3]
	...
	S += (t1_a1__y1_1*ADD[0]) < t1_a1__y1_2_mem0*ADD_mem[0]
	S += (t1_a1__y1_1*ADD[1]) < t1_a1__y1_2_mem0*ADD_mem[1]
	S += (t1_a1__y1_1*ADD[2]) < t1_a1__y1_2_mem0*ADD_mem[2]
	S += (t1_a1__y1_1*ADD[3]) < t1_a1__y1_2_mem0*ADD_mem[3]
	...
	S += (t1_t2_t1*MUL[0]) < t1_t2_s00_mem0*MUL_mem[0]
	...
	S += (t1_t3_s00*ADD[0]) < t1_t3_s01_mem0*ADD_mem[0]
	S += (t1_t3_s00*ADD[1]) < t1_t3_s01_mem0*ADD_mem[1]
	S += (t1_t3_s00*ADD[2]) < t1_t3_s01_mem0*ADD_mem[2]
	S += (t1_t3_s00*ADD[3]) < t1_t3_s01_mem0*ADD_mem[3]
	...
	S += (t5_t0_s00*ADD[0]) < t5_t0_s01_mem0*ADD_mem[0]
	S += (t5_t0_s00*ADD[1]) < t5_t0_s01_mem0*ADD_mem[1]
	S += (t5_t0_s00*ADD[2]) < t5_t0_s01_mem0*ADD_mem[2]
	S += (t5_t0_s00*ADD[3]) < t5_t0_s01_mem0*ADD_mem[3]
	...
	S += (t5_t1_s00*ADD[0]) < t5_t1_s01_mem0*ADD_mem[0]
	S += (t5_t1_s00*ADD[1]) < t5_t1_s01_mem0*ADD_mem[1]
	S += (t5_t1_s00*ADD[2]) < t5_t1_s01_mem0*ADD_mem[2]
	S += (t5_t1_s00*ADD[3]) < t5_t1_s01_mem0*ADD_mem[3]
	...
	S += (t5_t4_t1*MUL[0]) < t5_t4_s00_mem0*MUL_mem[0]
	...
	S += (t7_a1__y1_1*ADD[0]) < t7_a1__y1_2_mem0*ADD_mem[0]
	S += (t7_a1__y1_1*ADD[1]) < t7_a1__y1_2_mem0*ADD_mem[1]
	S += (t7_a1__y1_1*ADD[2]) < t7_a1__y1_2_mem0*ADD_mem[2]
	S += (t7_a1__y1_1*ADD[3]) < t7_a1__y1_2_mem0*ADD_mem[3]
	...
	S += (t7_t2_t1*MUL[0]) < t7_t2_s00_mem0*MUL_mem[0]
	...
	S += (t7_t3_s00*ADD[0]) < t7_t3_s01_mem0*ADD_mem[0]
	S += (t7_t3_s00*ADD[1]) < t7_t3_s01_mem0*ADD_mem[1]
	S += (t7_t3_s00*ADD[2]) < t7_t3_s01_mem0*ADD_mem[2]
	S += (t7_t3_s00*ADD[3]) < t7_t3_s01_mem0*ADD_mem[3]
	...
	S += (t10_t0_s00*ADD[0]) < t10_t0_s01_mem0*ADD_mem[0]
	S += (t10_t0_s00*ADD[1]) < t10_t0_s01_mem0*ADD_mem[1]
	S += (t10_t0_s00*ADD[2]) < t10_t0_s01_mem0*ADD_mem[2]
	S += (t10_t0_s00*ADD[3]) < t10_t0_s01_mem0*ADD_mem[3]
	S += t10_t0_s01_mem0 <= t10_t0_s01

	t10_t0_s01_mem1 = S.Task('t10_t0_s01_mem1', length=1, delay_cost=1)
	t10_t0_s01_mem1 += MUL_mem[0]
	S += 40 < t10_t0_s01_mem1
	...
	S += (t10_t1_s00*ADD[0]) < t10_t1_s01_mem0*ADD_mem[0]
	S += (t10_t1_s00*ADD[1]) < t10_t1_s01_mem0*ADD_mem[1]
	S += (t10_t1_s00*ADD[2]) < t10_t1_s01_mem0*ADD_mem[2]
	S += (t10_t1_s00*ADD[3]) < t10_t1_s01_mem0*ADD_mem[3]
	S += t10_t1_s01_mem0 <= t10_t1_s01

	t10_t1_s01_mem1 = S.Task('t10_t1_s01_mem1', length=1, delay_cost=1)
	t10_t1_s01_mem1 += MUL_mem[0]
	S += 42 < t10_t1_s01_mem1
	...
	S += (t10_t4_t1*MUL[0]) < t10_t4_s00_mem0*MUL_mem[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PDBL_mul1_add4/PDBL_2.png"
	if(S.solution() != []):
