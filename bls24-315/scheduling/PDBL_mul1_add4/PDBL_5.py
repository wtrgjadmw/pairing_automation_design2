...
def solve():
	...
	S += (t0_t4_y1_4*ADD[0])-1 < t0_t50_mem1*ADD_mem[0]
	S += (t0_t4_y1_4*ADD[1])-1 < t0_t50_mem1*ADD_mem[1]
	S += (t0_t4_y1_4*ADD[2])-1 < t0_t50_mem1*ADD_mem[2]
	S += (t0_t4_y1_4*ADD[3])-1 < t0_t50_mem1*ADD_mem[3]
	...
	S += (t1_t4_y1_4*ADD[0])-1 < t1_t50_mem1*ADD_mem[0]
	S += (t1_t4_y1_4*ADD[1])-1 < t1_t50_mem1*ADD_mem[1]
	S += (t1_t4_y1_4*ADD[2])-1 < t1_t50_mem1*ADD_mem[2]
	S += (t1_t4_y1_4*ADD[3])-1 < t1_t50_mem1*ADD_mem[3]
	...
	S += (t110*ADD[0])-1 < t2_t1_t0_mem1*ADD_mem[0]
	S += (t110*ADD[1])-1 < t2_t1_t0_mem1*ADD_mem[1]
	S += (t110*ADD[2])-1 < t2_t1_t0_mem1*ADD_mem[2]
	S += (t110*ADD[3])-1 < t2_t1_t0_mem1*ADD_mem[3]
	...
	S += (t110*ADD[0])-1 < t2_t1_t3_mem0*ADD_mem[0]
	S += (t110*ADD[1])-1 < t2_t1_t3_mem0*ADD_mem[1]
	S += (t110*ADD[2])-1 < t2_t1_t3_mem0*ADD_mem[2]
	S += (t110*ADD[3])-1 < t2_t1_t3_mem0*ADD_mem[3]
	...
	S += (t5_s0_y1_4*ADD[0])-1 < t500_mem1*ADD_mem[0]
	S += (t5_s0_y1_4*ADD[1])-1 < t500_mem1*ADD_mem[1]
	S += (t5_s0_y1_4*ADD[2])-1 < t500_mem1*ADD_mem[2]
	S += (t5_s0_y1_4*ADD[3])-1 < t500_mem1*ADD_mem[3]
	S += t500_mem1 <= t500
	...
	S += (t5_t40*ADD[0])-1 < t510_mem0*ADD_mem[0]
	S += (t5_t40*ADD[1])-1 < t510_mem0*ADD_mem[1]
	S += (t5_t40*ADD[2])-1 < t510_mem0*ADD_mem[2]
	S += (t5_t40*ADD[3])-1 < t510_mem0*ADD_mem[3]
	S += t510_mem0 <= t510

	t510_mem1 = S.Task('t510_mem1', length=1, delay_cost=1)
	t510_mem1 += alt(ADD_mem)
	S += (t5_t50*ADD[0])-1 < t510_mem1*ADD_mem[0]
	S += (t5_t50*ADD[1])-1 < t510_mem1*ADD_mem[1]
	S += (t5_t50*ADD[2])-1 < t510_mem1*ADD_mem[2]
	S += (t5_t50*ADD[3])-1 < t510_mem1*ADD_mem[3]
	S += t510_mem1 <= t510
	...
	S += (t501*ADD[0])-1 < t601_mem0*ADD_mem[0]
	S += (t501*ADD[1])-1 < t601_mem0*ADD_mem[1]
	S += (t501*ADD[2])-1 < t601_mem0*ADD_mem[2]
	S += (t501*ADD[3])-1 < t601_mem0*ADD_mem[3]
	S += t601_mem0 <= t601
	...
	S += (t7_t4_y1_4*ADD[0])-1 < t7_t50_mem1*ADD_mem[0]
	S += (t7_t4_y1_4*ADD[1])-1 < t7_t50_mem1*ADD_mem[1]
	S += (t7_t4_y1_4*ADD[2])-1 < t7_t50_mem1*ADD_mem[2]
	S += (t7_t4_y1_4*ADD[3])-1 < t7_t50_mem1*ADD_mem[3]
	...
	S += (t710*ADD[0])-1 < t810_mem0*ADD_mem[0]
	S += (t710*ADD[1])-1 < t810_mem0*ADD_mem[1]
	S += (t710*ADD[2])-1 < t810_mem0*ADD_mem[2]
	S += (t710*ADD[3])-1 < t810_mem0*ADD_mem[3]
	S += t810_mem0 <= t810
	...
	S += (t10_s0_y1_4*ADD[0])-1 < t1000_mem1*ADD_mem[0]
	S += (t10_s0_y1_4*ADD[1])-1 < t1000_mem1*ADD_mem[1]
	S += (t10_s0_y1_4*ADD[2])-1 < t1000_mem1*ADD_mem[2]
	S += (t10_s0_y1_4*ADD[3])-1 < t1000_mem1*ADD_mem[3]
	S += t1000_mem1 <= t1000
	...
	S += (t10_t40*ADD[0])-1 < t1010_mem0*ADD_mem[0]
	S += (t10_t40*ADD[1])-1 < t1010_mem0*ADD_mem[1]
	S += (t10_t40*ADD[2])-1 < t1010_mem0*ADD_mem[2]
	S += (t10_t40*ADD[3])-1 < t1010_mem0*ADD_mem[3]
	S += t1010_mem0 <= t1010

	t1010_mem1 = S.Task('t1010_mem1', length=1, delay_cost=1)
	t1010_mem1 += alt(ADD_mem)
	S += (t10_t50*ADD[0])-1 < t1010_mem1*ADD_mem[0]
	S += (t10_t50*ADD[1])-1 < t1010_mem1*ADD_mem[1]
	S += (t10_t50*ADD[2])-1 < t1010_mem1*ADD_mem[2]
	S += (t10_t50*ADD[3])-1 < t1010_mem1*ADD_mem[3]
	S += t1010_mem1 <= t1010
	...
	S += (t1001*ADD[0])-1 < t1101_mem0*ADD_mem[0]
	S += (t1001*ADD[1])-1 < t1101_mem0*ADD_mem[1]
	S += (t1001*ADD[2])-1 < t1101_mem0*ADD_mem[2]
	S += (t1001*ADD[3])-1 < t1101_mem0*ADD_mem[3]
	S += t1101_mem0 <= t1101
	...
	S += (t010*ADD[0])-1 < t12_t1_t2_mem0*ADD_mem[0]
	S += (t010*ADD[1])-1 < t12_t1_t2_mem0*ADD_mem[1]
	S += (t010*ADD[2])-1 < t12_t1_t2_mem0*ADD_mem[2]
	S += (t010*ADD[3])-1 < t12_t1_t2_mem0*ADD_mem[3]
	...
	S += (t12_t1_s00*ADD[0])-1 < t12_t1_s01_mem0*ADD_mem[0]
	S += (t12_t1_s00*ADD[1])-1 < t12_t1_s01_mem0*ADD_mem[1]
	S += (t12_t1_s00*ADD[2])-1 < t12_t1_s01_mem0*ADD_mem[2]
	S += (t12_t1_s00*ADD[3])-1 < t12_t1_s01_mem0*ADD_mem[3]
	S += t12_t1_s01_mem0 <= t12_t1_s01

	t12_t1_s01_mem1 = S.Task('t12_t1_s01_mem1', length=1, delay_cost=1)
	t12_t1_s01_mem1 += MUL_mem[0]
	S += 70 < t12_t1_s01_mem1
	...
	S += (t18_a1__y1_3*ADD[0])-1 < t18_a1__y1_4_mem0*ADD_mem[0]
	S += (t18_a1__y1_3*ADD[1])-1 < t18_a1__y1_4_mem0*ADD_mem[1]
	S += (t18_a1__y1_3*ADD[2])-1 < t18_a1__y1_4_mem0*ADD_mem[2]
	S += (t18_a1__y1_3*ADD[3])-1 < t18_a1__y1_4_mem0*ADD_mem[3]
	...
	S += (t010*ADD[0])-1 < t18_t3_t3_mem0*ADD_mem[0]
	S += (t010*ADD[1])-1 < t18_t3_t3_mem0*ADD_mem[1]
	S += (t010*ADD[2])-1 < t18_t3_t3_mem0*ADD_mem[2]
	S += (t010*ADD[3])-1 < t18_t3_t3_mem0*ADD_mem[3]
	...
	S += (t0_t20*ADD[0])-1 < t000_mem0*ADD_mem[0]
	S += (t0_t20*ADD[1])-1 < t000_mem0*ADD_mem[1]
	S += (t0_t20*ADD[2])-1 < t000_mem0*ADD_mem[2]
	S += (t0_t20*ADD[3])-1 < t000_mem0*ADD_mem[3]
	S += t000_mem0 <= t000
	...
	S += (t1_t20*ADD[0])-1 < t100_mem0*ADD_mem[0]
	S += (t1_t20*ADD[1])-1 < t100_mem0*ADD_mem[1]
	S += (t1_t20*ADD[2])-1 < t100_mem0*ADD_mem[2]
	S += (t1_t20*ADD[3])-1 < t100_mem0*ADD_mem[3]
	S += t100_mem0 <= t100

	t100_mem1 = S.Task('t100_mem1', length=1, delay_cost=1)
	t100_mem1 += alt(ADD_mem)
	S += (t1_t50*ADD[0])-1 < t100_mem1*ADD_mem[0]
	S += (t1_t50*ADD[1])-1 < t100_mem1*ADD_mem[1]
	S += (t1_t50*ADD[2])-1 < t100_mem1*ADD_mem[2]
	S += (t1_t50*ADD[3])-1 < t100_mem1*ADD_mem[3]
	S += t100_mem1 <= t100
	...
	S += (t1_t21*ADD[0])-1 < t101_mem0*ADD_mem[0]
	S += (t1_t21*ADD[1])-1 < t101_mem0*ADD_mem[1]
	S += (t1_t21*ADD[2])-1 < t101_mem0*ADD_mem[2]
	S += (t1_t21*ADD[3])-1 < t101_mem0*ADD_mem[3]
	S += t101_mem0 <= t101

	t101_mem1 = S.Task('t101_mem1', length=1, delay_cost=1)
	t101_mem1 += alt(ADD_mem)
	S += (t1_t51*ADD[0])-1 < t101_mem1*ADD_mem[0]
	S += (t1_t51*ADD[1])-1 < t101_mem1*ADD_mem[1]
	S += (t1_t51*ADD[2])-1 < t101_mem1*ADD_mem[2]
	S += (t1_t51*ADD[3])-1 < t101_mem1*ADD_mem[3]
	S += t101_mem1 <= t101
	...
	S += (t2_t1_t3*ADD[0])-1 < t2_t1_t4_mem1*ADD_mem[0]
	S += (t2_t1_t3*ADD[1])-1 < t2_t1_t4_mem1*ADD_mem[1]
	S += (t2_t1_t3*ADD[2])-1 < t2_t1_t4_mem1*ADD_mem[2]
	S += (t2_t1_t3*ADD[3])-1 < t2_t1_t4_mem1*ADD_mem[3]
	...
	S += (t2_t1_s03*ADD[0])-1 < t2_t1_s04_mem0*ADD_mem[0]
	S += (t2_t1_s03*ADD[1])-1 < t2_t1_s04_mem0*ADD_mem[1]
	S += (t2_t1_s03*ADD[2])-1 < t2_t1_s04_mem0*ADD_mem[2]
	S += (t2_t1_s03*ADD[3])-1 < t2_t1_s04_mem0*ADD_mem[3]
	...
	S += (t2_t1_t0*MUL[0])-1 < t2_t1_t5_mem0*MUL_mem[0]
	...
	S += (t500*ADD[0])-1 < t600_mem0*ADD_mem[0]
	S += (t500*ADD[1])-1 < t600_mem0*ADD_mem[1]
	S += (t500*ADD[2])-1 < t600_mem0*ADD_mem[2]
	S += (t500*ADD[3])-1 < t600_mem0*ADD_mem[3]
	S += t600_mem0 <= t600
	...
	S += (t7_t20*ADD[0])-1 < t700_mem0*ADD_mem[0]
	S += (t7_t20*ADD[1])-1 < t700_mem0*ADD_mem[1]
	S += (t7_t20*ADD[2])-1 < t700_mem0*ADD_mem[2]
	S += (t7_t20*ADD[3])-1 < t700_mem0*ADD_mem[3]
	S += t700_mem0 <= t700

	t700_mem1 = S.Task('t700_mem1', length=1, delay_cost=1)
	t700_mem1 += alt(ADD_mem)
	S += (t7_t50*ADD[0])-1 < t700_mem1*ADD_mem[0]
	S += (t7_t50*ADD[1])-1 < t700_mem1*ADD_mem[1]
	S += (t7_t50*ADD[2])-1 < t700_mem1*ADD_mem[2]
	S += (t7_t50*ADD[3])-1 < t700_mem1*ADD_mem[3]
	S += t700_mem1 <= t700
	...
	S += (t7_t21*ADD[0])-1 < t701_mem0*ADD_mem[0]
	S += (t7_t21*ADD[1])-1 < t701_mem0*ADD_mem[1]
	S += (t7_t21*ADD[2])-1 < t701_mem0*ADD_mem[2]
	S += (t7_t21*ADD[3])-1 < t701_mem0*ADD_mem[3]
	S += t701_mem0 <= t701

	t701_mem1 = S.Task('t701_mem1', length=1, delay_cost=1)
	t701_mem1 += alt(ADD_mem)
	S += (t7_t51*ADD[0])-1 < t701_mem1*ADD_mem[0]
	S += (t7_t51*ADD[1])-1 < t701_mem1*ADD_mem[1]
	S += (t7_t51*ADD[2])-1 < t701_mem1*ADD_mem[2]
	S += (t7_t51*ADD[3])-1 < t701_mem1*ADD_mem[3]
	S += t701_mem1 <= t701
	...
	S += (t710*ADD[0])-1 < t910_mem1*ADD_mem[0]
	S += (t710*ADD[1])-1 < t910_mem1*ADD_mem[1]
	S += (t710*ADD[2])-1 < t910_mem1*ADD_mem[2]
	S += (t710*ADD[3])-1 < t910_mem1*ADD_mem[3]
	S += t910_mem1 <= t910
	...
	S += (t1000*ADD[0])-1 < t1100_mem0*ADD_mem[0]
	S += (t1000*ADD[1])-1 < t1100_mem0*ADD_mem[1]
	S += (t1000*ADD[2])-1 < t1100_mem0*ADD_mem[2]
	S += (t1000*ADD[3])-1 < t1100_mem0*ADD_mem[3]
	S += t1100_mem0 <= t1100
	...
	S += (t12_t1_s01*ADD[0])-1 < t12_t1_s02_mem0*ADD_mem[0]
	S += (t12_t1_s01*ADD[1])-1 < t12_t1_s02_mem0*ADD_mem[1]
	S += (t12_t1_s01*ADD[2])-1 < t12_t1_s02_mem0*ADD_mem[2]
	S += (t12_t1_s01*ADD[3])-1 < t12_t1_s02_mem0*ADD_mem[3]
	...
	S += (t1101*ADD[0])-1 < t12_t31_mem0*ADD_mem[0]
	S += (t1101*ADD[1])-1 < t12_t31_mem0*ADD_mem[1]
	S += (t1101*ADD[2])-1 < t12_t31_mem0*ADD_mem[2]
	S += (t1101*ADD[3])-1 < t12_t31_mem0*ADD_mem[3]
	...
	S += (t601*ADD[0])-1 < new_TX_t31_mem0*ADD_mem[0]
	S += (t601*ADD[1])-1 < new_TX_t31_mem0*ADD_mem[1]
	S += (t601*ADD[2])-1 < new_TX_t31_mem0*ADD_mem[2]
	S += (t601*ADD[3])-1 < new_TX_t31_mem0*ADD_mem[3]
	S += new_TX_t31_mem0 <= new_TX_t31

	new_TX_t31_mem1 = S.Task('new_TX_t31_mem1', length=1, delay_cost=1)
	new_TX_t31_mem1 += ADD_mem[1]
	S += 64 < new_TX_t31_mem1
	...
	S += (t1101*ADD[0])-1 < c0001_mem0*ADD_mem[0]
	S += (t1101*ADD[1])-1 < c0001_mem0*ADD_mem[1]
	S += (t1101*ADD[2])-1 < c0001_mem0*ADD_mem[2]
	S += (t1101*ADD[3])-1 < c0001_mem0*ADD_mem[3]
	S += c0001_mem0 <= c0001
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PDBL_mul1_add4/PDBL_5.png"
	if(S.solution() != []):
