...
def solve():
	...
	S += t17_t0_t1_mem0 >= 102
	t17_t0_t1_mem0 += ADD_mem[1]

	t17_t0_t1_mem1 = S.Task('t17_t0_t1_mem1', length=1, delay_cost=1)
	S += t17_t0_t1_mem1 >= 102
	...
	S += t18_t4_y1_4_mem0 >= 108
	t18_t4_y1_4_mem0 += ADD_mem[1]

	t18_t4_y1_4_mem1 = S.Task('t18_t4_y1_4_mem1', length=1, delay_cost=1)
	S += t18_t4_y1_4_mem1 >= 108
	...
	S += t17_t0_s01_mem0 >= 112
	t17_t0_s01_mem0 += ADD_mem[3]

	t17_t0_s01_mem1 = S.Task('t17_t0_s01_mem1', length=1, delay_cost=1)
	S += t17_t0_s01_mem1 >= 112
	...
	t17_t0_t2_mem1 += ADD_mem[1]
	S += 101 < t17_t0_t2_mem1
	...
	S += (t17_t0_s02*ADD[0])-1 < t17_t0_s03_mem0*ADD_mem[0]
	S += (t17_t0_s02*ADD[1])-1 < t17_t0_s03_mem0*ADD_mem[1]
	S += (t17_t0_s02*ADD[2])-1 < t17_t0_s03_mem0*ADD_mem[2]
	S += (t17_t0_s02*ADD[3])-1 < t17_t0_s03_mem0*ADD_mem[3]
	...
	S += (t17_t4_s00*ADD[0])-1 < t17_t4_s01_mem0*ADD_mem[0]
	S += (t17_t4_s00*ADD[1])-1 < t17_t4_s01_mem0*ADD_mem[1]
	S += (t17_t4_s00*ADD[2])-1 < t17_t4_s01_mem0*ADD_mem[2]
	S += (t17_t4_s00*ADD[3])-1 < t17_t4_s01_mem0*ADD_mem[3]
	S += t17_t4_s01_mem0 <= t17_t4_s01

	t17_t4_s01_mem1 = S.Task('t17_t4_s01_mem1', length=1, delay_cost=1)
	t17_t4_s01_mem1 += MUL_mem[0]
	S += 115 < t17_t4_s01_mem1
	...
	S += (new_TX_t0_s03*ADD[0])-1 < new_TX_t0_s04_mem0*ADD_mem[0]
	S += (new_TX_t0_s03*ADD[1])-1 < new_TX_t0_s04_mem0*ADD_mem[1]
	S += (new_TX_t0_s03*ADD[2])-1 < new_TX_t0_s04_mem0*ADD_mem[2]
	S += (new_TX_t0_s03*ADD[3])-1 < new_TX_t0_s04_mem0*ADD_mem[3]
	...
	S += (new_TX_t1_s02*ADD[0])-1 < new_TX_t1_s03_mem0*ADD_mem[0]
	S += (new_TX_t1_s02*ADD[1])-1 < new_TX_t1_s03_mem0*ADD_mem[1]
	S += (new_TX_t1_s02*ADD[2])-1 < new_TX_t1_s03_mem0*ADD_mem[2]
	S += (new_TX_t1_s02*ADD[3])-1 < new_TX_t1_s03_mem0*ADD_mem[3]
	...
	S += (new_TX_t4_s01*ADD[0])-1 < new_TX_t4_s02_mem0*ADD_mem[0]
	S += (new_TX_t4_s01*ADD[1])-1 < new_TX_t4_s02_mem0*ADD_mem[1]
	S += (new_TX_t4_s01*ADD[2])-1 < new_TX_t4_s02_mem0*ADD_mem[2]
	S += (new_TX_t4_s01*ADD[3])-1 < new_TX_t4_s02_mem0*ADD_mem[3]
	...
	S += (t17_t1_s02*ADD[0])-1 < t17_t1_s03_mem0*ADD_mem[0]
	S += (t17_t1_s02*ADD[1])-1 < t17_t1_s03_mem0*ADD_mem[1]
	S += (t17_t1_s02*ADD[2])-1 < t17_t1_s03_mem0*ADD_mem[2]
	S += (t17_t1_s02*ADD[3])-1 < t17_t1_s03_mem0*ADD_mem[3]
	...
	S += (t17_t4_s01*ADD[0])-1 < t17_t4_s02_mem0*ADD_mem[0]
	S += (t17_t4_s01*ADD[1])-1 < t17_t4_s02_mem0*ADD_mem[1]
	S += (t17_t4_s01*ADD[2])-1 < t17_t4_s02_mem0*ADD_mem[2]
	S += (t17_t4_s01*ADD[3])-1 < t17_t4_s02_mem0*ADD_mem[3]
	...
	S += (t17_t1_s03*ADD[0])-1 < t17_t1_s04_mem0*ADD_mem[0]
	S += (t17_t1_s03*ADD[1])-1 < t17_t1_s04_mem0*ADD_mem[1]
	S += (t17_t1_s03*ADD[2])-1 < t17_t1_s04_mem0*ADD_mem[2]
	S += (t17_t1_s03*ADD[3])-1 < t17_t1_s04_mem0*ADD_mem[3]
	S += t17_t1_s04_mem0 <= t17_t1_s04

	t17_t1_s04_mem1 = S.Task('t17_t1_s04_mem1', length=1, delay_cost=1)
	t17_t1_s04_mem1 += MUL_mem[0]
	S += 114 < t17_t1_s04_mem1
	...
	S += (new_TX_t1_t4*MUL[0])-1 < new_TX_t11_mem0*MUL_mem[0]
	S += new_TX_t11_mem0 <= new_TX_t11

	new_TX_t11_mem1 = S.Task('new_TX_t11_mem1', length=1, delay_cost=1)
	new_TX_t11_mem1 += alt(ADD_mem)
	S += (new_TX_t1_t5*ADD[0])-1 < new_TX_t11_mem1*ADD_mem[0]
	S += (new_TX_t1_t5*ADD[1])-1 < new_TX_t11_mem1*ADD_mem[1]
	S += (new_TX_t1_t5*ADD[2])-1 < new_TX_t11_mem1*ADD_mem[2]
	S += (new_TX_t1_t5*ADD[3])-1 < new_TX_t11_mem1*ADD_mem[3]
	...
	S += (new_TX_t4_t2*ADD[0])-1 < new_TX_t4_t4_mem0*ADD_mem[0]
	S += (new_TX_t4_t2*ADD[1])-1 < new_TX_t4_t4_mem0*ADD_mem[1]
	S += (new_TX_t4_t2*ADD[2])-1 < new_TX_t4_t4_mem0*ADD_mem[2]
	S += (new_TX_t4_t2*ADD[3])-1 < new_TX_t4_t4_mem0*ADD_mem[3]
	...
	S += (new_TX_t4_t0*MUL[0])-1 < new_TX_t4_t5_mem0*MUL_mem[0]
	...
	S += (t17_t1_s04*ADD[0])-1 < t17_t10_mem1*ADD_mem[0]
	S += (t17_t1_s04*ADD[1])-1 < t17_t10_mem1*ADD_mem[1]
	S += (t17_t1_s04*ADD[2])-1 < t17_t10_mem1*ADD_mem[2]
	S += (t17_t1_s04*ADD[3])-1 < t17_t10_mem1*ADD_mem[3]
	...
	S += (t17_t4_t2*ADD[0])-1 < t17_t4_t4_mem0*ADD_mem[0]
	S += (t17_t4_t2*ADD[1])-1 < t17_t4_t4_mem0*ADD_mem[1]
	S += (t17_t4_t2*ADD[2])-1 < t17_t4_t4_mem0*ADD_mem[2]
	S += (t17_t4_t2*ADD[3])-1 < t17_t4_t4_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PDBL_mul1_add4/PDBL_9.png"
	if(S.solution() != []):
