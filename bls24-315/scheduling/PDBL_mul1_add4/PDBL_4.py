...
def solve():
	...
	S += (t0_t2_s03*ADD[0]) < t0_t2_s04_mem0*ADD_mem[0]
	S += (t0_t2_s03*ADD[1]) < t0_t2_s04_mem0*ADD_mem[1]
	S += (t0_t2_s03*ADD[2]) < t0_t2_s04_mem0*ADD_mem[2]
	S += (t0_t2_s03*ADD[3]) < t0_t2_s04_mem0*ADD_mem[3]
	...
	S += (t0_t3_s04*ADD[0]) < t0_t30_mem1*ADD_mem[0]
	S += (t0_t3_s04*ADD[1]) < t0_t30_mem1*ADD_mem[1]
	S += (t0_t3_s04*ADD[2]) < t0_t30_mem1*ADD_mem[2]
	S += (t0_t3_s04*ADD[3]) < t0_t30_mem1*ADD_mem[3]
	...
	S += (t0_t4_y1_2*ADD[0]) < t0_t4_y1_3_mem0*ADD_mem[0]
	S += (t0_t4_y1_2*ADD[1]) < t0_t4_y1_3_mem0*ADD_mem[1]
	S += (t0_t4_y1_2*ADD[2]) < t0_t4_y1_3_mem0*ADD_mem[2]
	S += (t0_t4_y1_2*ADD[3]) < t0_t4_y1_3_mem0*ADD_mem[3]
	...
	S += (t1_t2_s03*ADD[0]) < t1_t2_s04_mem0*ADD_mem[0]
	S += (t1_t2_s03*ADD[1]) < t1_t2_s04_mem0*ADD_mem[1]
	S += (t1_t2_s03*ADD[2]) < t1_t2_s04_mem0*ADD_mem[2]
	S += (t1_t2_s03*ADD[3]) < t1_t2_s04_mem0*ADD_mem[3]
	...
	S += (t1_t3_s04*ADD[0]) < t1_t30_mem1*ADD_mem[0]
	S += (t1_t3_s04*ADD[1]) < t1_t30_mem1*ADD_mem[1]
	S += (t1_t3_s04*ADD[2]) < t1_t30_mem1*ADD_mem[2]
	S += (t1_t3_s04*ADD[3]) < t1_t30_mem1*ADD_mem[3]
	...
	S += (t1_t4_y1_2*ADD[0]) < t1_t4_y1_3_mem0*ADD_mem[0]
	S += (t1_t4_y1_2*ADD[1]) < t1_t4_y1_3_mem0*ADD_mem[1]
	S += (t1_t4_y1_2*ADD[2]) < t1_t4_y1_3_mem0*ADD_mem[2]
	S += (t1_t4_y1_2*ADD[3]) < t1_t4_y1_3_mem0*ADD_mem[3]
	...
	S += (t2_t1_s00*ADD[0]) < t2_t1_s01_mem0*ADD_mem[0]
	S += (t2_t1_s00*ADD[1]) < t2_t1_s01_mem0*ADD_mem[1]
	S += (t2_t1_s00*ADD[2]) < t2_t1_s01_mem0*ADD_mem[2]
	S += (t2_t1_s00*ADD[3]) < t2_t1_s01_mem0*ADD_mem[3]
	...
	S += (t5_t0_s04*ADD[0]) < t5_t00_mem1*ADD_mem[0]
	S += (t5_t0_s04*ADD[1]) < t5_t00_mem1*ADD_mem[1]
	S += (t5_t0_s04*ADD[2]) < t5_t00_mem1*ADD_mem[2]
	S += (t5_t0_s04*ADD[3]) < t5_t00_mem1*ADD_mem[3]
	...
	S += (t5_t1_s04*ADD[0]) < t5_t10_mem1*ADD_mem[0]
	S += (t5_t1_s04*ADD[1]) < t5_t10_mem1*ADD_mem[1]
	S += (t5_t1_s04*ADD[2]) < t5_t10_mem1*ADD_mem[2]
	S += (t5_t1_s04*ADD[3]) < t5_t10_mem1*ADD_mem[3]
	...
	S += (t5_t4_s03*ADD[0]) < t5_t4_s04_mem0*ADD_mem[0]
	S += (t5_t4_s03*ADD[1]) < t5_t4_s04_mem0*ADD_mem[1]
	S += (t5_t4_s03*ADD[2]) < t5_t4_s04_mem0*ADD_mem[2]
	S += (t5_t4_s03*ADD[3]) < t5_t4_s04_mem0*ADD_mem[3]
	...
	S += (t5_s0_y1_2*ADD[0]) < t5_s0_y1_3_mem0*ADD_mem[0]
	S += (t5_s0_y1_2*ADD[1]) < t5_s0_y1_3_mem0*ADD_mem[1]
	S += (t5_s0_y1_2*ADD[2]) < t5_s0_y1_3_mem0*ADD_mem[2]
	S += (t5_s0_y1_2*ADD[3]) < t5_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (t7_t2_s03*ADD[0]) < t7_t2_s04_mem0*ADD_mem[0]
	S += (t7_t2_s03*ADD[1]) < t7_t2_s04_mem0*ADD_mem[1]
	S += (t7_t2_s03*ADD[2]) < t7_t2_s04_mem0*ADD_mem[2]
	S += (t7_t2_s03*ADD[3]) < t7_t2_s04_mem0*ADD_mem[3]
	...
	S += (t7_t3_s04*ADD[0]) < t7_t30_mem1*ADD_mem[0]
	S += (t7_t3_s04*ADD[1]) < t7_t30_mem1*ADD_mem[1]
	S += (t7_t3_s04*ADD[2]) < t7_t30_mem1*ADD_mem[2]
	S += (t7_t3_s04*ADD[3]) < t7_t30_mem1*ADD_mem[3]
	...
	S += (t7_t4_y1_2*ADD[0]) < t7_t4_y1_3_mem0*ADD_mem[0]
	S += (t7_t4_y1_2*ADD[1]) < t7_t4_y1_3_mem0*ADD_mem[1]
	S += (t7_t4_y1_2*ADD[2]) < t7_t4_y1_3_mem0*ADD_mem[2]
	S += (t7_t4_y1_2*ADD[3]) < t7_t4_y1_3_mem0*ADD_mem[3]
	...
	S += (t10_t0_s04*ADD[0]) < t10_t00_mem1*ADD_mem[0]
	S += (t10_t0_s04*ADD[1]) < t10_t00_mem1*ADD_mem[1]
	S += (t10_t0_s04*ADD[2]) < t10_t00_mem1*ADD_mem[2]
	S += (t10_t0_s04*ADD[3]) < t10_t00_mem1*ADD_mem[3]
	...
	S += (t10_t1_s04*ADD[0]) < t10_t10_mem1*ADD_mem[0]
	S += (t10_t1_s04*ADD[1]) < t10_t10_mem1*ADD_mem[1]
	S += (t10_t1_s04*ADD[2]) < t10_t10_mem1*ADD_mem[2]
	S += (t10_t1_s04*ADD[3]) < t10_t10_mem1*ADD_mem[3]
	...
	S += (t10_t4_s03*ADD[0]) < t10_t4_s04_mem0*ADD_mem[0]
	S += (t10_t4_s03*ADD[1]) < t10_t4_s04_mem0*ADD_mem[1]
	S += (t10_t4_s03*ADD[2]) < t10_t4_s04_mem0*ADD_mem[2]
	S += (t10_t4_s03*ADD[3]) < t10_t4_s04_mem0*ADD_mem[3]
	S += t10_t4_s04_mem0 <= t10_t4_s04

	t10_t4_s04_mem1 = S.Task('t10_t4_s04_mem1', length=1, delay_cost=1)
	t10_t4_s04_mem1 += MUL_mem[0]
	S += 56 < t10_t4_s04_mem1
	...
	S += (t10_s0_y1_2*ADD[0]) < t10_s0_y1_3_mem0*ADD_mem[0]
	S += (t10_s0_y1_2*ADD[1]) < t10_s0_y1_3_mem0*ADD_mem[1]
	S += (t10_s0_y1_2*ADD[2]) < t10_s0_y1_3_mem0*ADD_mem[2]
	S += (t10_s0_y1_2*ADD[3]) < t10_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (t18_a1__y1_1*ADD[0]) < t18_a1__y1_2_mem0*ADD_mem[0]
	S += (t18_a1__y1_1*ADD[1]) < t18_a1__y1_2_mem0*ADD_mem[1]
	S += (t18_a1__y1_1*ADD[2]) < t18_a1__y1_2_mem0*ADD_mem[2]
	S += (t18_a1__y1_1*ADD[3]) < t18_a1__y1_2_mem0*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PDBL_mul1_add4/PDBL_4.png"
	if(S.solution() != []):
