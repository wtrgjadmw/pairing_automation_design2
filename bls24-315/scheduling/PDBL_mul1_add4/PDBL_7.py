...
def solve():
	...
	S += (t2_t0_s01*ADD[0]) < t2_t0_s02_mem0*ADD_mem[0]
	S += (t2_t0_s01*ADD[1]) < t2_t0_s02_mem0*ADD_mem[1]
	S += (t2_t0_s01*ADD[2]) < t2_t0_s02_mem0*ADD_mem[2]
	S += (t2_t0_s01*ADD[3]) < t2_t0_s02_mem0*ADD_mem[3]
	...
	S += (t2_s0_y1_1*ADD[0]) < t2_s0_y1_2_mem0*ADD_mem[0]
	S += (t2_s0_y1_1*ADD[1]) < t2_s0_y1_2_mem0*ADD_mem[1]
	S += (t2_s0_y1_1*ADD[2]) < t2_s0_y1_2_mem0*ADD_mem[2]
	S += (t2_s0_y1_1*ADD[3]) < t2_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (t12_t0_s01*ADD[0]) < t12_t0_s02_mem0*ADD_mem[0]
	S += (t12_t0_s01*ADD[1]) < t12_t0_s02_mem0*ADD_mem[1]
	S += (t12_t0_s01*ADD[2]) < t12_t0_s02_mem0*ADD_mem[2]
	S += (t12_t0_s01*ADD[3]) < t12_t0_s02_mem0*ADD_mem[3]
	...
	S += (t12_t4_s00*ADD[0]) < t12_t4_s01_mem0*ADD_mem[0]
	S += (t12_t4_s00*ADD[1]) < t12_t4_s01_mem0*ADD_mem[1]
	S += (t12_t4_s00*ADD[2]) < t12_t4_s01_mem0*ADD_mem[2]
	S += (t12_t4_s00*ADD[3]) < t12_t4_s01_mem0*ADD_mem[3]
	S += t12_t4_s01_mem0 <= t12_t4_s01

	t12_t4_s01_mem1 = S.Task('t12_t4_s01_mem1', length=1, delay_cost=1)
	t12_t4_s01_mem1 += MUL_mem[0]
	S += 95 < t12_t4_s01_mem1
	...
	S += (t12_t11*ADD[0]) < t12_s0_y1_0_mem0*ADD_mem[0]
	S += (t12_t11*ADD[1]) < t12_s0_y1_0_mem0*ADD_mem[1]
	S += (t12_t11*ADD[2]) < t12_s0_y1_0_mem0*ADD_mem[2]
	S += (t12_t11*ADD[3]) < t12_s0_y1_0_mem0*ADD_mem[3]
	...
	S += (t12_t01*ADD[0]) < t1201_mem0*ADD_mem[0]
	S += (t12_t01*ADD[1]) < t1201_mem0*ADD_mem[1]
	S += (t12_t01*ADD[2]) < t1201_mem0*ADD_mem[2]
	S += (t12_t01*ADD[3]) < t1201_mem0*ADD_mem[3]
	S += t1201_mem0 <= t1201

	t1201_mem1 = S.Task('t1201_mem1', length=1, delay_cost=1)
	t1201_mem1 += alt(ADD_mem)
	S += (t12_t10*ADD[0]) < t1201_mem1*ADD_mem[0]
	S += (t12_t10*ADD[1]) < t1201_mem1*ADD_mem[1]
	S += (t12_t10*ADD[2]) < t1201_mem1*ADD_mem[2]
	S += (t12_t10*ADD[3]) < t1201_mem1*ADD_mem[3]
	S += t1201_mem1 <= t1201
	...
	S += (t18_t2_s00*ADD[0]) < t18_t2_s01_mem0*ADD_mem[0]
	S += (t18_t2_s00*ADD[1]) < t18_t2_s01_mem0*ADD_mem[1]
	S += (t18_t2_s00*ADD[2]) < t18_t2_s01_mem0*ADD_mem[2]
	S += (t18_t2_s00*ADD[3]) < t18_t2_s01_mem0*ADD_mem[3]
	S += t18_t2_s01_mem0 <= t18_t2_s01

	t18_t2_s01_mem1 = S.Task('t18_t2_s01_mem1', length=1, delay_cost=1)
	t18_t2_s01_mem1 += MUL_mem[0]
	S += 96 < t18_t2_s01_mem1
	...
	S += (t18_t3_s01*ADD[0]) < t18_t3_s02_mem0*ADD_mem[0]
	S += (t18_t3_s01*ADD[1]) < t18_t3_s02_mem0*ADD_mem[1]
	S += (t18_t3_s01*ADD[2]) < t18_t3_s02_mem0*ADD_mem[2]
	S += (t18_t3_s01*ADD[3]) < t18_t3_s02_mem0*ADD_mem[3]
	...
	S += (t18_t31*ADD[0]) < t18_t4_y1_0_mem0*ADD_mem[0]
	S += (t18_t31*ADD[1]) < t18_t4_y1_0_mem0*ADD_mem[1]
	S += (t18_t31*ADD[2]) < t18_t4_y1_0_mem0*ADD_mem[2]
	S += (t18_t31*ADD[3]) < t18_t4_y1_0_mem0*ADD_mem[3]
	...
	S += (t2_t0_s02*ADD[0]) < t2_t0_s03_mem0*ADD_mem[0]
	S += (t2_t0_s02*ADD[1]) < t2_t0_s03_mem0*ADD_mem[1]
	S += (t2_t0_s02*ADD[2]) < t2_t0_s03_mem0*ADD_mem[2]
	S += (t2_t0_s02*ADD[3]) < t2_t0_s03_mem0*ADD_mem[3]
	...
	S += (t201*ADD[0]) < t301_mem0*ADD_mem[0]
	S += (t201*ADD[1]) < t301_mem0*ADD_mem[1]
	S += (t201*ADD[2]) < t301_mem0*ADD_mem[2]
	S += (t201*ADD[3]) < t301_mem0*ADD_mem[3]
	S += t301_mem0 <= t301
	...
	S += (t12_t0_s02*ADD[0]) < t12_t0_s03_mem0*ADD_mem[0]
	S += (t12_t0_s02*ADD[1]) < t12_t0_s03_mem0*ADD_mem[1]
	S += (t12_t0_s02*ADD[2]) < t12_t0_s03_mem0*ADD_mem[2]
	S += (t12_t0_s02*ADD[3]) < t12_t0_s03_mem0*ADD_mem[3]
	...
	S += (t12_t4_s01*ADD[0]) < t12_t4_s02_mem0*ADD_mem[0]
	S += (t12_t4_s01*ADD[1]) < t12_t4_s02_mem0*ADD_mem[1]
	S += (t12_t4_s01*ADD[2]) < t12_t4_s02_mem0*ADD_mem[2]
	S += (t12_t4_s01*ADD[3]) < t12_t4_s02_mem0*ADD_mem[3]
	...
	S += (t12_s0_y1_0*ADD[0]) < t12_s0_y1_1_mem0*ADD_mem[0]
	S += (t12_s0_y1_0*ADD[1]) < t12_s0_y1_1_mem0*ADD_mem[1]
	S += (t12_s0_y1_0*ADD[2]) < t12_s0_y1_1_mem0*ADD_mem[2]
	S += (t12_s0_y1_0*ADD[3]) < t12_s0_y1_1_mem0*ADD_mem[3]
	S += t12_s0_y1_1_mem0 <= t12_s0_y1_1

	t12_s0_y1_1_mem1 = S.Task('t12_s0_y1_1_mem1', length=1, delay_cost=1)
	t12_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t12_t11*ADD[0]) < t12_s0_y1_1_mem1*ADD_mem[0]
	S += (t12_t11*ADD[1]) < t12_s0_y1_1_mem1*ADD_mem[1]
	S += (t12_t11*ADD[2]) < t12_s0_y1_1_mem1*ADD_mem[2]
	S += (t12_t11*ADD[3]) < t12_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t12_t41*ADD[0]) < t1211_mem0*ADD_mem[0]
	S += (t12_t41*ADD[1]) < t1211_mem0*ADD_mem[1]
	S += (t12_t41*ADD[2]) < t1211_mem0*ADD_mem[2]
	S += (t12_t41*ADD[3]) < t1211_mem0*ADD_mem[3]
	S += t1211_mem0 <= t1211

	t1211_mem1 = S.Task('t1211_mem1', length=1, delay_cost=1)
	t1211_mem1 += alt(ADD_mem)
	S += (t12_t51*ADD[0]) < t1211_mem1*ADD_mem[0]
	S += (t12_t51*ADD[1]) < t1211_mem1*ADD_mem[1]
	S += (t12_t51*ADD[2]) < t1211_mem1*ADD_mem[2]
	S += (t12_t51*ADD[3]) < t1211_mem1*ADD_mem[3]
	S += t1211_mem1 <= t1211
	...
	S += (t18_t2_s01*ADD[0]) < t18_t2_s02_mem0*ADD_mem[0]
	S += (t18_t2_s01*ADD[1]) < t18_t2_s02_mem0*ADD_mem[1]
	S += (t18_t2_s01*ADD[2]) < t18_t2_s02_mem0*ADD_mem[2]
	S += (t18_t2_s01*ADD[3]) < t18_t2_s02_mem0*ADD_mem[3]
	...
	S += (t18_t3_s02*ADD[0]) < t18_t3_s03_mem0*ADD_mem[0]
	S += (t18_t3_s02*ADD[1]) < t18_t3_s03_mem0*ADD_mem[1]
	S += (t18_t3_s02*ADD[2]) < t18_t3_s03_mem0*ADD_mem[2]
	S += (t18_t3_s02*ADD[3]) < t18_t3_s03_mem0*ADD_mem[3]
	...
	S += (t18_t4_y1_0*ADD[0]) < t18_t4_y1_1_mem0*ADD_mem[0]
	S += (t18_t4_y1_0*ADD[1]) < t18_t4_y1_1_mem0*ADD_mem[1]
	S += (t18_t4_y1_0*ADD[2]) < t18_t4_y1_1_mem0*ADD_mem[2]
	S += (t18_t4_y1_0*ADD[3]) < t18_t4_y1_1_mem0*ADD_mem[3]
	S += t18_t4_y1_1_mem0 <= t18_t4_y1_1

	t18_t4_y1_1_mem1 = S.Task('t18_t4_y1_1_mem1', length=1, delay_cost=1)
	t18_t4_y1_1_mem1 += alt(ADD_mem)
	S += (t18_t31*ADD[0]) < t18_t4_y1_1_mem1*ADD_mem[0]
	S += (t18_t31*ADD[1]) < t18_t4_y1_1_mem1*ADD_mem[1]
	S += (t18_t31*ADD[2]) < t18_t4_y1_1_mem1*ADD_mem[2]
	S += (t18_t31*ADD[3]) < t18_t4_y1_1_mem1*ADD_mem[3]
	...
	S += (t2_t0_s03*ADD[0]) < t2_t0_s04_mem0*ADD_mem[0]
	S += (t2_t0_s03*ADD[1]) < t2_t0_s04_mem0*ADD_mem[1]
	S += (t2_t0_s03*ADD[2]) < t2_t0_s04_mem0*ADD_mem[2]
	S += (t2_t0_s03*ADD[3]) < t2_t0_s04_mem0*ADD_mem[3]
	...
	S += (t201*ADD[0]) < t401_mem1*ADD_mem[0]
	S += (t201*ADD[1]) < t401_mem1*ADD_mem[1]
	S += (t201*ADD[2]) < t401_mem1*ADD_mem[2]
	S += (t201*ADD[3]) < t401_mem1*ADD_mem[3]
	S += t401_mem1 <= t401
	...
	S += (t12_t0_s03*ADD[0]) < t12_t0_s04_mem0*ADD_mem[0]
	S += (t12_t0_s03*ADD[1]) < t12_t0_s04_mem0*ADD_mem[1]
	S += (t12_t0_s03*ADD[2]) < t12_t0_s04_mem0*ADD_mem[2]
	S += (t12_t0_s03*ADD[3]) < t12_t0_s04_mem0*ADD_mem[3]
	S += t12_t0_s04_mem0 <= t12_t0_s04

	t12_t0_s04_mem1 = S.Task('t12_t0_s04_mem1', length=1, delay_cost=1)
	t12_t0_s04_mem1 += MUL_mem[0]
	S += 97 < t12_t0_s04_mem1
	...
	S += (t18_t2_s02*ADD[0]) < t18_t2_s03_mem0*ADD_mem[0]
	S += (t18_t2_s02*ADD[1]) < t18_t2_s03_mem0*ADD_mem[1]
	S += (t18_t2_s02*ADD[2]) < t18_t2_s03_mem0*ADD_mem[2]
	S += (t18_t2_s02*ADD[3]) < t18_t2_s03_mem0*ADD_mem[3]
	...
	S += (t18_t3_s03*ADD[0]) < t18_t3_s04_mem0*ADD_mem[0]
	S += (t18_t3_s03*ADD[1]) < t18_t3_s04_mem0*ADD_mem[1]
	S += (t18_t3_s03*ADD[2]) < t18_t3_s04_mem0*ADD_mem[2]
	S += (t18_t3_s03*ADD[3]) < t18_t3_s04_mem0*ADD_mem[3]
	S += t18_t3_s04_mem0 <= t18_t3_s04

	t18_t3_s04_mem1 = S.Task('t18_t3_s04_mem1', length=1, delay_cost=1)
	t18_t3_s04_mem1 += MUL_mem[0]
	S += 90 < t18_t3_s04_mem1
	...
	S += (t18_t4_y1_1*ADD[0]) < t18_t4_y1_2_mem0*ADD_mem[0]
	S += (t18_t4_y1_1*ADD[1]) < t18_t4_y1_2_mem0*ADD_mem[1]
	S += (t18_t4_y1_1*ADD[2]) < t18_t4_y1_2_mem0*ADD_mem[2]
	S += (t18_t4_y1_1*ADD[3]) < t18_t4_y1_2_mem0*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/PDBL_mul1_add4/PDBL_7.png"
	if(S.solution() != []):
