...
def solve():
	...
	t2_t0_s01_mem1 += alt(MUL_mem)
	S += (t2_t0_t1*MUL[0])-1 < t2_t0_s01_mem1*MUL_mem[0]
	...
	t12_t0_s01_mem0 += alt(ADD_mem)
	S += (t12_t0_s00*ADD[0])-1 < t12_t0_s01_mem0*ADD_mem[0]
	S += (t12_t0_s00*ADD[1])-1 < t12_t0_s01_mem0*ADD_mem[1]
	S += (t12_t0_s00*ADD[2])-1 < t12_t0_s01_mem0*ADD_mem[2]
	S += (t12_t0_s00*ADD[3])-1 < t12_t0_s01_mem0*ADD_mem[3]
	S += t12_t0_s01_mem0 <= t12_t0_s01

	t12_t0_s01_mem1 = S.Task('t12_t0_s01_mem1', length=1, delay_cost=1)
	t12_t0_s01_mem1 += alt(MUL_mem)
	S += (t12_t0_t1*MUL[0])-1 < t12_t0_s01_mem1*MUL_mem[0]
	S += t12_t0_s01_mem1 <= t12_t0_s01
	...
	t12_t10_mem0 += alt(MUL_mem)
	S += (t12_t1_t0*MUL[0])-1 < t12_t10_mem0*MUL_mem[0]
	S += t12_t10_mem0 <= t12_t10

	t12_t10_mem1 = S.Task('t12_t10_mem1', length=1, delay_cost=1)
	t12_t10_mem1 += alt(ADD_mem)
	S += (t12_t1_s04*ADD[0])-1 < t12_t10_mem1*ADD_mem[0]
	S += (t12_t1_s04*ADD[1])-1 < t12_t10_mem1*ADD_mem[1]
	S += (t12_t1_s04*ADD[2])-1 < t12_t10_mem1*ADD_mem[2]
	S += (t12_t1_s04*ADD[3])-1 < t12_t10_mem1*ADD_mem[3]
	...
	S += 94 < t12_t4_s00_mem0
	S += t12_t4_s00_mem0 <= t12_t4_s00
	...
	S += 98 < t18_t2_s00_mem0
	S += t18_t2_s00_mem0 <= t18_t2_s00
	...
	t18_t3_s01_mem0 += alt(ADD_mem)
	S += (t18_t3_s00*ADD[0])-1 < t18_t3_s01_mem0*ADD_mem[0]
	S += (t18_t3_s00*ADD[1])-1 < t18_t3_s01_mem0*ADD_mem[1]
	S += (t18_t3_s00*ADD[2])-1 < t18_t3_s01_mem0*ADD_mem[2]
	S += (t18_t3_s00*ADD[3])-1 < t18_t3_s01_mem0*ADD_mem[3]
	S += t18_t3_s01_mem0 <= t18_t3_s01

	t18_t3_s01_mem1 = S.Task('t18_t3_s01_mem1', length=1, delay_cost=1)
	t18_t3_s01_mem1 += MUL_mem[0]
	S += 81 < t18_t3_s01_mem1
	S += t18_t3_s01_mem1 <= t18_t3_s01
	...
	t2_s0_y1_2_mem0 += alt(ADD_mem)
	S += (t2_s0_y1_1*ADD[0])-1 < t2_s0_y1_2_mem0*ADD_mem[0]
	S += (t2_s0_y1_1*ADD[1])-1 < t2_s0_y1_2_mem0*ADD_mem[1]
	S += (t2_s0_y1_1*ADD[2])-1 < t2_s0_y1_2_mem0*ADD_mem[2]
	S += (t2_s0_y1_1*ADD[3])-1 < t2_s0_y1_2_mem0*ADD_mem[3]
	...
	t12_t0_s02_mem0 += alt(ADD_mem)
	S += (t12_t0_s01*ADD[0])-1 < t12_t0_s02_mem0*ADD_mem[0]
	S += (t12_t0_s01*ADD[1])-1 < t12_t0_s02_mem0*ADD_mem[1]
	S += (t12_t0_s01*ADD[2])-1 < t12_t0_s02_mem0*ADD_mem[2]
	S += (t12_t0_s01*ADD[3])-1 < t12_t0_s02_mem0*ADD_mem[3]
	S += t12_t0_s02_mem0 <= t12_t0_s02

	t12_t4_s01 = S.Task('t12_t4_s01', length=1, delay_cost=1)
	t12_t4_s01 += alt(ADD)

	t12_t4_s01_mem0 = S.Task('t12_t4_s01_mem0', length=1, delay_cost=1)
	t12_t4_s01_mem0 += alt(ADD_mem)
	S += (t12_t4_s00*ADD[0])-1 < t12_t4_s01_mem0*ADD_mem[0]
	S += (t12_t4_s00*ADD[1])-1 < t12_t4_s01_mem0*ADD_mem[1]
	S += (t12_t4_s00*ADD[2])-1 < t12_t4_s01_mem0*ADD_mem[2]
	S += (t12_t4_s00*ADD[3])-1 < t12_t4_s01_mem0*ADD_mem[3]
	S += t12_t4_s01_mem0 <= t12_t4_s01

	t12_t4_s01_mem1 = S.Task('t12_t4_s01_mem1', length=1, delay_cost=1)
	t12_t4_s01_mem1 += MUL_mem[0]
	S += 94 < t12_t4_s01_mem1
	S += t12_t4_s01_mem1 <= t12_t4_s01
	...
	t12_s0_y1_0_mem0 += alt(ADD_mem)
	S += (t12_t11*ADD[0])-1 < t12_s0_y1_0_mem0*ADD_mem[0]
	S += (t12_t11*ADD[1])-1 < t12_s0_y1_0_mem0*ADD_mem[1]
	S += (t12_t11*ADD[2])-1 < t12_s0_y1_0_mem0*ADD_mem[2]
	S += (t12_t11*ADD[3])-1 < t12_s0_y1_0_mem0*ADD_mem[3]
	S += t12_s0_y1_0_mem0 <= t12_s0_y1_0
	...
	S += (t12_t10*ADD[0])-1 < t1201_mem1*ADD_mem[0]
	S += (t12_t10*ADD[1])-1 < t1201_mem1*ADD_mem[1]
	S += (t12_t10*ADD[2])-1 < t1201_mem1*ADD_mem[2]
	S += (t12_t10*ADD[3])-1 < t1201_mem1*ADD_mem[3]
	S += t1201_mem1 <= t1201
	...
	t18_t2_s01_mem0 += alt(ADD_mem)
	S += (t18_t2_s00*ADD[0])-1 < t18_t2_s01_mem0*ADD_mem[0]
	S += (t18_t2_s00*ADD[1])-1 < t18_t2_s01_mem0*ADD_mem[1]
	S += (t18_t2_s00*ADD[2])-1 < t18_t2_s01_mem0*ADD_mem[2]
	S += (t18_t2_s00*ADD[3])-1 < t18_t2_s01_mem0*ADD_mem[3]
	S += t18_t2_s01_mem0 <= t18_t2_s01

	t18_t2_s01_mem1 = S.Task('t18_t2_s01_mem1', length=1, delay_cost=1)
	t18_t2_s01_mem1 += MUL_mem[0]
	S += 98 < t18_t2_s01_mem1
	S += t18_t2_s01_mem1 <= t18_t2_s01
	...
	t18_t3_s02_mem0 += alt(ADD_mem)
	S += (t18_t3_s01*ADD[0])-1 < t18_t3_s02_mem0*ADD_mem[0]
	S += (t18_t3_s01*ADD[1])-1 < t18_t3_s02_mem0*ADD_mem[1]
	S += (t18_t3_s01*ADD[2])-1 < t18_t3_s02_mem0*ADD_mem[2]
	S += (t18_t3_s01*ADD[3])-1 < t18_t3_s02_mem0*ADD_mem[3]
	S += t18_t3_s02_mem0 <= t18_t3_s02

	t18_t4_y1_0 = S.Task('t18_t4_y1_0', length=1, delay_cost=1)
	t18_t4_y1_0 += alt(ADD)

	t18_t4_y1_0_mem0 = S.Task('t18_t4_y1_0_mem0', length=1, delay_cost=1)
	t18_t4_y1_0_mem0 += alt(ADD_mem)
	S += (t18_t31*ADD[0])-1 < t18_t4_y1_0_mem0*ADD_mem[0]
	S += (t18_t31*ADD[1])-1 < t18_t4_y1_0_mem0*ADD_mem[1]
	S += (t18_t31*ADD[2])-1 < t18_t4_y1_0_mem0*ADD_mem[2]
	S += (t18_t31*ADD[3])-1 < t18_t4_y1_0_mem0*ADD_mem[3]
	S += t18_t4_y1_0_mem0 <= t18_t4_y1_0
	...
	t12_t0_s03_mem0 += alt(ADD_mem)
	S += (t12_t0_s02*ADD[0])-1 < t12_t0_s03_mem0*ADD_mem[0]
	S += (t12_t0_s02*ADD[1])-1 < t12_t0_s03_mem0*ADD_mem[1]
	S += (t12_t0_s02*ADD[2])-1 < t12_t0_s03_mem0*ADD_mem[2]
	S += (t12_t0_s02*ADD[3])-1 < t12_t0_s03_mem0*ADD_mem[3]
	S += t12_t0_s03_mem0 <= t12_t0_s03

	t12_t4_s02 = S.Task('t12_t4_s02', length=1, delay_cost=1)
	t12_t4_s02 += alt(ADD)

	t12_t4_s02_mem0 = S.Task('t12_t4_s02_mem0', length=1, delay_cost=1)
	t12_t4_s02_mem0 += alt(ADD_mem)
	S += (t12_t4_s01*ADD[0])-1 < t12_t4_s02_mem0*ADD_mem[0]
	S += (t12_t4_s01*ADD[1])-1 < t12_t4_s02_mem0*ADD_mem[1]
	S += (t12_t4_s01*ADD[2])-1 < t12_t4_s02_mem0*ADD_mem[2]
	S += (t12_t4_s01*ADD[3])-1 < t12_t4_s02_mem0*ADD_mem[3]
	...
	t12_s0_y1_1_mem0 += alt(ADD_mem)
	S += (t12_s0_y1_0*ADD[0])-1 < t12_s0_y1_1_mem0*ADD_mem[0]
	S += (t12_s0_y1_0*ADD[1])-1 < t12_s0_y1_1_mem0*ADD_mem[1]
	S += (t12_s0_y1_0*ADD[2])-1 < t12_s0_y1_1_mem0*ADD_mem[2]
	S += (t12_s0_y1_0*ADD[3])-1 < t12_s0_y1_1_mem0*ADD_mem[3]
	S += t12_s0_y1_1_mem0 <= t12_s0_y1_1

	t12_s0_y1_1_mem1 = S.Task('t12_s0_y1_1_mem1', length=1, delay_cost=1)
	t12_s0_y1_1_mem1 += alt(ADD_mem)
	S += (t12_t11*ADD[0])-1 < t12_s0_y1_1_mem1*ADD_mem[0]
	S += (t12_t11*ADD[1])-1 < t12_s0_y1_1_mem1*ADD_mem[1]
	S += (t12_t11*ADD[2])-1 < t12_s0_y1_1_mem1*ADD_mem[2]
	S += (t12_t11*ADD[3])-1 < t12_s0_y1_1_mem1*ADD_mem[3]
	...
	S += (t1201*ADD[0])-1 < t1301_mem0*ADD_mem[0]
	S += (t1201*ADD[1])-1 < t1301_mem0*ADD_mem[1]
	S += (t1201*ADD[2])-1 < t1301_mem0*ADD_mem[2]
	S += (t1201*ADD[3])-1 < t1301_mem0*ADD_mem[3]
	S += t1301_mem0 <= t1301
	...
	t18_t2_s02_mem0 += alt(ADD_mem)
	S += (t18_t2_s01*ADD[0])-1 < t18_t2_s02_mem0*ADD_mem[0]
	S += (t18_t2_s01*ADD[1])-1 < t18_t2_s02_mem0*ADD_mem[1]
	S += (t18_t2_s01*ADD[2])-1 < t18_t2_s02_mem0*ADD_mem[2]
	S += (t18_t2_s01*ADD[3])-1 < t18_t2_s02_mem0*ADD_mem[3]
	S += t18_t2_s02_mem0 <= t18_t2_s02

	t18_t3_s03 = S.Task('t18_t3_s03', length=1, delay_cost=1)
	t18_t3_s03 += alt(ADD)

	t18_t3_s03_mem0 = S.Task('t18_t3_s03_mem0', length=1, delay_cost=1)
	t18_t3_s03_mem0 += alt(ADD_mem)
	S += (t18_t3_s02*ADD[0])-1 < t18_t3_s03_mem0*ADD_mem[0]
	S += (t18_t3_s02*ADD[1])-1 < t18_t3_s03_mem0*ADD_mem[1]
	S += (t18_t3_s02*ADD[2])-1 < t18_t3_s03_mem0*ADD_mem[2]
	S += (t18_t3_s02*ADD[3])-1 < t18_t3_s03_mem0*ADD_mem[3]
	S += t18_t3_s03_mem0 <= t18_t3_s03

	t18_t4_y1_1 = S.Task('t18_t4_y1_1', length=1, delay_cost=1)
	t18_t4_y1_1 += alt(ADD)

	t18_t4_y1_1_mem0 = S.Task('t18_t4_y1_1_mem0', length=1, delay_cost=1)
	t18_t4_y1_1_mem0 += alt(ADD_mem)
	S += (t18_t4_y1_0*ADD[0])-1 < t18_t4_y1_1_mem0*ADD_mem[0]
	S += (t18_t4_y1_0*ADD[1])-1 < t18_t4_y1_1_mem0*ADD_mem[1]
	S += (t18_t4_y1_0*ADD[2])-1 < t18_t4_y1_1_mem0*ADD_mem[2]
	S += (t18_t4_y1_0*ADD[3])-1 < t18_t4_y1_1_mem0*ADD_mem[3]
	S += t18_t4_y1_1_mem0 <= t18_t4_y1_1

	t18_t4_y1_1_mem1 = S.Task('t18_t4_y1_1_mem1', length=1, delay_cost=1)
	t18_t4_y1_1_mem1 += alt(ADD_mem)
	S += (t18_t31*ADD[0])-1 < t18_t4_y1_1_mem1*ADD_mem[0]
	S += (t18_t31*ADD[1])-1 < t18_t4_y1_1_mem1*ADD_mem[1]
	S += (t18_t31*ADD[2])-1 < t18_t4_y1_1_mem1*ADD_mem[2]
	S += (t18_t31*ADD[3])-1 < t18_t4_y1_1_mem1*ADD_mem[3]
	S += t18_t4_y1_1_mem1 <= t18_t4_y1_1

	t2_t0_s04 = S.Task('t2_t0_s04', length=1, delay_cost=1)
	t2_t0_s04 += alt(ADD)

	t2_t0_s04_mem0 = S.Task('t2_t0_s04_mem0', length=1, delay_cost=1)
	t2_t0_s04_mem0 += alt(ADD_mem)
	S += (t2_t0_s03*ADD[0])-1 < t2_t0_s04_mem0*ADD_mem[0]
	S += (t2_t0_s03*ADD[1])-1 < t2_t0_s04_mem0*ADD_mem[1]
	S += (t2_t0_s03*ADD[2])-1 < t2_t0_s04_mem0*ADD_mem[2]
	S += (t2_t0_s03*ADD[3])-1 < t2_t0_s04_mem0*ADD_mem[3]
	S += t2_t0_s04_mem0 <= t2_t0_s04

	t2_t0_s04_mem1 = S.Task('t2_t0_s04_mem1', length=1, delay_cost=1)
	t2_t0_s04_mem1 += alt(MUL_mem)
	S += (t2_t0_t1*MUL[0])-1 < t2_t0_s04_mem1*MUL_mem[0]
	...
	S += (t2_t4_s02*ADD[0])-1 < t2_t4_s03_mem0*ADD_mem[0]
	S += (t2_t4_s02*ADD[1])-1 < t2_t4_s03_mem0*ADD_mem[1]
	S += (t2_t4_s02*ADD[2])-1 < t2_t4_s03_mem0*ADD_mem[2]
	S += (t2_t4_s02*ADD[3])-1 < t2_t4_s03_mem0*ADD_mem[3]
	...
	S += (t301*ADD[0])-1 < t401_mem0*ADD_mem[0]
	S += (t301*ADD[1])-1 < t401_mem0*ADD_mem[1]
	S += (t301*ADD[2])-1 < t401_mem0*ADD_mem[2]
	S += (t301*ADD[3])-1 < t401_mem0*ADD_mem[3]
	S += t401_mem0 <= t401

	t401_mem1 = S.Task('t401_mem1', length=1, delay_cost=1)
	t401_mem1 += alt(ADD_mem)
	S += (t201*ADD[0])-1 < t401_mem1*ADD_mem[0]
	S += (t201*ADD[1])-1 < t401_mem1*ADD_mem[1]
	S += (t201*ADD[2])-1 < t401_mem1*ADD_mem[2]
	S += (t201*ADD[3])-1 < t401_mem1*ADD_mem[3]
	S += t401_mem1 <= t401
	...
	t12_t0_s04_mem0 += alt(ADD_mem)
	S += (t12_t0_s03*ADD[0])-1 < t12_t0_s04_mem0*ADD_mem[0]
	S += (t12_t0_s03*ADD[1])-1 < t12_t0_s04_mem0*ADD_mem[1]
	S += (t12_t0_s03*ADD[2])-1 < t12_t0_s04_mem0*ADD_mem[2]
	S += (t12_t0_s03*ADD[3])-1 < t12_t0_s04_mem0*ADD_mem[3]
	S += t12_t0_s04_mem0 <= t12_t0_s04

	t12_t0_s04_mem1 = S.Task('t12_t0_s04_mem1', length=1, delay_cost=1)
	t12_t0_s04_mem1 += alt(MUL_mem)
	S += (t12_t0_t1*MUL[0])-1 < t12_t0_s04_mem1*MUL_mem[0]
	S += t12_t0_s04_mem1 <= t12_t0_s04
	...
	S += (t12_t4_s02*ADD[0])-1 < t12_t4_s03_mem0*ADD_mem[0]
	S += (t12_t4_s02*ADD[1])-1 < t12_t4_s03_mem0*ADD_mem[1]
	S += (t12_t4_s02*ADD[2])-1 < t12_t4_s03_mem0*ADD_mem[2]
	S += (t12_t4_s02*ADD[3])-1 < t12_t4_s03_mem0*ADD_mem[3]
	...
	S += (t12_s0_y1_1*ADD[0])-1 < t12_s0_y1_2_mem0*ADD_mem[0]
	S += (t12_s0_y1_1*ADD[1])-1 < t12_s0_y1_2_mem0*ADD_mem[1]
	S += (t12_s0_y1_1*ADD[2])-1 < t12_s0_y1_2_mem0*ADD_mem[2]
	S += (t12_s0_y1_1*ADD[3])-1 < t12_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (t1211*ADD[0])-1 < t1311_mem0*ADD_mem[0]
	S += (t1211*ADD[1])-1 < t1311_mem0*ADD_mem[1]
	S += (t1211*ADD[2])-1 < t1311_mem0*ADD_mem[2]
	S += (t1211*ADD[3])-1 < t1311_mem0*ADD_mem[3]
	S += t1311_mem0 <= t1311
	...
	S += (t1301*ADD[0])-1 < new_TZ01_mem0*ADD_mem[0]
	S += (t1301*ADD[1])-1 < new_TZ01_mem0*ADD_mem[1]
	S += (t1301*ADD[2])-1 < new_TZ01_mem0*ADD_mem[2]
	S += (t1301*ADD[3])-1 < new_TZ01_mem0*ADD_mem[3]
	...
	t18_t2_s03_mem0 += alt(ADD_mem)
	S += (t18_t2_s02*ADD[0])-1 < t18_t2_s03_mem0*ADD_mem[0]
	S += (t18_t2_s02*ADD[1])-1 < t18_t2_s03_mem0*ADD_mem[1]
	S += (t18_t2_s02*ADD[2])-1 < t18_t2_s03_mem0*ADD_mem[2]
	S += (t18_t2_s02*ADD[3])-1 < t18_t2_s03_mem0*ADD_mem[3]
	S += t18_t2_s03_mem0 <= t18_t2_s03

	t18_t3_s04 = S.Task('t18_t3_s04', length=1, delay_cost=1)
	t18_t3_s04 += alt(ADD)

	t18_t3_s04_mem0 = S.Task('t18_t3_s04_mem0', length=1, delay_cost=1)
	t18_t3_s04_mem0 += alt(ADD_mem)
	S += (t18_t3_s03*ADD[0])-1 < t18_t3_s04_mem0*ADD_mem[0]
	S += (t18_t3_s03*ADD[1])-1 < t18_t3_s04_mem0*ADD_mem[1]
	S += (t18_t3_s03*ADD[2])-1 < t18_t3_s04_mem0*ADD_mem[2]
	S += (t18_t3_s03*ADD[3])-1 < t18_t3_s04_mem0*ADD_mem[3]
	S += t18_t3_s04_mem0 <= t18_t3_s04

	t18_t3_s04_mem1 = S.Task('t18_t3_s04_mem1', length=1, delay_cost=1)
	t18_t3_s04_mem1 += MUL_mem[0]
	S += 81 < t18_t3_s04_mem1
	...
	t18_t4_y1_2_mem0 += alt(ADD_mem)
	S += (t18_t4_y1_1*ADD[0])-1 < t18_t4_y1_2_mem0*ADD_mem[0]
	S += (t18_t4_y1_1*ADD[1])-1 < t18_t4_y1_2_mem0*ADD_mem[1]
	S += (t18_t4_y1_1*ADD[2])-1 < t18_t4_y1_2_mem0*ADD_mem[2]
	S += (t18_t4_y1_1*ADD[3])-1 < t18_t4_y1_2_mem0*ADD_mem[3]
	S += t18_t4_y1_2_mem0 <= t18_t4_y1_2
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/PDBL_mul1_add4/PDBL_7.png"
	if(S.solution() != []):
