...
def solve():
	...
	S += (c_f101_s02*ADD[0]) < c_f101_s03_mem0*ADD_mem[0]
	S += (c_f101_s02*ADD[1]) < c_f101_s03_mem0*ADD_mem[1]
	S += (c_f101_s02*ADD[2]) < c_f101_s03_mem0*ADD_mem[2]
	S += (c_f101_s02*ADD[3]) < c_f101_s03_mem0*ADD_mem[3]
	...
	S += (c_f011_s02*ADD[0]) < c_f011_s03_mem0*ADD_mem[0]
	S += (c_f011_s02*ADD[1]) < c_f011_s03_mem0*ADD_mem[1]
	S += (c_f011_s02*ADD[2]) < c_f011_s03_mem0*ADD_mem[2]
	S += (c_f011_s02*ADD[3]) < c_f011_s03_mem0*ADD_mem[3]
	...
	S += (c_f111_s02*ADD[0]) < c_f111_s03_mem0*ADD_mem[0]
	S += (c_f111_s02*ADD[1]) < c_f111_s03_mem0*ADD_mem[1]
	S += (c_f111_s02*ADD[2]) < c_f111_s03_mem0*ADD_mem[2]
	S += (c_f111_s02*ADD[3]) < c_f111_s03_mem0*ADD_mem[3]
	...
	S += (c_f021_s02*ADD[0]) < c_f021_s03_mem0*ADD_mem[0]
	S += (c_f021_s02*ADD[1]) < c_f021_s03_mem0*ADD_mem[1]
	S += (c_f021_s02*ADD[2]) < c_f021_s03_mem0*ADD_mem[2]
	S += (c_f021_s02*ADD[3]) < c_f021_s03_mem0*ADD_mem[3]
	...
	S += (c_f121_s02*ADD[0]) < c_f121_s03_mem0*ADD_mem[0]
	S += (c_f121_s02*ADD[1]) < c_f121_s03_mem0*ADD_mem[1]
	S += (c_f121_s02*ADD[2]) < c_f121_s03_mem0*ADD_mem[2]
	S += (c_f121_s02*ADD[3]) < c_f121_s03_mem0*ADD_mem[3]
	...
	S += (c001_s02*ADD[0]) < c001_s03_mem0*ADD_mem[0]
	S += (c001_s02*ADD[1]) < c001_s03_mem0*ADD_mem[1]
	S += (c001_s02*ADD[2]) < c001_s03_mem0*ADD_mem[2]
	S += (c001_s02*ADD[3]) < c001_s03_mem0*ADD_mem[3]
	...
	S += (c10_t0_s02*ADD[0]) < c10_t0_s03_mem0*ADD_mem[0]
	S += (c10_t0_s02*ADD[1]) < c10_t0_s03_mem0*ADD_mem[1]
	S += (c10_t0_s02*ADD[2]) < c10_t0_s03_mem0*ADD_mem[2]
	S += (c10_t0_s02*ADD[3]) < c10_t0_s03_mem0*ADD_mem[3]
	...
	S += (c10_t1_t1*MUL[0]) < c10_t1_s00_mem0*MUL_mem[0]
	...
	S += (c01_t0_s02*ADD[0]) < c01_t0_s03_mem0*ADD_mem[0]
	S += (c01_t0_s02*ADD[1]) < c01_t0_s03_mem0*ADD_mem[1]
	S += (c01_t0_s02*ADD[2]) < c01_t0_s03_mem0*ADD_mem[2]
	S += (c01_t0_s02*ADD[3]) < c01_t0_s03_mem0*ADD_mem[3]
	...
	S += (c01_t1_t1*MUL[0]) < c01_t1_s00_mem0*MUL_mem[0]
	...
	S += (c11_t0_s02*ADD[0]) < c11_t0_s03_mem0*ADD_mem[0]
	S += (c11_t0_s02*ADD[1]) < c11_t0_s03_mem0*ADD_mem[1]
	S += (c11_t0_s02*ADD[2]) < c11_t0_s03_mem0*ADD_mem[2]
	S += (c11_t0_s02*ADD[3]) < c11_t0_s03_mem0*ADD_mem[3]
	...
	S += (c11_t1_t1*MUL[0]) < c11_t1_s00_mem0*MUL_mem[0]
	...
	S += (c02_t0_s02*ADD[0]) < c02_t0_s03_mem0*ADD_mem[0]
	S += (c02_t0_s02*ADD[1]) < c02_t0_s03_mem0*ADD_mem[1]
	S += (c02_t0_s02*ADD[2]) < c02_t0_s03_mem0*ADD_mem[2]
	S += (c02_t0_s02*ADD[3]) < c02_t0_s03_mem0*ADD_mem[3]
	...
	S += (c02_t1_t1*MUL[0]) < c02_t1_s00_mem0*MUL_mem[0]
	...
	S += (c12_t0_s02*ADD[0]) < c12_t0_s03_mem0*ADD_mem[0]
	S += (c12_t0_s02*ADD[1]) < c12_t0_s03_mem0*ADD_mem[1]
	S += (c12_t0_s02*ADD[2]) < c12_t0_s03_mem0*ADD_mem[2]
	S += (c12_t0_s02*ADD[3]) < c12_t0_s03_mem0*ADD_mem[3]
	...
	S += (c12_t1_t1*MUL[0]) < c12_t1_s00_mem0*MUL_mem[0]
	...
	S += (c_f101_s03*ADD[0]) < c_f101_s04_mem0*ADD_mem[0]
	S += (c_f101_s03*ADD[1]) < c_f101_s04_mem0*ADD_mem[1]
	S += (c_f101_s03*ADD[2]) < c_f101_s04_mem0*ADD_mem[2]
	S += (c_f101_s03*ADD[3]) < c_f101_s04_mem0*ADD_mem[3]
	...
	S += (c_f011_s03*ADD[0]) < c_f011_s04_mem0*ADD_mem[0]
	S += (c_f011_s03*ADD[1]) < c_f011_s04_mem0*ADD_mem[1]
	S += (c_f011_s03*ADD[2]) < c_f011_s04_mem0*ADD_mem[2]
	S += (c_f011_s03*ADD[3]) < c_f011_s04_mem0*ADD_mem[3]
	...
	S += (c_f111_s03*ADD[0]) < c_f111_s04_mem0*ADD_mem[0]
	S += (c_f111_s03*ADD[1]) < c_f111_s04_mem0*ADD_mem[1]
	S += (c_f111_s03*ADD[2]) < c_f111_s04_mem0*ADD_mem[2]
	S += (c_f111_s03*ADD[3]) < c_f111_s04_mem0*ADD_mem[3]
	...
	S += (c_f021_s03*ADD[0]) < c_f021_s04_mem0*ADD_mem[0]
	S += (c_f021_s03*ADD[1]) < c_f021_s04_mem0*ADD_mem[1]
	S += (c_f021_s03*ADD[2]) < c_f021_s04_mem0*ADD_mem[2]
	S += (c_f021_s03*ADD[3]) < c_f021_s04_mem0*ADD_mem[3]
	...
	S += (c_f121_s03*ADD[0]) < c_f121_s04_mem0*ADD_mem[0]
	S += (c_f121_s03*ADD[1]) < c_f121_s04_mem0*ADD_mem[1]
	S += (c_f121_s03*ADD[2]) < c_f121_s04_mem0*ADD_mem[2]
	S += (c_f121_s03*ADD[3]) < c_f121_s04_mem0*ADD_mem[3]
	...
	S += (c001_s03*ADD[0]) < c001_s04_mem0*ADD_mem[0]
	S += (c001_s03*ADD[1]) < c001_s04_mem0*ADD_mem[1]
	S += (c001_s03*ADD[2]) < c001_s04_mem0*ADD_mem[2]
	S += (c001_s03*ADD[3]) < c001_s04_mem0*ADD_mem[3]
	...
	S += (c10_t0_s03*ADD[0]) < c10_t0_s04_mem0*ADD_mem[0]
	S += (c10_t0_s03*ADD[1]) < c10_t0_s04_mem0*ADD_mem[1]
	S += (c10_t0_s03*ADD[2]) < c10_t0_s04_mem0*ADD_mem[2]
	S += (c10_t0_s03*ADD[3]) < c10_t0_s04_mem0*ADD_mem[3]
	...
	S += (c10_t1_s00*ADD[0]) < c10_t1_s01_mem0*ADD_mem[0]
	S += (c10_t1_s00*ADD[1]) < c10_t1_s01_mem0*ADD_mem[1]
	S += (c10_t1_s00*ADD[2]) < c10_t1_s01_mem0*ADD_mem[2]
	S += (c10_t1_s00*ADD[3]) < c10_t1_s01_mem0*ADD_mem[3]
	S += c10_t1_s01_mem0 <= c10_t1_s01

	c10_t1_s01_mem1 = S.Task('c10_t1_s01_mem1', length=1, delay_cost=1)
	c10_t1_s01_mem1 += alt(MUL_mem)
	S += (c10_t1_t1*MUL[0]) < c10_t1_s01_mem1*MUL_mem[0]
	...
	S += (c10_t4_t1*MUL[0]) < c10_t4_s00_mem0*MUL_mem[0]
	...
	S += (c01_t0_s03*ADD[0]) < c01_t0_s04_mem0*ADD_mem[0]
	S += (c01_t0_s03*ADD[1]) < c01_t0_s04_mem0*ADD_mem[1]
	S += (c01_t0_s03*ADD[2]) < c01_t0_s04_mem0*ADD_mem[2]
	S += (c01_t0_s03*ADD[3]) < c01_t0_s04_mem0*ADD_mem[3]
	S += c01_t0_s04_mem0 <= c01_t0_s04

	c01_t0_s04_mem1 = S.Task('c01_t0_s04_mem1', length=1, delay_cost=1)
	c01_t0_s04_mem1 += MUL_mem[0]
	S += 44 < c01_t0_s04_mem1
	...
	S += (c01_t1_s00*ADD[0]) < c01_t1_s01_mem0*ADD_mem[0]
	S += (c01_t1_s00*ADD[1]) < c01_t1_s01_mem0*ADD_mem[1]
	S += (c01_t1_s00*ADD[2]) < c01_t1_s01_mem0*ADD_mem[2]
	S += (c01_t1_s00*ADD[3]) < c01_t1_s01_mem0*ADD_mem[3]
	S += c01_t1_s01_mem0 <= c01_t1_s01

	c01_t1_s01_mem1 = S.Task('c01_t1_s01_mem1', length=1, delay_cost=1)
	c01_t1_s01_mem1 += alt(MUL_mem)
	S += (c01_t1_t1*MUL[0]) < c01_t1_s01_mem1*MUL_mem[0]
	...
	S += (c01_t4_t1*MUL[0]) < c01_t4_s00_mem0*MUL_mem[0]
	...
	S += (c11_t0_s03*ADD[0]) < c11_t0_s04_mem0*ADD_mem[0]
	S += (c11_t0_s03*ADD[1]) < c11_t0_s04_mem0*ADD_mem[1]
	S += (c11_t0_s03*ADD[2]) < c11_t0_s04_mem0*ADD_mem[2]
	S += (c11_t0_s03*ADD[3]) < c11_t0_s04_mem0*ADD_mem[3]
	S += c11_t0_s04_mem0 <= c11_t0_s04

	c11_t0_s04_mem1 = S.Task('c11_t0_s04_mem1', length=1, delay_cost=1)
	c11_t0_s04_mem1 += MUL_mem[0]
	S += 37 < c11_t0_s04_mem1
	...
	S += (c11_t1_s00*ADD[0]) < c11_t1_s01_mem0*ADD_mem[0]
	S += (c11_t1_s00*ADD[1]) < c11_t1_s01_mem0*ADD_mem[1]
	S += (c11_t1_s00*ADD[2]) < c11_t1_s01_mem0*ADD_mem[2]
	S += (c11_t1_s00*ADD[3]) < c11_t1_s01_mem0*ADD_mem[3]
	S += c11_t1_s01_mem0 <= c11_t1_s01

	c11_t1_s01_mem1 = S.Task('c11_t1_s01_mem1', length=1, delay_cost=1)
	c11_t1_s01_mem1 += alt(MUL_mem)
	S += (c11_t1_t1*MUL[0]) < c11_t1_s01_mem1*MUL_mem[0]
	...
	S += (c11_t4_t1*MUL[0]) < c11_t4_s00_mem0*MUL_mem[0]
	...
	S += (c02_t0_s03*ADD[0]) < c02_t0_s04_mem0*ADD_mem[0]
	S += (c02_t0_s03*ADD[1]) < c02_t0_s04_mem0*ADD_mem[1]
	S += (c02_t0_s03*ADD[2]) < c02_t0_s04_mem0*ADD_mem[2]
	S += (c02_t0_s03*ADD[3]) < c02_t0_s04_mem0*ADD_mem[3]
	S += c02_t0_s04_mem0 <= c02_t0_s04

	c02_t0_s04_mem1 = S.Task('c02_t0_s04_mem1', length=1, delay_cost=1)
	c02_t0_s04_mem1 += MUL_mem[0]
	S += 40 < c02_t0_s04_mem1
	...
	S += (c02_t1_s00*ADD[0]) < c02_t1_s01_mem0*ADD_mem[0]
	S += (c02_t1_s00*ADD[1]) < c02_t1_s01_mem0*ADD_mem[1]
	S += (c02_t1_s00*ADD[2]) < c02_t1_s01_mem0*ADD_mem[2]
	S += (c02_t1_s00*ADD[3]) < c02_t1_s01_mem0*ADD_mem[3]
	S += c02_t1_s01_mem0 <= c02_t1_s01

	c02_t1_s01_mem1 = S.Task('c02_t1_s01_mem1', length=1, delay_cost=1)
	c02_t1_s01_mem1 += alt(MUL_mem)
	S += (c02_t1_t1*MUL[0]) < c02_t1_s01_mem1*MUL_mem[0]
	...
	S += (c02_t4_t1*MUL[0]) < c02_t4_s00_mem0*MUL_mem[0]
	...
	S += (c12_t0_s03*ADD[0]) < c12_t0_s04_mem0*ADD_mem[0]
	S += (c12_t0_s03*ADD[1]) < c12_t0_s04_mem0*ADD_mem[1]
	S += (c12_t0_s03*ADD[2]) < c12_t0_s04_mem0*ADD_mem[2]
	S += (c12_t0_s03*ADD[3]) < c12_t0_s04_mem0*ADD_mem[3]
	S += c12_t0_s04_mem0 <= c12_t0_s04

	c12_t0_s04_mem1 = S.Task('c12_t0_s04_mem1', length=1, delay_cost=1)
	c12_t0_s04_mem1 += MUL_mem[0]
	S += 42 < c12_t0_s04_mem1
	...
	S += (c12_t1_s00*ADD[0]) < c12_t1_s01_mem0*ADD_mem[0]
	S += (c12_t1_s00*ADD[1]) < c12_t1_s01_mem0*ADD_mem[1]
	S += (c12_t1_s00*ADD[2]) < c12_t1_s01_mem0*ADD_mem[2]
	S += (c12_t1_s00*ADD[3]) < c12_t1_s01_mem0*ADD_mem[3]
	S += c12_t1_s01_mem0 <= c12_t1_s01

	c12_t1_s01_mem1 = S.Task('c12_t1_s01_mem1', length=1, delay_cost=1)
	c12_t1_s01_mem1 += alt(MUL_mem)
	S += (c12_t1_t1*MUL[0]) < c12_t1_s01_mem1*MUL_mem[0]
	...
	S += (c12_t4_t1*MUL[0]) < c12_t4_s00_mem0*MUL_mem[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/FROB_mul1_add4/FROB_4.png"
	if(S.solution() != []):
