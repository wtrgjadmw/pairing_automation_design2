...
def solve():
	horizon = 191
	S = Scenario("FROB_7", horizon=horizon)
	...
	S += c12_t1_s03_mem0 >= 75
	c12_t1_s03_mem0 += ADD_mem[3]
	...
	S += c10_t4_s02_mem0 >= 79
	c10_t4_s02_mem0 += ADD_mem[2]
	...
	S += c01_t4_s04_mem0 >= 81
	c01_t4_s04_mem0 += ADD_mem[3]

	c01_t4_s04_mem1 = S.Task('c01_t4_s04_mem1', length=1, delay_cost=1)
	S += c01_t4_s04_mem1 >= 81
	...
	S += c02_t1_s04_mem0 >= 82
	c02_t1_s04_mem0 += ADD_mem[1]

	c02_t1_s04_mem1 = S.Task('c02_t1_s04_mem1', length=1, delay_cost=1)
	S += c02_t1_s04_mem1 >= 82
	...
	S += c12_t1_s04_mem0 >= 82
	c12_t1_s04_mem0 += ADD_mem[1]

	c12_t1_s04_mem1 = S.Task('c12_t1_s04_mem1', length=1, delay_cost=1)
	S += c12_t1_s04_mem1 >= 82
	...
	S += c12_t4_s03_mem0 >= 82
	c12_t4_s03_mem0 += ADD_mem[0]
	...
	S += c02_t4_s03_mem0 >= 83
	c02_t4_s03_mem0 += ADD_mem[3]
	...
	c10_s0_y1_0_mem0 += ADD_mem[2]
	S += 94 < c10_s0_y1_0_mem0
	...
	c01_s0_y1_0_mem0 += ADD_mem[3]
	S += 95 < c01_s0_y1_0_mem0
	...
	c11_s0_y1_0_mem0 += ADD_mem[2]
	S += 95 < c11_s0_y1_0_mem0
	...
	c12_s0_y1_0_mem0 += ADD_mem[0]
	S += 90 < c12_s0_y1_0_mem0
	...
	S += (c10_s0_y1_0*ADD[0]) < c10_s0_y1_1_mem0*ADD_mem[0]
	S += (c10_s0_y1_0*ADD[1]) < c10_s0_y1_1_mem0*ADD_mem[1]
	S += (c10_s0_y1_0*ADD[2]) < c10_s0_y1_1_mem0*ADD_mem[2]
	S += (c10_s0_y1_0*ADD[3]) < c10_s0_y1_1_mem0*ADD_mem[3]
	S += c10_s0_y1_1_mem0 <= c10_s0_y1_1

	c10_s0_y1_1_mem1 = S.Task('c10_s0_y1_1_mem1', length=1, delay_cost=1)
	c10_s0_y1_1_mem1 += ADD_mem[2]
	S += 94 < c10_s0_y1_1_mem1
	...
	S += (c10_t40*ADD[0]) < c1010_mem0*ADD_mem[0]
	S += (c10_t40*ADD[1]) < c1010_mem0*ADD_mem[1]
	S += (c10_t40*ADD[2]) < c1010_mem0*ADD_mem[2]
	S += (c10_t40*ADD[3]) < c1010_mem0*ADD_mem[3]
	S += c1010_mem0 <= c1010

	c1010_mem1 = S.Task('c1010_mem1', length=1, delay_cost=1)
	c1010_mem1 += alt(ADD_mem)
	S += (c10_t50*ADD[0]) < c1010_mem1*ADD_mem[0]
	S += (c10_t50*ADD[1]) < c1010_mem1*ADD_mem[1]
	S += (c10_t50*ADD[2]) < c1010_mem1*ADD_mem[2]
	S += (c10_t50*ADD[3]) < c1010_mem1*ADD_mem[3]
	S += c1010_mem1 <= c1010
	...
	S += (c01_s0_y1_0*ADD[0]) < c01_s0_y1_1_mem0*ADD_mem[0]
	S += (c01_s0_y1_0*ADD[1]) < c01_s0_y1_1_mem0*ADD_mem[1]
	S += (c01_s0_y1_0*ADD[2]) < c01_s0_y1_1_mem0*ADD_mem[2]
	S += (c01_s0_y1_0*ADD[3]) < c01_s0_y1_1_mem0*ADD_mem[3]
	S += c01_s0_y1_1_mem0 <= c01_s0_y1_1

	c01_s0_y1_1_mem1 = S.Task('c01_s0_y1_1_mem1', length=1, delay_cost=1)
	c01_s0_y1_1_mem1 += ADD_mem[3]
	S += 95 < c01_s0_y1_1_mem1
	...
	S += (c01_t40*ADD[0]) < c0110_mem0*ADD_mem[0]
	S += (c01_t40*ADD[1]) < c0110_mem0*ADD_mem[1]
	S += (c01_t40*ADD[2]) < c0110_mem0*ADD_mem[2]
	S += (c01_t40*ADD[3]) < c0110_mem0*ADD_mem[3]
	S += c0110_mem0 <= c0110

	c0110_mem1 = S.Task('c0110_mem1', length=1, delay_cost=1)
	c0110_mem1 += alt(ADD_mem)
	S += (c01_t50*ADD[0]) < c0110_mem1*ADD_mem[0]
	S += (c01_t50*ADD[1]) < c0110_mem1*ADD_mem[1]
	S += (c01_t50*ADD[2]) < c0110_mem1*ADD_mem[2]
	S += (c01_t50*ADD[3]) < c0110_mem1*ADD_mem[3]
	S += c0110_mem1 <= c0110
	...
	S += (c11_s0_y1_0*ADD[0]) < c11_s0_y1_1_mem0*ADD_mem[0]
	S += (c11_s0_y1_0*ADD[1]) < c11_s0_y1_1_mem0*ADD_mem[1]
	S += (c11_s0_y1_0*ADD[2]) < c11_s0_y1_1_mem0*ADD_mem[2]
	S += (c11_s0_y1_0*ADD[3]) < c11_s0_y1_1_mem0*ADD_mem[3]
	S += c11_s0_y1_1_mem0 <= c11_s0_y1_1

	c11_s0_y1_1_mem1 = S.Task('c11_s0_y1_1_mem1', length=1, delay_cost=1)
	c11_s0_y1_1_mem1 += ADD_mem[2]
	S += 95 < c11_s0_y1_1_mem1
	...
	S += (c11_t40*ADD[0]) < c1110_mem0*ADD_mem[0]
	S += (c11_t40*ADD[1]) < c1110_mem0*ADD_mem[1]
	S += (c11_t40*ADD[2]) < c1110_mem0*ADD_mem[2]
	S += (c11_t40*ADD[3]) < c1110_mem0*ADD_mem[3]
	S += c1110_mem0 <= c1110

	c1110_mem1 = S.Task('c1110_mem1', length=1, delay_cost=1)
	c1110_mem1 += alt(ADD_mem)
	S += (c11_t50*ADD[0]) < c1110_mem1*ADD_mem[0]
	S += (c11_t50*ADD[1]) < c1110_mem1*ADD_mem[1]
	S += (c11_t50*ADD[2]) < c1110_mem1*ADD_mem[2]
	S += (c11_t50*ADD[3]) < c1110_mem1*ADD_mem[3]
	S += c1110_mem1 <= c1110
	...
	S += (c02_s0_y1_0*ADD[0]) < c02_s0_y1_1_mem0*ADD_mem[0]
	S += (c02_s0_y1_0*ADD[1]) < c02_s0_y1_1_mem0*ADD_mem[1]
	S += (c02_s0_y1_0*ADD[2]) < c02_s0_y1_1_mem0*ADD_mem[2]
	S += (c02_s0_y1_0*ADD[3]) < c02_s0_y1_1_mem0*ADD_mem[3]
	...
	S += (c02_t40*ADD[0]) < c0210_mem0*ADD_mem[0]
	S += (c02_t40*ADD[1]) < c0210_mem0*ADD_mem[1]
	S += (c02_t40*ADD[2]) < c0210_mem0*ADD_mem[2]
	S += (c02_t40*ADD[3]) < c0210_mem0*ADD_mem[3]
	S += c0210_mem0 <= c0210

	c0210_mem1 = S.Task('c0210_mem1', length=1, delay_cost=1)
	c0210_mem1 += alt(ADD_mem)
	S += (c02_t50*ADD[0]) < c0210_mem1*ADD_mem[0]
	S += (c02_t50*ADD[1]) < c0210_mem1*ADD_mem[1]
	S += (c02_t50*ADD[2]) < c0210_mem1*ADD_mem[2]
	S += (c02_t50*ADD[3]) < c0210_mem1*ADD_mem[3]
	S += c0210_mem1 <= c0210
	...
	S += (c12_s0_y1_0*ADD[0]) < c12_s0_y1_1_mem0*ADD_mem[0]
	S += (c12_s0_y1_0*ADD[1]) < c12_s0_y1_1_mem0*ADD_mem[1]
	S += (c12_s0_y1_0*ADD[2]) < c12_s0_y1_1_mem0*ADD_mem[2]
	S += (c12_s0_y1_0*ADD[3]) < c12_s0_y1_1_mem0*ADD_mem[3]
	S += c12_s0_y1_1_mem0 <= c12_s0_y1_1

	c12_s0_y1_1_mem1 = S.Task('c12_s0_y1_1_mem1', length=1, delay_cost=1)
	c12_s0_y1_1_mem1 += ADD_mem[0]
	S += 90 < c12_s0_y1_1_mem1
	...
	S += (c12_t40*ADD[0]) < c1210_mem0*ADD_mem[0]
	S += (c12_t40*ADD[1]) < c1210_mem0*ADD_mem[1]
	S += (c12_t40*ADD[2]) < c1210_mem0*ADD_mem[2]
	S += (c12_t40*ADD[3]) < c1210_mem0*ADD_mem[3]
	S += c1210_mem0 <= c1210

	c1210_mem1 = S.Task('c1210_mem1', length=1, delay_cost=1)
	c1210_mem1 += alt(ADD_mem)
	S += (c12_t50*ADD[0]) < c1210_mem1*ADD_mem[0]
	S += (c12_t50*ADD[1]) < c1210_mem1*ADD_mem[1]
	S += (c12_t50*ADD[2]) < c1210_mem1*ADD_mem[2]
	S += (c12_t50*ADD[3]) < c1210_mem1*ADD_mem[3]
	S += c1210_mem1 <= c1210
	...
	S += (c10_s0_y1_1*ADD[0]) < c10_s0_y1_2_mem0*ADD_mem[0]
	S += (c10_s0_y1_1*ADD[1]) < c10_s0_y1_2_mem0*ADD_mem[1]
	S += (c10_s0_y1_1*ADD[2]) < c10_s0_y1_2_mem0*ADD_mem[2]
	S += (c10_s0_y1_1*ADD[3]) < c10_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (c01_s0_y1_1*ADD[0]) < c01_s0_y1_2_mem0*ADD_mem[0]
	S += (c01_s0_y1_1*ADD[1]) < c01_s0_y1_2_mem0*ADD_mem[1]
	S += (c01_s0_y1_1*ADD[2]) < c01_s0_y1_2_mem0*ADD_mem[2]
	S += (c01_s0_y1_1*ADD[3]) < c01_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (c11_s0_y1_1*ADD[0]) < c11_s0_y1_2_mem0*ADD_mem[0]
	S += (c11_s0_y1_1*ADD[1]) < c11_s0_y1_2_mem0*ADD_mem[1]
	S += (c11_s0_y1_1*ADD[2]) < c11_s0_y1_2_mem0*ADD_mem[2]
	S += (c11_s0_y1_1*ADD[3]) < c11_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (c02_s0_y1_1*ADD[0]) < c02_s0_y1_2_mem0*ADD_mem[0]
	S += (c02_s0_y1_1*ADD[1]) < c02_s0_y1_2_mem0*ADD_mem[1]
	S += (c02_s0_y1_1*ADD[2]) < c02_s0_y1_2_mem0*ADD_mem[2]
	S += (c02_s0_y1_1*ADD[3]) < c02_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (c12_s0_y1_1*ADD[0]) < c12_s0_y1_2_mem0*ADD_mem[0]
	S += (c12_s0_y1_1*ADD[1]) < c12_s0_y1_2_mem0*ADD_mem[1]
	S += (c12_s0_y1_1*ADD[2]) < c12_s0_y1_2_mem0*ADD_mem[2]
	S += (c12_s0_y1_1*ADD[3]) < c12_s0_y1_2_mem0*ADD_mem[3]
	...
	S += (c10_s0_y1_2*ADD[0]) < c10_s0_y1_3_mem0*ADD_mem[0]
	S += (c10_s0_y1_2*ADD[1]) < c10_s0_y1_3_mem0*ADD_mem[1]
	S += (c10_s0_y1_2*ADD[2]) < c10_s0_y1_3_mem0*ADD_mem[2]
	S += (c10_s0_y1_2*ADD[3]) < c10_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (c01_s0_y1_2*ADD[0]) < c01_s0_y1_3_mem0*ADD_mem[0]
	S += (c01_s0_y1_2*ADD[1]) < c01_s0_y1_3_mem0*ADD_mem[1]
	S += (c01_s0_y1_2*ADD[2]) < c01_s0_y1_3_mem0*ADD_mem[2]
	S += (c01_s0_y1_2*ADD[3]) < c01_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (c11_s0_y1_2*ADD[0]) < c11_s0_y1_3_mem0*ADD_mem[0]
	S += (c11_s0_y1_2*ADD[1]) < c11_s0_y1_3_mem0*ADD_mem[1]
	S += (c11_s0_y1_2*ADD[2]) < c11_s0_y1_3_mem0*ADD_mem[2]
	S += (c11_s0_y1_2*ADD[3]) < c11_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (c02_s0_y1_2*ADD[0]) < c02_s0_y1_3_mem0*ADD_mem[0]
	S += (c02_s0_y1_2*ADD[1]) < c02_s0_y1_3_mem0*ADD_mem[1]
	S += (c02_s0_y1_2*ADD[2]) < c02_s0_y1_3_mem0*ADD_mem[2]
	S += (c02_s0_y1_2*ADD[3]) < c02_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (c12_s0_y1_2*ADD[0]) < c12_s0_y1_3_mem0*ADD_mem[0]
	S += (c12_s0_y1_2*ADD[1]) < c12_s0_y1_3_mem0*ADD_mem[1]
	S += (c12_s0_y1_2*ADD[2]) < c12_s0_y1_3_mem0*ADD_mem[2]
	S += (c12_s0_y1_2*ADD[3]) < c12_s0_y1_3_mem0*ADD_mem[3]
	...
	S += (c10_s0_y1_3*ADD[0]) < c10_s0_y1_4_mem0*ADD_mem[0]
	S += (c10_s0_y1_3*ADD[1]) < c10_s0_y1_4_mem0*ADD_mem[1]
	S += (c10_s0_y1_3*ADD[2]) < c10_s0_y1_4_mem0*ADD_mem[2]
	S += (c10_s0_y1_3*ADD[3]) < c10_s0_y1_4_mem0*ADD_mem[3]
	S += c10_s0_y1_4_mem0 <= c10_s0_y1_4

	c10_s0_y1_4_mem1 = S.Task('c10_s0_y1_4_mem1', length=1, delay_cost=1)
	c10_s0_y1_4_mem1 += ADD_mem[2]
	S += 94 < c10_s0_y1_4_mem1
	...
	S += (c01_s0_y1_3*ADD[0]) < c01_s0_y1_4_mem0*ADD_mem[0]
	S += (c01_s0_y1_3*ADD[1]) < c01_s0_y1_4_mem0*ADD_mem[1]
	S += (c01_s0_y1_3*ADD[2]) < c01_s0_y1_4_mem0*ADD_mem[2]
	S += (c01_s0_y1_3*ADD[3]) < c01_s0_y1_4_mem0*ADD_mem[3]
	S += c01_s0_y1_4_mem0 <= c01_s0_y1_4

	c01_s0_y1_4_mem1 = S.Task('c01_s0_y1_4_mem1', length=1, delay_cost=1)
	c01_s0_y1_4_mem1 += ADD_mem[3]
	S += 95 < c01_s0_y1_4_mem1
	...
	S += (c11_s0_y1_3*ADD[0]) < c11_s0_y1_4_mem0*ADD_mem[0]
	S += (c11_s0_y1_3*ADD[1]) < c11_s0_y1_4_mem0*ADD_mem[1]
	S += (c11_s0_y1_3*ADD[2]) < c11_s0_y1_4_mem0*ADD_mem[2]
	S += (c11_s0_y1_3*ADD[3]) < c11_s0_y1_4_mem0*ADD_mem[3]
	S += c11_s0_y1_4_mem0 <= c11_s0_y1_4

	c11_s0_y1_4_mem1 = S.Task('c11_s0_y1_4_mem1', length=1, delay_cost=1)
	c11_s0_y1_4_mem1 += ADD_mem[2]
	S += 95 < c11_s0_y1_4_mem1
	...
	S += (c02_s0_y1_3*ADD[0]) < c02_s0_y1_4_mem0*ADD_mem[0]
	S += (c02_s0_y1_3*ADD[1]) < c02_s0_y1_4_mem0*ADD_mem[1]
	S += (c02_s0_y1_3*ADD[2]) < c02_s0_y1_4_mem0*ADD_mem[2]
	S += (c02_s0_y1_3*ADD[3]) < c02_s0_y1_4_mem0*ADD_mem[3]
	...
	S += (c12_s0_y1_3*ADD[0]) < c12_s0_y1_4_mem0*ADD_mem[0]
	S += (c12_s0_y1_3*ADD[1]) < c12_s0_y1_4_mem0*ADD_mem[1]
	S += (c12_s0_y1_3*ADD[2]) < c12_s0_y1_4_mem0*ADD_mem[2]
	S += (c12_s0_y1_3*ADD[3]) < c12_s0_y1_4_mem0*ADD_mem[3]
	S += c12_s0_y1_4_mem0 <= c12_s0_y1_4

	c12_s0_y1_4_mem1 = S.Task('c12_s0_y1_4_mem1', length=1, delay_cost=1)
	c12_s0_y1_4_mem1 += ADD_mem[0]
	S += 90 < c12_s0_y1_4_mem1
	...
	S += (c10_s0_y1_4*ADD[0]) < c1000_mem1*ADD_mem[0]
	S += (c10_s0_y1_4*ADD[1]) < c1000_mem1*ADD_mem[1]
	S += (c10_s0_y1_4*ADD[2]) < c1000_mem1*ADD_mem[2]
	S += (c10_s0_y1_4*ADD[3]) < c1000_mem1*ADD_mem[3]
	S += c1000_mem1 <= c1000
	...
	S += (c01_s0_y1_4*ADD[0]) < c0100_mem1*ADD_mem[0]
	S += (c01_s0_y1_4*ADD[1]) < c0100_mem1*ADD_mem[1]
	S += (c01_s0_y1_4*ADD[2]) < c0100_mem1*ADD_mem[2]
	S += (c01_s0_y1_4*ADD[3]) < c0100_mem1*ADD_mem[3]
	S += c0100_mem1 <= c0100
	...
	S += (c11_s0_y1_4*ADD[0]) < c1100_mem1*ADD_mem[0]
	S += (c11_s0_y1_4*ADD[1]) < c1100_mem1*ADD_mem[1]
	S += (c11_s0_y1_4*ADD[2]) < c1100_mem1*ADD_mem[2]
	S += (c11_s0_y1_4*ADD[3]) < c1100_mem1*ADD_mem[3]
	S += c1100_mem1 <= c1100
	...
	S += (c02_s0_y1_4*ADD[0]) < c0200_mem1*ADD_mem[0]
	S += (c02_s0_y1_4*ADD[1]) < c0200_mem1*ADD_mem[1]
	S += (c02_s0_y1_4*ADD[2]) < c0200_mem1*ADD_mem[2]
	S += (c02_s0_y1_4*ADD[3]) < c0200_mem1*ADD_mem[3]
	S += c0200_mem1 <= c0200
	...
	S += (c12_s0_y1_4*ADD[0]) < c1200_mem1*ADD_mem[0]
	S += (c12_s0_y1_4*ADD[1]) < c1200_mem1*ADD_mem[1]
	S += (c12_s0_y1_4*ADD[2]) < c1200_mem1*ADD_mem[2]
	S += (c12_s0_y1_4*ADD[3]) < c1200_mem1*ADD_mem[3]
	S += c1200_mem1 <= c1200
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/FROB_mul1_add4/FROB_7.png"
	if(S.solution() != []):
