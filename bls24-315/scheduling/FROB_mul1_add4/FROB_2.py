...
def solve():
	...
	S += 13 < c_f101_s00_mem0
	S += c_f101_s00_mem0 <= c_f101_s00
	...
	S += 11 < c_f011_s00_mem0
	S += c_f011_s00_mem0 <= c_f011_s00
	...
	S += 19 < c_f021_s00_mem0
	S += c_f021_s00_mem0 <= c_f021_s00
	...
	S += 16 < c_f121_s00_mem0
	S += c_f121_s00_mem0 <= c_f121_s00
	...
	S += 10 < c10_t0_s00_mem0
	S += c10_t0_s00_mem0 <= c10_t0_s00
	...
	S += 43 < c01_t0_s00_mem0
	S += c01_t0_s00_mem0 <= c01_t0_s00
	...
	S += 38 < c11_t0_s00_mem0
	S += c11_t0_s00_mem0 <= c11_t0_s00
	...
	S += 41 < c02_t0_s00_mem0
	S += c02_t0_s00_mem0 <= c02_t0_s00
	...
	S += 37 < c12_t0_s00_mem0
	S += c12_t0_s00_mem0 <= c12_t0_s00
	...
	c_f101_s01_mem0 += alt(ADD_mem)
	S += (c_f101_s00*ADD[0])-1 < c_f101_s01_mem0*ADD_mem[0]
	S += (c_f101_s00*ADD[1])-1 < c_f101_s01_mem0*ADD_mem[1]
	S += (c_f101_s00*ADD[2])-1 < c_f101_s01_mem0*ADD_mem[2]
	S += (c_f101_s00*ADD[3])-1 < c_f101_s01_mem0*ADD_mem[3]
	S += c_f101_s01_mem0 <= c_f101_s01

	c_f101_s01_mem1 = S.Task('c_f101_s01_mem1', length=1, delay_cost=1)
	c_f101_s01_mem1 += MUL_mem[0]
	S += 13 < c_f101_s01_mem1
	S += c_f101_s01_mem1 <= c_f101_s01
	...
	S += (c_f101_t4*MUL[0])-1 < c_f1011_mem0*MUL_mem[0]
	S += c_f1011_mem0 <= c_f1011

	c_f1011_mem1 = S.Task('c_f1011_mem1', length=1, delay_cost=1)
	c_f1011_mem1 += alt(ADD_mem)
	S += (c_f101_t5*ADD[0])-1 < c_f1011_mem1*ADD_mem[0]
	S += (c_f101_t5*ADD[1])-1 < c_f1011_mem1*ADD_mem[1]
	S += (c_f101_t5*ADD[2])-1 < c_f1011_mem1*ADD_mem[2]
	S += (c_f101_t5*ADD[3])-1 < c_f1011_mem1*ADD_mem[3]
	...
	c_f011_s01_mem0 += alt(ADD_mem)
	S += (c_f011_s00*ADD[0])-1 < c_f011_s01_mem0*ADD_mem[0]
	S += (c_f011_s00*ADD[1])-1 < c_f011_s01_mem0*ADD_mem[1]
	S += (c_f011_s00*ADD[2])-1 < c_f011_s01_mem0*ADD_mem[2]
	S += (c_f011_s00*ADD[3])-1 < c_f011_s01_mem0*ADD_mem[3]
	S += c_f011_s01_mem0 <= c_f011_s01

	c_f011_s01_mem1 = S.Task('c_f011_s01_mem1', length=1, delay_cost=1)
	c_f011_s01_mem1 += MUL_mem[0]
	S += 11 < c_f011_s01_mem1
	S += c_f011_s01_mem1 <= c_f011_s01
	...
	S += (c_f011_t4*MUL[0])-1 < c_f0111_mem0*MUL_mem[0]
	S += c_f0111_mem0 <= c_f0111

	c_f0111_mem1 = S.Task('c_f0111_mem1', length=1, delay_cost=1)
	c_f0111_mem1 += alt(ADD_mem)
	S += (c_f011_t5*ADD[0])-1 < c_f0111_mem1*ADD_mem[0]
	S += (c_f011_t5*ADD[1])-1 < c_f0111_mem1*ADD_mem[1]
	S += (c_f011_t5*ADD[2])-1 < c_f0111_mem1*ADD_mem[2]
	S += (c_f011_t5*ADD[3])-1 < c_f0111_mem1*ADD_mem[3]
	...
	c_f111_s01_mem0 += alt(ADD_mem)
	S += (c_f111_s00*ADD[0])-1 < c_f111_s01_mem0*ADD_mem[0]
	S += (c_f111_s00*ADD[1])-1 < c_f111_s01_mem0*ADD_mem[1]
	S += (c_f111_s00*ADD[2])-1 < c_f111_s01_mem0*ADD_mem[2]
	S += (c_f111_s00*ADD[3])-1 < c_f111_s01_mem0*ADD_mem[3]
	S += c_f111_s01_mem0 <= c_f111_s01

	c_f111_s01_mem1 = S.Task('c_f111_s01_mem1', length=1, delay_cost=1)
	c_f111_s01_mem1 += MUL_mem[0]
	S += 7 < c_f111_s01_mem1
	S += c_f111_s01_mem1 <= c_f111_s01
	...
	S += (c_f111_t4*MUL[0])-1 < c_f1111_mem0*MUL_mem[0]
	S += c_f1111_mem0 <= c_f1111

	c_f1111_mem1 = S.Task('c_f1111_mem1', length=1, delay_cost=1)
	c_f1111_mem1 += alt(ADD_mem)
	S += (c_f111_t5*ADD[0])-1 < c_f1111_mem1*ADD_mem[0]
	S += (c_f111_t5*ADD[1])-1 < c_f1111_mem1*ADD_mem[1]
	S += (c_f111_t5*ADD[2])-1 < c_f1111_mem1*ADD_mem[2]
	S += (c_f111_t5*ADD[3])-1 < c_f1111_mem1*ADD_mem[3]
	...
	c_f021_s01_mem0 += alt(ADD_mem)
	S += (c_f021_s00*ADD[0])-1 < c_f021_s01_mem0*ADD_mem[0]
	S += (c_f021_s00*ADD[1])-1 < c_f021_s01_mem0*ADD_mem[1]
	S += (c_f021_s00*ADD[2])-1 < c_f021_s01_mem0*ADD_mem[2]
	S += (c_f021_s00*ADD[3])-1 < c_f021_s01_mem0*ADD_mem[3]
	S += c_f021_s01_mem0 <= c_f021_s01

	c_f021_s01_mem1 = S.Task('c_f021_s01_mem1', length=1, delay_cost=1)
	c_f021_s01_mem1 += MUL_mem[0]
	S += 19 < c_f021_s01_mem1
	S += c_f021_s01_mem1 <= c_f021_s01
	...
	S += (c_f021_t4*MUL[0])-1 < c_f0211_mem0*MUL_mem[0]
	S += c_f0211_mem0 <= c_f0211

	c_f0211_mem1 = S.Task('c_f0211_mem1', length=1, delay_cost=1)
	c_f0211_mem1 += alt(ADD_mem)
	S += (c_f021_t5*ADD[0])-1 < c_f0211_mem1*ADD_mem[0]
	S += (c_f021_t5*ADD[1])-1 < c_f0211_mem1*ADD_mem[1]
	S += (c_f021_t5*ADD[2])-1 < c_f0211_mem1*ADD_mem[2]
	S += (c_f021_t5*ADD[3])-1 < c_f0211_mem1*ADD_mem[3]
	...
	c_f121_s01_mem0 += alt(ADD_mem)
	S += (c_f121_s00*ADD[0])-1 < c_f121_s01_mem0*ADD_mem[0]
	S += (c_f121_s00*ADD[1])-1 < c_f121_s01_mem0*ADD_mem[1]
	S += (c_f121_s00*ADD[2])-1 < c_f121_s01_mem0*ADD_mem[2]
	S += (c_f121_s00*ADD[3])-1 < c_f121_s01_mem0*ADD_mem[3]
	S += c_f121_s01_mem0 <= c_f121_s01

	c_f121_s01_mem1 = S.Task('c_f121_s01_mem1', length=1, delay_cost=1)
	c_f121_s01_mem1 += MUL_mem[0]
	S += 16 < c_f121_s01_mem1
	S += c_f121_s01_mem1 <= c_f121_s01
	...
	S += (c_f121_t4*MUL[0])-1 < c_f1211_mem0*MUL_mem[0]
	S += c_f1211_mem0 <= c_f1211

	c_f1211_mem1 = S.Task('c_f1211_mem1', length=1, delay_cost=1)
	c_f1211_mem1 += alt(ADD_mem)
	S += (c_f121_t5*ADD[0])-1 < c_f1211_mem1*ADD_mem[0]
	S += (c_f121_t5*ADD[1])-1 < c_f1211_mem1*ADD_mem[1]
	S += (c_f121_t5*ADD[2])-1 < c_f1211_mem1*ADD_mem[2]
	S += (c_f121_t5*ADD[3])-1 < c_f1211_mem1*ADD_mem[3]
	...
	c001_s01_mem0 += alt(ADD_mem)
	S += (c001_s00*ADD[0])-1 < c001_s01_mem0*ADD_mem[0]
	S += (c001_s00*ADD[1])-1 < c001_s01_mem0*ADD_mem[1]
	S += (c001_s00*ADD[2])-1 < c001_s01_mem0*ADD_mem[2]
	S += (c001_s00*ADD[3])-1 < c001_s01_mem0*ADD_mem[3]
	S += c001_s01_mem0 <= c001_s01

	c001_s01_mem1 = S.Task('c001_s01_mem1', length=1, delay_cost=1)
	c001_s01_mem1 += MUL_mem[0]
	S += 20 < c001_s01_mem1
	S += c001_s01_mem1 <= c001_s01

	c10_t0_s01 = S.Task('c10_t0_s01', length=1, delay_cost=1)
	c10_t0_s01 += alt(ADD)

	c10_t0_s01_mem0 = S.Task('c10_t0_s01_mem0', length=1, delay_cost=1)
	c10_t0_s01_mem0 += alt(ADD_mem)
	S += (c10_t0_s00*ADD[0])-1 < c10_t0_s01_mem0*ADD_mem[0]
	S += (c10_t0_s00*ADD[1])-1 < c10_t0_s01_mem0*ADD_mem[1]
	S += (c10_t0_s00*ADD[2])-1 < c10_t0_s01_mem0*ADD_mem[2]
	S += (c10_t0_s00*ADD[3])-1 < c10_t0_s01_mem0*ADD_mem[3]
	S += c10_t0_s01_mem0 <= c10_t0_s01

	c10_t0_s01_mem1 = S.Task('c10_t0_s01_mem1', length=1, delay_cost=1)
	c10_t0_s01_mem1 += MUL_mem[0]
	S += 10 < c10_t0_s01_mem1
	S += c10_t0_s01_mem1 <= c10_t0_s01
	...
	S += (c10_t0_t4*MUL[0])-1 < c10_t01_mem0*MUL_mem[0]
	S += c10_t01_mem0 <= c10_t01

	c10_t01_mem1 = S.Task('c10_t01_mem1', length=1, delay_cost=1)
	c10_t01_mem1 += alt(ADD_mem)
	S += (c10_t0_t5*ADD[0])-1 < c10_t01_mem1*ADD_mem[0]
	S += (c10_t0_t5*ADD[1])-1 < c10_t01_mem1*ADD_mem[1]
	S += (c10_t0_t5*ADD[2])-1 < c10_t01_mem1*ADD_mem[2]
	S += (c10_t0_t5*ADD[3])-1 < c10_t01_mem1*ADD_mem[3]
	...
	c01_t0_s01_mem0 += alt(ADD_mem)
	S += (c01_t0_s00*ADD[0])-1 < c01_t0_s01_mem0*ADD_mem[0]
	S += (c01_t0_s00*ADD[1])-1 < c01_t0_s01_mem0*ADD_mem[1]
	S += (c01_t0_s00*ADD[2])-1 < c01_t0_s01_mem0*ADD_mem[2]
	S += (c01_t0_s00*ADD[3])-1 < c01_t0_s01_mem0*ADD_mem[3]
	S += c01_t0_s01_mem0 <= c01_t0_s01

	c01_t0_s01_mem1 = S.Task('c01_t0_s01_mem1', length=1, delay_cost=1)
	c01_t0_s01_mem1 += MUL_mem[0]
	S += 43 < c01_t0_s01_mem1
	S += c01_t0_s01_mem1 <= c01_t0_s01
	...
	S += (c01_t0_t4*MUL[0])-1 < c01_t01_mem0*MUL_mem[0]
	S += c01_t01_mem0 <= c01_t01

	c01_t01_mem1 = S.Task('c01_t01_mem1', length=1, delay_cost=1)
	c01_t01_mem1 += alt(ADD_mem)
	S += (c01_t0_t5*ADD[0])-1 < c01_t01_mem1*ADD_mem[0]
	S += (c01_t0_t5*ADD[1])-1 < c01_t01_mem1*ADD_mem[1]
	S += (c01_t0_t5*ADD[2])-1 < c01_t01_mem1*ADD_mem[2]
	S += (c01_t0_t5*ADD[3])-1 < c01_t01_mem1*ADD_mem[3]
	...
	c11_t0_s01_mem0 += alt(ADD_mem)
	S += (c11_t0_s00*ADD[0])-1 < c11_t0_s01_mem0*ADD_mem[0]
	S += (c11_t0_s00*ADD[1])-1 < c11_t0_s01_mem0*ADD_mem[1]
	S += (c11_t0_s00*ADD[2])-1 < c11_t0_s01_mem0*ADD_mem[2]
	S += (c11_t0_s00*ADD[3])-1 < c11_t0_s01_mem0*ADD_mem[3]
	S += c11_t0_s01_mem0 <= c11_t0_s01

	c11_t0_s01_mem1 = S.Task('c11_t0_s01_mem1', length=1, delay_cost=1)
	c11_t0_s01_mem1 += MUL_mem[0]
	S += 38 < c11_t0_s01_mem1
	S += c11_t0_s01_mem1 <= c11_t0_s01
	...
	S += (c11_t0_t4*MUL[0])-1 < c11_t01_mem0*MUL_mem[0]
	S += c11_t01_mem0 <= c11_t01

	c11_t01_mem1 = S.Task('c11_t01_mem1', length=1, delay_cost=1)
	c11_t01_mem1 += alt(ADD_mem)
	S += (c11_t0_t5*ADD[0])-1 < c11_t01_mem1*ADD_mem[0]
	S += (c11_t0_t5*ADD[1])-1 < c11_t01_mem1*ADD_mem[1]
	S += (c11_t0_t5*ADD[2])-1 < c11_t01_mem1*ADD_mem[2]
	S += (c11_t0_t5*ADD[3])-1 < c11_t01_mem1*ADD_mem[3]
	...
	c02_t0_s01_mem0 += alt(ADD_mem)
	S += (c02_t0_s00*ADD[0])-1 < c02_t0_s01_mem0*ADD_mem[0]
	S += (c02_t0_s00*ADD[1])-1 < c02_t0_s01_mem0*ADD_mem[1]
	S += (c02_t0_s00*ADD[2])-1 < c02_t0_s01_mem0*ADD_mem[2]
	S += (c02_t0_s00*ADD[3])-1 < c02_t0_s01_mem0*ADD_mem[3]
	S += c02_t0_s01_mem0 <= c02_t0_s01

	c02_t0_s01_mem1 = S.Task('c02_t0_s01_mem1', length=1, delay_cost=1)
	c02_t0_s01_mem1 += MUL_mem[0]
	S += 41 < c02_t0_s01_mem1
	S += c02_t0_s01_mem1 <= c02_t0_s01
	...
	S += (c02_t0_t4*MUL[0])-1 < c02_t01_mem0*MUL_mem[0]
	S += c02_t01_mem0 <= c02_t01

	c02_t01_mem1 = S.Task('c02_t01_mem1', length=1, delay_cost=1)
	c02_t01_mem1 += alt(ADD_mem)
	S += (c02_t0_t5*ADD[0])-1 < c02_t01_mem1*ADD_mem[0]
	S += (c02_t0_t5*ADD[1])-1 < c02_t01_mem1*ADD_mem[1]
	S += (c02_t0_t5*ADD[2])-1 < c02_t01_mem1*ADD_mem[2]
	S += (c02_t0_t5*ADD[3])-1 < c02_t01_mem1*ADD_mem[3]
	...
	c12_t0_s01_mem0 += alt(ADD_mem)
	S += (c12_t0_s00*ADD[0])-1 < c12_t0_s01_mem0*ADD_mem[0]
	S += (c12_t0_s00*ADD[1])-1 < c12_t0_s01_mem0*ADD_mem[1]
	S += (c12_t0_s00*ADD[2])-1 < c12_t0_s01_mem0*ADD_mem[2]
	S += (c12_t0_s00*ADD[3])-1 < c12_t0_s01_mem0*ADD_mem[3]
	S += c12_t0_s01_mem0 <= c12_t0_s01

	c12_t0_s01_mem1 = S.Task('c12_t0_s01_mem1', length=1, delay_cost=1)
	c12_t0_s01_mem1 += MUL_mem[0]
	S += 37 < c12_t0_s01_mem1
	S += c12_t0_s01_mem1 <= c12_t0_s01
	...
	S += (c12_t0_t4*MUL[0])-1 < c12_t01_mem0*MUL_mem[0]
	S += c12_t01_mem0 <= c12_t01

	c12_t01_mem1 = S.Task('c12_t01_mem1', length=1, delay_cost=1)
	c12_t01_mem1 += alt(ADD_mem)
	S += (c12_t0_t5*ADD[0])-1 < c12_t01_mem1*ADD_mem[0]
	S += (c12_t0_t5*ADD[1])-1 < c12_t01_mem1*ADD_mem[1]
	S += (c12_t0_t5*ADD[2])-1 < c12_t01_mem1*ADD_mem[2]
	S += (c12_t0_t5*ADD[3])-1 < c12_t01_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/FROB_mul1_add4/FROB_2.png"
	if(S.solution() != []):
