...
def solve():
	...
	S += 15 < c_f101_s02_mem0
	S += c_f101_s02_mem0 <= c_f101_s02
	...
	S += 14 < c_f011_s02_mem0
	S += c_f011_s02_mem0 <= c_f011_s02
	...
	S += 22 < c_f021_s02_mem0
	S += c_f021_s02_mem0 <= c_f021_s02
	...
	S += 21 < c_f121_s02_mem0
	S += c_f121_s02_mem0 <= c_f121_s02
	...
	S += 12 < c10_t0_s02_mem0
	S += c10_t0_s02_mem0 <= c10_t0_s02
	...
	S += 46 < c01_t0_s02_mem0
	S += c01_t0_s02_mem0 <= c01_t0_s02
	...
	S += 42 < c11_t0_s02_mem0
	S += c11_t0_s02_mem0 <= c11_t0_s02
	...
	S += 44 < c02_t0_s02_mem0
	S += c02_t0_s02_mem0 <= c02_t0_s02
	...
	S += 39 < c12_t0_s02_mem0
	S += c12_t0_s02_mem0 <= c12_t0_s02
	...
	c_f101_s03_mem0 += alt(ADD_mem)
	S += (c_f101_s02*ADD[0])-1 < c_f101_s03_mem0*ADD_mem[0]
	S += (c_f101_s02*ADD[1])-1 < c_f101_s03_mem0*ADD_mem[1]
	S += (c_f101_s02*ADD[2])-1 < c_f101_s03_mem0*ADD_mem[2]
	S += (c_f101_s02*ADD[3])-1 < c_f101_s03_mem0*ADD_mem[3]
	S += c_f101_s03_mem0 <= c_f101_s03

	c_f011_s03 = S.Task('c_f011_s03', length=1, delay_cost=1)
	c_f011_s03 += alt(ADD)

	c_f011_s03_mem0 = S.Task('c_f011_s03_mem0', length=1, delay_cost=1)
	c_f011_s03_mem0 += alt(ADD_mem)
	S += (c_f011_s02*ADD[0])-1 < c_f011_s03_mem0*ADD_mem[0]
	S += (c_f011_s02*ADD[1])-1 < c_f011_s03_mem0*ADD_mem[1]
	S += (c_f011_s02*ADD[2])-1 < c_f011_s03_mem0*ADD_mem[2]
	S += (c_f011_s02*ADD[3])-1 < c_f011_s03_mem0*ADD_mem[3]
	S += c_f011_s03_mem0 <= c_f011_s03

	c_f111_s03 = S.Task('c_f111_s03', length=1, delay_cost=1)
	c_f111_s03 += alt(ADD)

	c_f111_s03_mem0 = S.Task('c_f111_s03_mem0', length=1, delay_cost=1)
	c_f111_s03_mem0 += alt(ADD_mem)
	S += (c_f111_s02*ADD[0])-1 < c_f111_s03_mem0*ADD_mem[0]
	S += (c_f111_s02*ADD[1])-1 < c_f111_s03_mem0*ADD_mem[1]
	S += (c_f111_s02*ADD[2])-1 < c_f111_s03_mem0*ADD_mem[2]
	S += (c_f111_s02*ADD[3])-1 < c_f111_s03_mem0*ADD_mem[3]
	S += c_f111_s03_mem0 <= c_f111_s03

	c_f021_s03 = S.Task('c_f021_s03', length=1, delay_cost=1)
	c_f021_s03 += alt(ADD)

	c_f021_s03_mem0 = S.Task('c_f021_s03_mem0', length=1, delay_cost=1)
	c_f021_s03_mem0 += alt(ADD_mem)
	S += (c_f021_s02*ADD[0])-1 < c_f021_s03_mem0*ADD_mem[0]
	S += (c_f021_s02*ADD[1])-1 < c_f021_s03_mem0*ADD_mem[1]
	S += (c_f021_s02*ADD[2])-1 < c_f021_s03_mem0*ADD_mem[2]
	S += (c_f021_s02*ADD[3])-1 < c_f021_s03_mem0*ADD_mem[3]
	S += c_f021_s03_mem0 <= c_f021_s03

	c_f121_s03 = S.Task('c_f121_s03', length=1, delay_cost=1)
	c_f121_s03 += alt(ADD)

	c_f121_s03_mem0 = S.Task('c_f121_s03_mem0', length=1, delay_cost=1)
	c_f121_s03_mem0 += alt(ADD_mem)
	S += (c_f121_s02*ADD[0])-1 < c_f121_s03_mem0*ADD_mem[0]
	S += (c_f121_s02*ADD[1])-1 < c_f121_s03_mem0*ADD_mem[1]
	S += (c_f121_s02*ADD[2])-1 < c_f121_s03_mem0*ADD_mem[2]
	S += (c_f121_s02*ADD[3])-1 < c_f121_s03_mem0*ADD_mem[3]
	S += c_f121_s03_mem0 <= c_f121_s03

	c001_s03 = S.Task('c001_s03', length=1, delay_cost=1)
	c001_s03 += alt(ADD)

	c001_s03_mem0 = S.Task('c001_s03_mem0', length=1, delay_cost=1)
	c001_s03_mem0 += alt(ADD_mem)
	S += (c001_s02*ADD[0])-1 < c001_s03_mem0*ADD_mem[0]
	S += (c001_s02*ADD[1])-1 < c001_s03_mem0*ADD_mem[1]
	S += (c001_s02*ADD[2])-1 < c001_s03_mem0*ADD_mem[2]
	S += (c001_s02*ADD[3])-1 < c001_s03_mem0*ADD_mem[3]
	S += c001_s03_mem0 <= c001_s03

	c10_t0_s03 = S.Task('c10_t0_s03', length=1, delay_cost=1)
	c10_t0_s03 += alt(ADD)

	c10_t0_s03_mem0 = S.Task('c10_t0_s03_mem0', length=1, delay_cost=1)
	c10_t0_s03_mem0 += alt(ADD_mem)
	S += (c10_t0_s02*ADD[0])-1 < c10_t0_s03_mem0*ADD_mem[0]
	S += (c10_t0_s02*ADD[1])-1 < c10_t0_s03_mem0*ADD_mem[1]
	S += (c10_t0_s02*ADD[2])-1 < c10_t0_s03_mem0*ADD_mem[2]
	S += (c10_t0_s02*ADD[3])-1 < c10_t0_s03_mem0*ADD_mem[3]
	S += c10_t0_s03_mem0 <= c10_t0_s03

	c10_t1_s00 = S.Task('c10_t1_s00', length=1, delay_cost=1)
	c10_t1_s00 += alt(ADD)

	c10_t1_s00_mem0 = S.Task('c10_t1_s00_mem0', length=1, delay_cost=1)
	c10_t1_s00_mem0 += alt(MUL_mem)
	S += (c10_t1_t1*MUL[0])-1 < c10_t1_s00_mem0*MUL_mem[0]
	S += c10_t1_s00_mem0 <= c10_t1_s00
	...
	S += (c10_t21*ADD[0])-1 < c10_t4_t1_mem0*ADD_mem[0]
	S += (c10_t21*ADD[1])-1 < c10_t4_t1_mem0*ADD_mem[1]
	S += (c10_t21*ADD[2])-1 < c10_t4_t1_mem0*ADD_mem[2]
	S += (c10_t21*ADD[3])-1 < c10_t4_t1_mem0*ADD_mem[3]
	...
	c01_t0_s03_mem0 += alt(ADD_mem)
	S += (c01_t0_s02*ADD[0])-1 < c01_t0_s03_mem0*ADD_mem[0]
	S += (c01_t0_s02*ADD[1])-1 < c01_t0_s03_mem0*ADD_mem[1]
	S += (c01_t0_s02*ADD[2])-1 < c01_t0_s03_mem0*ADD_mem[2]
	S += (c01_t0_s02*ADD[3])-1 < c01_t0_s03_mem0*ADD_mem[3]
	S += c01_t0_s03_mem0 <= c01_t0_s03

	c01_t1_s00 = S.Task('c01_t1_s00', length=1, delay_cost=1)
	c01_t1_s00 += alt(ADD)

	c01_t1_s00_mem0 = S.Task('c01_t1_s00_mem0', length=1, delay_cost=1)
	c01_t1_s00_mem0 += alt(MUL_mem)
	S += (c01_t1_t1*MUL[0])-1 < c01_t1_s00_mem0*MUL_mem[0]
	S += c01_t1_s00_mem0 <= c01_t1_s00
	...
	S += (c01_t21*ADD[0])-1 < c01_t4_t1_mem0*ADD_mem[0]
	S += (c01_t21*ADD[1])-1 < c01_t4_t1_mem0*ADD_mem[1]
	S += (c01_t21*ADD[2])-1 < c01_t4_t1_mem0*ADD_mem[2]
	S += (c01_t21*ADD[3])-1 < c01_t4_t1_mem0*ADD_mem[3]
	...
	c11_t0_s03_mem0 += alt(ADD_mem)
	S += (c11_t0_s02*ADD[0])-1 < c11_t0_s03_mem0*ADD_mem[0]
	S += (c11_t0_s02*ADD[1])-1 < c11_t0_s03_mem0*ADD_mem[1]
	S += (c11_t0_s02*ADD[2])-1 < c11_t0_s03_mem0*ADD_mem[2]
	S += (c11_t0_s02*ADD[3])-1 < c11_t0_s03_mem0*ADD_mem[3]
	S += c11_t0_s03_mem0 <= c11_t0_s03

	c11_t1_s00 = S.Task('c11_t1_s00', length=1, delay_cost=1)
	c11_t1_s00 += alt(ADD)

	c11_t1_s00_mem0 = S.Task('c11_t1_s00_mem0', length=1, delay_cost=1)
	c11_t1_s00_mem0 += alt(MUL_mem)
	S += (c11_t1_t1*MUL[0])-1 < c11_t1_s00_mem0*MUL_mem[0]
	S += c11_t1_s00_mem0 <= c11_t1_s00
	...
	S += (c11_t21*ADD[0])-1 < c11_t4_t1_mem0*ADD_mem[0]
	S += (c11_t21*ADD[1])-1 < c11_t4_t1_mem0*ADD_mem[1]
	S += (c11_t21*ADD[2])-1 < c11_t4_t1_mem0*ADD_mem[2]
	S += (c11_t21*ADD[3])-1 < c11_t4_t1_mem0*ADD_mem[3]
	...
	c02_t0_s03_mem0 += alt(ADD_mem)
	S += (c02_t0_s02*ADD[0])-1 < c02_t0_s03_mem0*ADD_mem[0]
	S += (c02_t0_s02*ADD[1])-1 < c02_t0_s03_mem0*ADD_mem[1]
	S += (c02_t0_s02*ADD[2])-1 < c02_t0_s03_mem0*ADD_mem[2]
	S += (c02_t0_s02*ADD[3])-1 < c02_t0_s03_mem0*ADD_mem[3]
	S += c02_t0_s03_mem0 <= c02_t0_s03

	c02_t1_s00 = S.Task('c02_t1_s00', length=1, delay_cost=1)
	c02_t1_s00 += alt(ADD)

	c02_t1_s00_mem0 = S.Task('c02_t1_s00_mem0', length=1, delay_cost=1)
	c02_t1_s00_mem0 += alt(MUL_mem)
	S += (c02_t1_t1*MUL[0])-1 < c02_t1_s00_mem0*MUL_mem[0]
	S += c02_t1_s00_mem0 <= c02_t1_s00
	...
	S += (c02_t21*ADD[0])-1 < c02_t4_t1_mem0*ADD_mem[0]
	S += (c02_t21*ADD[1])-1 < c02_t4_t1_mem0*ADD_mem[1]
	S += (c02_t21*ADD[2])-1 < c02_t4_t1_mem0*ADD_mem[2]
	S += (c02_t21*ADD[3])-1 < c02_t4_t1_mem0*ADD_mem[3]
	...
	c12_t0_s03_mem0 += alt(ADD_mem)
	S += (c12_t0_s02*ADD[0])-1 < c12_t0_s03_mem0*ADD_mem[0]
	S += (c12_t0_s02*ADD[1])-1 < c12_t0_s03_mem0*ADD_mem[1]
	S += (c12_t0_s02*ADD[2])-1 < c12_t0_s03_mem0*ADD_mem[2]
	S += (c12_t0_s02*ADD[3])-1 < c12_t0_s03_mem0*ADD_mem[3]
	S += c12_t0_s03_mem0 <= c12_t0_s03

	c12_t1_s00 = S.Task('c12_t1_s00', length=1, delay_cost=1)
	c12_t1_s00 += alt(ADD)

	c12_t1_s00_mem0 = S.Task('c12_t1_s00_mem0', length=1, delay_cost=1)
	c12_t1_s00_mem0 += alt(MUL_mem)
	S += (c12_t1_t1*MUL[0])-1 < c12_t1_s00_mem0*MUL_mem[0]
	S += c12_t1_s00_mem0 <= c12_t1_s00
	...
	S += (c12_t21*ADD[0])-1 < c12_t4_t1_mem0*ADD_mem[0]
	S += (c12_t21*ADD[1])-1 < c12_t4_t1_mem0*ADD_mem[1]
	S += (c12_t21*ADD[2])-1 < c12_t4_t1_mem0*ADD_mem[2]
	S += (c12_t21*ADD[3])-1 < c12_t4_t1_mem0*ADD_mem[3]
	...
	c_f101_s04_mem0 += alt(ADD_mem)
	S += (c_f101_s03*ADD[0])-1 < c_f101_s04_mem0*ADD_mem[0]
	S += (c_f101_s03*ADD[1])-1 < c_f101_s04_mem0*ADD_mem[1]
	S += (c_f101_s03*ADD[2])-1 < c_f101_s04_mem0*ADD_mem[2]
	S += (c_f101_s03*ADD[3])-1 < c_f101_s04_mem0*ADD_mem[3]
	S += c_f101_s04_mem0 <= c_f101_s04

	c_f101_s04_mem1 = S.Task('c_f101_s04_mem1', length=1, delay_cost=1)
	c_f101_s04_mem1 += MUL_mem[0]
	S += 13 < c_f101_s04_mem1
	S += c_f101_s04_mem1 <= c_f101_s04

	c_f011_s04 = S.Task('c_f011_s04', length=1, delay_cost=1)
	c_f011_s04 += alt(ADD)

	c_f011_s04_mem0 = S.Task('c_f011_s04_mem0', length=1, delay_cost=1)
	c_f011_s04_mem0 += alt(ADD_mem)
	S += (c_f011_s03*ADD[0])-1 < c_f011_s04_mem0*ADD_mem[0]
	S += (c_f011_s03*ADD[1])-1 < c_f011_s04_mem0*ADD_mem[1]
	S += (c_f011_s03*ADD[2])-1 < c_f011_s04_mem0*ADD_mem[2]
	S += (c_f011_s03*ADD[3])-1 < c_f011_s04_mem0*ADD_mem[3]
	S += c_f011_s04_mem0 <= c_f011_s04

	c_f011_s04_mem1 = S.Task('c_f011_s04_mem1', length=1, delay_cost=1)
	c_f011_s04_mem1 += MUL_mem[0]
	S += 11 < c_f011_s04_mem1
	S += c_f011_s04_mem1 <= c_f011_s04

	c_f111_s04 = S.Task('c_f111_s04', length=1, delay_cost=1)
	c_f111_s04 += alt(ADD)

	c_f111_s04_mem0 = S.Task('c_f111_s04_mem0', length=1, delay_cost=1)
	c_f111_s04_mem0 += alt(ADD_mem)
	S += (c_f111_s03*ADD[0])-1 < c_f111_s04_mem0*ADD_mem[0]
	S += (c_f111_s03*ADD[1])-1 < c_f111_s04_mem0*ADD_mem[1]
	S += (c_f111_s03*ADD[2])-1 < c_f111_s04_mem0*ADD_mem[2]
	S += (c_f111_s03*ADD[3])-1 < c_f111_s04_mem0*ADD_mem[3]
	S += c_f111_s04_mem0 <= c_f111_s04

	c_f111_s04_mem1 = S.Task('c_f111_s04_mem1', length=1, delay_cost=1)
	c_f111_s04_mem1 += MUL_mem[0]
	S += 7 < c_f111_s04_mem1
	S += c_f111_s04_mem1 <= c_f111_s04

	c_f021_s04 = S.Task('c_f021_s04', length=1, delay_cost=1)
	c_f021_s04 += alt(ADD)

	c_f021_s04_mem0 = S.Task('c_f021_s04_mem0', length=1, delay_cost=1)
	c_f021_s04_mem0 += alt(ADD_mem)
	S += (c_f021_s03*ADD[0])-1 < c_f021_s04_mem0*ADD_mem[0]
	S += (c_f021_s03*ADD[1])-1 < c_f021_s04_mem0*ADD_mem[1]
	S += (c_f021_s03*ADD[2])-1 < c_f021_s04_mem0*ADD_mem[2]
	S += (c_f021_s03*ADD[3])-1 < c_f021_s04_mem0*ADD_mem[3]
	S += c_f021_s04_mem0 <= c_f021_s04

	c_f021_s04_mem1 = S.Task('c_f021_s04_mem1', length=1, delay_cost=1)
	c_f021_s04_mem1 += MUL_mem[0]
	S += 19 < c_f021_s04_mem1
	S += c_f021_s04_mem1 <= c_f021_s04

	c_f121_s04 = S.Task('c_f121_s04', length=1, delay_cost=1)
	c_f121_s04 += alt(ADD)

	c_f121_s04_mem0 = S.Task('c_f121_s04_mem0', length=1, delay_cost=1)
	c_f121_s04_mem0 += alt(ADD_mem)
	S += (c_f121_s03*ADD[0])-1 < c_f121_s04_mem0*ADD_mem[0]
	S += (c_f121_s03*ADD[1])-1 < c_f121_s04_mem0*ADD_mem[1]
	S += (c_f121_s03*ADD[2])-1 < c_f121_s04_mem0*ADD_mem[2]
	S += (c_f121_s03*ADD[3])-1 < c_f121_s04_mem0*ADD_mem[3]
	S += c_f121_s04_mem0 <= c_f121_s04

	c_f121_s04_mem1 = S.Task('c_f121_s04_mem1', length=1, delay_cost=1)
	c_f121_s04_mem1 += MUL_mem[0]
	S += 16 < c_f121_s04_mem1
	S += c_f121_s04_mem1 <= c_f121_s04

	c001_s04 = S.Task('c001_s04', length=1, delay_cost=1)
	c001_s04 += alt(ADD)

	c001_s04_mem0 = S.Task('c001_s04_mem0', length=1, delay_cost=1)
	c001_s04_mem0 += alt(ADD_mem)
	S += (c001_s03*ADD[0])-1 < c001_s04_mem0*ADD_mem[0]
	S += (c001_s03*ADD[1])-1 < c001_s04_mem0*ADD_mem[1]
	S += (c001_s03*ADD[2])-1 < c001_s04_mem0*ADD_mem[2]
	S += (c001_s03*ADD[3])-1 < c001_s04_mem0*ADD_mem[3]
	S += c001_s04_mem0 <= c001_s04

	c001_s04_mem1 = S.Task('c001_s04_mem1', length=1, delay_cost=1)
	c001_s04_mem1 += MUL_mem[0]
	S += 20 < c001_s04_mem1
	S += c001_s04_mem1 <= c001_s04

	c10_t0_s04 = S.Task('c10_t0_s04', length=1, delay_cost=1)
	c10_t0_s04 += alt(ADD)

	c10_t0_s04_mem0 = S.Task('c10_t0_s04_mem0', length=1, delay_cost=1)
	c10_t0_s04_mem0 += alt(ADD_mem)
	S += (c10_t0_s03*ADD[0])-1 < c10_t0_s04_mem0*ADD_mem[0]
	S += (c10_t0_s03*ADD[1])-1 < c10_t0_s04_mem0*ADD_mem[1]
	S += (c10_t0_s03*ADD[2])-1 < c10_t0_s04_mem0*ADD_mem[2]
	S += (c10_t0_s03*ADD[3])-1 < c10_t0_s04_mem0*ADD_mem[3]
	S += c10_t0_s04_mem0 <= c10_t0_s04

	c10_t0_s04_mem1 = S.Task('c10_t0_s04_mem1', length=1, delay_cost=1)
	c10_t0_s04_mem1 += MUL_mem[0]
	S += 10 < c10_t0_s04_mem1
	S += c10_t0_s04_mem1 <= c10_t0_s04

	c10_t1_s01 = S.Task('c10_t1_s01', length=1, delay_cost=1)
	c10_t1_s01 += alt(ADD)

	c10_t1_s01_mem0 = S.Task('c10_t1_s01_mem0', length=1, delay_cost=1)
	c10_t1_s01_mem0 += alt(ADD_mem)
	S += (c10_t1_s00*ADD[0])-1 < c10_t1_s01_mem0*ADD_mem[0]
	S += (c10_t1_s00*ADD[1])-1 < c10_t1_s01_mem0*ADD_mem[1]
	S += (c10_t1_s00*ADD[2])-1 < c10_t1_s01_mem0*ADD_mem[2]
	S += (c10_t1_s00*ADD[3])-1 < c10_t1_s01_mem0*ADD_mem[3]
	S += c10_t1_s01_mem0 <= c10_t1_s01

	c10_t1_s01_mem1 = S.Task('c10_t1_s01_mem1', length=1, delay_cost=1)
	c10_t1_s01_mem1 += alt(MUL_mem)
	S += (c10_t1_t1*MUL[0])-1 < c10_t1_s01_mem1*MUL_mem[0]
	S += c10_t1_s01_mem1 <= c10_t1_s01

	c10_t4_s00 = S.Task('c10_t4_s00', length=1, delay_cost=1)
	c10_t4_s00 += alt(ADD)

	c10_t4_s00_mem0 = S.Task('c10_t4_s00_mem0', length=1, delay_cost=1)
	c10_t4_s00_mem0 += alt(MUL_mem)
	S += (c10_t4_t1*MUL[0])-1 < c10_t4_s00_mem0*MUL_mem[0]
	S += c10_t4_s00_mem0 <= c10_t4_s00

	c01_t0_s04 = S.Task('c01_t0_s04', length=1, delay_cost=1)
	c01_t0_s04 += alt(ADD)

	c01_t0_s04_mem0 = S.Task('c01_t0_s04_mem0', length=1, delay_cost=1)
	c01_t0_s04_mem0 += alt(ADD_mem)
	S += (c01_t0_s03*ADD[0])-1 < c01_t0_s04_mem0*ADD_mem[0]
	S += (c01_t0_s03*ADD[1])-1 < c01_t0_s04_mem0*ADD_mem[1]
	S += (c01_t0_s03*ADD[2])-1 < c01_t0_s04_mem0*ADD_mem[2]
	S += (c01_t0_s03*ADD[3])-1 < c01_t0_s04_mem0*ADD_mem[3]
	S += c01_t0_s04_mem0 <= c01_t0_s04

	c01_t0_s04_mem1 = S.Task('c01_t0_s04_mem1', length=1, delay_cost=1)
	c01_t0_s04_mem1 += MUL_mem[0]
	S += 43 < c01_t0_s04_mem1
	S += c01_t0_s04_mem1 <= c01_t0_s04

	c01_t1_s01 = S.Task('c01_t1_s01', length=1, delay_cost=1)
	c01_t1_s01 += alt(ADD)

	c01_t1_s01_mem0 = S.Task('c01_t1_s01_mem0', length=1, delay_cost=1)
	c01_t1_s01_mem0 += alt(ADD_mem)
	S += (c01_t1_s00*ADD[0])-1 < c01_t1_s01_mem0*ADD_mem[0]
	S += (c01_t1_s00*ADD[1])-1 < c01_t1_s01_mem0*ADD_mem[1]
	S += (c01_t1_s00*ADD[2])-1 < c01_t1_s01_mem0*ADD_mem[2]
	S += (c01_t1_s00*ADD[3])-1 < c01_t1_s01_mem0*ADD_mem[3]
	S += c01_t1_s01_mem0 <= c01_t1_s01

	c01_t1_s01_mem1 = S.Task('c01_t1_s01_mem1', length=1, delay_cost=1)
	c01_t1_s01_mem1 += alt(MUL_mem)
	S += (c01_t1_t1*MUL[0])-1 < c01_t1_s01_mem1*MUL_mem[0]
	S += c01_t1_s01_mem1 <= c01_t1_s01

	c01_t4_s00 = S.Task('c01_t4_s00', length=1, delay_cost=1)
	c01_t4_s00 += alt(ADD)

	c01_t4_s00_mem0 = S.Task('c01_t4_s00_mem0', length=1, delay_cost=1)
	c01_t4_s00_mem0 += alt(MUL_mem)
	S += (c01_t4_t1*MUL[0])-1 < c01_t4_s00_mem0*MUL_mem[0]
	S += c01_t4_s00_mem0 <= c01_t4_s00

	c11_t0_s04 = S.Task('c11_t0_s04', length=1, delay_cost=1)
	c11_t0_s04 += alt(ADD)

	c11_t0_s04_mem0 = S.Task('c11_t0_s04_mem0', length=1, delay_cost=1)
	c11_t0_s04_mem0 += alt(ADD_mem)
	S += (c11_t0_s03*ADD[0])-1 < c11_t0_s04_mem0*ADD_mem[0]
	S += (c11_t0_s03*ADD[1])-1 < c11_t0_s04_mem0*ADD_mem[1]
	S += (c11_t0_s03*ADD[2])-1 < c11_t0_s04_mem0*ADD_mem[2]
	S += (c11_t0_s03*ADD[3])-1 < c11_t0_s04_mem0*ADD_mem[3]
	S += c11_t0_s04_mem0 <= c11_t0_s04

	c11_t0_s04_mem1 = S.Task('c11_t0_s04_mem1', length=1, delay_cost=1)
	c11_t0_s04_mem1 += MUL_mem[0]
	S += 38 < c11_t0_s04_mem1
	S += c11_t0_s04_mem1 <= c11_t0_s04

	c11_t1_s01 = S.Task('c11_t1_s01', length=1, delay_cost=1)
	c11_t1_s01 += alt(ADD)

	c11_t1_s01_mem0 = S.Task('c11_t1_s01_mem0', length=1, delay_cost=1)
	c11_t1_s01_mem0 += alt(ADD_mem)
	S += (c11_t1_s00*ADD[0])-1 < c11_t1_s01_mem0*ADD_mem[0]
	S += (c11_t1_s00*ADD[1])-1 < c11_t1_s01_mem0*ADD_mem[1]
	S += (c11_t1_s00*ADD[2])-1 < c11_t1_s01_mem0*ADD_mem[2]
	S += (c11_t1_s00*ADD[3])-1 < c11_t1_s01_mem0*ADD_mem[3]
	S += c11_t1_s01_mem0 <= c11_t1_s01

	c11_t1_s01_mem1 = S.Task('c11_t1_s01_mem1', length=1, delay_cost=1)
	c11_t1_s01_mem1 += alt(MUL_mem)
	S += (c11_t1_t1*MUL[0])-1 < c11_t1_s01_mem1*MUL_mem[0]
	S += c11_t1_s01_mem1 <= c11_t1_s01

	c11_t4_s00 = S.Task('c11_t4_s00', length=1, delay_cost=1)
	c11_t4_s00 += alt(ADD)

	c11_t4_s00_mem0 = S.Task('c11_t4_s00_mem0', length=1, delay_cost=1)
	c11_t4_s00_mem0 += alt(MUL_mem)
	S += (c11_t4_t1*MUL[0])-1 < c11_t4_s00_mem0*MUL_mem[0]
	S += c11_t4_s00_mem0 <= c11_t4_s00

	c02_t0_s04 = S.Task('c02_t0_s04', length=1, delay_cost=1)
	c02_t0_s04 += alt(ADD)

	c02_t0_s04_mem0 = S.Task('c02_t0_s04_mem0', length=1, delay_cost=1)
	c02_t0_s04_mem0 += alt(ADD_mem)
	S += (c02_t0_s03*ADD[0])-1 < c02_t0_s04_mem0*ADD_mem[0]
	S += (c02_t0_s03*ADD[1])-1 < c02_t0_s04_mem0*ADD_mem[1]
	S += (c02_t0_s03*ADD[2])-1 < c02_t0_s04_mem0*ADD_mem[2]
	S += (c02_t0_s03*ADD[3])-1 < c02_t0_s04_mem0*ADD_mem[3]
	S += c02_t0_s04_mem0 <= c02_t0_s04

	c02_t0_s04_mem1 = S.Task('c02_t0_s04_mem1', length=1, delay_cost=1)
	c02_t0_s04_mem1 += MUL_mem[0]
	S += 41 < c02_t0_s04_mem1
	S += c02_t0_s04_mem1 <= c02_t0_s04

	c02_t1_s01 = S.Task('c02_t1_s01', length=1, delay_cost=1)
	c02_t1_s01 += alt(ADD)

	c02_t1_s01_mem0 = S.Task('c02_t1_s01_mem0', length=1, delay_cost=1)
	c02_t1_s01_mem0 += alt(ADD_mem)
	S += (c02_t1_s00*ADD[0])-1 < c02_t1_s01_mem0*ADD_mem[0]
	S += (c02_t1_s00*ADD[1])-1 < c02_t1_s01_mem0*ADD_mem[1]
	S += (c02_t1_s00*ADD[2])-1 < c02_t1_s01_mem0*ADD_mem[2]
	S += (c02_t1_s00*ADD[3])-1 < c02_t1_s01_mem0*ADD_mem[3]
	S += c02_t1_s01_mem0 <= c02_t1_s01

	c02_t1_s01_mem1 = S.Task('c02_t1_s01_mem1', length=1, delay_cost=1)
	c02_t1_s01_mem1 += alt(MUL_mem)
	S += (c02_t1_t1*MUL[0])-1 < c02_t1_s01_mem1*MUL_mem[0]
	S += c02_t1_s01_mem1 <= c02_t1_s01

	c02_t4_s00 = S.Task('c02_t4_s00', length=1, delay_cost=1)
	c02_t4_s00 += alt(ADD)

	c02_t4_s00_mem0 = S.Task('c02_t4_s00_mem0', length=1, delay_cost=1)
	c02_t4_s00_mem0 += alt(MUL_mem)
	S += (c02_t4_t1*MUL[0])-1 < c02_t4_s00_mem0*MUL_mem[0]
	S += c02_t4_s00_mem0 <= c02_t4_s00

	c12_t0_s04 = S.Task('c12_t0_s04', length=1, delay_cost=1)
	c12_t0_s04 += alt(ADD)

	c12_t0_s04_mem0 = S.Task('c12_t0_s04_mem0', length=1, delay_cost=1)
	c12_t0_s04_mem0 += alt(ADD_mem)
	S += (c12_t0_s03*ADD[0])-1 < c12_t0_s04_mem0*ADD_mem[0]
	S += (c12_t0_s03*ADD[1])-1 < c12_t0_s04_mem0*ADD_mem[1]
	S += (c12_t0_s03*ADD[2])-1 < c12_t0_s04_mem0*ADD_mem[2]
	S += (c12_t0_s03*ADD[3])-1 < c12_t0_s04_mem0*ADD_mem[3]
	S += c12_t0_s04_mem0 <= c12_t0_s04

	c12_t0_s04_mem1 = S.Task('c12_t0_s04_mem1', length=1, delay_cost=1)
	c12_t0_s04_mem1 += MUL_mem[0]
	S += 37 < c12_t0_s04_mem1
	S += c12_t0_s04_mem1 <= c12_t0_s04

	c12_t1_s01 = S.Task('c12_t1_s01', length=1, delay_cost=1)
	c12_t1_s01 += alt(ADD)

	c12_t1_s01_mem0 = S.Task('c12_t1_s01_mem0', length=1, delay_cost=1)
	c12_t1_s01_mem0 += alt(ADD_mem)
	S += (c12_t1_s00*ADD[0])-1 < c12_t1_s01_mem0*ADD_mem[0]
	S += (c12_t1_s00*ADD[1])-1 < c12_t1_s01_mem0*ADD_mem[1]
	S += (c12_t1_s00*ADD[2])-1 < c12_t1_s01_mem0*ADD_mem[2]
	S += (c12_t1_s00*ADD[3])-1 < c12_t1_s01_mem0*ADD_mem[3]
	S += c12_t1_s01_mem0 <= c12_t1_s01

	c12_t1_s01_mem1 = S.Task('c12_t1_s01_mem1', length=1, delay_cost=1)
	c12_t1_s01_mem1 += alt(MUL_mem)
	S += (c12_t1_t1*MUL[0])-1 < c12_t1_s01_mem1*MUL_mem[0]
	S += c12_t1_s01_mem1 <= c12_t1_s01

	c12_t4_s00 = S.Task('c12_t4_s00', length=1, delay_cost=1)
	c12_t4_s00 += alt(ADD)

	c12_t4_s00_mem0 = S.Task('c12_t4_s00_mem0', length=1, delay_cost=1)
	c12_t4_s00_mem0 += alt(MUL_mem)
	S += (c12_t4_t1*MUL[0])-1 < c12_t4_s00_mem0*MUL_mem[0]
	S += c12_t4_s00_mem0 <= c12_t4_s00
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-315/scheduling/FROB_mul1_add4/FROB_3.png"
	if(S.solution() != []):
