...
def solve():
	...
	S += (c_f101_s00*ADD[0]) < c_f101_s01_mem0*ADD_mem[0]
	S += (c_f101_s00*ADD[1]) < c_f101_s01_mem0*ADD_mem[1]
	S += (c_f101_s00*ADD[2]) < c_f101_s01_mem0*ADD_mem[2]
	S += (c_f101_s00*ADD[3]) < c_f101_s01_mem0*ADD_mem[3]
	S += c_f101_s01_mem0 <= c_f101_s01

	c_f101_s01_mem1 = S.Task('c_f101_s01_mem1', length=1, delay_cost=1)
	c_f101_s01_mem1 += MUL_mem[0]
	S += 14 < c_f101_s01_mem1
	...
	S += (c_f011_s00*ADD[0]) < c_f011_s01_mem0*ADD_mem[0]
	S += (c_f011_s00*ADD[1]) < c_f011_s01_mem0*ADD_mem[1]
	S += (c_f011_s00*ADD[2]) < c_f011_s01_mem0*ADD_mem[2]
	S += (c_f011_s00*ADD[3]) < c_f011_s01_mem0*ADD_mem[3]
	S += c_f011_s01_mem0 <= c_f011_s01

	c_f011_s01_mem1 = S.Task('c_f011_s01_mem1', length=1, delay_cost=1)
	c_f011_s01_mem1 += MUL_mem[0]
	S += 12 < c_f011_s01_mem1
	...
	S += (c_f111_s00*ADD[0]) < c_f111_s01_mem0*ADD_mem[0]
	S += (c_f111_s00*ADD[1]) < c_f111_s01_mem0*ADD_mem[1]
	S += (c_f111_s00*ADD[2]) < c_f111_s01_mem0*ADD_mem[2]
	S += (c_f111_s00*ADD[3]) < c_f111_s01_mem0*ADD_mem[3]
	...
	S += (c_f021_s00*ADD[0]) < c_f021_s01_mem0*ADD_mem[0]
	S += (c_f021_s00*ADD[1]) < c_f021_s01_mem0*ADD_mem[1]
	S += (c_f021_s00*ADD[2]) < c_f021_s01_mem0*ADD_mem[2]
	S += (c_f021_s00*ADD[3]) < c_f021_s01_mem0*ADD_mem[3]
	S += c_f021_s01_mem0 <= c_f021_s01

	c_f021_s01_mem1 = S.Task('c_f021_s01_mem1', length=1, delay_cost=1)
	c_f021_s01_mem1 += MUL_mem[0]
	S += 20 < c_f021_s01_mem1
	...
	S += (c_f121_s00*ADD[0]) < c_f121_s01_mem0*ADD_mem[0]
	S += (c_f121_s00*ADD[1]) < c_f121_s01_mem0*ADD_mem[1]
	S += (c_f121_s00*ADD[2]) < c_f121_s01_mem0*ADD_mem[2]
	S += (c_f121_s00*ADD[3]) < c_f121_s01_mem0*ADD_mem[3]
	S += c_f121_s01_mem0 <= c_f121_s01

	c_f121_s01_mem1 = S.Task('c_f121_s01_mem1', length=1, delay_cost=1)
	c_f121_s01_mem1 += MUL_mem[0]
	S += 17 < c_f121_s01_mem1
	...
	S += (c001_s00*ADD[0]) < c001_s01_mem0*ADD_mem[0]
	S += (c001_s00*ADD[1]) < c001_s01_mem0*ADD_mem[1]
	S += (c001_s00*ADD[2]) < c001_s01_mem0*ADD_mem[2]
	S += (c001_s00*ADD[3]) < c001_s01_mem0*ADD_mem[3]
	...
	S += (c10_t0_s00*ADD[0]) < c10_t0_s01_mem0*ADD_mem[0]
	S += (c10_t0_s00*ADD[1]) < c10_t0_s01_mem0*ADD_mem[1]
	S += (c10_t0_s00*ADD[2]) < c10_t0_s01_mem0*ADD_mem[2]
	S += (c10_t0_s00*ADD[3]) < c10_t0_s01_mem0*ADD_mem[3]
	S += c10_t0_s01_mem0 <= c10_t0_s01

	c10_t0_s01_mem1 = S.Task('c10_t0_s01_mem1', length=1, delay_cost=1)
	c10_t0_s01_mem1 += MUL_mem[0]
	S += 11 < c10_t0_s01_mem1
	...
	S += (c01_t0_s00*ADD[0]) < c01_t0_s01_mem0*ADD_mem[0]
	S += (c01_t0_s00*ADD[1]) < c01_t0_s01_mem0*ADD_mem[1]
	S += (c01_t0_s00*ADD[2]) < c01_t0_s01_mem0*ADD_mem[2]
	S += (c01_t0_s00*ADD[3]) < c01_t0_s01_mem0*ADD_mem[3]
	S += c01_t0_s01_mem0 <= c01_t0_s01

	c01_t0_s01_mem1 = S.Task('c01_t0_s01_mem1', length=1, delay_cost=1)
	c01_t0_s01_mem1 += MUL_mem[0]
	S += 45 < c01_t0_s01_mem1
	...
	S += (c11_t0_s00*ADD[0]) < c11_t0_s01_mem0*ADD_mem[0]
	S += (c11_t0_s00*ADD[1]) < c11_t0_s01_mem0*ADD_mem[1]
	S += (c11_t0_s00*ADD[2]) < c11_t0_s01_mem0*ADD_mem[2]
	S += (c11_t0_s00*ADD[3]) < c11_t0_s01_mem0*ADD_mem[3]
	...
	S += (c02_t0_s00*ADD[0]) < c02_t0_s01_mem0*ADD_mem[0]
	S += (c02_t0_s00*ADD[1]) < c02_t0_s01_mem0*ADD_mem[1]
	S += (c02_t0_s00*ADD[2]) < c02_t0_s01_mem0*ADD_mem[2]
	S += (c02_t0_s00*ADD[3]) < c02_t0_s01_mem0*ADD_mem[3]
	...
	S += (c12_t0_s00*ADD[0]) < c12_t0_s01_mem0*ADD_mem[0]
	S += (c12_t0_s00*ADD[1]) < c12_t0_s01_mem0*ADD_mem[1]
	S += (c12_t0_s00*ADD[2]) < c12_t0_s01_mem0*ADD_mem[2]
	S += (c12_t0_s00*ADD[3]) < c12_t0_s01_mem0*ADD_mem[3]
	S += c12_t0_s01_mem0 <= c12_t0_s01

	c12_t0_s01_mem1 = S.Task('c12_t0_s01_mem1', length=1, delay_cost=1)
	c12_t0_s01_mem1 += MUL_mem[0]
	S += 43 < c12_t0_s01_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-315/scheduling/FROB_mul1_add4/FROB_3.png"
	if(S.solution() != []):
