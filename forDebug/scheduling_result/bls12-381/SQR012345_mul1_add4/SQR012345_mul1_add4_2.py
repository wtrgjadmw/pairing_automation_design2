...
def solve_SQR012345_mul1_add4_2(ConstStep, ExpStep):
	...
	C10_20_mem0 += alt(ADD_mem)
	S += (C10_10*ADD[0])-1<C10_20_mem0*ADD_mem[0]
	S += (C10_10*ADD[1])-1<C10_20_mem0*ADD_mem[1]
	S += (C10_10*ADD[2])-1<C10_20_mem0*ADD_mem[2]
	S += (C10_10*ADD[3])-1<C10_20_mem0*ADD_mem[3]
	S += C10_20_mem0<=C10_20

	C10_20_mem1 = S.Task('C10_20_mem1', length=1, delay_cost=1)
	C10_20_mem1 += INPUT_mem_r
	S += C10_20_mem1<=C10_20

	C10_21 = S.Task('C10_21', length=1, delay_cost=1)
	C10_21 += alt(ADD)

	C10_21_mem0 = S.Task('C10_21_mem0', length=1, delay_cost=1)
	C10_21_mem0 += alt(ADD_mem)
	S += (C10_11*ADD[0])-1<C10_21_mem0*ADD_mem[0]
	S += (C10_11*ADD[1])-1<C10_21_mem0*ADD_mem[1]
	S += (C10_11*ADD[2])-1<C10_21_mem0*ADD_mem[2]
	S += (C10_11*ADD[3])-1<C10_21_mem0*ADD_mem[3]
	S += C10_21_mem0<=C10_21

	C10_21_mem1 = S.Task('C10_21_mem1', length=1, delay_cost=1)
	C10_21_mem1 += INPUT_mem_r
	S += C10_21_mem1<=C10_21

	C20_21 = S.Task('C20_21', length=1, delay_cost=1)
	C20_21 += alt(ADD)

	C20_21_mem0 = S.Task('C20_21_mem0', length=1, delay_cost=1)
	C20_21_mem0 += alt(ADD_mem)
	S += (C20_11*ADD[0])-1<C20_21_mem0*ADD_mem[0]
	S += (C20_11*ADD[1])-1<C20_21_mem0*ADD_mem[1]
	S += (C20_11*ADD[2])-1<C20_21_mem0*ADD_mem[2]
	S += (C20_11*ADD[3])-1<C20_21_mem0*ADD_mem[3]
	S += C20_21_mem0<=C20_21

	C20_21_mem1 = S.Task('C20_21_mem1', length=1, delay_cost=1)
	C20_21_mem1 += ADD_mem[3]
	S += 34<C20_21_mem1
	S += C20_21_mem1<=C20_21

	C01_20 = S.Task('C01_20', length=1, delay_cost=1)
	C01_20 += alt(ADD)

	C01_20_mem0 = S.Task('C01_20_mem0', length=1, delay_cost=1)
	C01_20_mem0 += ADD_mem[2]
	S += 27<C01_20_mem0
	...
	C00_11_mem0 += alt(ADD_mem)
	S += (C00_1*ADD[0])-1<C00_11_mem0*ADD_mem[0]
	S += (C00_1*ADD[1])-1<C00_11_mem0*ADD_mem[1]
	S += (C00_1*ADD[2])-1<C00_11_mem0*ADD_mem[2]
	S += (C00_1*ADD[3])-1<C00_11_mem0*ADD_mem[3]
	...
	C01_21_mem0 += alt(ADD_mem)
	S += (C01_11*ADD[0])-1<C01_21_mem0*ADD_mem[0]
	S += (C01_11*ADD[1])-1<C01_21_mem0*ADD_mem[1]
	S += (C01_11*ADD[2])-1<C01_21_mem0*ADD_mem[2]
	S += (C01_11*ADD[3])-1<C01_21_mem0*ADD_mem[3]
	...
	C20_30_mem0 += alt(ADD_mem)
	S += (C20_20*ADD[0])-1<C20_30_mem0*ADD_mem[0]
	S += (C20_20*ADD[1])-1<C20_30_mem0*ADD_mem[1]
	S += (C20_20*ADD[2])-1<C20_30_mem0*ADD_mem[2]
	S += (C20_20*ADD[3])-1<C20_30_mem0*ADD_mem[3]
	S += C20_30_mem0<=C20_30

	C20_30_mem1 = S.Task('C20_30_mem1', length=1, delay_cost=1)
	C20_30_mem1 += MUL_mem[0]
	S += 35<C20_30_mem1
	S += C20_30_mem1<=C20_30

	C20_30_w = S.Task('C20_30_w', length=1, delay_cost=1)
	C20_30_w += alt(INPUT_mem_w)
	S += 0 < C20_30_w
	S += C20_30-1 <= C20_30_w
	...
	C21_21_mem0 += alt(ADD_mem)
	S += (C21_11*ADD[0])-1<C21_21_mem0*ADD_mem[0]
	S += (C21_11*ADD[1])-1<C21_21_mem0*ADD_mem[1]
	S += (C21_11*ADD[2])-1<C21_21_mem0*ADD_mem[2]
	S += (C21_11*ADD[3])-1<C21_21_mem0*ADD_mem[3]
	...
	C00_20_mem0 += alt(ADD_mem)
	S += (C00_10*ADD[0])-1<C00_20_mem0*ADD_mem[0]
	S += (C00_10*ADD[1])-1<C00_20_mem0*ADD_mem[1]
	S += (C00_10*ADD[2])-1<C00_20_mem0*ADD_mem[2]
	S += (C00_10*ADD[3])-1<C00_20_mem0*ADD_mem[3]
	S += C00_20_mem0<=C00_20

	C00_20_mem1 = S.Task('C00_20_mem1', length=1, delay_cost=1)
	C00_20_mem1 += INPUT_mem_r
	S += C00_20_mem1<=C00_20

	C00_20_w = S.Task('C00_20_w', length=1, delay_cost=1)
	C00_20_w += alt(INPUT_mem_w)
	S += 0 < C00_20_w
	S += C00_20-1 <= C00_20_w
	...
	C10_30_mem0 += alt(ADD_mem)
	S += (C10_20*ADD[0])-1<C10_30_mem0*ADD_mem[0]
	S += (C10_20*ADD[1])-1<C10_30_mem0*ADD_mem[1]
	S += (C10_20*ADD[2])-1<C10_30_mem0*ADD_mem[2]
	S += (C10_20*ADD[3])-1<C10_30_mem0*ADD_mem[3]
	...
	C10_31_mem0 += alt(ADD_mem)
	S += (C10_21*ADD[0])-1<C10_31_mem0*ADD_mem[0]
	S += (C10_21*ADD[1])-1<C10_31_mem0*ADD_mem[1]
	S += (C10_21*ADD[2])-1<C10_31_mem0*ADD_mem[2]
	S += (C10_21*ADD[3])-1<C10_31_mem0*ADD_mem[3]
	...
	C20_31_mem0 += alt(ADD_mem)
	S += (C20_21*ADD[0])-1<C20_31_mem0*ADD_mem[0]
	S += (C20_21*ADD[1])-1<C20_31_mem0*ADD_mem[1]
	S += (C20_21*ADD[2])-1<C20_31_mem0*ADD_mem[2]
	S += (C20_21*ADD[3])-1<C20_31_mem0*ADD_mem[3]
	S += C20_31_mem0<=C20_31

	C20_31_mem1 = S.Task('C20_31_mem1', length=1, delay_cost=1)
	C20_31_mem1 += ADD_mem[3]
	S += 35<C20_31_mem1
	S += C20_31_mem1<=C20_31

	C20_31_w = S.Task('C20_31_w', length=1, delay_cost=1)
	C20_31_w += alt(INPUT_mem_w)
	S += 0 < C20_31_w
	S += C20_31-1 <= C20_31_w
