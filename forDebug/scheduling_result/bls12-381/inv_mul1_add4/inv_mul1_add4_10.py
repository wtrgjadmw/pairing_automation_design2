...
def solve_inv_mul1_add4_10(ConstStep, ExpStep):
	horizon = 234
	S=Scenario("inv_mul1_add4_10",horizon = horizon)
	...
	S += T0_3T2<T0_3T4_mem0
	S += T0_3T4_mem0<=T0_3T4

	T0_3T4_mem1 = S.Task('T0_3T4_mem1', length=1, delay_cost=1)
	T0_3T4_mem1 += ADD_mem[2]
	S += T0_3T3<T0_3T4_mem1
	S += T0_3T4_mem1<=T0_3T4
	...
	S += T0_3T0<T0_3T5_mem0
	S += T0_3T5_mem0<=T0_3T5

	T0_3T5_mem1 = S.Task('T0_3T5_mem1', length=1, delay_cost=1)
	T0_3T5_mem1 += MUL_mem[0]
	S += T0_3T1<T0_3T5_mem1
	S += T0_3T5_mem1<=T0_3T5
	...
	S += T1_3T2<T1_3T4_mem0
	S += T1_3T4_mem0<=T1_3T4

	T1_3T4_mem1 = S.Task('T1_3T4_mem1', length=1, delay_cost=1)
	T1_3T4_mem1 += ADD_mem[2]
	S += T1_3T3<T1_3T4_mem1
	S += T1_3T4_mem1<=T1_3T4
	...
	S += T1_3T0<T1_3T5_mem0
	S += T1_3T5_mem0<=T1_3T5

	T1_3T5_mem1 = S.Task('T1_3T5_mem1', length=1, delay_cost=1)
	T1_3T5_mem1 += MUL_mem[0]
	S += T1_3T1<T1_3T5_mem1
	S += T1_3T5_mem1<=T1_3T5
	...
	S += T2_6T2<T2_6T4_mem0
	S += T2_6T4_mem0<=T2_6T4

	T2_6T4_mem1 = S.Task('T2_6T4_mem1', length=1, delay_cost=1)
	T2_6T4_mem1 += ADD_mem[3]
	S += T2_6T3<T2_6T4_mem1
	S += T2_6T4_mem1<=T2_6T4
	...
	S += T2_6T0<T2_6T5_mem0
	S += T2_6T5_mem0<=T2_6T5

	T2_6T5_mem1 = S.Task('T2_6T5_mem1', length=1, delay_cost=1)
	T2_6T5_mem1 += MUL_mem[0]
	S += T2_6T1<T2_6T5_mem1
	S += T2_6T5_mem1<=T2_6T5
	...
	S += T0_4T2<T0_4T4_mem0
	S += T0_4T4_mem0<=T0_4T4

	T0_4T4_mem1 = S.Task('T0_4T4_mem1', length=1, delay_cost=1)
	T0_4T4_mem1 += ADD_mem[1]
	S += T0_4T3<T0_4T4_mem1
	S += T0_4T4_mem1<=T0_4T4
	...
	S += T0_4T0<T0_4T5_mem0
	S += T0_4T5_mem0<=T0_4T5

	T0_4T5_mem1 = S.Task('T0_4T5_mem1', length=1, delay_cost=1)
	T0_4T5_mem1 += MUL_mem[0]
	S += T0_4T1<T0_4T5_mem1
	S += T0_4T5_mem1<=T0_4T5
	...
	S += T1_4T2<T1_4T4_mem0
	S += T1_4T4_mem0<=T1_4T4

	T1_4T4_mem1 = S.Task('T1_4T4_mem1', length=1, delay_cost=1)
	T1_4T4_mem1 += ADD_mem[0]
	S += T1_4T3<T1_4T4_mem1
	S += T1_4T4_mem1<=T1_4T4
	...
	S += T1_4T0<T1_4T5_mem0
	S += T1_4T5_mem0<=T1_4T5

	T1_4T5_mem1 = S.Task('T1_4T5_mem1', length=1, delay_cost=1)
	T1_4T5_mem1 += MUL_mem[0]
	S += T1_4T1<T1_4T5_mem1
	S += T1_4T5_mem1<=T1_4T5
	...
	S += T2_8T2<T2_8T4_mem0
	S += T2_8T4_mem0<=T2_8T4

	T2_8T4_mem1 = S.Task('T2_8T4_mem1', length=1, delay_cost=1)
	T2_8T4_mem1 += ADD_mem[0]
	S += T2_8T3<T2_8T4_mem1
	S += T2_8T4_mem1<=T2_8T4
	...
	S += T2_8T0<T2_8T5_mem0
	S += T2_8T5_mem0<=T2_8T5

	T2_8T5_mem1 = S.Task('T2_8T5_mem1', length=1, delay_cost=1)
	T2_8T5_mem1 += MUL_mem[0]
	S += T2_8T1<T2_8T5_mem1
	S += T2_8T5_mem1<=T2_8T5
	...
	T0_31_mem0 += alt(MUL_mem)
	S += (T0_3T4*MUL[0])-1<T0_31_mem0*MUL_mem[0]
	S += T0_31_mem0<=T0_31

	T0_31_mem1 = S.Task('T0_31_mem1', length=1, delay_cost=1)
	T0_31_mem1 += alt(ADD_mem)
	S += (T0_3T5*ADD[0])-1<T0_31_mem1*ADD_mem[0]
	S += (T0_3T5*ADD[1])-1<T0_31_mem1*ADD_mem[1]
	S += (T0_3T5*ADD[2])-1<T0_31_mem1*ADD_mem[2]
	S += (T0_3T5*ADD[3])-1<T0_31_mem1*ADD_mem[3]
	S += T0_31_mem1<=T0_31
	...
	T1_31_mem0 += alt(MUL_mem)
	S += (T1_3T4*MUL[0])-1<T1_31_mem0*MUL_mem[0]
	S += T1_31_mem0<=T1_31

	T1_31_mem1 = S.Task('T1_31_mem1', length=1, delay_cost=1)
	T1_31_mem1 += alt(ADD_mem)
	S += (T1_3T5*ADD[0])-1<T1_31_mem1*ADD_mem[0]
	S += (T1_3T5*ADD[1])-1<T1_31_mem1*ADD_mem[1]
	S += (T1_3T5*ADD[2])-1<T1_31_mem1*ADD_mem[2]
	S += (T1_3T5*ADD[3])-1<T1_31_mem1*ADD_mem[3]
	S += T1_31_mem1<=T1_31
	...
	T2_61_mem0 += alt(MUL_mem)
	S += (T2_6T4*MUL[0])-1<T2_61_mem0*MUL_mem[0]
	S += T2_61_mem0<=T2_61

	T2_61_mem1 = S.Task('T2_61_mem1', length=1, delay_cost=1)
	T2_61_mem1 += alt(ADD_mem)
	S += (T2_6T5*ADD[0])-1<T2_61_mem1*ADD_mem[0]
	S += (T2_6T5*ADD[1])-1<T2_61_mem1*ADD_mem[1]
	S += (T2_6T5*ADD[2])-1<T2_61_mem1*ADD_mem[2]
	S += (T2_6T5*ADD[3])-1<T2_61_mem1*ADD_mem[3]
	S += T2_61_mem1<=T2_61

	T3_5T4_in = S.Task('T3_5T4_in', length=1, delay_cost=1)
	T3_5T4_in += alt(MUL_in)
	...
	S += T3_5T2<T3_5T4_mem0
	S += T3_5T4_mem0<=T3_5T4

	T3_5T4_mem1 = S.Task('T3_5T4_mem1', length=1, delay_cost=1)
	T3_5T4_mem1 += alt(ADD_mem)
	S += (T3_5T3*ADD[0])-1<T3_5T4_mem1*ADD_mem[0]
	S += (T3_5T3*ADD[1])-1<T3_5T4_mem1*ADD_mem[1]
	S += (T3_5T3*ADD[2])-1<T3_5T4_mem1*ADD_mem[2]
	S += (T3_5T3*ADD[3])-1<T3_5T4_mem1*ADD_mem[3]
	S += T3_5T4_mem1<=T3_5T4
	...
	S += T3_5T0<T3_5T5_mem0
	S += T3_5T5_mem0<=T3_5T5

	T3_5T5_mem1 = S.Task('T3_5T5_mem1', length=1, delay_cost=1)
	T3_5T5_mem1 += alt(MUL_mem)
	S += (T3_5T1*MUL[0])-1<T3_5T5_mem1*MUL_mem[0]
	S += T3_5T5_mem1<=T3_5T5
	...
	T3_50_mem1 += alt(MUL_mem)
	S += (T3_5T1*MUL[0])-1<T3_50_mem1*MUL_mem[0]
	S += T3_50_mem1<=T3_50
	...
	S += (T0_30*ADD[0])-1<T4_140_mem0*ADD_mem[0]
	S += (T0_30*ADD[1])-1<T4_140_mem0*ADD_mem[1]
	S += (T0_30*ADD[2])-1<T4_140_mem0*ADD_mem[2]
	S += (T0_30*ADD[3])-1<T4_140_mem0*ADD_mem[3]
	S += T4_140_mem0<=T4_140

	T4_140_mem1 = S.Task('T4_140_mem1', length=1, delay_cost=1)
	T4_140_mem1 += alt(ADD_mem)
	S += (T1_30*ADD[0])-1<T4_140_mem1*ADD_mem[0]
	S += (T1_30*ADD[1])-1<T4_140_mem1*ADD_mem[1]
	S += (T1_30*ADD[2])-1<T4_140_mem1*ADD_mem[2]
	S += (T1_30*ADD[3])-1<T4_140_mem1*ADD_mem[3]
	S += T4_140_mem1<=T4_140

	T4_15T4_in = S.Task('T4_15T4_in', length=1, delay_cost=1)
	T4_15T4_in += alt(MUL_in)
	T4_15T4 = S.Task('T4_15T4', length=7, delay_cost=1)
	T4_15T4 += alt(MUL)
	S+=T4_15T4>=T4_15T4_in

	T4_15T4_mem0 = S.Task('T4_15T4_mem0', length=1, delay_cost=1)
	T4_15T4_mem0 += ADD_mem[0]
	S += T4_15T2<T4_15T4_mem0
	S += T4_15T4_mem0<=T4_15T4

	T4_15T4_mem1 = S.Task('T4_15T4_mem1', length=1, delay_cost=1)
	T4_15T4_mem1 += alt(ADD_mem)
	S += (T4_15T3*ADD[0])-1<T4_15T4_mem1*ADD_mem[0]
	S += (T4_15T3*ADD[1])-1<T4_15T4_mem1*ADD_mem[1]
	S += (T4_15T3*ADD[2])-1<T4_15T4_mem1*ADD_mem[2]
	S += (T4_15T3*ADD[3])-1<T4_15T4_mem1*ADD_mem[3]
	S += T4_15T4_mem1<=T4_15T4
	...
	S += T4_15T0<T4_15T5_mem0
	S += T4_15T5_mem0<=T4_15T5

	T4_15T5_mem1 = S.Task('T4_15T5_mem1', length=1, delay_cost=1)
	T4_15T5_mem1 += alt(MUL_mem)
	S += (T4_15T1*MUL[0])-1<T4_15T5_mem1*MUL_mem[0]
	S += T4_15T5_mem1<=T4_15T5
	...
	S += T4_15T0<T4_150_mem0
	S += T4_150_mem0<=T4_150

	T4_150_mem1 = S.Task('T4_150_mem1', length=1, delay_cost=1)
	T4_150_mem1 += alt(MUL_mem)
	S += (T4_15T1*MUL[0])-1<T4_150_mem1*MUL_mem[0]
	...
	T5_70_mem0 += alt(ADD_mem)
	S += (T1_30*ADD[0])-1<T5_70_mem0*ADD_mem[0]
	S += (T1_30*ADD[1])-1<T5_70_mem0*ADD_mem[1]
	S += (T1_30*ADD[2])-1<T5_70_mem0*ADD_mem[2]
	S += (T1_30*ADD[3])-1<T5_70_mem0*ADD_mem[3]
	S += T5_70_mem0<=T5_70

	T5_70_mem1 = S.Task('T5_70_mem1', length=1, delay_cost=1)
	T5_70_mem1 += alt(ADD_mem)
	S += (T2_60*ADD[0])-1<T5_70_mem1*ADD_mem[0]
	S += (T2_60*ADD[1])-1<T5_70_mem1*ADD_mem[1]
	S += (T2_60*ADD[2])-1<T5_70_mem1*ADD_mem[2]
	S += (T2_60*ADD[3])-1<T5_70_mem1*ADD_mem[3]
	S += T5_70_mem1<=T5_70

	T5_8T4_in = S.Task('T5_8T4_in', length=1, delay_cost=1)
	T5_8T4_in += alt(MUL_in)
	...
	S += T5_8T2<T5_8T4_mem0
	S += T5_8T4_mem0<=T5_8T4

	T5_8T4_mem1 = S.Task('T5_8T4_mem1', length=1, delay_cost=1)
	T5_8T4_mem1 += alt(ADD_mem)
	S += (T5_8T3*ADD[0])-1<T5_8T4_mem1*ADD_mem[0]
	S += (T5_8T3*ADD[1])-1<T5_8T4_mem1*ADD_mem[1]
	S += (T5_8T3*ADD[2])-1<T5_8T4_mem1*ADD_mem[2]
	S += (T5_8T3*ADD[3])-1<T5_8T4_mem1*ADD_mem[3]
	S += T5_8T4_mem1<=T5_8T4
	...
	S += T5_8T0<T5_8T5_mem0
	S += T5_8T5_mem0<=T5_8T5

	T5_8T5_mem1 = S.Task('T5_8T5_mem1', length=1, delay_cost=1)
	T5_8T5_mem1 += alt(MUL_mem)
	S += (T5_8T1*MUL[0])-1<T5_8T5_mem1*MUL_mem[0]
	S += T5_8T5_mem1<=T5_8T5
	...
	T5_80_mem1 += alt(MUL_mem)
	S += (T5_8T1*MUL[0])-1<T5_80_mem1*MUL_mem[0]
	S += T5_80_mem1<=T5_80
	...
	T6_10_mem0 += alt(ADD_mem)
	S += (T2_60*ADD[0])-1<T6_10_mem0*ADD_mem[0]
	S += (T2_60*ADD[1])-1<T6_10_mem0*ADD_mem[1]
	S += (T2_60*ADD[2])-1<T6_10_mem0*ADD_mem[2]
	S += (T2_60*ADD[3])-1<T6_10_mem0*ADD_mem[3]
	S += T6_10_mem0<=T6_10

	T6_10_mem1 = S.Task('T6_10_mem1', length=1, delay_cost=1)
	T6_10_mem1 += alt(ADD_mem)
	S += (T0_30*ADD[0])-1<T6_10_mem1*ADD_mem[0]
	S += (T0_30*ADD[1])-1<T6_10_mem1*ADD_mem[1]
	S += (T0_30*ADD[2])-1<T6_10_mem1*ADD_mem[2]
	S += (T0_30*ADD[3])-1<T6_10_mem1*ADD_mem[3]
	S += T6_10_mem1<=T6_10
	...
	T0_41_mem0 += alt(MUL_mem)
	S += (T0_4T4*MUL[0])-1<T0_41_mem0*MUL_mem[0]
	S += T0_41_mem0<=T0_41

	T0_41_mem1 = S.Task('T0_41_mem1', length=1, delay_cost=1)
	T0_41_mem1 += alt(ADD_mem)
	S += (T0_4T5*ADD[0])-1<T0_41_mem1*ADD_mem[0]
	S += (T0_4T5*ADD[1])-1<T0_41_mem1*ADD_mem[1]
	S += (T0_4T5*ADD[2])-1<T0_41_mem1*ADD_mem[2]
	S += (T0_4T5*ADD[3])-1<T0_41_mem1*ADD_mem[3]
	S += T0_41_mem1<=T0_41
	...
	T1_41_mem0 += alt(MUL_mem)
	S += (T1_4T4*MUL[0])-1<T1_41_mem0*MUL_mem[0]
	S += T1_41_mem0<=T1_41

	T1_41_mem1 = S.Task('T1_41_mem1', length=1, delay_cost=1)
	T1_41_mem1 += alt(ADD_mem)
	S += (T1_4T5*ADD[0])-1<T1_41_mem1*ADD_mem[0]
	S += (T1_4T5*ADD[1])-1<T1_41_mem1*ADD_mem[1]
	S += (T1_4T5*ADD[2])-1<T1_41_mem1*ADD_mem[2]
	S += (T1_4T5*ADD[3])-1<T1_41_mem1*ADD_mem[3]
	S += T1_41_mem1<=T1_41
	...
	T2_81_mem0 += alt(MUL_mem)
	S += (T2_8T4*MUL[0])-1<T2_81_mem0*MUL_mem[0]
	S += T2_81_mem0<=T2_81

	T2_81_mem1 = S.Task('T2_81_mem1', length=1, delay_cost=1)
	T2_81_mem1 += alt(ADD_mem)
	S += (T2_8T5*ADD[0])-1<T2_81_mem1*ADD_mem[0]
	S += (T2_8T5*ADD[1])-1<T2_81_mem1*ADD_mem[1]
	S += (T2_8T5*ADD[2])-1<T2_81_mem1*ADD_mem[2]
	S += (T2_8T5*ADD[3])-1<T2_81_mem1*ADD_mem[3]
	S += T2_81_mem1<=T2_81

	T3_7T4_in = S.Task('T3_7T4_in', length=1, delay_cost=1)
	T3_7T4_in += alt(MUL_in)
	...
	S += T3_7T2<T3_7T4_mem0
	S += T3_7T4_mem0<=T3_7T4

	T3_7T4_mem1 = S.Task('T3_7T4_mem1', length=1, delay_cost=1)
	T3_7T4_mem1 += alt(ADD_mem)
	S += (T3_7T3*ADD[0])-1<T3_7T4_mem1*ADD_mem[0]
	S += (T3_7T3*ADD[1])-1<T3_7T4_mem1*ADD_mem[1]
	S += (T3_7T3*ADD[2])-1<T3_7T4_mem1*ADD_mem[2]
	S += (T3_7T3*ADD[3])-1<T3_7T4_mem1*ADD_mem[3]
	S += T3_7T4_mem1<=T3_7T4
	...
	S += T3_7T0<T3_7T5_mem0
	S += T3_7T5_mem0<=T3_7T5

	T3_7T5_mem1 = S.Task('T3_7T5_mem1', length=1, delay_cost=1)
	T3_7T5_mem1 += alt(MUL_mem)
	S += (T3_7T1*MUL[0])-1<T3_7T5_mem1*MUL_mem[0]
	S += T3_7T5_mem1<=T3_7T5
	...
	T3_70_mem1 += alt(MUL_mem)
	S += (T3_7T1*MUL[0])-1<T3_70_mem1*MUL_mem[0]
	S += T3_70_mem1<=T3_70
	...
	T4_180_mem0 += alt(ADD_mem)
	S += (T0_40*ADD[0])-1<T4_180_mem0*ADD_mem[0]
	S += (T0_40*ADD[1])-1<T4_180_mem0*ADD_mem[1]
	S += (T0_40*ADD[2])-1<T4_180_mem0*ADD_mem[2]
	S += (T0_40*ADD[3])-1<T4_180_mem0*ADD_mem[3]
	S += T4_180_mem0<=T4_180

	T4_180_mem1 = S.Task('T4_180_mem1', length=1, delay_cost=1)
	T4_180_mem1 += alt(ADD_mem)
	S += (T1_40*ADD[0])-1<T4_180_mem1*ADD_mem[0]
	S += (T1_40*ADD[1])-1<T4_180_mem1*ADD_mem[1]
	S += (T1_40*ADD[2])-1<T4_180_mem1*ADD_mem[2]
	S += (T1_40*ADD[3])-1<T4_180_mem1*ADD_mem[3]
	S += T4_180_mem1<=T4_180

	T4_19T4_in = S.Task('T4_19T4_in', length=1, delay_cost=1)
	T4_19T4_in += alt(MUL_in)
	T4_19T4 = S.Task('T4_19T4', length=7, delay_cost=1)
	T4_19T4 += alt(MUL)
	S+=T4_19T4>=T4_19T4_in

	T4_19T4_mem0 = S.Task('T4_19T4_mem0', length=1, delay_cost=1)
	T4_19T4_mem0 += ADD_mem[2]
	S += T4_19T2<T4_19T4_mem0
	S += T4_19T4_mem0<=T4_19T4

	T4_19T4_mem1 = S.Task('T4_19T4_mem1', length=1, delay_cost=1)
	T4_19T4_mem1 += alt(ADD_mem)
	S += (T4_19T3*ADD[0])-1<T4_19T4_mem1*ADD_mem[0]
	S += (T4_19T3*ADD[1])-1<T4_19T4_mem1*ADD_mem[1]
	S += (T4_19T3*ADD[2])-1<T4_19T4_mem1*ADD_mem[2]
	S += (T4_19T3*ADD[3])-1<T4_19T4_mem1*ADD_mem[3]
	S += T4_19T4_mem1<=T4_19T4
	...
	S += T4_19T0<T4_19T5_mem0
	S += T4_19T5_mem0<=T4_19T5

	T4_19T5_mem1 = S.Task('T4_19T5_mem1', length=1, delay_cost=1)
	T4_19T5_mem1 += alt(MUL_mem)
	S += (T4_19T1*MUL[0])-1<T4_19T5_mem1*MUL_mem[0]
	S += T4_19T5_mem1<=T4_19T5
	...
	S += T4_19T0<T4_190_mem0
	S += T4_190_mem0<=T4_190

	T4_190_mem1 = S.Task('T4_190_mem1', length=1, delay_cost=1)
	T4_190_mem1 += alt(MUL_mem)
	S += (T4_19T1*MUL[0])-1<T4_190_mem1*MUL_mem[0]
	S += T4_190_mem1<=T4_190
	...
	S += (T1_40*ADD[0])-1<T5_100_mem0*ADD_mem[0]
	S += (T1_40*ADD[1])-1<T5_100_mem0*ADD_mem[1]
	S += (T1_40*ADD[2])-1<T5_100_mem0*ADD_mem[2]
	S += (T1_40*ADD[3])-1<T5_100_mem0*ADD_mem[3]
	S += T5_100_mem0<=T5_100

	T5_100_mem1 = S.Task('T5_100_mem1', length=1, delay_cost=1)
	T5_100_mem1 += alt(ADD_mem)
	S += (T2_80*ADD[0])-1<T5_100_mem1*ADD_mem[0]
	S += (T2_80*ADD[1])-1<T5_100_mem1*ADD_mem[1]
	S += (T2_80*ADD[2])-1<T5_100_mem1*ADD_mem[2]
	S += (T2_80*ADD[3])-1<T5_100_mem1*ADD_mem[3]
	...
	S += T5_11T2<T5_11T4_mem0
	S += T5_11T4_mem0<=T5_11T4

	T5_11T4_mem1 = S.Task('T5_11T4_mem1', length=1, delay_cost=1)
	T5_11T4_mem1 += alt(ADD_mem)
	S += (T5_11T3*ADD[0])-1<T5_11T4_mem1*ADD_mem[0]
	S += (T5_11T3*ADD[1])-1<T5_11T4_mem1*ADD_mem[1]
	S += (T5_11T3*ADD[2])-1<T5_11T4_mem1*ADD_mem[2]
	S += (T5_11T3*ADD[3])-1<T5_11T4_mem1*ADD_mem[3]
	...
	S += T5_11T0<T5_11T5_mem0
	S += T5_11T5_mem0<=T5_11T5

	T5_11T5_mem1 = S.Task('T5_11T5_mem1', length=1, delay_cost=1)
	T5_11T5_mem1 += alt(MUL_mem)
	S += (T5_11T1*MUL[0])-1<T5_11T5_mem1*MUL_mem[0]
	...
	S += T5_11T0<T5_110_mem0
	S += T5_110_mem0<=T5_110

	T5_110_mem1 = S.Task('T5_110_mem1', length=1, delay_cost=1)
	T5_110_mem1 += alt(MUL_mem)
	S += (T5_11T1*MUL[0])-1<T5_110_mem1*MUL_mem[0]
	...
	S += (T2_80*ADD[0])-1<T6_20_mem0*ADD_mem[0]
	S += (T2_80*ADD[1])-1<T6_20_mem0*ADD_mem[1]
	S += (T2_80*ADD[2])-1<T6_20_mem0*ADD_mem[2]
	S += (T2_80*ADD[3])-1<T6_20_mem0*ADD_mem[3]
	S += T6_20_mem0<=T6_20

	T6_20_mem1 = S.Task('T6_20_mem1', length=1, delay_cost=1)
	T6_20_mem1 += alt(ADD_mem)
	S += (T0_40*ADD[0])-1<T6_20_mem1*ADD_mem[0]
	S += (T0_40*ADD[1])-1<T6_20_mem1*ADD_mem[1]
	S += (T0_40*ADD[2])-1<T6_20_mem1*ADD_mem[2]
	S += (T0_40*ADD[3])-1<T6_20_mem1*ADD_mem[3]
	S += T6_20_mem1<=T6_20
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_10.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_10(0, 0)