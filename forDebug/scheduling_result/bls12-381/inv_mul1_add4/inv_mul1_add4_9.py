...
def solve_inv_mul1_add4_9(ConstStep, ExpStep):
	...
	T0_3T1_mem1 += alt(ADD_mem)
	S += (T71*ADD[0])-1<T0_3T1_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T0_3T1_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T0_3T1_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T0_3T1_mem1*ADD_mem[3]
	...
	T0_3T3_mem1 += alt(ADD_mem)
	S += (T71*ADD[0])-1<T0_3T3_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T0_3T3_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T0_3T3_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T0_3T3_mem1*ADD_mem[3]
	...
	T1_3T1_mem1 += alt(ADD_mem)
	S += (T81*ADD[0])-1<T1_3T1_mem1*ADD_mem[0]
	S += (T81*ADD[1])-1<T1_3T1_mem1*ADD_mem[1]
	S += (T81*ADD[2])-1<T1_3T1_mem1*ADD_mem[2]
	S += (T81*ADD[3])-1<T1_3T1_mem1*ADD_mem[3]
	...
	T1_3T3_mem1 += alt(ADD_mem)
	S += (T81*ADD[0])-1<T1_3T3_mem1*ADD_mem[0]
	S += (T81*ADD[1])-1<T1_3T3_mem1*ADD_mem[1]
	S += (T81*ADD[2])-1<T1_3T3_mem1*ADD_mem[2]
	S += (T81*ADD[3])-1<T1_3T3_mem1*ADD_mem[3]
	...
	T2_6T1_mem1 += alt(ADD_mem)
	S += (T91*ADD[0])-1<T2_6T1_mem1*ADD_mem[0]
	S += (T91*ADD[1])-1<T2_6T1_mem1*ADD_mem[1]
	S += (T91*ADD[2])-1<T2_6T1_mem1*ADD_mem[2]
	S += (T91*ADD[3])-1<T2_6T1_mem1*ADD_mem[3]
	...
	T2_6T3_mem1 += alt(ADD_mem)
	S += (T91*ADD[0])-1<T2_6T3_mem1*ADD_mem[0]
	S += (T91*ADD[1])-1<T2_6T3_mem1*ADD_mem[1]
	S += (T91*ADD[2])-1<T2_6T3_mem1*ADD_mem[2]
	S += (T91*ADD[3])-1<T2_6T3_mem1*ADD_mem[3]
	...
	S += (T71*ADD[0])-1<T101_mem0*ADD_mem[0]
	S += (T71*ADD[1])-1<T101_mem0*ADD_mem[1]
	S += (T71*ADD[2])-1<T101_mem0*ADD_mem[2]
	S += (T71*ADD[3])-1<T101_mem0*ADD_mem[3]
	S += T101_mem0<=T101

	T101_mem1 = S.Task('T101_mem1', length=1, delay_cost=1)
	T101_mem1 += alt(ADD_mem)
	S += (T81*ADD[0])-1<T101_mem1*ADD_mem[0]
	S += (T81*ADD[1])-1<T101_mem1*ADD_mem[1]
	S += (T81*ADD[2])-1<T101_mem1*ADD_mem[2]
	S += (T81*ADD[3])-1<T101_mem1*ADD_mem[3]
	S += T101_mem1<=T101
	...
	S += NEW_A000<T3_5T0_mem0
	S += T3_5T0_mem0<=T3_5T0

	T3_5T0_mem1 = S.Task('T3_5T0_mem1', length=1, delay_cost=1)
	T3_5T0_mem1 += alt(ADD_mem)
	S += (T100*ADD[0])-1<T3_5T0_mem1*ADD_mem[0]
	S += (T100*ADD[1])-1<T3_5T0_mem1*ADD_mem[1]
	S += (T100*ADD[2])-1<T3_5T0_mem1*ADD_mem[2]
	S += (T100*ADD[3])-1<T3_5T0_mem1*ADD_mem[3]
	...
	S += (T91*ADD[0])-1<T111_mem1*ADD_mem[0]
	S += (T91*ADD[1])-1<T111_mem1*ADD_mem[1]
	S += (T91*ADD[2])-1<T111_mem1*ADD_mem[2]
	S += (T91*ADD[3])-1<T111_mem1*ADD_mem[3]
	S += T111_mem1<=T111
	...
	S += NEW_A010<T4_15T0_mem0
	S += T4_15T0_mem0<=T4_15T0

	T4_15T0_mem1 = S.Task('T4_15T0_mem1', length=1, delay_cost=1)
	T4_15T0_mem1 += alt(ADD_mem)
	S += (T110*ADD[0])-1<T4_15T0_mem1*ADD_mem[0]
	S += (T110*ADD[1])-1<T4_15T0_mem1*ADD_mem[1]
	S += (T110*ADD[2])-1<T4_15T0_mem1*ADD_mem[2]
	S += (T110*ADD[3])-1<T4_15T0_mem1*ADD_mem[3]
	...
	S += (T91*ADD[0])-1<T121_mem0*ADD_mem[0]
	S += (T91*ADD[1])-1<T121_mem0*ADD_mem[1]
	S += (T91*ADD[2])-1<T121_mem0*ADD_mem[2]
	S += (T91*ADD[3])-1<T121_mem0*ADD_mem[3]
	S += T121_mem0<=T121

	T121_mem1 = S.Task('T121_mem1', length=1, delay_cost=1)
	T121_mem1 += alt(ADD_mem)
	S += (T71*ADD[0])-1<T121_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T121_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T121_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T121_mem1*ADD_mem[3]
	S += T121_mem1<=T121
	...
	S += NEW_A020<T5_8T0_mem0
	S += T5_8T0_mem0<=T5_8T0

	T5_8T0_mem1 = S.Task('T5_8T0_mem1', length=1, delay_cost=1)
	T5_8T0_mem1 += alt(ADD_mem)
	S += (T120*ADD[0])-1<T5_8T0_mem1*ADD_mem[0]
	S += (T120*ADD[1])-1<T5_8T0_mem1*ADD_mem[1]
	S += (T120*ADD[2])-1<T5_8T0_mem1*ADD_mem[2]
	S += (T120*ADD[3])-1<T5_8T0_mem1*ADD_mem[3]
	...
	T0_4T1_mem1 += alt(ADD_mem)
	S += (T71*ADD[0])-1<T0_4T1_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T0_4T1_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T0_4T1_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T0_4T1_mem1*ADD_mem[3]
	...
	T0_4T3_mem1 += alt(ADD_mem)
	S += (T71*ADD[0])-1<T0_4T3_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T0_4T3_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T0_4T3_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T0_4T3_mem1*ADD_mem[3]
	...
	T1_4T1_mem1 += alt(ADD_mem)
	S += (T81*ADD[0])-1<T1_4T1_mem1*ADD_mem[0]
	S += (T81*ADD[1])-1<T1_4T1_mem1*ADD_mem[1]
	S += (T81*ADD[2])-1<T1_4T1_mem1*ADD_mem[2]
	S += (T81*ADD[3])-1<T1_4T1_mem1*ADD_mem[3]
	...
	T1_4T3_mem1 += alt(ADD_mem)
	S += (T81*ADD[0])-1<T1_4T3_mem1*ADD_mem[0]
	S += (T81*ADD[1])-1<T1_4T3_mem1*ADD_mem[1]
	S += (T81*ADD[2])-1<T1_4T3_mem1*ADD_mem[2]
	S += (T81*ADD[3])-1<T1_4T3_mem1*ADD_mem[3]
	...
	T2_8T1_mem1 += alt(ADD_mem)
	S += (T91*ADD[0])-1<T2_8T1_mem1*ADD_mem[0]
	S += (T91*ADD[1])-1<T2_8T1_mem1*ADD_mem[1]
	S += (T91*ADD[2])-1<T2_8T1_mem1*ADD_mem[2]
	S += (T91*ADD[3])-1<T2_8T1_mem1*ADD_mem[3]
	...
	T2_8T3_mem1 += alt(ADD_mem)
	S += (T91*ADD[0])-1<T2_8T3_mem1*ADD_mem[0]
	S += (T91*ADD[1])-1<T2_8T3_mem1*ADD_mem[1]
	S += (T91*ADD[2])-1<T2_8T3_mem1*ADD_mem[2]
	S += (T91*ADD[3])-1<T2_8T3_mem1*ADD_mem[3]
	...
	S += NEW_A100<T3_7T0_mem0
	S += T3_7T0_mem0<=T3_7T0

	T3_7T0_mem1 = S.Task('T3_7T0_mem1', length=1, delay_cost=1)
	T3_7T0_mem1 += alt(ADD_mem)
	S += (T100*ADD[0])-1<T3_7T0_mem1*ADD_mem[0]
	S += (T100*ADD[1])-1<T3_7T0_mem1*ADD_mem[1]
	S += (T100*ADD[2])-1<T3_7T0_mem1*ADD_mem[2]
	S += (T100*ADD[3])-1<T3_7T0_mem1*ADD_mem[3]
	...
	S += NEW_A110<T4_19T0_mem0
	S += T4_19T0_mem0<=T4_19T0

	T4_19T0_mem1 = S.Task('T4_19T0_mem1', length=1, delay_cost=1)
	T4_19T0_mem1 += alt(ADD_mem)
	S += (T110*ADD[0])-1<T4_19T0_mem1*ADD_mem[0]
	S += (T110*ADD[1])-1<T4_19T0_mem1*ADD_mem[1]
	S += (T110*ADD[2])-1<T4_19T0_mem1*ADD_mem[2]
	S += (T110*ADD[3])-1<T4_19T0_mem1*ADD_mem[3]
	...
	S += NEW_A120<T5_11T0_mem0
	S += T5_11T0_mem0<=T5_11T0

	T5_11T0_mem1 = S.Task('T5_11T0_mem1', length=1, delay_cost=1)
	T5_11T0_mem1 += alt(ADD_mem)
	S += (T120*ADD[0])-1<T5_11T0_mem1*ADD_mem[0]
	S += (T120*ADD[1])-1<T5_11T0_mem1*ADD_mem[1]
	S += (T120*ADD[2])-1<T5_11T0_mem1*ADD_mem[2]
	S += (T120*ADD[3])-1<T5_11T0_mem1*ADD_mem[3]
