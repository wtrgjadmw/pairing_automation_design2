...
def solve_inv_mul1_add4_1(ConstStep, ExpStep):
	...
	S += NEW_A010<T4_T0_mem0
	S += T4_T0_mem0<=T4_T0

	T4_T0_mem1 = S.Task('T4_T0_mem1', length=1, delay_cost=1)
	T4_T0_mem1 += ADD_mem[0]
	S += NEW_A011<T4_T0_mem1
	S += T4_T0_mem1<=T4_T0
	...
	S += NEW_A010<T4_T1_mem0
	S += T4_T1_mem0<=T4_T1

	T4_T1_mem1 = S.Task('T4_T1_mem1', length=1, delay_cost=1)
	T4_T1_mem1 += ADD_mem[0]
	S += NEW_A011<T4_T1_mem1
	S += T4_T1_mem1<=T4_T1
	...
	S += NEW_A010<T4_T2_mem0
	S += T4_T2_mem0<=T4_T2

	T4_T2_mem1 = S.Task('T4_T2_mem1', length=1, delay_cost=1)
	T4_T2_mem1 += ADD_mem[0]
	S += NEW_A011<T4_T2_mem1
	S += T4_T2_mem1<=T4_T2
	...
	S += NEW_A020<T5_T0_mem0
	S += T5_T0_mem0<=T5_T0

	T5_T0_mem1 = S.Task('T5_T0_mem1', length=1, delay_cost=1)
	T5_T0_mem1 += ADD_mem[0]
	S += NEW_A021<T5_T0_mem1
	S += T5_T0_mem1<=T5_T0
	...
	S += NEW_A020<T5_T1_mem0
	S += T5_T1_mem0<=T5_T1

	T5_T1_mem1 = S.Task('T5_T1_mem1', length=1, delay_cost=1)
	T5_T1_mem1 += ADD_mem[0]
	S += NEW_A021<T5_T1_mem1
	S += T5_T1_mem1<=T5_T1
	...
	S += NEW_A020<T5_T2_mem0
	S += T5_T2_mem0<=T5_T2

	T5_T2_mem1 = S.Task('T5_T2_mem1', length=1, delay_cost=1)
	T5_T2_mem1 += ADD_mem[0]
	S += NEW_A021<T5_T2_mem1
	S += T5_T2_mem1<=T5_T2
