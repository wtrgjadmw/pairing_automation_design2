...
def solve_inv_mul1_add4_5(ConstStep, ExpStep):
	horizon = 172
	S=Scenario("inv_mul1_add4_5",horizon = horizon)
	...
	S += (T4_101*ADD[0])-1<T4_110_mem1*ADD_mem[0]
	S += (T4_101*ADD[1])-1<T4_110_mem1*ADD_mem[1]
	S += (T4_101*ADD[2])-1<T4_110_mem1*ADD_mem[2]
	S += (T4_101*ADD[3])-1<T4_110_mem1*ADD_mem[3]
	...
	S += (T4_101*ADD[0])-1<T4_111_mem1*ADD_mem[0]
	S += (T4_101*ADD[1])-1<T4_111_mem1*ADD_mem[1]
	S += (T4_101*ADD[2])-1<T4_111_mem1*ADD_mem[2]
	S += (T4_101*ADD[3])-1<T4_111_mem1*ADD_mem[3]
	...
	T4_120_mem0 += alt(ADD_mem)
	S += (T4_110*ADD[0])-1<T4_120_mem0*ADD_mem[0]
	S += (T4_110*ADD[1])-1<T4_120_mem0*ADD_mem[1]
	S += (T4_110*ADD[2])-1<T4_120_mem0*ADD_mem[2]
	S += (T4_110*ADD[3])-1<T4_120_mem0*ADD_mem[3]
	S += T4_120_mem0<=T4_120

	T4_120_mem1 = S.Task('T4_120_mem1', length=1, delay_cost=1)
	T4_120_mem1 += ADD_mem[3]
	S += 81<T4_120_mem1
	S += T4_120_mem1<=T4_120

	T4_121 = S.Task('T4_121', length=1, delay_cost=1)
	T4_121 += alt(ADD)

	T4_121_mem0 = S.Task('T4_121_mem0', length=1, delay_cost=1)
	T4_121_mem0 += alt(ADD_mem)
	S += (T4_111*ADD[0])-1<T4_121_mem0*ADD_mem[0]
	S += (T4_111*ADD[1])-1<T4_121_mem0*ADD_mem[1]
	S += (T4_111*ADD[2])-1<T4_121_mem0*ADD_mem[2]
	S += (T4_111*ADD[3])-1<T4_121_mem0*ADD_mem[3]
	S += T4_121_mem0<=T4_121

	T4_121_mem1 = S.Task('T4_121_mem1', length=1, delay_cost=1)
	T4_121_mem1 += alt(ADD_mem)
	S += (T5_61*ADD[0])-1<T4_121_mem1*ADD_mem[0]
	S += (T5_61*ADD[1])-1<T4_121_mem1*ADD_mem[1]
	S += (T5_61*ADD[2])-1<T4_121_mem1*ADD_mem[2]
	S += (T5_61*ADD[3])-1<T4_121_mem1*ADD_mem[3]
	S += T4_121_mem1<=T4_121
	...
	T4_13T0_mem0 += alt(ADD_mem)
	S += (T4_120*ADD[0])-1<T4_13T0_mem0*ADD_mem[0]
	S += (T4_120*ADD[1])-1<T4_13T0_mem0*ADD_mem[1]
	S += (T4_120*ADD[2])-1<T4_13T0_mem0*ADD_mem[2]
	S += (T4_120*ADD[3])-1<T4_13T0_mem0*ADD_mem[3]
	...
	T4_13T1_mem0 += alt(ADD_mem)
	S += (T4_121*ADD[0])-1<T4_13T1_mem0*ADD_mem[0]
	S += (T4_121*ADD[1])-1<T4_13T1_mem0*ADD_mem[1]
	S += (T4_121*ADD[2])-1<T4_13T1_mem0*ADD_mem[2]
	S += (T4_121*ADD[3])-1<T4_13T1_mem0*ADD_mem[3]
	...
	T4_13T4_mem1 += alt(ADD_mem)
	S += (T4_121*ADD[0])-1<T4_13T4_mem1*ADD_mem[0]
	S += (T4_121*ADD[1])-1<T4_13T4_mem1*ADD_mem[1]
	S += (T4_121*ADD[2])-1<T4_13T4_mem1*ADD_mem[2]
	S += (T4_121*ADD[3])-1<T4_13T4_mem1*ADD_mem[3]
	...
	T4_130_mem0 += alt(ADD_mem)
	S += (T4_120*ADD[0])-1<T4_130_mem0*ADD_mem[0]
	S += (T4_120*ADD[1])-1<T4_130_mem0*ADD_mem[1]
	S += (T4_120*ADD[2])-1<T4_130_mem0*ADD_mem[2]
	S += (T4_120*ADD[3])-1<T4_130_mem0*ADD_mem[3]
	...
	T4_131_mem0 += alt(ADD_mem)
	S += (T4_13T4*ADD[0])-1<T4_131_mem0*ADD_mem[0]
	S += (T4_13T4*ADD[1])-1<T4_131_mem0*ADD_mem[1]
	S += (T4_13T4*ADD[2])-1<T4_131_mem0*ADD_mem[2]
	S += (T4_13T4*ADD[3])-1<T4_131_mem0*ADD_mem[3]
	...
	T7T0_mem1 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T7T0_mem1*MUL_mem[0]
	S += T7T0_mem1<=T7T0
	...
	T7T1_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T7T1_mem1*MUL_mem[0]
	S += T7T1_mem1<=T7T1
	...
	T7T3_mem0 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T7T3_mem0*MUL_mem[0]
	S += T7T3_mem0<=T7T3

	T7T3_mem1 = S.Task('T7T3_mem1', length=1, delay_cost=1)
	T7T3_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T7T3_mem1*MUL_mem[0]
	S += T7T3_mem1<=T7T3
	...
	T8T0_mem1 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T8T0_mem1*MUL_mem[0]
	S += T8T0_mem1<=T8T0
	...
	T8T1_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T8T1_mem1*MUL_mem[0]
	S += T8T1_mem1<=T8T1
	...
	T8T3_mem0 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T8T3_mem0*MUL_mem[0]
	S += T8T3_mem0<=T8T3

	T8T3_mem1 = S.Task('T8T3_mem1', length=1, delay_cost=1)
	T8T3_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T8T3_mem1*MUL_mem[0]
	S += T8T3_mem1<=T8T3
	...
	T9T0_mem1 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T9T0_mem1*MUL_mem[0]
	S += T9T0_mem1<=T9T0
	...
	T9T1_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T9T1_mem1*MUL_mem[0]
	S += T9T1_mem1<=T9T1
	...
	T9T3_mem0 += alt(MUL_mem)
	S += (T4_130*MUL[0])-1<T9T3_mem0*MUL_mem[0]
	S += T9T3_mem0<=T9T3

	T9T3_mem1 = S.Task('T9T3_mem1', length=1, delay_cost=1)
	T9T3_mem1 += alt(MUL_mem)
	S += (T4_131*MUL[0])-1<T9T3_mem1*MUL_mem[0]
	S += T9T3_mem1<=T9T3
	...
	T8T4_mem1 += alt(ADD_mem)
	S += (T8T3*ADD[0])-1<T8T4_mem1*ADD_mem[0]
	S += (T8T3*ADD[1])-1<T8T4_mem1*ADD_mem[1]
	S += (T8T3*ADD[2])-1<T8T4_mem1*ADD_mem[2]
	S += (T8T3*ADD[3])-1<T8T4_mem1*ADD_mem[3]
	S += T8T4_mem1<=T8T4
	...
	T8T5_mem0 += alt(MUL_mem)
	S += (T8T0*MUL[0])-1<T8T5_mem0*MUL_mem[0]
	S += T8T5_mem0<=T8T5

	T8T5_mem1 = S.Task('T8T5_mem1', length=1, delay_cost=1)
	T8T5_mem1 += alt(MUL_mem)
	S += (T8T1*MUL[0])-1<T8T5_mem1*MUL_mem[0]
	S += T8T5_mem1<=T8T5
	...
	T80_mem0 += alt(MUL_mem)
	S += (T8T0*MUL[0])-1<T80_mem0*MUL_mem[0]
	S += T80_mem0<=T80

	T80_mem1 = S.Task('T80_mem1', length=1, delay_cost=1)
	T80_mem1 += alt(MUL_mem)
	S += (T8T1*MUL[0])-1<T80_mem1*MUL_mem[0]
	S += T80_mem1<=T80
	...
	T9T4_mem1 += alt(ADD_mem)
	S += (T9T3*ADD[0])-1<T9T4_mem1*ADD_mem[0]
	S += (T9T3*ADD[1])-1<T9T4_mem1*ADD_mem[1]
	S += (T9T3*ADD[2])-1<T9T4_mem1*ADD_mem[2]
	S += (T9T3*ADD[3])-1<T9T4_mem1*ADD_mem[3]
	S += T9T4_mem1<=T9T4
	...
	T9T5_mem0 += alt(MUL_mem)
	S += (T9T0*MUL[0])-1<T9T5_mem0*MUL_mem[0]
	S += T9T5_mem0<=T9T5

	T9T5_mem1 = S.Task('T9T5_mem1', length=1, delay_cost=1)
	T9T5_mem1 += alt(MUL_mem)
	S += (T9T1*MUL[0])-1<T9T5_mem1*MUL_mem[0]
	S += T9T5_mem1<=T9T5
	...
	S += (T9T0*MUL[0])-1<T90_mem0*MUL_mem[0]
	S += T90_mem0<=T90

	T90_mem1 = S.Task('T90_mem1', length=1, delay_cost=1)
	T90_mem1 += alt(MUL_mem)
	S += (T9T1*MUL[0])-1<T90_mem1*MUL_mem[0]
	S += T90_mem1<=T90
	...
	S += (T7T4*MUL[0])-1<T71_mem0*MUL_mem[0]
	S += T71_mem0<=T71

	T71_mem1 = S.Task('T71_mem1', length=1, delay_cost=1)
	T71_mem1 += alt(ADD_mem)
	S += (T7T5*ADD[0])-1<T71_mem1*ADD_mem[0]
	S += (T7T5*ADD[1])-1<T71_mem1*ADD_mem[1]
	S += (T7T5*ADD[2])-1<T71_mem1*ADD_mem[2]
	S += (T7T5*ADD[3])-1<T71_mem1*ADD_mem[3]
	S += T71_mem1<=T71
	...
	S += (T9T4*MUL[0])-1<T91_mem0*MUL_mem[0]
	S += T91_mem0<=T91

	T91_mem1 = S.Task('T91_mem1', length=1, delay_cost=1)
	T91_mem1 += alt(ADD_mem)
	S += (T9T5*ADD[0])-1<T91_mem1*ADD_mem[0]
	S += (T9T5*ADD[1])-1<T91_mem1*ADD_mem[1]
	S += (T9T5*ADD[2])-1<T91_mem1*ADD_mem[2]
	S += (T9T5*ADD[3])-1<T91_mem1*ADD_mem[3]
	S += T91_mem1<=T91

	T0_3T0_in = S.Task('T0_3T0_in', length=1, delay_cost=1)
	T0_3T0_in += alt(MUL_in)
	...
	S += T0_3T0_mem0<=T0_3T0

	T0_3T0_mem1 = S.Task('T0_3T0_mem1', length=1, delay_cost=1)
	T0_3T0_mem1 += alt(ADD_mem)
	S += (T70*ADD[0])-1<T0_3T0_mem1*ADD_mem[0]
	S += (T70*ADD[1])-1<T0_3T0_mem1*ADD_mem[1]
	S += (T70*ADD[2])-1<T0_3T0_mem1*ADD_mem[2]
	S += (T70*ADD[3])-1<T0_3T0_mem1*ADD_mem[3]
	S += T0_3T0_mem1<=T0_3T0

	T1_3T0_in = S.Task('T1_3T0_in', length=1, delay_cost=1)
	T1_3T0_in += alt(MUL_in)
	...
	S += T1_3T0_mem0<=T1_3T0

	T1_3T0_mem1 = S.Task('T1_3T0_mem1', length=1, delay_cost=1)
	T1_3T0_mem1 += alt(ADD_mem)
	S += (T80*ADD[0])-1<T1_3T0_mem1*ADD_mem[0]
	S += (T80*ADD[1])-1<T1_3T0_mem1*ADD_mem[1]
	S += (T80*ADD[2])-1<T1_3T0_mem1*ADD_mem[2]
	S += (T80*ADD[3])-1<T1_3T0_mem1*ADD_mem[3]
	S += T1_3T0_mem1<=T1_3T0

	T2_6T0_in = S.Task('T2_6T0_in', length=1, delay_cost=1)
	T2_6T0_in += alt(MUL_in)
	...
	S += T2_6T0_mem0<=T2_6T0

	T2_6T0_mem1 = S.Task('T2_6T0_mem1', length=1, delay_cost=1)
	T2_6T0_mem1 += alt(ADD_mem)
	S += (T90*ADD[0])-1<T2_6T0_mem1*ADD_mem[0]
	S += (T90*ADD[1])-1<T2_6T0_mem1*ADD_mem[1]
	S += (T90*ADD[2])-1<T2_6T0_mem1*ADD_mem[2]
	S += (T90*ADD[3])-1<T2_6T0_mem1*ADD_mem[3]
	S += T2_6T0_mem1<=T2_6T0
	...
	S += (T70*ADD[0])-1<T100_mem0*ADD_mem[0]
	S += (T70*ADD[1])-1<T100_mem0*ADD_mem[1]
	S += (T70*ADD[2])-1<T100_mem0*ADD_mem[2]
	S += (T70*ADD[3])-1<T100_mem0*ADD_mem[3]
	S += T100_mem0<=T100

	T100_mem1 = S.Task('T100_mem1', length=1, delay_cost=1)
	T100_mem1 += alt(ADD_mem)
	S += (T80*ADD[0])-1<T100_mem1*ADD_mem[0]
	S += (T80*ADD[1])-1<T100_mem1*ADD_mem[1]
	S += (T80*ADD[2])-1<T100_mem1*ADD_mem[2]
	S += (T80*ADD[3])-1<T100_mem1*ADD_mem[3]
	S += T100_mem1<=T100
	...
	S += (T80*ADD[0])-1<T110_mem0*ADD_mem[0]
	S += (T80*ADD[1])-1<T110_mem0*ADD_mem[1]
	S += (T80*ADD[2])-1<T110_mem0*ADD_mem[2]
	S += (T80*ADD[3])-1<T110_mem0*ADD_mem[3]
	S += T110_mem0<=T110

	T110_mem1 = S.Task('T110_mem1', length=1, delay_cost=1)
	T110_mem1 += alt(ADD_mem)
	S += (T90*ADD[0])-1<T110_mem1*ADD_mem[0]
	S += (T90*ADD[1])-1<T110_mem1*ADD_mem[1]
	S += (T90*ADD[2])-1<T110_mem1*ADD_mem[2]
	S += (T90*ADD[3])-1<T110_mem1*ADD_mem[3]
	S += T110_mem1<=T110
	...
	S += (T90*ADD[0])-1<T120_mem0*ADD_mem[0]
	S += (T90*ADD[1])-1<T120_mem0*ADD_mem[1]
	S += (T90*ADD[2])-1<T120_mem0*ADD_mem[2]
	S += (T90*ADD[3])-1<T120_mem0*ADD_mem[3]
	S += T120_mem0<=T120

	T120_mem1 = S.Task('T120_mem1', length=1, delay_cost=1)
	T120_mem1 += alt(ADD_mem)
	S += (T70*ADD[0])-1<T120_mem1*ADD_mem[0]
	S += (T70*ADD[1])-1<T120_mem1*ADD_mem[1]
	S += (T70*ADD[2])-1<T120_mem1*ADD_mem[2]
	S += (T70*ADD[3])-1<T120_mem1*ADD_mem[3]
	S += T120_mem1<=T120

	T0_4T0_in = S.Task('T0_4T0_in', length=1, delay_cost=1)
	T0_4T0_in += alt(MUL_in)
	...
	S += T0_4T0_mem0<=T0_4T0

	T0_4T0_mem1 = S.Task('T0_4T0_mem1', length=1, delay_cost=1)
	T0_4T0_mem1 += alt(ADD_mem)
	S += (T70*ADD[0])-1<T0_4T0_mem1*ADD_mem[0]
	S += (T70*ADD[1])-1<T0_4T0_mem1*ADD_mem[1]
	S += (T70*ADD[2])-1<T0_4T0_mem1*ADD_mem[2]
	S += (T70*ADD[3])-1<T0_4T0_mem1*ADD_mem[3]
	S += T0_4T0_mem1<=T0_4T0

	T1_4T0_in = S.Task('T1_4T0_in', length=1, delay_cost=1)
	T1_4T0_in += alt(MUL_in)
	...
	S += T1_4T0_mem0<=T1_4T0

	T1_4T0_mem1 = S.Task('T1_4T0_mem1', length=1, delay_cost=1)
	T1_4T0_mem1 += alt(ADD_mem)
	S += (T80*ADD[0])-1<T1_4T0_mem1*ADD_mem[0]
	S += (T80*ADD[1])-1<T1_4T0_mem1*ADD_mem[1]
	S += (T80*ADD[2])-1<T1_4T0_mem1*ADD_mem[2]
	S += (T80*ADD[3])-1<T1_4T0_mem1*ADD_mem[3]
	S += T1_4T0_mem1<=T1_4T0

	T2_8T0_in = S.Task('T2_8T0_in', length=1, delay_cost=1)
	T2_8T0_in += alt(MUL_in)
	...
	S += T2_8T0_mem0<=T2_8T0

	T2_8T0_mem1 = S.Task('T2_8T0_mem1', length=1, delay_cost=1)
	T2_8T0_mem1 += alt(ADD_mem)
	S += (T90*ADD[0])-1<T2_8T0_mem1*ADD_mem[0]
	S += (T90*ADD[1])-1<T2_8T0_mem1*ADD_mem[1]
	S += (T90*ADD[2])-1<T2_8T0_mem1*ADD_mem[2]
	S += (T90*ADD[3])-1<T2_8T0_mem1*ADD_mem[3]
	S += T2_8T0_mem1<=T2_8T0
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_5.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_5(0, 0)