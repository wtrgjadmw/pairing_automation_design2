...
def solve_inv_mul1_add4_8(ConstStep, ExpStep):
	horizon = 236
	S=Scenario("inv_mul1_add4_8",horizon = horizon)
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_8.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_8(0, 0)