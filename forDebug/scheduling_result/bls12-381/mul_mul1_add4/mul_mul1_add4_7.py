...
def solve_mul_mul1_add4_7(ConstStep, ExpStep):
	horizon = 179
	S=Scenario("mul_mul1_add4_7",horizon = horizon)
	...
	pic_file_name = "mul_mul1_add4/mul_mul1_add4_7.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_mul_mul1_add4_7(0, 0)