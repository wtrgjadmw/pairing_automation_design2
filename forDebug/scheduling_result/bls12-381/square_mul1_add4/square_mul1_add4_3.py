...
def solve_square_mul1_add4_3(ConstStep, ExpStep):
	horizon = 137
	S=Scenario("square_mul1_add4_3",horizon = horizon)
	...
	S += (T6T4*MUL[0])-1<T61_mem0*MUL_mem[0]
	S += T61_mem0<=T61

	T61_mem1 = S.Task('T61_mem1', length=1, delay_cost=1)
	T61_mem1 += alt(ADD_mem)
	S += (T6T5*ADD[0])-1<T61_mem1*ADD_mem[0]
	S += (T6T5*ADD[1])-1<T61_mem1*ADD_mem[1]
	S += (T6T5*ADD[2])-1<T61_mem1*ADD_mem[2]
	S += (T6T5*ADD[3])-1<T61_mem1*ADD_mem[3]
	S += T61_mem1<=T61
	...
	S += (T1_1T4*MUL[0])-1<T1_11_mem0*MUL_mem[0]
	S += T1_11_mem0<=T1_11

	T1_11_mem1 = S.Task('T1_11_mem1', length=1, delay_cost=1)
	T1_11_mem1 += alt(ADD_mem)
	S += (T1_1T5*ADD[0])-1<T1_11_mem1*ADD_mem[0]
	S += (T1_1T5*ADD[1])-1<T1_11_mem1*ADD_mem[1]
	S += (T1_1T5*ADD[2])-1<T1_11_mem1*ADD_mem[2]
	S += (T1_1T5*ADD[3])-1<T1_11_mem1*ADD_mem[3]
	S += T1_11_mem1<=T1_11
	...
	T2_1T4_mem0 += alt(ADD_mem)
	S += (T2_1T2*ADD[0])-1<T2_1T4_mem0*ADD_mem[0]
	S += (T2_1T2*ADD[1])-1<T2_1T4_mem0*ADD_mem[1]
	S += (T2_1T2*ADD[2])-1<T2_1T4_mem0*ADD_mem[2]
	S += (T2_1T2*ADD[3])-1<T2_1T4_mem0*ADD_mem[3]
	...
	T2_1T5_mem0 += alt(MUL_mem)
	S += (T2_1T0*MUL[0])-1<T2_1T5_mem0*MUL_mem[0]
	S += T2_1T5_mem0<=T2_1T5

	T2_1T5_mem1 = S.Task('T2_1T5_mem1', length=1, delay_cost=1)
	T2_1T5_mem1 += alt(MUL_mem)
	S += (T2_1T1*MUL[0])-1<T2_1T5_mem1*MUL_mem[0]
	...
	T2_10_mem0 += alt(MUL_mem)
	S += (T2_1T0*MUL[0])-1<T2_10_mem0*MUL_mem[0]
	S += T2_10_mem0<=T2_10

	T2_10_mem1 = S.Task('T2_10_mem1', length=1, delay_cost=1)
	T2_10_mem1 += alt(MUL_mem)
	S += (T2_1T1*MUL[0])-1<T2_10_mem1*MUL_mem[0]
	S += T2_10_mem1<=T2_10
	...
	T1_20_mem0 += alt(ADD_mem)
	S += (T1_10*ADD[0])-1<T1_20_mem0*ADD_mem[0]
	S += (T1_10*ADD[1])-1<T1_20_mem0*ADD_mem[1]
	S += (T1_10*ADD[2])-1<T1_20_mem0*ADD_mem[2]
	S += (T1_10*ADD[3])-1<T1_20_mem0*ADD_mem[3]
	S += T1_20_mem0<=T1_20
	...
	T9_51_mem0 += alt(ADD_mem)
	S += (T9_41*ADD[0])-1<T9_51_mem0*ADD_mem[0]
	S += (T9_41*ADD[1])-1<T9_51_mem0*ADD_mem[1]
	S += (T9_41*ADD[2])-1<T9_51_mem0*ADD_mem[2]
	S += (T9_41*ADD[3])-1<T9_51_mem0*ADD_mem[3]
	S += T9_51_mem0<=T9_51
	...
	T9_60_mem0 += alt(ADD_mem)
	S += (T9_50*ADD[0])-1<T9_60_mem0*ADD_mem[0]
	S += (T9_50*ADD[1])-1<T9_60_mem0*ADD_mem[1]
	S += (T9_50*ADD[2])-1<T9_60_mem0*ADD_mem[2]
	S += (T9_50*ADD[3])-1<T9_60_mem0*ADD_mem[3]
	S += T9_60_mem0<=T9_60
	...
	T3_30_mem0 += alt(ADD_mem)
	S += (T3_20*ADD[0])-1<T3_30_mem0*ADD_mem[0]
	S += (T3_20*ADD[1])-1<T3_30_mem0*ADD_mem[1]
	S += (T3_20*ADD[2])-1<T3_30_mem0*ADD_mem[2]
	S += (T3_20*ADD[3])-1<T3_30_mem0*ADD_mem[3]
	S += T3_30_mem0<=T3_30
	...
	T4_41_mem0 += alt(ADD_mem)
	S += (T4_31*ADD[0])-1<T4_41_mem0*ADD_mem[0]
	S += (T4_31*ADD[1])-1<T4_41_mem0*ADD_mem[1]
	S += (T4_31*ADD[2])-1<T4_41_mem0*ADD_mem[2]
	S += (T4_31*ADD[3])-1<T4_41_mem0*ADD_mem[3]
	S += T4_41_mem0<=T4_41
	...
	T4_50_mem0 += alt(ADD_mem)
	S += (T4_40*ADD[0])-1<T4_50_mem0*ADD_mem[0]
	S += (T4_40*ADD[1])-1<T4_50_mem0*ADD_mem[1]
	S += (T4_40*ADD[2])-1<T4_50_mem0*ADD_mem[2]
	S += (T4_40*ADD[3])-1<T4_50_mem0*ADD_mem[3]
	S += T4_50_mem0<=T4_50
	...
	T2_11_mem0 += alt(MUL_mem)
	S += (T2_1T4*MUL[0])-1<T2_11_mem0*MUL_mem[0]
	S += T2_11_mem0<=T2_11

	T2_11_mem1 = S.Task('T2_11_mem1', length=1, delay_cost=1)
	T2_11_mem1 += alt(ADD_mem)
	S += (T2_1T5*ADD[0])-1<T2_11_mem1*ADD_mem[0]
	S += (T2_1T5*ADD[1])-1<T2_11_mem1*ADD_mem[1]
	S += (T2_1T5*ADD[2])-1<T2_11_mem1*ADD_mem[2]
	S += (T2_1T5*ADD[3])-1<T2_11_mem1*ADD_mem[3]
	S += T2_11_mem1<=T2_11
	...
	T9_10_mem0 += alt(ADD_mem)
	S += (T9_0*ADD[0])-1<T9_10_mem0*ADD_mem[0]
	S += (T9_0*ADD[1])-1<T9_10_mem0*ADD_mem[1]
	S += (T9_0*ADD[2])-1<T9_10_mem0*ADD_mem[2]
	S += (T9_0*ADD[3])-1<T9_10_mem0*ADD_mem[3]
	S += T9_10_mem0<=T9_10

	T9_10_mem1 = S.Task('T9_10_mem1', length=1, delay_cost=1)
	T9_10_mem1 += alt(ADD_mem)
	S += (T60*ADD[0])-1<T9_10_mem1*ADD_mem[0]
	S += (T60*ADD[1])-1<T9_10_mem1*ADD_mem[1]
	S += (T60*ADD[2])-1<T9_10_mem1*ADD_mem[2]
	S += (T60*ADD[3])-1<T9_10_mem1*ADD_mem[3]
	S += T9_10_mem1<=T9_10
	...
	S += (T71*ADD[0])-1<T1_21_mem1*ADD_mem[0]
	S += (T71*ADD[1])-1<T1_21_mem1*ADD_mem[1]
	S += (T71*ADD[2])-1<T1_21_mem1*ADD_mem[2]
	S += (T71*ADD[3])-1<T1_21_mem1*ADD_mem[3]
	S += T1_21_mem1<=T1_21
	...
	T1_30_mem0 += alt(ADD_mem)
	S += (T1_20*ADD[0])-1<T1_30_mem0*ADD_mem[0]
	S += (T1_20*ADD[1])-1<T1_30_mem0*ADD_mem[1]
	S += (T1_20*ADD[2])-1<T1_30_mem0*ADD_mem[2]
	S += (T1_20*ADD[3])-1<T1_30_mem0*ADD_mem[3]
	S += T1_30_mem0<=T1_30
	...
	T2_20_mem0 += alt(ADD_mem)
	S += (T2_10*ADD[0])-1<T2_20_mem0*ADD_mem[0]
	S += (T2_10*ADD[1])-1<T2_20_mem0*ADD_mem[1]
	S += (T2_10*ADD[2])-1<T2_20_mem0*ADD_mem[2]
	S += (T2_10*ADD[3])-1<T2_20_mem0*ADD_mem[3]
	S += T2_20_mem0<=T2_20
	...
	T9_61_mem0 += alt(ADD_mem)
	S += (T9_51*ADD[0])-1<T9_61_mem0*ADD_mem[0]
	S += (T9_51*ADD[1])-1<T9_61_mem0*ADD_mem[1]
	S += (T9_51*ADD[2])-1<T9_61_mem0*ADD_mem[2]
	S += (T9_51*ADD[3])-1<T9_61_mem0*ADD_mem[3]
	S += T9_61_mem0<=T9_61
	...
	T3_31_mem0 += alt(ADD_mem)
	S += (T3_21*ADD[0])-1<T3_31_mem0*ADD_mem[0]
	S += (T3_21*ADD[1])-1<T3_31_mem0*ADD_mem[1]
	S += (T3_21*ADD[2])-1<T3_31_mem0*ADD_mem[2]
	S += (T3_21*ADD[3])-1<T3_31_mem0*ADD_mem[3]
	S += T3_31_mem0<=T3_31
	...
	T5_20_mem1 += alt(ADD_mem)
	S += (T4_50*ADD[0])-1<T5_20_mem1*ADD_mem[0]
	S += (T4_50*ADD[1])-1<T5_20_mem1*ADD_mem[1]
	S += (T4_50*ADD[2])-1<T5_20_mem1*ADD_mem[2]
	S += (T4_50*ADD[3])-1<T5_20_mem1*ADD_mem[3]
	S += T5_20_mem1<=T5_20
	...
	S += (T9_60*ADD[0])-1<T4_60_mem0*ADD_mem[0]
	S += (T9_60*ADD[1])-1<T4_60_mem0*ADD_mem[1]
	S += (T9_60*ADD[2])-1<T4_60_mem0*ADD_mem[2]
	S += (T9_60*ADD[3])-1<T4_60_mem0*ADD_mem[3]
	S += T4_60_mem0<=T4_60

	T4_60_mem1 = S.Task('T4_60_mem1', length=1, delay_cost=1)
	T4_60_mem1 += alt(ADD_mem)
	S += (T8_20*ADD[0])-1<T4_60_mem1*ADD_mem[0]
	S += (T8_20*ADD[1])-1<T4_60_mem1*ADD_mem[1]
	S += (T8_20*ADD[2])-1<T4_60_mem1*ADD_mem[2]
	S += (T8_20*ADD[3])-1<T4_60_mem1*ADD_mem[3]
	S += T4_60_mem1<=T4_60
	...
	pic_file_name = "square_mul1_add4/square_mul1_add4_3.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_square_mul1_add4_3(0, 0)