...
def solve_padd_mul1_add4_4(ConstStep, ExpStep):
	horizon = 151
	S=Scenario("padd_mul1_add4_4",horizon = horizon)
	...
	T5t0_a1b1_mem1 += alt(ADD_mem)
	S += (T210*ADD[0])-1<T5t0_a1b1_mem1*ADD_mem[0]
	S += (T210*ADD[1])-1<T5t0_a1b1_mem1*ADD_mem[1]
	S += (T210*ADD[2])-1<T5t0_a1b1_mem1*ADD_mem[2]
	S += (T210*ADD[3])-1<T5t0_a1b1_mem1*ADD_mem[3]
	S += T5t0_a1b1_mem1<=T5t0_a1b1

	T2_1t0_a1b1_in = S.Task('T2_1t0_a1b1_in', length=1, delay_cost=1)
	T2_1t0_a1b1_in += alt(MUL_in)
	T2_1t0_a1b1 = S.Task('T2_1t0_a1b1', length=7, delay_cost=1)
	T2_1t0_a1b1 += alt(MUL)
	S+=T2_1t0_a1b1>=T2_1t0_a1b1_in

	T2_1t0_a1b1_mem0 = S.Task('T2_1t0_a1b1_mem0', length=1, delay_cost=1)
	T2_1t0_a1b1_mem0 += alt(ADD_mem)
	S += (T210*ADD[0])-1<T2_1t0_a1b1_mem0*ADD_mem[0]
	S += (T210*ADD[1])-1<T2_1t0_a1b1_mem0*ADD_mem[1]
	S += (T210*ADD[2])-1<T2_1t0_a1b1_mem0*ADD_mem[2]
	S += (T210*ADD[3])-1<T2_1t0_a1b1_mem0*ADD_mem[3]
	S += T2_1t0_a1b1_mem0<=T2_1t0_a1b1

	T2_1t0_a1b1_mem1 = S.Task('T2_1t0_a1b1_mem1', length=1, delay_cost=1)
	T2_1t0_a1b1_mem1 += ADD_mem[2]
	S += T0_110<T2_1t0_a1b1_mem1
	S += T2_1t0_a1b1_mem1<=T2_1t0_a1b1

	T3t4_t0t1_in = S.Task('T3t4_t0t1_in', length=1, delay_cost=1)
	T3t4_t0t1_in += alt(MUL_in)
	T3t4_t0t1 = S.Task('T3t4_t0t1', length=7, delay_cost=1)
	T3t4_t0t1 += alt(MUL)
	S+=T3t4_t0t1>=T3t4_t0t1_in

	T3t4_t0t1_mem0 = S.Task('T3t4_t0t1_mem0', length=1, delay_cost=1)
	T3t4_t0t1_mem0 += alt(ADD_mem)
	S += (T3t2_t0t1*ADD[0])-1<T3t4_t0t1_mem0*ADD_mem[0]
	S += (T3t2_t0t1*ADD[1])-1<T3t4_t0t1_mem0*ADD_mem[1]
	S += (T3t2_t0t1*ADD[2])-1<T3t4_t0t1_mem0*ADD_mem[2]
	S += (T3t2_t0t1*ADD[3])-1<T3t4_t0t1_mem0*ADD_mem[3]
	S += T3t4_t0t1_mem0<=T3t4_t0t1

	T3t4_t0t1_mem1 = S.Task('T3t4_t0t1_mem1', length=1, delay_cost=1)
	T3t4_t0t1_mem1 += ADD_mem[3]
	S += T3t3_t0t1<T3t4_t0t1_mem1
	S += T3t4_t0t1_mem1<=T3t4_t0t1

	T3c0_t0t1 = S.Task('T3c0_t0t1', length=1, delay_cost=1)
	T3c0_t0t1 += alt(ADD)

	T3c0_t0t1_mem0 = S.Task('T3c0_t0t1_mem0', length=1, delay_cost=1)
	T3c0_t0t1_mem0 += alt(MUL_mem)
	S += (T3t0_t0t1*MUL[0])-1<T3c0_t0t1_mem0*MUL_mem[0]
	S += T3c0_t0t1_mem0<=T3c0_t0t1

	T3c0_t0t1_mem1 = S.Task('T3c0_t0t1_mem1', length=1, delay_cost=1)
	T3c0_t0t1_mem1 += alt(MUL_mem)
	S += (T3t1_t0t1*MUL[0])-1<T3c0_t0t1_mem1*MUL_mem[0]
	S += T3c0_t0t1_mem1<=T3c0_t0t1

	T3t6_t0t1 = S.Task('T3t6_t0t1', length=1, delay_cost=1)
	T3t6_t0t1 += alt(ADD)

	T3t6_t0t1_mem0 = S.Task('T3t6_t0t1_mem0', length=1, delay_cost=1)
	T3t6_t0t1_mem0 += alt(MUL_mem)
	S += (T3t0_t0t1*MUL[0])-1<T3t6_t0t1_mem0*MUL_mem[0]
	S += T3t6_t0t1_mem0<=T3t6_t0t1

	T3t6_t0t1_mem1 = S.Task('T3t6_t0t1_mem1', length=1, delay_cost=1)
	T3t6_t0t1_mem1 += alt(MUL_mem)
	S += (T3t1_t0t1*MUL[0])-1<T3t6_t0t1_mem1*MUL_mem[0]
	S += T3t6_t0t1_mem1<=T3t6_t0t1
	...
	S += T3c0_a0a1<T3t40_mem0
	S += T3t40_mem0<=T3t40

	T3t40_mem1 = S.Task('T3t40_mem1', length=1, delay_cost=1)
	T3t40_mem1 += alt(ADD_mem)
	S += (T3c1_a0a1*ADD[0])-1<T3t40_mem1*ADD_mem[0]
	S += (T3c1_a0a1*ADD[1])-1<T3t40_mem1*ADD_mem[1]
	S += (T3c1_a0a1*ADD[2])-1<T3t40_mem1*ADD_mem[2]
	S += (T3c1_a0a1*ADD[3])-1<T3t40_mem1*ADD_mem[3]
	S += T3t40_mem1<=T3t40
	...
	S += T3c0_a0a1<T3t41_mem0
	S += T3t41_mem0<=T3t41

	T3t41_mem1 = S.Task('T3t41_mem1', length=1, delay_cost=1)
	T3t41_mem1 += alt(ADD_mem)
	S += (T3c1_a0a1*ADD[0])-1<T3t41_mem1*ADD_mem[0]
	S += (T3c1_a0a1*ADD[1])-1<T3t41_mem1*ADD_mem[1]
	S += (T3c1_a0a1*ADD[2])-1<T3t41_mem1*ADD_mem[2]
	S += (T3c1_a0a1*ADD[3])-1<T3t41_mem1*ADD_mem[3]
	S += T3t41_mem1<=T3t41
	...
	S += (T3c1_a0a1*ADD[0])-1<T311_mem0*ADD_mem[0]
	S += (T3c1_a0a1*ADD[1])-1<T311_mem0*ADD_mem[1]
	S += (T3c1_a0a1*ADD[2])-1<T311_mem0*ADD_mem[2]
	S += (T3c1_a0a1*ADD[3])-1<T311_mem0*ADD_mem[3]
	S += T311_mem0<=T311
	...
	T3_1t0_a1b1_mem0 += alt(ADD_mem)
	S += (T310*ADD[0])-1<T3_1t0_a1b1_mem0*ADD_mem[0]
	S += (T310*ADD[1])-1<T3_1t0_a1b1_mem0*ADD_mem[1]
	S += (T310*ADD[2])-1<T3_1t0_a1b1_mem0*ADD_mem[2]
	S += (T310*ADD[3])-1<T3_1t0_a1b1_mem0*ADD_mem[3]
	...
	T4c1_t2t3_mem0 += alt(MUL_mem)
	S += (T4t4_t2t3*MUL[0])-1<T4c1_t2t3_mem0*MUL_mem[0]
	S += T4c1_t2t3_mem0<=T4c1_t2t3

	T4c1_t2t3_mem1 = S.Task('T4c1_t2t3_mem1', length=1, delay_cost=1)
	T4c1_t2t3_mem1 += alt(ADD_mem)
	S += (T4t6_t2t3*ADD[0])-1<T4c1_t2t3_mem1*ADD_mem[0]
	S += (T4t6_t2t3*ADD[1])-1<T4c1_t2t3_mem1*ADD_mem[1]
	S += (T4t6_t2t3*ADD[2])-1<T4c1_t2t3_mem1*ADD_mem[2]
	S += (T4t6_t2t3*ADD[3])-1<T4c1_t2t3_mem1*ADD_mem[3]
	...
	S += T4c0_a1b1<T4s0_0_mem0
	S += T4s0_0_mem0<=T4s0_0

	T4s0_0_mem1 = S.Task('T4s0_0_mem1', length=1, delay_cost=1)
	T4s0_0_mem1 += alt(ADD_mem)
	S += (T4c1_a1b1*ADD[0])-1<T4s0_0_mem1*ADD_mem[0]
	S += (T4c1_a1b1*ADD[1])-1<T4s0_0_mem1*ADD_mem[1]
	S += (T4c1_a1b1*ADD[2])-1<T4s0_0_mem1*ADD_mem[2]
	S += (T4c1_a1b1*ADD[3])-1<T4s0_0_mem1*ADD_mem[3]
	...
	T4s0_1_mem0 += alt(ADD_mem)
	S += (T4c1_a1b1*ADD[0])-1<T4s0_1_mem0*ADD_mem[0]
	S += (T4c1_a1b1*ADD[1])-1<T4s0_1_mem0*ADD_mem[1]
	S += (T4c1_a1b1*ADD[2])-1<T4s0_1_mem0*ADD_mem[2]
	S += (T4c1_a1b1*ADD[3])-1<T4s0_1_mem0*ADD_mem[3]
	S += T4s0_1_mem0<=T4s0_1

	T4s0_1_mem1 = S.Task('T4s0_1_mem1', length=1, delay_cost=1)
	T4s0_1_mem1 += ADD_mem[3]
	S += T4c0_a1b1<T4s0_1_mem1
	...
	T4t5_1_mem0 += alt(ADD_mem)
	S += (T4c1_a0b0*ADD[0])-1<T4t5_1_mem0*ADD_mem[0]
	S += (T4c1_a0b0*ADD[1])-1<T4t5_1_mem0*ADD_mem[1]
	S += (T4c1_a0b0*ADD[2])-1<T4t5_1_mem0*ADD_mem[2]
	S += (T4c1_a0b0*ADD[3])-1<T4t5_1_mem0*ADD_mem[3]
	S += T4t5_1_mem0<=T4t5_1

	T4t5_1_mem1 = S.Task('T4t5_1_mem1', length=1, delay_cost=1)
	T4t5_1_mem1 += alt(ADD_mem)
	S += (T4c1_a1b1*ADD[0])-1<T4t5_1_mem1*ADD_mem[0]
	S += (T4c1_a1b1*ADD[1])-1<T4t5_1_mem1*ADD_mem[1]
	S += (T4c1_a1b1*ADD[2])-1<T4t5_1_mem1*ADD_mem[2]
	S += (T4c1_a1b1*ADD[3])-1<T4t5_1_mem1*ADD_mem[3]
	...
	S += (T4c0_t2t3*ADD[0])-1<T410_mem0*ADD_mem[0]
	S += (T4c0_t2t3*ADD[1])-1<T410_mem0*ADD_mem[1]
	S += (T4c0_t2t3*ADD[2])-1<T410_mem0*ADD_mem[2]
	S += (T4c0_t2t3*ADD[3])-1<T410_mem0*ADD_mem[3]
	S += T410_mem0<=T410

	T410_mem1 = S.Task('T410_mem1', length=1, delay_cost=1)
	T410_mem1 += alt(ADD_mem)
	S += (T4t5_0*ADD[0])-1<T410_mem1*ADD_mem[0]
	S += (T4t5_0*ADD[1])-1<T410_mem1*ADD_mem[1]
	S += (T4t5_0*ADD[2])-1<T410_mem1*ADD_mem[2]
	S += (T4t5_0*ADD[3])-1<T410_mem1*ADD_mem[3]
	S += T410_mem1<=T410
	...
	T2_2c1_t2t3_mem0 += alt(MUL_mem)
	S += (T2_2t4_t2t3*MUL[0])-1<T2_2c1_t2t3_mem0*MUL_mem[0]
	S += T2_2c1_t2t3_mem0<=T2_2c1_t2t3

	T2_2c1_t2t3_mem1 = S.Task('T2_2c1_t2t3_mem1', length=1, delay_cost=1)
	T2_2c1_t2t3_mem1 += alt(ADD_mem)
	S += (T2_2t6_t2t3*ADD[0])-1<T2_2c1_t2t3_mem1*ADD_mem[0]
	S += (T2_2t6_t2t3*ADD[1])-1<T2_2c1_t2t3_mem1*ADD_mem[1]
	S += (T2_2t6_t2t3*ADD[2])-1<T2_2c1_t2t3_mem1*ADD_mem[2]
	S += (T2_2t6_t2t3*ADD[3])-1<T2_2c1_t2t3_mem1*ADD_mem[3]
	...
	T2_2s0_0_mem1 += alt(ADD_mem)
	S += (T2_2c1_a1b1*ADD[0])-1<T2_2s0_0_mem1*ADD_mem[0]
	S += (T2_2c1_a1b1*ADD[1])-1<T2_2s0_0_mem1*ADD_mem[1]
	S += (T2_2c1_a1b1*ADD[2])-1<T2_2s0_0_mem1*ADD_mem[2]
	S += (T2_2c1_a1b1*ADD[3])-1<T2_2s0_0_mem1*ADD_mem[3]
	...
	T2_2s0_1_mem0 += alt(ADD_mem)
	S += (T2_2c1_a1b1*ADD[0])-1<T2_2s0_1_mem0*ADD_mem[0]
	S += (T2_2c1_a1b1*ADD[1])-1<T2_2s0_1_mem0*ADD_mem[1]
	S += (T2_2c1_a1b1*ADD[2])-1<T2_2s0_1_mem0*ADD_mem[2]
	S += (T2_2c1_a1b1*ADD[3])-1<T2_2s0_1_mem0*ADD_mem[3]
	...
	T2_2t5_1_mem0 += alt(ADD_mem)
	S += (T2_2c1_a0b0*ADD[0])-1<T2_2t5_1_mem0*ADD_mem[0]
	S += (T2_2c1_a0b0*ADD[1])-1<T2_2t5_1_mem0*ADD_mem[1]
	S += (T2_2c1_a0b0*ADD[2])-1<T2_2t5_1_mem0*ADD_mem[2]
	S += (T2_2c1_a0b0*ADD[3])-1<T2_2t5_1_mem0*ADD_mem[3]
	S += T2_2t5_1_mem0<=T2_2t5_1

	T2_2t5_1_mem1 = S.Task('T2_2t5_1_mem1', length=1, delay_cost=1)
	T2_2t5_1_mem1 += alt(ADD_mem)
	S += (T2_2c1_a1b1*ADD[0])-1<T2_2t5_1_mem1*ADD_mem[0]
	S += (T2_2c1_a1b1*ADD[1])-1<T2_2t5_1_mem1*ADD_mem[1]
	S += (T2_2c1_a1b1*ADD[2])-1<T2_2t5_1_mem1*ADD_mem[2]
	S += (T2_2c1_a1b1*ADD[3])-1<T2_2t5_1_mem1*ADD_mem[3]
	...
	S += (T2_2c0_t2t3*ADD[0])-1<T2_210_mem0*ADD_mem[0]
	S += (T2_2c0_t2t3*ADD[1])-1<T2_210_mem0*ADD_mem[1]
	S += (T2_2c0_t2t3*ADD[2])-1<T2_210_mem0*ADD_mem[2]
	S += (T2_2c0_t2t3*ADD[3])-1<T2_210_mem0*ADD_mem[3]
	S += T2_210_mem0<=T2_210

	T2_210_mem1 = S.Task('T2_210_mem1', length=1, delay_cost=1)
	T2_210_mem1 += alt(ADD_mem)
	S += (T2_2t5_0*ADD[0])-1<T2_210_mem1*ADD_mem[0]
	S += (T2_2t5_0*ADD[1])-1<T2_210_mem1*ADD_mem[1]
	S += (T2_2t5_0*ADD[2])-1<T2_210_mem1*ADD_mem[2]
	S += (T2_2t5_0*ADD[3])-1<T2_210_mem1*ADD_mem[3]
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_4.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_4(0, 0)