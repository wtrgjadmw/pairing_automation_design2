...
def solve_padd_mul1_add4_11(ConstStep, ExpStep):
	horizon = 217
	S=Scenario("padd_mul1_add4_11",horizon = horizon)
	...
	S += TX_newt4_a1b1<TX_newc1_a1b1_mem0
	...
	S += TX_newt6_a1b1<TX_newc1_a1b1_mem1
	...
	S += T2t3_t0t1<TX_newt4_t2t3_mem0
	...
	S += TX_newt3_t2t3<TX_newt4_t2t3_mem1
	...
	S += TX_newt0_t2t3<TX_newc0_t2t3_mem0
	...
	S += TX_newt1_t2t3<TX_newc0_t2t3_mem1
	...
	S += TX_newt0_t2t3<TX_newt6_t2t3_mem0
	...
	S += TX_newt1_t2t3<TX_newt6_t2t3_mem1
	...
	T1_2c1_a1b1_mem0 += alt(MUL_mem)
	S += (T1_2t4_a1b1*MUL[0])-1<T1_2c1_a1b1_mem0*MUL_mem[0]
	S += T1_2c1_a1b1_mem0<=T1_2c1_a1b1

	T1_2c1_a1b1_mem1 = S.Task('T1_2c1_a1b1_mem1', length=1, delay_cost=1)
	T1_2c1_a1b1_mem1 += alt(ADD_mem)
	S += (T1_2t6_a1b1*ADD[0])-1<T1_2c1_a1b1_mem1*ADD_mem[0]
	S += (T1_2t6_a1b1*ADD[1])-1<T1_2c1_a1b1_mem1*ADD_mem[1]
	S += (T1_2t6_a1b1*ADD[2])-1<T1_2c1_a1b1_mem1*ADD_mem[2]
	S += (T1_2t6_a1b1*ADD[3])-1<T1_2c1_a1b1_mem1*ADD_mem[3]
	...
	S += T3t3_t0t1<T1_2t4_t2t3_mem0
	S += T1_2t4_t2t3_mem0<=T1_2t4_t2t3

	T1_2t4_t2t3_mem1 = S.Task('T1_2t4_t2t3_mem1', length=1, delay_cost=1)
	T1_2t4_t2t3_mem1 += alt(ADD_mem)
	S += (T1_2t3_t2t3*ADD[0])-1<T1_2t4_t2t3_mem1*ADD_mem[0]
	S += (T1_2t3_t2t3*ADD[1])-1<T1_2t4_t2t3_mem1*ADD_mem[1]
	S += (T1_2t3_t2t3*ADD[2])-1<T1_2t4_t2t3_mem1*ADD_mem[2]
	S += (T1_2t3_t2t3*ADD[3])-1<T1_2t4_t2t3_mem1*ADD_mem[3]
	...
	T1_2c0_t2t3_mem1 += alt(MUL_mem)
	S += (T1_2t1_t2t3*MUL[0])-1<T1_2c0_t2t3_mem1*MUL_mem[0]
	...
	T1_2t6_t2t3_mem1 += alt(MUL_mem)
	S += (T1_2t1_t2t3*MUL[0])-1<T1_2t6_t2t3_mem1*MUL_mem[0]
	...
	T1_2t5_0_mem1 += alt(ADD_mem)
	S += (T1_2c0_a1b1*ADD[0])-1<T1_2t5_0_mem1*ADD_mem[0]
	S += (T1_2c0_a1b1*ADD[1])-1<T1_2t5_0_mem1*ADD_mem[1]
	S += (T1_2c0_a1b1*ADD[2])-1<T1_2t5_0_mem1*ADD_mem[2]
	S += (T1_2c0_a1b1*ADD[3])-1<T1_2t5_0_mem1*ADD_mem[3]
	...
	S += TX_newc0_a1b1<TX_news0_0_mem0
	...
	S += TX_newc0_a1b1<TX_news0_1_mem1
	...
	S += TX_newc1_a0b0<TX_newt5_1_mem0
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_11.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_11(0, 0)