...
def solve_padd_mul1_add4_12(ConstStep, ExpStep):
	horizon = 226
	S=Scenario("padd_mul1_add4_12",horizon = horizon)
	...
	S += T1_2t3_t2t3_mem0 >= 111
	T1_2t3_t2t3_mem0 += ADD_mem[3]

	T1_2t3_t2t3_mem1 = S.Task('T1_2t3_t2t3_mem1', length=1, delay_cost=1)
	S += T1_2t3_t2t3_mem1 >= 111
	...
	S += TX_newc1_a0b0_mem0 >= 120
	TX_newc1_a0b0_mem0 += MUL_mem[0]

	TX_newc1_a0b0_mem1 = S.Task('TX_newc1_a0b0_mem1', length=1, delay_cost=1)
	S += TX_newc1_a0b0_mem1 >= 120
	TX_newc1_a0b0_mem1 += ADD_mem[2]
	...
	S += TX_news0_0_mem0 >= 127
	TX_news0_0_mem0 += ADD_mem[2]

	TX_news0_0_mem1 = S.Task('TX_news0_0_mem1', length=1, delay_cost=1)
	S += TX_news0_0_mem1 >= 127
	TX_news0_0_mem1 += ADD_mem[3]

	TX_news0_1_mem0 = S.Task('TX_news0_1_mem0', length=1, delay_cost=1)
	S += TX_news0_1_mem0 >= 127
	TX_news0_1_mem0 += ADD_mem[3]

	TX_news0_1_mem1 = S.Task('TX_news0_1_mem1', length=1, delay_cost=1)
	S += TX_news0_1_mem1 >= 127
	TX_news0_1_mem1 += ADD_mem[2]
	...
	S += TX_newt5_0_mem0 >= 128
	TX_newt5_0_mem0 += ADD_mem[3]

	TX_newt5_0_mem1 = S.Task('TX_newt5_0_mem1', length=1, delay_cost=1)
	S += TX_newt5_0_mem1 >= 128
	TX_newt5_0_mem1 += ADD_mem[2]

	TX_newt5_1_mem0 = S.Task('TX_newt5_1_mem0', length=1, delay_cost=1)
	S += TX_newt5_1_mem0 >= 128
	TX_newt5_1_mem0 += ADD_mem[0]

	TX_newt5_1_mem1 = S.Task('TX_newt5_1_mem1', length=1, delay_cost=1)
	S += TX_newt5_1_mem1 >= 128
	TX_newt5_1_mem1 += ADD_mem[3]
	...
	S += TX_newc0_t2t3_mem0 >= 131
	TX_newc0_t2t3_mem0 += MUL_mem[0]

	TX_newc0_t2t3_mem1 = S.Task('TX_newc0_t2t3_mem1', length=1, delay_cost=1)
	S += TX_newc0_t2t3_mem1 >= 131
	TX_newc0_t2t3_mem1 += MUL_mem[0]
	...
	S += T1_2t4_t2t3<T1_2c1_t2t3_mem0
	S += T1_2c1_t2t3_mem0<=T1_2c1_t2t3

	T1_2c1_t2t3_mem1 = S.Task('T1_2c1_t2t3_mem1', length=1, delay_cost=1)
	T1_2c1_t2t3_mem1 += ADD_mem[1]
	S += T1_2t6_t2t3<T1_2c1_t2t3_mem1
	S += T1_2c1_t2t3_mem1<=T1_2c1_t2t3

	T1_2s0_0 = S.Task('T1_2s0_0', length=1, delay_cost=1)
	T1_2s0_0 += alt(ADD)

	T1_2s0_0_mem0 = S.Task('T1_2s0_0_mem0', length=1, delay_cost=1)
	T1_2s0_0_mem0 += ADD_mem[0]
	S += T1_2c0_a1b1<T1_2s0_0_mem0
	S += T1_2s0_0_mem0<=T1_2s0_0

	T1_2s0_0_mem1 = S.Task('T1_2s0_0_mem1', length=1, delay_cost=1)
	T1_2s0_0_mem1 += ADD_mem[3]
	S += T1_2c1_a1b1<T1_2s0_0_mem1
	S += T1_2s0_0_mem1<=T1_2s0_0

	T1_2s0_1 = S.Task('T1_2s0_1', length=1, delay_cost=1)
	T1_2s0_1 += alt(ADD)

	T1_2s0_1_mem0 = S.Task('T1_2s0_1_mem0', length=1, delay_cost=1)
	T1_2s0_1_mem0 += ADD_mem[3]
	S += T1_2c1_a1b1<T1_2s0_1_mem0
	S += T1_2s0_1_mem0<=T1_2s0_1

	T1_2s0_1_mem1 = S.Task('T1_2s0_1_mem1', length=1, delay_cost=1)
	T1_2s0_1_mem1 += ADD_mem[0]
	S += T1_2c0_a1b1<T1_2s0_1_mem1
	S += T1_2s0_1_mem1<=T1_2s0_1

	T1_2t5_1 = S.Task('T1_2t5_1', length=1, delay_cost=1)
	T1_2t5_1 += alt(ADD)

	T1_2t5_1_mem0 = S.Task('T1_2t5_1_mem0', length=1, delay_cost=1)
	T1_2t5_1_mem0 += ADD_mem[0]
	S += T1_2c1_a0b0<T1_2t5_1_mem0
	S += T1_2t5_1_mem0<=T1_2t5_1

	T1_2t5_1_mem1 = S.Task('T1_2t5_1_mem1', length=1, delay_cost=1)
	T1_2t5_1_mem1 += ADD_mem[3]
	S += T1_2c1_a1b1<T1_2t5_1_mem1
	S += T1_2t5_1_mem1<=T1_2t5_1
	...
	S += T1_2c0_t2t3<T1_210_mem0
	S += T1_210_mem0<=T1_210

	T1_210_mem1 = S.Task('T1_210_mem1', length=1, delay_cost=1)
	T1_210_mem1 += ADD_mem[2]
	S += T1_2t5_0<T1_210_mem1
	S += T1_210_mem1<=T1_210
	...
	S += T1_2c0_a0b0<T1_200_mem0
	S += T1_200_mem0<=T1_200

	T1_200_mem1 = S.Task('T1_200_mem1', length=1, delay_cost=1)
	T1_200_mem1 += alt(ADD_mem)
	S += (T1_2s0_0*ADD[0])-1<T1_200_mem1*ADD_mem[0]
	S += (T1_2s0_0*ADD[1])-1<T1_200_mem1*ADD_mem[1]
	S += (T1_2s0_0*ADD[2])-1<T1_200_mem1*ADD_mem[2]
	S += (T1_2s0_0*ADD[3])-1<T1_200_mem1*ADD_mem[3]
	S += T1_200_mem1<=T1_200

	T1_201 = S.Task('T1_201', length=1, delay_cost=1)
	T1_201 += alt(ADD)

	T1_201_mem0 = S.Task('T1_201_mem0', length=1, delay_cost=1)
	T1_201_mem0 += ADD_mem[0]
	S += T1_2c1_a0b0<T1_201_mem0
	S += T1_201_mem0<=T1_201

	T1_201_mem1 = S.Task('T1_201_mem1', length=1, delay_cost=1)
	T1_201_mem1 += alt(ADD_mem)
	S += (T1_2s0_1*ADD[0])-1<T1_201_mem1*ADD_mem[0]
	S += (T1_2s0_1*ADD[1])-1<T1_201_mem1*ADD_mem[1]
	S += (T1_2s0_1*ADD[2])-1<T1_201_mem1*ADD_mem[2]
	S += (T1_2s0_1*ADD[3])-1<T1_201_mem1*ADD_mem[3]
	S += T1_201_mem1<=T1_201
	...
	S += (T1_2c1_t2t3*ADD[0])-1<T1_211_mem0*ADD_mem[0]
	S += (T1_2c1_t2t3*ADD[1])-1<T1_211_mem0*ADD_mem[1]
	S += (T1_2c1_t2t3*ADD[2])-1<T1_211_mem0*ADD_mem[2]
	S += (T1_2c1_t2t3*ADD[3])-1<T1_211_mem0*ADD_mem[3]
	S += T1_211_mem0<=T1_211

	T1_211_mem1 = S.Task('T1_211_mem1', length=1, delay_cost=1)
	T1_211_mem1 += alt(ADD_mem)
	S += (T1_2t5_1*ADD[0])-1<T1_211_mem1*ADD_mem[0]
	S += (T1_2t5_1*ADD[1])-1<T1_211_mem1*ADD_mem[1]
	S += (T1_2t5_1*ADD[2])-1<T1_211_mem1*ADD_mem[2]
	S += (T1_2t5_1*ADD[3])-1<T1_211_mem1*ADD_mem[3]
	S += T1_211_mem1<=T1_211
	...
	TZ_new10_mem0 += ADD_mem[0]
	S += TZ_newc0_t2t3<TZ_new10_mem0
	S += TZ_new10_mem0<=TZ_new10

	TZ_new10_mem1 = S.Task('TZ_new10_mem1', length=1, delay_cost=1)
	TZ_new10_mem1 += ADD_mem[1]
	S += TZ_newt5_0<TZ_new10_mem1
	...
	TZ_new00_mem0 += ADD_mem[2]
	S += TZ_newc0_a0b0<TZ_new00_mem0
	S += TZ_new00_mem0<=TZ_new00

	TZ_new00_mem1 = S.Task('TZ_new00_mem1', length=1, delay_cost=1)
	TZ_new00_mem1 += ADD_mem[2]
	S += TZ_news0_0<TZ_new00_mem1
	...
	TZ_new01_mem0 += ADD_mem[0]
	S += TZ_newc1_a0b0<TZ_new01_mem0
	S += TZ_new01_mem0<=TZ_new01

	TZ_new01_mem1 = S.Task('TZ_new01_mem1', length=1, delay_cost=1)
	TZ_new01_mem1 += ADD_mem[3]
	S += TZ_news0_1<TZ_new01_mem1
	...
	TZ_new11_mem0 += ADD_mem[1]
	S += TZ_newc1_t2t3<TZ_new11_mem0
	S += TZ_new11_mem0<=TZ_new11

	TZ_new11_mem1 = S.Task('TZ_new11_mem1', length=1, delay_cost=1)
	TZ_new11_mem1 += ADD_mem[1]
	S += TZ_newt5_1<TZ_new11_mem1
	...
	TX_new10_mem0 += ADD_mem[2]
	S += TX_newc0_t2t3<TX_new10_mem0
	S += TX_new10_mem0<=TX_new10

	TX_new10_mem1 = S.Task('TX_new10_mem1', length=1, delay_cost=1)
	TX_new10_mem1 += ADD_mem[0]
	S += TX_newt5_0<TX_new10_mem1
	...
	TX_new00_mem0 += ADD_mem[3]
	S += TX_newc0_a0b0<TX_new00_mem0
	S += TX_new00_mem0<=TX_new00

	TX_new00_mem1 = S.Task('TX_new00_mem1', length=1, delay_cost=1)
	TX_new00_mem1 += ADD_mem[1]
	S += TX_news0_0<TX_new00_mem1
	...
	TX_new01_mem0 += ADD_mem[0]
	S += TX_newc1_a0b0<TX_new01_mem0
	S += TX_new01_mem0<=TX_new01

	TX_new01_mem1 = S.Task('TX_new01_mem1', length=1, delay_cost=1)
	TX_new01_mem1 += ADD_mem[3]
	S += TX_news0_1<TX_new01_mem1
	...
	TX_new11_mem0 += ADD_mem[1]
	S += TX_newc1_t2t3<TX_new11_mem0
	S += TX_new11_mem0<=TX_new11

	TX_new11_mem1 = S.Task('TX_new11_mem1', length=1, delay_cost=1)
	TX_new11_mem1 += ADD_mem[3]
	S += TX_newt5_1<TX_new11_mem1
	...
	S += (T1_210*ADD[0])-1<TY_new10_mem0*ADD_mem[0]
	S += (T1_210*ADD[1])-1<TY_new10_mem0*ADD_mem[1]
	S += (T1_210*ADD[2])-1<TY_new10_mem0*ADD_mem[2]
	S += (T1_210*ADD[3])-1<TY_new10_mem0*ADD_mem[3]
	S += TY_new10_mem0<=TY_new10

	TY_new10_mem1 = S.Task('TY_new10_mem1', length=1, delay_cost=1)
	TY_new10_mem1 += ADD_mem[1]
	S += T610<TY_new10_mem1
	S += TY_new10_mem1<=TY_new10

	TY_new10_w = S.Task('TY_new10_w', length=1, delay_cost=1)
	TY_new10_w += alt(INPUT_mem_w)
	S += 101 < TY_new10_w
	S += TY_new10-1 <= TY_new10_w
	...
	S += (T1_200*ADD[0])-1<TY_new00_mem0*ADD_mem[0]
	S += (T1_200*ADD[1])-1<TY_new00_mem0*ADD_mem[1]
	S += (T1_200*ADD[2])-1<TY_new00_mem0*ADD_mem[2]
	S += (T1_200*ADD[3])-1<TY_new00_mem0*ADD_mem[3]
	S += TY_new00_mem0<=TY_new00

	TY_new00_mem1 = S.Task('TY_new00_mem1', length=1, delay_cost=1)
	TY_new00_mem1 += ADD_mem[1]
	S += T600<TY_new00_mem1
	S += TY_new00_mem1<=TY_new00

	TY_new00_w = S.Task('TY_new00_w', length=1, delay_cost=1)
	TY_new00_w += alt(INPUT_mem_w)
	S += 101 < TY_new00_w
	S += TY_new00-1 <= TY_new00_w
	...
	S += (T1_201*ADD[0])-1<TY_new01_mem0*ADD_mem[0]
	S += (T1_201*ADD[1])-1<TY_new01_mem0*ADD_mem[1]
	S += (T1_201*ADD[2])-1<TY_new01_mem0*ADD_mem[2]
	S += (T1_201*ADD[3])-1<TY_new01_mem0*ADD_mem[3]
	S += TY_new01_mem0<=TY_new01

	TY_new01_mem1 = S.Task('TY_new01_mem1', length=1, delay_cost=1)
	TY_new01_mem1 += ADD_mem[1]
	S += T601<TY_new01_mem1
	S += TY_new01_mem1<=TY_new01

	TY_new01_w = S.Task('TY_new01_w', length=1, delay_cost=1)
	TY_new01_w += alt(INPUT_mem_w)
	S += 101 < TY_new01_w
	S += TY_new01-1 <= TY_new01_w
	...
	S += (T1_211*ADD[0])-1<TY_new11_mem0*ADD_mem[0]
	S += (T1_211*ADD[1])-1<TY_new11_mem0*ADD_mem[1]
	S += (T1_211*ADD[2])-1<TY_new11_mem0*ADD_mem[2]
	S += (T1_211*ADD[3])-1<TY_new11_mem0*ADD_mem[3]
	S += TY_new11_mem0<=TY_new11

	TY_new11_mem1 = S.Task('TY_new11_mem1', length=1, delay_cost=1)
	TY_new11_mem1 += ADD_mem[3]
	S += T611<TY_new11_mem1
	S += TY_new11_mem1<=TY_new11

	TY_new11_w = S.Task('TY_new11_w', length=1, delay_cost=1)
	TY_new11_w += alt(INPUT_mem_w)
	S += 101 < TY_new11_w
	S += TY_new11-1 <= TY_new11_w
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_12.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_12(0, 0)