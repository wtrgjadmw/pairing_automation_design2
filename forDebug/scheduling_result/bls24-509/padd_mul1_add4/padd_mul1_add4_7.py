...
def solve_padd_mul1_add4_7(ConstStep, ExpStep):
	horizon = 183
	S=Scenario("padd_mul1_add4_7",horizon = horizon)
	...
	S += T2_1t0_t2t3<T2_1c0_t2t3_mem0
	S += T2_1c0_t2t3_mem0<=T2_1c0_t2t3

	T2_1c0_t2t3_mem1 = S.Task('T2_1c0_t2t3_mem1', length=1, delay_cost=1)
	T2_1c0_t2t3_mem1 += MUL_mem[0]
	S += T2_1t1_t2t3<T2_1c0_t2t3_mem1
	S += T2_1c0_t2t3_mem1<=T2_1c0_t2t3
	...
	S += T2_1t0_t2t3<T2_1t6_t2t3_mem0
	S += T2_1t6_t2t3_mem0<=T2_1t6_t2t3

	T2_1t6_t2t3_mem1 = S.Task('T2_1t6_t2t3_mem1', length=1, delay_cost=1)
	T2_1t6_t2t3_mem1 += MUL_mem[0]
	S += T2_1t1_t2t3<T2_1t6_t2t3_mem1
	S += T2_1t6_t2t3_mem1<=T2_1t6_t2t3
	...
	S += T2_1c0_a0b0<T2_1t5_0_mem0
	S += T2_1t5_0_mem0<=T2_1t5_0

	T2_1t5_0_mem1 = S.Task('T2_1t5_0_mem1', length=1, delay_cost=1)
	T2_1t5_0_mem1 += ADD_mem[2]
	S += T2_1c0_a1b1<T2_1t5_0_mem1
	S += T2_1t5_0_mem1<=T2_1t5_0
	...
	T5c1_t2t3_mem0 += alt(MUL_mem)
	S += (T5t4_t2t3*MUL[0])-1<T5c1_t2t3_mem0*MUL_mem[0]
	S += T5c1_t2t3_mem0<=T5c1_t2t3

	T5c1_t2t3_mem1 = S.Task('T5c1_t2t3_mem1', length=1, delay_cost=1)
	T5c1_t2t3_mem1 += alt(ADD_mem)
	S += (T5t6_t2t3*ADD[0])-1<T5c1_t2t3_mem1*ADD_mem[0]
	S += (T5t6_t2t3*ADD[1])-1<T5c1_t2t3_mem1*ADD_mem[1]
	S += (T5t6_t2t3*ADD[2])-1<T5c1_t2t3_mem1*ADD_mem[2]
	S += (T5t6_t2t3*ADD[3])-1<T5c1_t2t3_mem1*ADD_mem[3]
	...
	S += (T5c1_a0b0*ADD[0])-1<T501_mem0*ADD_mem[0]
	S += (T5c1_a0b0*ADD[1])-1<T501_mem0*ADD_mem[1]
	S += (T5c1_a0b0*ADD[2])-1<T501_mem0*ADD_mem[2]
	S += (T5c1_a0b0*ADD[3])-1<T501_mem0*ADD_mem[3]
	S += T501_mem0<=T501
	...
	T5t5_1_mem0 += alt(ADD_mem)
	S += (T5c1_a0b0*ADD[0])-1<T5t5_1_mem0*ADD_mem[0]
	S += (T5c1_a0b0*ADD[1])-1<T5t5_1_mem0*ADD_mem[1]
	S += (T5c1_a0b0*ADD[2])-1<T5t5_1_mem0*ADD_mem[2]
	S += (T5c1_a0b0*ADD[3])-1<T5t5_1_mem0*ADD_mem[3]
	S += T5t5_1_mem0<=T5t5_1

	T5t5_1_mem1 = S.Task('T5t5_1_mem1', length=1, delay_cost=1)
	T5t5_1_mem1 += ADD_mem[3]
	S += T5c1_a1b1<T5t5_1_mem1
	...
	S += (T5c0_t2t3*ADD[0])-1<T510_mem0*ADD_mem[0]
	S += (T5c0_t2t3*ADD[1])-1<T510_mem0*ADD_mem[1]
	S += (T5c0_t2t3*ADD[2])-1<T510_mem0*ADD_mem[2]
	S += (T5c0_t2t3*ADD[3])-1<T510_mem0*ADD_mem[3]
	S += T510_mem0<=T510

	T510_mem1 = S.Task('T510_mem1', length=1, delay_cost=1)
	T510_mem1 += alt(ADD_mem)
	S += (T5t5_0*ADD[0])-1<T510_mem1*ADD_mem[0]
	S += (T5t5_0*ADD[1])-1<T510_mem1*ADD_mem[1]
	S += (T5t5_0*ADD[2])-1<T510_mem1*ADD_mem[2]
	S += (T5t5_0*ADD[3])-1<T510_mem1*ADD_mem[3]
	S += T510_mem1<=T510
	...
	T2_1c1_t2t3_mem0 += alt(MUL_mem)
	S += (T2_1t4_t2t3*MUL[0])-1<T2_1c1_t2t3_mem0*MUL_mem[0]
	S += T2_1c1_t2t3_mem0<=T2_1c1_t2t3

	T2_1c1_t2t3_mem1 = S.Task('T2_1c1_t2t3_mem1', length=1, delay_cost=1)
	T2_1c1_t2t3_mem1 += alt(ADD_mem)
	S += (T2_1t6_t2t3*ADD[0])-1<T2_1c1_t2t3_mem1*ADD_mem[0]
	S += (T2_1t6_t2t3*ADD[1])-1<T2_1c1_t2t3_mem1*ADD_mem[1]
	S += (T2_1t6_t2t3*ADD[2])-1<T2_1c1_t2t3_mem1*ADD_mem[2]
	S += (T2_1t6_t2t3*ADD[3])-1<T2_1c1_t2t3_mem1*ADD_mem[3]
	S += T2_1c1_t2t3_mem1<=T2_1c1_t2t3
	...
	S += (T2_1c1_a0b0*ADD[0])-1<T2_101_mem0*ADD_mem[0]
	S += (T2_1c1_a0b0*ADD[1])-1<T2_101_mem0*ADD_mem[1]
	S += (T2_1c1_a0b0*ADD[2])-1<T2_101_mem0*ADD_mem[2]
	S += (T2_1c1_a0b0*ADD[3])-1<T2_101_mem0*ADD_mem[3]
	S += T2_101_mem0<=T2_101

	T2_101_mem1 = S.Task('T2_101_mem1', length=1, delay_cost=1)
	T2_101_mem1 += ADD_mem[2]
	S += T2_1s0_1<T2_101_mem1
	...
	T2_1t5_1_mem0 += alt(ADD_mem)
	S += (T2_1c1_a0b0*ADD[0])-1<T2_1t5_1_mem0*ADD_mem[0]
	S += (T2_1c1_a0b0*ADD[1])-1<T2_1t5_1_mem0*ADD_mem[1]
	S += (T2_1c1_a0b0*ADD[2])-1<T2_1t5_1_mem0*ADD_mem[2]
	S += (T2_1c1_a0b0*ADD[3])-1<T2_1t5_1_mem0*ADD_mem[3]
	S += T2_1t5_1_mem0<=T2_1t5_1

	T2_1t5_1_mem1 = S.Task('T2_1t5_1_mem1', length=1, delay_cost=1)
	T2_1t5_1_mem1 += ADD_mem[0]
	S += T2_1c1_a1b1<T2_1t5_1_mem1
	S += T2_1t5_1_mem1<=T2_1t5_1
	...
	S += (T2_1c0_t2t3*ADD[0])-1<T2_110_mem0*ADD_mem[0]
	S += (T2_1c0_t2t3*ADD[1])-1<T2_110_mem0*ADD_mem[1]
	S += (T2_1c0_t2t3*ADD[2])-1<T2_110_mem0*ADD_mem[2]
	S += (T2_1c0_t2t3*ADD[3])-1<T2_110_mem0*ADD_mem[3]
	S += T2_110_mem0<=T2_110

	T2_110_mem1 = S.Task('T2_110_mem1', length=1, delay_cost=1)
	T2_110_mem1 += alt(ADD_mem)
	S += (T2_1t5_0*ADD[0])-1<T2_110_mem1*ADD_mem[0]
	S += (T2_1t5_0*ADD[1])-1<T2_110_mem1*ADD_mem[1]
	S += (T2_1t5_0*ADD[2])-1<T2_110_mem1*ADD_mem[2]
	S += (T2_1t5_0*ADD[3])-1<T2_110_mem1*ADD_mem[3]
	...
	T3_1c1_t2t3_mem0 += alt(MUL_mem)
	S += (T3_1t4_t2t3*MUL[0])-1<T3_1c1_t2t3_mem0*MUL_mem[0]
	S += T3_1c1_t2t3_mem0<=T3_1c1_t2t3

	T3_1c1_t2t3_mem1 = S.Task('T3_1c1_t2t3_mem1', length=1, delay_cost=1)
	T3_1c1_t2t3_mem1 += alt(ADD_mem)
	S += (T3_1t6_t2t3*ADD[0])-1<T3_1c1_t2t3_mem1*ADD_mem[0]
	S += (T3_1t6_t2t3*ADD[1])-1<T3_1c1_t2t3_mem1*ADD_mem[1]
	S += (T3_1t6_t2t3*ADD[2])-1<T3_1c1_t2t3_mem1*ADD_mem[2]
	S += (T3_1t6_t2t3*ADD[3])-1<T3_1c1_t2t3_mem1*ADD_mem[3]
	S += T3_1c1_t2t3_mem1<=T3_1c1_t2t3
	...
	S += (T3_1c1_a0b0*ADD[0])-1<T3_101_mem0*ADD_mem[0]
	S += (T3_1c1_a0b0*ADD[1])-1<T3_101_mem0*ADD_mem[1]
	S += (T3_1c1_a0b0*ADD[2])-1<T3_101_mem0*ADD_mem[2]
	S += (T3_1c1_a0b0*ADD[3])-1<T3_101_mem0*ADD_mem[3]
	S += T3_101_mem0<=T3_101

	T3_101_mem1 = S.Task('T3_101_mem1', length=1, delay_cost=1)
	T3_101_mem1 += ADD_mem[3]
	S += T3_1s0_1<T3_101_mem1
	...
	T3_1t5_1_mem0 += alt(ADD_mem)
	S += (T3_1c1_a0b0*ADD[0])-1<T3_1t5_1_mem0*ADD_mem[0]
	S += (T3_1c1_a0b0*ADD[1])-1<T3_1t5_1_mem0*ADD_mem[1]
	S += (T3_1c1_a0b0*ADD[2])-1<T3_1t5_1_mem0*ADD_mem[2]
	S += (T3_1c1_a0b0*ADD[3])-1<T3_1t5_1_mem0*ADD_mem[3]
	S += T3_1t5_1_mem0<=T3_1t5_1

	T3_1t5_1_mem1 = S.Task('T3_1t5_1_mem1', length=1, delay_cost=1)
	T3_1t5_1_mem1 += ADD_mem[3]
	S += T3_1c1_a1b1<T3_1t5_1_mem1
	S += T3_1t5_1_mem1<=T3_1t5_1
	...
	S += (T3_1c0_t2t3*ADD[0])-1<T3_110_mem0*ADD_mem[0]
	S += (T3_1c0_t2t3*ADD[1])-1<T3_110_mem0*ADD_mem[1]
	S += (T3_1c0_t2t3*ADD[2])-1<T3_110_mem0*ADD_mem[2]
	S += (T3_1c0_t2t3*ADD[3])-1<T3_110_mem0*ADD_mem[3]
	S += T3_110_mem0<=T3_110

	T3_110_mem1 = S.Task('T3_110_mem1', length=1, delay_cost=1)
	T3_110_mem1 += alt(ADD_mem)
	S += (T3_1t5_0*ADD[0])-1<T3_110_mem1*ADD_mem[0]
	S += (T3_1t5_0*ADD[1])-1<T3_110_mem1*ADD_mem[1]
	S += (T3_1t5_0*ADD[2])-1<T3_110_mem1*ADD_mem[2]
	S += (T3_1t5_0*ADD[3])-1<T3_110_mem1*ADD_mem[3]
	...
	S += (T2_100*ADD[0])-1<T3_200_mem0*ADD_mem[0]
	S += (T2_100*ADD[1])-1<T3_200_mem0*ADD_mem[1]
	S += (T2_100*ADD[2])-1<T3_200_mem0*ADD_mem[2]
	S += (T2_100*ADD[3])-1<T3_200_mem0*ADD_mem[3]
	S += T3_200_mem0<=T3_200

	T3_200_mem1 = S.Task('T3_200_mem1', length=1, delay_cost=1)
	T3_200_mem1 += alt(ADD_mem)
	S += (T3_100*ADD[0])-1<T3_200_mem1*ADD_mem[0]
	S += (T3_100*ADD[1])-1<T3_200_mem1*ADD_mem[1]
	S += (T3_100*ADD[2])-1<T3_200_mem1*ADD_mem[2]
	S += (T3_100*ADD[3])-1<T3_200_mem1*ADD_mem[3]
	...
	T6t0_a0b0_mem0 += alt(ADD_mem)
	S += (T2_100*ADD[0])-1<T6t0_a0b0_mem0*ADD_mem[0]
	S += (T2_100*ADD[1])-1<T6t0_a0b0_mem0*ADD_mem[1]
	S += (T2_100*ADD[2])-1<T6t0_a0b0_mem0*ADD_mem[2]
	S += (T2_100*ADD[3])-1<T6t0_a0b0_mem0*ADD_mem[3]
	...
	S += (T2_100*ADD[0])-1<TZ_newt0_a0b0_mem1*ADD_mem[0]
	S += (T2_100*ADD[1])-1<TZ_newt0_a0b0_mem1*ADD_mem[1]
	S += (T2_100*ADD[2])-1<TZ_newt0_a0b0_mem1*ADD_mem[2]
	S += (T2_100*ADD[3])-1<TZ_newt0_a0b0_mem1*ADD_mem[3]
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_7.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_7(0, 0)