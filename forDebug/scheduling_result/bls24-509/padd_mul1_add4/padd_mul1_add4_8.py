...
def solve_padd_mul1_add4_8(ConstStep, ExpStep):
	horizon = 189
	S=Scenario("padd_mul1_add4_8",horizon = horizon)
	...
	S += (T2_111*ADD[0])-1<T3_211_mem0*ADD_mem[0]
	S += (T2_111*ADD[1])-1<T3_211_mem0*ADD_mem[1]
	S += (T2_111*ADD[2])-1<T3_211_mem0*ADD_mem[2]
	S += (T2_111*ADD[3])-1<T3_211_mem0*ADD_mem[3]
	S += T3_211_mem0<=T3_211

	T3_211_mem1 = S.Task('T3_211_mem1', length=1, delay_cost=1)
	T3_211_mem1 += alt(ADD_mem)
	S += (T3_111*ADD[0])-1<T3_211_mem1*ADD_mem[0]
	S += (T3_111*ADD[1])-1<T3_211_mem1*ADD_mem[1]
	S += (T3_111*ADD[2])-1<T3_211_mem1*ADD_mem[2]
	S += (T3_111*ADD[3])-1<T3_211_mem1*ADD_mem[3]
	...
	T3_400_mem0 += alt(ADD_mem)
	S += (T3_300*ADD[0])-1<T3_400_mem0*ADD_mem[0]
	S += (T3_300*ADD[1])-1<T3_400_mem0*ADD_mem[1]
	S += (T3_300*ADD[2])-1<T3_400_mem0*ADD_mem[2]
	S += (T3_300*ADD[3])-1<T3_400_mem0*ADD_mem[3]
	...
	S += T2_101<T6t2_1_mem0
	S += T6t2_1_mem0<=T6t2_1

	T6t2_1_mem1 = S.Task('T6t2_1_mem1', length=1, delay_cost=1)
	T6t2_1_mem1 += alt(ADD_mem)
	S += (T2_111*ADD[0])-1<T6t2_1_mem1*ADD_mem[0]
	S += (T2_111*ADD[1])-1<T6t2_1_mem1*ADD_mem[1]
	S += (T2_111*ADD[2])-1<T6t2_1_mem1*ADD_mem[2]
	S += (T2_111*ADD[3])-1<T6t2_1_mem1*ADD_mem[3]
	...
	T6t4_a0b0_mem0 += alt(ADD_mem)
	S += (T6t2_a0b0*ADD[0])-1<T6t4_a0b0_mem0*ADD_mem[0]
	S += (T6t2_a0b0*ADD[1])-1<T6t4_a0b0_mem0*ADD_mem[1]
	S += (T6t2_a0b0*ADD[2])-1<T6t4_a0b0_mem0*ADD_mem[2]
	S += (T6t2_a0b0*ADD[3])-1<T6t4_a0b0_mem0*ADD_mem[3]
	S += T6t4_a0b0_mem0<=T6t4_a0b0

	T6t4_a0b0_mem1 = S.Task('T6t4_a0b0_mem1', length=1, delay_cost=1)
	T6t4_a0b0_mem1 += ADD_mem[0]
	S += T6t3_a0b0<T6t4_a0b0_mem1
	...
	S += T6t0_a0b0<T6c0_a0b0_mem0
	S += T6c0_a0b0_mem0<=T6c0_a0b0

	T6c0_a0b0_mem1 = S.Task('T6c0_a0b0_mem1', length=1, delay_cost=1)
	T6c0_a0b0_mem1 += alt(MUL_mem)
	S += (T6t1_a0b0*MUL[0])-1<T6c0_a0b0_mem1*MUL_mem[0]
	...
	S += T6t0_a0b0<T6t6_a0b0_mem0
	S += T6t6_a0b0_mem0<=T6t6_a0b0

	T6t6_a0b0_mem1 = S.Task('T6t6_a0b0_mem1', length=1, delay_cost=1)
	T6t6_a0b0_mem1 += alt(MUL_mem)
	S += (T6t1_a0b0*MUL[0])-1<T6t6_a0b0_mem1*MUL_mem[0]
	...
	T6t1_a1b1_mem0 += alt(ADD_mem)
	S += (T2_111*ADD[0])-1<T6t1_a1b1_mem0*ADD_mem[0]
	S += (T2_111*ADD[1])-1<T6t1_a1b1_mem0*ADD_mem[1]
	S += (T2_111*ADD[2])-1<T6t1_a1b1_mem0*ADD_mem[2]
	S += (T2_111*ADD[3])-1<T6t1_a1b1_mem0*ADD_mem[3]
	...
	S += T2_110<T6t2_a1b1_mem0
	S += T6t2_a1b1_mem0<=T6t2_a1b1

	T6t2_a1b1_mem1 = S.Task('T6t2_a1b1_mem1', length=1, delay_cost=1)
	T6t2_a1b1_mem1 += alt(ADD_mem)
	S += (T2_111*ADD[0])-1<T6t2_a1b1_mem1*ADD_mem[0]
	S += (T2_111*ADD[1])-1<T6t2_a1b1_mem1*ADD_mem[1]
	S += (T2_111*ADD[2])-1<T6t2_a1b1_mem1*ADD_mem[2]
	S += (T2_111*ADD[3])-1<T6t2_a1b1_mem1*ADD_mem[3]
	...
	T6t0_t2t3_mem0 += alt(ADD_mem)
	S += (T6t2_0*ADD[0])-1<T6t0_t2t3_mem0*ADD_mem[0]
	S += (T6t2_0*ADD[1])-1<T6t0_t2t3_mem0*ADD_mem[1]
	S += (T6t2_0*ADD[2])-1<T6t0_t2t3_mem0*ADD_mem[2]
	S += (T6t2_0*ADD[3])-1<T6t0_t2t3_mem0*ADD_mem[3]
	S += T6t0_t2t3_mem0<=T6t0_t2t3

	T6t0_t2t3_mem1 = S.Task('T6t0_t2t3_mem1', length=1, delay_cost=1)
	T6t0_t2t3_mem1 += ADD_mem[0]
	S += T6t3_0<T6t0_t2t3_mem1
	...
	S += T0t2_a0b0<TZ_newt4_a0b0_mem0
	...
	S += (T6t2_a0b0*ADD[0])-1<TZ_newt4_a0b0_mem1*ADD_mem[0]
	S += (T6t2_a0b0*ADD[1])-1<TZ_newt4_a0b0_mem1*ADD_mem[1]
	S += (T6t2_a0b0*ADD[2])-1<TZ_newt4_a0b0_mem1*ADD_mem[2]
	S += (T6t2_a0b0*ADD[3])-1<TZ_newt4_a0b0_mem1*ADD_mem[3]
	...
	S += TZ_newt0_a0b0<TZ_newc0_a0b0_mem0
	...
	S += TZ_newt0_a0b0<TZ_newt6_a0b0_mem0
	...
	S += (T2_111*ADD[0])-1<TZ_newt1_a1b1_mem1*ADD_mem[0]
	S += (T2_111*ADD[1])-1<TZ_newt1_a1b1_mem1*ADD_mem[1]
	S += (T2_111*ADD[2])-1<TZ_newt1_a1b1_mem1*ADD_mem[2]
	S += (T2_111*ADD[3])-1<TZ_newt1_a1b1_mem1*ADD_mem[3]
	...
	S += (T6t2_0*ADD[0])-1<TZ_newt0_t2t3_mem1*ADD_mem[0]
	S += (T6t2_0*ADD[1])-1<TZ_newt0_t2t3_mem1*ADD_mem[1]
	S += (T6t2_0*ADD[2])-1<TZ_newt0_t2t3_mem1*ADD_mem[2]
	S += (T6t2_0*ADD[3])-1<TZ_newt0_t2t3_mem1*ADD_mem[3]
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_8.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_8(0, 0)