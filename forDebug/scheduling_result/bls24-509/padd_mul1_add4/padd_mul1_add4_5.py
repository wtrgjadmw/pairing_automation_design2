...
def solve_padd_mul1_add4_5(ConstStep, ExpStep):
	horizon = 159
	S=Scenario("padd_mul1_add4_5",horizon = horizon)
	...
	S += T5t2_a1b1<T5t4_a1b1_mem0
	S += T5t4_a1b1_mem0<=T5t4_a1b1

	T5t4_a1b1_mem1 = S.Task('T5t4_a1b1_mem1', length=1, delay_cost=1)
	T5t4_a1b1_mem1 += alt(ADD_mem)
	S += (T5t3_a1b1*ADD[0])-1<T5t4_a1b1_mem1*ADD_mem[0]
	S += (T5t3_a1b1*ADD[1])-1<T5t4_a1b1_mem1*ADD_mem[1]
	S += (T5t3_a1b1*ADD[2])-1<T5t4_a1b1_mem1*ADD_mem[2]
	S += (T5t3_a1b1*ADD[3])-1<T5t4_a1b1_mem1*ADD_mem[3]
	...
	S += T5t0_a1b1<T5c0_a1b1_mem0
	S += T5c0_a1b1_mem0<=T5c0_a1b1

	T5c0_a1b1_mem1 = S.Task('T5c0_a1b1_mem1', length=1, delay_cost=1)
	T5c0_a1b1_mem1 += alt(MUL_mem)
	S += (T5t1_a1b1*MUL[0])-1<T5c0_a1b1_mem1*MUL_mem[0]
	...
	S += T5t0_a1b1<T5t6_a1b1_mem0
	S += T5t6_a1b1_mem0<=T5t6_a1b1

	T5t6_a1b1_mem1 = S.Task('T5t6_a1b1_mem1', length=1, delay_cost=1)
	T5t6_a1b1_mem1 += alt(MUL_mem)
	S += (T5t1_a1b1*MUL[0])-1<T5t6_a1b1_mem1*MUL_mem[0]
	S += T5t6_a1b1_mem1<=T5t6_a1b1

	T2_1t4_a1b1_in = S.Task('T2_1t4_a1b1_in', length=1, delay_cost=1)
	T2_1t4_a1b1_in += alt(MUL_in)
	T2_1t4_a1b1 = S.Task('T2_1t4_a1b1', length=7, delay_cost=1)
	T2_1t4_a1b1 += alt(MUL)
	S+=T2_1t4_a1b1>=T2_1t4_a1b1_in

	T2_1t4_a1b1_mem0 = S.Task('T2_1t4_a1b1_mem0', length=1, delay_cost=1)
	T2_1t4_a1b1_mem0 += alt(ADD_mem)
	S += (T5t3_a1b1*ADD[0])-1<T2_1t4_a1b1_mem0*ADD_mem[0]
	S += (T5t3_a1b1*ADD[1])-1<T2_1t4_a1b1_mem0*ADD_mem[1]
	S += (T5t3_a1b1*ADD[2])-1<T2_1t4_a1b1_mem0*ADD_mem[2]
	S += (T5t3_a1b1*ADD[3])-1<T2_1t4_a1b1_mem0*ADD_mem[3]
	S += T2_1t4_a1b1_mem0<=T2_1t4_a1b1

	T2_1t4_a1b1_mem1 = S.Task('T2_1t4_a1b1_mem1', length=1, delay_cost=1)
	T2_1t4_a1b1_mem1 += ADD_mem[2]
	S += T2a11_new<T2_1t4_a1b1_mem1
	S += T2_1t4_a1b1_mem1<=T2_1t4_a1b1
	...
	S += T2_1t0_a1b1<T2_1c0_a1b1_mem0
	S += T2_1c0_a1b1_mem0<=T2_1c0_a1b1

	T2_1c0_a1b1_mem1 = S.Task('T2_1c0_a1b1_mem1', length=1, delay_cost=1)
	T2_1c0_a1b1_mem1 += alt(MUL_mem)
	S += (T2_1t1_a1b1*MUL[0])-1<T2_1c0_a1b1_mem1*MUL_mem[0]
	S += T2_1c0_a1b1_mem1<=T2_1c0_a1b1
	...
	S += T2_1t0_a1b1<T2_1t6_a1b1_mem0
	S += T2_1t6_a1b1_mem0<=T2_1t6_a1b1

	T2_1t6_a1b1_mem1 = S.Task('T2_1t6_a1b1_mem1', length=1, delay_cost=1)
	T2_1t6_a1b1_mem1 += alt(MUL_mem)
	S += (T2_1t1_a1b1*MUL[0])-1<T2_1t6_a1b1_mem1*MUL_mem[0]
	S += T2_1t6_a1b1_mem1<=T2_1t6_a1b1
	...
	S += (T3t50*ADD[0])-1<T300_mem1*ADD_mem[0]
	S += (T3t50*ADD[1])-1<T300_mem1*ADD_mem[1]
	S += (T3t50*ADD[2])-1<T300_mem1*ADD_mem[2]
	S += (T3t50*ADD[3])-1<T300_mem1*ADD_mem[3]
	S += T300_mem1<=T300
	...
	S += (T3c1_t0t1*ADD[0])-1<T301_mem0*ADD_mem[0]
	S += (T3c1_t0t1*ADD[1])-1<T301_mem0*ADD_mem[1]
	S += (T3c1_t0t1*ADD[2])-1<T301_mem0*ADD_mem[2]
	S += (T3c1_t0t1*ADD[3])-1<T301_mem0*ADD_mem[3]
	S += T301_mem0<=T301

	T301_mem1 = S.Task('T301_mem1', length=1, delay_cost=1)
	T301_mem1 += alt(ADD_mem)
	S += (T3t51*ADD[0])-1<T301_mem1*ADD_mem[0]
	S += (T3t51*ADD[1])-1<T301_mem1*ADD_mem[1]
	S += (T3t51*ADD[2])-1<T301_mem1*ADD_mem[2]
	S += (T3t51*ADD[3])-1<T301_mem1*ADD_mem[3]
	S += T301_mem1<=T301
	...
	T3_1t4_a1b1_mem0 += alt(ADD_mem)
	S += (T3_1t2_a1b1*ADD[0])-1<T3_1t4_a1b1_mem0*ADD_mem[0]
	S += (T3_1t2_a1b1*ADD[1])-1<T3_1t4_a1b1_mem0*ADD_mem[1]
	S += (T3_1t2_a1b1*ADD[2])-1<T3_1t4_a1b1_mem0*ADD_mem[2]
	S += (T3_1t2_a1b1*ADD[3])-1<T3_1t4_a1b1_mem0*ADD_mem[3]
	S += T3_1t4_a1b1_mem0<=T3_1t4_a1b1

	T3_1t4_a1b1_mem1 = S.Task('T3_1t4_a1b1_mem1', length=1, delay_cost=1)
	T3_1t4_a1b1_mem1 += ADD_mem[2]
	S += T0t2_a1b1<T3_1t4_a1b1_mem1
	...
	T3_1c0_a1b1_mem1 += alt(MUL_mem)
	S += (T3_1t1_a1b1*MUL[0])-1<T3_1c0_a1b1_mem1*MUL_mem[0]
	...
	T3_1t6_a1b1_mem1 += alt(MUL_mem)
	S += (T3_1t1_a1b1*MUL[0])-1<T3_1t6_a1b1_mem1*MUL_mem[0]
	...
	S += (T411*ADD[0])-1<T4_111_mem0*ADD_mem[0]
	S += (T411*ADD[1])-1<T4_111_mem0*ADD_mem[1]
	S += (T411*ADD[2])-1<T4_111_mem0*ADD_mem[2]
	S += (T411*ADD[3])-1<T4_111_mem0*ADD_mem[3]
	S += T4_111_mem0<=T4_111

	T4_111_mem1 = S.Task('T4_111_mem1', length=1, delay_cost=1)
	T4_111_mem1 += alt(ADD_mem)
	S += (T2_211*ADD[0])-1<T4_111_mem1*ADD_mem[0]
	S += (T2_211*ADD[1])-1<T4_111_mem1*ADD_mem[1]
	S += (T2_211*ADD[2])-1<T4_111_mem1*ADD_mem[2]
	S += (T2_211*ADD[3])-1<T4_111_mem1*ADD_mem[3]
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_5.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_5(0, 0)