...
def solve_padd_mul1_add4_9(ConstStep, ExpStep):
	horizon = 201
	S=Scenario("padd_mul1_add4_9",horizon = horizon)
	...
	S += TZ_newt4_a0b0<TZ_newc1_a0b0_mem0
	...
	S += TZ_newt6_a0b0<TZ_newc1_a0b0_mem1
	...
	S += T0t2_a1b1<TZ_newt4_a1b1_mem0
	...
	S += T6t2_a1b1<TZ_newt4_a1b1_mem1
	...
	S += TZ_newt0_a1b1<TZ_newc0_a1b1_mem0
	...
	S += TZ_newt1_a1b1<TZ_newc0_a1b1_mem1
	...
	S += TZ_newt0_a1b1<TZ_newt6_a1b1_mem0
	...
	S += TZ_newt1_a1b1<TZ_newt6_a1b1_mem1
	...
	T3_411_mem0 += alt(ADD_mem)
	S += (T3_311*ADD[0])-1<T3_411_mem0*ADD_mem[0]
	S += (T3_311*ADD[1])-1<T3_411_mem0*ADD_mem[1]
	S += (T3_311*ADD[2])-1<T3_411_mem0*ADD_mem[2]
	S += (T3_311*ADD[3])-1<T3_411_mem0*ADD_mem[3]
	...
	S += (T3_401*ADD[0])-1<T5_101_mem1*ADD_mem[0]
	S += (T3_401*ADD[1])-1<T5_101_mem1*ADD_mem[1]
	S += (T3_401*ADD[2])-1<T5_101_mem1*ADD_mem[2]
	S += (T3_401*ADD[3])-1<T5_101_mem1*ADD_mem[3]
	...
	S += (T3_410*ADD[0])-1<T5_110_mem1*ADD_mem[0]
	S += (T3_410*ADD[1])-1<T5_110_mem1*ADD_mem[1]
	S += (T3_410*ADD[2])-1<T5_110_mem1*ADD_mem[2]
	S += (T3_410*ADD[3])-1<T5_110_mem1*ADD_mem[3]
	...
	S += T1_100<T1_2t0_a0b0_mem0
	S += T1_2t0_a0b0_mem0<=T1_2t0_a0b0

	T1_2t0_a0b0_mem1 = S.Task('T1_2t0_a0b0_mem1', length=1, delay_cost=1)
	T1_2t0_a0b0_mem1 += alt(ADD_mem)
	S += (T5_100*ADD[0])-1<T1_2t0_a0b0_mem1*ADD_mem[0]
	S += (T5_100*ADD[1])-1<T1_2t0_a0b0_mem1*ADD_mem[1]
	S += (T5_100*ADD[2])-1<T1_2t0_a0b0_mem1*ADD_mem[2]
	S += (T5_100*ADD[3])-1<T1_2t0_a0b0_mem1*ADD_mem[3]
	...
	T6c1_a1b1_mem0 += alt(MUL_mem)
	S += (T6t4_a1b1*MUL[0])-1<T6c1_a1b1_mem0*MUL_mem[0]
	S += T6c1_a1b1_mem0<=T6c1_a1b1

	T6c1_a1b1_mem1 = S.Task('T6c1_a1b1_mem1', length=1, delay_cost=1)
	T6c1_a1b1_mem1 += alt(ADD_mem)
	S += (T6t6_a1b1*ADD[0])-1<T6c1_a1b1_mem1*ADD_mem[0]
	S += (T6t6_a1b1*ADD[1])-1<T6c1_a1b1_mem1*ADD_mem[1]
	S += (T6t6_a1b1*ADD[2])-1<T6c1_a1b1_mem1*ADD_mem[2]
	S += (T6t6_a1b1*ADD[3])-1<T6c1_a1b1_mem1*ADD_mem[3]
	...
	T6t4_t2t3_mem0 += alt(ADD_mem)
	S += (T6t2_t2t3*ADD[0])-1<T6t4_t2t3_mem0*ADD_mem[0]
	S += (T6t2_t2t3*ADD[1])-1<T6t4_t2t3_mem0*ADD_mem[1]
	S += (T6t2_t2t3*ADD[2])-1<T6t4_t2t3_mem0*ADD_mem[2]
	S += (T6t2_t2t3*ADD[3])-1<T6t4_t2t3_mem0*ADD_mem[3]
	S += T6t4_t2t3_mem0<=T6t4_t2t3

	T6t4_t2t3_mem1 = S.Task('T6t4_t2t3_mem1', length=1, delay_cost=1)
	T6t4_t2t3_mem1 += ADD_mem[1]
	S += T6t3_t2t3<T6t4_t2t3_mem1
	...
	S += T6t0_t2t3<T6c0_t2t3_mem0
	S += T6c0_t2t3_mem0<=T6c0_t2t3

	T6c0_t2t3_mem1 = S.Task('T6c0_t2t3_mem1', length=1, delay_cost=1)
	T6c0_t2t3_mem1 += alt(MUL_mem)
	S += (T6t1_t2t3*MUL[0])-1<T6c0_t2t3_mem1*MUL_mem[0]
	...
	S += T6t0_t2t3<T6t6_t2t3_mem0
	S += T6t6_t2t3_mem0<=T6t6_t2t3

	T6t6_t2t3_mem1 = S.Task('T6t6_t2t3_mem1', length=1, delay_cost=1)
	T6t6_t2t3_mem1 += alt(MUL_mem)
	S += (T6t1_t2t3*MUL[0])-1<T6t6_t2t3_mem1*MUL_mem[0]
	...
	S += T6c0_a0b0<T6t5_0_mem0
	S += T6t5_0_mem0<=T6t5_0

	T6t5_0_mem1 = S.Task('T6t5_0_mem1', length=1, delay_cost=1)
	T6t5_0_mem1 += alt(ADD_mem)
	S += (T6c0_a1b1*ADD[0])-1<T6t5_0_mem1*ADD_mem[0]
	S += (T6c0_a1b1*ADD[1])-1<T6t5_0_mem1*ADD_mem[1]
	S += (T6c0_a1b1*ADD[2])-1<T6t5_0_mem1*ADD_mem[2]
	S += (T6c0_a1b1*ADD[3])-1<T6t5_0_mem1*ADD_mem[3]
	...
	S += T3_400<TX_newt3_0_mem0
	S += TX_newt3_0_mem0<=TX_newt3_0

	TX_newt3_0_mem1 = S.Task('TX_newt3_0_mem1', length=1, delay_cost=1)
	TX_newt3_0_mem1 += alt(ADD_mem)
	S += (T3_410*ADD[0])-1<TX_newt3_0_mem1*ADD_mem[0]
	S += (T3_410*ADD[1])-1<TX_newt3_0_mem1*ADD_mem[1]
	S += (T3_410*ADD[2])-1<TX_newt3_0_mem1*ADD_mem[2]
	S += (T3_410*ADD[3])-1<TX_newt3_0_mem1*ADD_mem[3]
	...
	S += (T3_401*ADD[0])-1<TX_newt1_a0b0_mem1*ADD_mem[0]
	S += (T3_401*ADD[1])-1<TX_newt1_a0b0_mem1*ADD_mem[1]
	S += (T3_401*ADD[2])-1<TX_newt1_a0b0_mem1*ADD_mem[2]
	S += (T3_401*ADD[3])-1<TX_newt1_a0b0_mem1*ADD_mem[3]
	...
	S += (T3_401*ADD[0])-1<TX_newt3_a0b0_mem1*ADD_mem[0]
	S += (T3_401*ADD[1])-1<TX_newt3_a0b0_mem1*ADD_mem[1]
	S += (T3_401*ADD[2])-1<TX_newt3_a0b0_mem1*ADD_mem[2]
	S += (T3_401*ADD[3])-1<TX_newt3_a0b0_mem1*ADD_mem[3]
	...
	S += (T3_410*ADD[0])-1<TX_newt0_a1b1_mem1*ADD_mem[0]
	S += (T3_410*ADD[1])-1<TX_newt0_a1b1_mem1*ADD_mem[1]
	S += (T3_410*ADD[2])-1<TX_newt0_a1b1_mem1*ADD_mem[2]
	S += (T3_410*ADD[3])-1<TX_newt0_a1b1_mem1*ADD_mem[3]
	...
	S += T0t2_t2t3<TZ_newt4_t2t3_mem0
	...
	S += (T6t2_t2t3*ADD[0])-1<TZ_newt4_t2t3_mem1*ADD_mem[0]
	S += (T6t2_t2t3*ADD[1])-1<TZ_newt4_t2t3_mem1*ADD_mem[1]
	S += (T6t2_t2t3*ADD[2])-1<TZ_newt4_t2t3_mem1*ADD_mem[2]
	S += (T6t2_t2t3*ADD[3])-1<TZ_newt4_t2t3_mem1*ADD_mem[3]
	...
	S += TZ_newt0_t2t3<TZ_newc0_t2t3_mem0
	...
	S += TZ_newt0_t2t3<TZ_newt6_t2t3_mem0
	...
	S += TZ_newc0_a0b0<TZ_newt5_0_mem0
	...
	pic_file_name = "padd_mul1_add4/padd_mul1_add4_9.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_padd_mul1_add4_9(0, 0)