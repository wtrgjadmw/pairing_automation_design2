...
def solve_pdbl_mul1_add4_7(ConstStep, ExpStep):
	horizon = 119
	S=Scenario("pdbl_mul1_add4_7",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_7.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_7(0, 0)