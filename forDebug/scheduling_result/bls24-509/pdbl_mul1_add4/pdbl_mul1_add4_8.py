...
def solve_pdbl_mul1_add4_8(ConstStep, ExpStep):
	horizon = 126
	S=Scenario("pdbl_mul1_add4_8",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_8.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_8(0, 0)