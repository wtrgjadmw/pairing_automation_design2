...
def solve_pdbl_mul1_add4_3(ConstStep, ExpStep):
	horizon = 98
	S=Scenario("pdbl_mul1_add4_3",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_3.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_3(0, 0)