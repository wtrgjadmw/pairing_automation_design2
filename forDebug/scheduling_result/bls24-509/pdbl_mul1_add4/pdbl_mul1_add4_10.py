...
def solve_pdbl_mul1_add4_10(ConstStep, ExpStep):
	horizon = 138
	S=Scenario("pdbl_mul1_add4_10",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_10.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_10(0, 0)