...
def solve_pdbl_mul1_add4_6(ConstStep, ExpStep):
	horizon = 113
	S=Scenario("pdbl_mul1_add4_6",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_6.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_6(0, 0)