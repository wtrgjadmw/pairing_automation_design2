...
def solve_pdbl_mul1_add4_9(ConstStep, ExpStep):
	horizon = 131
	S=Scenario("pdbl_mul1_add4_9",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_9.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_9(0, 0)