...
def solve_pdbl_mul1_add4_4(ConstStep, ExpStep):
	horizon = 100
	S=Scenario("pdbl_mul1_add4_4",horizon = horizon)
	...
	pic_file_name = "pdbl_mul1_add4/pdbl_mul1_add4_4.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_pdbl_mul1_add4_4(0, 0)