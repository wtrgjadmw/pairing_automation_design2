...
def solve_s24_mul1_add4_3(ConstStep, ExpStep):
	horizon = 211
	S=Scenario("s24_mul1_add4_3",horizon = horizon)
	...
	T12t4_a0b0_in += alt(MUL_in)
	T12t4_a0b0 = S.Task('T12t4_a0b0', length=7, delay_cost=1)
	T12t4_a0b0 += alt(MUL)
	S+=T12t4_a0b0>=T12t4_a0b0_in
	...
	T12t4_a1b1_in += alt(MUL_in)
	T12t4_a1b1 = S.Task('T12t4_a1b1', length=7, delay_cost=1)
	T12t4_a1b1 += alt(MUL)
	S+=T12t4_a1b1>=T12t4_a1b1_in
	...
	T95t4_t2t3_in += alt(MUL_in)
	T95t4_t2t3 = S.Task('T95t4_t2t3', length=7, delay_cost=1)
	T95t4_t2t3 += alt(MUL)
	S+=T95t4_t2t3>=T95t4_t2t3_in
	...
	T32t4_t2t3_in += alt(MUL_in)
	T32t4_t2t3 = S.Task('T32t4_t2t3', length=7, delay_cost=1)
	T32t4_t2t3 += alt(MUL)
	S+=T32t4_t2t3>=T32t4_t2t3_in
	...
	T44t4_t2t3_in += alt(MUL_in)
	T44t4_t2t3 = S.Task('T44t4_t2t3', length=7, delay_cost=1)
	T44t4_t2t3 += alt(MUL)
	S+=T44t4_t2t3>=T44t4_t2t3_in
	...
	S += 100<T6t2_t2t3_mem0
	S += T6t2_t2t3_mem0<=T6t2_t2t3

	T6t2_t2t3_mem1 = S.Task('T6t2_t2t3_mem1', length=1, delay_cost=1)
	T6t2_t2t3_mem1 += ADD_mem[0]
	S += 118<T6t2_t2t3_mem1
	S += T6t2_t2t3_mem1<=T6t2_t2t3
	...
	pic_file_name = "s24_mul1_add4/s24_mul1_add4_3.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_s24_mul1_add4_3(0, 0)