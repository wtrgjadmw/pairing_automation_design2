...
def solve_s24_mul1_add4_6(ConstStep, ExpStep):
	horizon = 244
	S=Scenario("s24_mul1_add4_6",horizon = horizon)
	...
	S += 152<T91c1_t2t3_mem0
	S += T91c1_t2t3_mem0<=T91c1_t2t3

	T91c1_t2t3_mem1 = S.Task('T91c1_t2t3_mem1', length=1, delay_cost=1)
	T91c1_t2t3_mem1 += ADD_mem[3]
	S += 146<T91c1_t2t3_mem1
	S += T91c1_t2t3_mem1<=T91c1_t2t3
	...
	S += 146<T22c1_t2t3_mem0
	S += T22c1_t2t3_mem0<=T22c1_t2t3

	T22c1_t2t3_mem1 = S.Task('T22c1_t2t3_mem1', length=1, delay_cost=1)
	T22c1_t2t3_mem1 += ADD_mem[1]
	S += 143<T22c1_t2t3_mem1
	S += T22c1_t2t3_mem1<=T22c1_t2t3
	...
	pic_file_name = "s24_mul1_add4/s24_mul1_add4_6.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_s24_mul1_add4_6(0, 0)