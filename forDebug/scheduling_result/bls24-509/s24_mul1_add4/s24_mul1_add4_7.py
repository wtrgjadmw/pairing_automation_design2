...
def solve_s24_mul1_add4_7(ConstStep, ExpStep):
	horizon = 252
	S=Scenario("s24_mul1_add4_7",horizon = horizon)
	...
	pic_file_name = "s24_mul1_add4/s24_mul1_add4_7.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_s24_mul1_add4_7(0, 0)