...
def solve_s24_mul1_add4_5(ConstStep, ExpStep):
	horizon = 231
	S=Scenario("s24_mul1_add4_5",horizon = horizon)
	...
	T91t4_t2t3_in += alt(MUL_in)
	T91t4_t2t3 = S.Task('T91t4_t2t3', length=7, delay_cost=1)
	T91t4_t2t3 += alt(MUL)
	S+=T91t4_t2t3>=T91t4_t2t3_in
	...
	T22t4_t2t3_in += alt(MUL_in)
	T22t4_t2t3 = S.Task('T22t4_t2t3', length=7, delay_cost=1)
	T22t4_t2t3 += alt(MUL)
	S+=T22t4_t2t3>=T22t4_t2t3_in
	...
	pic_file_name = "s24_mul1_add4/s24_mul1_add4_5.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_s24_mul1_add4_5(0, 0)