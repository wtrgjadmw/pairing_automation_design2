...
def solve_s24_mul1_add4_9(ConstStep, ExpStep):
	horizon = 261
	S=Scenario("s24_mul1_add4_9",horizon = horizon)
	...
	# new tasks
	T9311 = S.Task('T9311', length=1, delay_cost=1)
	T9311 += alt(ADD)
	...
	T3600 = S.Task('T3600', length=1, delay_cost=1)
	T3600 += alt(ADD)

	T3601 = S.Task('T3601', length=1, delay_cost=1)
	T3601 += alt(ADD)

	T6200 = S.Task('T6200', length=1, delay_cost=1)
	T6200 += alt(ADD)

	T6201 = S.Task('T6201', length=1, delay_cost=1)
	T6201 += alt(ADD)

	T6310 = S.Task('T6310', length=1, delay_cost=1)
	T6310 += alt(ADD)

	T6311 = S.Task('T6311', length=1, delay_cost=1)
	T6311 += alt(ADD)

	T7210 = S.Task('T7210', length=1, delay_cost=1)
	T7210 += alt(ADD)

	T7211 = S.Task('T7211', length=1, delay_cost=1)
	T7211 += alt(ADD)

	T8400 = S.Task('T8400', length=1, delay_cost=1)
	T8400 += alt(ADD)

	T8401 = S.Task('T8401', length=1, delay_cost=1)
	T8401 += alt(ADD)

	T8411 = S.Task('T8411', length=1, delay_cost=1)
	T8411 += alt(ADD)
	...
	T6300 = S.Task('T6300', length=1, delay_cost=1)
	T6300 += alt(ADD)

	T6301 = S.Task('T6301', length=1, delay_cost=1)
	T6301 += alt(ADD)

	T7200 = S.Task('T7200', length=1, delay_cost=1)
	T7200 += alt(ADD)

	T7201 = S.Task('T7201', length=1, delay_cost=1)
	T7201 += alt(ADD)
	...
	S += 164 < C1211_in
	S += C1211-1 <= C1211_in
	T9311_mem0 = S.Task('T9311_mem0', length=1, delay_cost=1)
	T9311_mem0 += ADD_mem[1]
	S += 169<T9311_mem0
	S += T9311_mem0<=T9311

	T9311_mem1 = S.Task('T9311_mem1', length=1, delay_cost=1)
	T9311_mem1 += ADD_mem[3]
	S += 129<T9311_mem1
	S += T9311_mem1<=T9311
	...
	T2500_mem0 += ADD_mem[3]
	S += 116<T2500_mem0
	S += T2500_mem0<=T2500

	T2500_mem1 = S.Task('T2500_mem1', length=1, delay_cost=1)
	T2500_mem1 += ADD_mem[1]
	S += 160<T2500_mem1
	S += T2500_mem1<=T2500

	T2501_mem0 = S.Task('T2501_mem0', length=1, delay_cost=1)
	T2501_mem0 += ADD_mem[1]
	S += 114<T2501_mem0
	S += T2501_mem0<=T2501

	T2501_mem1 = S.Task('T2501_mem1', length=1, delay_cost=1)
	T2501_mem1 += ADD_mem[1]
	S += 158<T2501_mem1
	S += T2501_mem1<=T2501

	T2510_mem0 = S.Task('T2510_mem0', length=1, delay_cost=1)
	T2510_mem0 += ADD_mem[3]
	S += 121<T2510_mem0
	S += T2510_mem0<=T2510

	T2510_mem1 = S.Task('T2510_mem1', length=1, delay_cost=1)
	T2510_mem1 += ADD_mem[1]
	S += 152<T2510_mem1
	S += T2510_mem1<=T2510

	T3600_mem0 = S.Task('T3600_mem0', length=1, delay_cost=1)
	T3600_mem0 += ADD_mem[3]
	S += 64<T3600_mem0
	S += T3600_mem0<=T3600

	T3600_mem1 = S.Task('T3600_mem1', length=1, delay_cost=1)
	T3600_mem1 += ADD_mem[1]
	S += 167<T3600_mem1
	S += T3600_mem1<=T3600

	T3601_mem0 = S.Task('T3601_mem0', length=1, delay_cost=1)
	T3601_mem0 += ADD_mem[0]
	S += 97<T3601_mem0
	S += T3601_mem0<=T3601

	T3601_mem1 = S.Task('T3601_mem1', length=1, delay_cost=1)
	T3601_mem1 += ADD_mem[3]
	S += 165<T3601_mem1
	S += T3601_mem1<=T3601

	T6200_mem0 = S.Task('T6200_mem0', length=1, delay_cost=1)
	T6200_mem0 += ADD_mem[2]
	S += 164<T6200_mem0
	S += T6200_mem0<=T6200

	T6200_mem1 = S.Task('T6200_mem1', length=1, delay_cost=1)
	T6200_mem1 += ADD_mem[3]
	S += 168<T6200_mem1
	S += T6200_mem1<=T6200

	T6201_mem0 = S.Task('T6201_mem0', length=1, delay_cost=1)
	T6201_mem0 += ADD_mem[2]
	S += 164<T6201_mem0
	S += T6201_mem0<=T6201

	T6201_mem1 = S.Task('T6201_mem1', length=1, delay_cost=1)
	T6201_mem1 += ADD_mem[3]
	S += 168<T6201_mem1
	S += T6201_mem1<=T6201

	T6310_mem0 = S.Task('T6310_mem0', length=1, delay_cost=1)
	T6310_mem0 += ADD_mem[3]
	S += 166<T6310_mem0
	S += T6310_mem0<=T6310

	T6310_mem1 = S.Task('T6310_mem1', length=1, delay_cost=1)
	T6310_mem1 += ADD_mem[0]
	S += 147<T6310_mem1
	S += T6310_mem1<=T6310

	T6311_mem0 = S.Task('T6311_mem0', length=1, delay_cost=1)
	T6311_mem0 += ADD_mem[3]
	S += 153<T6311_mem0
	S += T6311_mem0<=T6311

	T6311_mem1 = S.Task('T6311_mem1', length=1, delay_cost=1)
	T6311_mem1 += ADD_mem[2]
	S += 168<T6311_mem1
	S += T6311_mem1<=T6311

	T7210_mem0 = S.Task('T7210_mem0', length=1, delay_cost=1)
	T7210_mem0 += ADD_mem[1]
	S += 159<T7210_mem0
	S += T7210_mem0<=T7210

	T7210_mem1 = S.Task('T7210_mem1', length=1, delay_cost=1)
	T7210_mem1 += ADD_mem[3]
	S += 166<T7210_mem1
	S += T7210_mem1<=T7210

	T7211_mem0 = S.Task('T7211_mem0', length=1, delay_cost=1)
	T7211_mem0 += ADD_mem[2]
	S += 165<T7211_mem0
	S += T7211_mem0<=T7211

	T7211_mem1 = S.Task('T7211_mem1', length=1, delay_cost=1)
	T7211_mem1 += ADD_mem[3]
	S += 153<T7211_mem1
	S += T7211_mem1<=T7211

	T8400_mem0 = S.Task('T8400_mem0', length=1, delay_cost=1)
	T8400_mem0 += ADD_mem[0]
	S += 147<T8400_mem0
	S += T8400_mem0<=T8400

	T8400_mem1 = S.Task('T8400_mem1', length=1, delay_cost=1)
	T8400_mem1 += ADD_mem[0]
	S += 146<T8400_mem1
	S += T8400_mem1<=T8400

	T8401_mem0 = S.Task('T8401_mem0', length=1, delay_cost=1)
	T8401_mem0 += ADD_mem[2]
	S += 168<T8401_mem0
	S += T8401_mem0<=T8401

	T8401_mem1 = S.Task('T8401_mem1', length=1, delay_cost=1)
	T8401_mem1 += ADD_mem[1]
	S += 161<T8401_mem1
	S += T8401_mem1<=T8401

	T8411_mem0 = S.Task('T8411_mem0', length=1, delay_cost=1)
	T8411_mem0 += ADD_mem[3]
	S += 168<T8411_mem0
	S += T8411_mem0<=T8411

	T8411_mem1 = S.Task('T8411_mem1', length=1, delay_cost=1)
	T8411_mem1 += ADD_mem[2]
	S += 165<T8411_mem1
	S += T8411_mem1<=T8411

	T0200_mem0 = S.Task('T0200_mem0', length=1, delay_cost=1)
	T0200_mem0 += ADD_mem[3]
	S += 152<T0200_mem0
	S += T0200_mem0<=T0200

	T0200_mem1 = S.Task('T0200_mem1', length=1, delay_cost=1)
	T0200_mem1 += alt(ADD_mem)
	S += (T1500*ADD[0])-1<T0200_mem1*ADD_mem[0]
	S += (T1500*ADD[1])-1<T0200_mem1*ADD_mem[1]
	S += (T1500*ADD[2])-1<T0200_mem1*ADD_mem[2]
	S += (T1500*ADD[3])-1<T0200_mem1*ADD_mem[3]
	S += T0200_mem1<=T0200

	T0201_mem0 = S.Task('T0201_mem0', length=1, delay_cost=1)
	T0201_mem0 += ADD_mem[2]
	S += 132<T0201_mem0
	S += T0201_mem0<=T0201

	T0201_mem1 = S.Task('T0201_mem1', length=1, delay_cost=1)
	T0201_mem1 += alt(ADD_mem)
	S += (T1501*ADD[0])-1<T0201_mem1*ADD_mem[0]
	S += (T1501*ADD[1])-1<T0201_mem1*ADD_mem[1]
	S += (T1501*ADD[2])-1<T0201_mem1*ADD_mem[2]
	S += (T1501*ADD[3])-1<T0201_mem1*ADD_mem[3]
	S += T0201_mem1<=T0201

	T1611_mem0 = S.Task('T1611_mem0', length=1, delay_cost=1)
	T1611_mem0 += alt(ADD_mem)
	S += (T9311*ADD[0])-1<T1611_mem0*ADD_mem[0]
	S += (T9311*ADD[1])-1<T1611_mem0*ADD_mem[1]
	S += (T9311*ADD[2])-1<T1611_mem0*ADD_mem[2]
	S += (T9311*ADD[3])-1<T1611_mem0*ADD_mem[3]
	S += T1611_mem0<=T1611
	...
	T6300_mem0 = S.Task('T6300_mem0', length=1, delay_cost=1)
	T6300_mem0 += alt(ADD_mem)
	S += (T3600*ADD[0])-1<T6300_mem0*ADD_mem[0]
	S += (T3600*ADD[1])-1<T6300_mem0*ADD_mem[1]
	S += (T3600*ADD[2])-1<T6300_mem0*ADD_mem[2]
	S += (T3600*ADD[3])-1<T6300_mem0*ADD_mem[3]
	S += T6300_mem0<=T6300

	T6300_mem1 = S.Task('T6300_mem1', length=1, delay_cost=1)
	T6300_mem1 += alt(ADD_mem)
	S += (T6200*ADD[0])-1<T6300_mem1*ADD_mem[0]
	S += (T6200*ADD[1])-1<T6300_mem1*ADD_mem[1]
	S += (T6200*ADD[2])-1<T6300_mem1*ADD_mem[2]
	S += (T6200*ADD[3])-1<T6300_mem1*ADD_mem[3]
	S += T6300_mem1<=T6300

	T6301_mem0 = S.Task('T6301_mem0', length=1, delay_cost=1)
	T6301_mem0 += alt(ADD_mem)
	S += (T3601*ADD[0])-1<T6301_mem0*ADD_mem[0]
	S += (T3601*ADD[1])-1<T6301_mem0*ADD_mem[1]
	S += (T3601*ADD[2])-1<T6301_mem0*ADD_mem[2]
	S += (T3601*ADD[3])-1<T6301_mem0*ADD_mem[3]
	S += T6301_mem0<=T6301

	T6301_mem1 = S.Task('T6301_mem1', length=1, delay_cost=1)
	T6301_mem1 += alt(ADD_mem)
	S += (T6201*ADD[0])-1<T6301_mem1*ADD_mem[0]
	S += (T6201*ADD[1])-1<T6301_mem1*ADD_mem[1]
	S += (T6201*ADD[2])-1<T6301_mem1*ADD_mem[2]
	S += (T6201*ADD[3])-1<T6301_mem1*ADD_mem[3]
	S += T6301_mem1<=T6301

	T7200_mem0 = S.Task('T7200_mem0', length=1, delay_cost=1)
	T7200_mem0 += ADD_mem[0]
	S += 146<T7200_mem0
	S += T7200_mem0<=T7200

	T7200_mem1 = S.Task('T7200_mem1', length=1, delay_cost=1)
	T7200_mem1 += alt(ADD_mem)
	S += (T3600*ADD[0])-1<T7200_mem1*ADD_mem[0]
	S += (T3600*ADD[1])-1<T7200_mem1*ADD_mem[1]
	S += (T3600*ADD[2])-1<T7200_mem1*ADD_mem[2]
	S += (T3600*ADD[3])-1<T7200_mem1*ADD_mem[3]
	S += T7200_mem1<=T7200

	T7201_mem0 = S.Task('T7201_mem0', length=1, delay_cost=1)
	T7201_mem0 += ADD_mem[1]
	S += 161<T7201_mem0
	S += T7201_mem0<=T7201

	T7201_mem1 = S.Task('T7201_mem1', length=1, delay_cost=1)
	T7201_mem1 += alt(ADD_mem)
	S += (T3601*ADD[0])-1<T7201_mem1*ADD_mem[0]
	S += (T3601*ADD[1])-1<T7201_mem1*ADD_mem[1]
	S += (T3601*ADD[2])-1<T7201_mem1*ADD_mem[2]
	S += (T3601*ADD[3])-1<T7201_mem1*ADD_mem[3]
	S += T7201_mem1<=T7201
	...
	S += (T0210*ADD[0])-1<C0010_mem0*ADD_mem[0]
	S += (T0210*ADD[1])-1<C0010_mem0*ADD_mem[1]
	S += (T0210*ADD[2])-1<C0010_mem0*ADD_mem[2]
	S += (T0210*ADD[3])-1<C0010_mem0*ADD_mem[3]
	S += C0010_mem0<=C0010

	C0010_mem1 = S.Task('C0010_mem1', length=1, delay_cost=1)
	C0010_mem1 += alt(ADD_mem)
	S += (T6310*ADD[0])-1<C0010_mem1*ADD_mem[0]
	S += (T6310*ADD[1])-1<C0010_mem1*ADD_mem[1]
	S += (T6310*ADD[2])-1<C0010_mem1*ADD_mem[2]
	S += (T6310*ADD[3])-1<C0010_mem1*ADD_mem[3]
	S += C0010_mem1<=C0010

	C0011_mem0 = S.Task('C0011_mem0', length=1, delay_cost=1)
	C0011_mem0 += alt(ADD_mem)
	S += (T0211*ADD[0])-1<C0011_mem0*ADD_mem[0]
	S += (T0211*ADD[1])-1<C0011_mem0*ADD_mem[1]
	S += (T0211*ADD[2])-1<C0011_mem0*ADD_mem[2]
	S += (T0211*ADD[3])-1<C0011_mem0*ADD_mem[3]
	S += C0011_mem0<=C0011

	C0011_mem1 = S.Task('C0011_mem1', length=1, delay_cost=1)
	C0011_mem1 += alt(ADD_mem)
	S += (T6311*ADD[0])-1<C0011_mem1*ADD_mem[0]
	S += (T6311*ADD[1])-1<C0011_mem1*ADD_mem[1]
	S += (T6311*ADD[2])-1<C0011_mem1*ADD_mem[2]
	S += (T6311*ADD[3])-1<C0011_mem1*ADD_mem[3]
	S += C0011_mem1<=C0011

	C0110_mem0 = S.Task('C0110_mem0', length=1, delay_cost=1)
	C0110_mem0 += alt(ADD_mem)
	S += (T1610*ADD[0])-1<C0110_mem0*ADD_mem[0]
	S += (T1610*ADD[1])-1<C0110_mem0*ADD_mem[1]
	S += (T1610*ADD[2])-1<C0110_mem0*ADD_mem[2]
	S += (T1610*ADD[3])-1<C0110_mem0*ADD_mem[3]
	S += C0110_mem0<=C0110

	C0110_mem1 = S.Task('C0110_mem1', length=1, delay_cost=1)
	C0110_mem1 += alt(ADD_mem)
	S += (T7210*ADD[0])-1<C0110_mem1*ADD_mem[0]
	S += (T7210*ADD[1])-1<C0110_mem1*ADD_mem[1]
	S += (T7210*ADD[2])-1<C0110_mem1*ADD_mem[2]
	S += (T7210*ADD[3])-1<C0110_mem1*ADD_mem[3]
	S += C0110_mem1<=C0110

	C0200_mem0 = S.Task('C0200_mem0', length=1, delay_cost=1)
	C0200_mem0 += alt(ADD_mem)
	S += (T2500*ADD[0])-1<C0200_mem0*ADD_mem[0]
	S += (T2500*ADD[1])-1<C0200_mem0*ADD_mem[1]
	S += (T2500*ADD[2])-1<C0200_mem0*ADD_mem[2]
	S += (T2500*ADD[3])-1<C0200_mem0*ADD_mem[3]
	S += C0200_mem0<=C0200

	C0200_mem1 = S.Task('C0200_mem1', length=1, delay_cost=1)
	C0200_mem1 += alt(ADD_mem)
	S += (T8400*ADD[0])-1<C0200_mem1*ADD_mem[0]
	S += (T8400*ADD[1])-1<C0200_mem1*ADD_mem[1]
	S += (T8400*ADD[2])-1<C0200_mem1*ADD_mem[2]
	S += (T8400*ADD[3])-1<C0200_mem1*ADD_mem[3]
	S += C0200_mem1<=C0200

	C0201_mem0 = S.Task('C0201_mem0', length=1, delay_cost=1)
	C0201_mem0 += alt(ADD_mem)
	S += (T2501*ADD[0])-1<C0201_mem0*ADD_mem[0]
	S += (T2501*ADD[1])-1<C0201_mem0*ADD_mem[1]
	S += (T2501*ADD[2])-1<C0201_mem0*ADD_mem[2]
	S += (T2501*ADD[3])-1<C0201_mem0*ADD_mem[3]
	S += C0201_mem0<=C0201

	C0201_mem1 = S.Task('C0201_mem1', length=1, delay_cost=1)
	C0201_mem1 += alt(ADD_mem)
	S += (T8401*ADD[0])-1<C0201_mem1*ADD_mem[0]
	S += (T8401*ADD[1])-1<C0201_mem1*ADD_mem[1]
	S += (T8401*ADD[2])-1<C0201_mem1*ADD_mem[2]
	S += (T8401*ADD[3])-1<C0201_mem1*ADD_mem[3]
	S += C0201_mem1<=C0201

	C0210_mem0 = S.Task('C0210_mem0', length=1, delay_cost=1)
	C0210_mem0 += alt(ADD_mem)
	S += (T2510*ADD[0])-1<C0210_mem0*ADD_mem[0]
	S += (T2510*ADD[1])-1<C0210_mem0*ADD_mem[1]
	S += (T2510*ADD[2])-1<C0210_mem0*ADD_mem[2]
	S += (T2510*ADD[3])-1<C0210_mem0*ADD_mem[3]
	S += C0210_mem0<=C0210
	...
	S += (T3600*ADD[0])-1<C1000_mem0*ADD_mem[0]
	S += (T3600*ADD[1])-1<C1000_mem0*ADD_mem[1]
	S += (T3600*ADD[2])-1<C1000_mem0*ADD_mem[2]
	S += (T3600*ADD[3])-1<C1000_mem0*ADD_mem[3]
	S += C1000_mem0<=C1000

	C1000_mem1 = S.Task('C1000_mem1', length=1, delay_cost=1)
	C1000_mem1 += alt(ADD_mem)
	S += (T3600*ADD[0])-1<C1000_mem1*ADD_mem[0]
	S += (T3600*ADD[1])-1<C1000_mem1*ADD_mem[1]
	S += (T3600*ADD[2])-1<C1000_mem1*ADD_mem[2]
	S += (T3600*ADD[3])-1<C1000_mem1*ADD_mem[3]
	S += C1000_mem1<=C1000

	C1001_mem0 = S.Task('C1001_mem0', length=1, delay_cost=1)
	C1001_mem0 += alt(ADD_mem)
	S += (T3601*ADD[0])-1<C1001_mem0*ADD_mem[0]
	S += (T3601*ADD[1])-1<C1001_mem0*ADD_mem[1]
	S += (T3601*ADD[2])-1<C1001_mem0*ADD_mem[2]
	S += (T3601*ADD[3])-1<C1001_mem0*ADD_mem[3]
	S += C1001_mem0<=C1001

	C1001_mem1 = S.Task('C1001_mem1', length=1, delay_cost=1)
	C1001_mem1 += alt(ADD_mem)
	S += (T3601*ADD[0])-1<C1001_mem1*ADD_mem[0]
	S += (T3601*ADD[1])-1<C1001_mem1*ADD_mem[1]
	S += (T3601*ADD[2])-1<C1001_mem1*ADD_mem[2]
	S += (T3601*ADD[3])-1<C1001_mem1*ADD_mem[3]
	S += C1001_mem1<=C1001

	C0000_mem0 = S.Task('C0000_mem0', length=1, delay_cost=1)
	C0000_mem0 += alt(ADD_mem)
	S += (T0200*ADD[0])-1<C0000_mem0*ADD_mem[0]
	S += (T0200*ADD[1])-1<C0000_mem0*ADD_mem[1]
	S += (T0200*ADD[2])-1<C0000_mem0*ADD_mem[2]
	S += (T0200*ADD[3])-1<C0000_mem0*ADD_mem[3]
	S += C0000_mem0<=C0000

	C0000_mem1 = S.Task('C0000_mem1', length=1, delay_cost=1)
	C0000_mem1 += alt(ADD_mem)
	S += (T6300*ADD[0])-1<C0000_mem1*ADD_mem[0]
	S += (T6300*ADD[1])-1<C0000_mem1*ADD_mem[1]
	S += (T6300*ADD[2])-1<C0000_mem1*ADD_mem[2]
	S += (T6300*ADD[3])-1<C0000_mem1*ADD_mem[3]
	S += C0000_mem1<=C0000

	C0001_mem0 = S.Task('C0001_mem0', length=1, delay_cost=1)
	C0001_mem0 += alt(ADD_mem)
	S += (T0201*ADD[0])-1<C0001_mem0*ADD_mem[0]
	S += (T0201*ADD[1])-1<C0001_mem0*ADD_mem[1]
	S += (T0201*ADD[2])-1<C0001_mem0*ADD_mem[2]
	S += (T0201*ADD[3])-1<C0001_mem0*ADD_mem[3]
	S += C0001_mem0<=C0001

	C0001_mem1 = S.Task('C0001_mem1', length=1, delay_cost=1)
	C0001_mem1 += alt(ADD_mem)
	S += (T6301*ADD[0])-1<C0001_mem1*ADD_mem[0]
	S += (T6301*ADD[1])-1<C0001_mem1*ADD_mem[1]
	S += (T6301*ADD[2])-1<C0001_mem1*ADD_mem[2]
	S += (T6301*ADD[3])-1<C0001_mem1*ADD_mem[3]
	S += C0001_mem1<=C0001

	C0100_mem0 = S.Task('C0100_mem0', length=1, delay_cost=1)
	C0100_mem0 += alt(ADD_mem)
	S += (T1600*ADD[0])-1<C0100_mem0*ADD_mem[0]
	S += (T1600*ADD[1])-1<C0100_mem0*ADD_mem[1]
	S += (T1600*ADD[2])-1<C0100_mem0*ADD_mem[2]
	S += (T1600*ADD[3])-1<C0100_mem0*ADD_mem[3]
	S += C0100_mem0<=C0100

	C0100_mem1 = S.Task('C0100_mem1', length=1, delay_cost=1)
	C0100_mem1 += alt(ADD_mem)
	S += (T7200*ADD[0])-1<C0100_mem1*ADD_mem[0]
	S += (T7200*ADD[1])-1<C0100_mem1*ADD_mem[1]
	S += (T7200*ADD[2])-1<C0100_mem1*ADD_mem[2]
	S += (T7200*ADD[3])-1<C0100_mem1*ADD_mem[3]
	S += C0100_mem1<=C0100

	C0101_mem0 = S.Task('C0101_mem0', length=1, delay_cost=1)
	C0101_mem0 += alt(ADD_mem)
	S += (T1601*ADD[0])-1<C0101_mem0*ADD_mem[0]
	S += (T1601*ADD[1])-1<C0101_mem0*ADD_mem[1]
	S += (T1601*ADD[2])-1<C0101_mem0*ADD_mem[2]
	S += (T1601*ADD[3])-1<C0101_mem0*ADD_mem[3]
	S += C0101_mem0<=C0101

	C0101_mem1 = S.Task('C0101_mem1', length=1, delay_cost=1)
	C0101_mem1 += alt(ADD_mem)
	S += (T7201*ADD[0])-1<C0101_mem1*ADD_mem[0]
	S += (T7201*ADD[1])-1<C0101_mem1*ADD_mem[1]
	S += (T7201*ADD[2])-1<C0101_mem1*ADD_mem[2]
	S += (T7201*ADD[3])-1<C0101_mem1*ADD_mem[3]
	S += C0101_mem1<=C0101

	C0111_mem0 = S.Task('C0111_mem0', length=1, delay_cost=1)
	C0111_mem0 += alt(ADD_mem)
	S += (T1611*ADD[0])-1<C0111_mem0*ADD_mem[0]
	S += (T1611*ADD[1])-1<C0111_mem0*ADD_mem[1]
	S += (T1611*ADD[2])-1<C0111_mem0*ADD_mem[2]
	S += (T1611*ADD[3])-1<C0111_mem0*ADD_mem[3]
	S += C0111_mem0<=C0111

	C0111_mem1 = S.Task('C0111_mem1', length=1, delay_cost=1)
	C0111_mem1 += alt(ADD_mem)
	S += (T7211*ADD[0])-1<C0111_mem1*ADD_mem[0]
	S += (T7211*ADD[1])-1<C0111_mem1*ADD_mem[1]
	S += (T7211*ADD[2])-1<C0111_mem1*ADD_mem[2]
	S += (T7211*ADD[3])-1<C0111_mem1*ADD_mem[3]
	S += C0111_mem1<=C0111

	C0211_mem0 = S.Task('C0211_mem0', length=1, delay_cost=1)
	C0211_mem0 += alt(ADD_mem)
	S += (T2511*ADD[0])-1<C0211_mem0*ADD_mem[0]
	S += (T2511*ADD[1])-1<C0211_mem0*ADD_mem[1]
	S += (T2511*ADD[2])-1<C0211_mem0*ADD_mem[2]
	S += (T2511*ADD[3])-1<C0211_mem0*ADD_mem[3]
	S += C0211_mem0<=C0211

	C0211_mem1 = S.Task('C0211_mem1', length=1, delay_cost=1)
	C0211_mem1 += alt(ADD_mem)
	S += (T8411*ADD[0])-1<C0211_mem1*ADD_mem[0]
	S += (T8411*ADD[1])-1<C0211_mem1*ADD_mem[1]
	S += (T8411*ADD[2])-1<C0211_mem1*ADD_mem[2]
	S += (T8411*ADD[3])-1<C0211_mem1*ADD_mem[3]
	S += C0211_mem1<=C0211
	...
	pic_file_name = "s24_mul1_add4/s24_mul1_add4_9.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_s24_mul1_add4_9(0, 0)