...
def solve_sparse_mul1_add4_4(ConstStep, ExpStep):
	horizon = 236
	S=Scenario("sparse_mul1_add4_4",horizon = horizon)
	...
	T9_1t4_t2t3_in += alt(MUL_in)
	T9_1t4_t2t3 = S.Task('T9_1t4_t2t3', length=7, delay_cost=1)
	T9_1t4_t2t3 += alt(MUL)
	S+=T9_1t4_t2t3>=T9_1t4_t2t3_in
	...
	pic_file_name = "sparse_mul1_add4/sparse_mul1_add4_4.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_sparse_mul1_add4_4(0, 0)