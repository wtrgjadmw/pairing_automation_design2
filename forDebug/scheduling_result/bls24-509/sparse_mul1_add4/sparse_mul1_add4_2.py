...
def solve_sparse_mul1_add4_2(ConstStep, ExpStep):
	...
	T6_1t4_a0b0_in += alt(MUL_in)
	T6_1t4_a0b0 = S.Task('T6_1t4_a0b0', length=7, delay_cost=1)
	T6_1t4_a0b0 += alt(MUL)
	S+=T6_1t4_a0b0>=T6_1t4_a0b0_in
	...
	T6_1t4_a1b1_in += alt(MUL_in)
	T6_1t4_a1b1 = S.Task('T6_1t4_a1b1', length=7, delay_cost=1)
	T6_1t4_a1b1 += alt(MUL)
	S+=T6_1t4_a1b1>=T6_1t4_a1b1_in
	...
	T6_2t4_t2t3_in += alt(MUL_in)
	T6_2t4_t2t3 = S.Task('T6_2t4_t2t3', length=7, delay_cost=1)
	T6_2t4_t2t3 += alt(MUL)
	S+=T6_2t4_t2t3>=T6_2t4_t2t3_in
	...
	T3_1t4_a1b1_in += alt(MUL_in)
	T3_1t4_a1b1 = S.Task('T3_1t4_a1b1', length=7, delay_cost=1)
	T3_1t4_a1b1 += alt(MUL)
	S+=T3_1t4_a1b1>=T3_1t4_a1b1_in
	...
	T5_2t4_a0b0_in += alt(MUL_in)
	T5_2t4_a0b0 = S.Task('T5_2t4_a0b0', length=7, delay_cost=1)
	T5_2t4_a0b0 += alt(MUL)
	S+=T5_2t4_a0b0>=T5_2t4_a0b0_in
	...
	T5_2t4_a1b1_in += alt(MUL_in)
	T5_2t4_a1b1 = S.Task('T5_2t4_a1b1', length=7, delay_cost=1)
	T5_2t4_a1b1 += alt(MUL)
	S+=T5_2t4_a1b1>=T5_2t4_a1b1_in
	...
	T9_2t4_a0b0_in += alt(MUL_in)
	T9_2t4_a0b0 = S.Task('T9_2t4_a0b0', length=7, delay_cost=1)
	T9_2t4_a0b0 += alt(MUL)
	S+=T9_2t4_a0b0>=T9_2t4_a0b0_in
	...
	T9_2t4_a1b1_in += alt(MUL_in)
	T9_2t4_a1b1 = S.Task('T9_2t4_a1b1', length=7, delay_cost=1)
	T9_2t4_a1b1 += alt(MUL)
	S+=T9_2t4_a1b1>=T9_2t4_a1b1_in
