...
def solve_sparse_mul1_add4_5(ConstStep, ExpStep):
	horizon = 237
	S=Scenario("sparse_mul1_add4_5",horizon = horizon)
	...
	pic_file_name = "sparse_mul1_add4/sparse_mul1_add4_5.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_sparse_mul1_add4_5(0, 0)