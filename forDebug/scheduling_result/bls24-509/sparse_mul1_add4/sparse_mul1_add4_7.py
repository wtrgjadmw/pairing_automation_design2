...
def solve_sparse_mul1_add4_7(ConstStep, ExpStep):
	horizon = 252
	S=Scenario("sparse_mul1_add4_7",horizon = horizon)
	...
	# new tasks
	T10_200 = S.Task('T10_200', length=1, delay_cost=1)
	T10_200 += alt(ADD)

	T10_201 = S.Task('T10_201', length=1, delay_cost=1)
	T10_201 += alt(ADD)

	T10_211 = S.Task('T10_211', length=1, delay_cost=1)
	T10_211 += alt(ADD)

	T8_300 = S.Task('T8_300', length=1, delay_cost=1)
	T8_300 += alt(ADD)

	T8_301 = S.Task('T8_301', length=1, delay_cost=1)
	T8_301 += alt(ADD)

	T9_400 = S.Task('T9_400', length=1, delay_cost=1)
	T9_400 += alt(ADD)

	T9_401 = S.Task('T9_401', length=1, delay_cost=1)
	T9_401 += alt(ADD)

	T10_310 = S.Task('T10_310', length=1, delay_cost=1)
	T10_310 += alt(ADD)

	T10_300 = S.Task('T10_300', length=1, delay_cost=1)
	T10_300 += alt(ADD)

	T10_301 = S.Task('T10_301', length=1, delay_cost=1)
	T10_301 += alt(ADD)

	T10_311 = S.Task('T10_311', length=1, delay_cost=1)
	T10_311 += alt(ADD)
	...
	T10_200_mem0 = S.Task('T10_200_mem0', length=1, delay_cost=1)
	T10_200_mem0 += ADD_mem[0]
	S += 158<T10_200_mem0
	S += T10_200_mem0<=T10_200

	T10_200_mem1 = S.Task('T10_200_mem1', length=1, delay_cost=1)
	T10_200_mem1 += ADD_mem[0]
	S += 144<T10_200_mem1
	S += T10_200_mem1<=T10_200

	T10_201_mem0 = S.Task('T10_201_mem0', length=1, delay_cost=1)
	T10_201_mem0 += ADD_mem[3]
	S += 158<T10_201_mem0
	S += T10_201_mem0<=T10_201

	T10_201_mem1 = S.Task('T10_201_mem1', length=1, delay_cost=1)
	T10_201_mem1 += ADD_mem[0]
	S += 155<T10_201_mem1
	S += T10_201_mem1<=T10_201

	T10_211_mem0 = S.Task('T10_211_mem0', length=1, delay_cost=1)
	T10_211_mem0 += ADD_mem[3]
	S += 155<T10_211_mem0
	S += T10_211_mem0<=T10_211

	T10_211_mem1 = S.Task('T10_211_mem1', length=1, delay_cost=1)
	T10_211_mem1 += ADD_mem[1]
	S += 149<T10_211_mem1
	S += T10_211_mem1<=T10_211

	T8_300_mem0 = S.Task('T8_300_mem0', length=1, delay_cost=1)
	T8_300_mem0 += ADD_mem[2]
	S += 153<T8_300_mem0
	S += T8_300_mem0<=T8_300

	T8_300_mem1 = S.Task('T8_300_mem1', length=1, delay_cost=1)
	T8_300_mem1 += ADD_mem[3]
	S += 134<T8_300_mem1
	S += T8_300_mem1<=T8_300

	T8_301_mem0 = S.Task('T8_301_mem0', length=1, delay_cost=1)
	T8_301_mem0 += ADD_mem[3]
	S += 156<T8_301_mem0
	S += T8_301_mem0<=T8_301

	T8_301_mem1 = S.Task('T8_301_mem1', length=1, delay_cost=1)
	T8_301_mem1 += ADD_mem[1]
	S += 135<T8_301_mem1
	S += T8_301_mem1<=T8_301

	T9_400_mem0 = S.Task('T9_400_mem0', length=1, delay_cost=1)
	T9_400_mem0 += ADD_mem[1]
	S += 158<T9_400_mem0
	S += T9_400_mem0<=T9_400

	T9_400_mem1 = S.Task('T9_400_mem1', length=1, delay_cost=1)
	T9_400_mem1 += ADD_mem[0]
	S += 122<T9_400_mem1
	S += T9_400_mem1<=T9_400

	T9_401_mem0 = S.Task('T9_401_mem0', length=1, delay_cost=1)
	T9_401_mem0 += ADD_mem[3]
	S += 159<T9_401_mem0
	S += T9_401_mem0<=T9_401

	T9_401_mem1 = S.Task('T9_401_mem1', length=1, delay_cost=1)
	T9_401_mem1 += ADD_mem[3]
	S += 122<T9_401_mem1
	S += T9_401_mem1<=T9_401

	T10_310_mem0 = S.Task('T10_310_mem0', length=1, delay_cost=1)
	T10_310_mem0 += ADD_mem[1]
	S += 154<T10_310_mem0
	S += T10_310_mem0<=T10_310

	T10_310_mem1 = S.Task('T10_310_mem1', length=1, delay_cost=1)
	T10_310_mem1 += ADD_mem[3]
	S += 117<T10_310_mem1
	S += T10_310_mem1<=T10_310

	T10_300_mem0 = S.Task('T10_300_mem0', length=1, delay_cost=1)
	T10_300_mem0 += alt(ADD_mem)
	S += (T10_200*ADD[0])-1<T10_300_mem0*ADD_mem[0]
	S += (T10_200*ADD[1])-1<T10_300_mem0*ADD_mem[1]
	S += (T10_200*ADD[2])-1<T10_300_mem0*ADD_mem[2]
	S += (T10_200*ADD[3])-1<T10_300_mem0*ADD_mem[3]
	S += T10_300_mem0<=T10_300

	T10_300_mem1 = S.Task('T10_300_mem1', length=1, delay_cost=1)
	T10_300_mem1 += ADD_mem[1]
	S += 118<T10_300_mem1
	S += T10_300_mem1<=T10_300

	T10_301_mem0 = S.Task('T10_301_mem0', length=1, delay_cost=1)
	T10_301_mem0 += alt(ADD_mem)
	S += (T10_201*ADD[0])-1<T10_301_mem0*ADD_mem[0]
	S += (T10_201*ADD[1])-1<T10_301_mem0*ADD_mem[1]
	S += (T10_201*ADD[2])-1<T10_301_mem0*ADD_mem[2]
	S += (T10_201*ADD[3])-1<T10_301_mem0*ADD_mem[3]
	S += T10_301_mem0<=T10_301

	T10_301_mem1 = S.Task('T10_301_mem1', length=1, delay_cost=1)
	T10_301_mem1 += ADD_mem[2]
	S += 129<T10_301_mem1
	S += T10_301_mem1<=T10_301

	T10_311_mem0 = S.Task('T10_311_mem0', length=1, delay_cost=1)
	T10_311_mem0 += alt(ADD_mem)
	S += (T10_211*ADD[0])-1<T10_311_mem0*ADD_mem[0]
	S += (T10_211*ADD[1])-1<T10_311_mem0*ADD_mem[1]
	S += (T10_211*ADD[2])-1<T10_311_mem0*ADD_mem[2]
	S += (T10_211*ADD[3])-1<T10_311_mem0*ADD_mem[3]
	S += T10_311_mem0<=T10_311

	T10_311_mem1 = S.Task('T10_311_mem1', length=1, delay_cost=1)
	T10_311_mem1 += ADD_mem[1]
	S += 132<T10_311_mem1
	S += T10_311_mem1<=T10_311
	...
	S += (T8_300*ADD[0])-1<C0000_mem0*ADD_mem[0]
	S += (T8_300*ADD[1])-1<C0000_mem0*ADD_mem[1]
	S += (T8_300*ADD[2])-1<C0000_mem0*ADD_mem[2]
	S += (T8_300*ADD[3])-1<C0000_mem0*ADD_mem[3]
	S += C0000_mem0<=C0000
	...
	S += (T8_301*ADD[0])-1<C0001_mem0*ADD_mem[0]
	S += (T8_301*ADD[1])-1<C0001_mem0*ADD_mem[1]
	S += (T8_301*ADD[2])-1<C0001_mem0*ADD_mem[2]
	S += (T8_301*ADD[3])-1<C0001_mem0*ADD_mem[3]
	S += C0001_mem0<=C0001
	...
	S += (T9_400*ADD[0])-1<C0100_mem0*ADD_mem[0]
	S += (T9_400*ADD[1])-1<C0100_mem0*ADD_mem[1]
	S += (T9_400*ADD[2])-1<C0100_mem0*ADD_mem[2]
	S += (T9_400*ADD[3])-1<C0100_mem0*ADD_mem[3]
	S += C0100_mem0<=C0100
	...
	S += (T9_401*ADD[0])-1<C0101_mem0*ADD_mem[0]
	S += (T9_401*ADD[1])-1<C0101_mem0*ADD_mem[1]
	S += (T9_401*ADD[2])-1<C0101_mem0*ADD_mem[2]
	S += (T9_401*ADD[3])-1<C0101_mem0*ADD_mem[3]
	S += C0101_mem0<=C0101
	...
	S += (T10_310*ADD[0])-1<C0210_mem0*ADD_mem[0]
	S += (T10_310*ADD[1])-1<C0210_mem0*ADD_mem[1]
	S += (T10_310*ADD[2])-1<C0210_mem0*ADD_mem[2]
	S += (T10_310*ADD[3])-1<C0210_mem0*ADD_mem[3]
	S += C0210_mem0<=C0210
	...
	S += (T10_300*ADD[0])-1<C0200_mem0*ADD_mem[0]
	S += (T10_300*ADD[1])-1<C0200_mem0*ADD_mem[1]
	S += (T10_300*ADD[2])-1<C0200_mem0*ADD_mem[2]
	S += (T10_300*ADD[3])-1<C0200_mem0*ADD_mem[3]
	S += C0200_mem0<=C0200
	...
	S += (T10_301*ADD[0])-1<C0201_mem0*ADD_mem[0]
	S += (T10_301*ADD[1])-1<C0201_mem0*ADD_mem[1]
	S += (T10_301*ADD[2])-1<C0201_mem0*ADD_mem[2]
	S += (T10_301*ADD[3])-1<C0201_mem0*ADD_mem[3]
	S += C0201_mem0<=C0201
	...
	S += (T10_311*ADD[0])-1<C0211_mem0*ADD_mem[0]
	S += (T10_311*ADD[1])-1<C0211_mem0*ADD_mem[1]
	S += (T10_311*ADD[2])-1<C0211_mem0*ADD_mem[2]
	S += (T10_311*ADD[3])-1<C0211_mem0*ADD_mem[3]
	S += C0211_mem0<=C0211
	...
	pic_file_name = "sparse_mul1_add4/sparse_mul1_add4_7.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_sparse_mul1_add4_7(0, 0)