...
def solve_sqr012345_mul1_add4_3(ConstStep, ExpStep):
	...
	T12t4_a0a1_in += alt(MUL_in)
	T12t4_a0a1 = S.Task('T12t4_a0a1', length=7, delay_cost=1)
	T12t4_a0a1 += alt(MUL)
	S+=T12t4_a0a1>=T12t4_a0a1_in
	...
	T21t4_a0a1_in += alt(MUL_in)
	T21t4_a0a1 = S.Task('T21t4_a0a1', length=7, delay_cost=1)
	T21t4_a0a1 += alt(MUL)
	S+=T21t4_a0a1>=T21t4_a0a1_in
