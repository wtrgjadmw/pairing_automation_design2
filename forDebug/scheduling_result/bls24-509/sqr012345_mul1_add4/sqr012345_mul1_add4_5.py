...
def solve_sqr012345_mul1_add4_5(ConstStep, ExpStep):
	horizon = 177
	S=Scenario("sqr012345_mul1_add4_5",horizon = horizon)
	...
	T12t4_t0t1_in += alt(MUL_in)
	T12t4_t0t1 = S.Task('T12t4_t0t1', length=7, delay_cost=1)
	T12t4_t0t1 += alt(MUL)
	S+=T12t4_t0t1>=T12t4_t0t1_in
	...
	T21t4_t0t1_in += alt(MUL_in)
	T21t4_t0t1 = S.Task('T21t4_t0t1', length=7, delay_cost=1)
	T21t4_t0t1 += alt(MUL)
	S+=T21t4_t0t1>=T21t4_t0t1_in
	...
	pic_file_name = "sqr012345_mul1_add4/sqr012345_mul1_add4_5.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_sqr012345_mul1_add4_5(0, 0)