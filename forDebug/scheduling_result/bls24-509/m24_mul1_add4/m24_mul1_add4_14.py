...
def solve_m24_mul1_add4_14(ConstStep, ExpStep):
	horizon = 304
	S=Scenario("m24_mul1_add4_14",horizon = horizon)
	...
	S += T3_5c0_a0b0<T3_500_mem0
	S += T3_500_mem0<=T3_500

	T3_500_mem1 = S.Task('T3_500_mem1', length=1, delay_cost=1)
	T3_500_mem1 += ADD_mem[1]
	S += T3_5s0_0<T3_500_mem1
	S += T3_500_mem1<=T3_500
	...
	S += T3_5c1_a0b0<T3_501_mem0
	S += T3_501_mem0<=T3_501

	T3_501_mem1 = S.Task('T3_501_mem1', length=1, delay_cost=1)
	T3_501_mem1 += ADD_mem[1]
	S += T3_5s0_1<T3_501_mem1
	S += T3_501_mem1<=T3_501
	...
	S += T3_5c1_t2t3<T3_511_mem0
	S += T3_511_mem0<=T3_511

	T3_511_mem1 = S.Task('T3_511_mem1', length=1, delay_cost=1)
	T3_511_mem1 += ADD_mem[3]
	S += T3_5t5_1<T3_511_mem1
	S += T3_511_mem1<=T3_511
	...
	S += T5_7c0_a0b0<T5_700_mem0
	S += T5_700_mem0<=T5_700

	T5_700_mem1 = S.Task('T5_700_mem1', length=1, delay_cost=1)
	T5_700_mem1 += ADD_mem[3]
	S += T5_7s0_0<T5_700_mem1
	S += T5_700_mem1<=T5_700
	...
	S += T5_7c1_a0b0<T5_701_mem0
	S += T5_701_mem0<=T5_701

	T5_701_mem1 = S.Task('T5_701_mem1', length=1, delay_cost=1)
	T5_701_mem1 += ADD_mem[0]
	S += T5_7s0_1<T5_701_mem1
	S += T5_701_mem1<=T5_701
	...
	S += T5_7c1_t2t3<T5_711_mem0
	S += T5_711_mem0<=T5_711

	T5_711_mem1 = S.Task('T5_711_mem1', length=1, delay_cost=1)
	T5_711_mem1 += ADD_mem[1]
	S += T5_7t5_1<T5_711_mem1
	S += T5_711_mem1<=T5_711
	...
	S += T4_810<T4_910_mem0
	S += T4_910_mem0<=T4_910

	T4_910_mem1 = S.Task('T4_910_mem1', length=1, delay_cost=1)
	T4_910_mem1 += ADD_mem[0]
	S += T1_110<T4_910_mem1
	S += T4_910_mem1<=T4_910
	...
	S += T3_9t4_t2t3<T3_9c1_t2t3_mem0
	S += T3_9c1_t2t3_mem0<=T3_9c1_t2t3

	T3_9c1_t2t3_mem1 = S.Task('T3_9c1_t2t3_mem1', length=1, delay_cost=1)
	T3_9c1_t2t3_mem1 += ADD_mem[3]
	S += T3_9t6_t2t3<T3_9c1_t2t3_mem1
	S += T3_9c1_t2t3_mem1<=T3_9c1_t2t3
	...
	S += T3_9c0_a1b1<T3_9s0_0_mem0
	S += T3_9s0_0_mem0<=T3_9s0_0

	T3_9s0_0_mem1 = S.Task('T3_9s0_0_mem1', length=1, delay_cost=1)
	T3_9s0_0_mem1 += ADD_mem[3]
	S += T3_9c1_a1b1<T3_9s0_0_mem1
	S += T3_9s0_0_mem1<=T3_9s0_0
	...
	S += T3_9c1_a1b1<T3_9s0_1_mem0
	S += T3_9s0_1_mem0<=T3_9s0_1

	T3_9s0_1_mem1 = S.Task('T3_9s0_1_mem1', length=1, delay_cost=1)
	T3_9s0_1_mem1 += ADD_mem[2]
	S += T3_9c0_a1b1<T3_9s0_1_mem1
	S += T3_9s0_1_mem1<=T3_9s0_1
	...
	S += T3_9c1_a0b0<T3_9t5_1_mem0
	S += T3_9t5_1_mem0<=T3_9t5_1

	T3_9t5_1_mem1 = S.Task('T3_9t5_1_mem1', length=1, delay_cost=1)
	T3_9t5_1_mem1 += ADD_mem[3]
	S += T3_9c1_a1b1<T3_9t5_1_mem1
	S += T3_9t5_1_mem1<=T3_9t5_1
	...
	S += T4_14c0_a1b1<T4_14s0_0_mem0
	S += T4_14s0_0_mem0<=T4_14s0_0

	T4_14s0_0_mem1 = S.Task('T4_14s0_0_mem1', length=1, delay_cost=1)
	T4_14s0_0_mem1 += ADD_mem[0]
	S += T4_14c1_a1b1<T4_14s0_0_mem1
	S += T4_14s0_0_mem1<=T4_14s0_0
	...
	S += T4_14c1_a1b1<T4_14s0_1_mem0
	S += T4_14s0_1_mem0<=T4_14s0_1

	T4_14s0_1_mem1 = S.Task('T4_14s0_1_mem1', length=1, delay_cost=1)
	T4_14s0_1_mem1 += ADD_mem[0]
	S += T4_14c0_a1b1<T4_14s0_1_mem1
	S += T4_14s0_1_mem1<=T4_14s0_1
	...
	S += T4_14c1_a0b0<T4_14t5_1_mem0
	S += T4_14t5_1_mem0<=T4_14t5_1

	T4_14t5_1_mem1 = S.Task('T4_14t5_1_mem1', length=1, delay_cost=1)
	T4_14t5_1_mem1 += ADD_mem[0]
	S += T4_14c1_a1b1<T4_14t5_1_mem1
	S += T4_14t5_1_mem1<=T4_14t5_1
	...
	S += T4_14c0_t2t3<T4_1410_mem0
	S += T4_1410_mem0<=T4_1410

	T4_1410_mem1 = S.Task('T4_1410_mem1', length=1, delay_cost=1)
	T4_1410_mem1 += ADD_mem[0]
	S += T4_14t5_0<T4_1410_mem1
	S += T4_1410_mem1<=T4_1410
	...
	pic_file_name = "m24_mul1_add4/m24_mul1_add4_14.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_m24_mul1_add4_14(0, 0)