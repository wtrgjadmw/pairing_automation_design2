...
def solve_m24_mul1_add4_15(ConstStep, ExpStep):
	horizon = 316
	S=Scenario("m24_mul1_add4_15",horizon = horizon)
	...
	S += T4_811<T4_911_mem0
	S += T4_911_mem0<=T4_911

	T4_911_mem1 = S.Task('T4_911_mem1', length=1, delay_cost=1)
	T4_911_mem1 += ADD_mem[0]
	S += T1_111<T4_911_mem1
	S += T4_911_mem1<=T4_911
	...
	S += T4_14c0_a0b0<T4_1400_mem0
	S += T4_1400_mem0<=T4_1400

	T4_1400_mem1 = S.Task('T4_1400_mem1', length=1, delay_cost=1)
	T4_1400_mem1 += ADD_mem[3]
	S += T4_14s0_0<T4_1400_mem1
	S += T4_1400_mem1<=T4_1400
	...
	S += T4_14c1_a0b0<T4_1401_mem0
	S += T4_1401_mem0<=T4_1401

	T4_1401_mem1 = S.Task('T4_1401_mem1', length=1, delay_cost=1)
	T4_1401_mem1 += ADD_mem[1]
	S += T4_14s0_1<T4_1401_mem1
	S += T4_1401_mem1<=T4_1401
	...
	S += T4_14c1_t2t3<T4_1411_mem0
	S += T4_1411_mem0<=T4_1411

	T4_1411_mem1 = S.Task('T4_1411_mem1', length=1, delay_cost=1)
	T4_1411_mem1 += ADD_mem[2]
	S += T4_14t5_1<T4_1411_mem1
	S += T4_1411_mem1<=T4_1411
	...
	S += T3_910<T3_1010_mem0
	S += T3_1010_mem0<=T3_1010

	T3_1010_mem1 = S.Task('T3_1010_mem1', length=1, delay_cost=1)
	T3_1010_mem1 += ADD_mem[0]
	S += T0_210<T3_1010_mem1
	S += T3_1010_mem1<=T3_1010
	...
	pic_file_name = "m24_mul1_add4/m24_mul1_add4_15.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_m24_mul1_add4_15(0, 0)