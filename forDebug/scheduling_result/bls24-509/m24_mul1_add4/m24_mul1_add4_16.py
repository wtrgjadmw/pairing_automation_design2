...
def solve_m24_mul1_add4_16(ConstStep, ExpStep):
	horizon = 325
	S=Scenario("m24_mul1_add4_16",horizon = horizon)
	...
	S += T3_900<T3_1000_mem0
	S += T3_1000_mem0<=T3_1000

	T3_1000_mem1 = S.Task('T3_1000_mem1', length=1, delay_cost=1)
	T3_1000_mem1 += ADD_mem[0]
	S += T0_200<T3_1000_mem1
	S += T3_1000_mem1<=T3_1000
	...
	S += T3_901<T3_1001_mem0
	S += T3_1001_mem0<=T3_1001

	T3_1001_mem1 = S.Task('T3_1001_mem1', length=1, delay_cost=1)
	T3_1001_mem1 += ADD_mem[1]
	S += T0_201<T3_1001_mem1
	S += T3_1001_mem1<=T3_1001
	...
	S += T3_911<T3_1011_mem0
	S += T3_1011_mem0<=T3_1011

	T3_1011_mem1 = S.Task('T3_1011_mem1', length=1, delay_cost=1)
	T3_1011_mem1 += ADD_mem[2]
	S += T0_211<T3_1011_mem1
	S += T3_1011_mem1<=T3_1011
	...
	S += T3_1010<T3_1110_mem0
	S += T3_1110_mem0<=T3_1110

	T3_1110_mem1 = S.Task('T3_1110_mem1', length=1, delay_cost=1)
	T3_1110_mem1 += ADD_mem[3]
	S += T1_210<T3_1110_mem1
	S += T3_1110_mem1<=T3_1110
	...
	S += T5_1310<T5_1410_mem0
	S += T5_1410_mem0<=T5_1410

	T5_1410_mem1 = S.Task('T5_1410_mem1', length=1, delay_cost=1)
	T5_1410_mem1 += ADD_mem[0]
	S += T0_210<T5_1410_mem1
	S += T5_1410_mem1<=T5_1410
	...
	pic_file_name = "m24_mul1_add4/m24_mul1_add4_16.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_m24_mul1_add4_16(0, 0)