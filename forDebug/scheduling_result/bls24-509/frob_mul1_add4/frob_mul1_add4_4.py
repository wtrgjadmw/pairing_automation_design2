...
def solve_frob_mul1_add4_4(ConstStep, ExpStep):
	horizon = 621
	S=Scenario("frob_mul1_add4_4",horizon = horizon)
	...
	C10t4_a1b1_in += alt(MUL_in)
	C10t4_a1b1 = S.Task('C10t4_a1b1', length=7, delay_cost=1)
	C10t4_a1b1 += alt(MUL)
	S+=C10t4_a1b1>=C10t4_a1b1_in
	...
	C12t1_t2t3_in += alt(MUL_in)
	C12t1_t2t3 = S.Task('C12t1_t2t3', length=7, delay_cost=1)
	C12t1_t2t3 += alt(MUL)
	S+=C12t1_t2t3>=C12t1_t2t3_in
	...
	pic_file_name = "frob_mul1_add4/frob_mul1_add4_4.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_frob_mul1_add4_4(0, 0)