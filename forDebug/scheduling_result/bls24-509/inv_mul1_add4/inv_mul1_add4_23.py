...
def solve_inv_mul1_add4_23(ConstStep, ExpStep):
	horizon = 352
	S=Scenario("inv_mul1_add4_23",horizon = horizon)
	...
	S += T4_14t4_c0<T4_14c1_c0_mem0
	S += T4_14c1_c0_mem0<=T4_14c1_c0

	T4_14c1_c0_mem1 = S.Task('T4_14c1_c0_mem1', length=1, delay_cost=1)
	T4_14c1_c0_mem1 += MUL_mem[0]
	S += T4_14t0_c0<T4_14c1_c0_mem1
	S += T4_14c1_c0_mem1<=T4_14c1_c0
	...
	S += T4_14t4_c1<T4_14c1_c1_mem0
	S += T4_14c1_c1_mem0<=T4_14c1_c1

	T4_14c1_c1_mem1 = S.Task('T4_14c1_c1_mem1', length=1, delay_cost=1)
	T4_14c1_c1_mem1 += MUL_mem[0]
	S += T4_14t1_c1<T4_14c1_c1_mem1
	S += T4_14c1_c1_mem1<=T4_14c1_c1
	...
	S += T4_14t0_c1<T4_1411_mem0
	S += T4_1411_mem0<=T4_1411

	T4_1411_mem1 = S.Task('T4_1411_mem1', length=1, delay_cost=1)
	T4_1411_mem1 += alt(ADD_mem)
	S += (T4_14c1_c1*ADD[0])-1<T4_1411_mem1*ADD_mem[0]
	S += (T4_14c1_c1*ADD[1])-1<T4_1411_mem1*ADD_mem[1]
	S += (T4_14c1_c1*ADD[2])-1<T4_1411_mem1*ADD_mem[2]
	S += (T4_14c1_c1*ADD[3])-1<T4_1411_mem1*ADD_mem[3]
	...
	S += T4_1400<T7t3_0_mem0
	S += T7t3_0_mem0<=T7t3_0

	T7t3_0_mem1 = S.Task('T7t3_0_mem1', length=1, delay_cost=1)
	T7t3_0_mem1 += alt(ADD_mem)
	S += (T4_1410*ADD[0])-1<T7t3_0_mem1*ADD_mem[0]
	S += (T4_1410*ADD[1])-1<T7t3_0_mem1*ADD_mem[1]
	S += (T4_1410*ADD[2])-1<T7t3_0_mem1*ADD_mem[2]
	S += (T4_1410*ADD[3])-1<T7t3_0_mem1*ADD_mem[3]
	...
	S += T0_310<T7t0_a1b1_mem0
	S += T7t0_a1b1_mem0<=T7t0_a1b1

	T7t0_a1b1_mem1 = S.Task('T7t0_a1b1_mem1', length=1, delay_cost=1)
	T7t0_a1b1_mem1 += alt(ADD_mem)
	S += (T4_1410*ADD[0])-1<T7t0_a1b1_mem1*ADD_mem[0]
	S += (T4_1410*ADD[1])-1<T7t0_a1b1_mem1*ADD_mem[1]
	S += (T4_1410*ADD[2])-1<T7t0_a1b1_mem1*ADD_mem[2]
	S += (T4_1410*ADD[3])-1<T7t0_a1b1_mem1*ADD_mem[3]
	...
	S += T2_610<T8t0_a1b1_mem0
	S += T8t0_a1b1_mem0<=T8t0_a1b1

	T8t0_a1b1_mem1 = S.Task('T8t0_a1b1_mem1', length=1, delay_cost=1)
	T8t0_a1b1_mem1 += alt(ADD_mem)
	S += (T4_1410*ADD[0])-1<T8t0_a1b1_mem1*ADD_mem[0]
	S += (T4_1410*ADD[1])-1<T8t0_a1b1_mem1*ADD_mem[1]
	S += (T4_1410*ADD[2])-1<T8t0_a1b1_mem1*ADD_mem[2]
	S += (T4_1410*ADD[3])-1<T8t0_a1b1_mem1*ADD_mem[3]
	S += T8t0_a1b1_mem1<=T8t0_a1b1

	T9t0_a1b1_in = S.Task('T9t0_a1b1_in', length=1, delay_cost=1)
	T9t0_a1b1_in += alt(MUL_in)
	T9t0_a1b1 = S.Task('T9t0_a1b1', length=7, delay_cost=1)
	T9t0_a1b1 += alt(MUL)
	S+=T9t0_a1b1>=T9t0_a1b1_in

	T9t0_a1b1_mem0 = S.Task('T9t0_a1b1_mem0', length=1, delay_cost=1)
	T9t0_a1b1_mem0 += ADD_mem[0]
	S += T1_310<T9t0_a1b1_mem0
	S += T9t0_a1b1_mem0<=T9t0_a1b1

	T9t0_a1b1_mem1 = S.Task('T9t0_a1b1_mem1', length=1, delay_cost=1)
	T9t0_a1b1_mem1 += alt(ADD_mem)
	S += (T4_1410*ADD[0])-1<T9t0_a1b1_mem1*ADD_mem[0]
	S += (T4_1410*ADD[1])-1<T9t0_a1b1_mem1*ADD_mem[1]
	S += (T4_1410*ADD[2])-1<T9t0_a1b1_mem1*ADD_mem[2]
	S += (T4_1410*ADD[3])-1<T9t0_a1b1_mem1*ADD_mem[3]
	S += T9t0_a1b1_mem1<=T9t0_a1b1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_23.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_23(0, 0)