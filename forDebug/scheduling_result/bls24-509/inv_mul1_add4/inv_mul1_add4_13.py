...
def solve_inv_mul1_add4_13(ConstStep, ExpStep):
	horizon = 271
	S=Scenario("inv_mul1_add4_13",horizon = horizon)
	...
	S += T0_2t4_t0t1<T0_2c1_t0t1_mem0
	S += T0_2c1_t0t1_mem0<=T0_2c1_t0t1

	T0_2c1_t0t1_mem1 = S.Task('T0_2c1_t0t1_mem1', length=1, delay_cost=1)
	T0_2c1_t0t1_mem1 += ADD_mem[0]
	S += T0_2t6_t0t1<T0_2c1_t0t1_mem1
	S += T0_2c1_t0t1_mem1<=T0_2c1_t0t1
	...
	S += T0_2c0_a0a1<T0_2t50_mem0
	S += T0_2t50_mem0<=T0_2t50

	T0_2t50_mem1 = S.Task('T0_2t50_mem1', length=1, delay_cost=1)
	T0_2t50_mem1 += ADD_mem[2]
	S += T0_2t40<T0_2t50_mem1
	S += T0_2t50_mem1<=T0_2t50
	...
	S += T0_2c1_a0a1<T0_2t51_mem0
	S += T0_2t51_mem0<=T0_2t51

	T0_2t51_mem1 = S.Task('T0_2t51_mem1', length=1, delay_cost=1)
	T0_2t51_mem1 += ADD_mem[1]
	S += T0_2t41<T0_2t51_mem1
	S += T0_2t51_mem1<=T0_2t51
	...
	S += T1_2t4_t0t1<T1_2c1_t0t1_mem0
	S += T1_2c1_t0t1_mem0<=T1_2c1_t0t1

	T1_2c1_t0t1_mem1 = S.Task('T1_2c1_t0t1_mem1', length=1, delay_cost=1)
	T1_2c1_t0t1_mem1 += ADD_mem[0]
	S += T1_2t6_t0t1<T1_2c1_t0t1_mem1
	S += T1_2c1_t0t1_mem1<=T1_2c1_t0t1
	...
	S += T1_2c0_a0a1<T1_2t50_mem0
	S += T1_2t50_mem0<=T1_2t50

	T1_2t50_mem1 = S.Task('T1_2t50_mem1', length=1, delay_cost=1)
	T1_2t50_mem1 += ADD_mem[0]
	S += T1_2t40<T1_2t50_mem1
	S += T1_2t50_mem1<=T1_2t50
	...
	S += T1_2c1_a0a1<T1_2t51_mem0
	S += T1_2t51_mem0<=T1_2t51

	T1_2t51_mem1 = S.Task('T1_2t51_mem1', length=1, delay_cost=1)
	T1_2t51_mem1 += ADD_mem[1]
	S += T1_2t41<T1_2t51_mem1
	S += T1_2t51_mem1<=T1_2t51
	...
	S += T2_4c0_a0a1<T2_4t50_mem0
	S += T2_4t50_mem0<=T2_4t50

	T2_4t50_mem1 = S.Task('T2_4t50_mem1', length=1, delay_cost=1)
	T2_4t50_mem1 += ADD_mem[2]
	S += T2_4t40<T2_4t50_mem1
	S += T2_4t50_mem1<=T2_4t50
	...
	S += T2_4c1_a0a1<T2_4t51_mem0
	S += T2_4t51_mem0<=T2_4t51

	T2_4t51_mem1 = S.Task('T2_4t51_mem1', length=1, delay_cost=1)
	T2_4t51_mem1 += ADD_mem[2]
	S += T2_4t41<T2_4t51_mem1
	S += T2_4t51_mem1<=T2_4t51
	...
	S += T4_8c0_a0b0<T4_800_mem0
	S += T4_800_mem0<=T4_800

	T4_800_mem1 = S.Task('T4_800_mem1', length=1, delay_cost=1)
	T4_800_mem1 += ADD_mem[0]
	S += T4_8s0_0<T4_800_mem1
	S += T4_800_mem1<=T4_800
	...
	S += T4_8c1_a0b0<T4_801_mem0
	S += T4_801_mem0<=T4_801

	T4_801_mem1 = S.Task('T4_801_mem1', length=1, delay_cost=1)
	T4_801_mem1 += ADD_mem[3]
	S += T4_8s0_1<T4_801_mem1
	S += T4_801_mem1<=T4_801
	...
	S += T4_8c1_t2t3<T4_811_mem0
	S += T4_811_mem0<=T4_811

	T4_811_mem1 = S.Task('T4_811_mem1', length=1, delay_cost=1)
	T4_811_mem1 += ADD_mem[3]
	S += T4_8t5_1<T4_811_mem1
	S += T4_811_mem1<=T4_811
	...
	S += T2_410<T2_500_mem0
	S += T2_500_mem0<=T2_500

	T2_500_mem1 = S.Task('T2_500_mem1', length=1, delay_cost=1)
	T2_500_mem1 += ADD_mem[3]
	S += T2_411<T2_500_mem1
	S += T2_500_mem1<=T2_500
	...
	S += T2_410<T2_501_mem0
	S += T2_501_mem0<=T2_501

	T2_501_mem1 = S.Task('T2_501_mem1', length=1, delay_cost=1)
	T2_501_mem1 += ADD_mem[3]
	S += T2_411<T2_501_mem1
	S += T2_501_mem1<=T2_501
	...
	S += T1_210<T1_310_mem0
	S += T1_310_mem0<=T1_310

	T1_310_mem1 = S.Task('T1_310_mem1', length=1, delay_cost=1)
	T1_310_mem1 += ADD_mem[1]
	S += T5_610<T1_310_mem1
	S += T1_310_mem1<=T1_310
	...
	S += T0_2c0_t0t1<T0_200_mem0
	S += T0_200_mem0<=T0_200

	T0_200_mem1 = S.Task('T0_200_mem1', length=1, delay_cost=1)
	T0_200_mem1 += alt(ADD_mem)
	S += (T0_2t50*ADD[0])-1<T0_200_mem1*ADD_mem[0]
	S += (T0_2t50*ADD[1])-1<T0_200_mem1*ADD_mem[1]
	S += (T0_2t50*ADD[2])-1<T0_200_mem1*ADD_mem[2]
	S += (T0_2t50*ADD[3])-1<T0_200_mem1*ADD_mem[3]
	S += T0_200_mem1<=T0_200

	T0_201 = S.Task('T0_201', length=1, delay_cost=1)
	T0_201 += alt(ADD)

	T0_201_mem0 = S.Task('T0_201_mem0', length=1, delay_cost=1)
	T0_201_mem0 += alt(ADD_mem)
	S += (T0_2c1_t0t1*ADD[0])-1<T0_201_mem0*ADD_mem[0]
	S += (T0_2c1_t0t1*ADD[1])-1<T0_201_mem0*ADD_mem[1]
	S += (T0_2c1_t0t1*ADD[2])-1<T0_201_mem0*ADD_mem[2]
	S += (T0_2c1_t0t1*ADD[3])-1<T0_201_mem0*ADD_mem[3]
	S += T0_201_mem0<=T0_201

	T0_201_mem1 = S.Task('T0_201_mem1', length=1, delay_cost=1)
	T0_201_mem1 += alt(ADD_mem)
	S += (T0_2t51*ADD[0])-1<T0_201_mem1*ADD_mem[0]
	S += (T0_2t51*ADD[1])-1<T0_201_mem1*ADD_mem[1]
	S += (T0_2t51*ADD[2])-1<T0_201_mem1*ADD_mem[2]
	S += (T0_2t51*ADD[3])-1<T0_201_mem1*ADD_mem[3]
	S += T0_201_mem1<=T0_201
	...
	S += T1_2c0_t0t1<T1_200_mem0
	S += T1_200_mem0<=T1_200

	T1_200_mem1 = S.Task('T1_200_mem1', length=1, delay_cost=1)
	T1_200_mem1 += alt(ADD_mem)
	S += (T1_2t50*ADD[0])-1<T1_200_mem1*ADD_mem[0]
	S += (T1_2t50*ADD[1])-1<T1_200_mem1*ADD_mem[1]
	S += (T1_2t50*ADD[2])-1<T1_200_mem1*ADD_mem[2]
	S += (T1_2t50*ADD[3])-1<T1_200_mem1*ADD_mem[3]
	...
	T1_201_mem0 += alt(ADD_mem)
	S += (T1_2c1_t0t1*ADD[0])-1<T1_201_mem0*ADD_mem[0]
	S += (T1_2c1_t0t1*ADD[1])-1<T1_201_mem0*ADD_mem[1]
	S += (T1_2c1_t0t1*ADD[2])-1<T1_201_mem0*ADD_mem[2]
	S += (T1_2c1_t0t1*ADD[3])-1<T1_201_mem0*ADD_mem[3]
	S += T1_201_mem0<=T1_201

	T1_201_mem1 = S.Task('T1_201_mem1', length=1, delay_cost=1)
	T1_201_mem1 += alt(ADD_mem)
	S += (T1_2t51*ADD[0])-1<T1_201_mem1*ADD_mem[0]
	S += (T1_2t51*ADD[1])-1<T1_201_mem1*ADD_mem[1]
	S += (T1_2t51*ADD[2])-1<T1_201_mem1*ADD_mem[2]
	S += (T1_2t51*ADD[3])-1<T1_201_mem1*ADD_mem[3]
	...
	S += T2_4c0_t0t1<T2_400_mem0
	S += T2_400_mem0<=T2_400

	T2_400_mem1 = S.Task('T2_400_mem1', length=1, delay_cost=1)
	T2_400_mem1 += alt(ADD_mem)
	S += (T2_4t50*ADD[0])-1<T2_400_mem1*ADD_mem[0]
	S += (T2_4t50*ADD[1])-1<T2_400_mem1*ADD_mem[1]
	S += (T2_4t50*ADD[2])-1<T2_400_mem1*ADD_mem[2]
	S += (T2_4t50*ADD[3])-1<T2_400_mem1*ADD_mem[3]
	S += T2_400_mem1<=T2_400
	...
	S += T2_4c1_t0t1<T2_401_mem0
	S += T2_401_mem0<=T2_401

	T2_401_mem1 = S.Task('T2_401_mem1', length=1, delay_cost=1)
	T2_401_mem1 += alt(ADD_mem)
	S += (T2_4t51*ADD[0])-1<T2_401_mem1*ADD_mem[0]
	S += (T2_4t51*ADD[1])-1<T2_401_mem1*ADD_mem[1]
	S += (T2_4t51*ADD[2])-1<T2_401_mem1*ADD_mem[2]
	S += (T2_4t51*ADD[3])-1<T2_401_mem1*ADD_mem[3]
	S += T2_401_mem1<=T2_401
	...
	S += T4_810<T4_900_mem0
	S += T4_900_mem0<=T4_900

	T4_900_mem1 = S.Task('T4_900_mem1', length=1, delay_cost=1)
	T4_900_mem1 += alt(ADD_mem)
	S += (T4_811*ADD[0])-1<T4_900_mem1*ADD_mem[0]
	S += (T4_811*ADD[1])-1<T4_900_mem1*ADD_mem[1]
	S += (T4_811*ADD[2])-1<T4_900_mem1*ADD_mem[2]
	S += (T4_811*ADD[3])-1<T4_900_mem1*ADD_mem[3]
	S += T4_900_mem1<=T4_900
	...
	S += T4_810<T4_901_mem0
	S += T4_901_mem0<=T4_901

	T4_901_mem1 = S.Task('T4_901_mem1', length=1, delay_cost=1)
	T4_901_mem1 += alt(ADD_mem)
	S += (T4_811*ADD[0])-1<T4_901_mem1*ADD_mem[0]
	S += (T4_811*ADD[1])-1<T4_901_mem1*ADD_mem[1]
	S += (T4_811*ADD[2])-1<T4_901_mem1*ADD_mem[2]
	S += (T4_811*ADD[3])-1<T4_901_mem1*ADD_mem[3]
	S += T4_901_mem1<=T4_901
	...
	S += T0_210<T0_310_mem0
	S += T0_310_mem0<=T0_310

	T0_310_mem1 = S.Task('T0_310_mem1', length=1, delay_cost=1)
	T0_310_mem1 += alt(ADD_mem)
	S += (T4_800*ADD[0])-1<T0_310_mem1*ADD_mem[0]
	S += (T4_800*ADD[1])-1<T0_310_mem1*ADD_mem[1]
	S += (T4_800*ADD[2])-1<T0_310_mem1*ADD_mem[2]
	S += (T4_800*ADD[3])-1<T0_310_mem1*ADD_mem[3]
	S += T0_310_mem1<=T0_310
	...
	S += T0_211<T0_311_mem0
	S += T0_311_mem0<=T0_311

	T0_311_mem1 = S.Task('T0_311_mem1', length=1, delay_cost=1)
	T0_311_mem1 += alt(ADD_mem)
	S += (T4_801*ADD[0])-1<T0_311_mem1*ADD_mem[0]
	S += (T4_801*ADD[1])-1<T0_311_mem1*ADD_mem[1]
	S += (T4_801*ADD[2])-1<T0_311_mem1*ADD_mem[2]
	S += (T4_801*ADD[3])-1<T0_311_mem1*ADD_mem[3]
	S += T0_311_mem1<=T0_311

	T2_600 = S.Task('T2_600', length=1, delay_cost=1)
	T2_600 += alt(ADD)

	T2_600_mem0 = S.Task('T2_600_mem0', length=1, delay_cost=1)
	T2_600_mem0 += alt(ADD_mem)
	S += (T2_500*ADD[0])-1<T2_600_mem0*ADD_mem[0]
	S += (T2_500*ADD[1])-1<T2_600_mem0*ADD_mem[1]
	S += (T2_500*ADD[2])-1<T2_600_mem0*ADD_mem[2]
	S += (T2_500*ADD[3])-1<T2_600_mem0*ADD_mem[3]
	S += T2_600_mem0<=T2_600

	T2_600_mem1 = S.Task('T2_600_mem1', length=1, delay_cost=1)
	T2_600_mem1 += alt(ADD_mem)
	S += (T3_400*ADD[0])-1<T2_600_mem1*ADD_mem[0]
	S += (T3_400*ADD[1])-1<T2_600_mem1*ADD_mem[1]
	S += (T3_400*ADD[2])-1<T2_600_mem1*ADD_mem[2]
	S += (T3_400*ADD[3])-1<T2_600_mem1*ADD_mem[3]
	S += T2_600_mem1<=T2_600

	T2_601 = S.Task('T2_601', length=1, delay_cost=1)
	T2_601 += alt(ADD)

	T2_601_mem0 = S.Task('T2_601_mem0', length=1, delay_cost=1)
	T2_601_mem0 += alt(ADD_mem)
	S += (T2_501*ADD[0])-1<T2_601_mem0*ADD_mem[0]
	S += (T2_501*ADD[1])-1<T2_601_mem0*ADD_mem[1]
	S += (T2_501*ADD[2])-1<T2_601_mem0*ADD_mem[2]
	S += (T2_501*ADD[3])-1<T2_601_mem0*ADD_mem[3]
	S += T2_601_mem0<=T2_601

	T2_601_mem1 = S.Task('T2_601_mem1', length=1, delay_cost=1)
	T2_601_mem1 += alt(ADD_mem)
	S += (T3_401*ADD[0])-1<T2_601_mem1*ADD_mem[0]
	S += (T3_401*ADD[1])-1<T2_601_mem1*ADD_mem[1]
	S += (T3_401*ADD[2])-1<T2_601_mem1*ADD_mem[2]
	S += (T3_401*ADD[3])-1<T2_601_mem1*ADD_mem[3]
	S += T2_601_mem1<=T2_601
	...
	S += T1_211<T1_311_mem0
	S += T1_311_mem0<=T1_311

	T1_311_mem1 = S.Task('T1_311_mem1', length=1, delay_cost=1)
	T1_311_mem1 += alt(ADD_mem)
	S += (T5_611*ADD[0])-1<T1_311_mem1*ADD_mem[0]
	S += (T5_611*ADD[1])-1<T1_311_mem1*ADD_mem[1]
	S += (T5_611*ADD[2])-1<T1_311_mem1*ADD_mem[2]
	S += (T5_611*ADD[3])-1<T1_311_mem1*ADD_mem[3]
	S += T1_311_mem1<=T1_311

	T4_10t0_a1b1_in = S.Task('T4_10t0_a1b1_in', length=1, delay_cost=1)
	T4_10t0_a1b1_in += alt(MUL_in)
	T4_10t0_a1b1 = S.Task('T4_10t0_a1b1', length=7, delay_cost=1)
	T4_10t0_a1b1 += alt(MUL)
	S+=T4_10t0_a1b1>=T4_10t0_a1b1_in

	T4_10t0_a1b1_mem0 = S.Task('T4_10t0_a1b1_mem0', length=1, delay_cost=1)
	T4_10t0_a1b1_mem0 += alt(ADD_mem)
	S += (T1_310*ADD[0])-1<T4_10t0_a1b1_mem0*ADD_mem[0]
	S += (T1_310*ADD[1])-1<T4_10t0_a1b1_mem0*ADD_mem[1]
	S += (T1_310*ADD[2])-1<T4_10t0_a1b1_mem0*ADD_mem[2]
	S += (T1_310*ADD[3])-1<T4_10t0_a1b1_mem0*ADD_mem[3]
	S += T4_10t0_a1b1_mem0<=T4_10t0_a1b1

	T4_10t0_a1b1_mem1 = S.Task('T4_10t0_a1b1_mem1', length=1, delay_cost=1)
	T4_10t0_a1b1_mem1 += ADD_mem[1]
	S += T20_110<T4_10t0_a1b1_mem1
	S += T4_10t0_a1b1_mem1<=T4_10t0_a1b1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_13.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_13(0, 0)