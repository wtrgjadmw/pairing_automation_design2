...
def solve_inv_mul1_add4_8(ConstStep, ExpStep):
	...
	S += T0_100<T4_400_mem0
	S += T4_400_mem0<=T4_400

	T4_400_mem1 = S.Task('T4_400_mem1', length=1, delay_cost=1)
	T4_400_mem1 += ADD_mem[1]
	S += T1_100<T4_400_mem1
	S += T4_400_mem1<=T4_400
	...
	S += T0_101<T4_401_mem0
	S += T4_401_mem0<=T4_401

	T4_401_mem1 = S.Task('T4_401_mem1', length=1, delay_cost=1)
	T4_401_mem1 += ADD_mem[0]
	S += T1_101<T4_401_mem1
	S += T4_401_mem1<=T4_401
	...
	S += T5_4c1_t0t1<T5_401_mem0
	S += T5_401_mem0<=T5_401

	T5_401_mem1 = S.Task('T5_401_mem1', length=1, delay_cost=1)
	T5_401_mem1 += ADD_mem[0]
	S += T5_4t51<T5_401_mem1
	S += T5_401_mem1<=T5_401
	...
	S += (T400*ADD[0])-1<T3_100_mem1*ADD_mem[0]
	S += (T400*ADD[1])-1<T3_100_mem1*ADD_mem[1]
	S += (T400*ADD[2])-1<T3_100_mem1*ADD_mem[2]
	S += (T400*ADD[3])-1<T3_100_mem1*ADD_mem[3]
	...
	S += (T401*ADD[0])-1<T3_101_mem1*ADD_mem[0]
	S += (T401*ADD[1])-1<T3_101_mem1*ADD_mem[1]
	S += (T401*ADD[2])-1<T3_101_mem1*ADD_mem[2]
	S += (T401*ADD[3])-1<T3_101_mem1*ADD_mem[3]
	...
	S += (T500*ADD[0])-1<T4_200_mem1*ADD_mem[0]
	S += (T500*ADD[1])-1<T4_200_mem1*ADD_mem[1]
	S += (T500*ADD[2])-1<T4_200_mem1*ADD_mem[2]
	S += (T500*ADD[3])-1<T4_200_mem1*ADD_mem[3]
	...
	S += (T501*ADD[0])-1<T4_201_mem1*ADD_mem[0]
	S += (T501*ADD[1])-1<T4_201_mem1*ADD_mem[1]
	S += (T501*ADD[2])-1<T4_201_mem1*ADD_mem[2]
	S += (T501*ADD[3])-1<T4_201_mem1*ADD_mem[3]
	...
	S += (T600*ADD[0])-1<T5_200_mem1*ADD_mem[0]
	S += (T600*ADD[1])-1<T5_200_mem1*ADD_mem[1]
	S += (T600*ADD[2])-1<T5_200_mem1*ADD_mem[2]
	S += (T600*ADD[3])-1<T5_200_mem1*ADD_mem[3]
	...
	S += (T601*ADD[0])-1<T5_201_mem1*ADD_mem[0]
	S += (T601*ADD[1])-1<T5_201_mem1*ADD_mem[1]
	S += (T601*ADD[2])-1<T5_201_mem1*ADD_mem[2]
	S += (T601*ADD[3])-1<T5_201_mem1*ADD_mem[3]
	...
	T1900_mem1 += alt(ADD_mem)
	S += (T4_300*ADD[0])-1<T1900_mem1*ADD_mem[0]
	S += (T4_300*ADD[1])-1<T1900_mem1*ADD_mem[1]
	S += (T4_300*ADD[2])-1<T1900_mem1*ADD_mem[2]
	S += (T4_300*ADD[3])-1<T1900_mem1*ADD_mem[3]
	S += T1900_mem1<=T1900
	...
	S += (T4_301*ADD[0])-1<T1901_mem1*ADD_mem[0]
	S += (T4_301*ADD[1])-1<T1901_mem1*ADD_mem[1]
	S += (T4_301*ADD[2])-1<T1901_mem1*ADD_mem[2]
	S += (T4_301*ADD[3])-1<T1901_mem1*ADD_mem[3]
	S += T1901_mem1<=T1901
	...
	T3_300_mem0 += alt(ADD_mem)
	S += (T3_200*ADD[0])-1<T3_300_mem0*ADD_mem[0]
	S += (T3_200*ADD[1])-1<T3_300_mem0*ADD_mem[1]
	S += (T3_200*ADD[2])-1<T3_300_mem0*ADD_mem[2]
	S += (T3_200*ADD[3])-1<T3_300_mem0*ADD_mem[3]
	S += T3_300_mem0<=T3_300

	T3_300_mem1 = S.Task('T3_300_mem1', length=1, delay_cost=1)
	T3_300_mem1 += alt(ADD_mem)
	S += (T4_400*ADD[0])-1<T3_300_mem1*ADD_mem[0]
	S += (T4_400*ADD[1])-1<T3_300_mem1*ADD_mem[1]
	S += (T4_400*ADD[2])-1<T3_300_mem1*ADD_mem[2]
	S += (T4_400*ADD[3])-1<T3_300_mem1*ADD_mem[3]
	S += T3_300_mem1<=T3_300

	T3_301 = S.Task('T3_301', length=1, delay_cost=1)
	T3_301 += alt(ADD)

	T3_301_mem0 = S.Task('T3_301_mem0', length=1, delay_cost=1)
	T3_301_mem0 += alt(ADD_mem)
	S += (T3_201*ADD[0])-1<T3_301_mem0*ADD_mem[0]
	S += (T3_201*ADD[1])-1<T3_301_mem0*ADD_mem[1]
	S += (T3_201*ADD[2])-1<T3_301_mem0*ADD_mem[2]
	S += (T3_201*ADD[3])-1<T3_301_mem0*ADD_mem[3]
	S += T3_301_mem0<=T3_301

	T3_301_mem1 = S.Task('T3_301_mem1', length=1, delay_cost=1)
	T3_301_mem1 += alt(ADD_mem)
	S += (T4_401*ADD[0])-1<T3_301_mem1*ADD_mem[0]
	S += (T4_401*ADD[1])-1<T3_301_mem1*ADD_mem[1]
	S += (T4_401*ADD[2])-1<T3_301_mem1*ADD_mem[2]
	S += (T4_401*ADD[3])-1<T3_301_mem1*ADD_mem[3]
	S += T3_301_mem1<=T3_301

	T4_600 = S.Task('T4_600', length=1, delay_cost=1)
	T4_600 += alt(ADD)

	T4_600_mem0 = S.Task('T4_600_mem0', length=1, delay_cost=1)
	T4_600_mem0 += alt(ADD_mem)
	S += (T4_500*ADD[0])-1<T4_600_mem0*ADD_mem[0]
	S += (T4_500*ADD[1])-1<T4_600_mem0*ADD_mem[1]
	S += (T4_500*ADD[2])-1<T4_600_mem0*ADD_mem[2]
	S += (T4_500*ADD[3])-1<T4_600_mem0*ADD_mem[3]
	S += T4_600_mem0<=T4_600

	T4_600_mem1 = S.Task('T4_600_mem1', length=1, delay_cost=1)
	T4_600_mem1 += alt(ADD_mem)
	S += (T5_300*ADD[0])-1<T4_600_mem1*ADD_mem[0]
	S += (T5_300*ADD[1])-1<T4_600_mem1*ADD_mem[1]
	S += (T5_300*ADD[2])-1<T4_600_mem1*ADD_mem[2]
	S += (T5_300*ADD[3])-1<T4_600_mem1*ADD_mem[3]
	...
	T4_601_mem0 += alt(ADD_mem)
	S += (T4_501*ADD[0])-1<T4_601_mem0*ADD_mem[0]
	S += (T4_501*ADD[1])-1<T4_601_mem0*ADD_mem[1]
	S += (T4_501*ADD[2])-1<T4_601_mem0*ADD_mem[2]
	S += (T4_501*ADD[3])-1<T4_601_mem0*ADD_mem[3]
	S += T4_601_mem0<=T4_601

	T4_601_mem1 = S.Task('T4_601_mem1', length=1, delay_cost=1)
	T4_601_mem1 += alt(ADD_mem)
	S += (T5_301*ADD[0])-1<T4_601_mem1*ADD_mem[0]
	S += (T5_301*ADD[1])-1<T4_601_mem1*ADD_mem[1]
	S += (T5_301*ADD[2])-1<T4_601_mem1*ADD_mem[2]
	S += (T5_301*ADD[3])-1<T4_601_mem1*ADD_mem[3]
	...
	T5_500_mem0 += alt(ADD_mem)
	S += (T5_400*ADD[0])-1<T5_500_mem0*ADD_mem[0]
	S += (T5_400*ADD[1])-1<T5_500_mem0*ADD_mem[1]
	S += (T5_400*ADD[2])-1<T5_500_mem0*ADD_mem[2]
	S += (T5_400*ADD[3])-1<T5_500_mem0*ADD_mem[3]
	S += T5_500_mem0<=T5_500

	T5_500_mem1 = S.Task('T5_500_mem1', length=1, delay_cost=1)
	T5_500_mem1 += alt(ADD_mem)
	S += (T6_100*ADD[0])-1<T5_500_mem1*ADD_mem[0]
	S += (T6_100*ADD[1])-1<T5_500_mem1*ADD_mem[1]
	S += (T6_100*ADD[2])-1<T5_500_mem1*ADD_mem[2]
	S += (T6_100*ADD[3])-1<T5_500_mem1*ADD_mem[3]
	...
	T5_501_mem0 += alt(ADD_mem)
	S += (T5_401*ADD[0])-1<T5_501_mem0*ADD_mem[0]
	S += (T5_401*ADD[1])-1<T5_501_mem0*ADD_mem[1]
	S += (T5_401*ADD[2])-1<T5_501_mem0*ADD_mem[2]
	S += (T5_401*ADD[3])-1<T5_501_mem0*ADD_mem[3]
	S += T5_501_mem0<=T5_501

	T5_501_mem1 = S.Task('T5_501_mem1', length=1, delay_cost=1)
	T5_501_mem1 += alt(ADD_mem)
	S += (T6_101*ADD[0])-1<T5_501_mem1*ADD_mem[0]
	S += (T6_101*ADD[1])-1<T5_501_mem1*ADD_mem[1]
	S += (T6_101*ADD[2])-1<T5_501_mem1*ADD_mem[2]
	S += (T6_101*ADD[3])-1<T5_501_mem1*ADD_mem[3]
	...
	S += (T4_700*ADD[0])-1<T2200_mem1*ADD_mem[0]
	S += (T4_700*ADD[1])-1<T2200_mem1*ADD_mem[1]
	S += (T4_700*ADD[2])-1<T2200_mem1*ADD_mem[2]
	S += (T4_700*ADD[3])-1<T2200_mem1*ADD_mem[3]
	S += T2200_mem1<=T2200
	...
	S += (T4_701*ADD[0])-1<T2201_mem1*ADD_mem[0]
	S += (T4_701*ADD[1])-1<T2201_mem1*ADD_mem[1]
	S += (T4_701*ADD[2])-1<T2201_mem1*ADD_mem[2]
	S += (T4_701*ADD[3])-1<T2201_mem1*ADD_mem[3]
	S += T2201_mem1<=T2201
	...
	S += T2410<T24_100_mem0
	S += T24_100_mem0<=T24_100

	T24_100_mem1 = S.Task('T24_100_mem1', length=1, delay_cost=1)
	T24_100_mem1 += alt(ADD_mem)
	S += (T2411*ADD[0])-1<T24_100_mem1*ADD_mem[0]
	S += (T2411*ADD[1])-1<T24_100_mem1*ADD_mem[1]
	S += (T2411*ADD[2])-1<T24_100_mem1*ADD_mem[2]
	S += (T2411*ADD[3])-1<T24_100_mem1*ADD_mem[3]
	S += T24_100_mem1<=T24_100
	...
	S += T2410<T24_101_mem0
	S += T24_101_mem0<=T24_101

	T24_101_mem1 = S.Task('T24_101_mem1', length=1, delay_cost=1)
	T24_101_mem1 += alt(ADD_mem)
	S += (T2411*ADD[0])-1<T24_101_mem1*ADD_mem[0]
	S += (T2411*ADD[1])-1<T24_101_mem1*ADD_mem[1]
	S += (T2411*ADD[2])-1<T24_101_mem1*ADD_mem[2]
	S += (T2411*ADD[3])-1<T24_101_mem1*ADD_mem[3]
	S += T24_101_mem1<=T24_101
	...
	S += T2110<T21_110_mem0
	S += T21_110_mem0<=T21_110

	T21_110_mem1 = S.Task('T21_110_mem1', length=1, delay_cost=1)
	T21_110_mem1 += alt(ADD_mem)
	S += (T2310*ADD[0])-1<T21_110_mem1*ADD_mem[0]
	S += (T2310*ADD[1])-1<T21_110_mem1*ADD_mem[1]
	S += (T2310*ADD[2])-1<T21_110_mem1*ADD_mem[2]
	S += (T2310*ADD[3])-1<T21_110_mem1*ADD_mem[3]
	S += T21_110_mem1<=T21_110

	T21_111 = S.Task('T21_111', length=1, delay_cost=1)
	T21_111 += alt(ADD)

	T21_111_mem0 = S.Task('T21_111_mem0', length=1, delay_cost=1)
	T21_111_mem0 += alt(ADD_mem)
	S += (T2111*ADD[0])-1<T21_111_mem0*ADD_mem[0]
	S += (T2111*ADD[1])-1<T21_111_mem0*ADD_mem[1]
	S += (T2111*ADD[2])-1<T21_111_mem0*ADD_mem[2]
	S += (T2111*ADD[3])-1<T21_111_mem0*ADD_mem[3]
	S += T21_111_mem0<=T21_111

	T21_111_mem1 = S.Task('T21_111_mem1', length=1, delay_cost=1)
	T21_111_mem1 += alt(ADD_mem)
	S += (T2311*ADD[0])-1<T21_111_mem1*ADD_mem[0]
	S += (T2311*ADD[1])-1<T21_111_mem1*ADD_mem[1]
	S += (T2311*ADD[2])-1<T21_111_mem1*ADD_mem[2]
	S += (T2311*ADD[3])-1<T21_111_mem1*ADD_mem[3]
	S += T21_111_mem1<=T21_111
