...
def solve_inv_mul1_add4_17(ConstStep, ExpStep):
	horizon = 305
	S=Scenario("inv_mul1_add4_17",horizon = horizon)
	...
	S += T3_511<T4_1111_mem0
	S += T4_1111_mem0<=T4_1111

	T4_1111_mem1 = S.Task('T4_1111_mem1', length=1, delay_cost=1)
	T4_1111_mem1 += ADD_mem[0]
	S += T4_1011<T4_1111_mem1
	S += T4_1111_mem1<=T4_1111
	...
	S += T4_1110<T4_1200_mem0
	S += T4_1200_mem0<=T4_1200

	T4_1200_mem1 = S.Task('T4_1200_mem1', length=1, delay_cost=1)
	T4_1200_mem1 += alt(ADD_mem)
	S += (T4_1111*ADD[0])-1<T4_1200_mem1*ADD_mem[0]
	S += (T4_1111*ADD[1])-1<T4_1200_mem1*ADD_mem[1]
	S += (T4_1111*ADD[2])-1<T4_1200_mem1*ADD_mem[2]
	S += (T4_1111*ADD[3])-1<T4_1200_mem1*ADD_mem[3]
	...
	S += T4_1110<T4_1201_mem0
	S += T4_1201_mem0<=T4_1201

	T4_1201_mem1 = S.Task('T4_1201_mem1', length=1, delay_cost=1)
	T4_1201_mem1 += alt(ADD_mem)
	S += (T4_1111*ADD[0])-1<T4_1201_mem1*ADD_mem[0]
	S += (T4_1111*ADD[1])-1<T4_1201_mem1*ADD_mem[1]
	S += (T4_1111*ADD[2])-1<T4_1201_mem1*ADD_mem[2]
	S += (T4_1111*ADD[3])-1<T4_1201_mem1*ADD_mem[3]
	...
	T4_1310_mem0 += alt(ADD_mem)
	S += (T4_1100*ADD[0])-1<T4_1310_mem0*ADD_mem[0]
	S += (T4_1100*ADD[1])-1<T4_1310_mem0*ADD_mem[1]
	S += (T4_1100*ADD[2])-1<T4_1310_mem0*ADD_mem[2]
	S += (T4_1100*ADD[3])-1<T4_1310_mem0*ADD_mem[3]
	S += T4_1310_mem0<=T4_1310

	T4_1310_mem1 = S.Task('T4_1310_mem1', length=1, delay_cost=1)
	T4_1310_mem1 += ADD_mem[2]
	S += T5_710<T4_1310_mem1
	...
	T4_1311_mem0 += alt(ADD_mem)
	S += (T4_1101*ADD[0])-1<T4_1311_mem0*ADD_mem[0]
	S += (T4_1101*ADD[1])-1<T4_1311_mem0*ADD_mem[1]
	S += (T4_1101*ADD[2])-1<T4_1311_mem0*ADD_mem[2]
	S += (T4_1101*ADD[3])-1<T4_1311_mem0*ADD_mem[3]
	S += T4_1311_mem0<=T4_1311

	T4_1311_mem1 = S.Task('T4_1311_mem1', length=1, delay_cost=1)
	T4_1311_mem1 += ADD_mem[3]
	S += T5_711<T4_1311_mem1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_17.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_17(0, 0)