...
def solve_inv_mul1_add4_34(ConstStep, ExpStep):
	horizon = 516
	S=Scenario("inv_mul1_add4_34",horizon = horizon)
	...
	T4_1800_mem0 += ADD_mem[3]
	S += T4_1710<T4_1800_mem0
	S += T4_1800_mem0<=T4_1800

	T4_1800_mem1 = S.Task('T4_1800_mem1', length=1, delay_cost=1)
	T4_1800_mem1 += ADD_mem[3]
	S += T4_1711<T4_1800_mem1
	S += T4_1800_mem1<=T4_1800

	T4_1801 = S.Task('T4_1801', length=1, delay_cost=1)
	T4_1801 += alt(ADD)

	T4_1801_mem0 = S.Task('T4_1801_mem0', length=1, delay_cost=1)
	T4_1801_mem0 += ADD_mem[3]
	S += T4_1710<T4_1801_mem0
	S += T4_1801_mem0<=T4_1801

	T4_1801_mem1 = S.Task('T4_1801_mem1', length=1, delay_cost=1)
	T4_1801_mem1 += ADD_mem[3]
	S += T4_1711<T4_1801_mem1
	S += T4_1801_mem1<=T4_1801

	T4_2200 = S.Task('T4_2200', length=1, delay_cost=1)
	T4_2200 += alt(ADD)

	T4_2200_mem0 = S.Task('T4_2200_mem0', length=1, delay_cost=1)
	T4_2200_mem0 += ADD_mem[2]
	S += T4_2110<T4_2200_mem0
	S += T4_2200_mem0<=T4_2200

	T4_2200_mem1 = S.Task('T4_2200_mem1', length=1, delay_cost=1)
	T4_2200_mem1 += ADD_mem[2]
	S += T4_2111<T4_2200_mem1
	S += T4_2200_mem1<=T4_2200

	T4_2201 = S.Task('T4_2201', length=1, delay_cost=1)
	T4_2201 += alt(ADD)

	T4_2201_mem0 = S.Task('T4_2201_mem0', length=1, delay_cost=1)
	T4_2201_mem0 += ADD_mem[2]
	S += T4_2110<T4_2201_mem0
	S += T4_2201_mem0<=T4_2201

	T4_2201_mem1 = S.Task('T4_2201_mem1', length=1, delay_cost=1)
	T4_2201_mem1 += ADD_mem[2]
	S += T4_2111<T4_2201_mem1
	S += T4_2201_mem1<=T4_2201
	...
	S += (T4_1800*ADD[0])-1<C0000_mem1*ADD_mem[0]
	S += (T4_1800*ADD[1])-1<C0000_mem1*ADD_mem[1]
	S += (T4_1800*ADD[2])-1<C0000_mem1*ADD_mem[2]
	S += (T4_1800*ADD[3])-1<C0000_mem1*ADD_mem[3]
	S += C0000_mem1<=C0000
	...
	S += (T4_1801*ADD[0])-1<C0001_mem1*ADD_mem[0]
	S += (T4_1801*ADD[1])-1<C0001_mem1*ADD_mem[1]
	S += (T4_1801*ADD[2])-1<C0001_mem1*ADD_mem[2]
	S += (T4_1801*ADD[3])-1<C0001_mem1*ADD_mem[3]
	S += C0001_mem1<=C0001
	...
	S += (T4_2200*ADD[0])-1<C1000_mem0*ADD_mem[0]
	S += (T4_2200*ADD[1])-1<C1000_mem0*ADD_mem[1]
	S += (T4_2200*ADD[2])-1<C1000_mem0*ADD_mem[2]
	S += (T4_2200*ADD[3])-1<C1000_mem0*ADD_mem[3]
	S += C1000_mem0<=C1000

	C1000_mem1 = S.Task('C1000_mem1', length=1, delay_cost=1)
	C1000_mem1 += ADD_mem[3]
	S += T0_500<C1000_mem1
	S += C1000_mem1<=C1000
	...
	S += (T4_2201*ADD[0])-1<C1001_mem0*ADD_mem[0]
	S += (T4_2201*ADD[1])-1<C1001_mem0*ADD_mem[1]
	S += (T4_2201*ADD[2])-1<C1001_mem0*ADD_mem[2]
	S += (T4_2201*ADD[3])-1<C1001_mem0*ADD_mem[3]
	S += C1001_mem0<=C1001
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_34.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_34(0, 0)