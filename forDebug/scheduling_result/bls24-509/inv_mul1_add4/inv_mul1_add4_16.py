...
def solve_inv_mul1_add4_16(ConstStep, ExpStep):
	horizon = 301
	S=Scenario("inv_mul1_add4_16",horizon = horizon)
	...
	S += T4_10c0_a0b0<T4_1000_mem0
	S += T4_1000_mem0<=T4_1000

	T4_1000_mem1 = S.Task('T4_1000_mem1', length=1, delay_cost=1)
	T4_1000_mem1 += ADD_mem[1]
	S += T4_10s0_0<T4_1000_mem1
	S += T4_1000_mem1<=T4_1000
	...
	S += T4_10c1_a0b0<T4_1001_mem0
	S += T4_1001_mem0<=T4_1001

	T4_1001_mem1 = S.Task('T4_1001_mem1', length=1, delay_cost=1)
	T4_1001_mem1 += ADD_mem[0]
	S += T4_10s0_1<T4_1001_mem1
	S += T4_1001_mem1<=T4_1001
	...
	S += T4_10c1_a0b0<T4_10t5_1_mem0
	S += T4_10t5_1_mem0<=T4_10t5_1

	T4_10t5_1_mem1 = S.Task('T4_10t5_1_mem1', length=1, delay_cost=1)
	T4_10t5_1_mem1 += ADD_mem[1]
	S += T4_10c1_a1b1<T4_10t5_1_mem1
	S += T4_10t5_1_mem1<=T4_10t5_1
	...
	S += T4_10c0_t2t3<T4_1010_mem0
	S += T4_1010_mem0<=T4_1010

	T4_1010_mem1 = S.Task('T4_1010_mem1', length=1, delay_cost=1)
	T4_1010_mem1 += ADD_mem[1]
	S += T4_10t5_0<T4_1010_mem1
	S += T4_1010_mem1<=T4_1010
	...
	T3_500_mem1 += alt(ADD_mem)
	S += (T3_5s0_0*ADD[0])-1<T3_500_mem1*ADD_mem[0]
	S += (T3_5s0_0*ADD[1])-1<T3_500_mem1*ADD_mem[1]
	S += (T3_5s0_0*ADD[2])-1<T3_500_mem1*ADD_mem[2]
	S += (T3_5s0_0*ADD[3])-1<T3_500_mem1*ADD_mem[3]
	...
	T3_501_mem1 += alt(ADD_mem)
	S += (T3_5s0_1*ADD[0])-1<T3_501_mem1*ADD_mem[0]
	S += (T3_5s0_1*ADD[1])-1<T3_501_mem1*ADD_mem[1]
	S += (T3_5s0_1*ADD[2])-1<T3_501_mem1*ADD_mem[2]
	S += (T3_5s0_1*ADD[3])-1<T3_501_mem1*ADD_mem[3]
	...
	T3_511_mem0 += alt(ADD_mem)
	S += (T3_5c1_t2t3*ADD[0])-1<T3_511_mem0*ADD_mem[0]
	S += (T3_5c1_t2t3*ADD[1])-1<T3_511_mem0*ADD_mem[1]
	S += (T3_5c1_t2t3*ADD[2])-1<T3_511_mem0*ADD_mem[2]
	S += (T3_5c1_t2t3*ADD[3])-1<T3_511_mem0*ADD_mem[3]
	S += T3_511_mem0<=T3_511

	T3_511_mem1 = S.Task('T3_511_mem1', length=1, delay_cost=1)
	T3_511_mem1 += alt(ADD_mem)
	S += (T3_5t5_1*ADD[0])-1<T3_511_mem1*ADD_mem[0]
	S += (T3_5t5_1*ADD[1])-1<T3_511_mem1*ADD_mem[1]
	S += (T3_5t5_1*ADD[2])-1<T3_511_mem1*ADD_mem[2]
	S += (T3_5t5_1*ADD[3])-1<T3_511_mem1*ADD_mem[3]
	...
	T4_1011_mem0 += alt(ADD_mem)
	S += (T4_10c1_t2t3*ADD[0])-1<T4_1011_mem0*ADD_mem[0]
	S += (T4_10c1_t2t3*ADD[1])-1<T4_1011_mem0*ADD_mem[1]
	S += (T4_10c1_t2t3*ADD[2])-1<T4_1011_mem0*ADD_mem[2]
	S += (T4_10c1_t2t3*ADD[3])-1<T4_1011_mem0*ADD_mem[3]
	S += T4_1011_mem0<=T4_1011

	T4_1011_mem1 = S.Task('T4_1011_mem1', length=1, delay_cost=1)
	T4_1011_mem1 += alt(ADD_mem)
	S += (T4_10t5_1*ADD[0])-1<T4_1011_mem1*ADD_mem[0]
	S += (T4_10t5_1*ADD[1])-1<T4_1011_mem1*ADD_mem[1]
	S += (T4_10t5_1*ADD[2])-1<T4_1011_mem1*ADD_mem[2]
	S += (T4_10t5_1*ADD[3])-1<T4_1011_mem1*ADD_mem[3]
	S += T4_1011_mem1<=T4_1011

	T4_1110 = S.Task('T4_1110', length=1, delay_cost=1)
	T4_1110 += alt(ADD)

	T4_1110_mem0 = S.Task('T4_1110_mem0', length=1, delay_cost=1)
	T4_1110_mem0 += alt(ADD_mem)
	S += (T3_510*ADD[0])-1<T4_1110_mem0*ADD_mem[0]
	S += (T3_510*ADD[1])-1<T4_1110_mem0*ADD_mem[1]
	S += (T3_510*ADD[2])-1<T4_1110_mem0*ADD_mem[2]
	S += (T3_510*ADD[3])-1<T4_1110_mem0*ADD_mem[3]
	S += T4_1110_mem0<=T4_1110

	T4_1110_mem1 = S.Task('T4_1110_mem1', length=1, delay_cost=1)
	T4_1110_mem1 += alt(ADD_mem)
	S += (T4_1010*ADD[0])-1<T4_1110_mem1*ADD_mem[0]
	S += (T4_1010*ADD[1])-1<T4_1110_mem1*ADD_mem[1]
	S += (T4_1010*ADD[2])-1<T4_1110_mem1*ADD_mem[2]
	S += (T4_1010*ADD[3])-1<T4_1110_mem1*ADD_mem[3]
	S += T4_1110_mem1<=T4_1110

	T5_711 = S.Task('T5_711', length=1, delay_cost=1)
	T5_711 += alt(ADD)

	T5_711_mem0 = S.Task('T5_711_mem0', length=1, delay_cost=1)
	T5_711_mem0 += alt(ADD_mem)
	S += (T5_7c1_t2t3*ADD[0])-1<T5_711_mem0*ADD_mem[0]
	S += (T5_7c1_t2t3*ADD[1])-1<T5_711_mem0*ADD_mem[1]
	S += (T5_7c1_t2t3*ADD[2])-1<T5_711_mem0*ADD_mem[2]
	S += (T5_7c1_t2t3*ADD[3])-1<T5_711_mem0*ADD_mem[3]
	S += T5_711_mem0<=T5_711

	T5_711_mem1 = S.Task('T5_711_mem1', length=1, delay_cost=1)
	T5_711_mem1 += alt(ADD_mem)
	S += (T5_7t5_1*ADD[0])-1<T5_711_mem1*ADD_mem[0]
	S += (T5_7t5_1*ADD[1])-1<T5_711_mem1*ADD_mem[1]
	S += (T5_7t5_1*ADD[2])-1<T5_711_mem1*ADD_mem[2]
	S += (T5_7t5_1*ADD[3])-1<T5_711_mem1*ADD_mem[3]
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_16.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_16(0, 0)