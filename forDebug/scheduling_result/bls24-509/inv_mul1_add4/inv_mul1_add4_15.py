...
def solve_inv_mul1_add4_15(ConstStep, ExpStep):
	horizon = 284
	S=Scenario("inv_mul1_add4_15",horizon = horizon)
	...
	S += T3_5t0_a1b1<T3_5c0_a1b1_mem0
	S += T3_5c0_a1b1_mem0<=T3_5c0_a1b1

	T3_5c0_a1b1_mem1 = S.Task('T3_5c0_a1b1_mem1', length=1, delay_cost=1)
	T3_5c0_a1b1_mem1 += MUL_mem[0]
	S += T3_5t1_a1b1<T3_5c0_a1b1_mem1
	S += T3_5c0_a1b1_mem1<=T3_5c0_a1b1
	...
	S += T5_7t0_a0b0<T5_7c0_a0b0_mem0
	S += T5_7c0_a0b0_mem0<=T5_7c0_a0b0

	T5_7c0_a0b0_mem1 = S.Task('T5_7c0_a0b0_mem1', length=1, delay_cost=1)
	T5_7c0_a0b0_mem1 += MUL_mem[0]
	S += T5_7t1_a0b0<T5_7c0_a0b0_mem1
	S += T5_7c0_a0b0_mem1<=T5_7c0_a0b0
	...
	S += T5_7t0_a0b0<T5_7t6_a0b0_mem0
	S += T5_7t6_a0b0_mem0<=T5_7t6_a0b0

	T5_7t6_a0b0_mem1 = S.Task('T5_7t6_a0b0_mem1', length=1, delay_cost=1)
	T5_7t6_a0b0_mem1 += MUL_mem[0]
	S += T5_7t1_a0b0<T5_7t6_a0b0_mem1
	S += T5_7t6_a0b0_mem1<=T5_7t6_a0b0
	...
	S += T5_7t2_0<T5_7t2_t2t3_mem0
	S += T5_7t2_t2t3_mem0<=T5_7t2_t2t3

	T5_7t2_t2t3_mem1 = S.Task('T5_7t2_t2t3_mem1', length=1, delay_cost=1)
	T5_7t2_t2t3_mem1 += ADD_mem[1]
	S += T5_7t2_1<T5_7t2_t2t3_mem1
	S += T5_7t2_t2t3_mem1<=T5_7t2_t2t3

	T3_5c1_a1b1 = S.Task('T3_5c1_a1b1', length=1, delay_cost=1)
	T3_5c1_a1b1 += alt(ADD)

	T3_5c1_a1b1_mem0 = S.Task('T3_5c1_a1b1_mem0', length=1, delay_cost=1)
	T3_5c1_a1b1_mem0 += alt(MUL_mem)
	S += (T3_5t4_a1b1*MUL[0])-1<T3_5c1_a1b1_mem0*MUL_mem[0]
	S += T3_5c1_a1b1_mem0<=T3_5c1_a1b1

	T3_5c1_a1b1_mem1 = S.Task('T3_5c1_a1b1_mem1', length=1, delay_cost=1)
	T3_5c1_a1b1_mem1 += alt(ADD_mem)
	S += (T3_5t6_a1b1*ADD[0])-1<T3_5c1_a1b1_mem1*ADD_mem[0]
	S += (T3_5t6_a1b1*ADD[1])-1<T3_5c1_a1b1_mem1*ADD_mem[1]
	S += (T3_5t6_a1b1*ADD[2])-1<T3_5c1_a1b1_mem1*ADD_mem[2]
	S += (T3_5t6_a1b1*ADD[3])-1<T3_5c1_a1b1_mem1*ADD_mem[3]
	...
	T3_5t4_t2t3_mem0 += alt(ADD_mem)
	S += (T3_5t2_t2t3*ADD[0])-1<T3_5t4_t2t3_mem0*ADD_mem[0]
	S += (T3_5t2_t2t3*ADD[1])-1<T3_5t4_t2t3_mem0*ADD_mem[1]
	S += (T3_5t2_t2t3*ADD[2])-1<T3_5t4_t2t3_mem0*ADD_mem[2]
	S += (T3_5t2_t2t3*ADD[3])-1<T3_5t4_t2t3_mem0*ADD_mem[3]
	S += T3_5t4_t2t3_mem0<=T3_5t4_t2t3

	T3_5t4_t2t3_mem1 = S.Task('T3_5t4_t2t3_mem1', length=1, delay_cost=1)
	T3_5t4_t2t3_mem1 += ADD_mem[1]
	S += T2_4t3_t0t1<T3_5t4_t2t3_mem1
	...
	T3_5c0_t2t3_mem0 += alt(MUL_mem)
	S += (T3_5t0_t2t3*MUL[0])-1<T3_5c0_t2t3_mem0*MUL_mem[0]
	S += T3_5c0_t2t3_mem0<=T3_5c0_t2t3

	T3_5c0_t2t3_mem1 = S.Task('T3_5c0_t2t3_mem1', length=1, delay_cost=1)
	T3_5c0_t2t3_mem1 += alt(MUL_mem)
	S += (T3_5t1_t2t3*MUL[0])-1<T3_5c0_t2t3_mem1*MUL_mem[0]
	...
	T3_5t6_t2t3_mem0 += alt(MUL_mem)
	S += (T3_5t0_t2t3*MUL[0])-1<T3_5t6_t2t3_mem0*MUL_mem[0]
	S += T3_5t6_t2t3_mem0<=T3_5t6_t2t3

	T3_5t6_t2t3_mem1 = S.Task('T3_5t6_t2t3_mem1', length=1, delay_cost=1)
	T3_5t6_t2t3_mem1 += alt(MUL_mem)
	S += (T3_5t1_t2t3*MUL[0])-1<T3_5t6_t2t3_mem1*MUL_mem[0]
	...
	T3_5t5_0_mem1 += alt(ADD_mem)
	S += (T3_5c0_a1b1*ADD[0])-1<T3_5t5_0_mem1*ADD_mem[0]
	S += (T3_5c0_a1b1*ADD[1])-1<T3_5t5_0_mem1*ADD_mem[1]
	S += (T3_5c0_a1b1*ADD[2])-1<T3_5t5_0_mem1*ADD_mem[2]
	S += (T3_5c0_a1b1*ADD[3])-1<T3_5t5_0_mem1*ADD_mem[3]
	S += T3_5t5_0_mem1<=T3_5t5_0

	T4_10c1_a0b0 = S.Task('T4_10c1_a0b0', length=1, delay_cost=1)
	T4_10c1_a0b0 += alt(ADD)

	T4_10c1_a0b0_mem0 = S.Task('T4_10c1_a0b0_mem0', length=1, delay_cost=1)
	T4_10c1_a0b0_mem0 += alt(MUL_mem)
	S += (T4_10t4_a0b0*MUL[0])-1<T4_10c1_a0b0_mem0*MUL_mem[0]
	S += T4_10c1_a0b0_mem0<=T4_10c1_a0b0

	T4_10c1_a0b0_mem1 = S.Task('T4_10c1_a0b0_mem1', length=1, delay_cost=1)
	T4_10c1_a0b0_mem1 += alt(ADD_mem)
	S += (T4_10t6_a0b0*ADD[0])-1<T4_10c1_a0b0_mem1*ADD_mem[0]
	S += (T4_10t6_a0b0*ADD[1])-1<T4_10c1_a0b0_mem1*ADD_mem[1]
	S += (T4_10t6_a0b0*ADD[2])-1<T4_10c1_a0b0_mem1*ADD_mem[2]
	S += (T4_10t6_a0b0*ADD[3])-1<T4_10c1_a0b0_mem1*ADD_mem[3]
	S += T4_10c1_a0b0_mem1<=T4_10c1_a0b0

	T4_10t4_t2t3_in = S.Task('T4_10t4_t2t3_in', length=1, delay_cost=1)
	T4_10t4_t2t3_in += alt(MUL_in)
	T4_10t4_t2t3 = S.Task('T4_10t4_t2t3', length=7, delay_cost=1)
	T4_10t4_t2t3 += alt(MUL)
	S+=T4_10t4_t2t3>=T4_10t4_t2t3_in

	T4_10t4_t2t3_mem0 = S.Task('T4_10t4_t2t3_mem0', length=1, delay_cost=1)
	T4_10t4_t2t3_mem0 += alt(ADD_mem)
	S += (T4_10t2_t2t3*ADD[0])-1<T4_10t4_t2t3_mem0*ADD_mem[0]
	S += (T4_10t2_t2t3*ADD[1])-1<T4_10t4_t2t3_mem0*ADD_mem[1]
	S += (T4_10t2_t2t3*ADD[2])-1<T4_10t4_t2t3_mem0*ADD_mem[2]
	S += (T4_10t2_t2t3*ADD[3])-1<T4_10t4_t2t3_mem0*ADD_mem[3]
	S += T4_10t4_t2t3_mem0<=T4_10t4_t2t3

	T4_10t4_t2t3_mem1 = S.Task('T4_10t4_t2t3_mem1', length=1, delay_cost=1)
	T4_10t4_t2t3_mem1 += ADD_mem[0]
	S += T1_2t3_t0t1<T4_10t4_t2t3_mem1
	S += T4_10t4_t2t3_mem1<=T4_10t4_t2t3

	T4_10c0_t2t3 = S.Task('T4_10c0_t2t3', length=1, delay_cost=1)
	T4_10c0_t2t3 += alt(ADD)

	T4_10c0_t2t3_mem0 = S.Task('T4_10c0_t2t3_mem0', length=1, delay_cost=1)
	T4_10c0_t2t3_mem0 += alt(MUL_mem)
	S += (T4_10t0_t2t3*MUL[0])-1<T4_10c0_t2t3_mem0*MUL_mem[0]
	S += T4_10c0_t2t3_mem0<=T4_10c0_t2t3

	T4_10c0_t2t3_mem1 = S.Task('T4_10c0_t2t3_mem1', length=1, delay_cost=1)
	T4_10c0_t2t3_mem1 += alt(MUL_mem)
	S += (T4_10t1_t2t3*MUL[0])-1<T4_10c0_t2t3_mem1*MUL_mem[0]
	S += T4_10c0_t2t3_mem1<=T4_10c0_t2t3

	T4_10t6_t2t3 = S.Task('T4_10t6_t2t3', length=1, delay_cost=1)
	T4_10t6_t2t3 += alt(ADD)

	T4_10t6_t2t3_mem0 = S.Task('T4_10t6_t2t3_mem0', length=1, delay_cost=1)
	T4_10t6_t2t3_mem0 += alt(MUL_mem)
	S += (T4_10t0_t2t3*MUL[0])-1<T4_10t6_t2t3_mem0*MUL_mem[0]
	S += T4_10t6_t2t3_mem0<=T4_10t6_t2t3

	T4_10t6_t2t3_mem1 = S.Task('T4_10t6_t2t3_mem1', length=1, delay_cost=1)
	T4_10t6_t2t3_mem1 += alt(MUL_mem)
	S += (T4_10t1_t2t3*MUL[0])-1<T4_10t6_t2t3_mem1*MUL_mem[0]
	S += T4_10t6_t2t3_mem1<=T4_10t6_t2t3
	...
	S += T4_10c0_a1b1<T4_10s0_0_mem0
	S += T4_10s0_0_mem0<=T4_10s0_0

	T4_10s0_0_mem1 = S.Task('T4_10s0_0_mem1', length=1, delay_cost=1)
	T4_10s0_0_mem1 += alt(ADD_mem)
	S += (T4_10c1_a1b1*ADD[0])-1<T4_10s0_0_mem1*ADD_mem[0]
	S += (T4_10c1_a1b1*ADD[1])-1<T4_10s0_0_mem1*ADD_mem[1]
	S += (T4_10c1_a1b1*ADD[2])-1<T4_10s0_0_mem1*ADD_mem[2]
	S += (T4_10c1_a1b1*ADD[3])-1<T4_10s0_0_mem1*ADD_mem[3]
	S += T4_10s0_0_mem1<=T4_10s0_0

	T4_10s0_1 = S.Task('T4_10s0_1', length=1, delay_cost=1)
	T4_10s0_1 += alt(ADD)

	T4_10s0_1_mem0 = S.Task('T4_10s0_1_mem0', length=1, delay_cost=1)
	T4_10s0_1_mem0 += alt(ADD_mem)
	S += (T4_10c1_a1b1*ADD[0])-1<T4_10s0_1_mem0*ADD_mem[0]
	S += (T4_10c1_a1b1*ADD[1])-1<T4_10s0_1_mem0*ADD_mem[1]
	S += (T4_10c1_a1b1*ADD[2])-1<T4_10s0_1_mem0*ADD_mem[2]
	S += (T4_10c1_a1b1*ADD[3])-1<T4_10s0_1_mem0*ADD_mem[3]
	S += T4_10s0_1_mem0<=T4_10s0_1

	T4_10s0_1_mem1 = S.Task('T4_10s0_1_mem1', length=1, delay_cost=1)
	T4_10s0_1_mem1 += ADD_mem[3]
	S += T4_10c0_a1b1<T4_10s0_1_mem1
	S += T4_10s0_1_mem1<=T4_10s0_1

	T4_10t5_0 = S.Task('T4_10t5_0', length=1, delay_cost=1)
	T4_10t5_0 += alt(ADD)

	T4_10t5_0_mem0 = S.Task('T4_10t5_0_mem0', length=1, delay_cost=1)
	T4_10t5_0_mem0 += alt(ADD_mem)
	S += (T4_10c0_a0b0*ADD[0])-1<T4_10t5_0_mem0*ADD_mem[0]
	S += (T4_10c0_a0b0*ADD[1])-1<T4_10t5_0_mem0*ADD_mem[1]
	S += (T4_10c0_a0b0*ADD[2])-1<T4_10t5_0_mem0*ADD_mem[2]
	S += (T4_10c0_a0b0*ADD[3])-1<T4_10t5_0_mem0*ADD_mem[3]
	S += T4_10t5_0_mem0<=T4_10t5_0

	T4_10t5_0_mem1 = S.Task('T4_10t5_0_mem1', length=1, delay_cost=1)
	T4_10t5_0_mem1 += ADD_mem[3]
	S += T4_10c0_a1b1<T4_10t5_0_mem1
	S += T4_10t5_0_mem1<=T4_10t5_0

	T5_7c1_a0b0 = S.Task('T5_7c1_a0b0', length=1, delay_cost=1)
	T5_7c1_a0b0 += alt(ADD)

	T5_7c1_a0b0_mem0 = S.Task('T5_7c1_a0b0_mem0', length=1, delay_cost=1)
	T5_7c1_a0b0_mem0 += alt(MUL_mem)
	S += (T5_7t4_a0b0*MUL[0])-1<T5_7c1_a0b0_mem0*MUL_mem[0]
	S += T5_7c1_a0b0_mem0<=T5_7c1_a0b0

	T5_7c1_a0b0_mem1 = S.Task('T5_7c1_a0b0_mem1', length=1, delay_cost=1)
	T5_7c1_a0b0_mem1 += alt(ADD_mem)
	S += (T5_7t6_a0b0*ADD[0])-1<T5_7c1_a0b0_mem1*ADD_mem[0]
	S += (T5_7t6_a0b0*ADD[1])-1<T5_7c1_a0b0_mem1*ADD_mem[1]
	S += (T5_7t6_a0b0*ADD[2])-1<T5_7c1_a0b0_mem1*ADD_mem[2]
	S += (T5_7t6_a0b0*ADD[3])-1<T5_7c1_a0b0_mem1*ADD_mem[3]
	S += T5_7c1_a0b0_mem1<=T5_7c1_a0b0

	T5_7t4_t2t3_in = S.Task('T5_7t4_t2t3_in', length=1, delay_cost=1)
	T5_7t4_t2t3_in += alt(MUL_in)
	T5_7t4_t2t3 = S.Task('T5_7t4_t2t3', length=7, delay_cost=1)
	T5_7t4_t2t3 += alt(MUL)
	S+=T5_7t4_t2t3>=T5_7t4_t2t3_in

	T5_7t4_t2t3_mem0 = S.Task('T5_7t4_t2t3_mem0', length=1, delay_cost=1)
	T5_7t4_t2t3_mem0 += alt(ADD_mem)
	S += (T5_7t2_t2t3*ADD[0])-1<T5_7t4_t2t3_mem0*ADD_mem[0]
	S += (T5_7t2_t2t3*ADD[1])-1<T5_7t4_t2t3_mem0*ADD_mem[1]
	S += (T5_7t2_t2t3*ADD[2])-1<T5_7t4_t2t3_mem0*ADD_mem[2]
	S += (T5_7t2_t2t3*ADD[3])-1<T5_7t4_t2t3_mem0*ADD_mem[3]
	S += T5_7t4_t2t3_mem0<=T5_7t4_t2t3

	T5_7t4_t2t3_mem1 = S.Task('T5_7t4_t2t3_mem1', length=1, delay_cost=1)
	T5_7t4_t2t3_mem1 += ADD_mem[0]
	S += T0_2t3_t0t1<T5_7t4_t2t3_mem1
	S += T5_7t4_t2t3_mem1<=T5_7t4_t2t3

	T5_7c0_t2t3 = S.Task('T5_7c0_t2t3', length=1, delay_cost=1)
	T5_7c0_t2t3 += alt(ADD)

	T5_7c0_t2t3_mem0 = S.Task('T5_7c0_t2t3_mem0', length=1, delay_cost=1)
	T5_7c0_t2t3_mem0 += alt(MUL_mem)
	S += (T5_7t0_t2t3*MUL[0])-1<T5_7c0_t2t3_mem0*MUL_mem[0]
	S += T5_7c0_t2t3_mem0<=T5_7c0_t2t3

	T5_7c0_t2t3_mem1 = S.Task('T5_7c0_t2t3_mem1', length=1, delay_cost=1)
	T5_7c0_t2t3_mem1 += alt(MUL_mem)
	S += (T5_7t1_t2t3*MUL[0])-1<T5_7c0_t2t3_mem1*MUL_mem[0]
	S += T5_7c0_t2t3_mem1<=T5_7c0_t2t3

	T5_7t6_t2t3 = S.Task('T5_7t6_t2t3', length=1, delay_cost=1)
	T5_7t6_t2t3 += alt(ADD)

	T5_7t6_t2t3_mem0 = S.Task('T5_7t6_t2t3_mem0', length=1, delay_cost=1)
	T5_7t6_t2t3_mem0 += alt(MUL_mem)
	S += (T5_7t0_t2t3*MUL[0])-1<T5_7t6_t2t3_mem0*MUL_mem[0]
	S += T5_7t6_t2t3_mem0<=T5_7t6_t2t3

	T5_7t6_t2t3_mem1 = S.Task('T5_7t6_t2t3_mem1', length=1, delay_cost=1)
	T5_7t6_t2t3_mem1 += alt(MUL_mem)
	S += (T5_7t1_t2t3*MUL[0])-1<T5_7t6_t2t3_mem1*MUL_mem[0]
	S += T5_7t6_t2t3_mem1<=T5_7t6_t2t3
	...
	S += T5_7c0_a1b1<T5_7s0_0_mem0
	S += T5_7s0_0_mem0<=T5_7s0_0

	T5_7s0_0_mem1 = S.Task('T5_7s0_0_mem1', length=1, delay_cost=1)
	T5_7s0_0_mem1 += alt(ADD_mem)
	S += (T5_7c1_a1b1*ADD[0])-1<T5_7s0_0_mem1*ADD_mem[0]
	S += (T5_7c1_a1b1*ADD[1])-1<T5_7s0_0_mem1*ADD_mem[1]
	S += (T5_7c1_a1b1*ADD[2])-1<T5_7s0_0_mem1*ADD_mem[2]
	S += (T5_7c1_a1b1*ADD[3])-1<T5_7s0_0_mem1*ADD_mem[3]
	S += T5_7s0_0_mem1<=T5_7s0_0

	T5_7s0_1 = S.Task('T5_7s0_1', length=1, delay_cost=1)
	T5_7s0_1 += alt(ADD)

	T5_7s0_1_mem0 = S.Task('T5_7s0_1_mem0', length=1, delay_cost=1)
	T5_7s0_1_mem0 += alt(ADD_mem)
	S += (T5_7c1_a1b1*ADD[0])-1<T5_7s0_1_mem0*ADD_mem[0]
	S += (T5_7c1_a1b1*ADD[1])-1<T5_7s0_1_mem0*ADD_mem[1]
	S += (T5_7c1_a1b1*ADD[2])-1<T5_7s0_1_mem0*ADD_mem[2]
	S += (T5_7c1_a1b1*ADD[3])-1<T5_7s0_1_mem0*ADD_mem[3]
	S += T5_7s0_1_mem0<=T5_7s0_1

	T5_7s0_1_mem1 = S.Task('T5_7s0_1_mem1', length=1, delay_cost=1)
	T5_7s0_1_mem1 += ADD_mem[3]
	S += T5_7c0_a1b1<T5_7s0_1_mem1
	S += T5_7s0_1_mem1<=T5_7s0_1

	T5_7t5_0 = S.Task('T5_7t5_0', length=1, delay_cost=1)
	T5_7t5_0 += alt(ADD)

	T5_7t5_0_mem0 = S.Task('T5_7t5_0_mem0', length=1, delay_cost=1)
	T5_7t5_0_mem0 += alt(ADD_mem)
	S += (T5_7c0_a0b0*ADD[0])-1<T5_7t5_0_mem0*ADD_mem[0]
	S += (T5_7c0_a0b0*ADD[1])-1<T5_7t5_0_mem0*ADD_mem[1]
	S += (T5_7c0_a0b0*ADD[2])-1<T5_7t5_0_mem0*ADD_mem[2]
	S += (T5_7c0_a0b0*ADD[3])-1<T5_7t5_0_mem0*ADD_mem[3]
	S += T5_7t5_0_mem0<=T5_7t5_0

	T5_7t5_0_mem1 = S.Task('T5_7t5_0_mem1', length=1, delay_cost=1)
	T5_7t5_0_mem1 += ADD_mem[3]
	S += T5_7c0_a1b1<T5_7t5_0_mem1
	S += T5_7t5_0_mem1<=T5_7t5_0
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_15.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_15(0, 0)