...
def solve_inv_mul1_add4_18(ConstStep, ExpStep):
	horizon = 308
	S=Scenario("inv_mul1_add4_18",horizon = horizon)
	...
	S += T4_1310<T4_14t0_a1_mem0
	S += T4_14t0_a1_mem0<=T4_14t0_a1

	T4_14t0_a1_mem1 = S.Task('T4_14t0_a1_mem1', length=1, delay_cost=1)
	T4_14t0_a1_mem1 += ADD_mem[2]
	S += T4_1311<T4_14t0_a1_mem1
	S += T4_14t0_a1_mem1<=T4_14t0_a1
	...
	S += T4_1310<T4_14t1_a1_mem0
	S += T4_14t1_a1_mem0<=T4_14t1_a1

	T4_14t1_a1_mem1 = S.Task('T4_14t1_a1_mem1', length=1, delay_cost=1)
	T4_14t1_a1_mem1 += ADD_mem[2]
	S += T4_1311<T4_14t1_a1_mem1
	S += T4_14t1_a1_mem1<=T4_14t1_a1

	T4_14t3_a1_in = S.Task('T4_14t3_a1_in', length=1, delay_cost=1)
	T4_14t3_a1_in += alt(MUL_in)
	T4_14t3_a1 = S.Task('T4_14t3_a1', length=7, delay_cost=1)
	T4_14t3_a1 += alt(MUL)
	S+=T4_14t3_a1>=T4_14t3_a1_in

	T4_14t3_a1_mem0 = S.Task('T4_14t3_a1_mem0', length=1, delay_cost=1)
	T4_14t3_a1_mem0 += ADD_mem[1]
	S += T4_1310<T4_14t3_a1_mem0
	S += T4_14t3_a1_mem0<=T4_14t3_a1

	T4_14t3_a1_mem1 = S.Task('T4_14t3_a1_mem1', length=1, delay_cost=1)
	T4_14t3_a1_mem1 += ADD_mem[2]
	S += T4_1311<T4_14t3_a1_mem1
	S += T4_14t3_a1_mem1<=T4_14t3_a1

	T4_14t0_a0 = S.Task('T4_14t0_a0', length=1, delay_cost=1)
	T4_14t0_a0 += alt(ADD)

	T4_14t0_a0_mem0 = S.Task('T4_14t0_a0_mem0', length=1, delay_cost=1)
	T4_14t0_a0_mem0 += alt(ADD_mem)
	S += (T4_1300*ADD[0])-1<T4_14t0_a0_mem0*ADD_mem[0]
	S += (T4_1300*ADD[1])-1<T4_14t0_a0_mem0*ADD_mem[1]
	S += (T4_1300*ADD[2])-1<T4_14t0_a0_mem0*ADD_mem[2]
	S += (T4_1300*ADD[3])-1<T4_14t0_a0_mem0*ADD_mem[3]
	S += T4_14t0_a0_mem0<=T4_14t0_a0

	T4_14t0_a0_mem1 = S.Task('T4_14t0_a0_mem1', length=1, delay_cost=1)
	T4_14t0_a0_mem1 += alt(ADD_mem)
	S += (T4_1301*ADD[0])-1<T4_14t0_a0_mem1*ADD_mem[0]
	S += (T4_1301*ADD[1])-1<T4_14t0_a0_mem1*ADD_mem[1]
	S += (T4_1301*ADD[2])-1<T4_14t0_a0_mem1*ADD_mem[2]
	S += (T4_1301*ADD[3])-1<T4_14t0_a0_mem1*ADD_mem[3]
	S += T4_14t0_a0_mem1<=T4_14t0_a0

	T4_14t1_a0 = S.Task('T4_14t1_a0', length=1, delay_cost=1)
	T4_14t1_a0 += alt(ADD)

	T4_14t1_a0_mem0 = S.Task('T4_14t1_a0_mem0', length=1, delay_cost=1)
	T4_14t1_a0_mem0 += alt(ADD_mem)
	S += (T4_1300*ADD[0])-1<T4_14t1_a0_mem0*ADD_mem[0]
	S += (T4_1300*ADD[1])-1<T4_14t1_a0_mem0*ADD_mem[1]
	S += (T4_1300*ADD[2])-1<T4_14t1_a0_mem0*ADD_mem[2]
	S += (T4_1300*ADD[3])-1<T4_14t1_a0_mem0*ADD_mem[3]
	S += T4_14t1_a0_mem0<=T4_14t1_a0

	T4_14t1_a0_mem1 = S.Task('T4_14t1_a0_mem1', length=1, delay_cost=1)
	T4_14t1_a0_mem1 += alt(ADD_mem)
	S += (T4_1301*ADD[0])-1<T4_14t1_a0_mem1*ADD_mem[0]
	S += (T4_1301*ADD[1])-1<T4_14t1_a0_mem1*ADD_mem[1]
	S += (T4_1301*ADD[2])-1<T4_14t1_a0_mem1*ADD_mem[2]
	S += (T4_1301*ADD[3])-1<T4_14t1_a0_mem1*ADD_mem[3]
	S += T4_14t1_a0_mem1<=T4_14t1_a0

	T4_14t3_a0_in = S.Task('T4_14t3_a0_in', length=1, delay_cost=1)
	T4_14t3_a0_in += alt(MUL_in)
	T4_14t3_a0 = S.Task('T4_14t3_a0', length=7, delay_cost=1)
	T4_14t3_a0 += alt(MUL)
	S+=T4_14t3_a0>=T4_14t3_a0_in

	T4_14t3_a0_mem0 = S.Task('T4_14t3_a0_mem0', length=1, delay_cost=1)
	T4_14t3_a0_mem0 += alt(ADD_mem)
	S += (T4_1300*ADD[0])-1<T4_14t3_a0_mem0*ADD_mem[0]
	S += (T4_1300*ADD[1])-1<T4_14t3_a0_mem0*ADD_mem[1]
	S += (T4_1300*ADD[2])-1<T4_14t3_a0_mem0*ADD_mem[2]
	S += (T4_1300*ADD[3])-1<T4_14t3_a0_mem0*ADD_mem[3]
	S += T4_14t3_a0_mem0<=T4_14t3_a0

	T4_14t3_a0_mem1 = S.Task('T4_14t3_a0_mem1', length=1, delay_cost=1)
	T4_14t3_a0_mem1 += alt(ADD_mem)
	S += (T4_1301*ADD[0])-1<T4_14t3_a0_mem1*ADD_mem[0]
	S += (T4_1301*ADD[1])-1<T4_14t3_a0_mem1*ADD_mem[1]
	S += (T4_1301*ADD[2])-1<T4_14t3_a0_mem1*ADD_mem[2]
	S += (T4_1301*ADD[3])-1<T4_14t3_a0_mem1*ADD_mem[3]
	S += T4_14t3_a0_mem1<=T4_14t3_a0

	T4_14c0_a1_in = S.Task('T4_14c0_a1_in', length=1, delay_cost=1)
	T4_14c0_a1_in += alt(MUL_in)
	T4_14c0_a1 = S.Task('T4_14c0_a1', length=7, delay_cost=1)
	T4_14c0_a1 += alt(MUL)
	S+=T4_14c0_a1>=T4_14c0_a1_in

	T4_14c0_a1_mem0 = S.Task('T4_14c0_a1_mem0', length=1, delay_cost=1)
	T4_14c0_a1_mem0 += alt(ADD_mem)
	S += (T4_14t0_a1*ADD[0])-1<T4_14c0_a1_mem0*ADD_mem[0]
	S += (T4_14t0_a1*ADD[1])-1<T4_14c0_a1_mem0*ADD_mem[1]
	S += (T4_14t0_a1*ADD[2])-1<T4_14c0_a1_mem0*ADD_mem[2]
	S += (T4_14t0_a1*ADD[3])-1<T4_14c0_a1_mem0*ADD_mem[3]
	S += T4_14c0_a1_mem0<=T4_14c0_a1

	T4_14c0_a1_mem1 = S.Task('T4_14c0_a1_mem1', length=1, delay_cost=1)
	T4_14c0_a1_mem1 += alt(ADD_mem)
	S += (T4_14t1_a1*ADD[0])-1<T4_14c0_a1_mem1*ADD_mem[0]
	S += (T4_14t1_a1*ADD[1])-1<T4_14c0_a1_mem1*ADD_mem[1]
	S += (T4_14t1_a1*ADD[2])-1<T4_14c0_a1_mem1*ADD_mem[2]
	S += (T4_14t1_a1*ADD[3])-1<T4_14c0_a1_mem1*ADD_mem[3]
	S += T4_14c0_a1_mem1<=T4_14c0_a1

	T4_14c1_a1 = S.Task('T4_14c1_a1', length=1, delay_cost=1)
	T4_14c1_a1 += alt(ADD)

	T4_14c1_a1_mem0 = S.Task('T4_14c1_a1_mem0', length=1, delay_cost=1)
	T4_14c1_a1_mem0 += alt(MUL_mem)
	S += (T4_14t3_a1*MUL[0])-1<T4_14c1_a1_mem0*MUL_mem[0]
	S += T4_14c1_a1_mem0<=T4_14c1_a1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_18.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_18(0, 0)