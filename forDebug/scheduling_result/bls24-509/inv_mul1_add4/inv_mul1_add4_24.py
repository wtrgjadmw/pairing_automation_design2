...
def solve_inv_mul1_add4_24(ConstStep, ExpStep):
	horizon = 363
	S=Scenario("inv_mul1_add4_24",horizon = horizon)
	...
	S += T5_7t2_a0b0<T7t4_a0b0_mem0
	S += T7t4_a0b0_mem0<=T7t4_a0b0

	T7t4_a0b0_mem1 = S.Task('T7t4_a0b0_mem1', length=1, delay_cost=1)
	T7t4_a0b0_mem1 += alt(ADD_mem)
	S += (T7t3_a0b0*ADD[0])-1<T7t4_a0b0_mem1*ADD_mem[0]
	S += (T7t3_a0b0*ADD[1])-1<T7t4_a0b0_mem1*ADD_mem[1]
	S += (T7t3_a0b0*ADD[2])-1<T7t4_a0b0_mem1*ADD_mem[2]
	S += (T7t3_a0b0*ADD[3])-1<T7t4_a0b0_mem1*ADD_mem[3]
	...
	S += T7t0_a0b0<T7c0_a0b0_mem0
	S += T7c0_a0b0_mem0<=T7c0_a0b0

	T7c0_a0b0_mem1 = S.Task('T7c0_a0b0_mem1', length=1, delay_cost=1)
	T7c0_a0b0_mem1 += alt(MUL_mem)
	S += (T7t1_a0b0*MUL[0])-1<T7c0_a0b0_mem1*MUL_mem[0]
	...
	S += T7t0_a0b0<T7t6_a0b0_mem0
	S += T7t6_a0b0_mem0<=T7t6_a0b0

	T7t6_a0b0_mem1 = S.Task('T7t6_a0b0_mem1', length=1, delay_cost=1)
	T7t6_a0b0_mem1 += alt(MUL_mem)
	S += (T7t1_a0b0*MUL[0])-1<T7t6_a0b0_mem1*MUL_mem[0]
	...
	S += T5_7t2_a1b1<T7t4_a1b1_mem0
	S += T7t4_a1b1_mem0<=T7t4_a1b1

	T7t4_a1b1_mem1 = S.Task('T7t4_a1b1_mem1', length=1, delay_cost=1)
	T7t4_a1b1_mem1 += alt(ADD_mem)
	S += (T7t3_a1b1*ADD[0])-1<T7t4_a1b1_mem1*ADD_mem[0]
	S += (T7t3_a1b1*ADD[1])-1<T7t4_a1b1_mem1*ADD_mem[1]
	S += (T7t3_a1b1*ADD[2])-1<T7t4_a1b1_mem1*ADD_mem[2]
	S += (T7t3_a1b1*ADD[3])-1<T7t4_a1b1_mem1*ADD_mem[3]
	...
	S += T7t0_a1b1<T7c0_a1b1_mem0
	S += T7c0_a1b1_mem0<=T7c0_a1b1

	T7c0_a1b1_mem1 = S.Task('T7c0_a1b1_mem1', length=1, delay_cost=1)
	T7c0_a1b1_mem1 += alt(MUL_mem)
	S += (T7t1_a1b1*MUL[0])-1<T7c0_a1b1_mem1*MUL_mem[0]
	...
	S += T7t0_a1b1<T7t6_a1b1_mem0
	S += T7t6_a1b1_mem0<=T7t6_a1b1

	T7t6_a1b1_mem1 = S.Task('T7t6_a1b1_mem1', length=1, delay_cost=1)
	T7t6_a1b1_mem1 += alt(MUL_mem)
	S += (T7t1_a1b1*MUL[0])-1<T7t6_a1b1_mem1*MUL_mem[0]
	...
	S += T5_7t2_1<T7t1_t2t3_mem0
	S += T7t1_t2t3_mem0<=T7t1_t2t3

	T7t1_t2t3_mem1 = S.Task('T7t1_t2t3_mem1', length=1, delay_cost=1)
	T7t1_t2t3_mem1 += alt(ADD_mem)
	S += (T7t3_1*ADD[0])-1<T7t1_t2t3_mem1*ADD_mem[0]
	S += (T7t3_1*ADD[1])-1<T7t1_t2t3_mem1*ADD_mem[1]
	S += (T7t3_1*ADD[2])-1<T7t1_t2t3_mem1*ADD_mem[2]
	S += (T7t3_1*ADD[3])-1<T7t1_t2t3_mem1*ADD_mem[3]
	...
	S += T7t3_0<T7t3_t2t3_mem0
	S += T7t3_t2t3_mem0<=T7t3_t2t3

	T7t3_t2t3_mem1 = S.Task('T7t3_t2t3_mem1', length=1, delay_cost=1)
	T7t3_t2t3_mem1 += alt(ADD_mem)
	S += (T7t3_1*ADD[0])-1<T7t3_t2t3_mem1*ADD_mem[0]
	S += (T7t3_1*ADD[1])-1<T7t3_t2t3_mem1*ADD_mem[1]
	S += (T7t3_1*ADD[2])-1<T7t3_t2t3_mem1*ADD_mem[2]
	S += (T7t3_1*ADD[3])-1<T7t3_t2t3_mem1*ADD_mem[3]
	...
	S += T3_5t2_a0b0<T8t4_a0b0_mem0
	S += T8t4_a0b0_mem0<=T8t4_a0b0

	T8t4_a0b0_mem1 = S.Task('T8t4_a0b0_mem1', length=1, delay_cost=1)
	T8t4_a0b0_mem1 += alt(ADD_mem)
	S += (T7t3_a0b0*ADD[0])-1<T8t4_a0b0_mem1*ADD_mem[0]
	S += (T7t3_a0b0*ADD[1])-1<T8t4_a0b0_mem1*ADD_mem[1]
	S += (T7t3_a0b0*ADD[2])-1<T8t4_a0b0_mem1*ADD_mem[2]
	S += (T7t3_a0b0*ADD[3])-1<T8t4_a0b0_mem1*ADD_mem[3]
	...
	S += T8t0_a0b0<T8c0_a0b0_mem0
	S += T8c0_a0b0_mem0<=T8c0_a0b0

	T8c0_a0b0_mem1 = S.Task('T8c0_a0b0_mem1', length=1, delay_cost=1)
	T8c0_a0b0_mem1 += alt(MUL_mem)
	S += (T8t1_a0b0*MUL[0])-1<T8c0_a0b0_mem1*MUL_mem[0]
	...
	S += T8t0_a0b0<T8t6_a0b0_mem0
	S += T8t6_a0b0_mem0<=T8t6_a0b0

	T8t6_a0b0_mem1 = S.Task('T8t6_a0b0_mem1', length=1, delay_cost=1)
	T8t6_a0b0_mem1 += alt(MUL_mem)
	S += (T8t1_a0b0*MUL[0])-1<T8t6_a0b0_mem1*MUL_mem[0]
	...
	S += T3_5t2_a1b1<T8t4_a1b1_mem0
	S += T8t4_a1b1_mem0<=T8t4_a1b1

	T8t4_a1b1_mem1 = S.Task('T8t4_a1b1_mem1', length=1, delay_cost=1)
	T8t4_a1b1_mem1 += alt(ADD_mem)
	S += (T7t3_a1b1*ADD[0])-1<T8t4_a1b1_mem1*ADD_mem[0]
	S += (T7t3_a1b1*ADD[1])-1<T8t4_a1b1_mem1*ADD_mem[1]
	S += (T7t3_a1b1*ADD[2])-1<T8t4_a1b1_mem1*ADD_mem[2]
	S += (T7t3_a1b1*ADD[3])-1<T8t4_a1b1_mem1*ADD_mem[3]
	...
	S += T8t0_a1b1<T8c0_a1b1_mem0
	S += T8c0_a1b1_mem0<=T8c0_a1b1

	T8c0_a1b1_mem1 = S.Task('T8c0_a1b1_mem1', length=1, delay_cost=1)
	T8c0_a1b1_mem1 += alt(MUL_mem)
	S += (T8t1_a1b1*MUL[0])-1<T8c0_a1b1_mem1*MUL_mem[0]
	...
	S += T8t0_a1b1<T8t6_a1b1_mem0
	S += T8t6_a1b1_mem0<=T8t6_a1b1

	T8t6_a1b1_mem1 = S.Task('T8t6_a1b1_mem1', length=1, delay_cost=1)
	T8t6_a1b1_mem1 += alt(MUL_mem)
	S += (T8t1_a1b1*MUL[0])-1<T8t6_a1b1_mem1*MUL_mem[0]
	...
	S += T3_5t2_1<T8t1_t2t3_mem0
	S += T8t1_t2t3_mem0<=T8t1_t2t3

	T8t1_t2t3_mem1 = S.Task('T8t1_t2t3_mem1', length=1, delay_cost=1)
	T8t1_t2t3_mem1 += alt(ADD_mem)
	S += (T7t3_1*ADD[0])-1<T8t1_t2t3_mem1*ADD_mem[0]
	S += (T7t3_1*ADD[1])-1<T8t1_t2t3_mem1*ADD_mem[1]
	S += (T7t3_1*ADD[2])-1<T8t1_t2t3_mem1*ADD_mem[2]
	S += (T7t3_1*ADD[3])-1<T8t1_t2t3_mem1*ADD_mem[3]
	S += T8t1_t2t3_mem1<=T8t1_t2t3

	T9t4_a0b0_in = S.Task('T9t4_a0b0_in', length=1, delay_cost=1)
	T9t4_a0b0_in += alt(MUL_in)
	T9t4_a0b0 = S.Task('T9t4_a0b0', length=7, delay_cost=1)
	T9t4_a0b0 += alt(MUL)
	S+=T9t4_a0b0>=T9t4_a0b0_in

	T9t4_a0b0_mem0 = S.Task('T9t4_a0b0_mem0', length=1, delay_cost=1)
	T9t4_a0b0_mem0 += ADD_mem[3]
	S += T4_10t2_a0b0<T9t4_a0b0_mem0
	S += T9t4_a0b0_mem0<=T9t4_a0b0

	T9t4_a0b0_mem1 = S.Task('T9t4_a0b0_mem1', length=1, delay_cost=1)
	T9t4_a0b0_mem1 += alt(ADD_mem)
	S += (T7t3_a0b0*ADD[0])-1<T9t4_a0b0_mem1*ADD_mem[0]
	S += (T7t3_a0b0*ADD[1])-1<T9t4_a0b0_mem1*ADD_mem[1]
	S += (T7t3_a0b0*ADD[2])-1<T9t4_a0b0_mem1*ADD_mem[2]
	S += (T7t3_a0b0*ADD[3])-1<T9t4_a0b0_mem1*ADD_mem[3]
	S += T9t4_a0b0_mem1<=T9t4_a0b0
	...
	S += T9t0_a0b0<T9c0_a0b0_mem0
	S += T9c0_a0b0_mem0<=T9c0_a0b0

	T9c0_a0b0_mem1 = S.Task('T9c0_a0b0_mem1', length=1, delay_cost=1)
	T9c0_a0b0_mem1 += alt(MUL_mem)
	S += (T9t1_a0b0*MUL[0])-1<T9c0_a0b0_mem1*MUL_mem[0]
	S += T9c0_a0b0_mem1<=T9c0_a0b0
	...
	S += T9t0_a0b0<T9t6_a0b0_mem0
	S += T9t6_a0b0_mem0<=T9t6_a0b0

	T9t6_a0b0_mem1 = S.Task('T9t6_a0b0_mem1', length=1, delay_cost=1)
	T9t6_a0b0_mem1 += alt(MUL_mem)
	S += (T9t1_a0b0*MUL[0])-1<T9t6_a0b0_mem1*MUL_mem[0]
	S += T9t6_a0b0_mem1<=T9t6_a0b0

	T9t4_a1b1_in = S.Task('T9t4_a1b1_in', length=1, delay_cost=1)
	T9t4_a1b1_in += alt(MUL_in)
	T9t4_a1b1 = S.Task('T9t4_a1b1', length=7, delay_cost=1)
	T9t4_a1b1 += alt(MUL)
	S+=T9t4_a1b1>=T9t4_a1b1_in

	T9t4_a1b1_mem0 = S.Task('T9t4_a1b1_mem0', length=1, delay_cost=1)
	T9t4_a1b1_mem0 += ADD_mem[1]
	S += T4_10t2_a1b1<T9t4_a1b1_mem0
	S += T9t4_a1b1_mem0<=T9t4_a1b1

	T9t4_a1b1_mem1 = S.Task('T9t4_a1b1_mem1', length=1, delay_cost=1)
	T9t4_a1b1_mem1 += alt(ADD_mem)
	S += (T7t3_a1b1*ADD[0])-1<T9t4_a1b1_mem1*ADD_mem[0]
	S += (T7t3_a1b1*ADD[1])-1<T9t4_a1b1_mem1*ADD_mem[1]
	S += (T7t3_a1b1*ADD[2])-1<T9t4_a1b1_mem1*ADD_mem[2]
	S += (T7t3_a1b1*ADD[3])-1<T9t4_a1b1_mem1*ADD_mem[3]
	S += T9t4_a1b1_mem1<=T9t4_a1b1
	...
	S += T9t0_a1b1<T9c0_a1b1_mem0
	S += T9c0_a1b1_mem0<=T9c0_a1b1

	T9c0_a1b1_mem1 = S.Task('T9c0_a1b1_mem1', length=1, delay_cost=1)
	T9c0_a1b1_mem1 += alt(MUL_mem)
	S += (T9t1_a1b1*MUL[0])-1<T9c0_a1b1_mem1*MUL_mem[0]
	S += T9c0_a1b1_mem1<=T9c0_a1b1
	...
	S += T9t0_a1b1<T9t6_a1b1_mem0
	S += T9t6_a1b1_mem0<=T9t6_a1b1

	T9t6_a1b1_mem1 = S.Task('T9t6_a1b1_mem1', length=1, delay_cost=1)
	T9t6_a1b1_mem1 += alt(MUL_mem)
	S += (T9t1_a1b1*MUL[0])-1<T9t6_a1b1_mem1*MUL_mem[0]
	S += T9t6_a1b1_mem1<=T9t6_a1b1

	T9t1_t2t3_in = S.Task('T9t1_t2t3_in', length=1, delay_cost=1)
	T9t1_t2t3_in += alt(MUL_in)
	T9t1_t2t3 = S.Task('T9t1_t2t3', length=7, delay_cost=1)
	T9t1_t2t3 += alt(MUL)
	S+=T9t1_t2t3>=T9t1_t2t3_in

	T9t1_t2t3_mem0 = S.Task('T9t1_t2t3_mem0', length=1, delay_cost=1)
	T9t1_t2t3_mem0 += ADD_mem[0]
	S += T4_10t2_1<T9t1_t2t3_mem0
	S += T9t1_t2t3_mem0<=T9t1_t2t3

	T9t1_t2t3_mem1 = S.Task('T9t1_t2t3_mem1', length=1, delay_cost=1)
	T9t1_t2t3_mem1 += alt(ADD_mem)
	S += (T7t3_1*ADD[0])-1<T9t1_t2t3_mem1*ADD_mem[0]
	S += (T7t3_1*ADD[1])-1<T9t1_t2t3_mem1*ADD_mem[1]
	S += (T7t3_1*ADD[2])-1<T9t1_t2t3_mem1*ADD_mem[2]
	S += (T7t3_1*ADD[3])-1<T9t1_t2t3_mem1*ADD_mem[3]
	S += T9t1_t2t3_mem1<=T9t1_t2t3
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_24.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_24(0, 0)