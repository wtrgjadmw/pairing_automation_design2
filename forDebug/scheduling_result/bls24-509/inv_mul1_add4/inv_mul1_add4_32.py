...
def solve_inv_mul1_add4_32(ConstStep, ExpStep):
	horizon = 492
	S=Scenario("inv_mul1_add4_32",horizon = horizon)
	...
	S += T0_4c0_a0b0<T0_400_mem0
	S += T0_400_mem0<=T0_400

	T0_400_mem1 = S.Task('T0_400_mem1', length=1, delay_cost=1)
	T0_400_mem1 += ADD_mem[1]
	S += T0_4s0_0<T0_400_mem1
	S += T0_400_mem1<=T0_400
	...
	S += T0_4c1_a0b0<T0_401_mem0
	S += T0_401_mem0<=T0_401

	T0_401_mem1 = S.Task('T0_401_mem1', length=1, delay_cost=1)
	T0_401_mem1 += ADD_mem[3]
	S += T0_4s0_1<T0_401_mem1
	S += T0_401_mem1<=T0_401
	...
	S += T0_4c1_t2t3<T0_411_mem0
	S += T0_411_mem0<=T0_411

	T0_411_mem1 = S.Task('T0_411_mem1', length=1, delay_cost=1)
	T0_411_mem1 += ADD_mem[2]
	S += T0_4t5_1<T0_411_mem1
	S += T0_411_mem1<=T0_411
	...
	S += T1_4c0_a0b0<T1_400_mem0
	S += T1_400_mem0<=T1_400

	T1_400_mem1 = S.Task('T1_400_mem1', length=1, delay_cost=1)
	T1_400_mem1 += ADD_mem[3]
	S += T1_4s0_0<T1_400_mem1
	S += T1_400_mem1<=T1_400
	...
	S += T1_4c1_a0b0<T1_401_mem0
	S += T1_401_mem0<=T1_401

	T1_401_mem1 = S.Task('T1_401_mem1', length=1, delay_cost=1)
	T1_401_mem1 += ADD_mem[0]
	S += T1_4s0_1<T1_401_mem1
	S += T1_401_mem1<=T1_401
	...
	S += T1_4c1_t2t3<T1_411_mem0
	S += T1_411_mem0<=T1_411

	T1_411_mem1 = S.Task('T1_411_mem1', length=1, delay_cost=1)
	T1_411_mem1 += ADD_mem[1]
	S += T1_4t5_1<T1_411_mem1
	S += T1_411_mem1<=T1_411
	...
	S += T2_7c0_a0b0<T2_700_mem0
	S += T2_700_mem0<=T2_700

	T2_700_mem1 = S.Task('T2_700_mem1', length=1, delay_cost=1)
	T2_700_mem1 += ADD_mem[2]
	S += T2_7s0_0<T2_700_mem1
	S += T2_700_mem1<=T2_700
	...
	S += T2_7c1_a0b0<T2_701_mem0
	S += T2_701_mem0<=T2_701

	T2_701_mem1 = S.Task('T2_701_mem1', length=1, delay_cost=1)
	T2_701_mem1 += ADD_mem[3]
	S += T2_7s0_1<T2_701_mem1
	S += T2_701_mem1<=T2_701
	...
	S += T2_7c1_t2t3<T2_711_mem0
	S += T2_711_mem0<=T2_711

	T2_711_mem1 = S.Task('T2_711_mem1', length=1, delay_cost=1)
	T2_711_mem1 += ADD_mem[2]
	S += T2_7t5_1<T2_711_mem1
	S += T2_711_mem1<=T2_711
	...
	S += T3_6t4_t2t3<T3_6c1_t2t3_mem0
	S += T3_6c1_t2t3_mem0<=T3_6c1_t2t3

	T3_6c1_t2t3_mem1 = S.Task('T3_6c1_t2t3_mem1', length=1, delay_cost=1)
	T3_6c1_t2t3_mem1 += ADD_mem[3]
	S += T3_6t6_t2t3<T3_6c1_t2t3_mem1
	S += T3_6c1_t2t3_mem1<=T3_6c1_t2t3
	...
	S += T3_6c0_a1b1<T3_6s0_0_mem0
	S += T3_6s0_0_mem0<=T3_6s0_0

	T3_6s0_0_mem1 = S.Task('T3_6s0_0_mem1', length=1, delay_cost=1)
	T3_6s0_0_mem1 += ADD_mem[0]
	S += T3_6c1_a1b1<T3_6s0_0_mem1
	S += T3_6s0_0_mem1<=T3_6s0_0
	...
	S += T3_6c1_a1b1<T3_6s0_1_mem0
	S += T3_6s0_1_mem0<=T3_6s0_1

	T3_6s0_1_mem1 = S.Task('T3_6s0_1_mem1', length=1, delay_cost=1)
	T3_6s0_1_mem1 += ADD_mem[2]
	S += T3_6c0_a1b1<T3_6s0_1_mem1
	S += T3_6s0_1_mem1<=T3_6s0_1
	...
	S += T3_6c1_a0b0<T3_6t5_1_mem0
	S += T3_6t5_1_mem0<=T3_6t5_1

	T3_6t5_1_mem1 = S.Task('T3_6t5_1_mem1', length=1, delay_cost=1)
	T3_6t5_1_mem1 += ADD_mem[0]
	S += T3_6c1_a1b1<T3_6t5_1_mem1
	S += T3_6t5_1_mem1<=T3_6t5_1
	...
	S += T3_6c0_t2t3<T3_610_mem0
	S += T3_610_mem0<=T3_610

	T3_610_mem1 = S.Task('T3_610_mem1', length=1, delay_cost=1)
	T3_610_mem1 += ADD_mem[1]
	S += T3_6t5_0<T3_610_mem1
	S += T3_610_mem1<=T3_610
	...
	S += T4_16c0_a1b1<T4_16s0_0_mem0
	S += T4_16s0_0_mem0<=T4_16s0_0

	T4_16s0_0_mem1 = S.Task('T4_16s0_0_mem1', length=1, delay_cost=1)
	T4_16s0_0_mem1 += ADD_mem[1]
	S += T4_16c1_a1b1<T4_16s0_0_mem1
	S += T4_16s0_0_mem1<=T4_16s0_0
	...
	S += T4_16c1_a1b1<T4_16s0_1_mem0
	S += T4_16s0_1_mem0<=T4_16s0_1

	T4_16s0_1_mem1 = S.Task('T4_16s0_1_mem1', length=1, delay_cost=1)
	T4_16s0_1_mem1 += ADD_mem[1]
	S += T4_16c0_a1b1<T4_16s0_1_mem1
	S += T4_16s0_1_mem1<=T4_16s0_1
	...
	S += T4_16c1_a0b0<T4_16t5_1_mem0
	S += T4_16t5_1_mem0<=T4_16t5_1

	T4_16t5_1_mem1 = S.Task('T4_16t5_1_mem1', length=1, delay_cost=1)
	T4_16t5_1_mem1 += ADD_mem[1]
	S += T4_16c1_a1b1<T4_16t5_1_mem1
	S += T4_16t5_1_mem1<=T4_16t5_1
	...
	S += T4_16c0_t2t3<T4_1610_mem0
	S += T4_1610_mem0<=T4_1610

	T4_1610_mem1 = S.Task('T4_1610_mem1', length=1, delay_cost=1)
	T4_1610_mem1 += ADD_mem[0]
	S += T4_16t5_0<T4_1610_mem1
	S += T4_1610_mem1<=T4_1610
	...
	S += T1_410<T5_810_mem0
	S += T5_810_mem0<=T5_810

	T5_810_mem1 = S.Task('T5_810_mem1', length=1, delay_cost=1)
	T5_810_mem1 += ADD_mem[3]
	S += T2_710<T5_810_mem1
	S += T5_810_mem1<=T5_810
	...
	S += T5_9t4_t2t3<T5_9c1_t2t3_mem0
	S += T5_9c1_t2t3_mem0<=T5_9c1_t2t3

	T5_9c1_t2t3_mem1 = S.Task('T5_9c1_t2t3_mem1', length=1, delay_cost=1)
	T5_9c1_t2t3_mem1 += ADD_mem[3]
	S += T5_9t6_t2t3<T5_9c1_t2t3_mem1
	S += T5_9c1_t2t3_mem1<=T5_9c1_t2t3
	...
	S += T5_9c0_a1b1<T5_9s0_0_mem0
	S += T5_9s0_0_mem0<=T5_9s0_0

	T5_9s0_0_mem1 = S.Task('T5_9s0_0_mem1', length=1, delay_cost=1)
	T5_9s0_0_mem1 += ADD_mem[0]
	S += T5_9c1_a1b1<T5_9s0_0_mem1
	S += T5_9s0_0_mem1<=T5_9s0_0
	...
	S += T5_9c1_a1b1<T5_9s0_1_mem0
	S += T5_9s0_1_mem0<=T5_9s0_1

	T5_9s0_1_mem1 = S.Task('T5_9s0_1_mem1', length=1, delay_cost=1)
	T5_9s0_1_mem1 += ADD_mem[0]
	S += T5_9c0_a1b1<T5_9s0_1_mem1
	S += T5_9s0_1_mem1<=T5_9s0_1
	...
	S += T5_9c1_a0b0<T5_9t5_1_mem0
	S += T5_9t5_1_mem0<=T5_9t5_1

	T5_9t5_1_mem1 = S.Task('T5_9t5_1_mem1', length=1, delay_cost=1)
	T5_9t5_1_mem1 += ADD_mem[0]
	S += T5_9c1_a1b1<T5_9t5_1_mem1
	S += T5_9t5_1_mem1<=T5_9t5_1
	...
	S += T5_9c0_t2t3<T5_910_mem0
	S += T5_910_mem0<=T5_910

	T5_910_mem1 = S.Task('T5_910_mem1', length=1, delay_cost=1)
	T5_910_mem1 += ADD_mem[0]
	S += T5_9t5_0<T5_910_mem1
	S += T5_910_mem1<=T5_910
	...
	S += T0_5c0_a0b0<T0_500_mem0
	S += T0_500_mem0<=T0_500

	T0_500_mem1 = S.Task('T0_500_mem1', length=1, delay_cost=1)
	T0_500_mem1 += ADD_mem[3]
	S += T0_5s0_0<T0_500_mem1
	S += T0_500_mem1<=T0_500
	...
	S += T0_5c1_a0b0<T0_501_mem0
	S += T0_501_mem0<=T0_501

	T0_501_mem1 = S.Task('T0_501_mem1', length=1, delay_cost=1)
	T0_501_mem1 += ADD_mem[0]
	S += T0_5s0_1<T0_501_mem1
	S += T0_501_mem1<=T0_501
	...
	S += T0_5c1_t2t3<T0_511_mem0
	S += T0_511_mem0<=T0_511

	T0_511_mem1 = S.Task('T0_511_mem1', length=1, delay_cost=1)
	T0_511_mem1 += ADD_mem[0]
	S += T0_5t5_1<T0_511_mem1
	S += T0_511_mem1<=T0_511
	...
	S += T1_5c0_a0b0<T1_500_mem0
	S += T1_500_mem0<=T1_500

	T1_500_mem1 = S.Task('T1_500_mem1', length=1, delay_cost=1)
	T1_500_mem1 += ADD_mem[1]
	S += T1_5s0_0<T1_500_mem1
	S += T1_500_mem1<=T1_500
	...
	S += T1_5c1_a0b0<T1_501_mem0
	S += T1_501_mem0<=T1_501

	T1_501_mem1 = S.Task('T1_501_mem1', length=1, delay_cost=1)
	T1_501_mem1 += ADD_mem[0]
	S += T1_5s0_1<T1_501_mem1
	S += T1_501_mem1<=T1_501
	...
	S += T1_5c1_t2t3<T1_511_mem0
	S += T1_511_mem0<=T1_511

	T1_511_mem1 = S.Task('T1_511_mem1', length=1, delay_cost=1)
	T1_511_mem1 += ADD_mem[2]
	S += T1_5t5_1<T1_511_mem1
	S += T1_511_mem1<=T1_511
	...
	S += T2_9c0_a0b0<T2_900_mem0
	S += T2_900_mem0<=T2_900

	T2_900_mem1 = S.Task('T2_900_mem1', length=1, delay_cost=1)
	T2_900_mem1 += ADD_mem[1]
	S += T2_9s0_0<T2_900_mem1
	S += T2_900_mem1<=T2_900
	...
	S += T2_9c1_a0b0<T2_901_mem0
	S += T2_901_mem0<=T2_901

	T2_901_mem1 = S.Task('T2_901_mem1', length=1, delay_cost=1)
	T2_901_mem1 += ADD_mem[2]
	S += T2_9s0_1<T2_901_mem1
	S += T2_901_mem1<=T2_901
	...
	S += T2_9c1_t2t3<T2_911_mem0
	S += T2_911_mem0<=T2_911

	T2_911_mem1 = S.Task('T2_911_mem1', length=1, delay_cost=1)
	T2_911_mem1 += ADD_mem[0]
	S += T2_9t5_1<T2_911_mem1
	S += T2_911_mem1<=T2_911
	...
	S += T3_8t4_t2t3<T3_8c1_t2t3_mem0
	S += T3_8c1_t2t3_mem0<=T3_8c1_t2t3

	T3_8c1_t2t3_mem1 = S.Task('T3_8c1_t2t3_mem1', length=1, delay_cost=1)
	T3_8c1_t2t3_mem1 += ADD_mem[1]
	S += T3_8t6_t2t3<T3_8c1_t2t3_mem1
	S += T3_8c1_t2t3_mem1<=T3_8c1_t2t3
	...
	S += T3_8c0_a1b1<T3_8s0_0_mem0
	S += T3_8s0_0_mem0<=T3_8s0_0

	T3_8s0_0_mem1 = S.Task('T3_8s0_0_mem1', length=1, delay_cost=1)
	T3_8s0_0_mem1 += ADD_mem[3]
	S += T3_8c1_a1b1<T3_8s0_0_mem1
	S += T3_8s0_0_mem1<=T3_8s0_0
	...
	S += T3_8c1_a1b1<T3_8s0_1_mem0
	S += T3_8s0_1_mem0<=T3_8s0_1

	T3_8s0_1_mem1 = S.Task('T3_8s0_1_mem1', length=1, delay_cost=1)
	T3_8s0_1_mem1 += ADD_mem[0]
	S += T3_8c0_a1b1<T3_8s0_1_mem1
	S += T3_8s0_1_mem1<=T3_8s0_1
	...
	S += T3_8c1_a0b0<T3_8t5_1_mem0
	S += T3_8t5_1_mem0<=T3_8t5_1

	T3_8t5_1_mem1 = S.Task('T3_8t5_1_mem1', length=1, delay_cost=1)
	T3_8t5_1_mem1 += ADD_mem[3]
	S += T3_8c1_a1b1<T3_8t5_1_mem1
	S += T3_8t5_1_mem1<=T3_8t5_1
	...
	S += T3_8c0_t2t3<T3_810_mem0
	S += T3_810_mem0<=T3_810

	T3_810_mem1 = S.Task('T3_810_mem1', length=1, delay_cost=1)
	T3_810_mem1 += ADD_mem[0]
	S += T3_8t5_0<T3_810_mem1
	S += T3_810_mem1<=T3_810
	...
	S += T4_20c0_a1b1<T4_20s0_0_mem0
	S += T4_20s0_0_mem0<=T4_20s0_0

	T4_20s0_0_mem1 = S.Task('T4_20s0_0_mem1', length=1, delay_cost=1)
	T4_20s0_0_mem1 += ADD_mem[0]
	S += T4_20c1_a1b1<T4_20s0_0_mem1
	S += T4_20s0_0_mem1<=T4_20s0_0
	...
	S += T4_20c1_a1b1<T4_20s0_1_mem0
	S += T4_20s0_1_mem0<=T4_20s0_1

	T4_20s0_1_mem1 = S.Task('T4_20s0_1_mem1', length=1, delay_cost=1)
	T4_20s0_1_mem1 += ADD_mem[1]
	S += T4_20c0_a1b1<T4_20s0_1_mem1
	S += T4_20s0_1_mem1<=T4_20s0_1
	...
	S += T4_20c1_a0b0<T4_20t5_1_mem0
	S += T4_20t5_1_mem0<=T4_20t5_1

	T4_20t5_1_mem1 = S.Task('T4_20t5_1_mem1', length=1, delay_cost=1)
	T4_20t5_1_mem1 += ADD_mem[0]
	S += T4_20c1_a1b1<T4_20t5_1_mem1
	S += T4_20t5_1_mem1<=T4_20t5_1
	...
	S += T4_20c0_t2t3<T4_2010_mem0
	S += T4_2010_mem0<=T4_2010

	T4_2010_mem1 = S.Task('T4_2010_mem1', length=1, delay_cost=1)
	T4_2010_mem1 += ADD_mem[1]
	S += T4_20t5_0<T4_2010_mem1
	S += T4_2010_mem1<=T4_2010
	...
	S += T5_12c0_a1b1<T5_12s0_0_mem0
	S += T5_12s0_0_mem0<=T5_12s0_0

	T5_12s0_0_mem1 = S.Task('T5_12s0_0_mem1', length=1, delay_cost=1)
	T5_12s0_0_mem1 += ADD_mem[0]
	S += T5_12c1_a1b1<T5_12s0_0_mem1
	S += T5_12s0_0_mem1<=T5_12s0_0
	...
	S += T5_12c1_a1b1<T5_12s0_1_mem0
	S += T5_12s0_1_mem0<=T5_12s0_1

	T5_12s0_1_mem1 = S.Task('T5_12s0_1_mem1', length=1, delay_cost=1)
	T5_12s0_1_mem1 += ADD_mem[3]
	S += T5_12c0_a1b1<T5_12s0_1_mem1
	S += T5_12s0_1_mem1<=T5_12s0_1
	...
	S += T5_12c1_a0b0<T5_12t5_1_mem0
	S += T5_12t5_1_mem0<=T5_12t5_1

	T5_12t5_1_mem1 = S.Task('T5_12t5_1_mem1', length=1, delay_cost=1)
	T5_12t5_1_mem1 += ADD_mem[0]
	S += T5_12c1_a1b1<T5_12t5_1_mem1
	S += T5_12t5_1_mem1<=T5_12t5_1
	...
	S += T5_12c0_t2t3<T5_1210_mem0
	S += T5_1210_mem0<=T5_1210

	T5_1210_mem1 = S.Task('T5_1210_mem1', length=1, delay_cost=1)
	T5_1210_mem1 += ADD_mem[1]
	S += T5_12t5_0<T5_1210_mem1
	S += T5_1210_mem1<=T5_1210
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_32.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_32(0, 0)