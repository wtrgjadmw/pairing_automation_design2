...
def solve_inv_mul1_add4_25(ConstStep, ExpStep):
	horizon = 376
	S=Scenario("inv_mul1_add4_25",horizon = horizon)
	...
	S += T9t4_a0b0<T9c1_a0b0_mem0
	S += T9c1_a0b0_mem0<=T9c1_a0b0

	T9c1_a0b0_mem1 = S.Task('T9c1_a0b0_mem1', length=1, delay_cost=1)
	T9c1_a0b0_mem1 += ADD_mem[2]
	S += T9t6_a0b0<T9c1_a0b0_mem1
	S += T9c1_a0b0_mem1<=T9c1_a0b0
	...
	S += T9t0_t2t3<T9c0_t2t3_mem0
	S += T9c0_t2t3_mem0<=T9c0_t2t3

	T9c0_t2t3_mem1 = S.Task('T9c0_t2t3_mem1', length=1, delay_cost=1)
	T9c0_t2t3_mem1 += MUL_mem[0]
	S += T9t1_t2t3<T9c0_t2t3_mem1
	S += T9c0_t2t3_mem1<=T9c0_t2t3
	...
	S += T9t0_t2t3<T9t6_t2t3_mem0
	S += T9t6_t2t3_mem0<=T9t6_t2t3

	T9t6_t2t3_mem1 = S.Task('T9t6_t2t3_mem1', length=1, delay_cost=1)
	T9t6_t2t3_mem1 += MUL_mem[0]
	S += T9t1_t2t3<T9t6_t2t3_mem1
	S += T9t6_t2t3_mem1<=T9t6_t2t3
	...
	S += T9c0_a0b0<T9t5_0_mem0
	S += T9t5_0_mem0<=T9t5_0

	T9t5_0_mem1 = S.Task('T9t5_0_mem1', length=1, delay_cost=1)
	T9t5_0_mem1 += ADD_mem[1]
	S += T9c0_a1b1<T9t5_0_mem1
	S += T9t5_0_mem1<=T9t5_0

	T7c1_t2t3 = S.Task('T7c1_t2t3', length=1, delay_cost=1)
	T7c1_t2t3 += alt(ADD)

	T7c1_t2t3_mem0 = S.Task('T7c1_t2t3_mem0', length=1, delay_cost=1)
	T7c1_t2t3_mem0 += alt(MUL_mem)
	S += (T7t4_t2t3*MUL[0])-1<T7c1_t2t3_mem0*MUL_mem[0]
	S += T7c1_t2t3_mem0<=T7c1_t2t3

	T7c1_t2t3_mem1 = S.Task('T7c1_t2t3_mem1', length=1, delay_cost=1)
	T7c1_t2t3_mem1 += alt(ADD_mem)
	S += (T7t6_t2t3*ADD[0])-1<T7c1_t2t3_mem1*ADD_mem[0]
	S += (T7t6_t2t3*ADD[1])-1<T7c1_t2t3_mem1*ADD_mem[1]
	S += (T7t6_t2t3*ADD[2])-1<T7c1_t2t3_mem1*ADD_mem[2]
	S += (T7t6_t2t3*ADD[3])-1<T7c1_t2t3_mem1*ADD_mem[3]
	...
	S += T7c0_a1b1<T7s0_0_mem0
	S += T7s0_0_mem0<=T7s0_0

	T7s0_0_mem1 = S.Task('T7s0_0_mem1', length=1, delay_cost=1)
	T7s0_0_mem1 += alt(ADD_mem)
	S += (T7c1_a1b1*ADD[0])-1<T7s0_0_mem1*ADD_mem[0]
	S += (T7c1_a1b1*ADD[1])-1<T7s0_0_mem1*ADD_mem[1]
	S += (T7c1_a1b1*ADD[2])-1<T7s0_0_mem1*ADD_mem[2]
	S += (T7c1_a1b1*ADD[3])-1<T7s0_0_mem1*ADD_mem[3]
	...
	T7s0_1_mem0 += alt(ADD_mem)
	S += (T7c1_a1b1*ADD[0])-1<T7s0_1_mem0*ADD_mem[0]
	S += (T7c1_a1b1*ADD[1])-1<T7s0_1_mem0*ADD_mem[1]
	S += (T7c1_a1b1*ADD[2])-1<T7s0_1_mem0*ADD_mem[2]
	S += (T7c1_a1b1*ADD[3])-1<T7s0_1_mem0*ADD_mem[3]
	S += T7s0_1_mem0<=T7s0_1

	T7s0_1_mem1 = S.Task('T7s0_1_mem1', length=1, delay_cost=1)
	T7s0_1_mem1 += ADD_mem[2]
	S += T7c0_a1b1<T7s0_1_mem1
	...
	T7t5_1_mem0 += alt(ADD_mem)
	S += (T7c1_a0b0*ADD[0])-1<T7t5_1_mem0*ADD_mem[0]
	S += (T7c1_a0b0*ADD[1])-1<T7t5_1_mem0*ADD_mem[1]
	S += (T7c1_a0b0*ADD[2])-1<T7t5_1_mem0*ADD_mem[2]
	S += (T7c1_a0b0*ADD[3])-1<T7t5_1_mem0*ADD_mem[3]
	S += T7t5_1_mem0<=T7t5_1

	T7t5_1_mem1 = S.Task('T7t5_1_mem1', length=1, delay_cost=1)
	T7t5_1_mem1 += alt(ADD_mem)
	S += (T7c1_a1b1*ADD[0])-1<T7t5_1_mem1*ADD_mem[0]
	S += (T7c1_a1b1*ADD[1])-1<T7t5_1_mem1*ADD_mem[1]
	S += (T7c1_a1b1*ADD[2])-1<T7t5_1_mem1*ADD_mem[2]
	S += (T7c1_a1b1*ADD[3])-1<T7t5_1_mem1*ADD_mem[3]
	...
	S += (T7c0_t2t3*ADD[0])-1<T710_mem0*ADD_mem[0]
	S += (T7c0_t2t3*ADD[1])-1<T710_mem0*ADD_mem[1]
	S += (T7c0_t2t3*ADD[2])-1<T710_mem0*ADD_mem[2]
	S += (T7c0_t2t3*ADD[3])-1<T710_mem0*ADD_mem[3]
	S += T710_mem0<=T710

	T710_mem1 = S.Task('T710_mem1', length=1, delay_cost=1)
	T710_mem1 += alt(ADD_mem)
	S += (T7t5_0*ADD[0])-1<T710_mem1*ADD_mem[0]
	S += (T7t5_0*ADD[1])-1<T710_mem1*ADD_mem[1]
	S += (T7t5_0*ADD[2])-1<T710_mem1*ADD_mem[2]
	S += (T7t5_0*ADD[3])-1<T710_mem1*ADD_mem[3]
	S += T710_mem1<=T710
	...
	T8c1_t2t3_mem0 += alt(MUL_mem)
	S += (T8t4_t2t3*MUL[0])-1<T8c1_t2t3_mem0*MUL_mem[0]
	S += T8c1_t2t3_mem0<=T8c1_t2t3

	T8c1_t2t3_mem1 = S.Task('T8c1_t2t3_mem1', length=1, delay_cost=1)
	T8c1_t2t3_mem1 += alt(ADD_mem)
	S += (T8t6_t2t3*ADD[0])-1<T8c1_t2t3_mem1*ADD_mem[0]
	S += (T8t6_t2t3*ADD[1])-1<T8c1_t2t3_mem1*ADD_mem[1]
	S += (T8t6_t2t3*ADD[2])-1<T8c1_t2t3_mem1*ADD_mem[2]
	S += (T8t6_t2t3*ADD[3])-1<T8c1_t2t3_mem1*ADD_mem[3]
	...
	S += T8c0_a1b1<T8s0_0_mem0
	S += T8s0_0_mem0<=T8s0_0

	T8s0_0_mem1 = S.Task('T8s0_0_mem1', length=1, delay_cost=1)
	T8s0_0_mem1 += alt(ADD_mem)
	S += (T8c1_a1b1*ADD[0])-1<T8s0_0_mem1*ADD_mem[0]
	S += (T8c1_a1b1*ADD[1])-1<T8s0_0_mem1*ADD_mem[1]
	S += (T8c1_a1b1*ADD[2])-1<T8s0_0_mem1*ADD_mem[2]
	S += (T8c1_a1b1*ADD[3])-1<T8s0_0_mem1*ADD_mem[3]
	...
	T8s0_1_mem0 += alt(ADD_mem)
	S += (T8c1_a1b1*ADD[0])-1<T8s0_1_mem0*ADD_mem[0]
	S += (T8c1_a1b1*ADD[1])-1<T8s0_1_mem0*ADD_mem[1]
	S += (T8c1_a1b1*ADD[2])-1<T8s0_1_mem0*ADD_mem[2]
	S += (T8c1_a1b1*ADD[3])-1<T8s0_1_mem0*ADD_mem[3]
	S += T8s0_1_mem0<=T8s0_1

	T8s0_1_mem1 = S.Task('T8s0_1_mem1', length=1, delay_cost=1)
	T8s0_1_mem1 += ADD_mem[2]
	S += T8c0_a1b1<T8s0_1_mem1
	...
	T8t5_1_mem0 += alt(ADD_mem)
	S += (T8c1_a0b0*ADD[0])-1<T8t5_1_mem0*ADD_mem[0]
	S += (T8c1_a0b0*ADD[1])-1<T8t5_1_mem0*ADD_mem[1]
	S += (T8c1_a0b0*ADD[2])-1<T8t5_1_mem0*ADD_mem[2]
	S += (T8c1_a0b0*ADD[3])-1<T8t5_1_mem0*ADD_mem[3]
	S += T8t5_1_mem0<=T8t5_1

	T8t5_1_mem1 = S.Task('T8t5_1_mem1', length=1, delay_cost=1)
	T8t5_1_mem1 += alt(ADD_mem)
	S += (T8c1_a1b1*ADD[0])-1<T8t5_1_mem1*ADD_mem[0]
	S += (T8c1_a1b1*ADD[1])-1<T8t5_1_mem1*ADD_mem[1]
	S += (T8c1_a1b1*ADD[2])-1<T8t5_1_mem1*ADD_mem[2]
	S += (T8c1_a1b1*ADD[3])-1<T8t5_1_mem1*ADD_mem[3]
	...
	S += (T8c0_t2t3*ADD[0])-1<T810_mem0*ADD_mem[0]
	S += (T8c0_t2t3*ADD[1])-1<T810_mem0*ADD_mem[1]
	S += (T8c0_t2t3*ADD[2])-1<T810_mem0*ADD_mem[2]
	S += (T8c0_t2t3*ADD[3])-1<T810_mem0*ADD_mem[3]
	S += T810_mem0<=T810

	T810_mem1 = S.Task('T810_mem1', length=1, delay_cost=1)
	T810_mem1 += alt(ADD_mem)
	S += (T8t5_0*ADD[0])-1<T810_mem1*ADD_mem[0]
	S += (T8t5_0*ADD[1])-1<T810_mem1*ADD_mem[1]
	S += (T8t5_0*ADD[2])-1<T810_mem1*ADD_mem[2]
	S += (T8t5_0*ADD[3])-1<T810_mem1*ADD_mem[3]
	S += T810_mem1<=T810
	...
	T9c1_t2t3_mem0 += alt(MUL_mem)
	S += (T9t4_t2t3*MUL[0])-1<T9c1_t2t3_mem0*MUL_mem[0]
	S += T9c1_t2t3_mem0<=T9c1_t2t3

	T9c1_t2t3_mem1 = S.Task('T9c1_t2t3_mem1', length=1, delay_cost=1)
	T9c1_t2t3_mem1 += alt(ADD_mem)
	S += (T9t6_t2t3*ADD[0])-1<T9c1_t2t3_mem1*ADD_mem[0]
	S += (T9t6_t2t3*ADD[1])-1<T9c1_t2t3_mem1*ADD_mem[1]
	S += (T9t6_t2t3*ADD[2])-1<T9c1_t2t3_mem1*ADD_mem[2]
	S += (T9t6_t2t3*ADD[3])-1<T9c1_t2t3_mem1*ADD_mem[3]
	S += T9c1_t2t3_mem1<=T9c1_t2t3
	...
	S += T9c0_a1b1<T9s0_0_mem0
	S += T9s0_0_mem0<=T9s0_0

	T9s0_0_mem1 = S.Task('T9s0_0_mem1', length=1, delay_cost=1)
	T9s0_0_mem1 += alt(ADD_mem)
	S += (T9c1_a1b1*ADD[0])-1<T9s0_0_mem1*ADD_mem[0]
	S += (T9c1_a1b1*ADD[1])-1<T9s0_0_mem1*ADD_mem[1]
	S += (T9c1_a1b1*ADD[2])-1<T9s0_0_mem1*ADD_mem[2]
	S += (T9c1_a1b1*ADD[3])-1<T9s0_0_mem1*ADD_mem[3]
	S += T9s0_0_mem1<=T9s0_0

	T9s0_1 = S.Task('T9s0_1', length=1, delay_cost=1)
	T9s0_1 += alt(ADD)

	T9s0_1_mem0 = S.Task('T9s0_1_mem0', length=1, delay_cost=1)
	T9s0_1_mem0 += alt(ADD_mem)
	S += (T9c1_a1b1*ADD[0])-1<T9s0_1_mem0*ADD_mem[0]
	S += (T9c1_a1b1*ADD[1])-1<T9s0_1_mem0*ADD_mem[1]
	S += (T9c1_a1b1*ADD[2])-1<T9s0_1_mem0*ADD_mem[2]
	S += (T9c1_a1b1*ADD[3])-1<T9s0_1_mem0*ADD_mem[3]
	S += T9s0_1_mem0<=T9s0_1

	T9s0_1_mem1 = S.Task('T9s0_1_mem1', length=1, delay_cost=1)
	T9s0_1_mem1 += ADD_mem[1]
	S += T9c0_a1b1<T9s0_1_mem1
	S += T9s0_1_mem1<=T9s0_1

	T9t5_1 = S.Task('T9t5_1', length=1, delay_cost=1)
	T9t5_1 += alt(ADD)

	T9t5_1_mem0 = S.Task('T9t5_1_mem0', length=1, delay_cost=1)
	T9t5_1_mem0 += alt(ADD_mem)
	S += (T9c1_a0b0*ADD[0])-1<T9t5_1_mem0*ADD_mem[0]
	S += (T9c1_a0b0*ADD[1])-1<T9t5_1_mem0*ADD_mem[1]
	S += (T9c1_a0b0*ADD[2])-1<T9t5_1_mem0*ADD_mem[2]
	S += (T9c1_a0b0*ADD[3])-1<T9t5_1_mem0*ADD_mem[3]
	S += T9t5_1_mem0<=T9t5_1

	T9t5_1_mem1 = S.Task('T9t5_1_mem1', length=1, delay_cost=1)
	T9t5_1_mem1 += alt(ADD_mem)
	S += (T9c1_a1b1*ADD[0])-1<T9t5_1_mem1*ADD_mem[0]
	S += (T9c1_a1b1*ADD[1])-1<T9t5_1_mem1*ADD_mem[1]
	S += (T9c1_a1b1*ADD[2])-1<T9t5_1_mem1*ADD_mem[2]
	S += (T9c1_a1b1*ADD[3])-1<T9t5_1_mem1*ADD_mem[3]
	S += T9t5_1_mem1<=T9t5_1
	...
	S += (T9c0_t2t3*ADD[0])-1<T910_mem0*ADD_mem[0]
	S += (T9c0_t2t3*ADD[1])-1<T910_mem0*ADD_mem[1]
	S += (T9c0_t2t3*ADD[2])-1<T910_mem0*ADD_mem[2]
	S += (T9c0_t2t3*ADD[3])-1<T910_mem0*ADD_mem[3]
	S += T910_mem0<=T910

	T910_mem1 = S.Task('T910_mem1', length=1, delay_cost=1)
	T910_mem1 += alt(ADD_mem)
	S += (T9t5_0*ADD[0])-1<T910_mem1*ADD_mem[0]
	S += (T9t5_0*ADD[1])-1<T910_mem1*ADD_mem[1]
	S += (T9t5_0*ADD[2])-1<T910_mem1*ADD_mem[2]
	S += (T9t5_0*ADD[3])-1<T910_mem1*ADD_mem[3]
	S += T910_mem1<=T910
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_25.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_25(0, 0)