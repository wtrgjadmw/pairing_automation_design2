...
def solve_inv_mul1_add4_19(ConstStep, ExpStep):
	horizon = 314
	S=Scenario("inv_mul1_add4_19",horizon = horizon)
	...
	S += T4_14t3_a0<T4_14c1_a0_mem0
	S += T4_14c1_a0_mem0<=T4_14c1_a0
	...
	S += T4_14c0_a1<T4_14c4_mem0
	S += T4_14c4_mem0<=T4_14c4

	T4_14c4_mem1 = S.Task('T4_14c4_mem1', length=1, delay_cost=1)
	T4_14c4_mem1 += ADD_mem[0]
	S += T4_14c1_a1<T4_14c4_mem1
	S += T4_14c4_mem1<=T4_14c4
	...
	S += T4_14c0_a1<T4_14c5_mem0
	S += T4_14c5_mem0<=T4_14c5

	T4_14c5_mem1 = S.Task('T4_14c5_mem1', length=1, delay_cost=1)
	T4_14c5_mem1 += ADD_mem[0]
	S += T4_14c1_a1<T4_14c5_mem1
	S += T4_14c5_mem1<=T4_14c5

	T4_14c0 = S.Task('T4_14c0', length=1, delay_cost=1)
	T4_14c0 += alt(ADD)

	T4_14c0_mem0 = S.Task('T4_14c0_mem0', length=1, delay_cost=1)
	T4_14c0_mem0 += alt(MUL_mem)
	S += (T4_14c0_a0*MUL[0])-1<T4_14c0_mem0*MUL_mem[0]
	S += T4_14c0_mem0<=T4_14c0

	T4_14c0_mem1 = S.Task('T4_14c0_mem1', length=1, delay_cost=1)
	T4_14c0_mem1 += alt(ADD_mem)
	S += (T4_14c4*ADD[0])-1<T4_14c0_mem1*ADD_mem[0]
	S += (T4_14c4*ADD[1])-1<T4_14c0_mem1*ADD_mem[1]
	S += (T4_14c4*ADD[2])-1<T4_14c0_mem1*ADD_mem[2]
	S += (T4_14c4*ADD[3])-1<T4_14c0_mem1*ADD_mem[3]
	S += T4_14c0_mem1<=T4_14c0

	T4_14c1 = S.Task('T4_14c1', length=1, delay_cost=1)
	T4_14c1 += alt(ADD)

	T4_14c1_mem0 = S.Task('T4_14c1_mem0', length=1, delay_cost=1)
	T4_14c1_mem0 += alt(ADD_mem)
	S += (T4_14c1_a0*ADD[0])-1<T4_14c1_mem0*ADD_mem[0]
	S += (T4_14c1_a0*ADD[1])-1<T4_14c1_mem0*ADD_mem[1]
	S += (T4_14c1_a0*ADD[2])-1<T4_14c1_mem0*ADD_mem[2]
	S += (T4_14c1_a0*ADD[3])-1<T4_14c1_mem0*ADD_mem[3]
	S += T4_14c1_mem0<=T4_14c1

	T4_14c1_mem1 = S.Task('T4_14c1_mem1', length=1, delay_cost=1)
	T4_14c1_mem1 += alt(ADD_mem)
	S += (T4_14c5*ADD[0])-1<T4_14c1_mem1*ADD_mem[0]
	S += (T4_14c5*ADD[1])-1<T4_14c1_mem1*ADD_mem[1]
	S += (T4_14c5*ADD[2])-1<T4_14c1_mem1*ADD_mem[2]
	S += (T4_14c5*ADD[3])-1<T4_14c1_mem1*ADD_mem[3]
	S += T4_14c1_mem1<=T4_14c1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_19.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_19(0, 0)