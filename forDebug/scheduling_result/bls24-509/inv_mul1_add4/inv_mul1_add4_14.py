...
def solve_inv_mul1_add4_14(ConstStep, ExpStep):
	horizon = 273
	S=Scenario("inv_mul1_add4_14",horizon = horizon)
	...
	S += T0_200<T0_300_mem0
	S += T0_300_mem0<=T0_300

	T0_300_mem1 = S.Task('T0_300_mem1', length=1, delay_cost=1)
	T0_300_mem1 += ADD_mem[2]
	S += T4_900<T0_300_mem1
	S += T0_300_mem1<=T0_300
	...
	S += T0_201<T0_301_mem0
	S += T0_301_mem0<=T0_301

	T0_301_mem1 = S.Task('T0_301_mem1', length=1, delay_cost=1)
	T0_301_mem1 += ADD_mem[3]
	S += T4_901<T0_301_mem1
	S += T0_301_mem1<=T0_301
	...
	S += T2_400<T2_610_mem0
	S += T2_610_mem0<=T2_610

	T2_610_mem1 = S.Task('T2_610_mem1', length=1, delay_cost=1)
	T2_610_mem1 += ADD_mem[2]
	S += T3_410<T2_610_mem1
	S += T2_610_mem1<=T2_610
	...
	S += T2_401<T2_611_mem0
	S += T2_611_mem0<=T2_611

	T2_611_mem1 = S.Task('T2_611_mem1', length=1, delay_cost=1)
	T2_611_mem1 += ADD_mem[2]
	S += T3_411<T2_611_mem1
	S += T2_611_mem1<=T2_611
	...
	S += T1_200<T1_300_mem0
	S += T1_300_mem0<=T1_300

	T1_300_mem1 = S.Task('T1_300_mem1', length=1, delay_cost=1)
	T1_300_mem1 += ADD_mem[2]
	S += T5_600<T1_300_mem1
	S += T1_300_mem1<=T1_300
	...
	S += T0_310<T5_7t2_a1b1_mem0
	S += T5_7t2_a1b1_mem0<=T5_7t2_a1b1

	T5_7t2_a1b1_mem1 = S.Task('T5_7t2_a1b1_mem1', length=1, delay_cost=1)
	T5_7t2_a1b1_mem1 += ADD_mem[0]
	S += T0_311<T5_7t2_a1b1_mem1
	S += T5_7t2_a1b1_mem1<=T5_7t2_a1b1
	...
	S += T2_600<T3_5t2_0_mem0
	S += T3_5t2_0_mem0<=T3_5t2_0

	T3_5t2_0_mem1 = S.Task('T3_5t2_0_mem1', length=1, delay_cost=1)
	T3_5t2_0_mem1 += alt(ADD_mem)
	S += (T2_610*ADD[0])-1<T3_5t2_0_mem1*ADD_mem[0]
	S += (T2_610*ADD[1])-1<T3_5t2_0_mem1*ADD_mem[1]
	S += (T2_610*ADD[2])-1<T3_5t2_0_mem1*ADD_mem[2]
	S += (T2_610*ADD[3])-1<T3_5t2_0_mem1*ADD_mem[3]
	S += T3_5t2_0_mem1<=T3_5t2_0
	...
	S += T2_601<T3_5t2_1_mem0
	S += T3_5t2_1_mem0<=T3_5t2_1

	T3_5t2_1_mem1 = S.Task('T3_5t2_1_mem1', length=1, delay_cost=1)
	T3_5t2_1_mem1 += alt(ADD_mem)
	S += (T2_611*ADD[0])-1<T3_5t2_1_mem1*ADD_mem[0]
	S += (T2_611*ADD[1])-1<T3_5t2_1_mem1*ADD_mem[1]
	S += (T2_611*ADD[2])-1<T3_5t2_1_mem1*ADD_mem[2]
	S += (T2_611*ADD[3])-1<T3_5t2_1_mem1*ADD_mem[3]
	S += T3_5t2_1_mem1<=T3_5t2_1

	T3_5t4_a0b0_in = S.Task('T3_5t4_a0b0_in', length=1, delay_cost=1)
	T3_5t4_a0b0_in += alt(MUL_in)
	T3_5t4_a0b0 = S.Task('T3_5t4_a0b0', length=7, delay_cost=1)
	T3_5t4_a0b0 += alt(MUL)
	S+=T3_5t4_a0b0>=T3_5t4_a0b0_in

	T3_5t4_a0b0_mem0 = S.Task('T3_5t4_a0b0_mem0', length=1, delay_cost=1)
	T3_5t4_a0b0_mem0 += alt(ADD_mem)
	S += (T3_5t2_a0b0*ADD[0])-1<T3_5t4_a0b0_mem0*ADD_mem[0]
	S += (T3_5t2_a0b0*ADD[1])-1<T3_5t4_a0b0_mem0*ADD_mem[1]
	S += (T3_5t2_a0b0*ADD[2])-1<T3_5t4_a0b0_mem0*ADD_mem[2]
	S += (T3_5t2_a0b0*ADD[3])-1<T3_5t4_a0b0_mem0*ADD_mem[3]
	S += T3_5t4_a0b0_mem0<=T3_5t4_a0b0

	T3_5t4_a0b0_mem1 = S.Task('T3_5t4_a0b0_mem1', length=1, delay_cost=1)
	T3_5t4_a0b0_mem1 += ADD_mem[0]
	S += T2_4t2_a0a1<T3_5t4_a0b0_mem1
	S += T3_5t4_a0b0_mem1<=T3_5t4_a0b0

	T3_5c0_a0b0 = S.Task('T3_5c0_a0b0', length=1, delay_cost=1)
	T3_5c0_a0b0 += alt(ADD)

	T3_5c0_a0b0_mem0 = S.Task('T3_5c0_a0b0_mem0', length=1, delay_cost=1)
	T3_5c0_a0b0_mem0 += alt(MUL_mem)
	S += (T3_5t0_a0b0*MUL[0])-1<T3_5c0_a0b0_mem0*MUL_mem[0]
	S += T3_5c0_a0b0_mem0<=T3_5c0_a0b0

	T3_5c0_a0b0_mem1 = S.Task('T3_5c0_a0b0_mem1', length=1, delay_cost=1)
	T3_5c0_a0b0_mem1 += alt(MUL_mem)
	S += (T3_5t1_a0b0*MUL[0])-1<T3_5c0_a0b0_mem1*MUL_mem[0]
	S += T3_5c0_a0b0_mem1<=T3_5c0_a0b0

	T3_5t6_a0b0 = S.Task('T3_5t6_a0b0', length=1, delay_cost=1)
	T3_5t6_a0b0 += alt(ADD)

	T3_5t6_a0b0_mem0 = S.Task('T3_5t6_a0b0_mem0', length=1, delay_cost=1)
	T3_5t6_a0b0_mem0 += alt(MUL_mem)
	S += (T3_5t0_a0b0*MUL[0])-1<T3_5t6_a0b0_mem0*MUL_mem[0]
	S += T3_5t6_a0b0_mem0<=T3_5t6_a0b0

	T3_5t6_a0b0_mem1 = S.Task('T3_5t6_a0b0_mem1', length=1, delay_cost=1)
	T3_5t6_a0b0_mem1 += alt(MUL_mem)
	S += (T3_5t1_a0b0*MUL[0])-1<T3_5t6_a0b0_mem1*MUL_mem[0]
	S += T3_5t6_a0b0_mem1<=T3_5t6_a0b0

	T3_5t0_a1b1_in = S.Task('T3_5t0_a1b1_in', length=1, delay_cost=1)
	T3_5t0_a1b1_in += alt(MUL_in)
	T3_5t0_a1b1 = S.Task('T3_5t0_a1b1', length=7, delay_cost=1)
	T3_5t0_a1b1 += alt(MUL)
	S+=T3_5t0_a1b1>=T3_5t0_a1b1_in

	T3_5t0_a1b1_mem0 = S.Task('T3_5t0_a1b1_mem0', length=1, delay_cost=1)
	T3_5t0_a1b1_mem0 += alt(ADD_mem)
	S += (T2_610*ADD[0])-1<T3_5t0_a1b1_mem0*ADD_mem[0]
	S += (T2_610*ADD[1])-1<T3_5t0_a1b1_mem0*ADD_mem[1]
	S += (T2_610*ADD[2])-1<T3_5t0_a1b1_mem0*ADD_mem[2]
	S += (T2_610*ADD[3])-1<T3_5t0_a1b1_mem0*ADD_mem[3]
	S += T3_5t0_a1b1_mem0<=T3_5t0_a1b1

	T3_5t0_a1b1_mem1 = S.Task('T3_5t0_a1b1_mem1', length=1, delay_cost=1)
	T3_5t0_a1b1_mem1 += ADD_mem[1]
	S += T21_110<T3_5t0_a1b1_mem1
	S += T3_5t0_a1b1_mem1<=T3_5t0_a1b1

	T3_5t1_a1b1_in = S.Task('T3_5t1_a1b1_in', length=1, delay_cost=1)
	T3_5t1_a1b1_in += alt(MUL_in)
	T3_5t1_a1b1 = S.Task('T3_5t1_a1b1', length=7, delay_cost=1)
	T3_5t1_a1b1 += alt(MUL)
	S+=T3_5t1_a1b1>=T3_5t1_a1b1_in

	T3_5t1_a1b1_mem0 = S.Task('T3_5t1_a1b1_mem0', length=1, delay_cost=1)
	T3_5t1_a1b1_mem0 += alt(ADD_mem)
	S += (T2_611*ADD[0])-1<T3_5t1_a1b1_mem0*ADD_mem[0]
	S += (T2_611*ADD[1])-1<T3_5t1_a1b1_mem0*ADD_mem[1]
	S += (T2_611*ADD[2])-1<T3_5t1_a1b1_mem0*ADD_mem[2]
	S += (T2_611*ADD[3])-1<T3_5t1_a1b1_mem0*ADD_mem[3]
	S += T3_5t1_a1b1_mem0<=T3_5t1_a1b1

	T3_5t1_a1b1_mem1 = S.Task('T3_5t1_a1b1_mem1', length=1, delay_cost=1)
	T3_5t1_a1b1_mem1 += ADD_mem[3]
	S += T21_111<T3_5t1_a1b1_mem1
	S += T3_5t1_a1b1_mem1<=T3_5t1_a1b1

	T3_5t2_a1b1 = S.Task('T3_5t2_a1b1', length=1, delay_cost=1)
	T3_5t2_a1b1 += alt(ADD)

	T3_5t2_a1b1_mem0 = S.Task('T3_5t2_a1b1_mem0', length=1, delay_cost=1)
	T3_5t2_a1b1_mem0 += alt(ADD_mem)
	S += (T2_610*ADD[0])-1<T3_5t2_a1b1_mem0*ADD_mem[0]
	S += (T2_610*ADD[1])-1<T3_5t2_a1b1_mem0*ADD_mem[1]
	S += (T2_610*ADD[2])-1<T3_5t2_a1b1_mem0*ADD_mem[2]
	S += (T2_610*ADD[3])-1<T3_5t2_a1b1_mem0*ADD_mem[3]
	S += T3_5t2_a1b1_mem0<=T3_5t2_a1b1

	T3_5t2_a1b1_mem1 = S.Task('T3_5t2_a1b1_mem1', length=1, delay_cost=1)
	T3_5t2_a1b1_mem1 += alt(ADD_mem)
	S += (T2_611*ADD[0])-1<T3_5t2_a1b1_mem1*ADD_mem[0]
	S += (T2_611*ADD[1])-1<T3_5t2_a1b1_mem1*ADD_mem[1]
	S += (T2_611*ADD[2])-1<T3_5t2_a1b1_mem1*ADD_mem[2]
	S += (T2_611*ADD[3])-1<T3_5t2_a1b1_mem1*ADD_mem[3]
	S += T3_5t2_a1b1_mem1<=T3_5t2_a1b1

	T4_10t2_0 = S.Task('T4_10t2_0', length=1, delay_cost=1)
	T4_10t2_0 += alt(ADD)

	T4_10t2_0_mem0 = S.Task('T4_10t2_0_mem0', length=1, delay_cost=1)
	T4_10t2_0_mem0 += alt(ADD_mem)
	S += (T1_300*ADD[0])-1<T4_10t2_0_mem0*ADD_mem[0]
	S += (T1_300*ADD[1])-1<T4_10t2_0_mem0*ADD_mem[1]
	S += (T1_300*ADD[2])-1<T4_10t2_0_mem0*ADD_mem[2]
	S += (T1_300*ADD[3])-1<T4_10t2_0_mem0*ADD_mem[3]
	S += T4_10t2_0_mem0<=T4_10t2_0

	T4_10t2_0_mem1 = S.Task('T4_10t2_0_mem1', length=1, delay_cost=1)
	T4_10t2_0_mem1 += ADD_mem[0]
	S += T1_310<T4_10t2_0_mem1
	S += T4_10t2_0_mem1<=T4_10t2_0

	T4_10t2_1 = S.Task('T4_10t2_1', length=1, delay_cost=1)
	T4_10t2_1 += alt(ADD)

	T4_10t2_1_mem0 = S.Task('T4_10t2_1_mem0', length=1, delay_cost=1)
	T4_10t2_1_mem0 += alt(ADD_mem)
	S += (T1_301*ADD[0])-1<T4_10t2_1_mem0*ADD_mem[0]
	S += (T1_301*ADD[1])-1<T4_10t2_1_mem0*ADD_mem[1]
	S += (T1_301*ADD[2])-1<T4_10t2_1_mem0*ADD_mem[2]
	S += (T1_301*ADD[3])-1<T4_10t2_1_mem0*ADD_mem[3]
	S += T4_10t2_1_mem0<=T4_10t2_1

	T4_10t2_1_mem1 = S.Task('T4_10t2_1_mem1', length=1, delay_cost=1)
	T4_10t2_1_mem1 += ADD_mem[3]
	S += T1_311<T4_10t2_1_mem1
	S += T4_10t2_1_mem1<=T4_10t2_1

	T4_10t0_a0b0_in = S.Task('T4_10t0_a0b0_in', length=1, delay_cost=1)
	T4_10t0_a0b0_in += alt(MUL_in)
	T4_10t0_a0b0 = S.Task('T4_10t0_a0b0', length=7, delay_cost=1)
	T4_10t0_a0b0 += alt(MUL)
	S+=T4_10t0_a0b0>=T4_10t0_a0b0_in

	T4_10t0_a0b0_mem0 = S.Task('T4_10t0_a0b0_mem0', length=1, delay_cost=1)
	T4_10t0_a0b0_mem0 += alt(ADD_mem)
	S += (T1_300*ADD[0])-1<T4_10t0_a0b0_mem0*ADD_mem[0]
	S += (T1_300*ADD[1])-1<T4_10t0_a0b0_mem0*ADD_mem[1]
	S += (T1_300*ADD[2])-1<T4_10t0_a0b0_mem0*ADD_mem[2]
	S += (T1_300*ADD[3])-1<T4_10t0_a0b0_mem0*ADD_mem[3]
	S += T4_10t0_a0b0_mem0<=T4_10t0_a0b0

	T4_10t0_a0b0_mem1 = S.Task('T4_10t0_a0b0_mem1', length=1, delay_cost=1)
	T4_10t0_a0b0_mem1 += ADD_mem[1]
	S += T20_100<T4_10t0_a0b0_mem1
	S += T4_10t0_a0b0_mem1<=T4_10t0_a0b0

	T4_10t1_a0b0_in = S.Task('T4_10t1_a0b0_in', length=1, delay_cost=1)
	T4_10t1_a0b0_in += alt(MUL_in)
	T4_10t1_a0b0 = S.Task('T4_10t1_a0b0', length=7, delay_cost=1)
	T4_10t1_a0b0 += alt(MUL)
	S+=T4_10t1_a0b0>=T4_10t1_a0b0_in

	T4_10t1_a0b0_mem0 = S.Task('T4_10t1_a0b0_mem0', length=1, delay_cost=1)
	T4_10t1_a0b0_mem0 += alt(ADD_mem)
	S += (T1_301*ADD[0])-1<T4_10t1_a0b0_mem0*ADD_mem[0]
	S += (T1_301*ADD[1])-1<T4_10t1_a0b0_mem0*ADD_mem[1]
	S += (T1_301*ADD[2])-1<T4_10t1_a0b0_mem0*ADD_mem[2]
	S += (T1_301*ADD[3])-1<T4_10t1_a0b0_mem0*ADD_mem[3]
	S += T4_10t1_a0b0_mem0<=T4_10t1_a0b0

	T4_10t1_a0b0_mem1 = S.Task('T4_10t1_a0b0_mem1', length=1, delay_cost=1)
	T4_10t1_a0b0_mem1 += ADD_mem[3]
	S += T20_101<T4_10t1_a0b0_mem1
	S += T4_10t1_a0b0_mem1<=T4_10t1_a0b0

	T4_10t2_a0b0 = S.Task('T4_10t2_a0b0', length=1, delay_cost=1)
	T4_10t2_a0b0 += alt(ADD)

	T4_10t2_a0b0_mem0 = S.Task('T4_10t2_a0b0_mem0', length=1, delay_cost=1)
	T4_10t2_a0b0_mem0 += alt(ADD_mem)
	S += (T1_300*ADD[0])-1<T4_10t2_a0b0_mem0*ADD_mem[0]
	S += (T1_300*ADD[1])-1<T4_10t2_a0b0_mem0*ADD_mem[1]
	S += (T1_300*ADD[2])-1<T4_10t2_a0b0_mem0*ADD_mem[2]
	S += (T1_300*ADD[3])-1<T4_10t2_a0b0_mem0*ADD_mem[3]
	S += T4_10t2_a0b0_mem0<=T4_10t2_a0b0

	T4_10t2_a0b0_mem1 = S.Task('T4_10t2_a0b0_mem1', length=1, delay_cost=1)
	T4_10t2_a0b0_mem1 += alt(ADD_mem)
	S += (T1_301*ADD[0])-1<T4_10t2_a0b0_mem1*ADD_mem[0]
	S += (T1_301*ADD[1])-1<T4_10t2_a0b0_mem1*ADD_mem[1]
	S += (T1_301*ADD[2])-1<T4_10t2_a0b0_mem1*ADD_mem[2]
	S += (T1_301*ADD[3])-1<T4_10t2_a0b0_mem1*ADD_mem[3]
	S += T4_10t2_a0b0_mem1<=T4_10t2_a0b0

	T4_10t4_a1b1_in = S.Task('T4_10t4_a1b1_in', length=1, delay_cost=1)
	T4_10t4_a1b1_in += alt(MUL_in)
	T4_10t4_a1b1 = S.Task('T4_10t4_a1b1', length=7, delay_cost=1)
	T4_10t4_a1b1 += alt(MUL)
	S+=T4_10t4_a1b1>=T4_10t4_a1b1_in

	T4_10t4_a1b1_mem0 = S.Task('T4_10t4_a1b1_mem0', length=1, delay_cost=1)
	T4_10t4_a1b1_mem0 += alt(ADD_mem)
	S += (T4_10t2_a1b1*ADD[0])-1<T4_10t4_a1b1_mem0*ADD_mem[0]
	S += (T4_10t2_a1b1*ADD[1])-1<T4_10t4_a1b1_mem0*ADD_mem[1]
	S += (T4_10t2_a1b1*ADD[2])-1<T4_10t4_a1b1_mem0*ADD_mem[2]
	S += (T4_10t2_a1b1*ADD[3])-1<T4_10t4_a1b1_mem0*ADD_mem[3]
	S += T4_10t4_a1b1_mem0<=T4_10t4_a1b1

	T4_10t4_a1b1_mem1 = S.Task('T4_10t4_a1b1_mem1', length=1, delay_cost=1)
	T4_10t4_a1b1_mem1 += ADD_mem[0]
	S += T1_2a11_new<T4_10t4_a1b1_mem1
	S += T4_10t4_a1b1_mem1<=T4_10t4_a1b1

	T4_10c0_a1b1 = S.Task('T4_10c0_a1b1', length=1, delay_cost=1)
	T4_10c0_a1b1 += alt(ADD)

	T4_10c0_a1b1_mem0 = S.Task('T4_10c0_a1b1_mem0', length=1, delay_cost=1)
	T4_10c0_a1b1_mem0 += MUL_mem[0]
	S += T4_10t0_a1b1<T4_10c0_a1b1_mem0
	S += T4_10c0_a1b1_mem0<=T4_10c0_a1b1

	T4_10c0_a1b1_mem1 = S.Task('T4_10c0_a1b1_mem1', length=1, delay_cost=1)
	T4_10c0_a1b1_mem1 += alt(MUL_mem)
	S += (T4_10t1_a1b1*MUL[0])-1<T4_10c0_a1b1_mem1*MUL_mem[0]
	S += T4_10c0_a1b1_mem1<=T4_10c0_a1b1

	T4_10t6_a1b1 = S.Task('T4_10t6_a1b1', length=1, delay_cost=1)
	T4_10t6_a1b1 += alt(ADD)

	T4_10t6_a1b1_mem0 = S.Task('T4_10t6_a1b1_mem0', length=1, delay_cost=1)
	T4_10t6_a1b1_mem0 += MUL_mem[0]
	S += T4_10t0_a1b1<T4_10t6_a1b1_mem0
	S += T4_10t6_a1b1_mem0<=T4_10t6_a1b1

	T4_10t6_a1b1_mem1 = S.Task('T4_10t6_a1b1_mem1', length=1, delay_cost=1)
	T4_10t6_a1b1_mem1 += alt(MUL_mem)
	S += (T4_10t1_a1b1*MUL[0])-1<T4_10t6_a1b1_mem1*MUL_mem[0]
	S += T4_10t6_a1b1_mem1<=T4_10t6_a1b1

	T5_7t2_0 = S.Task('T5_7t2_0', length=1, delay_cost=1)
	T5_7t2_0 += alt(ADD)

	T5_7t2_0_mem0 = S.Task('T5_7t2_0_mem0', length=1, delay_cost=1)
	T5_7t2_0_mem0 += alt(ADD_mem)
	S += (T0_300*ADD[0])-1<T5_7t2_0_mem0*ADD_mem[0]
	S += (T0_300*ADD[1])-1<T5_7t2_0_mem0*ADD_mem[1]
	S += (T0_300*ADD[2])-1<T5_7t2_0_mem0*ADD_mem[2]
	S += (T0_300*ADD[3])-1<T5_7t2_0_mem0*ADD_mem[3]
	S += T5_7t2_0_mem0<=T5_7t2_0

	T5_7t2_0_mem1 = S.Task('T5_7t2_0_mem1', length=1, delay_cost=1)
	T5_7t2_0_mem1 += ADD_mem[0]
	S += T0_310<T5_7t2_0_mem1
	S += T5_7t2_0_mem1<=T5_7t2_0

	T5_7t2_1 = S.Task('T5_7t2_1', length=1, delay_cost=1)
	T5_7t2_1 += alt(ADD)

	T5_7t2_1_mem0 = S.Task('T5_7t2_1_mem0', length=1, delay_cost=1)
	T5_7t2_1_mem0 += alt(ADD_mem)
	S += (T0_301*ADD[0])-1<T5_7t2_1_mem0*ADD_mem[0]
	S += (T0_301*ADD[1])-1<T5_7t2_1_mem0*ADD_mem[1]
	S += (T0_301*ADD[2])-1<T5_7t2_1_mem0*ADD_mem[2]
	S += (T0_301*ADD[3])-1<T5_7t2_1_mem0*ADD_mem[3]
	S += T5_7t2_1_mem0<=T5_7t2_1

	T5_7t2_1_mem1 = S.Task('T5_7t2_1_mem1', length=1, delay_cost=1)
	T5_7t2_1_mem1 += ADD_mem[0]
	S += T0_311<T5_7t2_1_mem1
	S += T5_7t2_1_mem1<=T5_7t2_1

	T5_7t0_a0b0_in = S.Task('T5_7t0_a0b0_in', length=1, delay_cost=1)
	T5_7t0_a0b0_in += alt(MUL_in)
	T5_7t0_a0b0 = S.Task('T5_7t0_a0b0', length=7, delay_cost=1)
	T5_7t0_a0b0 += alt(MUL)
	S+=T5_7t0_a0b0>=T5_7t0_a0b0_in

	T5_7t0_a0b0_mem0 = S.Task('T5_7t0_a0b0_mem0', length=1, delay_cost=1)
	T5_7t0_a0b0_mem0 += alt(ADD_mem)
	S += (T0_300*ADD[0])-1<T5_7t0_a0b0_mem0*ADD_mem[0]
	S += (T0_300*ADD[1])-1<T5_7t0_a0b0_mem0*ADD_mem[1]
	S += (T0_300*ADD[2])-1<T5_7t0_a0b0_mem0*ADD_mem[2]
	S += (T0_300*ADD[3])-1<T5_7t0_a0b0_mem0*ADD_mem[3]
	S += T5_7t0_a0b0_mem0<=T5_7t0_a0b0

	T5_7t0_a0b0_mem1 = S.Task('T5_7t0_a0b0_mem1', length=1, delay_cost=1)
	T5_7t0_a0b0_mem1 += ADD_mem[0]
	S += T19_100<T5_7t0_a0b0_mem1
	S += T5_7t0_a0b0_mem1<=T5_7t0_a0b0

	T5_7t1_a0b0_in = S.Task('T5_7t1_a0b0_in', length=1, delay_cost=1)
	T5_7t1_a0b0_in += alt(MUL_in)
	T5_7t1_a0b0 = S.Task('T5_7t1_a0b0', length=7, delay_cost=1)
	T5_7t1_a0b0 += alt(MUL)
	S+=T5_7t1_a0b0>=T5_7t1_a0b0_in

	T5_7t1_a0b0_mem0 = S.Task('T5_7t1_a0b0_mem0', length=1, delay_cost=1)
	T5_7t1_a0b0_mem0 += alt(ADD_mem)
	S += (T0_301*ADD[0])-1<T5_7t1_a0b0_mem0*ADD_mem[0]
	S += (T0_301*ADD[1])-1<T5_7t1_a0b0_mem0*ADD_mem[1]
	S += (T0_301*ADD[2])-1<T5_7t1_a0b0_mem0*ADD_mem[2]
	S += (T0_301*ADD[3])-1<T5_7t1_a0b0_mem0*ADD_mem[3]
	S += T5_7t1_a0b0_mem0<=T5_7t1_a0b0

	T5_7t1_a0b0_mem1 = S.Task('T5_7t1_a0b0_mem1', length=1, delay_cost=1)
	T5_7t1_a0b0_mem1 += ADD_mem[0]
	S += T19_101<T5_7t1_a0b0_mem1
	S += T5_7t1_a0b0_mem1<=T5_7t1_a0b0

	T5_7t2_a0b0 = S.Task('T5_7t2_a0b0', length=1, delay_cost=1)
	T5_7t2_a0b0 += alt(ADD)

	T5_7t2_a0b0_mem0 = S.Task('T5_7t2_a0b0_mem0', length=1, delay_cost=1)
	T5_7t2_a0b0_mem0 += alt(ADD_mem)
	S += (T0_300*ADD[0])-1<T5_7t2_a0b0_mem0*ADD_mem[0]
	S += (T0_300*ADD[1])-1<T5_7t2_a0b0_mem0*ADD_mem[1]
	S += (T0_300*ADD[2])-1<T5_7t2_a0b0_mem0*ADD_mem[2]
	S += (T0_300*ADD[3])-1<T5_7t2_a0b0_mem0*ADD_mem[3]
	S += T5_7t2_a0b0_mem0<=T5_7t2_a0b0

	T5_7t2_a0b0_mem1 = S.Task('T5_7t2_a0b0_mem1', length=1, delay_cost=1)
	T5_7t2_a0b0_mem1 += alt(ADD_mem)
	S += (T0_301*ADD[0])-1<T5_7t2_a0b0_mem1*ADD_mem[0]
	S += (T0_301*ADD[1])-1<T5_7t2_a0b0_mem1*ADD_mem[1]
	S += (T0_301*ADD[2])-1<T5_7t2_a0b0_mem1*ADD_mem[2]
	S += (T0_301*ADD[3])-1<T5_7t2_a0b0_mem1*ADD_mem[3]
	S += T5_7t2_a0b0_mem1<=T5_7t2_a0b0

	T5_7t4_a1b1_in = S.Task('T5_7t4_a1b1_in', length=1, delay_cost=1)
	T5_7t4_a1b1_in += alt(MUL_in)
	T5_7t4_a1b1 = S.Task('T5_7t4_a1b1', length=7, delay_cost=1)
	T5_7t4_a1b1 += alt(MUL)
	S+=T5_7t4_a1b1>=T5_7t4_a1b1_in

	T5_7t4_a1b1_mem0 = S.Task('T5_7t4_a1b1_mem0', length=1, delay_cost=1)
	T5_7t4_a1b1_mem0 += alt(ADD_mem)
	S += (T5_7t2_a1b1*ADD[0])-1<T5_7t4_a1b1_mem0*ADD_mem[0]
	S += (T5_7t2_a1b1*ADD[1])-1<T5_7t4_a1b1_mem0*ADD_mem[1]
	S += (T5_7t2_a1b1*ADD[2])-1<T5_7t4_a1b1_mem0*ADD_mem[2]
	S += (T5_7t2_a1b1*ADD[3])-1<T5_7t4_a1b1_mem0*ADD_mem[3]
	S += T5_7t4_a1b1_mem0<=T5_7t4_a1b1

	T5_7t4_a1b1_mem1 = S.Task('T5_7t4_a1b1_mem1', length=1, delay_cost=1)
	T5_7t4_a1b1_mem1 += ADD_mem[2]
	S += T0_2a11_new<T5_7t4_a1b1_mem1
	S += T5_7t4_a1b1_mem1<=T5_7t4_a1b1

	T5_7c0_a1b1 = S.Task('T5_7c0_a1b1', length=1, delay_cost=1)
	T5_7c0_a1b1 += alt(ADD)

	T5_7c0_a1b1_mem0 = S.Task('T5_7c0_a1b1_mem0', length=1, delay_cost=1)
	T5_7c0_a1b1_mem0 += alt(MUL_mem)
	S += (T5_7t0_a1b1*MUL[0])-1<T5_7c0_a1b1_mem0*MUL_mem[0]
	S += T5_7c0_a1b1_mem0<=T5_7c0_a1b1

	T5_7c0_a1b1_mem1 = S.Task('T5_7c0_a1b1_mem1', length=1, delay_cost=1)
	T5_7c0_a1b1_mem1 += alt(MUL_mem)
	S += (T5_7t1_a1b1*MUL[0])-1<T5_7c0_a1b1_mem1*MUL_mem[0]
	S += T5_7c0_a1b1_mem1<=T5_7c0_a1b1

	T5_7t6_a1b1 = S.Task('T5_7t6_a1b1', length=1, delay_cost=1)
	T5_7t6_a1b1 += alt(ADD)

	T5_7t6_a1b1_mem0 = S.Task('T5_7t6_a1b1_mem0', length=1, delay_cost=1)
	T5_7t6_a1b1_mem0 += alt(MUL_mem)
	S += (T5_7t0_a1b1*MUL[0])-1<T5_7t6_a1b1_mem0*MUL_mem[0]
	S += T5_7t6_a1b1_mem0<=T5_7t6_a1b1

	T5_7t6_a1b1_mem1 = S.Task('T5_7t6_a1b1_mem1', length=1, delay_cost=1)
	T5_7t6_a1b1_mem1 += alt(MUL_mem)
	S += (T5_7t1_a1b1*MUL[0])-1<T5_7t6_a1b1_mem1*MUL_mem[0]
	S += T5_7t6_a1b1_mem1<=T5_7t6_a1b1
	...
	pic_file_name = "inv_mul1_add4/inv_mul1_add4_14.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_inv_mul1_add4_14(0, 0)