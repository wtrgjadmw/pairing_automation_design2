...
16: begin
	...
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
	add1_opr1 <= add0_out; add1_opr2 <= add3_out_reg; issub1 <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
	ram_add3_wr_n <= 0;
	ram_add0_wr_n <= 0;
...
23: begin
	add1_opr1 <= ram_input_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	add3_opr1 <= add3_out; add3_opr2 <= ram_add3_out1; issub3 <= 1;
...
42: begin
	...
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_input_out2; issub3 <= 0;
	add0_opr1 <= add1_out; add0_opr2 <= ram_add0_out2; issub0 <= 1;
...
61: begin
	...
	add1_opr1 <= add1_out; add1_opr2 <= add3_out_reg; issub1 <= 1;
...
64: begin
	add1_opr1 <= ram_add2_out1; add1_opr2 <= add2_out; issub1 <= 1;
...
68: begin
	...
	add0_opr1 <= ram_add0_out2; add0_opr2 <= add2_out; issub0 <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
...
69: begin
	add1_opr1 <= add1_out; add1_opr2 <= add3_out; issub1 <= 1;
...
82: begin
	...
	add3_opr1 <= add0_out; add3_opr2 <= add2_out; issub3 <= 1;
	add2_opr1 <= add3_out_reg; add2_opr2 <= ram_add2_out1; issub2 <= 1;
