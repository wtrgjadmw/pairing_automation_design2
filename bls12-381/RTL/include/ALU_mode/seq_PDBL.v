...
7: begin
	mm0_opr1 <= ram_input_out1; mm0_opr2 <= ram_input_out2; 
	ram_input_raddr1 <= `RAM_b_t0;
	ram_input_raddr2 <= `RAM_b_t1;
	state <= state + 1;
end
8: begin
...
14: begin
	...
	add3_opr1 <= ram_mm0_out1; add3_opr2 <= ram_mm0_out1; issub3 <= 1;
...
36: begin
	...
	mm0_opr1 <= add0_out_reg; mm0_opr2 <= add2_out; 
...
37: begin
	...
	add0_opr1 <= add3_out_reg; add0_opr2 <= add2_out; issub0 <= 1;
