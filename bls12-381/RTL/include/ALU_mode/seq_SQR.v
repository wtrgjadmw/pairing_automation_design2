...
41: begin
	...
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_add0_out2; issub0 <= 0;
...
45: begin
	...
	add2_opr1 <= add1_out_reg; add2_opr2 <= add2_out_reg; issub2 <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 3;
	ram_add0_wr_n <= 0;
	ram_add2_wr_n <= 0;
...
52: begin
	...
	add1_opr1 <= add0_out_reg; add1_opr2 <= add0_out_reg; issub1 <= 0;
	mm0_opr1 <= ram_add2_out1; mm0_opr2 <= ram_add3_out1; 
	add2_opr1 <= ram_add3_out2; add2_opr2 <= add0_out_reg; issub2 <= 1;
	ram_add2_wr_n <= 1;
	ram_mm0_wr_n <= 0;
	ram_add0_wr_n <= 0;
	ram_mm0_waddr <= 1;
...
66: begin
	...
	add1_opr1 <= ram_add3_out2; add1_opr2 <= ram_add0_out2; issub1 <= 1;
