...
function [`WORD_SIZE-1: 0] wdata_func1;
    input [`WORD_SIZE-1: 0] mm0_out_reg, add0_out_reg, add1_out_reg, add2_out_reg, add3_out_reg;
    input [`OPR_NUM_SIZE-1: 0] wdata_s1;
    begin
        case (wdata_s1)
            `MM0: wdata_func1 = mm0_out_reg;
            `ADD0: wdata_func1 = add0_out_reg;
            `ADD1: wdata_func1 = add1_out_reg;
            `ADD2: wdata_func1 = add2_out_reg;
            `ADD3: wdata_func1 = add3_out_reg;
        endcase
    end
endfunction
...
function [`WORD_SIZE-1: 0] wdata_func2;
    ...
    begin
        case (wdata_s2)
            `MM0: wdata_func2 = mm0_out_reg;
            `ADD0: wdata_func2 = add0_out_reg;
            `ADD1: wdata_func2 = add1_out_reg;
            `ADD2: wdata_func2 = add2_out_reg;
            `ADD3: wdata_func2 = add3_out_reg;
        endcase
    end
endfunction
