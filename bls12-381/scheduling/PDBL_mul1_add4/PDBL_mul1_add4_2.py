...
def solve():
	...
	new_yt0_mem0 += alt(ADD_mem)
	S += (t170*ADD[0])-1<new_yt0_mem0*ADD_mem[0]
	S += (t170*ADD[1])-1<new_yt0_mem0*ADD_mem[1]
	S += (t170*ADD[2])-1<new_yt0_mem0*ADD_mem[2]
	S += (t170*ADD[3])-1<new_yt0_mem0*ADD_mem[3]
	S += new_yt0_mem0<=new_yt0

	new_yt0_mem1 = S.Task('new_yt0_mem1', length=1, delay_cost=1)
	new_yt0_mem1 += ADD_mem[1]
	S += 37<new_yt0_mem1
	...
	new_yt1_mem0 += alt(ADD_mem)
	S += (t171*ADD[0])-1<new_yt1_mem0*ADD_mem[0]
	S += (t171*ADD[1])-1<new_yt1_mem0*ADD_mem[1]
	S += (t171*ADD[2])-1<new_yt1_mem0*ADD_mem[2]
	S += (t171*ADD[3])-1<new_yt1_mem0*ADD_mem[3]
	S += new_yt1_mem0<=new_yt1

	new_yt1_mem1 = S.Task('new_yt1_mem1', length=1, delay_cost=1)
	new_yt1_mem1 += ADD_mem[2]
	S += 38<new_yt1_mem1
