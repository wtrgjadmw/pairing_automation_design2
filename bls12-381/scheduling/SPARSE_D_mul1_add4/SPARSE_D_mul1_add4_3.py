...
def solve():
	horizon = 139
	S = Scenario("SPARSE_D_mul1_add4_3", horizon=horizon)
	...
	S += t5_t41_mem0 >= 43
	t5_t41_mem0 += ADD_mem[0]

	t5_t41_mem1 = S.Task('t5_t41_mem1', length=1, delay_cost=1)
	S += t5_t41_mem1 >= 43
	t5_t41_mem1 += INPUT_mem_r
	...
	S += t5_t0_t2_mem0 >= 44
	t5_t0_t2_mem0 += ADD_mem[0]

	t5_t0_t2_mem1 = S.Task('t5_t0_t2_mem1', length=1, delay_cost=1)
	S += t5_t0_t2_mem1 >= 44
	t5_t0_t2_mem1 += ADD_mem[0]
	...
	S += (t420*ADD[0])-1<t170_mem0*ADD_mem[0]
	S += (t420*ADD[1])-1<t170_mem0*ADD_mem[1]
	S += (t420*ADD[2])-1<t170_mem0*ADD_mem[2]
	S += (t420*ADD[3])-1<t170_mem0*ADD_mem[3]
	S += t170_mem0<=t170

	t170_mem1 = S.Task('t170_mem1', length=1, delay_cost=1)
	t170_mem1 += alt(ADD_mem)
	S += (t421*ADD[0])-1<t170_mem1*ADD_mem[0]
	S += (t421*ADD[1])-1<t170_mem1*ADD_mem[1]
	S += (t421*ADD[2])-1<t170_mem1*ADD_mem[2]
	S += (t421*ADD[3])-1<t170_mem1*ADD_mem[3]
	S += t170_mem1<=t170
	...
	S += (t421*ADD[0])-1<t171_mem0*ADD_mem[0]
	S += (t421*ADD[1])-1<t171_mem0*ADD_mem[1]
	S += (t421*ADD[2])-1<t171_mem0*ADD_mem[2]
	S += (t421*ADD[3])-1<t171_mem0*ADD_mem[3]
	S += t171_mem0<=t171

	t171_mem1 = S.Task('t171_mem1', length=1, delay_cost=1)
	t171_mem1 += alt(ADD_mem)
	S += (t420*ADD[0])-1<t171_mem1*ADD_mem[0]
	S += (t420*ADD[1])-1<t171_mem1*ADD_mem[1]
	S += (t420*ADD[2])-1<t171_mem1*ADD_mem[2]
	S += (t420*ADD[3])-1<t171_mem1*ADD_mem[3]
	S += t171_mem1<=t171
	...
	S += (t01*ADD[0])-1<t141_mem0*ADD_mem[0]
	S += (t01*ADD[1])-1<t141_mem0*ADD_mem[1]
	S += (t01*ADD[2])-1<t141_mem0*ADD_mem[2]
	S += (t01*ADD[3])-1<t141_mem0*ADD_mem[3]
	S += t141_mem0<=t141
	...
	S += (t410*ADD[0])-1<c110_mem1*ADD_mem[0]
	S += (t410*ADD[1])-1<c110_mem1*ADD_mem[1]
	S += (t410*ADD[2])-1<c110_mem1*ADD_mem[2]
	S += (t410*ADD[3])-1<c110_mem1*ADD_mem[3]
	S += c110_mem1<=c110
	...
	S += (t170*ADD[0])-1<c000_mem1*ADD_mem[0]
	S += (t170*ADD[1])-1<c000_mem1*ADD_mem[1]
	S += (t170*ADD[2])-1<c000_mem1*ADD_mem[2]
	S += (t170*ADD[3])-1<c000_mem1*ADD_mem[3]
	S += c000_mem1<=c000
	...
	S += (t171*ADD[0])-1<c001_mem1*ADD_mem[0]
	S += (t171*ADD[1])-1<c001_mem1*ADD_mem[1]
	S += (t171*ADD[2])-1<c001_mem1*ADD_mem[2]
	S += (t171*ADD[3])-1<c001_mem1*ADD_mem[3]
	S += c001_mem1<=c001
	...
	S += (t400*ADD[0])-1<c200_mem1*ADD_mem[0]
	S += (t400*ADD[1])-1<c200_mem1*ADD_mem[1]
	S += (t400*ADD[2])-1<c200_mem1*ADD_mem[2]
	S += (t400*ADD[3])-1<c200_mem1*ADD_mem[3]
	S += c200_mem1<=c200
	...
	S += (t11*ADD[0])-1<c201_mem0*ADD_mem[0]
	S += (t11*ADD[1])-1<c201_mem0*ADD_mem[1]
	S += (t11*ADD[2])-1<c201_mem0*ADD_mem[2]
	S += (t11*ADD[3])-1<c201_mem0*ADD_mem[3]
	S += c201_mem0<=c201

	c201_mem1 = S.Task('c201_mem1', length=1, delay_cost=1)
	c201_mem1 += alt(ADD_mem)
	S += (t401*ADD[0])-1<c201_mem1*ADD_mem[0]
	S += (t401*ADD[1])-1<c201_mem1*ADD_mem[1]
	S += (t401*ADD[2])-1<c201_mem1*ADD_mem[2]
	S += (t401*ADD[3])-1<c201_mem1*ADD_mem[3]
	S += c201_mem1<=c201
	...
	S += (t21*ADD[0])-1<c111_mem0*ADD_mem[0]
	S += (t21*ADD[1])-1<c111_mem0*ADD_mem[1]
	S += (t21*ADD[2])-1<c111_mem0*ADD_mem[2]
	S += (t21*ADD[3])-1<c111_mem0*ADD_mem[3]
	S += c111_mem0<=c111

	c111_mem1 = S.Task('c111_mem1', length=1, delay_cost=1)
	c111_mem1 += alt(ADD_mem)
	S += (t411*ADD[0])-1<c111_mem1*ADD_mem[0]
	S += (t411*ADD[1])-1<c111_mem1*ADD_mem[1]
	S += (t411*ADD[2])-1<c111_mem1*ADD_mem[2]
	S += (t411*ADD[3])-1<c111_mem1*ADD_mem[3]
	S += c111_mem1<=c111
	...
	pic_file_name = "SPARSE_D_mul1_add4/SPARSE_D_mul1_add4_3.png"
	if(S.solution() != []):
