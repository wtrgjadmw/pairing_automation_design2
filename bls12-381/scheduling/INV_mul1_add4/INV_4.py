...
def solve():
	...
	S += (c_aa_t2_t2*ADD[0])-1<c_aa_t2_t4_mem0*ADD_mem[0]
	S += (c_aa_t2_t2*ADD[1])-1<c_aa_t2_t4_mem0*ADD_mem[1]
	S += (c_aa_t2_t2*ADD[2])-1<c_aa_t2_t4_mem0*ADD_mem[2]
	S += (c_aa_t2_t2*ADD[3])-1<c_aa_t2_t4_mem0*ADD_mem[3]
	S += c_aa_t2_t4_mem0<=c_aa_t2_t4

	c_aa_t2_t4_mem1 = S.Task('c_aa_t2_t4_mem1', length=1, delay_cost=1)
	c_aa_t2_t4_mem1 += ADD_mem[1]
	S += 24<c_aa_t2_t4_mem1
	...
	S += (c_aa_t2_t0*MUL[0])-1<c_aa_t20_mem0*MUL_mem[0]
	S += c_aa_t20_mem0<=c_aa_t20

	c_aa_t20_mem1 = S.Task('c_aa_t20_mem1', length=1, delay_cost=1)
	c_aa_t20_mem1 += alt(MUL_mem)
	S += (c_aa_t2_t1*MUL[0])-1<c_aa_t20_mem1*MUL_mem[0]
	...
	S += (c_aa_t2_t0*MUL[0])-1<c_aa_t2_t5_mem0*MUL_mem[0]
	S += c_aa_t2_t5_mem0<=c_aa_t2_t5

	c_aa_t2_t5_mem1 = S.Task('c_aa_t2_t5_mem1', length=1, delay_cost=1)
	c_aa_t2_t5_mem1 += alt(MUL_mem)
	S += (c_aa_t2_t1*MUL[0])-1<c_aa_t2_t5_mem1*MUL_mem[0]
	...
	S += (c_aa_t31*ADD[0])-1<c_aa_t40_mem1*ADD_mem[0]
	S += (c_aa_t31*ADD[1])-1<c_aa_t40_mem1*ADD_mem[1]
	S += (c_aa_t31*ADD[2])-1<c_aa_t40_mem1*ADD_mem[2]
	S += (c_aa_t31*ADD[3])-1<c_aa_t40_mem1*ADD_mem[3]
	...
	S += (c_aa_t31*ADD[0])-1<c_aa_t41_mem0*ADD_mem[0]
	S += (c_aa_t31*ADD[1])-1<c_aa_t41_mem0*ADD_mem[1]
	S += (c_aa_t31*ADD[2])-1<c_aa_t41_mem0*ADD_mem[2]
	S += (c_aa_t31*ADD[3])-1<c_aa_t41_mem0*ADD_mem[3]
	...
	S += (c_aa_t31*ADD[0])-1<c_aa11_mem0*ADD_mem[0]
	S += (c_aa_t31*ADD[1])-1<c_aa11_mem0*ADD_mem[1]
	S += (c_aa_t31*ADD[2])-1<c_aa11_mem0*ADD_mem[2]
	S += (c_aa_t31*ADD[3])-1<c_aa11_mem0*ADD_mem[3]
	S += c_aa11_mem0<=c_aa11

	c_aa11_mem1 = S.Task('c_aa11_mem1', length=1, delay_cost=1)
	c_aa11_mem1 += alt(ADD_mem)
	S += (c_aa_t31*ADD[0])-1<c_aa11_mem1*ADD_mem[0]
	S += (c_aa_t31*ADD[1])-1<c_aa11_mem1*ADD_mem[1]
	S += (c_aa_t31*ADD[2])-1<c_aa11_mem1*ADD_mem[2]
	S += (c_aa_t31*ADD[3])-1<c_aa11_mem1*ADD_mem[3]
	...
	S += (c_bb_t2_t2*ADD[0])-1<c_bb_t2_t4_mem0*ADD_mem[0]
	S += (c_bb_t2_t2*ADD[1])-1<c_bb_t2_t4_mem0*ADD_mem[1]
	S += (c_bb_t2_t2*ADD[2])-1<c_bb_t2_t4_mem0*ADD_mem[2]
	S += (c_bb_t2_t2*ADD[3])-1<c_bb_t2_t4_mem0*ADD_mem[3]
	...
	S += (c_bb_t2_t0*MUL[0])-1<c_bb_t20_mem0*MUL_mem[0]
	S += c_bb_t20_mem0<=c_bb_t20

	c_bb_t20_mem1 = S.Task('c_bb_t20_mem1', length=1, delay_cost=1)
	c_bb_t20_mem1 += alt(MUL_mem)
	S += (c_bb_t2_t1*MUL[0])-1<c_bb_t20_mem1*MUL_mem[0]
	...
	S += (c_bb_t2_t0*MUL[0])-1<c_bb_t2_t5_mem0*MUL_mem[0]
	S += c_bb_t2_t5_mem0<=c_bb_t2_t5

	c_bb_t2_t5_mem1 = S.Task('c_bb_t2_t5_mem1', length=1, delay_cost=1)
	c_bb_t2_t5_mem1 += alt(MUL_mem)
	S += (c_bb_t2_t1*MUL[0])-1<c_bb_t2_t5_mem1*MUL_mem[0]
	...
	S += (c_bb_t31*ADD[0])-1<c_bb_t40_mem1*ADD_mem[0]
	S += (c_bb_t31*ADD[1])-1<c_bb_t40_mem1*ADD_mem[1]
	S += (c_bb_t31*ADD[2])-1<c_bb_t40_mem1*ADD_mem[2]
	S += (c_bb_t31*ADD[3])-1<c_bb_t40_mem1*ADD_mem[3]
	...
	S += (c_bb_t31*ADD[0])-1<c_bb_t41_mem0*ADD_mem[0]
	S += (c_bb_t31*ADD[1])-1<c_bb_t41_mem0*ADD_mem[1]
	S += (c_bb_t31*ADD[2])-1<c_bb_t41_mem0*ADD_mem[2]
	S += (c_bb_t31*ADD[3])-1<c_bb_t41_mem0*ADD_mem[3]
	...
	S += (c_bb_t31*ADD[0])-1<c_bb11_mem0*ADD_mem[0]
	S += (c_bb_t31*ADD[1])-1<c_bb11_mem0*ADD_mem[1]
	S += (c_bb_t31*ADD[2])-1<c_bb11_mem0*ADD_mem[2]
	S += (c_bb_t31*ADD[3])-1<c_bb11_mem0*ADD_mem[3]
	S += c_bb11_mem0<=c_bb11

	c_bb11_mem1 = S.Task('c_bb11_mem1', length=1, delay_cost=1)
	c_bb11_mem1 += alt(ADD_mem)
	S += (c_bb_t31*ADD[0])-1<c_bb11_mem1*ADD_mem[0]
	S += (c_bb_t31*ADD[1])-1<c_bb11_mem1*ADD_mem[1]
	S += (c_bb_t31*ADD[2])-1<c_bb11_mem1*ADD_mem[2]
	S += (c_bb_t31*ADD[3])-1<c_bb11_mem1*ADD_mem[3]
	...
	S += (c_cc_t2_t2*ADD[0])-1<c_cc_t2_t4_mem0*ADD_mem[0]
	S += (c_cc_t2_t2*ADD[1])-1<c_cc_t2_t4_mem0*ADD_mem[1]
	S += (c_cc_t2_t2*ADD[2])-1<c_cc_t2_t4_mem0*ADD_mem[2]
	S += (c_cc_t2_t2*ADD[3])-1<c_cc_t2_t4_mem0*ADD_mem[3]
	S += c_cc_t2_t4_mem0<=c_cc_t2_t4

	c_cc_t2_t4_mem1 = S.Task('c_cc_t2_t4_mem1', length=1, delay_cost=1)
	c_cc_t2_t4_mem1 += ADD_mem[1]
	S += 22<c_cc_t2_t4_mem1
	...
	S += (c_cc_t2_t0*MUL[0])-1<c_cc_t20_mem0*MUL_mem[0]
	S += c_cc_t20_mem0<=c_cc_t20

	c_cc_t20_mem1 = S.Task('c_cc_t20_mem1', length=1, delay_cost=1)
	c_cc_t20_mem1 += alt(MUL_mem)
	S += (c_cc_t2_t1*MUL[0])-1<c_cc_t20_mem1*MUL_mem[0]
	...
	S += (c_cc_t2_t0*MUL[0])-1<c_cc_t2_t5_mem0*MUL_mem[0]
	S += c_cc_t2_t5_mem0<=c_cc_t2_t5

	c_cc_t2_t5_mem1 = S.Task('c_cc_t2_t5_mem1', length=1, delay_cost=1)
	c_cc_t2_t5_mem1 += alt(MUL_mem)
	S += (c_cc_t2_t1*MUL[0])-1<c_cc_t2_t5_mem1*MUL_mem[0]
	...
	S += (c_cc_t31*ADD[0])-1<c_cc_t40_mem1*ADD_mem[0]
	S += (c_cc_t31*ADD[1])-1<c_cc_t40_mem1*ADD_mem[1]
	S += (c_cc_t31*ADD[2])-1<c_cc_t40_mem1*ADD_mem[2]
	S += (c_cc_t31*ADD[3])-1<c_cc_t40_mem1*ADD_mem[3]
	...
	S += (c_cc_t31*ADD[0])-1<c_cc_t41_mem0*ADD_mem[0]
	S += (c_cc_t31*ADD[1])-1<c_cc_t41_mem0*ADD_mem[1]
	S += (c_cc_t31*ADD[2])-1<c_cc_t41_mem0*ADD_mem[2]
	S += (c_cc_t31*ADD[3])-1<c_cc_t41_mem0*ADD_mem[3]
	...
	S += (c_cc_t31*ADD[0])-1<c_cc11_mem0*ADD_mem[0]
	S += (c_cc_t31*ADD[1])-1<c_cc11_mem0*ADD_mem[1]
	S += (c_cc_t31*ADD[2])-1<c_cc11_mem0*ADD_mem[2]
	S += (c_cc_t31*ADD[3])-1<c_cc11_mem0*ADD_mem[3]
	S += c_cc11_mem0<=c_cc11

	c_cc11_mem1 = S.Task('c_cc11_mem1', length=1, delay_cost=1)
	c_cc11_mem1 += alt(ADD_mem)
	S += (c_cc_t31*ADD[0])-1<c_cc11_mem1*ADD_mem[0]
	S += (c_cc_t31*ADD[1])-1<c_cc11_mem1*ADD_mem[1]
	S += (c_cc_t31*ADD[2])-1<c_cc11_mem1*ADD_mem[2]
	S += (c_cc_t31*ADD[3])-1<c_cc11_mem1*ADD_mem[3]
	...
	S += (c_ab_t4_t4*MUL[0])-1<c_ab_t41_mem0*MUL_mem[0]
	S += c_ab_t41_mem0<=c_ab_t41

	c_ab_t41_mem1 = S.Task('c_ab_t41_mem1', length=1, delay_cost=1)
	c_ab_t41_mem1 += alt(ADD_mem)
	S += (c_ab_t4_t5*ADD[0])-1<c_ab_t41_mem1*ADD_mem[0]
	S += (c_ab_t4_t5*ADD[1])-1<c_ab_t41_mem1*ADD_mem[1]
	S += (c_ab_t4_t5*ADD[2])-1<c_ab_t41_mem1*ADD_mem[2]
	S += (c_ab_t4_t5*ADD[3])-1<c_ab_t41_mem1*ADD_mem[3]
	...
	S += (c_ab_t11*ADD[0])-1<c_ab_s00_mem1*ADD_mem[0]
	S += (c_ab_t11*ADD[1])-1<c_ab_s00_mem1*ADD_mem[1]
	S += (c_ab_t11*ADD[2])-1<c_ab_s00_mem1*ADD_mem[2]
	S += (c_ab_t11*ADD[3])-1<c_ab_s00_mem1*ADD_mem[3]
	...
	S += (c_ab_t11*ADD[0])-1<c_ab_s01_mem0*ADD_mem[0]
	S += (c_ab_t11*ADD[1])-1<c_ab_s01_mem0*ADD_mem[1]
	S += (c_ab_t11*ADD[2])-1<c_ab_s01_mem0*ADD_mem[2]
	S += (c_ab_t11*ADD[3])-1<c_ab_s01_mem0*ADD_mem[3]
	...
	S += (c_ab_t01*ADD[0])-1<c_ab_t51_mem0*ADD_mem[0]
	S += (c_ab_t01*ADD[1])-1<c_ab_t51_mem0*ADD_mem[1]
	S += (c_ab_t01*ADD[2])-1<c_ab_t51_mem0*ADD_mem[2]
	S += (c_ab_t01*ADD[3])-1<c_ab_t51_mem0*ADD_mem[3]
	S += c_ab_t51_mem0<=c_ab_t51

	c_ab_t51_mem1 = S.Task('c_ab_t51_mem1', length=1, delay_cost=1)
	c_ab_t51_mem1 += alt(ADD_mem)
	S += (c_ab_t11*ADD[0])-1<c_ab_t51_mem1*ADD_mem[0]
	S += (c_ab_t11*ADD[1])-1<c_ab_t51_mem1*ADD_mem[1]
	S += (c_ab_t11*ADD[2])-1<c_ab_t51_mem1*ADD_mem[2]
	S += (c_ab_t11*ADD[3])-1<c_ab_t51_mem1*ADD_mem[3]
	...
	S += (c_ab_t40*ADD[0])-1<c_ab10_mem0*ADD_mem[0]
	S += (c_ab_t40*ADD[1])-1<c_ab10_mem0*ADD_mem[1]
	S += (c_ab_t40*ADD[2])-1<c_ab10_mem0*ADD_mem[2]
	S += (c_ab_t40*ADD[3])-1<c_ab10_mem0*ADD_mem[3]
	S += c_ab10_mem0<=c_ab10

	c_ab10_mem1 = S.Task('c_ab10_mem1', length=1, delay_cost=1)
	c_ab10_mem1 += alt(ADD_mem)
	S += (c_ab_t50*ADD[0])-1<c_ab10_mem1*ADD_mem[0]
	S += (c_ab_t50*ADD[1])-1<c_ab10_mem1*ADD_mem[1]
	S += (c_ab_t50*ADD[2])-1<c_ab10_mem1*ADD_mem[2]
	S += (c_ab_t50*ADD[3])-1<c_ab10_mem1*ADD_mem[3]
	...
	S += (c_bc_t4_t4*MUL[0])-1<c_bc_t41_mem0*MUL_mem[0]
	S += c_bc_t41_mem0<=c_bc_t41

	c_bc_t41_mem1 = S.Task('c_bc_t41_mem1', length=1, delay_cost=1)
	c_bc_t41_mem1 += alt(ADD_mem)
	S += (c_bc_t4_t5*ADD[0])-1<c_bc_t41_mem1*ADD_mem[0]
	S += (c_bc_t4_t5*ADD[1])-1<c_bc_t41_mem1*ADD_mem[1]
	S += (c_bc_t4_t5*ADD[2])-1<c_bc_t41_mem1*ADD_mem[2]
	S += (c_bc_t4_t5*ADD[3])-1<c_bc_t41_mem1*ADD_mem[3]
	...
	S += (c_bc_t11*ADD[0])-1<c_bc_s00_mem1*ADD_mem[0]
	S += (c_bc_t11*ADD[1])-1<c_bc_s00_mem1*ADD_mem[1]
	S += (c_bc_t11*ADD[2])-1<c_bc_s00_mem1*ADD_mem[2]
	S += (c_bc_t11*ADD[3])-1<c_bc_s00_mem1*ADD_mem[3]
	...
	S += (c_bc_t11*ADD[0])-1<c_bc_s01_mem0*ADD_mem[0]
	S += (c_bc_t11*ADD[1])-1<c_bc_s01_mem0*ADD_mem[1]
	S += (c_bc_t11*ADD[2])-1<c_bc_s01_mem0*ADD_mem[2]
	S += (c_bc_t11*ADD[3])-1<c_bc_s01_mem0*ADD_mem[3]
	...
	S += (c_bc_t01*ADD[0])-1<c_bc_t51_mem0*ADD_mem[0]
	S += (c_bc_t01*ADD[1])-1<c_bc_t51_mem0*ADD_mem[1]
	S += (c_bc_t01*ADD[2])-1<c_bc_t51_mem0*ADD_mem[2]
	S += (c_bc_t01*ADD[3])-1<c_bc_t51_mem0*ADD_mem[3]
	S += c_bc_t51_mem0<=c_bc_t51

	c_bc_t51_mem1 = S.Task('c_bc_t51_mem1', length=1, delay_cost=1)
	c_bc_t51_mem1 += alt(ADD_mem)
	S += (c_bc_t11*ADD[0])-1<c_bc_t51_mem1*ADD_mem[0]
	S += (c_bc_t11*ADD[1])-1<c_bc_t51_mem1*ADD_mem[1]
	S += (c_bc_t11*ADD[2])-1<c_bc_t51_mem1*ADD_mem[2]
	S += (c_bc_t11*ADD[3])-1<c_bc_t51_mem1*ADD_mem[3]
	...
	S += (c_bc_t40*ADD[0])-1<c_bc10_mem0*ADD_mem[0]
	S += (c_bc_t40*ADD[1])-1<c_bc10_mem0*ADD_mem[1]
	S += (c_bc_t40*ADD[2])-1<c_bc10_mem0*ADD_mem[2]
	S += (c_bc_t40*ADD[3])-1<c_bc10_mem0*ADD_mem[3]
	S += c_bc10_mem0<=c_bc10

	c_bc10_mem1 = S.Task('c_bc10_mem1', length=1, delay_cost=1)
	c_bc10_mem1 += alt(ADD_mem)
	S += (c_bc_t50*ADD[0])-1<c_bc10_mem1*ADD_mem[0]
	S += (c_bc_t50*ADD[1])-1<c_bc10_mem1*ADD_mem[1]
	S += (c_bc_t50*ADD[2])-1<c_bc10_mem1*ADD_mem[2]
	S += (c_bc_t50*ADD[3])-1<c_bc10_mem1*ADD_mem[3]
	...
	S += (c_ac_t4_t4*MUL[0])-1<c_ac_t41_mem0*MUL_mem[0]
	S += c_ac_t41_mem0<=c_ac_t41

	c_ac_t41_mem1 = S.Task('c_ac_t41_mem1', length=1, delay_cost=1)
	c_ac_t41_mem1 += alt(ADD_mem)
	S += (c_ac_t4_t5*ADD[0])-1<c_ac_t41_mem1*ADD_mem[0]
	S += (c_ac_t4_t5*ADD[1])-1<c_ac_t41_mem1*ADD_mem[1]
	S += (c_ac_t4_t5*ADD[2])-1<c_ac_t41_mem1*ADD_mem[2]
	S += (c_ac_t4_t5*ADD[3])-1<c_ac_t41_mem1*ADD_mem[3]
	...
	S += (c_ac_t11*ADD[0])-1<c_ac_s00_mem1*ADD_mem[0]
	S += (c_ac_t11*ADD[1])-1<c_ac_s00_mem1*ADD_mem[1]
	S += (c_ac_t11*ADD[2])-1<c_ac_s00_mem1*ADD_mem[2]
	S += (c_ac_t11*ADD[3])-1<c_ac_s00_mem1*ADD_mem[3]
	...
	S += (c_ac_t11*ADD[0])-1<c_ac_s01_mem0*ADD_mem[0]
	S += (c_ac_t11*ADD[1])-1<c_ac_s01_mem0*ADD_mem[1]
	S += (c_ac_t11*ADD[2])-1<c_ac_s01_mem0*ADD_mem[2]
	S += (c_ac_t11*ADD[3])-1<c_ac_s01_mem0*ADD_mem[3]
	...
	S += (c_ac_t01*ADD[0])-1<c_ac_t51_mem0*ADD_mem[0]
	S += (c_ac_t01*ADD[1])-1<c_ac_t51_mem0*ADD_mem[1]
	S += (c_ac_t01*ADD[2])-1<c_ac_t51_mem0*ADD_mem[2]
	S += (c_ac_t01*ADD[3])-1<c_ac_t51_mem0*ADD_mem[3]
	S += c_ac_t51_mem0<=c_ac_t51

	c_ac_t51_mem1 = S.Task('c_ac_t51_mem1', length=1, delay_cost=1)
	c_ac_t51_mem1 += alt(ADD_mem)
	S += (c_ac_t11*ADD[0])-1<c_ac_t51_mem1*ADD_mem[0]
	S += (c_ac_t11*ADD[1])-1<c_ac_t51_mem1*ADD_mem[1]
	S += (c_ac_t11*ADD[2])-1<c_ac_t51_mem1*ADD_mem[2]
	S += (c_ac_t11*ADD[3])-1<c_ac_t51_mem1*ADD_mem[3]
	...
	S += (c_ac_t40*ADD[0])-1<c_ac10_mem0*ADD_mem[0]
	S += (c_ac_t40*ADD[1])-1<c_ac10_mem0*ADD_mem[1]
	S += (c_ac_t40*ADD[2])-1<c_ac10_mem0*ADD_mem[2]
	S += (c_ac_t40*ADD[3])-1<c_ac10_mem0*ADD_mem[3]
	S += c_ac10_mem0<=c_ac10

	c_ac10_mem1 = S.Task('c_ac10_mem1', length=1, delay_cost=1)
	c_ac10_mem1 += alt(ADD_mem)
	S += (c_ac_t50*ADD[0])-1<c_ac10_mem1*ADD_mem[0]
	S += (c_ac_t50*ADD[1])-1<c_ac10_mem1*ADD_mem[1]
	S += (c_ac_t50*ADD[2])-1<c_ac10_mem1*ADD_mem[2]
	S += (c_ac_t50*ADD[3])-1<c_ac10_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-381/scheduling/INV_mul1_add4/INV_4.png"
	if(S.solution() != []):
