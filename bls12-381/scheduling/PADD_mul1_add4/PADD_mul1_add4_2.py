...
def solve():
	...
	new_zt_t1_in = S.Task('new_zt_t1_in', length=1, delay_cost=1)
	new_zt_t1_in += alt(MUL_in)
	new_zt_t1 = S.Task('new_zt_t1', length=7, delay_cost=1)
	new_zt_t1 += alt(MUL)
	S += new_zt_t1>=new_zt_t1_in

	new_zt_t1_mem0 = S.Task('new_zt_t1_mem0', length=1, delay_cost=1)
	new_zt_t1_mem0 += INPUT_mem_r
	S += new_zt_t1_mem0<=new_zt_t1

	new_zt_t1_mem1 = S.Task('new_zt_t1_mem1', length=1, delay_cost=1)
	new_zt_t1_mem1 += ADD_mem[0]
	S += 43<new_zt_t1_mem1
	S += new_zt_t1_mem1<=new_zt_t1

	new_zt_t3 = S.Task('new_zt_t3', length=1, delay_cost=1)
	new_zt_t3 += alt(ADD)

	new_zt_t3_mem0 = S.Task('new_zt_t3_mem0', length=1, delay_cost=1)
	new_zt_t3_mem0 += ADD_mem[0]
	S += 40<new_zt_t3_mem0
	S += new_zt_t3_mem0<=new_zt_t3

	new_zt_t3_mem1 = S.Task('new_zt_t3_mem1', length=1, delay_cost=1)
	new_zt_t3_mem1 += ADD_mem[0]
	S += 43<new_zt_t3_mem1
	S += new_zt_t3_mem1<=new_zt_t3
	...
	new_zt_t4_in = S.Task('new_zt_t4_in', length=1, delay_cost=1)
	new_zt_t4_in += alt(MUL_in)
	new_zt_t4 = S.Task('new_zt_t4', length=7, delay_cost=1)
	new_zt_t4 += alt(MUL)
	S += new_zt_t4>=new_zt_t4_in

	new_zt_t4_mem0 = S.Task('new_zt_t4_mem0', length=1, delay_cost=1)
	new_zt_t4_mem0 += ADD_mem[1]
	S += 8<new_zt_t4_mem0
	S += new_zt_t4_mem0<=new_zt_t4

	new_zt_t4_mem1 = S.Task('new_zt_t4_mem1', length=1, delay_cost=1)
	new_zt_t4_mem1 += alt(ADD_mem)
	S += (new_zt_t3*ADD[0])-1<new_zt_t4_mem1*ADD_mem[0]
	S += (new_zt_t3*ADD[1])-1<new_zt_t4_mem1*ADD_mem[1]
	S += (new_zt_t3*ADD[2])-1<new_zt_t4_mem1*ADD_mem[2]
	S += (new_zt_t3*ADD[3])-1<new_zt_t4_mem1*ADD_mem[3]
	S += new_zt_t4_mem1<=new_zt_t4

	new_zt_t5 = S.Task('new_zt_t5', length=1, delay_cost=1)
	new_zt_t5 += alt(ADD)

	new_zt_t5_mem0 = S.Task('new_zt_t5_mem0', length=1, delay_cost=1)
	new_zt_t5_mem0 += MUL_mem[0]
	S += 47<new_zt_t5_mem0
	S += new_zt_t5_mem0<=new_zt_t5

	new_zt_t5_mem1 = S.Task('new_zt_t5_mem1', length=1, delay_cost=1)
	new_zt_t5_mem1 += alt(MUL_mem)
	S += (new_zt_t1*MUL[0])-1<new_zt_t5_mem1*MUL_mem[0]
	S += new_zt_t5_mem1<=new_zt_t5
	...
	new_zt0 = S.Task('new_zt0', length=1, delay_cost=1)
	new_zt0 += alt(ADD)

	new_zt0_mem0 = S.Task('new_zt0_mem0', length=1, delay_cost=1)
	new_zt0_mem0 += MUL_mem[0]
	S += 47<new_zt0_mem0
	S += new_zt0_mem0<=new_zt0

	new_zt0_mem1 = S.Task('new_zt0_mem1', length=1, delay_cost=1)
	new_zt0_mem1 += alt(MUL_mem)
	S += (new_zt_t1*MUL[0])-1<new_zt0_mem1*MUL_mem[0]
	S += new_zt0_mem1<=new_zt0

	new_zt0_w = S.Task('new_zt0_w', length=1, delay_cost=1)
	new_zt0_w += alt(INPUT_mem_w)
	S += new_zt0-1 <= new_zt0_w

	new_zt1 = S.Task('new_zt1', length=1, delay_cost=1)
	new_zt1 += alt(ADD)

	new_zt1_mem0 = S.Task('new_zt1_mem0', length=1, delay_cost=1)
	new_zt1_mem0 += alt(MUL_mem)
	S += (new_zt_t4*MUL[0])-1<new_zt1_mem0*MUL_mem[0]
	S += new_zt1_mem0<=new_zt1

	new_zt1_mem1 = S.Task('new_zt1_mem1', length=1, delay_cost=1)
	new_zt1_mem1 += alt(ADD_mem)
	S += (new_zt_t5*ADD[0])-1<new_zt1_mem1*ADD_mem[0]
	S += (new_zt_t5*ADD[1])-1<new_zt1_mem1*ADD_mem[1]
	S += (new_zt_t5*ADD[2])-1<new_zt1_mem1*ADD_mem[2]
	S += (new_zt_t5*ADD[3])-1<new_zt1_mem1*ADD_mem[3]
	S += new_zt1_mem1<=new_zt1

	new_zt1_w = S.Task('new_zt1_w', length=1, delay_cost=1)
	new_zt1_w += alt(INPUT_mem_w)
	S += new_zt1-1 <= new_zt1_w

	new_xt0 = S.Task('new_xt0', length=1, delay_cost=1)
	new_xt0 += alt(ADD)

	new_xt0_mem0 = S.Task('new_xt0_mem0', length=1, delay_cost=1)
	new_xt0_mem0 += alt(MUL_mem)
	S += (new_xt_t0*MUL[0])-1<new_xt0_mem0*MUL_mem[0]
	S += new_xt0_mem0<=new_xt0

	new_xt0_mem1 = S.Task('new_xt0_mem1', length=1, delay_cost=1)
	new_xt0_mem1 += alt(MUL_mem)
	S += (new_xt_t1*MUL[0])-1<new_xt0_mem1*MUL_mem[0]
	S += new_xt0_mem1<=new_xt0

	new_xt0_w = S.Task('new_xt0_w', length=1, delay_cost=1)
	new_xt0_w += alt(INPUT_mem_w)
	S += new_xt0-1 <= new_xt0_w

	new_xt1 = S.Task('new_xt1', length=1, delay_cost=1)
	new_xt1 += alt(ADD)

	new_xt1_mem0 = S.Task('new_xt1_mem0', length=1, delay_cost=1)
	new_xt1_mem0 += alt(MUL_mem)
	S += (new_xt_t4*MUL[0])-1<new_xt1_mem0*MUL_mem[0]
	S += new_xt1_mem0<=new_xt1

	new_xt1_mem1 = S.Task('new_xt1_mem1', length=1, delay_cost=1)
	new_xt1_mem1 += alt(ADD_mem)
	S += (new_xt_t5*ADD[0])-1<new_xt1_mem1*ADD_mem[0]
	S += (new_xt_t5*ADD[1])-1<new_xt1_mem1*ADD_mem[1]
	S += (new_xt_t5*ADD[2])-1<new_xt1_mem1*ADD_mem[2]
	S += (new_xt_t5*ADD[3])-1<new_xt1_mem1*ADD_mem[3]
	S += new_xt1_mem1<=new_xt1

	new_xt1_w = S.Task('new_xt1_w', length=1, delay_cost=1)
	new_xt1_w += alt(INPUT_mem_w)
	S += new_xt1-1 <= new_xt1_w
	...
	new_yt0 = S.Task('new_yt0', length=1, delay_cost=1)
	new_yt0 += alt(ADD)

	new_yt0_mem0 = S.Task('new_yt0_mem0', length=1, delay_cost=1)
	new_yt0_mem0 += INPUT_mem_r
	S += new_yt0_mem0<=new_yt0

	new_yt0_mem1 = S.Task('new_yt0_mem1', length=1, delay_cost=1)
	new_yt0_mem1 += alt(ADD_mem)
	S += (t130*ADD[0])-1<new_yt0_mem1*ADD_mem[0]
	S += (t130*ADD[1])-1<new_yt0_mem1*ADD_mem[1]
	S += (t130*ADD[2])-1<new_yt0_mem1*ADD_mem[2]
	S += (t130*ADD[3])-1<new_yt0_mem1*ADD_mem[3]
	S += new_yt0_mem1<=new_yt0

	new_yt0_w = S.Task('new_yt0_w', length=1, delay_cost=1)
	new_yt0_w += alt(INPUT_mem_w)
	S += new_yt0-1 <= new_yt0_w
	...
	new_yt1 = S.Task('new_yt1', length=1, delay_cost=1)
	new_yt1 += alt(ADD)

	new_yt1_mem0 = S.Task('new_yt1_mem0', length=1, delay_cost=1)
	new_yt1_mem0 += INPUT_mem_r
	S += new_yt1_mem0<=new_yt1

	new_yt1_mem1 = S.Task('new_yt1_mem1', length=1, delay_cost=1)
	new_yt1_mem1 += alt(ADD_mem)
	S += (t131*ADD[0])-1<new_yt1_mem1*ADD_mem[0]
	S += (t131*ADD[1])-1<new_yt1_mem1*ADD_mem[1]
	S += (t131*ADD[2])-1<new_yt1_mem1*ADD_mem[2]
	S += (t131*ADD[3])-1<new_yt1_mem1*ADD_mem[3]
	S += new_yt1_mem1<=new_yt1

	new_yt1_w = S.Task('new_yt1_w', length=1, delay_cost=1)
	new_yt1_w += alt(INPUT_mem_w)
	S += new_yt1-1 <= new_yt1_w
