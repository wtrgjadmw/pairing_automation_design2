...
233: begin
	add0_opr1 <= ram_add3_out1; add0_opr2 <= add3_out_reg; issub0 <= 1;
...
238: begin
	...
	add1_opr1 <= ram_add0_out1; add1_opr2 <= ram_add3_out1; issub1 <= 0;
	add2_opr1 <= ram_add0_out2; add2_opr2 <= ram_add1_out1; issub2 <= 1;
	add3_opr1 <= ram_add2_out2; add3_opr2 <= ram_add3_out2; issub3 <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
	ram_add3_wr_n <= 0;
...
241: begin
	add0_opr1 <= ram_add3_out1; add0_opr2 <= add3_out_reg; issub0 <= 0;
	add2_opr1 <= ram_add0_out1; add2_opr2 <= ram_add1_out1; issub2 <= 0;
	add1_opr1 <= ram_add2_out1; add1_opr2 <= ram_add0_out2; issub1 <= 1;
	add3_opr1 <= ram_add1_out2; add3_opr2 <= ram_add2_out2; issub3 <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 1;
	ram_add2_wr_n <= 1;
