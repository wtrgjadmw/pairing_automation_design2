...
def solve():
	...
	S += (t900*ADD[0]) < c0100_mem0*ADD_mem[0]
	S += (t900*ADD[1]) < c0100_mem0*ADD_mem[1]
	S += (t900*ADD[2]) < c0100_mem0*ADD_mem[2]
	S += (t900*ADD[3]) < c0100_mem0*ADD_mem[3]
	S += c0100_mem0 <= c0100
	...
	S += (t901*ADD[0]) < c0101_mem0*ADD_mem[0]
	S += (t901*ADD[1]) < c0101_mem0*ADD_mem[1]
	S += (t901*ADD[2]) < c0101_mem0*ADD_mem[2]
	S += (t901*ADD[3]) < c0101_mem0*ADD_mem[3]
	S += c0101_mem0 <= c0101
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-317/scheduling/PDBL_mul1_add4/PDBL_5.png"
	if(S.solution() != []):
