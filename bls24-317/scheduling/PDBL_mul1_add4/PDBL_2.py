...
def solve():
	...
	S += (t0_t01*ADD[0])-1<t0_t2_t1_mem0*ADD_mem[0]
	S += (t0_t01*ADD[1])-1<t0_t2_t1_mem0*ADD_mem[1]
	S += (t0_t01*ADD[2])-1<t0_t2_t1_mem0*ADD_mem[2]
	S += (t0_t01*ADD[3])-1<t0_t2_t1_mem0*ADD_mem[3]
	...
	S += (t0_t01*ADD[0])-1<t0_t2_t2_mem1*ADD_mem[0]
	S += (t0_t01*ADD[1])-1<t0_t2_t2_mem1*ADD_mem[1]
	S += (t0_t01*ADD[2])-1<t0_t2_t2_mem1*ADD_mem[2]
	S += (t0_t01*ADD[3])-1<t0_t2_t2_mem1*ADD_mem[3]
	...
	S += (t0_t30*ADD[0])-1<t010_mem0*ADD_mem[0]
	S += (t0_t30*ADD[1])-1<t010_mem0*ADD_mem[1]
	S += (t0_t30*ADD[2])-1<t010_mem0*ADD_mem[2]
	S += (t0_t30*ADD[3])-1<t010_mem0*ADD_mem[3]
	S += t010_mem0<=t010

	t010_mem1 = S.Task('t010_mem1', length=1, delay_cost=1)
	t010_mem1 += alt(ADD_mem)
	S += (t0_t30*ADD[0])-1<t010_mem1*ADD_mem[0]
	S += (t0_t30*ADD[1])-1<t010_mem1*ADD_mem[1]
	S += (t0_t30*ADD[2])-1<t010_mem1*ADD_mem[2]
	S += (t0_t30*ADD[3])-1<t010_mem1*ADD_mem[3]
	S += t010_mem1<=t010
	...
	S += (t1_t01*ADD[0])-1<t1_t2_t1_mem0*ADD_mem[0]
	S += (t1_t01*ADD[1])-1<t1_t2_t1_mem0*ADD_mem[1]
	S += (t1_t01*ADD[2])-1<t1_t2_t1_mem0*ADD_mem[2]
	S += (t1_t01*ADD[3])-1<t1_t2_t1_mem0*ADD_mem[3]
	...
	S += (t1_t01*ADD[0])-1<t1_t2_t2_mem1*ADD_mem[0]
	S += (t1_t01*ADD[1])-1<t1_t2_t2_mem1*ADD_mem[1]
	S += (t1_t01*ADD[2])-1<t1_t2_t2_mem1*ADD_mem[2]
	S += (t1_t01*ADD[3])-1<t1_t2_t2_mem1*ADD_mem[3]
	...
	S += (t1_t30*ADD[0])-1<t110_mem0*ADD_mem[0]
	S += (t1_t30*ADD[1])-1<t110_mem0*ADD_mem[1]
	S += (t1_t30*ADD[2])-1<t110_mem0*ADD_mem[2]
	S += (t1_t30*ADD[3])-1<t110_mem0*ADD_mem[3]
	S += t110_mem0<=t110

	t110_mem1 = S.Task('t110_mem1', length=1, delay_cost=1)
	t110_mem1 += alt(ADD_mem)
	S += (t1_t30*ADD[0])-1<t110_mem1*ADD_mem[0]
	S += (t1_t30*ADD[1])-1<t110_mem1*ADD_mem[1]
	S += (t1_t30*ADD[2])-1<t110_mem1*ADD_mem[2]
	S += (t1_t30*ADD[3])-1<t110_mem1*ADD_mem[3]
	S += t110_mem1<=t110
	...
	S += (t5_t4_t0*MUL[0])-1<t5_t40_mem0*MUL_mem[0]
	S += t5_t40_mem0<=t5_t40

	t5_t40_mem1 = S.Task('t5_t40_mem1', length=1, delay_cost=1)
	t5_t40_mem1 += alt(MUL_mem)
	S += (t5_t4_t1*MUL[0])-1<t5_t40_mem1*MUL_mem[0]
	...
	S += (t5_t00*ADD[0])-1<t5_t50_mem0*ADD_mem[0]
	S += (t5_t00*ADD[1])-1<t5_t50_mem0*ADD_mem[1]
	S += (t5_t00*ADD[2])-1<t5_t50_mem0*ADD_mem[2]
	S += (t5_t00*ADD[3])-1<t5_t50_mem0*ADD_mem[3]
	S += t5_t50_mem0<=t5_t50

	t5_t50_mem1 = S.Task('t5_t50_mem1', length=1, delay_cost=1)
	t5_t50_mem1 += alt(ADD_mem)
	S += (t5_t10*ADD[0])-1<t5_t50_mem1*ADD_mem[0]
	S += (t5_t10*ADD[1])-1<t5_t50_mem1*ADD_mem[1]
	S += (t5_t10*ADD[2])-1<t5_t50_mem1*ADD_mem[2]
	S += (t5_t10*ADD[3])-1<t5_t50_mem1*ADD_mem[3]
	...
	S += (t7_t01*ADD[0])-1<t7_t2_t1_mem0*ADD_mem[0]
	S += (t7_t01*ADD[1])-1<t7_t2_t1_mem0*ADD_mem[1]
	S += (t7_t01*ADD[2])-1<t7_t2_t1_mem0*ADD_mem[2]
	S += (t7_t01*ADD[3])-1<t7_t2_t1_mem0*ADD_mem[3]
	...
	S += (t7_t01*ADD[0])-1<t7_t2_t2_mem1*ADD_mem[0]
	S += (t7_t01*ADD[1])-1<t7_t2_t2_mem1*ADD_mem[1]
	S += (t7_t01*ADD[2])-1<t7_t2_t2_mem1*ADD_mem[2]
	S += (t7_t01*ADD[3])-1<t7_t2_t2_mem1*ADD_mem[3]
	...
	S += (t7_t30*ADD[0])-1<t710_mem0*ADD_mem[0]
	S += (t7_t30*ADD[1])-1<t710_mem0*ADD_mem[1]
	S += (t7_t30*ADD[2])-1<t710_mem0*ADD_mem[2]
	S += (t7_t30*ADD[3])-1<t710_mem0*ADD_mem[3]
	S += t710_mem0<=t710

	t710_mem1 = S.Task('t710_mem1', length=1, delay_cost=1)
	t710_mem1 += alt(ADD_mem)
	S += (t7_t30*ADD[0])-1<t710_mem1*ADD_mem[0]
	S += (t7_t30*ADD[1])-1<t710_mem1*ADD_mem[1]
	S += (t7_t30*ADD[2])-1<t710_mem1*ADD_mem[2]
	S += (t7_t30*ADD[3])-1<t710_mem1*ADD_mem[3]
	S += t710_mem1<=t710
	...
	S += (t10_t00*ADD[0])-1<t10_t50_mem0*ADD_mem[0]
	S += (t10_t00*ADD[1])-1<t10_t50_mem0*ADD_mem[1]
	S += (t10_t00*ADD[2])-1<t10_t50_mem0*ADD_mem[2]
	S += (t10_t00*ADD[3])-1<t10_t50_mem0*ADD_mem[3]
	S += t10_t50_mem0<=t10_t50

	t10_t50_mem1 = S.Task('t10_t50_mem1', length=1, delay_cost=1)
	t10_t50_mem1 += alt(ADD_mem)
	S += (t10_t10*ADD[0])-1<t10_t50_mem1*ADD_mem[0]
	S += (t10_t10*ADD[1])-1<t10_t50_mem1*ADD_mem[1]
	S += (t10_t10*ADD[2])-1<t10_t50_mem1*ADD_mem[2]
	S += (t10_t10*ADD[3])-1<t10_t50_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-317/scheduling/PDBL_mul1_add4/PDBL_2.png"
	if(S.solution() != []):
