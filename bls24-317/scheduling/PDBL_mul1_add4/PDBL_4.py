...
def solve():
	...
	S += (t1100*ADD[0]) < c1100_mem0*ADD_mem[0]
	S += (t1100*ADD[1]) < c1100_mem0*ADD_mem[1]
	S += (t1100*ADD[2]) < c1100_mem0*ADD_mem[2]
	S += (t1100*ADD[3]) < c1100_mem0*ADD_mem[3]
	S += c1100_mem0 <= c1100
	...
	S += (t1101*ADD[0]) < c1101_mem0*ADD_mem[0]
	S += (t1101*ADD[1]) < c1101_mem0*ADD_mem[1]
	S += (t1101*ADD[2]) < c1101_mem0*ADD_mem[2]
	S += (t1101*ADD[3]) < c1101_mem0*ADD_mem[3]
	S += c1101_mem0 <= c1101
	...
	S += (t1111*ADD[0]) < c1111_mem0*ADD_mem[0]
	S += (t1111*ADD[1]) < c1111_mem0*ADD_mem[1]
	S += (t1111*ADD[2]) < c1111_mem0*ADD_mem[2]
	S += (t1111*ADD[3]) < c1111_mem0*ADD_mem[3]
	S += c1111_mem0 <= c1111
	...
	S += (t911*ADD[0]) < c0111_mem0*ADD_mem[0]
	S += (t911*ADD[1]) < c0111_mem0*ADD_mem[1]
	S += (t911*ADD[2]) < c0111_mem0*ADD_mem[2]
	S += (t911*ADD[3]) < c0111_mem0*ADD_mem[3]
	S += c0111_mem0 <= c0111
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-317/scheduling/PDBL_mul1_add4/PDBL_4.png"
	if(S.solution() != []):
