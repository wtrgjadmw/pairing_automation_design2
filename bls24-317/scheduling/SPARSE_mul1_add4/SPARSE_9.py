...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-317/scheduling/SPARSE_mul1_add4/SPARSE_9.png"
	if(S.solution() != []):
