...
def solve():
	...
	S += (t310*ADD[0]) < c1110_mem0*ADD_mem[0]
	S += (t310*ADD[1]) < c1110_mem0*ADD_mem[1]
	S += (t310*ADD[2]) < c1110_mem0*ADD_mem[2]
	S += (t310*ADD[3]) < c1110_mem0*ADD_mem[3]
	S += c1110_mem0 <= c1110
	...
	S += (t110*ADD[0]) < c0110_mem0*ADD_mem[0]
	S += (t110*ADD[1]) < c0110_mem0*ADD_mem[1]
	S += (t110*ADD[2]) < c0110_mem0*ADD_mem[2]
	S += (t110*ADD[3]) < c0110_mem0*ADD_mem[3]
	S += c0110_mem0 <= c0110
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-317/scheduling/PADD_mul1_add4/PADD_2.png"
	if(S.solution() != []):
