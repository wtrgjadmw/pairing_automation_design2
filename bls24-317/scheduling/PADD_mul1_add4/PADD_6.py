...
def solve():
	...
	t6_t0_t3_mem1 += alt(ADD_mem)
	S += (t501*ADD[0]) < t6_t0_t3_mem1*ADD_mem[0]
	S += (t501*ADD[1]) < t6_t0_t3_mem1*ADD_mem[1]
	S += (t501*ADD[2]) < t6_t0_t3_mem1*ADD_mem[2]
	S += (t501*ADD[3]) < t6_t0_t3_mem1*ADD_mem[3]
	...
	t6_t11_mem0 += alt(MUL_mem)
	S += (t6_t1_t4*MUL[0]) < t6_t11_mem0*MUL_mem[0]
	S += t6_t11_mem0 <= t6_t11

	t6_t11_mem1 = S.Task('t6_t11_mem1', length=1, delay_cost=1)
	t6_t11_mem1 += alt(ADD_mem)
	S += (t6_t1_t5*ADD[0]) < t6_t11_mem1*ADD_mem[0]
	S += (t6_t1_t5*ADD[1]) < t6_t11_mem1*ADD_mem[1]
	S += (t6_t1_t5*ADD[2]) < t6_t11_mem1*ADD_mem[2]
	S += (t6_t1_t5*ADD[3]) < t6_t11_mem1*ADD_mem[3]
	...
	t7_t11_mem0 += alt(MUL_mem)
	S += (t7_t1_t4*MUL[0]) < t7_t11_mem0*MUL_mem[0]
	S += t7_t11_mem0 <= t7_t11

	t7_t11_mem1 = S.Task('t7_t11_mem1', length=1, delay_cost=1)
	t7_t11_mem1 += alt(ADD_mem)
	S += (t7_t1_t5*ADD[0]) < t7_t11_mem1*ADD_mem[0]
	S += (t7_t1_t5*ADD[1]) < t7_t11_mem1*ADD_mem[1]
	S += (t7_t1_t5*ADD[2]) < t7_t11_mem1*ADD_mem[2]
	S += (t7_t1_t5*ADD[3]) < t7_t11_mem1*ADD_mem[3]
	...
	t9_t0_t3_mem1 += alt(ADD_mem)
	S += (t501*ADD[0]) < t9_t0_t3_mem1*ADD_mem[0]
	S += (t501*ADD[1]) < t9_t0_t3_mem1*ADD_mem[1]
	S += (t501*ADD[2]) < t9_t0_t3_mem1*ADD_mem[2]
	S += (t501*ADD[3]) < t9_t0_t3_mem1*ADD_mem[3]
	...
	t9_t11_mem0 += alt(MUL_mem)
	S += (t9_t1_t4*MUL[0]) < t9_t11_mem0*MUL_mem[0]
	S += t9_t11_mem0 <= t9_t11

	t9_t11_mem1 = S.Task('t9_t11_mem1', length=1, delay_cost=1)
	t9_t11_mem1 += alt(ADD_mem)
	S += (t9_t1_t5*ADD[0]) < t9_t11_mem1*ADD_mem[0]
	S += (t9_t1_t5*ADD[1]) < t9_t11_mem1*ADD_mem[1]
	S += (t9_t1_t5*ADD[2]) < t9_t11_mem1*ADD_mem[2]
	S += (t9_t1_t5*ADD[3]) < t9_t11_mem1*ADD_mem[3]
	...
	t6_s00_mem0 += alt(ADD_mem)
	S += (t6_t10*ADD[0]) < t6_s00_mem0*ADD_mem[0]
	S += (t6_t10*ADD[1]) < t6_s00_mem0*ADD_mem[1]
	S += (t6_t10*ADD[2]) < t6_s00_mem0*ADD_mem[2]
	S += (t6_t10*ADD[3]) < t6_s00_mem0*ADD_mem[3]
	...
	t6_s01_mem1 += alt(ADD_mem)
	S += (t6_t10*ADD[0]) < t6_s01_mem1*ADD_mem[0]
	S += (t6_t10*ADD[1]) < t6_s01_mem1*ADD_mem[1]
	S += (t6_t10*ADD[2]) < t6_s01_mem1*ADD_mem[2]
	S += (t6_t10*ADD[3]) < t6_s01_mem1*ADD_mem[3]
	...
	t6_t50_mem1 += alt(ADD_mem)
	S += (t6_t10*ADD[0]) < t6_t50_mem1*ADD_mem[0]
	S += (t6_t10*ADD[1]) < t6_t50_mem1*ADD_mem[1]
	S += (t6_t10*ADD[2]) < t6_t50_mem1*ADD_mem[2]
	S += (t6_t10*ADD[3]) < t6_t50_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-317/scheduling/PADD_mul1_add4/PADD_6.png"
	if(S.solution() != []):
