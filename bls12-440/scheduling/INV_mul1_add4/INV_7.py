...
def solve():
	...
	S += (c_pbc_t4_t4*MUL[0]) < c_pbc_t41_mem0*MUL_mem[0]
	S += c_pbc_t41_mem0 <= c_pbc_t41

	c_pbc_t41_mem1 = S.Task('c_pbc_t41_mem1', length=1, delay_cost=1)
	c_pbc_t41_mem1 += alt(ADD_mem)
	S += (c_pbc_t4_t5*ADD[0]) < c_pbc_t41_mem1*ADD_mem[0]
	S += (c_pbc_t4_t5*ADD[1]) < c_pbc_t41_mem1*ADD_mem[1]
	S += (c_pbc_t4_t5*ADD[2]) < c_pbc_t41_mem1*ADD_mem[2]
	S += (c_pbc_t4_t5*ADD[3]) < c_pbc_t41_mem1*ADD_mem[3]
	...
	S += 105 < c_pbc_s00_mem0
	S += c_pbc_s00_mem0 <= c_pbc_s00

	c_pbc_s00_mem1 = S.Task('c_pbc_s00_mem1', length=1, delay_cost=1)
	c_pbc_s00_mem1 += alt(ADD_mem)
	S += (c_pbc_t11*ADD[0]) < c_pbc_s00_mem1*ADD_mem[0]
	S += (c_pbc_t11*ADD[1]) < c_pbc_s00_mem1*ADD_mem[1]
	S += (c_pbc_t11*ADD[2]) < c_pbc_s00_mem1*ADD_mem[2]
	S += (c_pbc_t11*ADD[3]) < c_pbc_s00_mem1*ADD_mem[3]
	...
	S += (c_pbc_t11*ADD[0]) < c_pbc_s01_mem0*ADD_mem[0]
	S += (c_pbc_t11*ADD[1]) < c_pbc_s01_mem0*ADD_mem[1]
	S += (c_pbc_t11*ADD[2]) < c_pbc_s01_mem0*ADD_mem[2]
	S += (c_pbc_t11*ADD[3]) < c_pbc_s01_mem0*ADD_mem[3]
	S += c_pbc_s01_mem0 <= c_pbc_s01

	c_pbc_s01_mem1 = S.Task('c_pbc_s01_mem1', length=1, delay_cost=1)
	c_pbc_s01_mem1 += ADD_mem[2]
	S += 105 < c_pbc_s01_mem1
	...
	S += 102 < c_pbc_t51_mem0
	S += c_pbc_t51_mem0 <= c_pbc_t51

	c_pbc_t51_mem1 = S.Task('c_pbc_t51_mem1', length=1, delay_cost=1)
	c_pbc_t51_mem1 += alt(ADD_mem)
	S += (c_pbc_t11*ADD[0]) < c_pbc_t51_mem1*ADD_mem[0]
	S += (c_pbc_t11*ADD[1]) < c_pbc_t51_mem1*ADD_mem[1]
	S += (c_pbc_t11*ADD[2]) < c_pbc_t51_mem1*ADD_mem[2]
	S += (c_pbc_t11*ADD[3]) < c_pbc_t51_mem1*ADD_mem[3]
	...
	S += (c_pbc_t40*ADD[0]) < c_pbc10_mem0*ADD_mem[0]
	S += (c_pbc_t40*ADD[1]) < c_pbc10_mem0*ADD_mem[1]
	S += (c_pbc_t40*ADD[2]) < c_pbc10_mem0*ADD_mem[2]
	S += (c_pbc_t40*ADD[3]) < c_pbc10_mem0*ADD_mem[3]
	S += c_pbc10_mem0 <= c_pbc10

	c_pbc10_mem1 = S.Task('c_pbc10_mem1', length=1, delay_cost=1)
	c_pbc10_mem1 += alt(ADD_mem)
	S += (c_pbc_t50*ADD[0]) < c_pbc10_mem1*ADD_mem[0]
	S += (c_pbc_t50*ADD[1]) < c_pbc10_mem1*ADD_mem[1]
	S += (c_pbc_t50*ADD[2]) < c_pbc10_mem1*ADD_mem[2]
	S += (c_pbc_t50*ADD[3]) < c_pbc10_mem1*ADD_mem[3]
	...
	S += (c_pcb_t4_t4*MUL[0]) < c_pcb_t41_mem0*MUL_mem[0]
	S += c_pcb_t41_mem0 <= c_pcb_t41

	c_pcb_t41_mem1 = S.Task('c_pcb_t41_mem1', length=1, delay_cost=1)
	c_pcb_t41_mem1 += alt(ADD_mem)
	S += (c_pcb_t4_t5*ADD[0]) < c_pcb_t41_mem1*ADD_mem[0]
	S += (c_pcb_t4_t5*ADD[1]) < c_pcb_t41_mem1*ADD_mem[1]
	S += (c_pcb_t4_t5*ADD[2]) < c_pcb_t41_mem1*ADD_mem[2]
	S += (c_pcb_t4_t5*ADD[3]) < c_pcb_t41_mem1*ADD_mem[3]
	...
	S += (c_pcb_s00*ADD[0]) < c_pcb00_mem1*ADD_mem[0]
	S += (c_pcb_s00*ADD[1]) < c_pcb00_mem1*ADD_mem[1]
	S += (c_pcb_s00*ADD[2]) < c_pcb00_mem1*ADD_mem[2]
	S += (c_pcb_s00*ADD[3]) < c_pcb00_mem1*ADD_mem[3]
	...
	S += (c_pcb_t01*ADD[0]) < c_pcb01_mem0*ADD_mem[0]
	S += (c_pcb_t01*ADD[1]) < c_pcb01_mem0*ADD_mem[1]
	S += (c_pcb_t01*ADD[2]) < c_pcb01_mem0*ADD_mem[2]
	S += (c_pcb_t01*ADD[3]) < c_pcb01_mem0*ADD_mem[3]
	S += c_pcb01_mem0 <= c_pcb01

	c_pcb01_mem1 = S.Task('c_pcb01_mem1', length=1, delay_cost=1)
	c_pcb01_mem1 += alt(ADD_mem)
	S += (c_pcb_s01*ADD[0]) < c_pcb01_mem1*ADD_mem[0]
	S += (c_pcb_s01*ADD[1]) < c_pcb01_mem1*ADD_mem[1]
	S += (c_pcb_s01*ADD[2]) < c_pcb01_mem1*ADD_mem[2]
	S += (c_pcb_s01*ADD[3]) < c_pcb01_mem1*ADD_mem[3]
	...
	S += (c_pcb_t01*ADD[0]) < c_pcb_t51_mem0*ADD_mem[0]
	S += (c_pcb_t01*ADD[1]) < c_pcb_t51_mem0*ADD_mem[1]
	S += (c_pcb_t01*ADD[2]) < c_pcb_t51_mem0*ADD_mem[2]
	S += (c_pcb_t01*ADD[3]) < c_pcb_t51_mem0*ADD_mem[3]
	...
	S += (c_pcb_t40*ADD[0]) < c_pcb10_mem0*ADD_mem[0]
	S += (c_pcb_t40*ADD[1]) < c_pcb10_mem0*ADD_mem[1]
	S += (c_pcb_t40*ADD[2]) < c_pcb10_mem0*ADD_mem[2]
	S += (c_pcb_t40*ADD[3]) < c_pcb10_mem0*ADD_mem[3]
	S += c_pcb10_mem0 <= c_pcb10

	c_pcb10_mem1 = S.Task('c_pcb10_mem1', length=1, delay_cost=1)
	c_pcb10_mem1 += alt(ADD_mem)
	S += (c_pcb_t50*ADD[0]) < c_pcb10_mem1*ADD_mem[0]
	S += (c_pcb_t50*ADD[1]) < c_pcb10_mem1*ADD_mem[1]
	S += (c_pcb_t50*ADD[2]) < c_pcb10_mem1*ADD_mem[2]
	S += (c_pcb_t50*ADD[3]) < c_pcb10_mem1*ADD_mem[3]
	...
	S += (c_paa_t4_t4*MUL[0]) < c_paa_t41_mem0*MUL_mem[0]
	S += c_paa_t41_mem0 <= c_paa_t41

	c_paa_t41_mem1 = S.Task('c_paa_t41_mem1', length=1, delay_cost=1)
	c_paa_t41_mem1 += alt(ADD_mem)
	S += (c_paa_t4_t5*ADD[0]) < c_paa_t41_mem1*ADD_mem[0]
	S += (c_paa_t4_t5*ADD[1]) < c_paa_t41_mem1*ADD_mem[1]
	S += (c_paa_t4_t5*ADD[2]) < c_paa_t41_mem1*ADD_mem[2]
	S += (c_paa_t4_t5*ADD[3]) < c_paa_t41_mem1*ADD_mem[3]
	...
	S += (c_paa_t01*ADD[0]) < c_paa01_mem0*ADD_mem[0]
	S += (c_paa_t01*ADD[1]) < c_paa01_mem0*ADD_mem[1]
	S += (c_paa_t01*ADD[2]) < c_paa01_mem0*ADD_mem[2]
	S += (c_paa_t01*ADD[3]) < c_paa01_mem0*ADD_mem[3]
	...
	S += (c_paa_t01*ADD[0]) < c_paa_t51_mem0*ADD_mem[0]
	S += (c_paa_t01*ADD[1]) < c_paa_t51_mem0*ADD_mem[1]
	S += (c_paa_t01*ADD[2]) < c_paa_t51_mem0*ADD_mem[2]
	S += (c_paa_t01*ADD[3]) < c_paa_t51_mem0*ADD_mem[3]
	...
	S += (c_paa_t40*ADD[0]) < c_paa10_mem0*ADD_mem[0]
	S += (c_paa_t40*ADD[1]) < c_paa10_mem0*ADD_mem[1]
	S += (c_paa_t40*ADD[2]) < c_paa10_mem0*ADD_mem[2]
	S += (c_paa_t40*ADD[3]) < c_paa10_mem0*ADD_mem[3]
	S += c_paa10_mem0 <= c_paa10

	c_paa10_mem1 = S.Task('c_paa10_mem1', length=1, delay_cost=1)
	c_paa10_mem1 += alt(ADD_mem)
	S += (c_paa_t50*ADD[0]) < c_paa10_mem1*ADD_mem[0]
	S += (c_paa_t50*ADD[1]) < c_paa10_mem1*ADD_mem[1]
	S += (c_paa_t50*ADD[2]) < c_paa10_mem1*ADD_mem[2]
	S += (c_paa_t50*ADD[3]) < c_paa10_mem1*ADD_mem[3]
	...
	S += (c_pcb00*ADD[0]) < c_pbccb00_mem1*ADD_mem[0]
	S += (c_pcb00*ADD[1]) < c_pbccb00_mem1*ADD_mem[1]
	S += (c_pcb00*ADD[2]) < c_pbccb00_mem1*ADD_mem[2]
	S += (c_pcb00*ADD[3]) < c_pbccb00_mem1*ADD_mem[3]
	...
	S += (c_pbccb10*ADD[0]) < c_pxi_y1_0_mem0*ADD_mem[0]
	S += (c_pbccb10*ADD[1]) < c_pxi_y1_0_mem0*ADD_mem[1]
	S += (c_pbccb10*ADD[2]) < c_pxi_y1_0_mem0*ADD_mem[2]
	S += (c_pbccb10*ADD[3]) < c_pxi_y1_0_mem0*ADD_mem[3]
	...
	S += (c_pbccb11*ADD[0]) < c_pxi_y1_1_mem0*ADD_mem[0]
	S += (c_pbccb11*ADD[1]) < c_pxi_y1_1_mem0*ADD_mem[1]
	S += (c_pbccb11*ADD[2]) < c_pxi_y1_1_mem0*ADD_mem[2]
	S += (c_pbccb11*ADD[3]) < c_pxi_y1_1_mem0*ADD_mem[3]
	...
	S += (c_qinv_aa_t4*MUL[0]) < c_qinv_aa1_mem0*MUL_mem[0]
	S += c_qinv_aa1_mem0 <= c_qinv_aa1

	c_qinv_aa1_mem1 = S.Task('c_qinv_aa1_mem1', length=1, delay_cost=1)
	c_qinv_aa1_mem1 += alt(ADD_mem)
	S += (c_qinv_aa_t5*ADD[0]) < c_qinv_aa1_mem1*ADD_mem[0]
	S += (c_qinv_aa_t5*ADD[1]) < c_qinv_aa1_mem1*ADD_mem[1]
	S += (c_qinv_aa_t5*ADD[2]) < c_qinv_aa1_mem1*ADD_mem[2]
	S += (c_qinv_aa_t5*ADD[3]) < c_qinv_aa1_mem1*ADD_mem[3]
	...
	S += (c_qinv_bb0*ADD[0]) < c_qinv_bbxi0_mem0*ADD_mem[0]
	S += (c_qinv_bb0*ADD[1]) < c_qinv_bbxi0_mem0*ADD_mem[1]
	S += (c_qinv_bb0*ADD[2]) < c_qinv_bbxi0_mem0*ADD_mem[2]
	S += (c_qinv_bb0*ADD[3]) < c_qinv_bbxi0_mem0*ADD_mem[3]
	...
	S += (c_qinv_bb1*ADD[0]) < c_qinv_bbxi0_mem1*ADD_mem[0]
	S += (c_qinv_bb1*ADD[1]) < c_qinv_bbxi0_mem1*ADD_mem[1]
	S += (c_qinv_bb1*ADD[2]) < c_qinv_bbxi0_mem1*ADD_mem[2]
	S += (c_qinv_bb1*ADD[3]) < c_qinv_bbxi0_mem1*ADD_mem[3]
	...
	S += (c_qinv_bb1*ADD[0]) < c_qinv_bbxi1_mem0*ADD_mem[0]
	S += (c_qinv_bb1*ADD[1]) < c_qinv_bbxi1_mem0*ADD_mem[1]
	S += (c_qinv_bb1*ADD[2]) < c_qinv_bbxi1_mem0*ADD_mem[2]
	S += (c_qinv_bb1*ADD[3]) < c_qinv_bbxi1_mem0*ADD_mem[3]
	...
	S += (c_qinv_bb0*ADD[0]) < c_qinv_bbxi1_mem1*ADD_mem[0]
	S += (c_qinv_bb0*ADD[1]) < c_qinv_bbxi1_mem1*ADD_mem[1]
	S += (c_qinv_bb0*ADD[2]) < c_qinv_bbxi1_mem1*ADD_mem[2]
	S += (c_qinv_bb0*ADD[3]) < c_qinv_bbxi1_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls12-440/scheduling/INV_mul1_add4/INV_7.png"
	if(S.solution() != []):
