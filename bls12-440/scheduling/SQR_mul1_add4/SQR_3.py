...
def solve():
	...
	S += (c_t0_t2_t2*ADD[0])-1<c_t0_t2_t4_mem0*ADD_mem[0]
	S += (c_t0_t2_t2*ADD[1])-1<c_t0_t2_t4_mem0*ADD_mem[1]
	S += (c_t0_t2_t2*ADD[2])-1<c_t0_t2_t4_mem0*ADD_mem[2]
	S += (c_t0_t2_t2*ADD[3])-1<c_t0_t2_t4_mem0*ADD_mem[3]
	...
	S += (c_t0_t2_t0*MUL[0])-1<c_t0_t20_mem0*MUL_mem[0]
	S += c_t0_t20_mem0<=c_t0_t20

	c_t0_t20_mem1 = S.Task('c_t0_t20_mem1', length=1, delay_cost=1)
	c_t0_t20_mem1 += alt(MUL_mem)
	S += (c_t0_t2_t1*MUL[0])-1<c_t0_t20_mem1*MUL_mem[0]
	...
	S += (c_t0_t31*ADD[0])-1<c_t0_t40_mem1*ADD_mem[0]
	S += (c_t0_t31*ADD[1])-1<c_t0_t40_mem1*ADD_mem[1]
	S += (c_t0_t31*ADD[2])-1<c_t0_t40_mem1*ADD_mem[2]
	S += (c_t0_t31*ADD[3])-1<c_t0_t40_mem1*ADD_mem[3]
	...
	S += (c_t0_t31*ADD[0])-1<c_t0_t41_mem0*ADD_mem[0]
	S += (c_t0_t31*ADD[1])-1<c_t0_t41_mem0*ADD_mem[1]
	S += (c_t0_t31*ADD[2])-1<c_t0_t41_mem0*ADD_mem[2]
	S += (c_t0_t31*ADD[3])-1<c_t0_t41_mem0*ADD_mem[3]
	...
	S += (c_t0_t31*ADD[0])-1<c_t011_mem0*ADD_mem[0]
	S += (c_t0_t31*ADD[1])-1<c_t011_mem0*ADD_mem[1]
	S += (c_t0_t31*ADD[2])-1<c_t011_mem0*ADD_mem[2]
	S += (c_t0_t31*ADD[3])-1<c_t011_mem0*ADD_mem[3]
	S += c_t011_mem0<=c_t011

	c_t011_mem1 = S.Task('c_t011_mem1', length=1, delay_cost=1)
	c_t011_mem1 += alt(ADD_mem)
	S += (c_t0_t31*ADD[0])-1<c_t011_mem1*ADD_mem[0]
	S += (c_t0_t31*ADD[1])-1<c_t011_mem1*ADD_mem[1]
	S += (c_t0_t31*ADD[2])-1<c_t011_mem1*ADD_mem[2]
	S += (c_t0_t31*ADD[3])-1<c_t011_mem1*ADD_mem[3]
	...
	S += (c_t1_t2_t2*ADD[0])-1<c_t1_t2_t4_mem0*ADD_mem[0]
	S += (c_t1_t2_t2*ADD[1])-1<c_t1_t2_t4_mem0*ADD_mem[1]
	S += (c_t1_t2_t2*ADD[2])-1<c_t1_t2_t4_mem0*ADD_mem[2]
	S += (c_t1_t2_t2*ADD[3])-1<c_t1_t2_t4_mem0*ADD_mem[3]
	...
	S += (c_t1_t2_t0*MUL[0])-1<c_t1_t20_mem0*MUL_mem[0]
	S += c_t1_t20_mem0<=c_t1_t20

	c_t1_t20_mem1 = S.Task('c_t1_t20_mem1', length=1, delay_cost=1)
	c_t1_t20_mem1 += alt(MUL_mem)
	S += (c_t1_t2_t1*MUL[0])-1<c_t1_t20_mem1*MUL_mem[0]
	...
	S += (c_t1_t31*ADD[0])-1<c_t1_t40_mem1*ADD_mem[0]
	S += (c_t1_t31*ADD[1])-1<c_t1_t40_mem1*ADD_mem[1]
	S += (c_t1_t31*ADD[2])-1<c_t1_t40_mem1*ADD_mem[2]
	S += (c_t1_t31*ADD[3])-1<c_t1_t40_mem1*ADD_mem[3]
	...
	S += (c_t1_t31*ADD[0])-1<c_t1_t41_mem0*ADD_mem[0]
	S += (c_t1_t31*ADD[1])-1<c_t1_t41_mem0*ADD_mem[1]
	S += (c_t1_t31*ADD[2])-1<c_t1_t41_mem0*ADD_mem[2]
	S += (c_t1_t31*ADD[3])-1<c_t1_t41_mem0*ADD_mem[3]
	...
	S += (c_t1_t31*ADD[0])-1<c_t111_mem0*ADD_mem[0]
	S += (c_t1_t31*ADD[1])-1<c_t111_mem0*ADD_mem[1]
	S += (c_t1_t31*ADD[2])-1<c_t111_mem0*ADD_mem[2]
	S += (c_t1_t31*ADD[3])-1<c_t111_mem0*ADD_mem[3]
	S += c_t111_mem0<=c_t111

	c_t111_mem1 = S.Task('c_t111_mem1', length=1, delay_cost=1)
	c_t111_mem1 += alt(ADD_mem)
	S += (c_t1_t31*ADD[0])-1<c_t111_mem1*ADD_mem[0]
	S += (c_t1_t31*ADD[1])-1<c_t111_mem1*ADD_mem[1]
	S += (c_t1_t31*ADD[2])-1<c_t111_mem1*ADD_mem[2]
	S += (c_t1_t31*ADD[3])-1<c_t111_mem1*ADD_mem[3]
	...
	S += (c_t2_t2_t2*ADD[0])-1<c_t2_t2_t4_mem0*ADD_mem[0]
	S += (c_t2_t2_t2*ADD[1])-1<c_t2_t2_t4_mem0*ADD_mem[1]
	S += (c_t2_t2_t2*ADD[2])-1<c_t2_t2_t4_mem0*ADD_mem[2]
	S += (c_t2_t2_t2*ADD[3])-1<c_t2_t2_t4_mem0*ADD_mem[3]
	...
	S += (c_t2_t2_t0*MUL[0])-1<c_t2_t20_mem0*MUL_mem[0]
	S += c_t2_t20_mem0<=c_t2_t20

	c_t2_t20_mem1 = S.Task('c_t2_t20_mem1', length=1, delay_cost=1)
	c_t2_t20_mem1 += alt(MUL_mem)
	S += (c_t2_t2_t1*MUL[0])-1<c_t2_t20_mem1*MUL_mem[0]
	...
	S += (c_t2_t31*ADD[0])-1<c_t2_t40_mem1*ADD_mem[0]
	S += (c_t2_t31*ADD[1])-1<c_t2_t40_mem1*ADD_mem[1]
	S += (c_t2_t31*ADD[2])-1<c_t2_t40_mem1*ADD_mem[2]
	S += (c_t2_t31*ADD[3])-1<c_t2_t40_mem1*ADD_mem[3]
	...
	S += (c_t2_t31*ADD[0])-1<c_t2_t41_mem0*ADD_mem[0]
	S += (c_t2_t31*ADD[1])-1<c_t2_t41_mem0*ADD_mem[1]
	S += (c_t2_t31*ADD[2])-1<c_t2_t41_mem0*ADD_mem[2]
	S += (c_t2_t31*ADD[3])-1<c_t2_t41_mem0*ADD_mem[3]
	...
	S += (c_t2_t31*ADD[0])-1<c_t211_mem0*ADD_mem[0]
	S += (c_t2_t31*ADD[1])-1<c_t211_mem0*ADD_mem[1]
	S += (c_t2_t31*ADD[2])-1<c_t211_mem0*ADD_mem[2]
	S += (c_t2_t31*ADD[3])-1<c_t211_mem0*ADD_mem[3]
	S += c_t211_mem0<=c_t211

	c_t211_mem1 = S.Task('c_t211_mem1', length=1, delay_cost=1)
	c_t211_mem1 += alt(ADD_mem)
	S += (c_t2_t31*ADD[0])-1<c_t211_mem1*ADD_mem[0]
	S += (c_t2_t31*ADD[1])-1<c_t211_mem1*ADD_mem[1]
	S += (c_t2_t31*ADD[2])-1<c_t211_mem1*ADD_mem[2]
	S += (c_t2_t31*ADD[3])-1<c_t211_mem1*ADD_mem[3]
	...
	S += (c_t3_t00*ADD[0])-1<c_t3_t2_t0_mem0*ADD_mem[0]
	S += (c_t3_t00*ADD[1])-1<c_t3_t2_t0_mem0*ADD_mem[1]
	S += (c_t3_t00*ADD[2])-1<c_t3_t2_t0_mem0*ADD_mem[2]
	S += (c_t3_t00*ADD[3])-1<c_t3_t2_t0_mem0*ADD_mem[3]
	...
	S += (c_t3_t01*ADD[0])-1<c_t3_t2_t1_mem0*ADD_mem[0]
	S += (c_t3_t01*ADD[1])-1<c_t3_t2_t1_mem0*ADD_mem[1]
	S += (c_t3_t01*ADD[2])-1<c_t3_t2_t1_mem0*ADD_mem[2]
	S += (c_t3_t01*ADD[3])-1<c_t3_t2_t1_mem0*ADD_mem[3]
	...
	S += (c_t3_t00*ADD[0])-1<c_t3_t2_t2_mem0*ADD_mem[0]
	S += (c_t3_t00*ADD[1])-1<c_t3_t2_t2_mem0*ADD_mem[1]
	S += (c_t3_t00*ADD[2])-1<c_t3_t2_t2_mem0*ADD_mem[2]
	S += (c_t3_t00*ADD[3])-1<c_t3_t2_t2_mem0*ADD_mem[3]
	S += c_t3_t2_t2_mem0<=c_t3_t2_t2

	c_t3_t2_t2_mem1 = S.Task('c_t3_t2_t2_mem1', length=1, delay_cost=1)
	c_t3_t2_t2_mem1 += alt(ADD_mem)
	S += (c_t3_t01*ADD[0])-1<c_t3_t2_t2_mem1*ADD_mem[0]
	S += (c_t3_t01*ADD[1])-1<c_t3_t2_t2_mem1*ADD_mem[1]
	S += (c_t3_t01*ADD[2])-1<c_t3_t2_t2_mem1*ADD_mem[2]
	S += (c_t3_t01*ADD[3])-1<c_t3_t2_t2_mem1*ADD_mem[3]
	...
	S += (c_t3_t3_t4*MUL[0])-1<c_t3_t31_mem0*MUL_mem[0]
	S += c_t3_t31_mem0<=c_t3_t31

	c_t3_t31_mem1 = S.Task('c_t3_t31_mem1', length=1, delay_cost=1)
	c_t3_t31_mem1 += alt(ADD_mem)
	S += (c_t3_t3_t5*ADD[0])-1<c_t3_t31_mem1*ADD_mem[0]
	S += (c_t3_t3_t5*ADD[1])-1<c_t3_t31_mem1*ADD_mem[1]
	S += (c_t3_t3_t5*ADD[2])-1<c_t3_t31_mem1*ADD_mem[2]
	S += (c_t3_t3_t5*ADD[3])-1<c_t3_t31_mem1*ADD_mem[3]
	...
	S += (c_t3_t30*ADD[0])-1<c_t310_mem0*ADD_mem[0]
	S += (c_t3_t30*ADD[1])-1<c_t310_mem0*ADD_mem[1]
	S += (c_t3_t30*ADD[2])-1<c_t310_mem0*ADD_mem[2]
	S += (c_t3_t30*ADD[3])-1<c_t310_mem0*ADD_mem[3]
	S += c_t310_mem0<=c_t310

	c_t310_mem1 = S.Task('c_t310_mem1', length=1, delay_cost=1)
	c_t310_mem1 += alt(ADD_mem)
	S += (c_t3_t30*ADD[0])-1<c_t310_mem1*ADD_mem[0]
	S += (c_t3_t30*ADD[1])-1<c_t310_mem1*ADD_mem[1]
	S += (c_t3_t30*ADD[2])-1<c_t310_mem1*ADD_mem[2]
	S += (c_t3_t30*ADD[3])-1<c_t310_mem1*ADD_mem[3]
	...
	S += (c_t4_t00*ADD[0])-1<c_t4_t2_t0_mem0*ADD_mem[0]
	S += (c_t4_t00*ADD[1])-1<c_t4_t2_t0_mem0*ADD_mem[1]
	S += (c_t4_t00*ADD[2])-1<c_t4_t2_t0_mem0*ADD_mem[2]
	S += (c_t4_t00*ADD[3])-1<c_t4_t2_t0_mem0*ADD_mem[3]
	...
	S += (c_t4_t01*ADD[0])-1<c_t4_t2_t1_mem0*ADD_mem[0]
	S += (c_t4_t01*ADD[1])-1<c_t4_t2_t1_mem0*ADD_mem[1]
	S += (c_t4_t01*ADD[2])-1<c_t4_t2_t1_mem0*ADD_mem[2]
	S += (c_t4_t01*ADD[3])-1<c_t4_t2_t1_mem0*ADD_mem[3]
	...
	S += (c_t4_t00*ADD[0])-1<c_t4_t2_t2_mem0*ADD_mem[0]
	S += (c_t4_t00*ADD[1])-1<c_t4_t2_t2_mem0*ADD_mem[1]
	S += (c_t4_t00*ADD[2])-1<c_t4_t2_t2_mem0*ADD_mem[2]
	S += (c_t4_t00*ADD[3])-1<c_t4_t2_t2_mem0*ADD_mem[3]
	S += c_t4_t2_t2_mem0<=c_t4_t2_t2

	c_t4_t2_t2_mem1 = S.Task('c_t4_t2_t2_mem1', length=1, delay_cost=1)
	c_t4_t2_t2_mem1 += alt(ADD_mem)
	S += (c_t4_t01*ADD[0])-1<c_t4_t2_t2_mem1*ADD_mem[0]
	S += (c_t4_t01*ADD[1])-1<c_t4_t2_t2_mem1*ADD_mem[1]
	S += (c_t4_t01*ADD[2])-1<c_t4_t2_t2_mem1*ADD_mem[2]
	S += (c_t4_t01*ADD[3])-1<c_t4_t2_t2_mem1*ADD_mem[3]
	...
	S += (c_t4_t3_t4*MUL[0])-1<c_t4_t31_mem0*MUL_mem[0]
	S += c_t4_t31_mem0<=c_t4_t31

	c_t4_t31_mem1 = S.Task('c_t4_t31_mem1', length=1, delay_cost=1)
	c_t4_t31_mem1 += alt(ADD_mem)
	S += (c_t4_t3_t5*ADD[0])-1<c_t4_t31_mem1*ADD_mem[0]
	S += (c_t4_t3_t5*ADD[1])-1<c_t4_t31_mem1*ADD_mem[1]
	S += (c_t4_t3_t5*ADD[2])-1<c_t4_t31_mem1*ADD_mem[2]
	S += (c_t4_t3_t5*ADD[3])-1<c_t4_t31_mem1*ADD_mem[3]
	...
	S += (c_t4_t30*ADD[0])-1<c_t410_mem0*ADD_mem[0]
	S += (c_t4_t30*ADD[1])-1<c_t410_mem0*ADD_mem[1]
	S += (c_t4_t30*ADD[2])-1<c_t410_mem0*ADD_mem[2]
	S += (c_t4_t30*ADD[3])-1<c_t410_mem0*ADD_mem[3]
	S += c_t410_mem0<=c_t410

	c_t410_mem1 = S.Task('c_t410_mem1', length=1, delay_cost=1)
	c_t410_mem1 += alt(ADD_mem)
	S += (c_t4_t30*ADD[0])-1<c_t410_mem1*ADD_mem[0]
	S += (c_t4_t30*ADD[1])-1<c_t410_mem1*ADD_mem[1]
	S += (c_t4_t30*ADD[2])-1<c_t410_mem1*ADD_mem[2]
	S += (c_t4_t30*ADD[3])-1<c_t410_mem1*ADD_mem[3]
	...
	S += (c_t5_t00*ADD[0])-1<c_t5_t2_t0_mem0*ADD_mem[0]
	S += (c_t5_t00*ADD[1])-1<c_t5_t2_t0_mem0*ADD_mem[1]
	S += (c_t5_t00*ADD[2])-1<c_t5_t2_t0_mem0*ADD_mem[2]
	S += (c_t5_t00*ADD[3])-1<c_t5_t2_t0_mem0*ADD_mem[3]
	...
	S += (c_t5_t01*ADD[0])-1<c_t5_t2_t1_mem0*ADD_mem[0]
	S += (c_t5_t01*ADD[1])-1<c_t5_t2_t1_mem0*ADD_mem[1]
	S += (c_t5_t01*ADD[2])-1<c_t5_t2_t1_mem0*ADD_mem[2]
	S += (c_t5_t01*ADD[3])-1<c_t5_t2_t1_mem0*ADD_mem[3]
	...
	S += (c_t5_t00*ADD[0])-1<c_t5_t2_t2_mem0*ADD_mem[0]
	S += (c_t5_t00*ADD[1])-1<c_t5_t2_t2_mem0*ADD_mem[1]
	S += (c_t5_t00*ADD[2])-1<c_t5_t2_t2_mem0*ADD_mem[2]
	S += (c_t5_t00*ADD[3])-1<c_t5_t2_t2_mem0*ADD_mem[3]
	S += c_t5_t2_t2_mem0<=c_t5_t2_t2

	c_t5_t2_t2_mem1 = S.Task('c_t5_t2_t2_mem1', length=1, delay_cost=1)
	c_t5_t2_t2_mem1 += alt(ADD_mem)
	S += (c_t5_t01*ADD[0])-1<c_t5_t2_t2_mem1*ADD_mem[0]
	S += (c_t5_t01*ADD[1])-1<c_t5_t2_t2_mem1*ADD_mem[1]
	S += (c_t5_t01*ADD[2])-1<c_t5_t2_t2_mem1*ADD_mem[2]
	S += (c_t5_t01*ADD[3])-1<c_t5_t2_t2_mem1*ADD_mem[3]
	...
	S += (c_t5_t3_t4*MUL[0])-1<c_t5_t31_mem0*MUL_mem[0]
	S += c_t5_t31_mem0<=c_t5_t31

	c_t5_t31_mem1 = S.Task('c_t5_t31_mem1', length=1, delay_cost=1)
	c_t5_t31_mem1 += alt(ADD_mem)
	S += (c_t5_t3_t5*ADD[0])-1<c_t5_t31_mem1*ADD_mem[0]
	S += (c_t5_t3_t5*ADD[1])-1<c_t5_t31_mem1*ADD_mem[1]
	S += (c_t5_t3_t5*ADD[2])-1<c_t5_t31_mem1*ADD_mem[2]
	S += (c_t5_t3_t5*ADD[3])-1<c_t5_t31_mem1*ADD_mem[3]
	...
	S += (c_t5_t30*ADD[0])-1<c_t510_mem0*ADD_mem[0]
	S += (c_t5_t30*ADD[1])-1<c_t510_mem0*ADD_mem[1]
	S += (c_t5_t30*ADD[2])-1<c_t510_mem0*ADD_mem[2]
	S += (c_t5_t30*ADD[3])-1<c_t510_mem0*ADD_mem[3]
	S += c_t510_mem0<=c_t510

	c_t510_mem1 = S.Task('c_t510_mem1', length=1, delay_cost=1)
	c_t510_mem1 += alt(ADD_mem)
	S += (c_t5_t30*ADD[0])-1<c_t510_mem1*ADD_mem[0]
	S += (c_t5_t30*ADD[1])-1<c_t510_mem1*ADD_mem[1]
	S += (c_t5_t30*ADD[2])-1<c_t510_mem1*ADD_mem[2]
	S += (c_t5_t30*ADD[3])-1<c_t510_mem1*ADD_mem[3]
	...
	S += (c_t010*ADD[0])-1<c_s0010_mem0*ADD_mem[0]
	S += (c_t010*ADD[1])-1<c_s0010_mem0*ADD_mem[1]
	S += (c_t010*ADD[2])-1<c_s0010_mem0*ADD_mem[2]
	S += (c_t010*ADD[3])-1<c_s0010_mem0*ADD_mem[3]
	S += c_s0010_mem0<=c_s0010

	c_s0010_mem1 = S.Task('c_s0010_mem1', length=1, delay_cost=1)
	c_s0010_mem1 += alt(ADD_mem)
	S += (c_t110*ADD[0])-1<c_s0010_mem1*ADD_mem[0]
	S += (c_t110*ADD[1])-1<c_s0010_mem1*ADD_mem[1]
	S += (c_t110*ADD[2])-1<c_s0010_mem1*ADD_mem[2]
	S += (c_t110*ADD[3])-1<c_s0010_mem1*ADD_mem[3]
	...
	S += (c_t110*ADD[0])-1<c_s1010_mem0*ADD_mem[0]
	S += (c_t110*ADD[1])-1<c_s1010_mem0*ADD_mem[1]
	S += (c_t110*ADD[2])-1<c_s1010_mem0*ADD_mem[2]
	S += (c_t110*ADD[3])-1<c_s1010_mem0*ADD_mem[3]
	S += c_s1010_mem0<=c_s1010

	c_s1010_mem1 = S.Task('c_s1010_mem1', length=1, delay_cost=1)
	c_s1010_mem1 += alt(ADD_mem)
	S += (c_t210*ADD[0])-1<c_s1010_mem1*ADD_mem[0]
	S += (c_t210*ADD[1])-1<c_s1010_mem1*ADD_mem[1]
	S += (c_t210*ADD[2])-1<c_s1010_mem1*ADD_mem[2]
	S += (c_t210*ADD[3])-1<c_s1010_mem1*ADD_mem[3]
	...
	S += (c_t210*ADD[0])-1<c_s2010_mem0*ADD_mem[0]
	S += (c_t210*ADD[1])-1<c_s2010_mem0*ADD_mem[1]
	S += (c_t210*ADD[2])-1<c_s2010_mem0*ADD_mem[2]
	S += (c_t210*ADD[3])-1<c_s2010_mem0*ADD_mem[3]
	S += c_s2010_mem0<=c_s2010

	c_s2010_mem1 = S.Task('c_s2010_mem1', length=1, delay_cost=1)
	c_s2010_mem1 += alt(ADD_mem)
	S += (c_t010*ADD[0])-1<c_s2010_mem1*ADD_mem[0]
	S += (c_t010*ADD[1])-1<c_s2010_mem1*ADD_mem[1]
	S += (c_t010*ADD[2])-1<c_s2010_mem1*ADD_mem[2]
	S += (c_t010*ADD[3])-1<c_s2010_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-381/scheduling/SQR_mul1_add4/SQR_3.png"
	if(S.solution() != []):
