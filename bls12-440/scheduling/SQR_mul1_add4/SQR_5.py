...
def solve():
	...
	S += c_t4_t40_mem1 >= 58
	c_t4_t40_mem1 += ADD_mem[3]

	c_t4_t41_mem0 = S.Task('c_t4_t41_mem0', length=1, delay_cost=1)
	S += c_t4_t41_mem0 >= 58
	c_t4_t41_mem0 += ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls12-440/scheduling/SQR_mul1_add4/SQR_5.png"
	if(S.solution() != []):
