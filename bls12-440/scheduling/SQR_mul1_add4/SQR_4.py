...
def solve():
	...
	c_t4_t40_mem1 += alt(ADD_mem)
	S += (c_t4_t31*ADD[0]) < c_t4_t40_mem1*ADD_mem[0]
	S += (c_t4_t31*ADD[1]) < c_t4_t40_mem1*ADD_mem[1]
	S += (c_t4_t31*ADD[2]) < c_t4_t40_mem1*ADD_mem[2]
	S += (c_t4_t31*ADD[3]) < c_t4_t40_mem1*ADD_mem[3]
	...
	S += (c_t4_t31*ADD[0]) < c_t4_t41_mem0*ADD_mem[0]
	S += (c_t4_t31*ADD[1]) < c_t4_t41_mem0*ADD_mem[1]
	S += (c_t4_t31*ADD[2]) < c_t4_t41_mem0*ADD_mem[2]
	S += (c_t4_t31*ADD[3]) < c_t4_t41_mem0*ADD_mem[3]
	...
	c_t411_mem0 += alt(ADD_mem)
	S += (c_t4_t31*ADD[0]) < c_t411_mem0*ADD_mem[0]
	S += (c_t4_t31*ADD[1]) < c_t411_mem0*ADD_mem[1]
	S += (c_t4_t31*ADD[2]) < c_t411_mem0*ADD_mem[2]
	S += (c_t4_t31*ADD[3]) < c_t411_mem0*ADD_mem[3]
	...
	c_t5_t40_mem1 += alt(ADD_mem)
	S += (c_t5_t31*ADD[0]) < c_t5_t40_mem1*ADD_mem[0]
	S += (c_t5_t31*ADD[1]) < c_t5_t40_mem1*ADD_mem[1]
	S += (c_t5_t31*ADD[2]) < c_t5_t40_mem1*ADD_mem[2]
	S += (c_t5_t31*ADD[3]) < c_t5_t40_mem1*ADD_mem[3]
	...
	c_t5_t41_mem0 += alt(ADD_mem)
	S += (c_t5_t31*ADD[0]) < c_t5_t41_mem0*ADD_mem[0]
	S += (c_t5_t31*ADD[1]) < c_t5_t41_mem0*ADD_mem[1]
	S += (c_t5_t31*ADD[2]) < c_t5_t41_mem0*ADD_mem[2]
	S += (c_t5_t31*ADD[3]) < c_t5_t41_mem0*ADD_mem[3]
	...
	c_t511_mem0 += alt(ADD_mem)
	S += (c_t5_t31*ADD[0]) < c_t511_mem0*ADD_mem[0]
	S += (c_t5_t31*ADD[1]) < c_t511_mem0*ADD_mem[1]
	S += (c_t5_t31*ADD[2]) < c_t511_mem0*ADD_mem[2]
	S += (c_t5_t31*ADD[3]) < c_t511_mem0*ADD_mem[3]
	...
	S += (c_t4_t31*ADD[0]) < c_t4_t51_mem0*ADD_mem[0]
	S += (c_t4_t31*ADD[1]) < c_t4_t51_mem0*ADD_mem[1]
	S += (c_t4_t31*ADD[2]) < c_t4_t51_mem0*ADD_mem[2]
	S += (c_t4_t31*ADD[3]) < c_t4_t51_mem0*ADD_mem[3]
	...
	S += (c_t5_t31*ADD[0]) < c_t5_t51_mem0*ADD_mem[0]
	S += (c_t5_t31*ADD[1]) < c_t5_t51_mem0*ADD_mem[1]
	S += (c_t5_t31*ADD[2]) < c_t5_t51_mem0*ADD_mem[2]
	S += (c_t5_t31*ADD[3]) < c_t5_t51_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design2/bls12-440/scheduling/SQR_mul1_add4/SQR_4.png"
	if(S.solution() != []):
