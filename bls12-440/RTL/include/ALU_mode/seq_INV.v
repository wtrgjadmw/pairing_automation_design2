...
73: begin
	...
	add1_opr1 <= ram_input_out2; add1_opr2 <= ram_add0_out2; issub1 <= 0;
	ram_add0_wr_n <= 0;
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 0;
	ram_add2_waddr <= 3;
...
74: begin
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_add2_out1; issub3 <= 0;
	add1_opr1 <= ram_add1_out1; add1_opr2 <= ram_add1_out2; issub1 <= 0;
	add0_opr1 <= ram_input_out2; add0_opr2 <= ram_add0_out1; issub0 <= 0;
...
81: begin
	add0_opr1 <= add3_out_reg; add0_opr2 <= add1_out_reg; issub0 <= 0;
...
90: begin
	...
	add0_opr1 <= add0_out_reg; add0_opr2 <= ram_add2_out2; issub0 <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 0;
	ram_add3_raddr1 <= 4;
	ram_add0_raddr1 <= 1;
...
106: begin
	...
	add0_opr1 <= ram_add3_out2; add0_opr2 <= add2_out_reg; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
...
114: begin
	...
	add3_opr1 <= add2_out_reg; add3_opr2 <= add0_out_reg; issub3 <= 0;
	add2_opr1 <= ram_mm0_out1; add2_opr2 <= ram_mm0_out2; issub2 <= 0;
	ram_mm0_wr_n <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 5;
...
131: begin
	...
	add0_opr1 <= add2_out_reg; add0_opr2 <= add3_out_reg; issub0 <= 0;
	ram_add2_wr_n <= 1;
	ram_add3_wr_n <= 1;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 1;
...
158: begin
	mm0_opr1 <= ram_add2_out1; mm0_opr2 <= inv_out_reg; 
	state <= state + 1;
end
159: begin
	state <= state + 1;
...
178: begin
	...
	add1_opr1 <= add0_out_reg; add1_opr2 <= ram_add2_out2; issub1 <= 1;
	ram_add0_wr_n <= 1;
	ram_add0_raddr1 <= 2;
	ram_add2_raddr1 <= 1;
	ram_add3_raddr1 <= 1;
...
202: begin
	...
	add1_opr1 <= ram_add0_out2; add1_opr2 <= add2_out_reg; issub1 <= 1;
	mm0_opr1 <= ram_add1_out1; mm0_opr2 <= ram_add3_out2; 
	add3_opr1 <= ram_mm0_out1; add3_opr2 <= ram_mm0_out2; issub3 <= 1;
	ram_add1_wr_n <= 1;
	ram_add2_wr_n <= 1;
