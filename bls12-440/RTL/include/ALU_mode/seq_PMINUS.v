...
15: begin
	...
	add3_opr1 <= ram_input_out2; add3_opr2 <= add1_out_reg; issub3 <= 1;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 0;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
...
22: begin
	add2_opr1 <= ram_input_out1; add2_opr2 <= add0_out_reg; issub2 <= 1;
...
72: begin
	add3_opr1 <= ram_input_out1; add3_opr2 <= add0_out_reg; issub3 <= 1;
	ram_add1_wr_n <= 1;
	ram_add1_raddr1 <= 0;
	w1_n_reg <= 1;
	state <= state + 1;
