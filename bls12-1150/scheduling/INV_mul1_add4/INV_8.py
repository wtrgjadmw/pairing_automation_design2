...
def solve():
	...
	S += (c_pbc_t0_t4*MUL[0])-1 < c_pbc_t01_mem0*MUL_mem[0]
	S += c_pbc_t01_mem0 <= c_pbc_t01

	c_pbc_t01_mem1 = S.Task('c_pbc_t01_mem1', length=1, delay_cost=1)
	c_pbc_t01_mem1 += alt(ADD_mem)
	S += (c_pbc_t0_t5*ADD[0])-1 < c_pbc_t01_mem1*ADD_mem[0]
	S += (c_pbc_t0_t5*ADD[1])-1 < c_pbc_t01_mem1*ADD_mem[1]
	S += (c_pbc_t0_t5*ADD[2])-1 < c_pbc_t01_mem1*ADD_mem[2]
	S += (c_pbc_t0_t5*ADD[3])-1 < c_pbc_t01_mem1*ADD_mem[3]
	...
	S += (c_pbc_t1_t2*ADD[0])-1 < c_pbc_t1_t4_mem0*ADD_mem[0]
	S += (c_pbc_t1_t2*ADD[1])-1 < c_pbc_t1_t4_mem0*ADD_mem[1]
	S += (c_pbc_t1_t2*ADD[2])-1 < c_pbc_t1_t4_mem0*ADD_mem[2]
	S += (c_pbc_t1_t2*ADD[3])-1 < c_pbc_t1_t4_mem0*ADD_mem[3]
	S += c_pbc_t1_t4_mem0 <= c_pbc_t1_t4

	c_pbc_t1_t4_mem1 = S.Task('c_pbc_t1_t4_mem1', length=1, delay_cost=1)
	c_pbc_t1_t4_mem1 += ADD_mem[1]
	S += 68 < c_pbc_t1_t4_mem1
	...
	S += (c_pbc_t1_t1*MUL[0])-1 < c_pbc_t10_mem1*MUL_mem[0]
	...
	S += (c_pbc_t21*ADD[0])-1 < c_pbc_t4_t1_mem0*ADD_mem[0]
	S += (c_pbc_t21*ADD[1])-1 < c_pbc_t4_t1_mem0*ADD_mem[1]
	S += (c_pbc_t21*ADD[2])-1 < c_pbc_t4_t1_mem0*ADD_mem[2]
	S += (c_pbc_t21*ADD[3])-1 < c_pbc_t4_t1_mem0*ADD_mem[3]
	...
	S += 92 < c_pbc_t4_t2_mem0
	S += c_pbc_t4_t2_mem0 <= c_pbc_t4_t2

	c_pbc_t4_t2_mem1 = S.Task('c_pbc_t4_t2_mem1', length=1, delay_cost=1)
	c_pbc_t4_t2_mem1 += alt(ADD_mem)
	S += (c_pbc_t21*ADD[0])-1 < c_pbc_t4_t2_mem1*ADD_mem[0]
	S += (c_pbc_t21*ADD[1])-1 < c_pbc_t4_t2_mem1*ADD_mem[1]
	S += (c_pbc_t21*ADD[2])-1 < c_pbc_t4_t2_mem1*ADD_mem[2]
	S += (c_pbc_t21*ADD[3])-1 < c_pbc_t4_t2_mem1*ADD_mem[3]
	...
	S += (c_pcb_t0_t2*ADD[0])-1 < c_pcb_t0_t4_mem0*ADD_mem[0]
	S += (c_pcb_t0_t2*ADD[1])-1 < c_pcb_t0_t4_mem0*ADD_mem[1]
	S += (c_pcb_t0_t2*ADD[2])-1 < c_pcb_t0_t4_mem0*ADD_mem[2]
	S += (c_pcb_t0_t2*ADD[3])-1 < c_pcb_t0_t4_mem0*ADD_mem[3]
	...
	S += (c_pcb_t0_t1*MUL[0])-1 < c_pcb_t00_mem1*MUL_mem[0]
	...
	S += (c_pcb_t0_t1*MUL[0])-1 < c_pcb_t0_t5_mem1*MUL_mem[0]
	...
	c_pcb_s0_x13 += alt(ADD)

	c_pcb_s0_x13_mem0 = S.Task('c_pcb_s0_x13_mem0', length=1, delay_cost=1)
	c_pcb_s0_x13_mem0 += alt(ADD_mem)
	S += (c_pcb_s0_x12*ADD[0])-1 < c_pcb_s0_x13_mem0*ADD_mem[0]
	S += (c_pcb_s0_x12*ADD[1])-1 < c_pcb_s0_x13_mem0*ADD_mem[1]
	S += (c_pcb_s0_x12*ADD[2])-1 < c_pcb_s0_x13_mem0*ADD_mem[2]
	S += (c_pcb_s0_x12*ADD[3])-1 < c_pcb_s0_x13_mem0*ADD_mem[3]
	S += c_pcb_s0_x13_mem0 <= c_pcb_s0_x13
	...
	S += (c_paa_t0_t2*ADD[0])-1 < c_paa_t0_t4_mem0*ADD_mem[0]
	S += (c_paa_t0_t2*ADD[1])-1 < c_paa_t0_t4_mem0*ADD_mem[1]
	S += (c_paa_t0_t2*ADD[2])-1 < c_paa_t0_t4_mem0*ADD_mem[2]
	S += (c_paa_t0_t2*ADD[3])-1 < c_paa_t0_t4_mem0*ADD_mem[3]
	S += c_paa_t0_t4_mem0 <= c_paa_t0_t4

	c_paa_t0_t4_mem1 = S.Task('c_paa_t0_t4_mem1', length=1, delay_cost=1)
	c_paa_t0_t4_mem1 += ADD_mem[0]
	S += 61 < c_paa_t0_t4_mem1
	...
	S += (c_paa_t0_t1*MUL[0])-1 < c_paa_t00_mem1*MUL_mem[0]
	...
	S += (c_paa_t0_t1*MUL[0])-1 < c_paa_t0_t5_mem1*MUL_mem[0]
	...
	S += (c_paa_t1_t5*ADD[0])-1 < c_paa_t11_mem1*ADD_mem[0]
	S += (c_paa_t1_t5*ADD[1])-1 < c_paa_t11_mem1*ADD_mem[1]
	S += (c_paa_t1_t5*ADD[2])-1 < c_paa_t11_mem1*ADD_mem[2]
	S += (c_paa_t1_t5*ADD[3])-1 < c_paa_t11_mem1*ADD_mem[3]
	...
	S += (c_paa_t21*ADD[0])-1 < c_paa_t4_t1_mem0*ADD_mem[0]
	S += (c_paa_t21*ADD[1])-1 < c_paa_t4_t1_mem0*ADD_mem[1]
	S += (c_paa_t21*ADD[2])-1 < c_paa_t4_t1_mem0*ADD_mem[2]
	S += (c_paa_t21*ADD[3])-1 < c_paa_t4_t1_mem0*ADD_mem[3]
	S += c_paa_t4_t1_mem0 <= c_paa_t4_t1

	c_paa_t4_t1_mem1 = S.Task('c_paa_t4_t1_mem1', length=1, delay_cost=1)
	c_paa_t4_t1_mem1 += ADD_mem[0]
	S += 64 < c_paa_t4_t1_mem1
	...
	S += 90 < c_paa_t4_t2_mem0
	S += c_paa_t4_t2_mem0 <= c_paa_t4_t2

	c_paa_t4_t2_mem1 = S.Task('c_paa_t4_t2_mem1', length=1, delay_cost=1)
	c_paa_t4_t2_mem1 += alt(ADD_mem)
	S += (c_paa_t21*ADD[0])-1 < c_paa_t4_t2_mem1*ADD_mem[0]
	S += (c_paa_t21*ADD[1])-1 < c_paa_t4_t2_mem1*ADD_mem[1]
	S += (c_paa_t21*ADD[2])-1 < c_paa_t4_t2_mem1*ADD_mem[2]
	S += (c_paa_t21*ADD[3])-1 < c_paa_t4_t2_mem1*ADD_mem[3]
	...
	c_paa_s0_x00_mem0 += alt(ADD_mem)
	S += (c_paa_t10*ADD[0])-1 < c_paa_s0_x00_mem0*ADD_mem[0]
	S += (c_paa_t10*ADD[1])-1 < c_paa_s0_x00_mem0*ADD_mem[1]
	S += (c_paa_t10*ADD[2])-1 < c_paa_s0_x00_mem0*ADD_mem[2]
	S += (c_paa_t10*ADD[3])-1 < c_paa_s0_x00_mem0*ADD_mem[3]
	...
	S += (c0_t21*ADD[0])-1 < c0_t4_t2_mem1*ADD_mem[0]
	S += (c0_t21*ADD[1])-1 < c0_t4_t2_mem1*ADD_mem[1]
	S += (c0_t21*ADD[2])-1 < c0_t4_t2_mem1*ADD_mem[2]
	S += (c0_t21*ADD[3])-1 < c0_t4_t2_mem1*ADD_mem[3]
	...
	S += (c1_t21*ADD[0])-1 < c1_t4_t2_mem1*ADD_mem[0]
	S += (c1_t21*ADD[1])-1 < c1_t4_t2_mem1*ADD_mem[1]
	S += (c1_t21*ADD[2])-1 < c1_t4_t2_mem1*ADD_mem[2]
	S += (c1_t21*ADD[3])-1 < c1_t4_t2_mem1*ADD_mem[3]
	...
	S += (c2_t21*ADD[0])-1 < c2_t4_t2_mem1*ADD_mem[0]
	S += (c2_t21*ADD[1])-1 < c2_t4_t2_mem1*ADD_mem[1]
	S += (c2_t21*ADD[2])-1 < c2_t4_t2_mem1*ADD_mem[2]
	S += (c2_t21*ADD[3])-1 < c2_t4_t2_mem1*ADD_mem[3]
	...
	c_pbc_t11_mem0 += alt(MUL_mem)
	S += (c_pbc_t1_t4*MUL[0])-1 < c_pbc_t11_mem0*MUL_mem[0]
	S += c_pbc_t11_mem0 <= c_pbc_t11

	c_pbc_t11_mem1 = S.Task('c_pbc_t11_mem1', length=1, delay_cost=1)
	c_pbc_t11_mem1 += alt(ADD_mem)
	S += (c_pbc_t1_t5*ADD[0])-1 < c_pbc_t11_mem1*ADD_mem[0]
	S += (c_pbc_t1_t5*ADD[1])-1 < c_pbc_t11_mem1*ADD_mem[1]
	S += (c_pbc_t1_t5*ADD[2])-1 < c_pbc_t11_mem1*ADD_mem[2]
	S += (c_pbc_t1_t5*ADD[3])-1 < c_pbc_t11_mem1*ADD_mem[3]
	...
	c_pbc_t4_t4_mem0 += alt(ADD_mem)
	S += (c_pbc_t4_t2*ADD[0])-1 < c_pbc_t4_t4_mem0*ADD_mem[0]
	S += (c_pbc_t4_t2*ADD[1])-1 < c_pbc_t4_t4_mem0*ADD_mem[1]
	S += (c_pbc_t4_t2*ADD[2])-1 < c_pbc_t4_t4_mem0*ADD_mem[2]
	S += (c_pbc_t4_t2*ADD[3])-1 < c_pbc_t4_t4_mem0*ADD_mem[3]
	S += c_pbc_t4_t4_mem0 <= c_pbc_t4_t4

	c_pbc_t4_t4_mem1 = S.Task('c_pbc_t4_t4_mem1', length=1, delay_cost=1)
	c_pbc_t4_t4_mem1 += ADD_mem[0]
	S += 70 < c_pbc_t4_t4_mem1
	...
	c_pbc_t40_mem0 += alt(MUL_mem)
	S += (c_pbc_t4_t0*MUL[0])-1 < c_pbc_t40_mem0*MUL_mem[0]
	S += c_pbc_t40_mem0 <= c_pbc_t40

	c_pbc_t40_mem1 = S.Task('c_pbc_t40_mem1', length=1, delay_cost=1)
	c_pbc_t40_mem1 += alt(MUL_mem)
	S += (c_pbc_t4_t1*MUL[0])-1 < c_pbc_t40_mem1*MUL_mem[0]
	...
	c_pbc_t4_t5_mem0 += alt(MUL_mem)
	S += (c_pbc_t4_t0*MUL[0])-1 < c_pbc_t4_t5_mem0*MUL_mem[0]
	S += c_pbc_t4_t5_mem0 <= c_pbc_t4_t5

	c_pbc_t4_t5_mem1 = S.Task('c_pbc_t4_t5_mem1', length=1, delay_cost=1)
	c_pbc_t4_t5_mem1 += alt(MUL_mem)
	S += (c_pbc_t4_t1*MUL[0])-1 < c_pbc_t4_t5_mem1*MUL_mem[0]
	S += c_pbc_t4_t5_mem1 <= c_pbc_t4_t5

	c_pbc_s0_x00 = S.Task('c_pbc_s0_x00', length=1, delay_cost=1)
	c_pbc_s0_x00 += alt(ADD)

	c_pbc_s0_x00_mem0 = S.Task('c_pbc_s0_x00_mem0', length=1, delay_cost=1)
	c_pbc_s0_x00_mem0 += alt(ADD_mem)
	S += (c_pbc_t10*ADD[0])-1 < c_pbc_s0_x00_mem0*ADD_mem[0]
	S += (c_pbc_t10*ADD[1])-1 < c_pbc_s0_x00_mem0*ADD_mem[1]
	S += (c_pbc_t10*ADD[2])-1 < c_pbc_s0_x00_mem0*ADD_mem[2]
	S += (c_pbc_t10*ADD[3])-1 < c_pbc_s0_x00_mem0*ADD_mem[3]
	S += c_pbc_s0_x00_mem0 <= c_pbc_s0_x00

	c_pbc_t50 = S.Task('c_pbc_t50', length=1, delay_cost=1)
	c_pbc_t50 += alt(ADD)

	c_pbc_t50_mem0 = S.Task('c_pbc_t50_mem0', length=1, delay_cost=1)
	c_pbc_t50_mem0 += alt(ADD_mem)
	S += (c_pbc_t00*ADD[0])-1 < c_pbc_t50_mem0*ADD_mem[0]
	S += (c_pbc_t00*ADD[1])-1 < c_pbc_t50_mem0*ADD_mem[1]
	S += (c_pbc_t00*ADD[2])-1 < c_pbc_t50_mem0*ADD_mem[2]
	S += (c_pbc_t00*ADD[3])-1 < c_pbc_t50_mem0*ADD_mem[3]
	S += c_pbc_t50_mem0 <= c_pbc_t50

	c_pbc_t50_mem1 = S.Task('c_pbc_t50_mem1', length=1, delay_cost=1)
	c_pbc_t50_mem1 += alt(ADD_mem)
	S += (c_pbc_t10*ADD[0])-1 < c_pbc_t50_mem1*ADD_mem[0]
	S += (c_pbc_t10*ADD[1])-1 < c_pbc_t50_mem1*ADD_mem[1]
	S += (c_pbc_t10*ADD[2])-1 < c_pbc_t50_mem1*ADD_mem[2]
	S += (c_pbc_t10*ADD[3])-1 < c_pbc_t50_mem1*ADD_mem[3]
	...
	c_pcb_t4_t4_mem0 += alt(ADD_mem)
	S += (c_pcb_t4_t2*ADD[0])-1 < c_pcb_t4_t4_mem0*ADD_mem[0]
	S += (c_pcb_t4_t2*ADD[1])-1 < c_pcb_t4_t4_mem0*ADD_mem[1]
	S += (c_pcb_t4_t2*ADD[2])-1 < c_pcb_t4_t4_mem0*ADD_mem[2]
	S += (c_pcb_t4_t2*ADD[3])-1 < c_pcb_t4_t4_mem0*ADD_mem[3]
	S += c_pcb_t4_t4_mem0 <= c_pcb_t4_t4

	c_pcb_t4_t4_mem1 = S.Task('c_pcb_t4_t4_mem1', length=1, delay_cost=1)
	c_pcb_t4_t4_mem1 += ADD_mem[3]
	S += 61 < c_pcb_t4_t4_mem1
	...
	c_pcb_t40_mem0 += alt(MUL_mem)
	S += (c_pcb_t4_t0*MUL[0])-1 < c_pcb_t40_mem0*MUL_mem[0]
	S += c_pcb_t40_mem0 <= c_pcb_t40

	c_pcb_t40_mem1 = S.Task('c_pcb_t40_mem1', length=1, delay_cost=1)
	c_pcb_t40_mem1 += alt(MUL_mem)
	S += (c_pcb_t4_t1*MUL[0])-1 < c_pcb_t40_mem1*MUL_mem[0]
	...
	c_pcb_t4_t5_mem0 += alt(MUL_mem)
	S += (c_pcb_t4_t0*MUL[0])-1 < c_pcb_t4_t5_mem0*MUL_mem[0]
	S += c_pcb_t4_t5_mem0 <= c_pcb_t4_t5

	c_pcb_t4_t5_mem1 = S.Task('c_pcb_t4_t5_mem1', length=1, delay_cost=1)
	c_pcb_t4_t5_mem1 += alt(MUL_mem)
	S += (c_pcb_t4_t1*MUL[0])-1 < c_pcb_t4_t5_mem1*MUL_mem[0]
	...
	c_pcb_s01_mem0 += alt(ADD_mem)
	S += (c_pcb_s0_x13*ADD[0])-1 < c_pcb_s01_mem0*ADD_mem[0]
	S += (c_pcb_s0_x13*ADD[1])-1 < c_pcb_s01_mem0*ADD_mem[1]
	S += (c_pcb_s0_x13*ADD[2])-1 < c_pcb_s01_mem0*ADD_mem[2]
	S += (c_pcb_s0_x13*ADD[3])-1 < c_pcb_s01_mem0*ADD_mem[3]
	...
	c_pcb00_mem0 += alt(ADD_mem)
	S += (c_pcb_t00*ADD[0])-1 < c_pcb00_mem0*ADD_mem[0]
	S += (c_pcb_t00*ADD[1])-1 < c_pcb00_mem0*ADD_mem[1]
	S += (c_pcb_t00*ADD[2])-1 < c_pcb00_mem0*ADD_mem[2]
	S += (c_pcb_t00*ADD[3])-1 < c_pcb00_mem0*ADD_mem[3]
	...
	c_pcb_t50_mem0 += alt(ADD_mem)
	S += (c_pcb_t00*ADD[0])-1 < c_pcb_t50_mem0*ADD_mem[0]
	S += (c_pcb_t00*ADD[1])-1 < c_pcb_t50_mem0*ADD_mem[1]
	S += (c_pcb_t00*ADD[2])-1 < c_pcb_t50_mem0*ADD_mem[2]
	S += (c_pcb_t00*ADD[3])-1 < c_pcb_t50_mem0*ADD_mem[3]
	...
	c_paa_t01_mem0 += alt(MUL_mem)
	S += (c_paa_t0_t4*MUL[0])-1 < c_paa_t01_mem0*MUL_mem[0]
	...
	c_paa_t4_t4_mem0 += alt(ADD_mem)
	S += (c_paa_t4_t2*ADD[0])-1 < c_paa_t4_t4_mem0*ADD_mem[0]
	S += (c_paa_t4_t2*ADD[1])-1 < c_paa_t4_t4_mem0*ADD_mem[1]
	S += (c_paa_t4_t2*ADD[2])-1 < c_paa_t4_t4_mem0*ADD_mem[2]
	S += (c_paa_t4_t2*ADD[3])-1 < c_paa_t4_t4_mem0*ADD_mem[3]
	S += c_paa_t4_t4_mem0 <= c_paa_t4_t4

	c_paa_t4_t4_mem1 = S.Task('c_paa_t4_t4_mem1', length=1, delay_cost=1)
	c_paa_t4_t4_mem1 += ADD_mem[3]
	S += 65 < c_paa_t4_t4_mem1
	...
	c_paa_t40_mem0 += alt(MUL_mem)
	S += (c_paa_t4_t0*MUL[0])-1 < c_paa_t40_mem0*MUL_mem[0]
	S += c_paa_t40_mem0 <= c_paa_t40

	c_paa_t40_mem1 = S.Task('c_paa_t40_mem1', length=1, delay_cost=1)
	c_paa_t40_mem1 += alt(MUL_mem)
	S += (c_paa_t4_t1*MUL[0])-1 < c_paa_t40_mem1*MUL_mem[0]
	...
	c_paa_t4_t5_mem0 += alt(MUL_mem)
	S += (c_paa_t4_t0*MUL[0])-1 < c_paa_t4_t5_mem0*MUL_mem[0]
	S += c_paa_t4_t5_mem0 <= c_paa_t4_t5

	c_paa_t4_t5_mem1 = S.Task('c_paa_t4_t5_mem1', length=1, delay_cost=1)
	c_paa_t4_t5_mem1 += alt(MUL_mem)
	S += (c_paa_t4_t1*MUL[0])-1 < c_paa_t4_t5_mem1*MUL_mem[0]
	...
	c_paa_s0_x10 += alt(ADD)

	c_paa_s0_x10_mem0 = S.Task('c_paa_s0_x10_mem0', length=1, delay_cost=1)
	c_paa_s0_x10_mem0 += alt(ADD_mem)
	S += (c_paa_t11*ADD[0])-1 < c_paa_s0_x10_mem0*ADD_mem[0]
	S += (c_paa_t11*ADD[1])-1 < c_paa_s0_x10_mem0*ADD_mem[1]
	S += (c_paa_t11*ADD[2])-1 < c_paa_s0_x10_mem0*ADD_mem[2]
	S += (c_paa_t11*ADD[3])-1 < c_paa_s0_x10_mem0*ADD_mem[3]
	S += c_paa_s0_x10_mem0 <= c_paa_s0_x10

	c_paa_t50 = S.Task('c_paa_t50', length=1, delay_cost=1)
	c_paa_t50 += alt(ADD)

	c_paa_t50_mem0 = S.Task('c_paa_t50_mem0', length=1, delay_cost=1)
	c_paa_t50_mem0 += alt(ADD_mem)
	S += (c_paa_t00*ADD[0])-1 < c_paa_t50_mem0*ADD_mem[0]
	S += (c_paa_t00*ADD[1])-1 < c_paa_t50_mem0*ADD_mem[1]
	S += (c_paa_t00*ADD[2])-1 < c_paa_t50_mem0*ADD_mem[2]
	S += (c_paa_t00*ADD[3])-1 < c_paa_t50_mem0*ADD_mem[3]
	S += c_paa_t50_mem0 <= c_paa_t50

	c_paa_t50_mem1 = S.Task('c_paa_t50_mem1', length=1, delay_cost=1)
	c_paa_t50_mem1 += alt(ADD_mem)
	S += (c_paa_t10*ADD[0])-1 < c_paa_t50_mem1*ADD_mem[0]
	S += (c_paa_t10*ADD[1])-1 < c_paa_t50_mem1*ADD_mem[1]
	S += (c_paa_t10*ADD[2])-1 < c_paa_t50_mem1*ADD_mem[2]
	S += (c_paa_t10*ADD[3])-1 < c_paa_t50_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-1150/scheduling/INV_mul1_add4/INV_8.png"
	if(S.solution() != []):
