...
def solve():
	...
	S += (c_pcb_s0_x12*ADD[0]) < c_pcb_s0_x13_mem0*ADD_mem[0]
	S += (c_pcb_s0_x12*ADD[1]) < c_pcb_s0_x13_mem0*ADD_mem[1]
	S += (c_pcb_s0_x12*ADD[2]) < c_pcb_s0_x13_mem0*ADD_mem[2]
	S += (c_pcb_s0_x12*ADD[3]) < c_pcb_s0_x13_mem0*ADD_mem[3]
	...
	S += (c_pcb_s0_x03*ADD[0]) < c_pcb_s00_mem0*ADD_mem[0]
	S += (c_pcb_s0_x03*ADD[1]) < c_pcb_s00_mem0*ADD_mem[1]
	S += (c_pcb_s0_x03*ADD[2]) < c_pcb_s00_mem0*ADD_mem[2]
	S += (c_pcb_s0_x03*ADD[3]) < c_pcb_s00_mem0*ADD_mem[3]
	...
	S += (c_paa_t10*ADD[0]) < c_paa_s0_x00_mem0*ADD_mem[0]
	S += (c_paa_t10*ADD[1]) < c_paa_s0_x00_mem0*ADD_mem[1]
	S += (c_paa_t10*ADD[2]) < c_paa_s0_x00_mem0*ADD_mem[2]
	S += (c_paa_t10*ADD[3]) < c_paa_s0_x00_mem0*ADD_mem[3]
	...
	S += (c_pbc_t1_t4*MUL[0]) < c_pbc_t11_mem0*MUL_mem[0]
	S += c_pbc_t11_mem0 <= c_pbc_t11

	c_pbc_t11_mem1 = S.Task('c_pbc_t11_mem1', length=1, delay_cost=1)
	c_pbc_t11_mem1 += alt(ADD_mem)
	S += (c_pbc_t1_t5*ADD[0]) < c_pbc_t11_mem1*ADD_mem[0]
	S += (c_pbc_t1_t5*ADD[1]) < c_pbc_t11_mem1*ADD_mem[1]
	S += (c_pbc_t1_t5*ADD[2]) < c_pbc_t11_mem1*ADD_mem[2]
	S += (c_pbc_t1_t5*ADD[3]) < c_pbc_t11_mem1*ADD_mem[3]
	...
	S += (c_pbc_t4_t2*ADD[0]) < c_pbc_t4_t4_mem0*ADD_mem[0]
	S += (c_pbc_t4_t2*ADD[1]) < c_pbc_t4_t4_mem0*ADD_mem[1]
	S += (c_pbc_t4_t2*ADD[2]) < c_pbc_t4_t4_mem0*ADD_mem[2]
	S += (c_pbc_t4_t2*ADD[3]) < c_pbc_t4_t4_mem0*ADD_mem[3]
	...
	S += (c_pbc_t10*ADD[0]) < c_pbc_s0_x00_mem0*ADD_mem[0]
	S += (c_pbc_t10*ADD[1]) < c_pbc_s0_x00_mem0*ADD_mem[1]
	S += (c_pbc_t10*ADD[2]) < c_pbc_s0_x00_mem0*ADD_mem[2]
	S += (c_pbc_t10*ADD[3]) < c_pbc_s0_x00_mem0*ADD_mem[3]
	...
	S += (c_pbc_t00*ADD[0]) < c_pbc_t50_mem0*ADD_mem[0]
	S += (c_pbc_t00*ADD[1]) < c_pbc_t50_mem0*ADD_mem[1]
	S += (c_pbc_t00*ADD[2]) < c_pbc_t50_mem0*ADD_mem[2]
	S += (c_pbc_t00*ADD[3]) < c_pbc_t50_mem0*ADD_mem[3]
	S += c_pbc_t50_mem0 <= c_pbc_t50

	c_pbc_t50_mem1 = S.Task('c_pbc_t50_mem1', length=1, delay_cost=1)
	c_pbc_t50_mem1 += alt(ADD_mem)
	S += (c_pbc_t10*ADD[0]) < c_pbc_t50_mem1*ADD_mem[0]
	S += (c_pbc_t10*ADD[1]) < c_pbc_t50_mem1*ADD_mem[1]
	S += (c_pbc_t10*ADD[2]) < c_pbc_t50_mem1*ADD_mem[2]
	S += (c_pbc_t10*ADD[3]) < c_pbc_t50_mem1*ADD_mem[3]
	...
	S += (c_pcb_t0_t4*MUL[0]) < c_pcb_t01_mem0*MUL_mem[0]
	S += c_pcb_t01_mem0 <= c_pcb_t01

	c_pcb_t01_mem1 = S.Task('c_pcb_t01_mem1', length=1, delay_cost=1)
	c_pcb_t01_mem1 += alt(ADD_mem)
	S += (c_pcb_t0_t5*ADD[0]) < c_pcb_t01_mem1*ADD_mem[0]
	S += (c_pcb_t0_t5*ADD[1]) < c_pcb_t01_mem1*ADD_mem[1]
	S += (c_pcb_t0_t5*ADD[2]) < c_pcb_t01_mem1*ADD_mem[2]
	S += (c_pcb_t0_t5*ADD[3]) < c_pcb_t01_mem1*ADD_mem[3]
	...
	S += (c_pcb_t4_t2*ADD[0]) < c_pcb_t4_t4_mem0*ADD_mem[0]
	S += (c_pcb_t4_t2*ADD[1]) < c_pcb_t4_t4_mem0*ADD_mem[1]
	S += (c_pcb_t4_t2*ADD[2]) < c_pcb_t4_t4_mem0*ADD_mem[2]
	S += (c_pcb_t4_t2*ADD[3]) < c_pcb_t4_t4_mem0*ADD_mem[3]
	S += c_pcb_t4_t4_mem0 <= c_pcb_t4_t4

	c_pcb_t4_t4_mem1 = S.Task('c_pcb_t4_t4_mem1', length=1, delay_cost=1)
	c_pcb_t4_t4_mem1 += ADD_mem[2]
	S += 63 < c_pcb_t4_t4_mem1
	...
	S += (c_pcb_s0_x13*ADD[0]) < c_pcb_s01_mem0*ADD_mem[0]
	S += (c_pcb_s0_x13*ADD[1]) < c_pcb_s01_mem0*ADD_mem[1]
	S += (c_pcb_s0_x13*ADD[2]) < c_pcb_s01_mem0*ADD_mem[2]
	S += (c_pcb_s0_x13*ADD[3]) < c_pcb_s01_mem0*ADD_mem[3]
	...
	S += (c_pcb_t00*ADD[0]) < c_pcb00_mem0*ADD_mem[0]
	S += (c_pcb_t00*ADD[1]) < c_pcb00_mem0*ADD_mem[1]
	S += (c_pcb_t00*ADD[2]) < c_pcb00_mem0*ADD_mem[2]
	S += (c_pcb_t00*ADD[3]) < c_pcb00_mem0*ADD_mem[3]
	...
	S += (c_pcb_t00*ADD[0]) < c_pcb_t50_mem0*ADD_mem[0]
	S += (c_pcb_t00*ADD[1]) < c_pcb_t50_mem0*ADD_mem[1]
	S += (c_pcb_t00*ADD[2]) < c_pcb_t50_mem0*ADD_mem[2]
	S += (c_pcb_t00*ADD[3]) < c_pcb_t50_mem0*ADD_mem[3]
	...
	S += (c_paa_t0_t4*MUL[0]) < c_paa_t01_mem0*MUL_mem[0]
	S += c_paa_t01_mem0 <= c_paa_t01

	c_paa_t01_mem1 = S.Task('c_paa_t01_mem1', length=1, delay_cost=1)
	c_paa_t01_mem1 += alt(ADD_mem)
	S += (c_paa_t0_t5*ADD[0]) < c_paa_t01_mem1*ADD_mem[0]
	S += (c_paa_t0_t5*ADD[1]) < c_paa_t01_mem1*ADD_mem[1]
	S += (c_paa_t0_t5*ADD[2]) < c_paa_t01_mem1*ADD_mem[2]
	S += (c_paa_t0_t5*ADD[3]) < c_paa_t01_mem1*ADD_mem[3]
	...
	S += (c_paa_t4_t2*ADD[0]) < c_paa_t4_t4_mem0*ADD_mem[0]
	S += (c_paa_t4_t2*ADD[1]) < c_paa_t4_t4_mem0*ADD_mem[1]
	S += (c_paa_t4_t2*ADD[2]) < c_paa_t4_t4_mem0*ADD_mem[2]
	S += (c_paa_t4_t2*ADD[3]) < c_paa_t4_t4_mem0*ADD_mem[3]
	S += c_paa_t4_t4_mem0 <= c_paa_t4_t4

	c_paa_t4_t4_mem1 = S.Task('c_paa_t4_t4_mem1', length=1, delay_cost=1)
	c_paa_t4_t4_mem1 += ADD_mem[1]
	S += 67 < c_paa_t4_t4_mem1
	...
	S += (c_paa_s0_x00*ADD[0]) < c_paa_s0_x01_mem0*ADD_mem[0]
	S += (c_paa_s0_x00*ADD[1]) < c_paa_s0_x01_mem0*ADD_mem[1]
	S += (c_paa_s0_x00*ADD[2]) < c_paa_s0_x01_mem0*ADD_mem[2]
	S += (c_paa_s0_x00*ADD[3]) < c_paa_s0_x01_mem0*ADD_mem[3]
	...
	S += (c_paa_t11*ADD[0]) < c_paa_s0_x10_mem0*ADD_mem[0]
	S += (c_paa_t11*ADD[1]) < c_paa_s0_x10_mem0*ADD_mem[1]
	S += (c_paa_t11*ADD[2]) < c_paa_s0_x10_mem0*ADD_mem[2]
	S += (c_paa_t11*ADD[3]) < c_paa_s0_x10_mem0*ADD_mem[3]
	...
	S += (c_paa_t00*ADD[0]) < c_paa_t50_mem0*ADD_mem[0]
	S += (c_paa_t00*ADD[1]) < c_paa_t50_mem0*ADD_mem[1]
	S += (c_paa_t00*ADD[2]) < c_paa_t50_mem0*ADD_mem[2]
	S += (c_paa_t00*ADD[3]) < c_paa_t50_mem0*ADD_mem[3]
	S += c_paa_t50_mem0 <= c_paa_t50

	c_paa_t50_mem1 = S.Task('c_paa_t50_mem1', length=1, delay_cost=1)
	c_paa_t50_mem1 += alt(ADD_mem)
	S += (c_paa_t10*ADD[0]) < c_paa_t50_mem1*ADD_mem[0]
	S += (c_paa_t10*ADD[1]) < c_paa_t50_mem1*ADD_mem[1]
	S += (c_paa_t10*ADD[2]) < c_paa_t50_mem1*ADD_mem[2]
	S += (c_paa_t10*ADD[3]) < c_paa_t50_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls12-1150/scheduling/INV_mul1_add4/INV_8.png"
	if(S.solution() != []):
