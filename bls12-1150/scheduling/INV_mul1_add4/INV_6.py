...
def solve():
	...
	S += 47 < c_aa_t4_x13_mem0
	S += c_aa_t4_x13_mem0 <= c_aa_t4_x13
	...
	S += 30 < c_bb_t4_x13_mem0
	S += c_bb_t4_x13_mem0 <= c_bb_t4_x13
	...
	S += 32 < c_cc_t4_x13_mem0
	S += c_cc_t4_x13_mem0 <= c_cc_t4_x13
	...
	S += 67 < c_ab_s0_x13_mem0
	S += c_ab_s0_x13_mem0 <= c_ab_s0_x13
	...
	S += 68 < c_bc_s0_x13_mem0
	S += c_bc_s0_x13_mem0 <= c_bc_s0_x13
	...
	S += 58 < c_ac_s0_x13_mem0
	S += c_ac_s0_x13_mem0 <= c_ac_s0_x13
	...
	S += (c_aa_t4_x13*ADD[0])-1 < c_aa_t41_mem0*ADD_mem[0]
	S += (c_aa_t4_x13*ADD[1])-1 < c_aa_t41_mem0*ADD_mem[1]
	S += (c_aa_t4_x13*ADD[2])-1 < c_aa_t41_mem0*ADD_mem[2]
	S += (c_aa_t4_x13*ADD[3])-1 < c_aa_t41_mem0*ADD_mem[3]
	...
	c_aa_t50_mem1 += alt(ADD_mem)
	S += (c_aa_t40*ADD[0])-1 < c_aa_t50_mem1*ADD_mem[0]
	S += (c_aa_t40*ADD[1])-1 < c_aa_t50_mem1*ADD_mem[1]
	S += (c_aa_t40*ADD[2])-1 < c_aa_t50_mem1*ADD_mem[2]
	S += (c_aa_t40*ADD[3])-1 < c_aa_t50_mem1*ADD_mem[3]
	...
	S += (c_bb_t4_x13*ADD[0])-1 < c_bb_t41_mem0*ADD_mem[0]
	S += (c_bb_t4_x13*ADD[1])-1 < c_bb_t41_mem0*ADD_mem[1]
	S += (c_bb_t4_x13*ADD[2])-1 < c_bb_t41_mem0*ADD_mem[2]
	S += (c_bb_t4_x13*ADD[3])-1 < c_bb_t41_mem0*ADD_mem[3]
	...
	c_bb_t50_mem1 += alt(ADD_mem)
	S += (c_bb_t40*ADD[0])-1 < c_bb_t50_mem1*ADD_mem[0]
	S += (c_bb_t40*ADD[1])-1 < c_bb_t50_mem1*ADD_mem[1]
	S += (c_bb_t40*ADD[2])-1 < c_bb_t50_mem1*ADD_mem[2]
	S += (c_bb_t40*ADD[3])-1 < c_bb_t50_mem1*ADD_mem[3]
	...
	S += (c_cc_t4_x13*ADD[0])-1 < c_cc_t41_mem0*ADD_mem[0]
	S += (c_cc_t4_x13*ADD[1])-1 < c_cc_t41_mem0*ADD_mem[1]
	S += (c_cc_t4_x13*ADD[2])-1 < c_cc_t41_mem0*ADD_mem[2]
	S += (c_cc_t4_x13*ADD[3])-1 < c_cc_t41_mem0*ADD_mem[3]
	...
	c_cc_t50_mem1 += alt(ADD_mem)
	S += (c_cc_t40*ADD[0])-1 < c_cc_t50_mem1*ADD_mem[0]
	S += (c_cc_t40*ADD[1])-1 < c_cc_t50_mem1*ADD_mem[1]
	S += (c_cc_t40*ADD[2])-1 < c_cc_t50_mem1*ADD_mem[2]
	S += (c_cc_t40*ADD[3])-1 < c_cc_t50_mem1*ADD_mem[3]
	...
	S += (c_ab_s0_x13*ADD[0])-1 < c_ab_s01_mem0*ADD_mem[0]
	S += (c_ab_s0_x13*ADD[1])-1 < c_ab_s01_mem0*ADD_mem[1]
	S += (c_ab_s0_x13*ADD[2])-1 < c_ab_s01_mem0*ADD_mem[2]
	S += (c_ab_s0_x13*ADD[3])-1 < c_ab_s01_mem0*ADD_mem[3]
	...
	c_ab00_mem1 += alt(ADD_mem)
	S += (c_ab_s00*ADD[0])-1 < c_ab00_mem1*ADD_mem[0]
	S += (c_ab_s00*ADD[1])-1 < c_ab00_mem1*ADD_mem[1]
	S += (c_ab_s00*ADD[2])-1 < c_ab00_mem1*ADD_mem[2]
	S += (c_ab_s00*ADD[3])-1 < c_ab00_mem1*ADD_mem[3]
	...
	S += (c_bc_s0_x13*ADD[0])-1 < c_bc_s01_mem0*ADD_mem[0]
	S += (c_bc_s0_x13*ADD[1])-1 < c_bc_s01_mem0*ADD_mem[1]
	S += (c_bc_s0_x13*ADD[2])-1 < c_bc_s01_mem0*ADD_mem[2]
	S += (c_bc_s0_x13*ADD[3])-1 < c_bc_s01_mem0*ADD_mem[3]
	...
	c_bc00_mem1 += alt(ADD_mem)
	S += (c_bc_s00*ADD[0])-1 < c_bc00_mem1*ADD_mem[0]
	S += (c_bc_s00*ADD[1])-1 < c_bc00_mem1*ADD_mem[1]
	S += (c_bc_s00*ADD[2])-1 < c_bc00_mem1*ADD_mem[2]
	S += (c_bc_s00*ADD[3])-1 < c_bc00_mem1*ADD_mem[3]
	...
	S += (c_ac_s0_x13*ADD[0])-1 < c_ac_s01_mem0*ADD_mem[0]
	S += (c_ac_s0_x13*ADD[1])-1 < c_ac_s01_mem0*ADD_mem[1]
	S += (c_ac_s0_x13*ADD[2])-1 < c_ac_s01_mem0*ADD_mem[2]
	S += (c_ac_s0_x13*ADD[3])-1 < c_ac_s01_mem0*ADD_mem[3]
	...
	c_ac00_mem1 += alt(ADD_mem)
	S += (c_ac_s00*ADD[0])-1 < c_ac00_mem1*ADD_mem[0]
	S += (c_ac_s00*ADD[1])-1 < c_ac00_mem1*ADD_mem[1]
	S += (c_ac_s00*ADD[2])-1 < c_ac00_mem1*ADD_mem[2]
	S += (c_ac_s00*ADD[3])-1 < c_ac00_mem1*ADD_mem[3]
	S += c_ac00_mem1 <= c_ac00

	c_bcxi_y1__x03 = S.Task('c_bcxi_y1__x03', length=1, delay_cost=1)
	c_bcxi_y1__x03 += alt(ADD)

	c_bcxi_y1__x03_mem0 = S.Task('c_bcxi_y1__x03_mem0', length=1, delay_cost=1)
	c_bcxi_y1__x03_mem0 += alt(ADD_mem)
	S += (c_bcxi_y1__x02*ADD[0])-1 < c_bcxi_y1__x03_mem0*ADD_mem[0]
	S += (c_bcxi_y1__x02*ADD[1])-1 < c_bcxi_y1__x03_mem0*ADD_mem[1]
	S += (c_bcxi_y1__x02*ADD[2])-1 < c_bcxi_y1__x03_mem0*ADD_mem[2]
	S += (c_bcxi_y1__x02*ADD[3])-1 < c_bcxi_y1__x03_mem0*ADD_mem[3]
	S += c_bcxi_y1__x03_mem0 <= c_bcxi_y1__x03

	c_bcxi_y1__x12 = S.Task('c_bcxi_y1__x12', length=1, delay_cost=1)
	c_bcxi_y1__x12 += alt(ADD)

	c_bcxi_y1__x12_mem0 = S.Task('c_bcxi_y1__x12_mem0', length=1, delay_cost=1)
	c_bcxi_y1__x12_mem0 += alt(ADD_mem)
	S += (c_bcxi_y1__x11*ADD[0])-1 < c_bcxi_y1__x12_mem0*ADD_mem[0]
	S += (c_bcxi_y1__x11*ADD[1])-1 < c_bcxi_y1__x12_mem0*ADD_mem[1]
	S += (c_bcxi_y1__x11*ADD[2])-1 < c_bcxi_y1__x12_mem0*ADD_mem[2]
	S += (c_bcxi_y1__x11*ADD[3])-1 < c_bcxi_y1__x12_mem0*ADD_mem[3]
	S += c_bcxi_y1__x12_mem0 <= c_bcxi_y1__x12

	c_bcxi_y1__x12_mem1 = S.Task('c_bcxi_y1__x12_mem1', length=1, delay_cost=1)
	c_bcxi_y1__x12_mem1 += ADD_mem[0]
	S += 67 < c_bcxi_y1__x12_mem1
	S += c_bcxi_y1__x12_mem1 <= c_bcxi_y1__x12

	c_ccxi_y1__x13 = S.Task('c_ccxi_y1__x13', length=1, delay_cost=1)
	c_ccxi_y1__x13 += alt(ADD)

	c_ccxi_y1__x13_mem0 = S.Task('c_ccxi_y1__x13_mem0', length=1, delay_cost=1)
	c_ccxi_y1__x13_mem0 += alt(ADD_mem)
	S += (c_ccxi_y1__x12*ADD[0])-1 < c_ccxi_y1__x13_mem0*ADD_mem[0]
	S += (c_ccxi_y1__x12*ADD[1])-1 < c_ccxi_y1__x13_mem0*ADD_mem[1]
	S += (c_ccxi_y1__x12*ADD[2])-1 < c_ccxi_y1__x13_mem0*ADD_mem[2]
	S += (c_ccxi_y1__x12*ADD[3])-1 < c_ccxi_y1__x13_mem0*ADD_mem[3]
	S += c_ccxi_y1__x13_mem0 <= c_ccxi_y1__x13

	c_ccxi_y1_0 = S.Task('c_ccxi_y1_0', length=1, delay_cost=1)
	c_ccxi_y1_0 += alt(ADD)

	c_ccxi_y1_0_mem0 = S.Task('c_ccxi_y1_0_mem0', length=1, delay_cost=1)
	c_ccxi_y1_0_mem0 += alt(ADD_mem)
	S += (c_ccxi_y1__x03*ADD[0])-1 < c_ccxi_y1_0_mem0*ADD_mem[0]
	S += (c_ccxi_y1__x03*ADD[1])-1 < c_ccxi_y1_0_mem0*ADD_mem[1]
	S += (c_ccxi_y1__x03*ADD[2])-1 < c_ccxi_y1_0_mem0*ADD_mem[2]
	S += (c_ccxi_y1__x03*ADD[3])-1 < c_ccxi_y1_0_mem0*ADD_mem[3]
	S += c_ccxi_y1_0_mem0 <= c_ccxi_y1_0

	c_ccxi_y1_0_mem1 = S.Task('c_ccxi_y1_0_mem1', length=1, delay_cost=1)
	c_ccxi_y1_0_mem1 += ADD_mem[0]
	S += 30 < c_ccxi_y1_0_mem1
	...
	c_pcb_t1_t4_mem0 += alt(ADD_mem)
	S += (c_pcb_t1_t2*ADD[0])-1 < c_pcb_t1_t4_mem0*ADD_mem[0]
	S += (c_pcb_t1_t2*ADD[1])-1 < c_pcb_t1_t4_mem0*ADD_mem[1]
	S += (c_pcb_t1_t2*ADD[2])-1 < c_pcb_t1_t4_mem0*ADD_mem[2]
	S += (c_pcb_t1_t2*ADD[3])-1 < c_pcb_t1_t4_mem0*ADD_mem[3]
	S += c_pcb_t1_t4_mem0 <= c_pcb_t1_t4

	c_pcb_t1_t4_mem1 = S.Task('c_pcb_t1_t4_mem1', length=1, delay_cost=1)
	c_pcb_t1_t4_mem1 += ADD_mem[0]
	S += 58 < c_pcb_t1_t4_mem1
	...
	c_pcb_t10_mem1 += alt(MUL_mem)
	S += (c_pcb_t1_t1*MUL[0])-1 < c_pcb_t10_mem1*MUL_mem[0]
	...
	S += 79 < c_pcb_t1_t5_mem0
	S += c_pcb_t1_t5_mem0 <= c_pcb_t1_t5

	c_pcb_t1_t5_mem1 = S.Task('c_pcb_t1_t5_mem1', length=1, delay_cost=1)
	c_pcb_t1_t5_mem1 += alt(MUL_mem)
	S += (c_pcb_t1_t1*MUL[0])-1 < c_pcb_t1_t5_mem1*MUL_mem[0]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-1150/scheduling/INV_mul1_add4/INV_6.png"
	if(S.solution() != []):
