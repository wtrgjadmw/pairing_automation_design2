...
def solve():
	...
	S += (c_t3_t4_x03*ADD[0])-1 < c_t3_t40_mem0*ADD_mem[0]
	S += (c_t3_t4_x03*ADD[1])-1 < c_t3_t40_mem0*ADD_mem[1]
	S += (c_t3_t4_x03*ADD[2])-1 < c_t3_t40_mem0*ADD_mem[2]
	S += (c_t3_t4_x03*ADD[3])-1 < c_t3_t40_mem0*ADD_mem[3]
	...
	S += (c_t3_t40*ADD[0])-1 < c_t3_t50_mem1*ADD_mem[0]
	S += (c_t3_t40*ADD[1])-1 < c_t3_t50_mem1*ADD_mem[1]
	S += (c_t3_t40*ADD[2])-1 < c_t3_t50_mem1*ADD_mem[2]
	S += (c_t3_t40*ADD[3])-1 < c_t3_t50_mem1*ADD_mem[3]
	...
	S += (c_t0_t21*ADD[0])-1 < c_t001_mem0*ADD_mem[0]
	S += (c_t0_t21*ADD[1])-1 < c_t001_mem0*ADD_mem[1]
	S += (c_t0_t21*ADD[2])-1 < c_t001_mem0*ADD_mem[2]
	S += (c_t0_t21*ADD[3])-1 < c_t001_mem0*ADD_mem[3]
	S += c_t001_mem0 <= c_t001

	c_t001_mem1 = S.Task('c_t001_mem1', length=1, delay_cost=1)
	c_t001_mem1 += alt(ADD_mem)
	S += (c_t0_t51*ADD[0])-1 < c_t001_mem1*ADD_mem[0]
	S += (c_t0_t51*ADD[1])-1 < c_t001_mem1*ADD_mem[1]
	S += (c_t0_t51*ADD[2])-1 < c_t001_mem1*ADD_mem[2]
	S += (c_t0_t51*ADD[3])-1 < c_t001_mem1*ADD_mem[3]
	...
	S += (c_t1_t21*ADD[0])-1 < c_t101_mem0*ADD_mem[0]
	S += (c_t1_t21*ADD[1])-1 < c_t101_mem0*ADD_mem[1]
	S += (c_t1_t21*ADD[2])-1 < c_t101_mem0*ADD_mem[2]
	S += (c_t1_t21*ADD[3])-1 < c_t101_mem0*ADD_mem[3]
	S += c_t101_mem0 <= c_t101

	c_t101_mem1 = S.Task('c_t101_mem1', length=1, delay_cost=1)
	c_t101_mem1 += alt(ADD_mem)
	S += (c_t1_t51*ADD[0])-1 < c_t101_mem1*ADD_mem[0]
	S += (c_t1_t51*ADD[1])-1 < c_t101_mem1*ADD_mem[1]
	S += (c_t1_t51*ADD[2])-1 < c_t101_mem1*ADD_mem[2]
	S += (c_t1_t51*ADD[3])-1 < c_t101_mem1*ADD_mem[3]
	...
	S += (c_t2_t21*ADD[0])-1 < c_t201_mem0*ADD_mem[0]
	S += (c_t2_t21*ADD[1])-1 < c_t201_mem0*ADD_mem[1]
	S += (c_t2_t21*ADD[2])-1 < c_t201_mem0*ADD_mem[2]
	S += (c_t2_t21*ADD[3])-1 < c_t201_mem0*ADD_mem[3]
	S += c_t201_mem0 <= c_t201

	c_t201_mem1 = S.Task('c_t201_mem1', length=1, delay_cost=1)
	c_t201_mem1 += alt(ADD_mem)
	S += (c_t2_t51*ADD[0])-1 < c_t201_mem1*ADD_mem[0]
	S += (c_t2_t51*ADD[1])-1 < c_t201_mem1*ADD_mem[1]
	S += (c_t2_t51*ADD[2])-1 < c_t201_mem1*ADD_mem[2]
	S += (c_t2_t51*ADD[3])-1 < c_t201_mem1*ADD_mem[3]
	...
	S += (c_t3_t2_t4*MUL[0])-1 < c_t3_t21_mem0*MUL_mem[0]
	...
	S += (c_t3_t41*ADD[0])-1 < c_t3_t51_mem1*ADD_mem[0]
	S += (c_t3_t41*ADD[1])-1 < c_t3_t51_mem1*ADD_mem[1]
	S += (c_t3_t41*ADD[2])-1 < c_t3_t51_mem1*ADD_mem[2]
	S += (c_t3_t41*ADD[3])-1 < c_t3_t51_mem1*ADD_mem[3]
	...
	S += (c_t3_t20*ADD[0])-1 < c_t300_mem0*ADD_mem[0]
	S += (c_t3_t20*ADD[1])-1 < c_t300_mem0*ADD_mem[1]
	S += (c_t3_t20*ADD[2])-1 < c_t300_mem0*ADD_mem[2]
	S += (c_t3_t20*ADD[3])-1 < c_t300_mem0*ADD_mem[3]
	S += c_t300_mem0 <= c_t300

	c_t300_mem1 = S.Task('c_t300_mem1', length=1, delay_cost=1)
	c_t300_mem1 += alt(ADD_mem)
	S += (c_t3_t50*ADD[0])-1 < c_t300_mem1*ADD_mem[0]
	S += (c_t3_t50*ADD[1])-1 < c_t300_mem1*ADD_mem[1]
	S += (c_t3_t50*ADD[2])-1 < c_t300_mem1*ADD_mem[2]
	S += (c_t3_t50*ADD[3])-1 < c_t300_mem1*ADD_mem[3]
	...
	S += (c_t4_t2_t4*MUL[0])-1 < c_t4_t21_mem0*MUL_mem[0]
	S += c_t4_t21_mem0 <= c_t4_t21

	c_t4_t21_mem1 = S.Task('c_t4_t21_mem1', length=1, delay_cost=1)
	c_t4_t21_mem1 += alt(ADD_mem)
	S += (c_t4_t2_t5*ADD[0])-1 < c_t4_t21_mem1*ADD_mem[0]
	S += (c_t4_t2_t5*ADD[1])-1 < c_t4_t21_mem1*ADD_mem[1]
	S += (c_t4_t2_t5*ADD[2])-1 < c_t4_t21_mem1*ADD_mem[2]
	S += (c_t4_t2_t5*ADD[3])-1 < c_t4_t21_mem1*ADD_mem[3]
	...
	S += (c_t4_t41*ADD[0])-1 < c_t4_t51_mem1*ADD_mem[0]
	S += (c_t4_t41*ADD[1])-1 < c_t4_t51_mem1*ADD_mem[1]
	S += (c_t4_t41*ADD[2])-1 < c_t4_t51_mem1*ADD_mem[2]
	S += (c_t4_t41*ADD[3])-1 < c_t4_t51_mem1*ADD_mem[3]
	...
	S += (c_t4_t20*ADD[0])-1 < c_t400_mem0*ADD_mem[0]
	S += (c_t4_t20*ADD[1])-1 < c_t400_mem0*ADD_mem[1]
	S += (c_t4_t20*ADD[2])-1 < c_t400_mem0*ADD_mem[2]
	S += (c_t4_t20*ADD[3])-1 < c_t400_mem0*ADD_mem[3]
	S += c_t400_mem0 <= c_t400

	c_t400_mem1 = S.Task('c_t400_mem1', length=1, delay_cost=1)
	c_t400_mem1 += alt(ADD_mem)
	S += (c_t4_t50*ADD[0])-1 < c_t400_mem1*ADD_mem[0]
	S += (c_t4_t50*ADD[1])-1 < c_t400_mem1*ADD_mem[1]
	S += (c_t4_t50*ADD[2])-1 < c_t400_mem1*ADD_mem[2]
	S += (c_t4_t50*ADD[3])-1 < c_t400_mem1*ADD_mem[3]
	...
	S += (c_t5_t2_t4*MUL[0])-1 < c_t5_t21_mem0*MUL_mem[0]
	S += c_t5_t21_mem0 <= c_t5_t21

	c_t5_t21_mem1 = S.Task('c_t5_t21_mem1', length=1, delay_cost=1)
	c_t5_t21_mem1 += alt(ADD_mem)
	S += (c_t5_t2_t5*ADD[0])-1 < c_t5_t21_mem1*ADD_mem[0]
	S += (c_t5_t2_t5*ADD[1])-1 < c_t5_t21_mem1*ADD_mem[1]
	S += (c_t5_t2_t5*ADD[2])-1 < c_t5_t21_mem1*ADD_mem[2]
	S += (c_t5_t2_t5*ADD[3])-1 < c_t5_t21_mem1*ADD_mem[3]
	...
	S += (c_t5_t41*ADD[0])-1 < c_t5_t51_mem1*ADD_mem[0]
	S += (c_t5_t41*ADD[1])-1 < c_t5_t51_mem1*ADD_mem[1]
	S += (c_t5_t41*ADD[2])-1 < c_t5_t51_mem1*ADD_mem[2]
	S += (c_t5_t41*ADD[3])-1 < c_t5_t51_mem1*ADD_mem[3]
	...
	S += (c_t5_t20*ADD[0])-1 < c_t500_mem0*ADD_mem[0]
	S += (c_t5_t20*ADD[1])-1 < c_t500_mem0*ADD_mem[1]
	S += (c_t5_t20*ADD[2])-1 < c_t500_mem0*ADD_mem[2]
	S += (c_t5_t20*ADD[3])-1 < c_t500_mem0*ADD_mem[3]
	S += c_t500_mem0 <= c_t500

	c_t500_mem1 = S.Task('c_t500_mem1', length=1, delay_cost=1)
	c_t500_mem1 += alt(ADD_mem)
	S += (c_t5_t50*ADD[0])-1 < c_t500_mem1*ADD_mem[0]
	S += (c_t5_t50*ADD[1])-1 < c_t500_mem1*ADD_mem[1]
	S += (c_t5_t50*ADD[2])-1 < c_t500_mem1*ADD_mem[2]
	S += (c_t5_t50*ADD[3])-1 < c_t500_mem1*ADD_mem[3]
	...
	S += (c_t000*ADD[0])-1 < c_s0000_mem0*ADD_mem[0]
	S += (c_t000*ADD[1])-1 < c_s0000_mem0*ADD_mem[1]
	S += (c_t000*ADD[2])-1 < c_s0000_mem0*ADD_mem[2]
	S += (c_t000*ADD[3])-1 < c_s0000_mem0*ADD_mem[3]
	S += c_s0000_mem0 <= c_s0000

	c_s0000_mem1 = S.Task('c_s0000_mem1', length=1, delay_cost=1)
	c_s0000_mem1 += alt(ADD_mem)
	S += (c_t100*ADD[0])-1 < c_s0000_mem1*ADD_mem[0]
	S += (c_t100*ADD[1])-1 < c_s0000_mem1*ADD_mem[1]
	S += (c_t100*ADD[2])-1 < c_s0000_mem1*ADD_mem[2]
	S += (c_t100*ADD[3])-1 < c_s0000_mem1*ADD_mem[3]
	...
	S += (c_t100*ADD[0])-1 < c_s1000_mem0*ADD_mem[0]
	S += (c_t100*ADD[1])-1 < c_s1000_mem0*ADD_mem[1]
	S += (c_t100*ADD[2])-1 < c_s1000_mem0*ADD_mem[2]
	S += (c_t100*ADD[3])-1 < c_s1000_mem0*ADD_mem[3]
	S += c_s1000_mem0 <= c_s1000

	c_s1000_mem1 = S.Task('c_s1000_mem1', length=1, delay_cost=1)
	c_s1000_mem1 += alt(ADD_mem)
	S += (c_t200*ADD[0])-1 < c_s1000_mem1*ADD_mem[0]
	S += (c_t200*ADD[1])-1 < c_s1000_mem1*ADD_mem[1]
	S += (c_t200*ADD[2])-1 < c_s1000_mem1*ADD_mem[2]
	S += (c_t200*ADD[3])-1 < c_s1000_mem1*ADD_mem[3]
	...
	S += (c_t200*ADD[0])-1 < c_s2000_mem0*ADD_mem[0]
	S += (c_t200*ADD[1])-1 < c_s2000_mem0*ADD_mem[1]
	S += (c_t200*ADD[2])-1 < c_s2000_mem0*ADD_mem[2]
	S += (c_t200*ADD[3])-1 < c_s2000_mem0*ADD_mem[3]
	S += c_s2000_mem0 <= c_s2000

	c_s2000_mem1 = S.Task('c_s2000_mem1', length=1, delay_cost=1)
	c_s2000_mem1 += alt(ADD_mem)
	S += (c_t000*ADD[0])-1 < c_s2000_mem1*ADD_mem[0]
	S += (c_t000*ADD[1])-1 < c_s2000_mem1*ADD_mem[1]
	S += (c_t000*ADD[2])-1 < c_s2000_mem1*ADD_mem[2]
	S += (c_t000*ADD[3])-1 < c_s2000_mem1*ADD_mem[3]
	...
	S += (c_s1_y1__x12*ADD[0])-1 < c_s1_y1__x13_mem0*ADD_mem[0]
	S += (c_s1_y1__x12*ADD[1])-1 < c_s1_y1__x13_mem0*ADD_mem[1]
	S += (c_s1_y1__x12*ADD[2])-1 < c_s1_y1__x13_mem0*ADD_mem[2]
	S += (c_s1_y1__x12*ADD[3])-1 < c_s1_y1__x13_mem0*ADD_mem[3]
	...
	S += (c_s1_y1__x03*ADD[0])-1 < c_s1_y1_0_mem0*ADD_mem[0]
	S += (c_s1_y1__x03*ADD[1])-1 < c_s1_y1_0_mem0*ADD_mem[1]
	S += (c_s1_y1__x03*ADD[2])-1 < c_s1_y1_0_mem0*ADD_mem[2]
	S += (c_s1_y1__x03*ADD[3])-1 < c_s1_y1_0_mem0*ADD_mem[3]
	...
	S += (c_t3_t21*ADD[0])-1 < c_t301_mem0*ADD_mem[0]
	S += (c_t3_t21*ADD[1])-1 < c_t301_mem0*ADD_mem[1]
	S += (c_t3_t21*ADD[2])-1 < c_t301_mem0*ADD_mem[2]
	S += (c_t3_t21*ADD[3])-1 < c_t301_mem0*ADD_mem[3]
	S += c_t301_mem0 <= c_t301

	c_t301_mem1 = S.Task('c_t301_mem1', length=1, delay_cost=1)
	c_t301_mem1 += alt(ADD_mem)
	S += (c_t3_t51*ADD[0])-1 < c_t301_mem1*ADD_mem[0]
	S += (c_t3_t51*ADD[1])-1 < c_t301_mem1*ADD_mem[1]
	S += (c_t3_t51*ADD[2])-1 < c_t301_mem1*ADD_mem[2]
	S += (c_t3_t51*ADD[3])-1 < c_t301_mem1*ADD_mem[3]
	...
	S += (c_t4_t21*ADD[0])-1 < c_t401_mem0*ADD_mem[0]
	S += (c_t4_t21*ADD[1])-1 < c_t401_mem0*ADD_mem[1]
	S += (c_t4_t21*ADD[2])-1 < c_t401_mem0*ADD_mem[2]
	S += (c_t4_t21*ADD[3])-1 < c_t401_mem0*ADD_mem[3]
	S += c_t401_mem0 <= c_t401

	c_t401_mem1 = S.Task('c_t401_mem1', length=1, delay_cost=1)
	c_t401_mem1 += alt(ADD_mem)
	S += (c_t4_t51*ADD[0])-1 < c_t401_mem1*ADD_mem[0]
	S += (c_t4_t51*ADD[1])-1 < c_t401_mem1*ADD_mem[1]
	S += (c_t4_t51*ADD[2])-1 < c_t401_mem1*ADD_mem[2]
	S += (c_t4_t51*ADD[3])-1 < c_t401_mem1*ADD_mem[3]
	...
	S += (c_t5_t21*ADD[0])-1 < c_t501_mem0*ADD_mem[0]
	S += (c_t5_t21*ADD[1])-1 < c_t501_mem0*ADD_mem[1]
	S += (c_t5_t21*ADD[2])-1 < c_t501_mem0*ADD_mem[2]
	S += (c_t5_t21*ADD[3])-1 < c_t501_mem0*ADD_mem[3]
	...
	S += (c_t001*ADD[0])-1 < c_s0001_mem0*ADD_mem[0]
	S += (c_t001*ADD[1])-1 < c_s0001_mem0*ADD_mem[1]
	S += (c_t001*ADD[2])-1 < c_s0001_mem0*ADD_mem[2]
	S += (c_t001*ADD[3])-1 < c_s0001_mem0*ADD_mem[3]
	S += c_s0001_mem0 <= c_s0001

	c_s0001_mem1 = S.Task('c_s0001_mem1', length=1, delay_cost=1)
	c_s0001_mem1 += alt(ADD_mem)
	S += (c_t101*ADD[0])-1 < c_s0001_mem1*ADD_mem[0]
	S += (c_t101*ADD[1])-1 < c_s0001_mem1*ADD_mem[1]
	S += (c_t101*ADD[2])-1 < c_s0001_mem1*ADD_mem[2]
	S += (c_t101*ADD[3])-1 < c_s0001_mem1*ADD_mem[3]
	...
	S += (c_t300*ADD[0])-1 < c_s000_mem0*ADD_mem[0]
	S += (c_t300*ADD[1])-1 < c_s000_mem0*ADD_mem[1]
	S += (c_t300*ADD[2])-1 < c_s000_mem0*ADD_mem[2]
	S += (c_t300*ADD[3])-1 < c_s000_mem0*ADD_mem[3]
	S += c_s000_mem0 <= c_s000

	c_s000_mem1 = S.Task('c_s000_mem1', length=1, delay_cost=1)
	c_s000_mem1 += alt(ADD_mem)
	S += (c_s0000*ADD[0])-1 < c_s000_mem1*ADD_mem[0]
	S += (c_s0000*ADD[1])-1 < c_s000_mem1*ADD_mem[1]
	S += (c_s0000*ADD[2])-1 < c_s000_mem1*ADD_mem[2]
	S += (c_s0000*ADD[3])-1 < c_s000_mem1*ADD_mem[3]
	...
	S += (c_t101*ADD[0])-1 < c_s1001_mem0*ADD_mem[0]
	S += (c_t101*ADD[1])-1 < c_s1001_mem0*ADD_mem[1]
	S += (c_t101*ADD[2])-1 < c_s1001_mem0*ADD_mem[2]
	S += (c_t101*ADD[3])-1 < c_s1001_mem0*ADD_mem[3]
	S += c_s1001_mem0 <= c_s1001

	c_s1001_mem1 = S.Task('c_s1001_mem1', length=1, delay_cost=1)
	c_s1001_mem1 += alt(ADD_mem)
	S += (c_t201*ADD[0])-1 < c_s1001_mem1*ADD_mem[0]
	S += (c_t201*ADD[1])-1 < c_s1001_mem1*ADD_mem[1]
	S += (c_t201*ADD[2])-1 < c_s1001_mem1*ADD_mem[2]
	S += (c_t201*ADD[3])-1 < c_s1001_mem1*ADD_mem[3]
	...
	S += (c_t400*ADD[0])-1 < c_s1100_mem0*ADD_mem[0]
	S += (c_t400*ADD[1])-1 < c_s1100_mem0*ADD_mem[1]
	S += (c_t400*ADD[2])-1 < c_s1100_mem0*ADD_mem[2]
	S += (c_t400*ADD[3])-1 < c_s1100_mem0*ADD_mem[3]
	S += c_s1100_mem0 <= c_s1100

	c_s1100_mem1 = S.Task('c_s1100_mem1', length=1, delay_cost=1)
	c_s1100_mem1 += alt(ADD_mem)
	S += (c_s1000*ADD[0])-1 < c_s1100_mem1*ADD_mem[0]
	S += (c_s1000*ADD[1])-1 < c_s1100_mem1*ADD_mem[1]
	S += (c_s1000*ADD[2])-1 < c_s1100_mem1*ADD_mem[2]
	S += (c_s1000*ADD[3])-1 < c_s1100_mem1*ADD_mem[3]
	...
	S += (c_t201*ADD[0])-1 < c_s2001_mem0*ADD_mem[0]
	S += (c_t201*ADD[1])-1 < c_s2001_mem0*ADD_mem[1]
	S += (c_t201*ADD[2])-1 < c_s2001_mem0*ADD_mem[2]
	S += (c_t201*ADD[3])-1 < c_s2001_mem0*ADD_mem[3]
	S += c_s2001_mem0 <= c_s2001

	c_s2001_mem1 = S.Task('c_s2001_mem1', length=1, delay_cost=1)
	c_s2001_mem1 += alt(ADD_mem)
	S += (c_t001*ADD[0])-1 < c_s2001_mem1*ADD_mem[0]
	S += (c_t001*ADD[1])-1 < c_s2001_mem1*ADD_mem[1]
	S += (c_t001*ADD[2])-1 < c_s2001_mem1*ADD_mem[2]
	S += (c_t001*ADD[3])-1 < c_s2001_mem1*ADD_mem[3]
	...
	S += (c_t500*ADD[0])-1 < c_s200_mem0*ADD_mem[0]
	S += (c_t500*ADD[1])-1 < c_s200_mem0*ADD_mem[1]
	S += (c_t500*ADD[2])-1 < c_s200_mem0*ADD_mem[2]
	S += (c_t500*ADD[3])-1 < c_s200_mem0*ADD_mem[3]
	S += c_s200_mem0 <= c_s200

	c_s200_mem1 = S.Task('c_s200_mem1', length=1, delay_cost=1)
	c_s200_mem1 += alt(ADD_mem)
	S += (c_s2000*ADD[0])-1 < c_s200_mem1*ADD_mem[0]
	S += (c_s2000*ADD[1])-1 < c_s200_mem1*ADD_mem[1]
	S += (c_s2000*ADD[2])-1 < c_s200_mem1*ADD_mem[2]
	S += (c_s2000*ADD[3])-1 < c_s200_mem1*ADD_mem[3]
	...
	S += (c_s1_y1__x13*ADD[0])-1 < c_s1_y1_1_mem0*ADD_mem[0]
	S += (c_s1_y1__x13*ADD[1])-1 < c_s1_y1_1_mem0*ADD_mem[1]
	S += (c_s1_y1__x13*ADD[2])-1 < c_s1_y1_1_mem0*ADD_mem[2]
	S += (c_s1_y1__x13*ADD[3])-1 < c_s1_y1_1_mem0*ADD_mem[3]
	...
	S += (c_t301*ADD[0])-1 < c_s001_mem0*ADD_mem[0]
	S += (c_t301*ADD[1])-1 < c_s001_mem0*ADD_mem[1]
	S += (c_t301*ADD[2])-1 < c_s001_mem0*ADD_mem[2]
	S += (c_t301*ADD[3])-1 < c_s001_mem0*ADD_mem[3]
	S += c_s001_mem0 <= c_s001

	c_s001_mem1 = S.Task('c_s001_mem1', length=1, delay_cost=1)
	c_s001_mem1 += alt(ADD_mem)
	S += (c_s0001*ADD[0])-1 < c_s001_mem1*ADD_mem[0]
	S += (c_s0001*ADD[1])-1 < c_s001_mem1*ADD_mem[1]
	S += (c_s0001*ADD[2])-1 < c_s001_mem1*ADD_mem[2]
	S += (c_s0001*ADD[3])-1 < c_s001_mem1*ADD_mem[3]
	...
	S += (c_t401*ADD[0])-1 < c_s1101_mem0*ADD_mem[0]
	S += (c_t401*ADD[1])-1 < c_s1101_mem0*ADD_mem[1]
	S += (c_t401*ADD[2])-1 < c_s1101_mem0*ADD_mem[2]
	S += (c_t401*ADD[3])-1 < c_s1101_mem0*ADD_mem[3]
	S += c_s1101_mem0 <= c_s1101

	c_s1101_mem1 = S.Task('c_s1101_mem1', length=1, delay_cost=1)
	c_s1101_mem1 += alt(ADD_mem)
	S += (c_s1001*ADD[0])-1 < c_s1101_mem1*ADD_mem[0]
	S += (c_s1001*ADD[1])-1 < c_s1101_mem1*ADD_mem[1]
	S += (c_s1001*ADD[2])-1 < c_s1101_mem1*ADD_mem[2]
	S += (c_s1001*ADD[3])-1 < c_s1101_mem1*ADD_mem[3]
	...
	S += (c_s2001*ADD[0])-1 < c_s201_mem1*ADD_mem[0]
	S += (c_s2001*ADD[1])-1 < c_s201_mem1*ADD_mem[1]
	S += (c_s2001*ADD[2])-1 < c_s201_mem1*ADD_mem[2]
	S += (c_s2001*ADD[3])-1 < c_s201_mem1*ADD_mem[3]
	...
	S += (c_t200*ADD[0])-1 < c110_mem1*ADD_mem[0]
	S += (c_t200*ADD[1])-1 < c110_mem1*ADD_mem[1]
	S += (c_t200*ADD[2])-1 < c110_mem1*ADD_mem[2]
	S += (c_t200*ADD[3])-1 < c110_mem1*ADD_mem[3]
	S += c110_mem1 <= c110
	...
	S += (c_t000*ADD[0])-1 < c000_mem0*ADD_mem[0]
	S += (c_t000*ADD[1])-1 < c000_mem0*ADD_mem[1]
	S += (c_t000*ADD[2])-1 < c000_mem0*ADD_mem[2]
	S += (c_t000*ADD[3])-1 < c000_mem0*ADD_mem[3]
	S += c000_mem0 <= c000

	c000_mem1 = S.Task('c000_mem1', length=1, delay_cost=1)
	c000_mem1 += alt(ADD_mem)
	S += (c_s1_y1_0*ADD[0])-1 < c000_mem1*ADD_mem[0]
	S += (c_s1_y1_0*ADD[1])-1 < c000_mem1*ADD_mem[1]
	S += (c_s1_y1_0*ADD[2])-1 < c000_mem1*ADD_mem[2]
	S += (c_s1_y1_0*ADD[3])-1 < c000_mem1*ADD_mem[3]
	S += c000_mem1 <= c000
	...
	S += (c_t201*ADD[0])-1 < c111_mem1*ADD_mem[0]
	S += (c_t201*ADD[1])-1 < c111_mem1*ADD_mem[1]
	S += (c_t201*ADD[2])-1 < c111_mem1*ADD_mem[2]
	S += (c_t201*ADD[3])-1 < c111_mem1*ADD_mem[3]
	S += c111_mem1 <= c111
	...
	S += (c_t001*ADD[0])-1 < c001_mem0*ADD_mem[0]
	S += (c_t001*ADD[1])-1 < c001_mem0*ADD_mem[1]
	S += (c_t001*ADD[2])-1 < c001_mem0*ADD_mem[2]
	S += (c_t001*ADD[3])-1 < c001_mem0*ADD_mem[3]
	S += c001_mem0 <= c001

	c001_mem1 = S.Task('c001_mem1', length=1, delay_cost=1)
	c001_mem1 += alt(ADD_mem)
	S += (c_s1_y1_1*ADD[0])-1 < c001_mem1*ADD_mem[0]
	S += (c_s1_y1_1*ADD[1])-1 < c001_mem1*ADD_mem[1]
	S += (c_s1_y1_1*ADD[2])-1 < c001_mem1*ADD_mem[2]
	S += (c_s1_y1_1*ADD[3])-1 < c001_mem1*ADD_mem[3]
	S += c001_mem1 <= c001
	...
	S += (c_s000*ADD[0])-1 < c100_mem0*ADD_mem[0]
	S += (c_s000*ADD[1])-1 < c100_mem0*ADD_mem[1]
	S += (c_s000*ADD[2])-1 < c100_mem0*ADD_mem[2]
	S += (c_s000*ADD[3])-1 < c100_mem0*ADD_mem[3]
	S += c100_mem0 <= c100
	...
	S += (c_t100*ADD[0])-1 < c200_mem0*ADD_mem[0]
	S += (c_t100*ADD[1])-1 < c200_mem0*ADD_mem[1]
	S += (c_t100*ADD[2])-1 < c200_mem0*ADD_mem[2]
	S += (c_t100*ADD[3])-1 < c200_mem0*ADD_mem[3]
	S += c200_mem0 <= c200

	c200_mem1 = S.Task('c200_mem1', length=1, delay_cost=1)
	c200_mem1 += alt(ADD_mem)
	S += (c_s200*ADD[0])-1 < c200_mem1*ADD_mem[0]
	S += (c_s200*ADD[1])-1 < c200_mem1*ADD_mem[1]
	S += (c_s200*ADD[2])-1 < c200_mem1*ADD_mem[2]
	S += (c_s200*ADD[3])-1 < c200_mem1*ADD_mem[3]
	S += c200_mem1 <= c200
	...
	S += (c_s1101*ADD[0])-1 < c011_mem1*ADD_mem[0]
	S += (c_s1101*ADD[1])-1 < c011_mem1*ADD_mem[1]
	S += (c_s1101*ADD[2])-1 < c011_mem1*ADD_mem[2]
	S += (c_s1101*ADD[3])-1 < c011_mem1*ADD_mem[3]
	S += c011_mem1 <= c011
	...
	S += (c_s001*ADD[0])-1 < c101_mem0*ADD_mem[0]
	S += (c_s001*ADD[1])-1 < c101_mem0*ADD_mem[1]
	S += (c_s001*ADD[2])-1 < c101_mem0*ADD_mem[2]
	S += (c_s001*ADD[3])-1 < c101_mem0*ADD_mem[3]
	S += c101_mem0 <= c101

	c101_mem1 = S.Task('c101_mem1', length=1, delay_cost=1)
	c101_mem1 += alt(ADD_mem)
	S += (c_t6_y1_1*ADD[0])-1 < c101_mem1*ADD_mem[0]
	S += (c_t6_y1_1*ADD[1])-1 < c101_mem1*ADD_mem[1]
	S += (c_t6_y1_1*ADD[2])-1 < c101_mem1*ADD_mem[2]
	S += (c_t6_y1_1*ADD[3])-1 < c101_mem1*ADD_mem[3]
	S += c101_mem1 <= c101
	...
	S += (c_t101*ADD[0])-1 < c201_mem0*ADD_mem[0]
	S += (c_t101*ADD[1])-1 < c201_mem0*ADD_mem[1]
	S += (c_t101*ADD[2])-1 < c201_mem0*ADD_mem[2]
	S += (c_t101*ADD[3])-1 < c201_mem0*ADD_mem[3]
	S += c201_mem0 <= c201
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-1150/scheduling/SQR_mul1_add4/SQR_6.png"
	if(S.solution() != []):
