...
def solve():
	...
	S += (c10_t4*MUL[0])-1 < c101_mem0*MUL_mem[0]
	S += c101_mem0 <= c101

	c101_mem1 = S.Task('c101_mem1', length=1, delay_cost=1)
	c101_mem1 += alt(ADD_mem)
	S += (c10_t5*ADD[0])-1 < c101_mem1*ADD_mem[0]
	S += (c10_t5*ADD[1])-1 < c101_mem1*ADD_mem[1]
	S += (c10_t5*ADD[2])-1 < c101_mem1*ADD_mem[2]
	S += (c10_t5*ADD[3])-1 < c101_mem1*ADD_mem[3]
	S += c101_mem1 <= c101
	...
	S += (c20_t5*ADD[0])-1 < c201_mem1*ADD_mem[0]
	S += (c20_t5*ADD[1])-1 < c201_mem1*ADD_mem[1]
	S += (c20_t5*ADD[2])-1 < c201_mem1*ADD_mem[2]
	S += (c20_t5*ADD[3])-1 < c201_mem1*ADD_mem[3]
	S += c201_mem1 <= c201
	...
	S += (c01_t4*MUL[0])-1 < c011_mem0*MUL_mem[0]
	S += c011_mem0 <= c011

	c011_mem1 = S.Task('c011_mem1', length=1, delay_cost=1)
	c011_mem1 += alt(ADD_mem)
	S += (c01_t5*ADD[0])-1 < c011_mem1*ADD_mem[0]
	S += (c01_t5*ADD[1])-1 < c011_mem1*ADD_mem[1]
	S += (c01_t5*ADD[2])-1 < c011_mem1*ADD_mem[2]
	S += (c01_t5*ADD[3])-1 < c011_mem1*ADD_mem[3]
	S += c011_mem1 <= c011
	...
	S += (c11_t5*ADD[0])-1 < c111_mem1*ADD_mem[0]
	S += (c11_t5*ADD[1])-1 < c111_mem1*ADD_mem[1]
	S += (c11_t5*ADD[2])-1 < c111_mem1*ADD_mem[2]
	S += (c11_t5*ADD[3])-1 < c111_mem1*ADD_mem[3]
	S += c111_mem1 <= c111
	...
	S += (c21_t4*MUL[0])-1 < c211_mem0*MUL_mem[0]
	S += c211_mem0 <= c211

	c211_mem1 = S.Task('c211_mem1', length=1, delay_cost=1)
	c211_mem1 += alt(ADD_mem)
	S += (c21_t5*ADD[0])-1 < c211_mem1*ADD_mem[0]
	S += (c21_t5*ADD[1])-1 < c211_mem1*ADD_mem[1]
	S += (c21_t5*ADD[2])-1 < c211_mem1*ADD_mem[2]
	S += (c21_t5*ADD[3])-1 < c211_mem1*ADD_mem[3]
	S += c211_mem1 <= c211
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-1150/scheduling/FROB_mul1_add4/FROB_1.png"
	if(S.solution() != []):
