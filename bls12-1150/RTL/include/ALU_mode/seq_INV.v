...
19: begin
	...
	mm0_opr1 <= add0_out_reg; mm0_opr2 <= add3_out; 
...
56: begin
	...
	add2_opr1 <= ram_add2_out1; add2_opr2 <= add2_out_reg; issub2 <= 1;
	add1_opr1 <= add1_out; add1_opr2 <= add1_out; issub1 <= 0;
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
...
57: begin
	add3_opr1 <= add3_out; add3_opr2 <= ram_add1_out1; issub3 <= 1;
...
59: begin
	...
	add2_opr1 <= add1_out; add2_opr2 <= ram_add2_out2; issub2 <= 0;
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_input_out2; issub3 <= 0;
	ram_add1_wr_n <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 1;
...
64: begin
	add1_opr1 <= add3_out; add1_opr2 <= add1_out_reg; issub1 <= 1;
	add3_opr1 <= add2_out; add3_opr2 <= add2_out; issub3 <= 0;
...
70: begin
	add1_opr1 <= ram_add2_out1; add1_opr2 <= ram_input_out1; issub1 <= 0;
	add2_opr1 <= ram_add1_out1; add2_opr2 <= ram_input_out2; issub2 <= 0;
...
71: begin
	...
	add1_opr1 <= add1_out; add1_opr2 <= add1_out; issub1 <= 0;
	add0_opr1 <= add2_out; add0_opr2 <= add2_out; issub0 <= 0;
	add3_opr1 <= ram_add3_out1; add3_opr2 <= ram_input_out2; issub3 <= 0;
	ram_add2_wr_n <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 2;
	ram_add0_wr_n <= 0;
...
72: begin
	...
	add3_opr1 <= ram_add0_out2; add3_opr2 <= ram_input_out2; issub3 <= 0;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
	ram_add3_wr_n <= 1;
	ram_add0_wr_n <= 1;
...
73: begin
	add0_opr1 <= add0_out_reg; add0_opr2 <= ram_input_out1; issub0 <= 1;
...
74: begin
	add0_opr1 <= add2_out_reg; add0_opr2 <= ram_input_out1; issub0 <= 1;
	add3_opr1 <= ram_add1_out1; add3_opr2 <= ram_add2_out1; issub3 <= 0;
	add1_opr1 <= add1_out_reg; add1_opr2 <= ram_input_out2; issub1 <= 0;
...
75: begin
	add3_opr1 <= ram_add1_out1; add3_opr2 <= ram_input_out1; issub3 <= 0;
...
76: begin
	add2_opr1 <= ram_input_out1; add2_opr2 <= add0_out_reg; issub2 <= 0;
...
77: begin
	...
	add3_opr1 <= ram_add3_out1; add3_opr2 <= ram_input_out1; issub3 <= 1;
	add1_opr1 <= ram_add1_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
	ram_add3_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
	ram_add1_wr_n <= 0;
...
78: begin
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_add3_out1; issub0 <= 0;
	...
	add3_opr1 <= ram_input_out2; add3_opr2 <= add1_out; issub3 <= 0;
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 1;
	ram_add0_wr_n <= 1;
	ram_add2_waddr <= 1;
...
79: begin
	...
	add2_opr1 <= ram_input_out1; add2_opr2 <= add3_out_reg; issub2 <= 0;
	ram_add2_wr_n <= 0;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_add2_waddr <= 2;
...
90: begin
	...
	add3_opr1 <= add0_out; add3_opr2 <= ram_add1_out2; issub3 <= 0;
...
100: begin
	...
	mm0_opr1 <= ram_add2_out2; mm0_opr2 <= ram_input_out1; 
...
115: begin
	add0_opr1 <= ram_add2_out1; add0_opr2 <= ram_add2_out1; issub0 <= 0;
	add1_opr1 <= ram_add1_out1; add1_opr2 <= add3_out; issub1 <= 0;
	add2_opr1 <= add0_out; add2_opr2 <= ram_add0_out1; issub2 <= 1;
	add3_opr1 <= mm0_out_reg; add3_opr2 <= ram_mm0_out1; issub3 <= 0;
	ram_add3_wr_n <= 1;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
...
121: begin
	add2_opr1 <= add2_out; add2_opr2 <= add1_out; issub2 <= 0;
...
122: begin
	add2_opr1 <= add0_out_reg; add2_opr2 <= add2_out; issub2 <= 1;
	add0_opr1 <= add2_out; add0_opr2 <= add2_out; issub0 <= 0;
...
123: begin
	...
	mm0_opr1 <= add1_out; mm0_opr2 <= add3_out_reg; 
	ram_add2_wr_n <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 6;
	ram_add2_raddr1 <= 4;
...
133: begin
	add2_opr1 <= add3_out; add2_opr2 <= ram_add0_out1; issub2 <= 1;
...
148: begin
	if (inv_comp == 1) begin
	mm0_opr1 <= ram_add2_out1; mm0_opr2 <= inv_out; 
	ram_add1_raddr1 <= 6;
	state <= state + 1;
	end
end
...
167: begin
	add3_opr1 <= add2_out_reg; add3_opr2 <= ram_add1_out1; issub3 <= 1;
	add2_opr1 <= add2_out_reg; add2_opr2 <= ram_add1_out2; issub2 <= 1;
...
171: begin
	...
	add3_opr1 <= ram_add0_out2; add3_opr2 <= ram_add3_out2; issub3 <= 1;
	ram_add2_wr_n <= 1;
	ram_add1_wr_n <= 0;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 1;
