...
27: begin
	...
	mm0_opr1 <= add2_out_reg; mm0_opr2 <= add1_out_reg; 
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 0;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 1;
...
38: begin
	...
	add3_opr1 <= ram_add1_out2; add3_opr2 <= ram_input_out2; issub3 <= 0;
	ram_add2_wr_n <= 0;
	ram_mm0_wr_n <= 0;
	ram_add0_wr_n <= 0;
	ram_add2_waddr <= 2;
...
41: begin
	...
	add1_opr1 <= add1_out_reg; add1_opr2 <= add3_out_reg; issub1 <= 1;
...
42: begin
	...
	add3_opr1 <= add3_out_reg; add3_opr2 <= add3_out_reg; issub3 <= 0;
	add1_opr1 <= ram_input_out1; add1_opr2 <= add1_out_reg; issub1 <= 0;
