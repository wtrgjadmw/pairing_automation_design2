...
19: begin
	...
	add2_opr1 <= ram_input_out2; add2_opr2 <= add3_out; issub2 <= 1;
	ram_add0_raddr1 <= 2;
	ram_add1_raddr1 <= 0;
	ram_add1_raddr2 <= 0;
	state <= state + 1;
...
21: begin
	...
	add3_opr1 <= ram_input_out2; add3_opr2 <= add0_out; issub3 <= 1;
...
29: begin
	...
	add0_opr1 <= mm0_out; add0_opr2 <= add3_out_reg; issub0 <= 1;
	ram_add1_wr_n <= 1;
	ram_mm0_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
...
44: begin
	...
	add2_opr1 <= add1_out; add2_opr2 <= ram_add2_out2; issub2 <= 1;
...
58: begin
	add1_opr1 <= mm0_out; add1_opr2 <= ram_mm0_out1; issub1 <= 1;
	add2_opr1 <= add0_out; add2_opr2 <= add3_out; issub2 <= 0;
	ram_mm0_raddr1 <= 0;
	ram_input_raddr1 <= `RAM_ZERO;
	w1_n_reg <= 0;
	waddr1_reg <= `RAM_TX0;
...
59: begin
	add1_opr1 <= mm0_out_reg; add1_opr2 <= ram_mm0_out1; issub1 <= 0;
	add2_opr1 <= ram_input_out1; add2_opr2 <= add2_out; issub2 <= 1;
	ram_add3_raddr1 <= 0;
	w1_n_reg <= 0;
	waddr1_reg <= `RAM_TY1;
	wdata_s1 <= `ADD2;
