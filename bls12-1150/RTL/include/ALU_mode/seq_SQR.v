...
40: begin
	...
	add1_opr1 <= ram_add3_out1; add1_opr2 <= ram_input_out2; issub1 <= 1;
...
47: begin
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_add1_out1; issub0 <= 0;
...
48: begin
	...
	add1_opr1 <= add0_out_reg; add1_opr2 <= ram_input_out2; issub1 <= 1;
...
49: begin
	...
	add2_opr1 <= ram_add0_out2; add2_opr2 <= ram_input_out1; issub2 <= 0;
	add3_opr1 <= ram_input_out2; add3_opr2 <= ram_add1_out1; issub3 <= 0;
...
72: begin
	...
	add3_opr1 <= ram_add0_out2; add3_opr2 <= add3_out_reg; issub3 <= 1;
	add2_opr1 <= mm0_out_reg; add2_opr2 <= ram_mm0_out1; issub2 <= 1;
...
78: begin
	...
	add1_opr1 <= add3_out_reg; add1_opr2 <= add1_out_reg; issub1 <= 1;
...
82: begin
	...
	add3_opr1 <= add2_out_reg; add3_opr2 <= ram_add0_out2; issub3 <= 1;
	ram_add0_wr_n <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_add1_wr_n <= 0;
...
85: begin
	...
	add1_opr1 <= add2_out_reg; add1_opr2 <= add0_out_reg; issub1 <= 1;
	add3_opr1 <= ram_add1_out1; add3_opr2 <= ram_add2_out1; issub3 <= 0;
	ram_add1_raddr1 <= 0;
	ram_add2_raddr1 <= 6;
	state <= state + 1;
...
86: begin
	...
	add1_opr1 <= add3_out_reg; add1_opr2 <= add0_out_reg; issub1 <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_add2_raddr1 <= 2;
	w1_n_reg <= 0;
