...
def solve():
	...
	S += 53 < new_TX_t0_t4_mem0
	S += new_TX_t0_t4_mem0 <= new_TX_t0_t4

	new_TX_t0_t4_mem1 = S.Task('new_TX_t0_t4_mem1', length=1, delay_cost=1)
	new_TX_t0_t4_mem1 += alt(ADD_mem)
	S += (new_TX_t0_t3*ADD[0])-1 < new_TX_t0_t4_mem1*ADD_mem[0]
	S += (new_TX_t0_t3*ADD[1])-1 < new_TX_t0_t4_mem1*ADD_mem[1]
	S += (new_TX_t0_t3*ADD[2])-1 < new_TX_t0_t4_mem1*ADD_mem[2]
	S += (new_TX_t0_t3*ADD[3])-1 < new_TX_t0_t4_mem1*ADD_mem[3]
	...
	S += (t1111*ADD[0])-1 < new_TX_t1_t3_mem1*ADD_mem[0]
	S += (t1111*ADD[1])-1 < new_TX_t1_t3_mem1*ADD_mem[1]
	S += (t1111*ADD[2])-1 < new_TX_t1_t3_mem1*ADD_mem[2]
	S += (t1111*ADD[3])-1 < new_TX_t1_t3_mem1*ADD_mem[3]
	...
	S += (new_TX_t30*ADD[0])-1 < new_TX_t4_t0_mem1*ADD_mem[0]
	S += (new_TX_t30*ADD[1])-1 < new_TX_t4_t0_mem1*ADD_mem[1]
	S += (new_TX_t30*ADD[2])-1 < new_TX_t4_t0_mem1*ADD_mem[2]
	S += (new_TX_t30*ADD[3])-1 < new_TX_t4_t0_mem1*ADD_mem[3]
	...
	S += 111 < t13_t0_t3_mem0
	S += t13_t0_t3_mem0 <= t13_t0_t3

	t13_t0_t3_mem1 = S.Task('t13_t0_t3_mem1', length=1, delay_cost=1)
	t13_t0_t3_mem1 += alt(ADD_mem)
	S += (t1201*ADD[0])-1 < t13_t0_t3_mem1*ADD_mem[0]
	S += (t1201*ADD[1])-1 < t13_t0_t3_mem1*ADD_mem[1]
	S += (t1201*ADD[2])-1 < t13_t0_t3_mem1*ADD_mem[2]
	S += (t1201*ADD[3])-1 < t13_t0_t3_mem1*ADD_mem[3]
	...
	S += (t1210*ADD[0])-1 < t13_t1_t0_mem1*ADD_mem[0]
	S += (t1210*ADD[1])-1 < t13_t1_t0_mem1*ADD_mem[1]
	S += (t1210*ADD[2])-1 < t13_t1_t0_mem1*ADD_mem[2]
	S += (t1210*ADD[3])-1 < t13_t1_t0_mem1*ADD_mem[3]
	...
	S += (t1210*ADD[0])-1 < t13_t30_mem1*ADD_mem[0]
	S += (t1210*ADD[1])-1 < t13_t30_mem1*ADD_mem[1]
	S += (t1210*ADD[2])-1 < t13_t30_mem1*ADD_mem[2]
	S += (t1210*ADD[3])-1 < t13_t30_mem1*ADD_mem[3]
	...
	t14_t11_mem0 += alt(MUL_mem)
	S += (t14_t1_t4*MUL[0])-1 < t14_t11_mem0*MUL_mem[0]
	S += t14_t11_mem0 <= t14_t11

	t14_t11_mem1 = S.Task('t14_t11_mem1', length=1, delay_cost=1)
	t14_t11_mem1 += alt(ADD_mem)
	S += (t14_t1_t5*ADD[0])-1 < t14_t11_mem1*ADD_mem[0]
	S += (t14_t1_t5*ADD[1])-1 < t14_t11_mem1*ADD_mem[1]
	S += (t14_t1_t5*ADD[2])-1 < t14_t11_mem1*ADD_mem[2]
	S += (t14_t1_t5*ADD[3])-1 < t14_t11_mem1*ADD_mem[3]
	...
	t14_t4_t4_mem1 += alt(ADD_mem)
	S += (t14_t4_t3*ADD[0])-1 < t14_t4_t4_mem1*ADD_mem[0]
	S += (t14_t4_t3*ADD[1])-1 < t14_t4_t4_mem1*ADD_mem[1]
	S += (t14_t4_t3*ADD[2])-1 < t14_t4_t4_mem1*ADD_mem[2]
	S += (t14_t4_t3*ADD[3])-1 < t14_t4_t4_mem1*ADD_mem[3]
	...
	t14_t40_mem1 += alt(MUL_mem)
	S += (t14_t4_t1*MUL[0])-1 < t14_t40_mem1*MUL_mem[0]
	...
	S += 128 < t14_t4_t5_mem0
	S += t14_t4_t5_mem0 <= t14_t4_t5

	t14_t4_t5_mem1 = S.Task('t14_t4_t5_mem1', length=1, delay_cost=1)
	t14_t4_t5_mem1 += alt(MUL_mem)
	S += (t14_t4_t1*MUL[0])-1 < t14_t4_t5_mem1*MUL_mem[0]
	...
	new_TZ_t11_mem0 += alt(MUL_mem)
	S += (new_TZ_t1_t4*MUL[0])-1 < new_TZ_t11_mem0*MUL_mem[0]
	S += new_TZ_t11_mem0 <= new_TZ_t11

	new_TZ_t11_mem1 = S.Task('new_TZ_t11_mem1', length=1, delay_cost=1)
	new_TZ_t11_mem1 += alt(ADD_mem)
	S += (new_TZ_t1_t5*ADD[0])-1 < new_TZ_t11_mem1*ADD_mem[0]
	S += (new_TZ_t1_t5*ADD[1])-1 < new_TZ_t11_mem1*ADD_mem[1]
	S += (new_TZ_t1_t5*ADD[2])-1 < new_TZ_t11_mem1*ADD_mem[2]
	S += (new_TZ_t1_t5*ADD[3])-1 < new_TZ_t11_mem1*ADD_mem[3]
	...
	new_TZ_t4_t4_mem1 += alt(ADD_mem)
	S += (new_TZ_t4_t3*ADD[0])-1 < new_TZ_t4_t4_mem1*ADD_mem[0]
	S += (new_TZ_t4_t3*ADD[1])-1 < new_TZ_t4_t4_mem1*ADD_mem[1]
	S += (new_TZ_t4_t3*ADD[2])-1 < new_TZ_t4_t4_mem1*ADD_mem[2]
	S += (new_TZ_t4_t3*ADD[3])-1 < new_TZ_t4_t4_mem1*ADD_mem[3]
	...
	S += 131 < new_TZ_t40_mem0
	S += new_TZ_t40_mem0 <= new_TZ_t40

	new_TZ_t40_mem1 = S.Task('new_TZ_t40_mem1', length=1, delay_cost=1)
	new_TZ_t40_mem1 += alt(MUL_mem)
	S += (new_TZ_t4_t1*MUL[0])-1 < new_TZ_t40_mem1*MUL_mem[0]
	...
	S += 131 < new_TZ_t4_t5_mem0
	S += new_TZ_t4_t5_mem0 <= new_TZ_t4_t5

	new_TZ_t4_t5_mem1 = S.Task('new_TZ_t4_t5_mem1', length=1, delay_cost=1)
	new_TZ_t4_t5_mem1 += alt(MUL_mem)
	S += (new_TZ_t4_t1*MUL[0])-1 < new_TZ_t4_t5_mem1*MUL_mem[0]
	...
	S += (new_TX_t1_t3*ADD[0])-1 < new_TX_t1_t4_mem1*ADD_mem[0]
	S += (new_TX_t1_t3*ADD[1])-1 < new_TX_t1_t4_mem1*ADD_mem[1]
	S += (new_TX_t1_t3*ADD[2])-1 < new_TX_t1_t4_mem1*ADD_mem[2]
	S += (new_TX_t1_t3*ADD[3])-1 < new_TX_t1_t4_mem1*ADD_mem[3]
	...
	S += (new_TX_t31*ADD[0])-1 < new_TX_t4_t3_mem1*ADD_mem[0]
	S += (new_TX_t31*ADD[1])-1 < new_TX_t4_t3_mem1*ADD_mem[1]
	S += (new_TX_t31*ADD[2])-1 < new_TX_t4_t3_mem1*ADD_mem[2]
	S += (new_TX_t31*ADD[3])-1 < new_TX_t4_t3_mem1*ADD_mem[3]
	...
	S += (t13_t0_t3*ADD[0])-1 < t13_t0_t4_mem1*ADD_mem[0]
	S += (t13_t0_t3*ADD[1])-1 < t13_t0_t4_mem1*ADD_mem[1]
	S += (t13_t0_t3*ADD[2])-1 < t13_t0_t4_mem1*ADD_mem[2]
	S += (t13_t0_t3*ADD[3])-1 < t13_t0_t4_mem1*ADD_mem[3]
	...
	t13_t00_mem0 += alt(MUL_mem)
	S += (t13_t0_t0*MUL[0])-1 < t13_t00_mem0*MUL_mem[0]
	S += t13_t00_mem0 <= t13_t00

	t13_t00_mem1 = S.Task('t13_t00_mem1', length=1, delay_cost=1)
	t13_t00_mem1 += alt(MUL_mem)
	S += (t13_t0_t1*MUL[0])-1 < t13_t00_mem1*MUL_mem[0]
	...
	S += (t13_t0_t0*MUL[0])-1 < t13_t0_t5_mem0*MUL_mem[0]
	S += t13_t0_t5_mem0 <= t13_t0_t5

	t13_t0_t5_mem1 = S.Task('t13_t0_t5_mem1', length=1, delay_cost=1)
	t13_t0_t5_mem1 += alt(MUL_mem)
	S += (t13_t0_t1*MUL[0])-1 < t13_t0_t5_mem1*MUL_mem[0]
	...
	S += (t1210*ADD[0])-1 < t13_t1_t3_mem0*ADD_mem[0]
	S += (t1210*ADD[1])-1 < t13_t1_t3_mem0*ADD_mem[1]
	S += (t1210*ADD[2])-1 < t13_t1_t3_mem0*ADD_mem[2]
	S += (t1210*ADD[3])-1 < t13_t1_t3_mem0*ADD_mem[3]
	S += t13_t1_t3_mem0 <= t13_t1_t3

	t13_t1_t3_mem1 = S.Task('t13_t1_t3_mem1', length=1, delay_cost=1)
	t13_t1_t3_mem1 += alt(ADD_mem)
	S += (t1211*ADD[0])-1 < t13_t1_t3_mem1*ADD_mem[0]
	S += (t1211*ADD[1])-1 < t13_t1_t3_mem1*ADD_mem[1]
	S += (t1211*ADD[2])-1 < t13_t1_t3_mem1*ADD_mem[2]
	S += (t1211*ADD[3])-1 < t13_t1_t3_mem1*ADD_mem[3]
	...
	t13_t4_t0_mem1 += alt(ADD_mem)
	S += (t13_t30*ADD[0])-1 < t13_t4_t0_mem1*ADD_mem[0]
	S += (t13_t30*ADD[1])-1 < t13_t4_t0_mem1*ADD_mem[1]
	S += (t13_t30*ADD[2])-1 < t13_t4_t0_mem1*ADD_mem[2]
	S += (t13_t30*ADD[3])-1 < t13_t4_t0_mem1*ADD_mem[3]
	...
	S += (t14_t4_t4*MUL[0])-1 < t14_t41_mem0*MUL_mem[0]
	S += t14_t41_mem0 <= t14_t41

	t14_t41_mem1 = S.Task('t14_t41_mem1', length=1, delay_cost=1)
	t14_t41_mem1 += alt(ADD_mem)
	S += (t14_t4_t5*ADD[0])-1 < t14_t41_mem1*ADD_mem[0]
	S += (t14_t4_t5*ADD[1])-1 < t14_t41_mem1*ADD_mem[1]
	S += (t14_t4_t5*ADD[2])-1 < t14_t41_mem1*ADD_mem[2]
	S += (t14_t4_t5*ADD[3])-1 < t14_t41_mem1*ADD_mem[3]
	...
	t14_s00_mem0 += alt(ADD_mem)
	S += (t14_t10*ADD[0])-1 < t14_s00_mem0*ADD_mem[0]
	S += (t14_t10*ADD[1])-1 < t14_s00_mem0*ADD_mem[1]
	S += (t14_t10*ADD[2])-1 < t14_s00_mem0*ADD_mem[2]
	S += (t14_t10*ADD[3])-1 < t14_s00_mem0*ADD_mem[3]
	S += t14_s00_mem0 <= t14_s00

	t14_s00_mem1 = S.Task('t14_s00_mem1', length=1, delay_cost=1)
	t14_s00_mem1 += alt(ADD_mem)
	S += (t14_t11*ADD[0])-1 < t14_s00_mem1*ADD_mem[0]
	S += (t14_t11*ADD[1])-1 < t14_s00_mem1*ADD_mem[1]
	S += (t14_t11*ADD[2])-1 < t14_s00_mem1*ADD_mem[2]
	S += (t14_t11*ADD[3])-1 < t14_s00_mem1*ADD_mem[3]
	S += t14_s00_mem1 <= t14_s00

	t14_s01 = S.Task('t14_s01', length=1, delay_cost=1)
	t14_s01 += alt(ADD)

	t14_s01_mem0 = S.Task('t14_s01_mem0', length=1, delay_cost=1)
	t14_s01_mem0 += alt(ADD_mem)
	S += (t14_t11*ADD[0])-1 < t14_s01_mem0*ADD_mem[0]
	S += (t14_t11*ADD[1])-1 < t14_s01_mem0*ADD_mem[1]
	S += (t14_t11*ADD[2])-1 < t14_s01_mem0*ADD_mem[2]
	S += (t14_t11*ADD[3])-1 < t14_s01_mem0*ADD_mem[3]
	S += t14_s01_mem0 <= t14_s01

	t14_s01_mem1 = S.Task('t14_s01_mem1', length=1, delay_cost=1)
	t14_s01_mem1 += alt(ADD_mem)
	S += (t14_t10*ADD[0])-1 < t14_s01_mem1*ADD_mem[0]
	S += (t14_t10*ADD[1])-1 < t14_s01_mem1*ADD_mem[1]
	S += (t14_t10*ADD[2])-1 < t14_s01_mem1*ADD_mem[2]
	S += (t14_t10*ADD[3])-1 < t14_s01_mem1*ADD_mem[3]
	S += t14_s01_mem1 <= t14_s01

	t14_t51 = S.Task('t14_t51', length=1, delay_cost=1)
	t14_t51 += alt(ADD)

	t14_t51_mem0 = S.Task('t14_t51_mem0', length=1, delay_cost=1)
	t14_t51_mem0 += alt(ADD_mem)
	S += (t14_t01*ADD[0])-1 < t14_t51_mem0*ADD_mem[0]
	S += (t14_t01*ADD[1])-1 < t14_t51_mem0*ADD_mem[1]
	S += (t14_t01*ADD[2])-1 < t14_t51_mem0*ADD_mem[2]
	S += (t14_t01*ADD[3])-1 < t14_t51_mem0*ADD_mem[3]
	S += t14_t51_mem0 <= t14_t51

	t14_t51_mem1 = S.Task('t14_t51_mem1', length=1, delay_cost=1)
	t14_t51_mem1 += alt(ADD_mem)
	S += (t14_t11*ADD[0])-1 < t14_t51_mem1*ADD_mem[0]
	S += (t14_t11*ADD[1])-1 < t14_t51_mem1*ADD_mem[1]
	S += (t14_t11*ADD[2])-1 < t14_t51_mem1*ADD_mem[2]
	S += (t14_t11*ADD[3])-1 < t14_t51_mem1*ADD_mem[3]
	...
	S += (new_TZ_t4_t4*MUL[0])-1 < new_TZ_t41_mem0*MUL_mem[0]
	S += new_TZ_t41_mem0 <= new_TZ_t41

	new_TZ_t41_mem1 = S.Task('new_TZ_t41_mem1', length=1, delay_cost=1)
	new_TZ_t41_mem1 += alt(ADD_mem)
	S += (new_TZ_t4_t5*ADD[0])-1 < new_TZ_t41_mem1*ADD_mem[0]
	S += (new_TZ_t4_t5*ADD[1])-1 < new_TZ_t41_mem1*ADD_mem[1]
	S += (new_TZ_t4_t5*ADD[2])-1 < new_TZ_t41_mem1*ADD_mem[2]
	S += (new_TZ_t4_t5*ADD[3])-1 < new_TZ_t41_mem1*ADD_mem[3]
	...
	new_TZ_s00_mem0 += alt(ADD_mem)
	S += (new_TZ_t10*ADD[0])-1 < new_TZ_s00_mem0*ADD_mem[0]
	S += (new_TZ_t10*ADD[1])-1 < new_TZ_s00_mem0*ADD_mem[1]
	S += (new_TZ_t10*ADD[2])-1 < new_TZ_s00_mem0*ADD_mem[2]
	S += (new_TZ_t10*ADD[3])-1 < new_TZ_s00_mem0*ADD_mem[3]
	S += new_TZ_s00_mem0 <= new_TZ_s00

	new_TZ_s00_mem1 = S.Task('new_TZ_s00_mem1', length=1, delay_cost=1)
	new_TZ_s00_mem1 += alt(ADD_mem)
	S += (new_TZ_t11*ADD[0])-1 < new_TZ_s00_mem1*ADD_mem[0]
	S += (new_TZ_t11*ADD[1])-1 < new_TZ_s00_mem1*ADD_mem[1]
	S += (new_TZ_t11*ADD[2])-1 < new_TZ_s00_mem1*ADD_mem[2]
	S += (new_TZ_t11*ADD[3])-1 < new_TZ_s00_mem1*ADD_mem[3]
	S += new_TZ_s00_mem1 <= new_TZ_s00

	new_TZ_s01 = S.Task('new_TZ_s01', length=1, delay_cost=1)
	new_TZ_s01 += alt(ADD)

	new_TZ_s01_mem0 = S.Task('new_TZ_s01_mem0', length=1, delay_cost=1)
	new_TZ_s01_mem0 += alt(ADD_mem)
	S += (new_TZ_t11*ADD[0])-1 < new_TZ_s01_mem0*ADD_mem[0]
	S += (new_TZ_t11*ADD[1])-1 < new_TZ_s01_mem0*ADD_mem[1]
	S += (new_TZ_t11*ADD[2])-1 < new_TZ_s01_mem0*ADD_mem[2]
	S += (new_TZ_t11*ADD[3])-1 < new_TZ_s01_mem0*ADD_mem[3]
	S += new_TZ_s01_mem0 <= new_TZ_s01

	new_TZ_s01_mem1 = S.Task('new_TZ_s01_mem1', length=1, delay_cost=1)
	new_TZ_s01_mem1 += alt(ADD_mem)
	S += (new_TZ_t10*ADD[0])-1 < new_TZ_s01_mem1*ADD_mem[0]
	S += (new_TZ_t10*ADD[1])-1 < new_TZ_s01_mem1*ADD_mem[1]
	S += (new_TZ_t10*ADD[2])-1 < new_TZ_s01_mem1*ADD_mem[2]
	S += (new_TZ_t10*ADD[3])-1 < new_TZ_s01_mem1*ADD_mem[3]
	S += new_TZ_s01_mem1 <= new_TZ_s01

	new_TZ_t51 = S.Task('new_TZ_t51', length=1, delay_cost=1)
	new_TZ_t51 += alt(ADD)

	new_TZ_t51_mem0 = S.Task('new_TZ_t51_mem0', length=1, delay_cost=1)
	new_TZ_t51_mem0 += alt(ADD_mem)
	S += (new_TZ_t01*ADD[0])-1 < new_TZ_t51_mem0*ADD_mem[0]
	S += (new_TZ_t01*ADD[1])-1 < new_TZ_t51_mem0*ADD_mem[1]
	S += (new_TZ_t01*ADD[2])-1 < new_TZ_t51_mem0*ADD_mem[2]
	S += (new_TZ_t01*ADD[3])-1 < new_TZ_t51_mem0*ADD_mem[3]
	S += new_TZ_t51_mem0 <= new_TZ_t51

	new_TZ_t51_mem1 = S.Task('new_TZ_t51_mem1', length=1, delay_cost=1)
	new_TZ_t51_mem1 += alt(ADD_mem)
	S += (new_TZ_t11*ADD[0])-1 < new_TZ_t51_mem1*ADD_mem[0]
	S += (new_TZ_t11*ADD[1])-1 < new_TZ_t51_mem1*ADD_mem[1]
	S += (new_TZ_t11*ADD[2])-1 < new_TZ_t51_mem1*ADD_mem[2]
	S += (new_TZ_t11*ADD[3])-1 < new_TZ_t51_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-318/scheduling/PADD_mul1_add4/PADD_8.png"
	if(S.solution() != []):
