...
def solve():
	...
	S += (t0_t10*ADD[0])-1 < t0_s00_mem0*ADD_mem[0]
	S += (t0_t10*ADD[1])-1 < t0_s00_mem0*ADD_mem[1]
	S += (t0_t10*ADD[2])-1 < t0_s00_mem0*ADD_mem[2]
	S += (t0_t10*ADD[3])-1 < t0_s00_mem0*ADD_mem[3]
	S += t0_s00_mem0 <= t0_s00

	t0_s00_mem1 = S.Task('t0_s00_mem1', length=1, delay_cost=1)
	t0_s00_mem1 += alt(ADD_mem)
	S += (t0_t11*ADD[0])-1 < t0_s00_mem1*ADD_mem[0]
	S += (t0_t11*ADD[1])-1 < t0_s00_mem1*ADD_mem[1]
	S += (t0_t11*ADD[2])-1 < t0_s00_mem1*ADD_mem[2]
	S += (t0_t11*ADD[3])-1 < t0_s00_mem1*ADD_mem[3]
	...
	S += (t0_t11*ADD[0])-1 < t0_s01_mem0*ADD_mem[0]
	S += (t0_t11*ADD[1])-1 < t0_s01_mem0*ADD_mem[1]
	S += (t0_t11*ADD[2])-1 < t0_s01_mem0*ADD_mem[2]
	S += (t0_t11*ADD[3])-1 < t0_s01_mem0*ADD_mem[3]
	S += t0_s01_mem0 <= t0_s01

	t0_s01_mem1 = S.Task('t0_s01_mem1', length=1, delay_cost=1)
	t0_s01_mem1 += alt(ADD_mem)
	S += (t0_t10*ADD[0])-1 < t0_s01_mem1*ADD_mem[0]
	S += (t0_t10*ADD[1])-1 < t0_s01_mem1*ADD_mem[1]
	S += (t0_t10*ADD[2])-1 < t0_s01_mem1*ADD_mem[2]
	S += (t0_t10*ADD[3])-1 < t0_s01_mem1*ADD_mem[3]
	...
	S += (t2_t10*ADD[0])-1 < t2_s00_mem0*ADD_mem[0]
	S += (t2_t10*ADD[1])-1 < t2_s00_mem0*ADD_mem[1]
	S += (t2_t10*ADD[2])-1 < t2_s00_mem0*ADD_mem[2]
	S += (t2_t10*ADD[3])-1 < t2_s00_mem0*ADD_mem[3]
	S += t2_s00_mem0 <= t2_s00

	t2_s00_mem1 = S.Task('t2_s00_mem1', length=1, delay_cost=1)
	t2_s00_mem1 += alt(ADD_mem)
	S += (t2_t11*ADD[0])-1 < t2_s00_mem1*ADD_mem[0]
	S += (t2_t11*ADD[1])-1 < t2_s00_mem1*ADD_mem[1]
	S += (t2_t11*ADD[2])-1 < t2_s00_mem1*ADD_mem[2]
	S += (t2_t11*ADD[3])-1 < t2_s00_mem1*ADD_mem[3]
	...
	S += (t2_t11*ADD[0])-1 < t2_s01_mem0*ADD_mem[0]
	S += (t2_t11*ADD[1])-1 < t2_s01_mem0*ADD_mem[1]
	S += (t2_t11*ADD[2])-1 < t2_s01_mem0*ADD_mem[2]
	S += (t2_t11*ADD[3])-1 < t2_s01_mem0*ADD_mem[3]
	S += t2_s01_mem0 <= t2_s01

	t2_s01_mem1 = S.Task('t2_s01_mem1', length=1, delay_cost=1)
	t2_s01_mem1 += alt(ADD_mem)
	S += (t2_t10*ADD[0])-1 < t2_s01_mem1*ADD_mem[0]
	S += (t2_t10*ADD[1])-1 < t2_s01_mem1*ADD_mem[1]
	S += (t2_t10*ADD[2])-1 < t2_s01_mem1*ADD_mem[2]
	S += (t2_t10*ADD[3])-1 < t2_s01_mem1*ADD_mem[3]
	...
	S += (t0_s00*ADD[0])-1 < t000_mem1*ADD_mem[0]
	S += (t0_s00*ADD[1])-1 < t000_mem1*ADD_mem[1]
	S += (t0_s00*ADD[2])-1 < t000_mem1*ADD_mem[2]
	S += (t0_s00*ADD[3])-1 < t000_mem1*ADD_mem[3]
	S += t000_mem1 <= t000
	...
	S += (t0_t01*ADD[0])-1 < t001_mem0*ADD_mem[0]
	S += (t0_t01*ADD[1])-1 < t001_mem0*ADD_mem[1]
	S += (t0_t01*ADD[2])-1 < t001_mem0*ADD_mem[2]
	S += (t0_t01*ADD[3])-1 < t001_mem0*ADD_mem[3]
	S += t001_mem0 <= t001

	t001_mem1 = S.Task('t001_mem1', length=1, delay_cost=1)
	t001_mem1 += alt(ADD_mem)
	S += (t0_s01*ADD[0])-1 < t001_mem1*ADD_mem[0]
	S += (t0_s01*ADD[1])-1 < t001_mem1*ADD_mem[1]
	S += (t0_s01*ADD[2])-1 < t001_mem1*ADD_mem[2]
	S += (t0_s01*ADD[3])-1 < t001_mem1*ADD_mem[3]
	S += t001_mem1 <= t001
	...
	S += (t011*ADD[0])-1 < t111_mem1*ADD_mem[0]
	S += (t011*ADD[1])-1 < t111_mem1*ADD_mem[1]
	S += (t011*ADD[2])-1 < t111_mem1*ADD_mem[2]
	S += (t011*ADD[3])-1 < t111_mem1*ADD_mem[3]
	S += t111_mem1 <= t111
	...
	S += (t310*ADD[0])-1 < t16_t1_t0_mem1*ADD_mem[0]
	S += (t310*ADD[1])-1 < t16_t1_t0_mem1*ADD_mem[1]
	S += (t310*ADD[2])-1 < t16_t1_t0_mem1*ADD_mem[2]
	S += (t310*ADD[3])-1 < t16_t1_t0_mem1*ADD_mem[3]
	...
	S += (t110*ADD[0])-1 < t17_t1_t0_mem1*ADD_mem[0]
	S += (t110*ADD[1])-1 < t17_t1_t0_mem1*ADD_mem[1]
	S += (t110*ADD[2])-1 < t17_t1_t0_mem1*ADD_mem[2]
	S += (t110*ADD[3])-1 < t17_t1_t0_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-318/scheduling/PADD_mul1_add4/PADD_2.png"
	if(S.solution() != []):
