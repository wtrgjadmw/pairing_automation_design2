...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-318/scheduling/SQR_mul1_add4/SQR_12.png"
	if(S.solution() != []):
