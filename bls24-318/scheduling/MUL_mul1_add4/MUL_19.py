...
def solve():
	horizon = 353
	S = Scenario("MUL_19", horizon=horizon)
	...
	S += c_t4_t700_mem0 >= 246
	c_t4_t700_mem0 += ADD_mem[3]

	c_t4_t700_mem1 = S.Task('c_t4_t700_mem1', length=1, delay_cost=1)
	S += c_t4_t700_mem1 >= 246
	c_t4_t700_mem1 += ADD_mem[2]
	...
	S += c_t4_t711_mem0 >= 256
	c_t4_t711_mem0 += ADD_mem[0]

	c_t4_t711_mem1 = S.Task('c_t4_t711_mem1', length=1, delay_cost=1)
	S += c_t4_t711_mem1 >= 256
	...
	S += (c_t4011*ADD[0]) < c1011_mem0*ADD_mem[0]
	S += (c_t4011*ADD[1]) < c1011_mem0*ADD_mem[1]
	S += (c_t4011*ADD[2]) < c1011_mem0*ADD_mem[2]
	S += (c_t4011*ADD[3]) < c1011_mem0*ADD_mem[3]
	S += c1011_mem0 <= c1011

	c1011_mem1 = S.Task('c1011_mem1', length=1, delay_cost=1)
	c1011_mem1 += alt(ADD_mem)
	S += (c_t5011*ADD[0]) < c1011_mem1*ADD_mem[0]
	S += (c_t5011*ADD[1]) < c1011_mem1*ADD_mem[1]
	S += (c_t5011*ADD[2]) < c1011_mem1*ADD_mem[2]
	S += (c_t5011*ADD[3]) < c1011_mem1*ADD_mem[3]
	S += c1011_mem1 <= c1011
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-318/scheduling/MUL_mul1_add4/MUL_19.png"
	if(S.solution() != []):
