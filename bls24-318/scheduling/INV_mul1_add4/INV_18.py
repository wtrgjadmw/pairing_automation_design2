...
def solve():
	...
	S += 217 < c_denom_inv_aa_t2_t1_mem0
	...
	S += 204 < c_denom_inv_aa_t2_t1_mem1
	...
	S += 222 < c_denom_inv_aa_t2_t2_mem0
	...
	S += 217 < c_denom_inv_aa_t2_t2_mem1
	...
	S += 214 < c_denom_inv_bb_t2_t0_mem0
	...
	S += 201 < c_denom_inv_bb_t2_t0_mem1
	...
	S += 216 < c_denom_inv_bb_t2_t1_mem0
	...
	S += 211 < c_denom_inv_bb_t2_t1_mem1
	...
	S += 214 < c_denom_inv_bb_t2_t2_mem0
	...
	S += 216 < c_denom_inv_bb_t2_t2_mem1
	...
	S += 205 < c_denom_inv_ab_t4_t4_mem0
	...
	S += 215 < c_denom_inv_ab_t4_t4_mem1
	...
	S += 214 < c_denom_inv_bc_t4_t4_mem0
	...
	S += 189 < c_denom_inv_bc_t4_t4_mem1
	...
	S += 222 < c_denom_inv_bc_t4_t5_mem0
	...
	S += 223 < c_denom_inv_bc_t4_t5_mem1
	...
	S += 197 < c_denom_inv_ac_t4_t4_mem0
	...
	S += 212 < c_denom_inv_ac_t4_t4_mem1
	...
	S += 231 < c_denom_inv_ac_t4_t5_mem0
	...
	S += 229 < c_denom_inv_ac_t4_t5_mem1
	...
	S += 198 < c_denom_inv_ccxi_y1_0_mem0
	...
	S += 206 < c_denom_inv_ccxi_y1_0_mem1
	...
	S += 206 < c_denom_inv_ccxi_y1_1_mem0
	...
	S += 198 < c_denom_inv_ccxi_y1_1_mem1
	...
	c_denom_inv_aa_t2_t4_mem0 += alt(ADD_mem)
	S += (c_denom_inv_aa_t2_t2*ADD[0]) < c_denom_inv_aa_t2_t4_mem0*ADD_mem[0]
	S += (c_denom_inv_aa_t2_t2*ADD[1]) < c_denom_inv_aa_t2_t4_mem0*ADD_mem[1]
	S += (c_denom_inv_aa_t2_t2*ADD[2]) < c_denom_inv_aa_t2_t4_mem0*ADD_mem[2]
	S += (c_denom_inv_aa_t2_t2*ADD[3]) < c_denom_inv_aa_t2_t4_mem0*ADD_mem[3]
	...
	S += 215 < c_denom_inv_aa_t2_t4_mem1
	...
	c_denom_inv_aa_t20_mem0 += alt(MUL_mem)
	S += (c_denom_inv_aa_t2_t0*MUL[0]) < c_denom_inv_aa_t20_mem0*MUL_mem[0]
	S += c_denom_inv_aa_t20_mem0 <= c_denom_inv_aa_t20

	c_denom_inv_aa_t20_mem1 = S.Task('c_denom_inv_aa_t20_mem1', length=1, delay_cost=1)
	c_denom_inv_aa_t20_mem1 += alt(MUL_mem)
	S += (c_denom_inv_aa_t2_t1*MUL[0]) < c_denom_inv_aa_t20_mem1*MUL_mem[0]
	...
	c_denom_inv_aa_t2_t5_mem0 += alt(MUL_mem)
	S += (c_denom_inv_aa_t2_t0*MUL[0]) < c_denom_inv_aa_t2_t5_mem0*MUL_mem[0]
	...
	c_denom_inv_aa_t2_t5_mem1 += alt(MUL_mem)
	S += (c_denom_inv_aa_t2_t1*MUL[0]) < c_denom_inv_aa_t2_t5_mem1*MUL_mem[0]
	...
	c_denom_inv_bb_t2_t4_mem0 += alt(ADD_mem)
	S += (c_denom_inv_bb_t2_t2*ADD[0]) < c_denom_inv_bb_t2_t4_mem0*ADD_mem[0]
	S += (c_denom_inv_bb_t2_t2*ADD[1]) < c_denom_inv_bb_t2_t4_mem0*ADD_mem[1]
	S += (c_denom_inv_bb_t2_t2*ADD[2]) < c_denom_inv_bb_t2_t4_mem0*ADD_mem[2]
	S += (c_denom_inv_bb_t2_t2*ADD[3]) < c_denom_inv_bb_t2_t4_mem0*ADD_mem[3]
	...
	c_denom_inv_bb_t20_mem0 += alt(MUL_mem)
	S += (c_denom_inv_bb_t2_t0*MUL[0]) < c_denom_inv_bb_t20_mem0*MUL_mem[0]
	S += c_denom_inv_bb_t20_mem0 <= c_denom_inv_bb_t20

	c_denom_inv_bb_t20_mem1 = S.Task('c_denom_inv_bb_t20_mem1', length=1, delay_cost=1)
	c_denom_inv_bb_t20_mem1 += alt(MUL_mem)
	S += (c_denom_inv_bb_t2_t1*MUL[0]) < c_denom_inv_bb_t20_mem1*MUL_mem[0]
	...
	c_denom_inv_bb_t2_t5_mem0 += alt(MUL_mem)
	S += (c_denom_inv_bb_t2_t0*MUL[0]) < c_denom_inv_bb_t2_t5_mem0*MUL_mem[0]
	...
	c_denom_inv_bb_t2_t5_mem1 += alt(MUL_mem)
	S += (c_denom_inv_bb_t2_t1*MUL[0]) < c_denom_inv_bb_t2_t5_mem1*MUL_mem[0]
	...
	c_denom_inv_cc00 += alt(ADD)

	c_denom_inv_cc00_mem0 = S.Task('c_denom_inv_cc00_mem0', length=1, delay_cost=1)
	c_denom_inv_cc00_mem0 += ADD_mem[1]
	S += 211 < c_denom_inv_cc00_mem0
	S += c_denom_inv_cc00_mem0 <= c_denom_inv_cc00

	c_denom_inv_cc00_mem1 = S.Task('c_denom_inv_cc00_mem1', length=1, delay_cost=1)
	c_denom_inv_cc00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_cc_t50*ADD[0]) < c_denom_inv_cc00_mem1*ADD_mem[0]
	S += (c_denom_inv_cc_t50*ADD[1]) < c_denom_inv_cc00_mem1*ADD_mem[1]
	S += (c_denom_inv_cc_t50*ADD[2]) < c_denom_inv_cc00_mem1*ADD_mem[2]
	S += (c_denom_inv_cc_t50*ADD[3]) < c_denom_inv_cc00_mem1*ADD_mem[3]
	S += c_denom_inv_cc00_mem1 <= c_denom_inv_cc00

	c_denom_inv_cc01 = S.Task('c_denom_inv_cc01', length=1, delay_cost=1)
	c_denom_inv_cc01 += alt(ADD)

	c_denom_inv_cc01_mem0 = S.Task('c_denom_inv_cc01_mem0', length=1, delay_cost=1)
	c_denom_inv_cc01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_cc_t21*ADD[0]) < c_denom_inv_cc01_mem0*ADD_mem[0]
	S += (c_denom_inv_cc_t21*ADD[1]) < c_denom_inv_cc01_mem0*ADD_mem[1]
	S += (c_denom_inv_cc_t21*ADD[2]) < c_denom_inv_cc01_mem0*ADD_mem[2]
	S += (c_denom_inv_cc_t21*ADD[3]) < c_denom_inv_cc01_mem0*ADD_mem[3]
	S += c_denom_inv_cc01_mem0 <= c_denom_inv_cc01

	c_denom_inv_cc01_mem1 = S.Task('c_denom_inv_cc01_mem1', length=1, delay_cost=1)
	c_denom_inv_cc01_mem1 += alt(ADD_mem)
	S += (c_denom_inv_cc_t51*ADD[0]) < c_denom_inv_cc01_mem1*ADD_mem[0]
	S += (c_denom_inv_cc_t51*ADD[1]) < c_denom_inv_cc01_mem1*ADD_mem[1]
	S += (c_denom_inv_cc_t51*ADD[2]) < c_denom_inv_cc01_mem1*ADD_mem[2]
	S += (c_denom_inv_cc_t51*ADD[3]) < c_denom_inv_cc01_mem1*ADD_mem[3]
	S += c_denom_inv_cc01_mem1 <= c_denom_inv_cc01
	...
	S += 207 < c_denom_inv_ab_s00_mem0
	S += c_denom_inv_ab_s00_mem0 <= c_denom_inv_ab_s00

	c_denom_inv_ab_s00_mem1 = S.Task('c_denom_inv_ab_s00_mem1', length=1, delay_cost=1)
	c_denom_inv_ab_s00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_ab_t11*ADD[0]) < c_denom_inv_ab_s00_mem1*ADD_mem[0]
	S += (c_denom_inv_ab_t11*ADD[1]) < c_denom_inv_ab_s00_mem1*ADD_mem[1]
	S += (c_denom_inv_ab_t11*ADD[2]) < c_denom_inv_ab_s00_mem1*ADD_mem[2]
	S += (c_denom_inv_ab_t11*ADD[3]) < c_denom_inv_ab_s00_mem1*ADD_mem[3]
	...
	c_denom_inv_ab_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_ab_t11*ADD[0]) < c_denom_inv_ab_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_ab_t11*ADD[1]) < c_denom_inv_ab_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_ab_t11*ADD[2]) < c_denom_inv_ab_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_ab_t11*ADD[3]) < c_denom_inv_ab_s01_mem0*ADD_mem[3]
	...
	c_denom_inv_ab_t51_mem1 += alt(ADD_mem)
	S += (c_denom_inv_ab_t11*ADD[0]) < c_denom_inv_ab_t51_mem1*ADD_mem[0]
	S += (c_denom_inv_ab_t11*ADD[1]) < c_denom_inv_ab_t51_mem1*ADD_mem[1]
	S += (c_denom_inv_ab_t11*ADD[2]) < c_denom_inv_ab_t51_mem1*ADD_mem[2]
	S += (c_denom_inv_ab_t11*ADD[3]) < c_denom_inv_ab_t51_mem1*ADD_mem[3]
	...
	S += 219 < c_denom_inv_bc_s00_mem0
	S += c_denom_inv_bc_s00_mem0 <= c_denom_inv_bc_s00

	c_denom_inv_bc_s00_mem1 = S.Task('c_denom_inv_bc_s00_mem1', length=1, delay_cost=1)
	c_denom_inv_bc_s00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_bc_t11*ADD[0]) < c_denom_inv_bc_s00_mem1*ADD_mem[0]
	S += (c_denom_inv_bc_t11*ADD[1]) < c_denom_inv_bc_s00_mem1*ADD_mem[1]
	S += (c_denom_inv_bc_t11*ADD[2]) < c_denom_inv_bc_s00_mem1*ADD_mem[2]
	S += (c_denom_inv_bc_t11*ADD[3]) < c_denom_inv_bc_s00_mem1*ADD_mem[3]
	...
	c_denom_inv_bc_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_bc_t11*ADD[0]) < c_denom_inv_bc_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_bc_t11*ADD[1]) < c_denom_inv_bc_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_bc_t11*ADD[2]) < c_denom_inv_bc_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_bc_t11*ADD[3]) < c_denom_inv_bc_s01_mem0*ADD_mem[3]
	...
	c_denom_inv_bc_t51_mem1 += alt(ADD_mem)
	S += (c_denom_inv_bc_t11*ADD[0]) < c_denom_inv_bc_t51_mem1*ADD_mem[0]
	S += (c_denom_inv_bc_t11*ADD[1]) < c_denom_inv_bc_t51_mem1*ADD_mem[1]
	S += (c_denom_inv_bc_t11*ADD[2]) < c_denom_inv_bc_t51_mem1*ADD_mem[2]
	S += (c_denom_inv_bc_t11*ADD[3]) < c_denom_inv_bc_t51_mem1*ADD_mem[3]
	...
	S += 210 < c_denom_inv_ac_s00_mem0
	S += c_denom_inv_ac_s00_mem0 <= c_denom_inv_ac_s00

	c_denom_inv_ac_s00_mem1 = S.Task('c_denom_inv_ac_s00_mem1', length=1, delay_cost=1)
	c_denom_inv_ac_s00_mem1 += alt(ADD_mem)
	S += (c_denom_inv_ac_t11*ADD[0]) < c_denom_inv_ac_s00_mem1*ADD_mem[0]
	S += (c_denom_inv_ac_t11*ADD[1]) < c_denom_inv_ac_s00_mem1*ADD_mem[1]
	S += (c_denom_inv_ac_t11*ADD[2]) < c_denom_inv_ac_s00_mem1*ADD_mem[2]
	S += (c_denom_inv_ac_t11*ADD[3]) < c_denom_inv_ac_s00_mem1*ADD_mem[3]
	...
	c_denom_inv_ac_s01_mem0 += alt(ADD_mem)
	S += (c_denom_inv_ac_t11*ADD[0]) < c_denom_inv_ac_s01_mem0*ADD_mem[0]
	S += (c_denom_inv_ac_t11*ADD[1]) < c_denom_inv_ac_s01_mem0*ADD_mem[1]
	S += (c_denom_inv_ac_t11*ADD[2]) < c_denom_inv_ac_s01_mem0*ADD_mem[2]
	S += (c_denom_inv_ac_t11*ADD[3]) < c_denom_inv_ac_s01_mem0*ADD_mem[3]
	...
	c_denom_inv_ac_t51_mem1 += alt(ADD_mem)
	S += (c_denom_inv_ac_t11*ADD[0]) < c_denom_inv_ac_t51_mem1*ADD_mem[0]
	S += (c_denom_inv_ac_t11*ADD[1]) < c_denom_inv_ac_t51_mem1*ADD_mem[1]
	S += (c_denom_inv_ac_t11*ADD[2]) < c_denom_inv_ac_t51_mem1*ADD_mem[2]
	S += (c_denom_inv_ac_t11*ADD[3]) < c_denom_inv_ac_t51_mem1*ADD_mem[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-318/scheduling/INV_mul1_add4/INV_18.png"
	if(S.solution() != []):
