...
def solve():
	...
	S += 154 < c_bb_t910_mem0
	S += c_bb_t910_mem0 <= c_bb_t910

	c_bb_t910_mem1 = S.Task('c_bb_t910_mem1', length=1, delay_cost=1)
	c_bb_t910_mem1 += ADD_mem[2]
	S += 154 < c_bb_t910_mem1
	S += c_bb_t910_mem1 <= c_bb_t910
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls24-318/scheduling/INV_mul1_add4/INV_13.png"
	if(S.solution() != []):
