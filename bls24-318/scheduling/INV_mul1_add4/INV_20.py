...
def solve():
	...
	S += 237 < c_denom_inv_pbc_t0_t0_mem0
	...
	S += 171 < c_denom_inv_pbc_t0_t0_mem1
	...
	S += 236 < c_denom_inv_pbc_t0_t1_mem0
	...
	S += 237 < c_denom_inv_pbc_t0_t2_mem0
	...
	S += 236 < c_denom_inv_pbc_t0_t2_mem1
	...
	S += 235 < c_denom_inv_pbc_t1_t4_mem0
	...
	S += 183 < c_denom_inv_pbc_t1_t4_mem1
	...
	S += 233 < c_denom_inv_pbc_t10_mem0
	...
	S += 236 < c_denom_inv_pbc_t10_mem1
	...
	S += 233 < c_denom_inv_pbc_t1_t5_mem0
	...
	S += 236 < c_denom_inv_pbc_t1_t5_mem1
	...
	S += 237 < c_denom_inv_pbc_t20_mem0
	...
	S += 226 < c_denom_inv_pbc_t20_mem1
	...
	S += 236 < c_denom_inv_pbc_t21_mem0
	...
	S += 229 < c_denom_inv_pbc_t21_mem1
	...
	S += 233 < c_denom_inv_pcb_t0_t0_mem0
	...
	S += 185 < c_denom_inv_pcb_t0_t0_mem1
	...
	S += 233 < c_denom_inv_pcb_t0_t1_mem0
	...
	S += 233 < c_denom_inv_pcb_t0_t2_mem0
	...
	S += 233 < c_denom_inv_pcb_t0_t2_mem1
	...
	S += 229 < c_denom_inv_pcb_t1_t4_mem0
	...
	S += 199 < c_denom_inv_pcb_t1_t4_mem1
	...
	S += 232 < c_denom_inv_pcb_t10_mem0
	...
	S += 235 < c_denom_inv_pcb_t10_mem1
	...
	S += 232 < c_denom_inv_pcb_t1_t5_mem0
	...
	S += 235 < c_denom_inv_pcb_t1_t5_mem1
	...
	S += 233 < c_denom_inv_pcb_t20_mem0
	...
	S += 225 < c_denom_inv_pcb_t20_mem1
	...
	S += 233 < c_denom_inv_pcb_t21_mem0
	...
	S += 228 < c_denom_inv_pcb_t21_mem1
	...
	S += 237 < c_denom_inv_paa_t1_t0_mem0
	...
	S += 175 < c_denom_inv_pbc_t0_t4_mem1
	...
	S += (c_denom_inv_pbc_t20*ADD[0])-1 < c_denom_inv_pbc_t4_t0_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t20*ADD[1])-1 < c_denom_inv_pbc_t4_t0_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t20*ADD[2])-1 < c_denom_inv_pbc_t4_t0_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t20*ADD[3])-1 < c_denom_inv_pbc_t4_t0_mem0*ADD_mem[3]
	...
	S += 176 < c_denom_inv_pbc_t4_t0_mem1
	...
	S += (c_denom_inv_pbc_t21*ADD[0])-1 < c_denom_inv_pbc_t4_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t21*ADD[1])-1 < c_denom_inv_pbc_t4_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t21*ADD[2])-1 < c_denom_inv_pbc_t4_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t21*ADD[3])-1 < c_denom_inv_pbc_t4_t1_mem0*ADD_mem[3]
	...
	S += 176 < c_denom_inv_pbc_t4_t1_mem1
	...
	S += (c_denom_inv_pbc_t20*ADD[0])-1 < c_denom_inv_pbc_t4_t2_mem0*ADD_mem[0]
	S += (c_denom_inv_pbc_t20*ADD[1])-1 < c_denom_inv_pbc_t4_t2_mem0*ADD_mem[1]
	S += (c_denom_inv_pbc_t20*ADD[2])-1 < c_denom_inv_pbc_t4_t2_mem0*ADD_mem[2]
	S += (c_denom_inv_pbc_t20*ADD[3])-1 < c_denom_inv_pbc_t4_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pbc_t21*ADD[0])-1 < c_denom_inv_pbc_t4_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_pbc_t21*ADD[1])-1 < c_denom_inv_pbc_t4_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_pbc_t21*ADD[2])-1 < c_denom_inv_pbc_t4_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_pbc_t21*ADD[3])-1 < c_denom_inv_pbc_t4_t2_mem1*ADD_mem[3]
	...
	S += 190 < c_denom_inv_pcb_t0_t4_mem1
	...
	S += 196 < c_denom_inv_pcb_t4_t0_mem1
	...
	S += 204 < c_denom_inv_pcb_t4_t1_mem1
	...
	S += 184 < c_denom_inv_paa_t0_t0_mem1
	...
	S += (c_denom_inv_pa01*ADD[0])-1 < c_denom_inv_paa_t0_t1_mem0*ADD_mem[0]
	S += (c_denom_inv_pa01*ADD[1])-1 < c_denom_inv_paa_t0_t1_mem0*ADD_mem[1]
	S += (c_denom_inv_pa01*ADD[2])-1 < c_denom_inv_paa_t0_t1_mem0*ADD_mem[2]
	S += (c_denom_inv_pa01*ADD[3])-1 < c_denom_inv_paa_t0_t1_mem0*ADD_mem[3]
	...
	S += 186 < c_denom_inv_paa_t0_t1_mem1
	...
	S += (c_denom_inv_pa01*ADD[0])-1 < c_denom_inv_paa_t0_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_pa01*ADD[1])-1 < c_denom_inv_paa_t0_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_pa01*ADD[2])-1 < c_denom_inv_paa_t0_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_pa01*ADD[3])-1 < c_denom_inv_paa_t0_t2_mem1*ADD_mem[3]
	...
	S += 183 < c_denom_inv_paa_t1_t1_mem1
	...
	S += 237 < c_denom_inv_paa_t1_t2_mem0
	...
	S += 237 < c_denom_inv_paa_t20_mem1
	...
	S += (c_denom_inv_pa01*ADD[0])-1 < c_denom_inv_paa_t21_mem0*ADD_mem[0]
	S += (c_denom_inv_pa01*ADD[1])-1 < c_denom_inv_paa_t21_mem0*ADD_mem[1]
	S += (c_denom_inv_pa01*ADD[2])-1 < c_denom_inv_paa_t21_mem0*ADD_mem[2]
	S += (c_denom_inv_pa01*ADD[3])-1 < c_denom_inv_paa_t21_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pa11*ADD[0])-1 < c_denom_inv_paa_t21_mem1*ADD_mem[0]
	S += (c_denom_inv_pa11*ADD[1])-1 < c_denom_inv_paa_t21_mem1*ADD_mem[1]
	S += (c_denom_inv_pa11*ADD[2])-1 < c_denom_inv_paa_t21_mem1*ADD_mem[2]
	S += (c_denom_inv_pa11*ADD[3])-1 < c_denom_inv_paa_t21_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_pa01*ADD[0])-1 < c_denom_inv0_t0_t2_mem1*ADD_mem[0]
	S += (c_denom_inv_pa01*ADD[1])-1 < c_denom_inv0_t0_t2_mem1*ADD_mem[1]
	S += (c_denom_inv_pa01*ADD[2])-1 < c_denom_inv0_t0_t2_mem1*ADD_mem[2]
	S += (c_denom_inv_pa01*ADD[3])-1 < c_denom_inv0_t0_t2_mem1*ADD_mem[3]
	...
	S += (c_denom_inv_pa01*ADD[0])-1 < c_denom_inv0_t21_mem0*ADD_mem[0]
	S += (c_denom_inv_pa01*ADD[1])-1 < c_denom_inv0_t21_mem0*ADD_mem[1]
	S += (c_denom_inv_pa01*ADD[2])-1 < c_denom_inv0_t21_mem0*ADD_mem[2]
	S += (c_denom_inv_pa01*ADD[3])-1 < c_denom_inv0_t21_mem0*ADD_mem[3]
	...
	S += (c_denom_inv_pa11*ADD[0])-1 < c_denom_inv0_t21_mem1*ADD_mem[0]
	S += (c_denom_inv_pa11*ADD[1])-1 < c_denom_inv0_t21_mem1*ADD_mem[1]
	S += (c_denom_inv_pa11*ADD[2])-1 < c_denom_inv0_t21_mem1*ADD_mem[2]
	S += (c_denom_inv_pa11*ADD[3])-1 < c_denom_inv0_t21_mem1*ADD_mem[3]
	...
	S += (c_denom_inv1_t20*ADD[0])-1 < c_denom_inv1_t4_t2_mem0*ADD_mem[0]
	S += (c_denom_inv1_t20*ADD[1])-1 < c_denom_inv1_t4_t2_mem0*ADD_mem[1]
	S += (c_denom_inv1_t20*ADD[2])-1 < c_denom_inv1_t4_t2_mem0*ADD_mem[2]
	S += (c_denom_inv1_t20*ADD[3])-1 < c_denom_inv1_t4_t2_mem0*ADD_mem[3]
	...
	S += (c_denom_inv1_t21*ADD[0])-1 < c_denom_inv1_t4_t2_mem1*ADD_mem[0]
	S += (c_denom_inv1_t21*ADD[1])-1 < c_denom_inv1_t4_t2_mem1*ADD_mem[1]
	S += (c_denom_inv1_t21*ADD[2])-1 < c_denom_inv1_t4_t2_mem1*ADD_mem[2]
	S += (c_denom_inv1_t21*ADD[3])-1 < c_denom_inv1_t4_t2_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-318/scheduling/INV_mul1_add4/INV_20.png"
	if(S.solution() != []):
