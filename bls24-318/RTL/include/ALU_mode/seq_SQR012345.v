...
63: begin
	...
	add1_opr1 <= add1_out_reg; add1_opr2 <= ram_add0_out2; issub1 <= 1;
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 2;
...
68: begin
	...
	add2_opr1 <= add2_out_reg; add2_opr2 <= ram_add0_out2; issub2 <= 0;
	ram_add1_wr_n <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
	ram_add2_wr_n <= 0;
...
69: begin
	...
	add0_opr1 <= ram_add2_out1; add0_opr2 <= ram_input_out2; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 1;
	ram_mm0_waddr <= 1;
...
70: begin
	...
	add2_opr1 <= ram_add2_out2; add2_opr2 <= ram_input_out2; issub2 <= 0;
	ram_mm0_wr_n <= 0;
	ram_add2_wr_n <= 0;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 3;
...
72: begin
	...
	add0_opr1 <= ram_add2_out2; add0_opr2 <= ram_input_out2; issub0 <= 1;
	mm0_opr1 <= add3_out_reg; mm0_opr2 <= ram_add0_out1; 
...
73: begin
	...
	add1_opr1 <= ram_add3_out1; add1_opr2 <= ram_input_out2; issub1 <= 0;
...
74: begin
	...
	add2_opr1 <= ram_add3_out1; add2_opr2 <= ram_input_out2; issub2 <= 1;
...
90: begin
	...
	add2_opr1 <= ram_mm0_out1; add2_opr2 <= ram_mm0_out2; issub2 <= 0;
	mm0_opr1 <= add1_out_reg; mm0_opr2 <= ram_add3_out2; 
...
92: begin
	...
	add3_opr1 <= add1_out_reg; add3_opr2 <= ram_input_out1; issub3 <= 0;
...
93: begin
	add2_opr1 <= add0_out_reg; add2_opr2 <= add3_out_reg; issub2 <= 0;
...
97: begin
	...
	add0_opr1 <= add1_out_reg; add0_opr2 <= ram_input_out1; issub0 <= 1;
...
102: begin
	...
	add2_opr1 <= ram_add2_out2; add2_opr2 <= ram_input_out1; issub2 <= 0;
	add1_opr1 <= add1_out_reg; add1_opr2 <= ram_add1_out1; issub1 <= 0;
	ram_add0_wr_n <= 0;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 3;
...
104: begin
	...
	add0_opr1 <= ram_add3_out2; add0_opr2 <= ram_add0_out2; issub0 <= 1;
	ram_add3_wr_n <= 1;
	ram_add0_wr_n <= 0;
	ram_add1_wr_n <= 0;
	ram_add0_waddr <= 0;
...
107: begin
	...
	add3_opr1 <= ram_add3_out1; add3_opr2 <= ram_add3_out1; issub3 <= 0;
	add2_opr1 <= ram_add3_out2; add2_opr2 <= ram_input_out1; issub2 <= 0;
	ram_add0_wr_n <= 1;
	ram_add2_wr_n <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 1;
...
110: begin
	...
	add1_opr1 <= ram_input_out1; add1_opr2 <= add2_out_reg; issub1 <= 0;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 0;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
...
116: begin
	...
	add2_opr1 <= ram_add1_out1; add2_opr2 <= ram_add1_out1; issub2 <= 0;
	add1_opr1 <= ram_input_out1; add1_opr2 <= add2_out_reg; issub1 <= 0;
	add0_opr1 <= ram_input_out2; add0_opr2 <= add3_out_reg; issub0 <= 0;
	ram_add1_raddr1 <= 4;
	ram_add1_raddr2 <= 5;
	ram_input_raddr1 <= inst_addr_opr1 + `RAM_ADDR_SIZE'd12;
	w1_n_reg <= 0;
...
117: begin
	...
	add2_opr1 <= ram_input_out1; add2_opr2 <= add2_out_reg; issub2 <= 0;
	ram_add0_raddr1 <= 4;
	w1_n_reg <= 0;
	w2_n_reg <= 1;
