...
60: begin
	...
	add0_opr1 <= ram_input_out2; add0_opr2 <= ram_add2_out1; issub0 <= 0;
	mm0_opr1 <= ram_add1_out1; mm0_opr2 <= add3_out; 
	ram_add1_wr_n <= 1;
	ram_add1_raddr1 <= 0;
	ram_input_raddr1 <= `RAM_XI410;
...
61: begin
	...
	add2_opr1 <= ram_input_out2; add2_opr2 <= ram_add1_out2; issub2 <= 0;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 3;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 7;
...
62: begin
	...
	mm0_opr1 <= ram_add2_out1; mm0_opr2 <= ram_input_out2; 
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 0;
	ram_add0_wr_n <= 1;
	ram_add0_raddr1 <= 3;
...
66: begin
	...
	add0_opr1 <= ram_add1_out1; add0_opr2 <= add0_out; issub0 <= 0;
	mm0_opr1 <= ram_add0_out1; mm0_opr2 <= ram_input_out2; 
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 10;
...
81: begin
	add3_opr1 <= ram_add0_out1; add3_opr2 <= add0_out; issub3 <= 1;
...
83: begin
	...
	add0_opr1 <= ram_mm0_out2; add0_opr2 <= add0_out_reg; issub0 <= 1;
	ram_add3_wr_n <= 1;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 9;
	ram_add0_raddr1 <= 6;
...
96: begin
	...
	add1_opr1 <= ram_mm0_out2; add1_opr2 <= ram_add0_out1; issub1 <= 1;
	ram_add0_raddr1 <= 1;
	ram_add3_raddr1 <= 0;
	ram_mm0_raddr1 <= 8;
	ram_add0_raddr2 <= 2;
