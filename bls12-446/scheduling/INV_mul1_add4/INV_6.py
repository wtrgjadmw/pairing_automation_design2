...
def solve():
	...
	S += (c_pbc_t1_t0*MUL[0])-1<c_pbc_t10_mem0*MUL_mem[0]
	...
	S += (c_pbc_t1_t0*MUL[0])-1<c_pbc_t1_t5_mem0*MUL_mem[0]
	...
	S += (c_pbc_t20*ADD[0])-1<c_pbc_t4_t0_mem0*ADD_mem[0]
	S += (c_pbc_t20*ADD[1])-1<c_pbc_t4_t0_mem0*ADD_mem[1]
	S += (c_pbc_t20*ADD[2])-1<c_pbc_t4_t0_mem0*ADD_mem[2]
	S += (c_pbc_t20*ADD[3])-1<c_pbc_t4_t0_mem0*ADD_mem[3]
	...
	S += (c_pbc_t20*ADD[0])-1<c_pbc_t4_t2_mem0*ADD_mem[0]
	S += (c_pbc_t20*ADD[1])-1<c_pbc_t4_t2_mem0*ADD_mem[1]
	S += (c_pbc_t20*ADD[2])-1<c_pbc_t4_t2_mem0*ADD_mem[2]
	S += (c_pbc_t20*ADD[3])-1<c_pbc_t4_t2_mem0*ADD_mem[3]
	...
	S += (c_pcb_t0_t0*MUL[0])-1<c_pcb_t00_mem0*MUL_mem[0]
	...
	S += (c_pcb_t0_t0*MUL[0])-1<c_pcb_t0_t5_mem0*MUL_mem[0]
	...
	S += (c_pcb_t1_t4*MUL[0])-1<c_pcb_t11_mem0*MUL_mem[0]
	S += c_pcb_t11_mem0<=c_pcb_t11

	c_pcb_t11_mem1 = S.Task('c_pcb_t11_mem1', length=1, delay_cost=1)
	c_pcb_t11_mem1 += alt(ADD_mem)
	S += (c_pcb_t1_t5*ADD[0])-1<c_pcb_t11_mem1*ADD_mem[0]
	S += (c_pcb_t1_t5*ADD[1])-1<c_pcb_t11_mem1*ADD_mem[1]
	S += (c_pcb_t1_t5*ADD[2])-1<c_pcb_t11_mem1*ADD_mem[2]
	S += (c_pcb_t1_t5*ADD[3])-1<c_pcb_t11_mem1*ADD_mem[3]
	...
	S += (c_pcb_t20*ADD[0])-1<c_pcb_t4_t0_mem0*ADD_mem[0]
	S += (c_pcb_t20*ADD[1])-1<c_pcb_t4_t0_mem0*ADD_mem[1]
	S += (c_pcb_t20*ADD[2])-1<c_pcb_t4_t0_mem0*ADD_mem[2]
	S += (c_pcb_t20*ADD[3])-1<c_pcb_t4_t0_mem0*ADD_mem[3]
	...
	S += (c_pcb_t20*ADD[0])-1<c_pcb_t4_t2_mem0*ADD_mem[0]
	S += (c_pcb_t20*ADD[1])-1<c_pcb_t4_t2_mem0*ADD_mem[1]
	S += (c_pcb_t20*ADD[2])-1<c_pcb_t4_t2_mem0*ADD_mem[2]
	S += (c_pcb_t20*ADD[3])-1<c_pcb_t4_t2_mem0*ADD_mem[3]
	...
	S += (c_paa_t0_t0*MUL[0])-1<c_paa_t00_mem0*MUL_mem[0]
	...
	S += (c_paa_t0_t0*MUL[0])-1<c_paa_t0_t5_mem0*MUL_mem[0]
	...
	S += (c_paa_t20*ADD[0])-1<c_paa_t4_t0_mem0*ADD_mem[0]
	S += (c_paa_t20*ADD[1])-1<c_paa_t4_t0_mem0*ADD_mem[1]
	S += (c_paa_t20*ADD[2])-1<c_paa_t4_t0_mem0*ADD_mem[2]
	S += (c_paa_t20*ADD[3])-1<c_paa_t4_t0_mem0*ADD_mem[3]
	...
	S += (c_paa_t20*ADD[0])-1<c_paa_t4_t2_mem0*ADD_mem[0]
	S += (c_paa_t20*ADD[1])-1<c_paa_t4_t2_mem0*ADD_mem[1]
	S += (c_paa_t20*ADD[2])-1<c_paa_t4_t2_mem0*ADD_mem[2]
	S += (c_paa_t20*ADD[3])-1<c_paa_t4_t2_mem0*ADD_mem[3]
	...
	S += (c0_t20*ADD[0])-1<c0_t4_t2_mem0*ADD_mem[0]
	S += (c0_t20*ADD[1])-1<c0_t4_t2_mem0*ADD_mem[1]
	S += (c0_t20*ADD[2])-1<c0_t4_t2_mem0*ADD_mem[2]
	S += (c0_t20*ADD[3])-1<c0_t4_t2_mem0*ADD_mem[3]
	...
	S += (c1_t20*ADD[0])-1<c1_t4_t2_mem0*ADD_mem[0]
	S += (c1_t20*ADD[1])-1<c1_t4_t2_mem0*ADD_mem[1]
	S += (c1_t20*ADD[2])-1<c1_t4_t2_mem0*ADD_mem[2]
	S += (c1_t20*ADD[3])-1<c1_t4_t2_mem0*ADD_mem[3]
	...
	S += (c2_t20*ADD[0])-1<c2_t4_t2_mem0*ADD_mem[0]
	S += (c2_t20*ADD[1])-1<c2_t4_t2_mem0*ADD_mem[1]
	S += (c2_t20*ADD[2])-1<c2_t4_t2_mem0*ADD_mem[2]
	S += (c2_t20*ADD[3])-1<c2_t4_t2_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-381/scheduling/INV_mul1_add4/INV_6.png"
	if(S.solution() != []):
