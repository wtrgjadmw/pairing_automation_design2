...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/pairing_automation_design2/bls12-446/scheduling/INV_mul1_add4/INV_7.png"
	if(S.solution() != []):
