...
writeCommands(24, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
...
writeCommands(58, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
...
writeCommands(66, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
...
writeCommands(73, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
...
writeCommands(84, {`MODE_MUL, `RAM_E, `RAM_C, `RAM_E});
writeCommands(85, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(86, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(87, {`MODE_MUL_CONJ, `RAM_E, `RAM_C, `RAM_E});
writeCommands(88, {`MODE_MUL_CONJ, `RAM_E, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(t2, t1)
// t4 = expFp12(t1)
writeCommands(89, {`MODE_SQR012345, `RAM_G, `RAM_C, `RAM_C});
writeCommands(90, {`MODE_CONJ, `RAM_G, `RAM_C, `RAM_B});
...
writeCommands(107, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(149, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(167, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
writeCommands(168, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(169, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(170, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(171, {`MODE_MUL_CONJ, `RAM_F, `RAM_G, `RAM_G}); // t1 = mulFp12_conj_forRTL(f, t1) 
// t5 = expFp12(t4)
writeCommands(172, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
writeCommands(173, {`MODE_CONJ, `RAM_B, `RAM_C, `RAM_A});
...
writeCommands(190, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(224, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(232, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(239, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
...
writeCommands(250, {`MODE_MUL, `RAM_A, `RAM_C, `RAM_A});
writeCommands(251, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(252, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(253, {`MODE_MUL_CONJ, `RAM_A, `RAM_C, `RAM_A});
writeCommands(254, {`MODE_MUL, `RAM_F, `RAM_B, `RAM_B}); // t4 = mulFp12(f, t4)
// t3 = expFp12(t5)
writeCommands(255, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
writeCommands(256, {`MODE_CONJ, `RAM_A, `RAM_C, `RAM_D});
...
writeCommands(273, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(307, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(315, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(322, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(333, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
writeCommands(334, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(335, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(336, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(337, {`MODE_MUL, `RAM_E, `RAM_A, `RAM_A}); // t5 = mulFp12(t2, t5)
writeCommands(338, {`MODE_SQR012345, `RAM_E, `RAM_E, `RAM_E}); // t2 = SQR012345Fp12(t2)
writeCommands(339, {`MODE_FROB, `RAM_B, `RAM_E, `RAM_B}); // t4 = FrobFp12(FrobFp12(t4))
writeCommands(340, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B});
writeCommands(341, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(FrobFp12(t5))
writeCommands(342, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A});
writeCommands(343, {`MODE_MUL, `RAM_E, `RAM_D, `RAM_E}); //t2 = mulFp12(t2, t3)
writeCommands(344, {`MODE_FROB, `RAM_B, `RAM_B, `RAM_B}); // t4 = FrobFp12(t4)
// t3 = expFp12(t2)
writeCommands(345, {`MODE_SQR012345, `RAM_E, `RAM_C, `RAM_C});
writeCommands(346, {`MODE_CONJ, `RAM_E, `RAM_C, `RAM_D});
...
writeCommands(363, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(397, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(405, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(412, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
...
writeCommands(423, {`MODE_MUL, `RAM_D, `RAM_C, `RAM_D});
writeCommands(424, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(425, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_C});
writeCommands(426, {`MODE_MUL_CONJ, `RAM_D, `RAM_C, `RAM_D});
writeCommands(427, {`MODE_MUL, `RAM_B, `RAM_A, `RAM_B}); // t4 = mulFp12(t4, t5)
writeCommands(428, {`MODE_MUL_CONJ, `RAM_E, `RAM_F, `RAM_A}); // t5 = mulFp12_conj_forRTL(t2, f)
writeCommands(429, {`MODE_MUL, `RAM_G, `RAM_D, `RAM_G}); // t1 = mulFp12(t1, t3)
writeCommands(430, {`MODE_FROB, `RAM_A, `RAM_A, `RAM_A}); // t5 = FrobFp12(t5)
writeCommands(431, {`MODE_MUL, `RAM_G, `RAM_B, `RAM_G}); // t1 = mulFp12(t1, t4)
writeCommands(432, {`MODE_MUL, `RAM_G, `RAM_A, `RAM_G}); // t1 = mulFp12(t1, t3)
