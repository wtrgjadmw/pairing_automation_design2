...
75: begin
	...
	add0_opr1 <= ram_add2_out2; add0_opr2 <= add3_out; issub0 <= 1;
	ram_add1_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add3_wr_n <= 1;
	ram_add2_waddr <= 0;
...
103: begin
	...
	add3_opr1 <= ram_add2_out2; add3_opr2 <= add1_out; issub3 <= 1;
	ram_add3_wr_n <= 0;
	ram_add2_wr_n <= 1;
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 5;
...
115: begin
	...
	add0_opr1 <= add0_out; add0_opr2 <= ram_add2_out2; issub0 <= 1;
	ram_mm0_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 6;
	ram_add3_wr_n <= 0;
...
166: begin
	...
	add2_opr1 <= ram_add0_out2; add2_opr2 <= add3_out_reg; issub2 <= 1;
	ram_add3_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 1;
	ram_add0_wr_n <= 0;
...
167: begin
	add0_opr1 <= ram_add2_out1; add0_opr2 <= ram_add3_out1; issub0 <= 0;
	add3_opr1 <= ram_add0_out1; add3_opr2 <= ram_add3_out2; issub3 <= 1;
...
186: begin
	...
	add0_opr1 <= add0_out; add0_opr2 <= add2_out_reg; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 0;
...
196: begin
	add3_opr1 <= ram_mm0_out1; add3_opr2 <= add1_out; issub3 <= 1;
	ram_add3_raddr1 <= 0;
	w1_n_reg <= 1;
	w2_n_reg <= 1;
	state <= state + 1;
