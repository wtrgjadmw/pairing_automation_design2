...
def solve_MUL_mul1_add4_3():
	horizon = 159
	S=Scenario("MUL_mul1_add4_3",horizon = horizon)
	...
	S += (c_t0_s01*ADD[0])-1<c_t001_mem1*ADD_mem[0]
	S += (c_t0_s01*ADD[1])-1<c_t001_mem1*ADD_mem[1]
	S += (c_t0_s01*ADD[2])-1<c_t001_mem1*ADD_mem[2]
	S += (c_t0_s01*ADD[3])-1<c_t001_mem1*ADD_mem[3]
	...
	S += (c_t1_s01*ADD[0])-1<c_t101_mem1*ADD_mem[0]
	S += (c_t1_s01*ADD[1])-1<c_t101_mem1*ADD_mem[1]
	S += (c_t1_s01*ADD[2])-1<c_t101_mem1*ADD_mem[2]
	S += (c_t1_s01*ADD[3])-1<c_t101_mem1*ADD_mem[3]
	...
	S += (c_t2_s01*ADD[0])-1<c_t201_mem1*ADD_mem[0]
	S += (c_t2_s01*ADD[1])-1<c_t201_mem1*ADD_mem[1]
	S += (c_t2_s01*ADD[2])-1<c_t201_mem1*ADD_mem[2]
	S += (c_t2_s01*ADD[3])-1<c_t201_mem1*ADD_mem[3]
	...
	S += (c_t3_t11*ADD[0])-1<c_t3_s00_mem1*ADD_mem[0]
	S += (c_t3_t11*ADD[1])-1<c_t3_s00_mem1*ADD_mem[1]
	S += (c_t3_t11*ADD[2])-1<c_t3_s00_mem1*ADD_mem[2]
	S += (c_t3_t11*ADD[3])-1<c_t3_s00_mem1*ADD_mem[3]
	...
	S += (c_t3_t11*ADD[0])-1<c_t3_s01_mem0*ADD_mem[0]
	S += (c_t3_t11*ADD[1])-1<c_t3_s01_mem0*ADD_mem[1]
	S += (c_t3_t11*ADD[2])-1<c_t3_s01_mem0*ADD_mem[2]
	S += (c_t3_t11*ADD[3])-1<c_t3_s01_mem0*ADD_mem[3]
	...
	S += (c_t4_t11*ADD[0])-1<c_t4_s00_mem1*ADD_mem[0]
	S += (c_t4_t11*ADD[1])-1<c_t4_s00_mem1*ADD_mem[1]
	S += (c_t4_t11*ADD[2])-1<c_t4_s00_mem1*ADD_mem[2]
	S += (c_t4_t11*ADD[3])-1<c_t4_s00_mem1*ADD_mem[3]
	...
	S += (c_t4_t11*ADD[0])-1<c_t4_s01_mem0*ADD_mem[0]
	S += (c_t4_t11*ADD[1])-1<c_t4_s01_mem0*ADD_mem[1]
	S += (c_t4_t11*ADD[2])-1<c_t4_s01_mem0*ADD_mem[2]
	S += (c_t4_t11*ADD[3])-1<c_t4_s01_mem0*ADD_mem[3]
	...
	S += (c_t5_t11*ADD[0])-1<c_t5_s00_mem1*ADD_mem[0]
	S += (c_t5_t11*ADD[1])-1<c_t5_s00_mem1*ADD_mem[1]
	S += (c_t5_t11*ADD[2])-1<c_t5_s00_mem1*ADD_mem[2]
	S += (c_t5_t11*ADD[3])-1<c_t5_s00_mem1*ADD_mem[3]
	...
	S += (c_t5_t11*ADD[0])-1<c_t5_s01_mem0*ADD_mem[0]
	S += (c_t5_t11*ADD[1])-1<c_t5_s01_mem0*ADD_mem[1]
	S += (c_t5_t11*ADD[2])-1<c_t5_s01_mem0*ADD_mem[2]
	S += (c_t5_t11*ADD[3])-1<c_t5_s01_mem0*ADD_mem[3]
	...
	pic_file_name = "MUL_mul1_add4/MUL_mul1_add4_3.png"
	if(S.solution() != []):
...
if __name__ == "__main__":
	solution = solve_MUL_mul1_add4_3()