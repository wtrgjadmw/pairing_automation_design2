...
def solve():
	...
	S += (t100*ADD[0])-1 < t2_t0_t0_mem1*ADD_mem[0]
	S += (t100*ADD[1])-1 < t2_t0_t0_mem1*ADD_mem[1]
	S += (t100*ADD[2])-1 < t2_t0_t0_mem1*ADD_mem[2]
	S += (t100*ADD[3])-1 < t2_t0_t0_mem1*ADD_mem[3]
	...
	S += (t101*ADD[0])-1 < t2_t0_t1_mem1*ADD_mem[0]
	S += (t101*ADD[1])-1 < t2_t0_t1_mem1*ADD_mem[1]
	S += (t101*ADD[2])-1 < t2_t0_t1_mem1*ADD_mem[2]
	S += (t101*ADD[3])-1 < t2_t0_t1_mem1*ADD_mem[3]
	...
	S += (t100*ADD[0])-1 < t2_t0_t3_mem0*ADD_mem[0]
	S += (t100*ADD[1])-1 < t2_t0_t3_mem0*ADD_mem[1]
	S += (t100*ADD[2])-1 < t2_t0_t3_mem0*ADD_mem[2]
	S += (t100*ADD[3])-1 < t2_t0_t3_mem0*ADD_mem[3]
	S += t2_t0_t3_mem0 <= t2_t0_t3

	t2_t0_t3_mem1 = S.Task('t2_t0_t3_mem1', length=1, delay_cost=1)
	t2_t0_t3_mem1 += alt(ADD_mem)
	S += (t101*ADD[0])-1 < t2_t0_t3_mem1*ADD_mem[0]
	S += (t101*ADD[1])-1 < t2_t0_t3_mem1*ADD_mem[1]
	S += (t101*ADD[2])-1 < t2_t0_t3_mem1*ADD_mem[2]
	S += (t101*ADD[3])-1 < t2_t0_t3_mem1*ADD_mem[3]
	...
	S += (t100*ADD[0])-1 < t2_t30_mem0*ADD_mem[0]
	S += (t100*ADD[1])-1 < t2_t30_mem0*ADD_mem[1]
	S += (t100*ADD[2])-1 < t2_t30_mem0*ADD_mem[2]
	S += (t100*ADD[3])-1 < t2_t30_mem0*ADD_mem[3]
	...
	S += (t101*ADD[0])-1 < t2_t31_mem0*ADD_mem[0]
	S += (t101*ADD[1])-1 < t2_t31_mem0*ADD_mem[1]
	S += (t101*ADD[2])-1 < t2_t31_mem0*ADD_mem[2]
	S += (t101*ADD[3])-1 < t2_t31_mem0*ADD_mem[3]
	...
	S += (t700*ADD[0])-1 < t800_mem0*ADD_mem[0]
	S += (t700*ADD[1])-1 < t800_mem0*ADD_mem[1]
	S += (t700*ADD[2])-1 < t800_mem0*ADD_mem[2]
	S += (t700*ADD[3])-1 < t800_mem0*ADD_mem[3]
	S += t800_mem0 <= t800

	t800_mem1 = S.Task('t800_mem1', length=1, delay_cost=1)
	t800_mem1 += alt(ADD_mem)
	S += (t700*ADD[0])-1 < t800_mem1*ADD_mem[0]
	S += (t700*ADD[1])-1 < t800_mem1*ADD_mem[1]
	S += (t700*ADD[2])-1 < t800_mem1*ADD_mem[2]
	S += (t700*ADD[3])-1 < t800_mem1*ADD_mem[3]
	S += t800_mem1 <= t800
	...
	S += (t701*ADD[0])-1 < t801_mem0*ADD_mem[0]
	S += (t701*ADD[1])-1 < t801_mem0*ADD_mem[1]
	S += (t701*ADD[2])-1 < t801_mem0*ADD_mem[2]
	S += (t701*ADD[3])-1 < t801_mem0*ADD_mem[3]
	S += t801_mem0 <= t801
	...
	S += (t000*ADD[0])-1 < t12_t0_t0_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t12_t0_t0_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t12_t0_t0_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t12_t0_t0_mem0*ADD_mem[3]
	S += t12_t0_t0_mem0 <= t12_t0_t0

	t12_t0_t0_mem1 = S.Task('t12_t0_t0_mem1', length=1, delay_cost=1)
	t12_t0_t0_mem1 += alt(ADD_mem)
	S += (t1100*ADD[0])-1 < t12_t0_t0_mem1*ADD_mem[0]
	S += (t1100*ADD[1])-1 < t12_t0_t0_mem1*ADD_mem[1]
	S += (t1100*ADD[2])-1 < t12_t0_t0_mem1*ADD_mem[2]
	S += (t1100*ADD[3])-1 < t12_t0_t0_mem1*ADD_mem[3]
	...
	S += (t001*ADD[0])-1 < t12_t0_t1_mem0*ADD_mem[0]
	S += (t001*ADD[1])-1 < t12_t0_t1_mem0*ADD_mem[1]
	S += (t001*ADD[2])-1 < t12_t0_t1_mem0*ADD_mem[2]
	S += (t001*ADD[3])-1 < t12_t0_t1_mem0*ADD_mem[3]
	S += t12_t0_t1_mem0 <= t12_t0_t1

	t12_t0_t1_mem1 = S.Task('t12_t0_t1_mem1', length=1, delay_cost=1)
	t12_t0_t1_mem1 += alt(ADD_mem)
	S += (t1101*ADD[0])-1 < t12_t0_t1_mem1*ADD_mem[0]
	S += (t1101*ADD[1])-1 < t12_t0_t1_mem1*ADD_mem[1]
	S += (t1101*ADD[2])-1 < t12_t0_t1_mem1*ADD_mem[2]
	S += (t1101*ADD[3])-1 < t12_t0_t1_mem1*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t12_t0_t2_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t12_t0_t2_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t12_t0_t2_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t12_t0_t2_mem0*ADD_mem[3]
	S += t12_t0_t2_mem0 <= t12_t0_t2

	t12_t0_t2_mem1 = S.Task('t12_t0_t2_mem1', length=1, delay_cost=1)
	t12_t0_t2_mem1 += alt(ADD_mem)
	S += (t001*ADD[0])-1 < t12_t0_t2_mem1*ADD_mem[0]
	S += (t001*ADD[1])-1 < t12_t0_t2_mem1*ADD_mem[1]
	S += (t001*ADD[2])-1 < t12_t0_t2_mem1*ADD_mem[2]
	S += (t001*ADD[3])-1 < t12_t0_t2_mem1*ADD_mem[3]
	...
	S += (t1100*ADD[0])-1 < t12_t0_t3_mem0*ADD_mem[0]
	S += (t1100*ADD[1])-1 < t12_t0_t3_mem0*ADD_mem[1]
	S += (t1100*ADD[2])-1 < t12_t0_t3_mem0*ADD_mem[2]
	S += (t1100*ADD[3])-1 < t12_t0_t3_mem0*ADD_mem[3]
	S += t12_t0_t3_mem0 <= t12_t0_t3

	t12_t0_t3_mem1 = S.Task('t12_t0_t3_mem1', length=1, delay_cost=1)
	t12_t0_t3_mem1 += alt(ADD_mem)
	S += (t1101*ADD[0])-1 < t12_t0_t3_mem1*ADD_mem[0]
	S += (t1101*ADD[1])-1 < t12_t0_t3_mem1*ADD_mem[1]
	S += (t1101*ADD[2])-1 < t12_t0_t3_mem1*ADD_mem[2]
	S += (t1101*ADD[3])-1 < t12_t0_t3_mem1*ADD_mem[3]
	...
	S += (t1111*ADD[0])-1 < t12_t1_t3_mem1*ADD_mem[0]
	S += (t1111*ADD[1])-1 < t12_t1_t3_mem1*ADD_mem[1]
	S += (t1111*ADD[2])-1 < t12_t1_t3_mem1*ADD_mem[2]
	S += (t1111*ADD[3])-1 < t12_t1_t3_mem1*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t12_t20_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t12_t20_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t12_t20_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t12_t20_mem0*ADD_mem[3]
	...
	S += (t001*ADD[0])-1 < t12_t21_mem0*ADD_mem[0]
	S += (t001*ADD[1])-1 < t12_t21_mem0*ADD_mem[1]
	S += (t001*ADD[2])-1 < t12_t21_mem0*ADD_mem[2]
	S += (t001*ADD[3])-1 < t12_t21_mem0*ADD_mem[3]
	...
	S += (t1100*ADD[0])-1 < t12_t30_mem0*ADD_mem[0]
	S += (t1100*ADD[1])-1 < t12_t30_mem0*ADD_mem[1]
	S += (t1100*ADD[2])-1 < t12_t30_mem0*ADD_mem[2]
	S += (t1100*ADD[3])-1 < t12_t30_mem0*ADD_mem[3]
	...
	S += (t1111*ADD[0])-1 < t12_t31_mem1*ADD_mem[0]
	S += (t1111*ADD[1])-1 < t12_t31_mem1*ADD_mem[1]
	S += (t1111*ADD[2])-1 < t12_t31_mem1*ADD_mem[2]
	S += (t1111*ADD[3])-1 < t12_t31_mem1*ADD_mem[3]
	...
	S += (t600*ADD[0])-1 < new_TX_t0_t3_mem0*ADD_mem[0]
	S += (t600*ADD[1])-1 < new_TX_t0_t3_mem0*ADD_mem[1]
	S += (t600*ADD[2])-1 < new_TX_t0_t3_mem0*ADD_mem[2]
	S += (t600*ADD[3])-1 < new_TX_t0_t3_mem0*ADD_mem[3]
	...
	S += (t601*ADD[0])-1 < new_TX_t0_t3_mem1*ADD_mem[0]
	S += (t601*ADD[1])-1 < new_TX_t0_t3_mem1*ADD_mem[1]
	S += (t601*ADD[2])-1 < new_TX_t0_t3_mem1*ADD_mem[2]
	S += (t601*ADD[3])-1 < new_TX_t0_t3_mem1*ADD_mem[3]
	...
	S += (t611*ADD[0])-1 < new_TX_t1_t3_mem1*ADD_mem[0]
	S += (t611*ADD[1])-1 < new_TX_t1_t3_mem1*ADD_mem[1]
	S += (t611*ADD[2])-1 < new_TX_t1_t3_mem1*ADD_mem[2]
	S += (t611*ADD[3])-1 < new_TX_t1_t3_mem1*ADD_mem[3]
	...
	S += (t600*ADD[0])-1 < new_TX_t30_mem0*ADD_mem[0]
	S += (t600*ADD[1])-1 < new_TX_t30_mem0*ADD_mem[1]
	S += (t600*ADD[2])-1 < new_TX_t30_mem0*ADD_mem[2]
	S += (t600*ADD[3])-1 < new_TX_t30_mem0*ADD_mem[3]
	S += new_TX_t30_mem0 <= new_TX_t30

	new_TX_t30_mem1 = S.Task('new_TX_t30_mem1', length=1, delay_cost=1)
	new_TX_t30_mem1 += ADD_mem[0]
	S += 60 < new_TX_t30_mem1
	...
	S += (t611*ADD[0])-1 < new_TX_t31_mem1*ADD_mem[0]
	S += (t611*ADD[1])-1 < new_TX_t31_mem1*ADD_mem[1]
	S += (t611*ADD[2])-1 < new_TX_t31_mem1*ADD_mem[2]
	S += (t611*ADD[3])-1 < new_TX_t31_mem1*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t18_t00_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t18_t00_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t18_t00_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t18_t00_mem0*ADD_mem[3]
	...
	S += (t001*ADD[0])-1 < t18_t01_mem0*ADD_mem[0]
	S += (t001*ADD[1])-1 < t18_t01_mem0*ADD_mem[1]
	S += (t001*ADD[2])-1 < t18_t01_mem0*ADD_mem[2]
	S += (t001*ADD[3])-1 < t18_t01_mem0*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t18_t10_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t18_t10_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t18_t10_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t18_t10_mem0*ADD_mem[3]
	...
	S += (t001*ADD[0])-1 < t18_t11_mem0*ADD_mem[0]
	S += (t001*ADD[1])-1 < t18_t11_mem0*ADD_mem[1]
	S += (t001*ADD[2])-1 < t18_t11_mem0*ADD_mem[2]
	S += (t001*ADD[3])-1 < t18_t11_mem0*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t18_t3_t0_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t18_t3_t0_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t18_t3_t0_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t18_t3_t0_mem0*ADD_mem[3]
	...
	S += (t001*ADD[0])-1 < t18_t3_t1_mem0*ADD_mem[0]
	S += (t001*ADD[1])-1 < t18_t3_t1_mem0*ADD_mem[1]
	S += (t001*ADD[2])-1 < t18_t3_t1_mem0*ADD_mem[2]
	S += (t001*ADD[3])-1 < t18_t3_t1_mem0*ADD_mem[3]
	...
	S += (t000*ADD[0])-1 < t18_t3_t2_mem0*ADD_mem[0]
	S += (t000*ADD[1])-1 < t18_t3_t2_mem0*ADD_mem[1]
	S += (t000*ADD[2])-1 < t18_t3_t2_mem0*ADD_mem[2]
	S += (t000*ADD[3])-1 < t18_t3_t2_mem0*ADD_mem[3]
	S += t18_t3_t2_mem0 <= t18_t3_t2

	t18_t3_t2_mem1 = S.Task('t18_t3_t2_mem1', length=1, delay_cost=1)
	t18_t3_t2_mem1 += alt(ADD_mem)
	S += (t001*ADD[0])-1 < t18_t3_t2_mem1*ADD_mem[0]
	S += (t001*ADD[1])-1 < t18_t3_t2_mem1*ADD_mem[1]
	S += (t001*ADD[2])-1 < t18_t3_t2_mem1*ADD_mem[2]
	S += (t001*ADD[3])-1 < t18_t3_t2_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls24-318/scheduling/PDBL_mul1_add4/PDBL_4.png"
	if(S.solution() != []):
