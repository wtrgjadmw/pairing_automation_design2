...
writeCommands(18, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_A});
writeCommands(19, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(35, {`MODE_MUL, `RAM_A, `RAM_C, `RAM_A});
...
// b = expFp24(a)
writeCommands(41, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(52, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
writeCommands(53, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(69, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(74, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(75, {`MODE_SQR012345, `RAM_A, `RAM_A, `RAM_A}); // a = squareFp24(a)
writeCommands(76, {`MODE_MUL_CONJ, `RAM_B, `RAM_A, `RAM_A}); // a = mulFp24_conj_forRTL(b, a)
writeCommands(77, {`MODE_MUL, `RAM_A, `RAM_F, `RAM_A}); // a = mulFp24(a, f)
// b = expFp24(a)
writeCommands(78, {`MODE_SQR012345, `RAM_A, `RAM_C, `RAM_C});
...
writeCommands(89, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
writeCommands(90, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(106, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(111, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(112, {`MODE_FROB, `RAM_A, `RAM_C, `RAM_E}); // e = FrobFp24(a)
writeCommands(113, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
writeCommands(114, {`MODE_CONJ, `RAM_A, `RAM_A, `RAM_A}); // a = conjFp24(a)
// b = expFp24(b)
writeCommands(115, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(126, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(148, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(149, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(150, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(151, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(179, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(184, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(185, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(186, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(187, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(198, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
writeCommands(199, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(215, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(220, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(221, {`MODE_MUL, `RAM_B, `RAM_A, `RAM_B}); // b = mulFp24(b, a)
writeCommands(222, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(223, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(224, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(235, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
...
writeCommands(252, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(257, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(258, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(259, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(260, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(288, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(293, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(294, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(295, {`MODE_MUL, `RAM_E, `RAM_B, `RAM_E}); // e = mulFp24(e, b)
// b = expFp24(b)
writeCommands(296, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(307, {`MODE_SQR012345, `RAM_C, `RAM_C, `RAM_B});
writeCommands(308, {`MODE_SQR012345, `RAM_B, `RAM_C, `RAM_C});
...
writeCommands(324, {`MODE_MUL, `RAM_B, `RAM_C, `RAM_B});
...
writeCommands(329, {`MODE_MUL_CONJ, `RAM_B, `RAM_C, `RAM_B});
writeCommands(330, {`MODE_SQR012345, `RAM_F, `RAM_F, `RAM_A}); // a = squareFp24(f)
writeCommands(331, {`MODE_MUL, `RAM_A, `RAM_B, `RAM_A}); // a = mulFp24(a, b)
writeCommands(332, {`MODE_MUL, `RAM_A, `RAM_F, `RAM_A}); // a = mulFp24(a, f)
writeCommands(333, {`MODE_FROB, `RAM_E, `RAM_E, `RAM_E}); // e = FrobFp24(e)
writeCommands(334, {`MODE_MUL, `RAM_E, `RAM_A, `RAM_E}); // e = mulFp24(e, a)
