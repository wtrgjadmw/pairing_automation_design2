...
29: begin
	...
	add0_opr1 <= ram_input_out1; add0_opr2 <= ram_input_out2; issub0 <= 1;
	mm0_opr1 <= add3_out; mm0_opr2 <= add0_out; 
	ram_add1_wr_n <= 0;
	ram_add1_waddr <= 6;
	ram_add0_wr_n <= 1;
	ram_add3_wr_n <= 1;
...
33: begin
	add0_opr1 <= ram_add0_out1; add0_opr2 <= add2_out; issub0 <= 1;
...
35: begin
	...
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_input_out2; issub3 <= 0;
	add0_opr1 <= add1_out_reg; add0_opr2 <= add2_out; issub0 <= 0;
	mm0_opr1 <= ram_add0_out1; mm0_opr2 <= add2_out; 
...
49: begin
	...
	add3_opr1 <= ram_add2_out2; add3_opr2 <= add1_out_reg; issub3 <= 1;
	ram_mm0_wr_n <= 1;
	ram_add1_wr_n <= 1;
	ram_add3_wr_n <= 0;
	ram_add3_waddr <= 0;
...
60: begin
	add0_opr1 <= add0_out; add0_opr2 <= add2_out; issub0 <= 0;
