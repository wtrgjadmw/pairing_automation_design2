...
def solve():
	...
	S += (c_qinv_denom0*ADD[0])-1<c_qinv_denom_inv_aa_mem0*ADD_mem[0]
	S += (c_qinv_denom0*ADD[1])-1<c_qinv_denom_inv_aa_mem0*ADD_mem[1]
	S += (c_qinv_denom0*ADD[2])-1<c_qinv_denom_inv_aa_mem0*ADD_mem[2]
	S += (c_qinv_denom0*ADD[3])-1<c_qinv_denom_inv_aa_mem0*ADD_mem[3]
	...
	c_qinv_denom_inv_aa_mem1 += alt(ADD_mem)
	S += (c_qinv_denom0*ADD[0])-1<c_qinv_denom_inv_aa_mem1*ADD_mem[0]
	S += (c_qinv_denom0*ADD[1])-1<c_qinv_denom_inv_aa_mem1*ADD_mem[1]
	S += (c_qinv_denom0*ADD[2])-1<c_qinv_denom_inv_aa_mem1*ADD_mem[2]
	S += (c_qinv_denom0*ADD[3])-1<c_qinv_denom_inv_aa_mem1*ADD_mem[3]
	...
	S += (c_qinv_denom1*ADD[0])-1<c_qinv_denom_inv_bb_mem0*ADD_mem[0]
	S += (c_qinv_denom1*ADD[1])-1<c_qinv_denom_inv_bb_mem0*ADD_mem[1]
	S += (c_qinv_denom1*ADD[2])-1<c_qinv_denom_inv_bb_mem0*ADD_mem[2]
	S += (c_qinv_denom1*ADD[3])-1<c_qinv_denom_inv_bb_mem0*ADD_mem[3]
	...
	c_qinv_denom_inv_bb_mem1 += alt(ADD_mem)
	S += (c_qinv_denom1*ADD[0])-1<c_qinv_denom_inv_bb_mem1*ADD_mem[0]
	S += (c_qinv_denom1*ADD[1])-1<c_qinv_denom_inv_bb_mem1*ADD_mem[1]
	S += (c_qinv_denom1*ADD[2])-1<c_qinv_denom_inv_bb_mem1*ADD_mem[2]
	S += (c_qinv_denom1*ADD[3])-1<c_qinv_denom_inv_bb_mem1*ADD_mem[3]
	...
	S += (c_qinv_denom_inv_aa*MUL[0])-1<c_qinv_denom_inv_denom_mem0*MUL_mem[0]
	...
	S += (c_qinv_denom_inv_bb*MUL[0])-1<c_qinv_denom_inv_denom_mem1*MUL_mem[0]
	...
	S += (c_qinv_denom_inv_denom*ADD[0])-1<c_qinv_denom_inv_denom_inv_mem0*ADD_mem[0]
	S += (c_qinv_denom_inv_denom*ADD[1])-1<c_qinv_denom_inv_denom_inv_mem0*ADD_mem[1]
	S += (c_qinv_denom_inv_denom*ADD[2])-1<c_qinv_denom_inv_denom_inv_mem0*ADD_mem[2]
	S += (c_qinv_denom_inv_denom*ADD[3])-1<c_qinv_denom_inv_denom_inv_mem0*ADD_mem[3]
	...
	c_qinv_denom_inv_denom_inv_mem1 += alt(ADD_mem)
	S += (c_qinv_denom_inv_denom*ADD[0])-1<c_qinv_denom_inv_denom_inv_mem1*ADD_mem[0]
	S += (c_qinv_denom_inv_denom*ADD[1])-1<c_qinv_denom_inv_denom_inv_mem1*ADD_mem[1]
	S += (c_qinv_denom_inv_denom*ADD[2])-1<c_qinv_denom_inv_denom_inv_mem1*ADD_mem[2]
	S += (c_qinv_denom_inv_denom*ADD[3])-1<c_qinv_denom_inv_denom_inv_mem1*ADD_mem[3]
	...
	S += (c_qinv_denom0*ADD[0])-1<c_qinv_denom_inv0_mem0*ADD_mem[0]
	S += (c_qinv_denom0*ADD[1])-1<c_qinv_denom_inv0_mem0*ADD_mem[1]
	S += (c_qinv_denom0*ADD[2])-1<c_qinv_denom_inv0_mem0*ADD_mem[2]
	S += (c_qinv_denom0*ADD[3])-1<c_qinv_denom_inv0_mem0*ADD_mem[3]
	...
	S += (c_qinv_denom1*ADD[0])-1<c_qinv_denom_inv1__mem0*ADD_mem[0]
	S += (c_qinv_denom1*ADD[1])-1<c_qinv_denom_inv1__mem0*ADD_mem[1]
	S += (c_qinv_denom1*ADD[2])-1<c_qinv_denom_inv1__mem0*ADD_mem[2]
	S += (c_qinv_denom1*ADD[3])-1<c_qinv_denom_inv1__mem0*ADD_mem[3]
	...
	S += 126<c_qinv0_t4_mem0
	S += c_qinv0_t4_mem0<=c_qinv0_t4

	c_qinv0_t4_mem1 = S.Task('c_qinv0_t4_mem1', length=1, delay_cost=1)
	c_qinv0_t4_mem1 += alt(ADD_mem)
	S += (c_qinv0_t3*ADD[0])-1<c_qinv0_t4_mem1*ADD_mem[0]
	S += (c_qinv0_t3*ADD[1])-1<c_qinv0_t4_mem1*ADD_mem[1]
	S += (c_qinv0_t3*ADD[2])-1<c_qinv0_t4_mem1*ADD_mem[2]
	S += (c_qinv0_t3*ADD[3])-1<c_qinv0_t4_mem1*ADD_mem[3]
	...
	S += 120<c_qinv1__t4_mem0
	S += c_qinv1__t4_mem0<=c_qinv1__t4

	c_qinv1__t4_mem1 = S.Task('c_qinv1__t4_mem1', length=1, delay_cost=1)
	c_qinv1__t4_mem1 += alt(ADD_mem)
	S += (c_qinv1__t3*ADD[0])-1<c_qinv1__t4_mem1*ADD_mem[0]
	S += (c_qinv1__t3*ADD[1])-1<c_qinv1__t4_mem1*ADD_mem[1]
	S += (c_qinv1__t3*ADD[2])-1<c_qinv1__t4_mem1*ADD_mem[2]
	S += (c_qinv1__t3*ADD[3])-1<c_qinv1__t4_mem1*ADD_mem[3]
	...
	S += (c_qinv0_t4*MUL[0])-1<c_qinv01_mem0*MUL_mem[0]
	S += c_qinv01_mem0<=c_qinv01

	c_qinv01_mem1 = S.Task('c_qinv01_mem1', length=1, delay_cost=1)
	c_qinv01_mem1 += alt(ADD_mem)
	S += (c_qinv0_t5*ADD[0])-1<c_qinv01_mem1*ADD_mem[0]
	S += (c_qinv0_t5*ADD[1])-1<c_qinv01_mem1*ADD_mem[1]
	S += (c_qinv0_t5*ADD[2])-1<c_qinv01_mem1*ADD_mem[2]
	S += (c_qinv0_t5*ADD[3])-1<c_qinv01_mem1*ADD_mem[3]
	...
	S += (c_qinv1__t4*MUL[0])-1<c_qinv1_1_mem0*MUL_mem[0]
	S += c_qinv1_1_mem0<=c_qinv1_1

	c_qinv1_1_mem1 = S.Task('c_qinv1_1_mem1', length=1, delay_cost=1)
	c_qinv1_1_mem1 += alt(ADD_mem)
	S += (c_qinv1__t5*ADD[0])-1<c_qinv1_1_mem1*ADD_mem[0]
	S += (c_qinv1__t5*ADD[1])-1<c_qinv1_1_mem1*ADD_mem[1]
	S += (c_qinv1__t5*ADD[2])-1<c_qinv1_1_mem1*ADD_mem[2]
	S += (c_qinv1__t5*ADD[3])-1<c_qinv1_1_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c0_t0_t0_mem1*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c0_t0_t0_mem1*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c0_t0_t0_mem1*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c0_t0_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c0_t1_t0_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c0_t1_t0_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c0_t1_t0_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c0_t1_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c0_t30_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c0_t30_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c0_t30_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c0_t30_mem0*ADD_mem[3]
	S += c0_t30_mem0<=c0_t30

	c0_t30_mem1 = S.Task('c0_t30_mem1', length=1, delay_cost=1)
	c0_t30_mem1 += alt(ADD_mem)
	S += (c_qinv1_0*ADD[0])-1<c0_t30_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c0_t30_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c0_t30_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c0_t30_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c1_t0_t0_mem1*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c1_t0_t0_mem1*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c1_t0_t0_mem1*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c1_t0_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c1_t1_t0_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c1_t1_t0_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c1_t1_t0_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c1_t1_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c1_t30_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c1_t30_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c1_t30_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c1_t30_mem0*ADD_mem[3]
	S += c1_t30_mem0<=c1_t30

	c1_t30_mem1 = S.Task('c1_t30_mem1', length=1, delay_cost=1)
	c1_t30_mem1 += alt(ADD_mem)
	S += (c_qinv1_0*ADD[0])-1<c1_t30_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c1_t30_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c1_t30_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c1_t30_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c2_t0_t0_mem1*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c2_t0_t0_mem1*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c2_t0_t0_mem1*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c2_t0_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c2_t1_t0_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c2_t1_t0_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c2_t1_t0_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c2_t1_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c2_t30_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c2_t30_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c2_t30_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c2_t30_mem0*ADD_mem[3]
	S += c2_t30_mem0<=c2_t30

	c2_t30_mem1 = S.Task('c2_t30_mem1', length=1, delay_cost=1)
	c2_t30_mem1 += alt(ADD_mem)
	S += (c_qinv1_0*ADD[0])-1<c2_t30_mem1*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c2_t30_mem1*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c2_t30_mem1*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c2_t30_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c0_t0_t1_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c0_t0_t1_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c0_t0_t1_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c0_t0_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c0_t0_t3_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c0_t0_t3_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c0_t0_t3_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c0_t0_t3_mem0*ADD_mem[3]
	S += c0_t0_t3_mem0<=c0_t0_t3

	c0_t0_t3_mem1 = S.Task('c0_t0_t3_mem1', length=1, delay_cost=1)
	c0_t0_t3_mem1 += alt(ADD_mem)
	S += (c_qinv01*ADD[0])-1<c0_t0_t3_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c0_t0_t3_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c0_t0_t3_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c0_t0_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv1_1*ADD[0])-1<c0_t1_t1_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c0_t1_t1_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c0_t1_t1_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c0_t1_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c0_t1_t3_mem0*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c0_t1_t3_mem0*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c0_t1_t3_mem0*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c0_t1_t3_mem0*ADD_mem[3]
	S += c0_t1_t3_mem0<=c0_t1_t3

	c0_t1_t3_mem1 = S.Task('c0_t1_t3_mem1', length=1, delay_cost=1)
	c0_t1_t3_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c0_t1_t3_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c0_t1_t3_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c0_t1_t3_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c0_t1_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c0_t31_mem0*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c0_t31_mem0*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c0_t31_mem0*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c0_t31_mem0*ADD_mem[3]
	S += c0_t31_mem0<=c0_t31

	c0_t31_mem1 = S.Task('c0_t31_mem1', length=1, delay_cost=1)
	c0_t31_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c0_t31_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c0_t31_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c0_t31_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c0_t31_mem1*ADD_mem[3]
	...
	S += (c0_t30*ADD[0])-1<c0_t4_t0_mem1*ADD_mem[0]
	S += (c0_t30*ADD[1])-1<c0_t4_t0_mem1*ADD_mem[1]
	S += (c0_t30*ADD[2])-1<c0_t4_t0_mem1*ADD_mem[2]
	S += (c0_t30*ADD[3])-1<c0_t4_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c1_t0_t1_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c1_t0_t1_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c1_t0_t1_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c1_t0_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c1_t0_t3_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c1_t0_t3_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c1_t0_t3_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c1_t0_t3_mem0*ADD_mem[3]
	S += c1_t0_t3_mem0<=c1_t0_t3

	c1_t0_t3_mem1 = S.Task('c1_t0_t3_mem1', length=1, delay_cost=1)
	c1_t0_t3_mem1 += alt(ADD_mem)
	S += (c_qinv01*ADD[0])-1<c1_t0_t3_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c1_t0_t3_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c1_t0_t3_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c1_t0_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv1_1*ADD[0])-1<c1_t1_t1_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c1_t1_t1_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c1_t1_t1_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c1_t1_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c1_t1_t3_mem0*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c1_t1_t3_mem0*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c1_t1_t3_mem0*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c1_t1_t3_mem0*ADD_mem[3]
	S += c1_t1_t3_mem0<=c1_t1_t3

	c1_t1_t3_mem1 = S.Task('c1_t1_t3_mem1', length=1, delay_cost=1)
	c1_t1_t3_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c1_t1_t3_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c1_t1_t3_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c1_t1_t3_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c1_t1_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c1_t31_mem0*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c1_t31_mem0*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c1_t31_mem0*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c1_t31_mem0*ADD_mem[3]
	S += c1_t31_mem0<=c1_t31

	c1_t31_mem1 = S.Task('c1_t31_mem1', length=1, delay_cost=1)
	c1_t31_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c1_t31_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c1_t31_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c1_t31_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c1_t31_mem1*ADD_mem[3]
	...
	S += (c1_t30*ADD[0])-1<c1_t4_t0_mem1*ADD_mem[0]
	S += (c1_t30*ADD[1])-1<c1_t4_t0_mem1*ADD_mem[1]
	S += (c1_t30*ADD[2])-1<c1_t4_t0_mem1*ADD_mem[2]
	S += (c1_t30*ADD[3])-1<c1_t4_t0_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c2_t0_t1_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c2_t0_t1_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c2_t0_t1_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c2_t0_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv00*ADD[0])-1<c2_t0_t3_mem0*ADD_mem[0]
	S += (c_qinv00*ADD[1])-1<c2_t0_t3_mem0*ADD_mem[1]
	S += (c_qinv00*ADD[2])-1<c2_t0_t3_mem0*ADD_mem[2]
	S += (c_qinv00*ADD[3])-1<c2_t0_t3_mem0*ADD_mem[3]
	S += c2_t0_t3_mem0<=c2_t0_t3

	c2_t0_t3_mem1 = S.Task('c2_t0_t3_mem1', length=1, delay_cost=1)
	c2_t0_t3_mem1 += alt(ADD_mem)
	S += (c_qinv01*ADD[0])-1<c2_t0_t3_mem1*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c2_t0_t3_mem1*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c2_t0_t3_mem1*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c2_t0_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv1_1*ADD[0])-1<c2_t1_t1_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c2_t1_t1_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c2_t1_t1_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c2_t1_t1_mem1*ADD_mem[3]
	...
	S += (c_qinv1_0*ADD[0])-1<c2_t1_t3_mem0*ADD_mem[0]
	S += (c_qinv1_0*ADD[1])-1<c2_t1_t3_mem0*ADD_mem[1]
	S += (c_qinv1_0*ADD[2])-1<c2_t1_t3_mem0*ADD_mem[2]
	S += (c_qinv1_0*ADD[3])-1<c2_t1_t3_mem0*ADD_mem[3]
	S += c2_t1_t3_mem0<=c2_t1_t3

	c2_t1_t3_mem1 = S.Task('c2_t1_t3_mem1', length=1, delay_cost=1)
	c2_t1_t3_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c2_t1_t3_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c2_t1_t3_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c2_t1_t3_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c2_t1_t3_mem1*ADD_mem[3]
	...
	S += (c_qinv01*ADD[0])-1<c2_t31_mem0*ADD_mem[0]
	S += (c_qinv01*ADD[1])-1<c2_t31_mem0*ADD_mem[1]
	S += (c_qinv01*ADD[2])-1<c2_t31_mem0*ADD_mem[2]
	S += (c_qinv01*ADD[3])-1<c2_t31_mem0*ADD_mem[3]
	S += c2_t31_mem0<=c2_t31

	c2_t31_mem1 = S.Task('c2_t31_mem1', length=1, delay_cost=1)
	c2_t31_mem1 += alt(ADD_mem)
	S += (c_qinv1_1*ADD[0])-1<c2_t31_mem1*ADD_mem[0]
	S += (c_qinv1_1*ADD[1])-1<c2_t31_mem1*ADD_mem[1]
	S += (c_qinv1_1*ADD[2])-1<c2_t31_mem1*ADD_mem[2]
	S += (c_qinv1_1*ADD[3])-1<c2_t31_mem1*ADD_mem[3]
	...
	S += (c2_t30*ADD[0])-1<c2_t4_t0_mem1*ADD_mem[0]
	S += (c2_t30*ADD[1])-1<c2_t4_t0_mem1*ADD_mem[1]
	S += (c2_t30*ADD[2])-1<c2_t4_t0_mem1*ADD_mem[2]
	S += (c2_t30*ADD[3])-1<c2_t4_t0_mem1*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-381/scheduling/INV_mul1_add4/INV_8.png"
	if(S.solution() != []):
