...
39: begin
	...
	add3_opr1 <= ram_add1_out2; add3_opr2 <= add0_out; issub3 <= 1;
	mm0_opr1 <= ram_input_out1; mm0_opr2 <= ram_input_out2; 
	ram_add1_wr_n <= 1;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 2;
...
63: begin
	...
	add3_opr1 <= add2_out; add3_opr2 <= add2_out_reg; issub3 <= 0;
...
69: begin
	add1_opr1 <= ram_add2_out1; add1_opr2 <= ram_input_out1; issub1 <= 1;
	add3_opr1 <= ram_input_out2; add3_opr2 <= ram_add3_out1; issub3 <= 0;
	add2_opr1 <= ram_add1_out1; add2_opr2 <= ram_add0_out1; issub2 <= 0;
	add0_opr1 <= mm0_out_reg; add0_opr2 <= mm0_out; issub0 <= 1;
	mm0_opr1 <= add2_out_reg; mm0_opr2 <= add3_out; 
	ram_mm0_wr_n <= 1;
	ram_add0_wr_n <= 0;
	ram_add0_waddr <= 0;
	ram_add1_wr_n <= 0;
...
70: begin
	add3_opr1 <= ram_input_out1; add3_opr2 <= ram_add3_out1; issub3 <= 0;
...
73: begin
	add2_opr1 <= ram_add2_out1; add2_opr2 <= ram_input_out1; issub2 <= 1;
	...
	add0_opr1 <= ram_add2_out2; add0_opr2 <= ram_input_out2; issub0 <= 0;
	ram_mm0_wr_n <= 0;
	ram_mm0_waddr <= 0;
	ram_add2_wr_n <= 0;
	ram_add0_wr_n <= 0;
...
74: begin
	...
	add2_opr1 <= ram_add3_out1; add2_opr2 <= ram_input_out1; issub2 <= 1;
...
75: begin
	...
	add2_opr1 <= mm0_out_reg; add2_opr2 <= ram_mm0_out1; issub2 <= 1;
	add1_opr1 <= add0_out_reg; add1_opr2 <= add3_out; issub1 <= 1;
...
98: begin
	...
	add1_opr1 <= ram_add2_out2; add1_opr2 <= ram_input_out1; issub1 <= 0;
	ram_add3_wr_n <= 1;
	ram_add2_wr_n <= 0;
	ram_add2_waddr <= 2;
	ram_input_raddr1 <= inst_addr_opr1 + `RAM_ADDR_SIZE'd14;
...
99: begin
	add1_opr1 <= add0_out; add1_opr2 <= add0_out; issub1 <= 0;
	add2_opr1 <= add1_out; add2_opr2 <= add1_out; issub2 <= 0;
	add0_opr1 <= ram_input_out1; add0_opr2 <= add3_out; issub0 <= 0;
	add3_opr1 <= ram_add2_out1; add3_opr2 <= ram_add3_out1; issub3 <= 0;
	ram_add2_wr_n <= 1;
	ram_add1_raddr1 <= 7;
	ram_add3_raddr1 <= 18;
...
101: begin
	add3_opr1 <= add2_out; add3_opr2 <= add2_out; issub3 <= 0;
	add0_opr1 <= add1_out; add0_opr2 <= ram_input_out1; issub0 <= 1;
	add1_opr1 <= ram_add3_out1; add1_opr2 <= ram_add0_out1; issub1 <= 0;
	add2_opr1 <= add3_out; add2_opr2 <= ram_input_out2; issub2 <= 0;
	ram_add3_raddr1 <= 6;
	ram_add0_raddr1 <= 1;
...
102: begin
	...
	add1_opr1 <= add1_out; add1_opr2 <= ram_input_out1; issub1 <= 0;
	ram_input_raddr1 <= inst_addr_opr1 + `RAM_ADDR_SIZE'd15;
	ram_add2_raddr1 <= 7;
	ram_add2_raddr2 <= 11;
	ram_add0_raddr1 <= 3;
...
103: begin
	add2_opr1 <= add1_out; add2_opr2 <= add1_out; issub2 <= 0;
	add3_opr1 <= ram_input_out1; add3_opr2 <= add0_out; issub3 <= 0;
...
104: begin
	add1_opr1 <= add3_out; add1_opr2 <= add3_out; issub1 <= 0;
	add2_opr1 <= ram_add1_out1; add2_opr2 <= ram_add2_out1; issub2 <= 0;
	add3_opr1 <= add0_out; add3_opr2 <= ram_input_out1; issub3 <= 0;
	add0_opr1 <= add1_out; add0_opr2 <= ram_input_out2; issub0 <= 0;
	ram_add1_raddr1 <= 13;
	ram_add1_raddr2 <= 13;
	w1_n_reg <= 0;
...
106: begin
	...
	add3_opr1 <= ram_add0_out1; add3_opr2 <= ram_add1_out1; issub3 <= 1;
	add2_opr1 <= ram_input_out1; add2_opr2 <= add2_out; issub2 <= 0;
	add0_opr1 <= ram_input_out2; add0_opr2 <= add0_out; issub0 <= 0;
	w1_n_reg <= 1;
	w2_n_reg <= 1;
	state <= state + 1;
end
...
112: begin
	add3_opr1 <= add0_out; add3_opr2 <= add2_out_reg; issub3 <= 1;
...
113: begin
	add2_opr1 <= add3_out; add2_opr2 <= add0_out; issub2 <= 0;
	add1_opr1 <= add2_out; add1_opr2 <= add2_out; issub1 <= 0;
...
115: begin
	add1_opr1 <= add0_out; add1_opr2 <= add1_out; issub1 <= 1;
	add2_opr1 <= add1_out; add2_opr2 <= add2_out; issub2 <= 0;
	w2_n_reg <= 0;
