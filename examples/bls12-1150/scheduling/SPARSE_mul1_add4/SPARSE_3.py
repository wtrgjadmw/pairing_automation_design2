...
def solve():
	...
	S += (t3_x00*ADD[0])-1 < t3_x01_mem0*ADD_mem[0]
	S += (t3_x00*ADD[1])-1 < t3_x01_mem0*ADD_mem[1]
	S += (t3_x00*ADD[2])-1 < t3_x01_mem0*ADD_mem[2]
	S += (t3_x00*ADD[3])-1 < t3_x01_mem0*ADD_mem[3]
	...
	S += (t01*ADD[0])-1 < t3_x10_mem0*ADD_mem[0]
	S += (t01*ADD[1])-1 < t3_x10_mem0*ADD_mem[1]
	S += (t01*ADD[2])-1 < t3_x10_mem0*ADD_mem[2]
	S += (t01*ADD[3])-1 < t3_x10_mem0*ADD_mem[3]
	...
	S += (t4_t10_x00*ADD[0])-1 < t4_t10_x01_mem0*ADD_mem[0]
	S += (t4_t10_x00*ADD[1])-1 < t4_t10_x01_mem0*ADD_mem[1]
	S += (t4_t10_x00*ADD[2])-1 < t4_t10_x01_mem0*ADD_mem[2]
	S += (t4_t10_x00*ADD[3])-1 < t4_t10_x01_mem0*ADD_mem[3]
	...
	S += (t4_t21*ADD[0])-1 < t4_t10_x10_mem0*ADD_mem[0]
	S += (t4_t21*ADD[1])-1 < t4_t10_x10_mem0*ADD_mem[1]
	S += (t4_t21*ADD[2])-1 < t4_t10_x10_mem0*ADD_mem[2]
	S += (t4_t21*ADD[3])-1 < t4_t10_x10_mem0*ADD_mem[3]
	...
	S += (t5_t20*ADD[0])-1 < t5_t10_x00_mem0*ADD_mem[0]
	S += (t5_t20*ADD[1])-1 < t5_t10_x00_mem0*ADD_mem[1]
	S += (t5_t20*ADD[2])-1 < t5_t10_x00_mem0*ADD_mem[2]
	S += (t5_t20*ADD[3])-1 < t5_t10_x00_mem0*ADD_mem[3]
	...
	S += (t17_x00*ADD[0])-1 < t17_x01_mem0*ADD_mem[0]
	S += (t17_x00*ADD[1])-1 < t17_x01_mem0*ADD_mem[1]
	S += (t17_x00*ADD[2])-1 < t17_x01_mem0*ADD_mem[2]
	S += (t17_x00*ADD[3])-1 < t17_x01_mem0*ADD_mem[3]
	...
	S += (t21*ADD[0])-1 < t17_x10_mem0*ADD_mem[0]
	S += (t21*ADD[1])-1 < t17_x10_mem0*ADD_mem[1]
	S += (t21*ADD[2])-1 < t17_x10_mem0*ADD_mem[2]
	S += (t21*ADD[3])-1 < t17_x10_mem0*ADD_mem[3]
	...
	S += (t3_x01*ADD[0])-1 < t3_x02_mem0*ADD_mem[0]
	S += (t3_x01*ADD[1])-1 < t3_x02_mem0*ADD_mem[1]
	S += (t3_x01*ADD[2])-1 < t3_x02_mem0*ADD_mem[2]
	S += (t3_x01*ADD[3])-1 < t3_x02_mem0*ADD_mem[3]
	...
	S += (t3_x10*ADD[0])-1 < t3_x11_mem0*ADD_mem[0]
	S += (t3_x10*ADD[1])-1 < t3_x11_mem0*ADD_mem[1]
	S += (t3_x10*ADD[2])-1 < t3_x11_mem0*ADD_mem[2]
	S += (t3_x10*ADD[3])-1 < t3_x11_mem0*ADD_mem[3]
	...
	S += (t4_t10_x01*ADD[0])-1 < t4_t10_x02_mem0*ADD_mem[0]
	S += (t4_t10_x01*ADD[1])-1 < t4_t10_x02_mem0*ADD_mem[1]
	S += (t4_t10_x01*ADD[2])-1 < t4_t10_x02_mem0*ADD_mem[2]
	S += (t4_t10_x01*ADD[3])-1 < t4_t10_x02_mem0*ADD_mem[3]
	...
	S += (t4_t10_x10*ADD[0])-1 < t4_t10_x11_mem0*ADD_mem[0]
	S += (t4_t10_x10*ADD[1])-1 < t4_t10_x11_mem0*ADD_mem[1]
	S += (t4_t10_x10*ADD[2])-1 < t4_t10_x11_mem0*ADD_mem[2]
	S += (t4_t10_x10*ADD[3])-1 < t4_t10_x11_mem0*ADD_mem[3]
	...
	S += (t5_t10_x00*ADD[0])-1 < t5_t10_x01_mem0*ADD_mem[0]
	S += (t5_t10_x00*ADD[1])-1 < t5_t10_x01_mem0*ADD_mem[1]
	S += (t5_t10_x00*ADD[2])-1 < t5_t10_x01_mem0*ADD_mem[2]
	S += (t5_t10_x00*ADD[3])-1 < t5_t10_x01_mem0*ADD_mem[3]
	...
	S += (t5_t21*ADD[0])-1 < t5_t10_x10_mem0*ADD_mem[0]
	S += (t5_t21*ADD[1])-1 < t5_t10_x10_mem0*ADD_mem[1]
	S += (t5_t21*ADD[2])-1 < t5_t10_x10_mem0*ADD_mem[2]
	S += (t5_t21*ADD[3])-1 < t5_t10_x10_mem0*ADD_mem[3]
	...
	S += (t17_x01*ADD[0])-1 < t17_x02_mem0*ADD_mem[0]
	S += (t17_x01*ADD[1])-1 < t17_x02_mem0*ADD_mem[1]
	S += (t17_x01*ADD[2])-1 < t17_x02_mem0*ADD_mem[2]
	S += (t17_x01*ADD[3])-1 < t17_x02_mem0*ADD_mem[3]
	...
	S += (t17_x10*ADD[0])-1 < t17_x11_mem0*ADD_mem[0]
	S += (t17_x10*ADD[1])-1 < t17_x11_mem0*ADD_mem[1]
	S += (t17_x10*ADD[2])-1 < t17_x11_mem0*ADD_mem[2]
	S += (t17_x10*ADD[3])-1 < t17_x11_mem0*ADD_mem[3]
	...
	pic_file_name = "/home/mfukuda/pairing_automation_design/bls12-1150/scheduling/SPARSE_mul1_add4/SPARSE_3.png"
	if(S.solution() != []):
